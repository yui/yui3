...
Base.create = function(name, base, extensions, px, sx) {
        _yuitest_coverfunc("build/base-build/base-build.js", "create", 407);
...
return build(name, base, extensions, px, sx);
     ...
     */
    _yuitest_coverline("build/base-build/base-build.js", 420);
Base.mix = function(main, extensions) {

        _yuitest_coverfunc("build/base-build/base-build.js", "mix", 420);
_yuitest_coverline("build/base-build/base-build.js", 422);
if (main._CACHED_CLASS_DATA) {
            _yuitest_coverline("build/base-build/base-build.js", 423);
main._CACHED_CLASS_DATA = null;
        }

        _yuitest_coverline("build/base-build/base-build.js", 426);
...
BaseCore._buildCfg = {
    ...
    _yuitest_coverline("build/base-build/base-build.js", 453);
Base._buildCfg = {
        custom: {
            ATTRS         : attrsAggregator,
            _ATTR_CFG     : attrCfgAggregator,
