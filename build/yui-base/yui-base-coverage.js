...
*/
_yuitest_coverline("build/yui-base/yui-base.js", 1984);
...
_yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 8)", 1984);
...
@since 3.5.0
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2054);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "_isNative", 2054);
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2072);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isArray", 2072);
_yuitest_coverline("build/yui-base/yui-base.js", 2073);
...
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isBoolean", 2083);
_yuitest_coverline("build/yui-base/yui-base.js", 2084);
...
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isDate", 2094);
_yuitest_coverline("build/yui-base/yui-base.js", 2095);
...
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isFunction", 2122);
...
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNull", 2133);
...
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNumber", 2144);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isObject", 2159);
...
L.isString = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isString", 2172);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isUndefined", 2183);
...
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isValue", 2196);
...
return false;
        ...
        default:
            _yuitest_coverline("build/yui-base/yui-base.js", 2208);
return !!t;
    }
};
...
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 9)", 2220);
...
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "sub", 2235);
_yuitest_coverline("build/yui-base/yui-base.js", 2236);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 10)", 2236);
...
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 11)", 2249);
_yuitest_coverline("build/yui-base/yui-base.js", 2250);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2251);
_yuitest_coverline("build/yui-base/yui-base.js", 2252);
try {
...
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 12)", 2266);
_yuitest_coverline("build/yui-base/yui-base.js", 2267);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2268);
...
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 13)", 2279);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "type", 2312);
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "YArray", 2353);
_yuitest_coverline("build/yui-base/yui-base.js", 2354);
var len, result;
...
if (force || YArray.test(thing)) {
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2360);
try {
...
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "dedupe", 2392);
_yuitest_coverline("build/yui-base/yui-base.js", 2393);
var hash    = {},
        results = [],
        i, item, len;

    _yuitest_coverline("build/yui-base/yui-base.js", 2397);
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 14)", 2424);
_yuitest_coverline("build/yui-base/yui-base.js", 2425);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui-base/yui-base.js", 2426);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2427);
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hash", 2461);
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 15)", 2489);
_yuitest_coverline("build/yui-base/yui-base.js", 2490);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2491);
...
from = (from > 0 || -1) * Math.floor(Math.abs(from));
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2498);
if (from < 0) {
...
for (; from < len; ++from) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2507);
if (from in array && array[from] === value) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2508);
return from;
        }
    }
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "numericSort", 2534);
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 16)", 2554);
_yuitest_coverline("build/yui-base/yui-base.js", 2555);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2556);
_yuitest_coverline("build/yui-base/yui-base.js", 2557);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2558);
...
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "test", 2584);
...
result = 1;
    } else {_yuitest_coverline("build/yui-base/yui-base.js", 2589);
...
function Queue() {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "Queue", 2618);
_yuitest_coverline("build/yui-base/yui-base.js", 2619);
this._init();
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_init", 2630);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "next", 2647);
...
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "last", 2657);
...
return this._q.pop();
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 2668);
_yuitest_coverline("build/yui-base/yui-base.js", 2669);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui-base/yui-base.js", 2671);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2680);
_yuitest_coverline("build/yui-base/yui-base.js", 2681);
...
@for YUI
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2727);
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "cached", 2727);
_yuitest_coverline("build/yui-base/yui-base.js", 2728);
cache || (cache = {});

    _yuitest_coverline("build/yui-base/yui-base.js", 2730);
return function (arg) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 17)", 2730);
...
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2736);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getLocation", 2759);
_yuitest_coverline("build/yui-base/yui-base.js", 2763);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2769);
...
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2784);
Y.merge = function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "merge", 2784);
_yuitest_coverline("build/yui-base/yui-base.js", 2785);
var i      = 0,
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2791);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2792);
obj = arguments[i];

        _yuitest_coverline("build/yui-base/yui-base.js", 2794);
for (key in obj) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2795);
...
result[key] = obj[key];
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2801);
return result;
};
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "mix", 2838);
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2906);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2914);
for (key in from) {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2932);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui-base/yui-base.js", 2940);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2941);
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 18)", 2977);
_yuitest_coverline("build/yui-base/yui-base.js", 2983);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 19)", 2984);
_yuitest_coverline("build/yui-base/yui-base.js", 2986);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui-base/yui-base.js", 2989);
return function (obj) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 20)", 2989);
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "owns", 3052);
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "keys", 3088);
...
if (hasProtoEnumBug && typeof obj === 'function') {
        _yuitest_coverline("build/yui-base/yui-base.js", 3097);
for (key in obj) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3098);
...
keys.push(key);
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3110);
if (hasEnumBug) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3111);
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3112);
key = forceEnum[i];

            _yuitest_coverline("build/yui-base/yui-base.js", 3114);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 3115);
keys.push(key);
            }
        }
    }
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3140);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "values", 3140);
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3147);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3150);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3161);
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 3161);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hasValue", 3179);
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3203);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "each", 3203);
...
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3208);
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3235);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "some", 3235);
_yuitest_coverline("build/yui-base/yui-base.js", 3236);
var key;
...
return true;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3246);
return false;
};
...
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getValue", 3262);
...
return UNDEFINED;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3267);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui-base/yui-base.js", 3271);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3292);
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "setValue", 3292);
_yuitest_coverline("build/yui-base/yui-base.js", 3293);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;
...
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3300);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui-base/yui-base.js", 3303);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3304);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("build/yui-base/yui-base.js", 3306);
return UNDEFINED;
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3310);
return o;
};
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isEmpty", 3322);
_yuitest_coverline("build/yui-base/yui-base.js", 3323);
...
YUI.Env.parseUA = function(subUA) {
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "parseUA", 3358);
_yuitest_coverline("build/yui-base/yui-base.js", 3360);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "numberify", 3360);
_yuitest_coverline("build/yui-base/yui-base.js", 3361);
var c = 0;
            _yuitest_coverline("build/yui-base/yui-base.js", 3362);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 22)", 3362);
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3606);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3607);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3608);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3609);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3610);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3611);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3612);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3613);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3614);
if ((/rhino/i).test(ua)) {
...
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui-base/yui-base.js", 3704);
if (m) {
...
o.opera = numberify(m[1]); // opera 10+
                ...
                _yuitest_coverline("build/yui-base/yui-base.js", 3722);
...
if (m && m[1]) {
                        _yuitest_coverline("build/yui-base/yui-base.js", 3726);
o.opera = numberify(m[1]);
                    }
                }
...
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui-base/yui-base.js", 3743);
if (m && m[1]) {
...
if (win && nav && !(o.chrome && o.chrome < 6)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3755);
o.touchEnabled = (("ontouchstart" in win) || (("msMaxTouchPoints" in nav) && (nav.msMaxTouchPoints > 0)));
    }

    //It was a parsed UA, do not assign the global value.
    _yuitest_coverline("build/yui-base/yui-base.js", 3759);
if (!subUA) {
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui-base/yui-base.js", 3800);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "compareVersions", 3800);
_yuitest_coverline("build/yui-base/yui-base.js", 3801);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui-base/yui-base.js", 3803);
if (a === b) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3804);
return 0;
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3807);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui-base/yui-base.js", 3808);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui-base/yui-base.js", 3810);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3811);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui-base/yui-base.js", 3812);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui-base/yui-base.js", 3814);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui-base/yui-base.js", 3815);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui-base/yui-base.js", 3817);
if (aPart < bPart) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3818);
return -1;
        }

        _yuitest_coverline("build/yui-base/yui-base.js", 3821);
if (aPart > bPart) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3822);
return 1;
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3826);
return 0;
};
_yuitest_coverline("build/yui-base/yui-base.js", 3828);
YUI.Env.aliases = {
