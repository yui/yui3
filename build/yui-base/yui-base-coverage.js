...
return Native.slice.call(thing, startIndex);
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 2130);
result = [];

            _yuitest_coverline("build/yui-base/yui-base.js", 2132);
...
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "dedupe", 2159);
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 14)", 2191);
_yuitest_coverline("build/yui-base/yui-base.js", 2192);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui-base/yui-base.js", 2193);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2194);
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hash", 2228);
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 15)", 2256);
_yuitest_coverline("build/yui-base/yui-base.js", 2257);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2258);
...
from += len;
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2268);
if (from < 0) {
...
from = 0;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2273);
for (; from < len; ++from) {
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "numericSort", 2301);
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 16)", 2321);
_yuitest_coverline("build/yui-base/yui-base.js", 2322);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2323);
...
@static
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2351);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "test", 2351);
...
result = 1;
    } else {_yuitest_coverline("build/yui-base/yui-base.js", 2356);
if (Lang.isObject(obj)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2357);
try {
...
function Queue() {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "Queue", 2385);
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_init", 2397);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "next", 2414);
_yuitest_coverline("build/yui-base/yui-base.js", 2415);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "last", 2424);
...
return this._q.pop();
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 2435);
_yuitest_coverline("build/yui-base/yui-base.js", 2436);
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2447);
...
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "cached", 2494);
_yuitest_coverline("build/yui-base/yui-base.js", 2495);
cache || (cache = {});

    _yuitest_coverline("build/yui-base/yui-base.js", 2497);
return function (arg) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 17)", 2497);
...
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2503);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getLocation", 2526);
...
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2536);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "merge", 2551);
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "mix", 2605);
...
Y.mix(receiver.prototype, supplier.prototype, overwrite,
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2626);
...
to   = receiver;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2642);
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2673);
if (overwrite || !exists) {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2699);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2700);
to[key] = from[key];
            }}
        }
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 18)", 2744);
_yuitest_coverline("build/yui-base/yui-base.js", 2750);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 19)", 2751);
...
return function (obj) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 20)", 2756);
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "owns", 2819);
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "keys", 2855);
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "values", 2907);
...
var keys   = O.keys(obj),
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2913);
for (; i < len; ++i) {
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2928);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hasValue", 2946);
...
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "each", 2970);
...
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2975);
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "some", 3002);
_yuitest_coverline("build/yui-base/yui-base.js", 3003);
var key;
...
return true;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3013);
return false;
};
...
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getValue", 3029);
...
var i,
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3038);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3039);
o = o[p[i]];
    }
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "setValue", 3059);
_yuitest_coverline("build/yui-base/yui-base.js", 3060);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;
...
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3067);
ref = ref[p[i]];
        }
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isEmpty", 3089);
...
*/
_yuitest_coverline("build/yui-base/yui-base.js", 3125);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui-base/yui-base.js", "parseUA", 3125);
_yuitest_coverline("build/yui-base/yui-base.js", 3127);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "numberify", 3127);
_yuitest_coverline("build/yui-base/yui-base.js", 3128);
var c = 0;
            _yuitest_coverline("build/yui-base/yui-base.js", 3129);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 22)", 3129);
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3373);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3374);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3375);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3376);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3377);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3378);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3379);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3380);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3381);
if ((/rhino/i).test(ua)) {
...
if (win && nav && !(o.chrome && o.chrome < 6)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3522);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "compareVersions", 3567);
