...
@since 3.8.
**/
_yuitest_coverline("build/array-extras/array-extras.js", 421);
A.intersect = function (arr1, arr2) {

    _yuitest_coverfunc("build/array-extras/array-extras.js", "intersect", 421);
_yuitest_coverline("build/array-extras/array-extras.js", 423);
var args = Y.Array(arguments),
        otherArrays;

    // Recursively intersect():
    _yuitest_coverline("build/array-extras/array-extras.js", 427);
if (args.length > 2) {
        _yuitest_coverline("build/array-extras/array-extras.js", 428);
otherArrays = args.splice(2);
        ...
        _yuitest_coverline("build/array-extras/array-extras.js", 433);
otherArrays.unshift(A.intersect(arr1, arr2));
        _yuitest_coverline("build/array-extras/array-extras.js", 434);
return A.intersect.apply(this, otherArrays);
    }

    _yuitest_coverline("build/array-extras/array-extras.js", 437);
return A.filter(arr1, function (val1) {
        _yuitest_coverfunc("build/array-extras/array-extras.js", "(anonymous 12)", 437);
_yuitest_coverline("build/array-extras/array-extras.js", 438);
...
@since 3.8.
**/
_yuitest_coverline("build/array-extras/array-extras.js", 461);
A.diff = function (arr1, arr2) {

    _yuitest_coverfunc("build/array-extras/array-extras.js", "diff", 461);
_yuitest_coverline("build/array-extras/array-extras.js", 463);
var args = Y.Array(arguments),
        cc;

    _yuitest_coverline("build/array-extras/array-extras.js", 466);
if (args.length > 2) {
        // combine all subsequent arguments (arr2 onwards)
        _yuitest_coverline("build/array-extras/array-extras.js", 468);
args.splice(0, 2);
        _yuitest_coverline("build/array-extras/array-extras.js", 469);
cc = arr2.concat(args);
        _yuitest_coverline("build/array-extras/array-extras.js", 470);
return A.diff(arr1, cc);
    }

    _yuitest_coverline("build/array-extras/array-extras.js", 473);
return A.filter(arr1, function (val1) {
        _yuitest_coverfunc("build/array-extras/array-extras.js", "(anonymous 13)", 473);
_yuitest_coverline("build/array-extras/array-extras.js", 474);
return (A.indexOf(arr2, val1) === -1);
    });
};
