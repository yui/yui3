...
_yuitest_coverage["/home/yui/src/yui3/src/io/build_tmp/io-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 11);
...
**/
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 32);
function IO (config) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "IO", 32);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 33);
var io = this;

    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 35);
io._uid = 'io:' + uid++;
    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 36);
io._init(config);
    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 37);
Y.io._map[io._uid] = io;
}

_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 40);
IO.prototype = {
    //--------------------------------------
    //  Properties
    //--------------------------------------
    ...
    */
    ...
    _init: function(config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_init", 79);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 80);
var io = this, i, len;

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 82);
io.cfg = config || {};

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 84);
Y.augment(io, Y.EventTarget);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 85);
for (i = 0, len = EVENTS.length; i < len; ++i) {
            // Publish IO global events with configurations, if any.
            // IO global events are set to broadcast by default.
            // These events use the "io:" namespace.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 89);
io.publish('io:' + EVENTS[i], Y.merge({ broadcast: 1 }, config));
            // Publish IO transaction events with configurations, if
            // any.  These events use the "io-trn:" namespace.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 92);
io.publish('io-trn:' + EVENTS[i], config);
    ...
    */
    _create: function(config, id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_create", 107);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 108);
var io = this,
            transaction = {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 117);
if (alt === 'native') {
            // Non-IE  can use XHR level 2 and not rely on an
            // external transport.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 120);
alt = Y.UA.ie ? 'xdr' : null;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 123);
use = alt || form;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 124);
transaction = use ? Y.merge(Y.IO.customTransport(use), transaction) :
                            Y.merge(Y.IO.defaultTransport(), transaction);

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 127);
if (transaction.notify) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 128);
config.notify = function (e, t, c) { _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "notify", 128);
io.notify(e, t, c); };
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 131);
if (!use) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 132);
if (win && win.FormData && config.data instanceof FormData) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 133);
transaction.c.upload.onprogress = function (e) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "onprogress", 133);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 134);
io.progress(transaction, e, config);
                };
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 136);
transaction.c.onload = function (e) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "onload", 136);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 137);
io.load(transaction, e, config);
                };
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 139);
transaction.c.onerror = function (e) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "onerror", 139);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 140);
io.error(transaction, e, config);
                };
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 142);
transaction.upload = true;
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 146);
return transaction;
    },

    _destroy: function(transaction) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_destroy", 149);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 150);
if (win && !transaction.notify && !transaction.xdr) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 151);
if (XHR && !transaction.upload) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 152);
transaction.c.onreadystatechange = null;
            } else {_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 153);
if (transaction.upload) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 154);
transaction.c.upload.onprogress = null;
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 155);
transaction.c.onload = null;
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 156);
transaction.c.onerror = null;
            } else {_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 157);
if (Y.UA.ie && !transaction.e) {
                // IE, when using XMLHttpRequest as an ActiveX Object, will throw
                // a "Type Mismatch" error if the event handler is set to "null".
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 160);
transaction.c.abort();
            }}}
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 164);
transaction = transaction.c = null;
    ...
    */
    _evt: function(eventName, transaction, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_evt", 176);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 177);
var io          = this, params,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 184);
this.detach(trnEvent);

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 186);
if (transaction.e) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 187);
transaction.c = { status: 0, statusText: transaction.e };
        }

        // Fire event with parameters or an Event Facade.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 191);
params = [ emitFacade ?
            {
                id: transaction.id,
                data: transaction.c,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 201);
if (!emitFacade) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 202);
if (eventName === EVENTS[0] || eventName === EVENTS[2]) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 203);
if (args) {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 204);
params.push(args);
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 207);
if (transaction.evt) {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 208);
params.push(transaction.evt);
                } else {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 210);
params.push(transaction.c);
                }
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 212);
if (args) {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 213);
params.push(args);
                }
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 218);
params.unshift(globalEvent);
        // Fire global events.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 220);
io.fire.apply(io, params);
        // Fire transaction events, if receivers are defined.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 222);
if (config.on) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 223);
params[0] = trnEvent;
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 224);
io.once(trnEvent, config.on[eventName], config.context || Y);
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 225);
io.fire.apply(io, params);
        }
    },
    ...
    */
    start: function(transaction, config) {
        ...
        * @event io:start
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "start", 237);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 242);
this._evt(EVENTS[0], transaction, config);
    ...
    */
    complete: function(transaction, config) {
        ...
        * @event io:complete
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "complete", 254);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 261);
this._evt(EVENTS[1], transaction, config);
    ...
    */
        ...
        * @event io:end
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "end", 272);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 277);
this._evt(EVENTS[2], transaction, config);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 278);
this._destroy(transaction);
    ...
    */
    success: function(transaction, config) {
        ...
        * @event io:success
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "success", 289);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 295);
this._evt(EVENTS[3], transaction, config);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 296);
this.end(transaction, config);
    ...
    */
    failure: function(transaction, config) {
        ...
        * @event io:failure
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "failure", 307);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 313);
this._evt(EVENTS[4], transaction, config);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 314);
this.end(transaction, config);
    },
    ...
    */
    progress: function(transaction, e, config) {
        ...
        * @event io:progress
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "progress", 327);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 333);
transaction.evt = e;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 334);
this._evt(EVENTS[5], transaction, config);
    ...
    */
    load: function (transaction, e, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "load", 347);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 348);
transaction.evt = e.target;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 349);
this._evt(EVENTS[1], transaction, config);
    },
    ...
    */
    error: function (transaction, e, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "error", 362);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 363);
transaction.evt = e;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 364);
this._evt(EVENTS[4], transaction, config);
    },
    ...
    */
    _retry: function(transaction, uri, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_retry", 377);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 378);
this._destroy(transaction);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 379);
config.xdr.use = 'flash';
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 380);
return this.send(uri, config, transaction.id);
    ...
    */
    _concat: function(uri, data) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_concat", 392);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 393);
uri += (uri.indexOf('?') === -1 ? '?' : '&') + data;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 394);
return uri;
    },
    ...
    */
    setHeader: function(name, value) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "setHeader", 405);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 406);
if (value) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 407);
this._headers[name] = value;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 409);
delete this._headers[name];
    ...
    */
    _setHeaders: function(transaction, headers) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_setHeaders", 422);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 423);
headers = Y.merge(this._headers, headers);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 424);
Y.Object.each(headers, function(value, name) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "(anonymous 2)", 424);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 425);
if (value !== 'disable') {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 426);
transaction.setRequestHeader(name, headers[name]);
    ...
    */
    _startTimeout: function(transaction, timeout) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_startTimeout", 440);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 441);
var io = this;

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 443);
io._timeout[transaction.id] = setTimeout(function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "(anonymous 3)", 443);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 444);
io._abort(transaction, 'timeout');
    ...
    */
    _clearTimeout: function(id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_clearTimeout", 455);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 456);
clearTimeout(this._timeout[id]);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 457);
delete this._timeout[id];
    ...
    */
    _result: function(transaction, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_result", 471);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 472);
var status;
        // Firefox will throw an exception if attempting to access
        // an XHR object's status property, after a request is aborted.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 475);
try {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 476);
status = transaction.c.status;
        } catch(e) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 478);
status = 0;
        }

        // IE reports HTTP 204 as HTTP 1223.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 482);
if (status >= 200 && status < 300 || status === 304 || status === 1223) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 483);
this.success(transaction, config);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 485);
this.failure(transaction, config);
    ...
    */
    _rS: function(transaction, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_rS", 497);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 498);
var io = this;

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 500);
if (transaction.c.readyState === 4) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 501);
if (config.timeout) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 502);
io._clearTimeout(transaction.id);
            }

            // Yield in the event of request timeout or abort.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 506);
setTimeout(function() {
                _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "(anonymous 4)", 506);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 507);
io.complete(transaction, config);
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 508);
io._result(transaction, config);
    ...
    */
    _abort: function(transaction, type) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "_abort", 521);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 522);
if (transaction && transaction.c) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 523);
transaction.e = type;
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 524);
transaction.c.abort();
        }
    },
    ...
    */
    send: function(uri, config, id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "send", 631);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 632);
var transaction, method, i, len, sync, data,
            io = this,
            u = uri,
            response = {};

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 637);
config = config ? Y.Object(config) : {};
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 638);
transaction = io._create(config, id);
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 639);
method = config.method ? config.method.toUpperCase() : 'GET';
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 640);
sync = config.sync;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 641);
data = config.data;

        // Serialize an map object into a key-value string using
        // querystring-stringify-simple.
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 645);
if ((Y.Lang.isObject(data) && !data.nodeType) && !transaction.upload) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 646);
data = Y.QueryString.stringify(data);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 649);
if (config.form) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 650);
if (config.form.upload) {
                // This is a file upload transaction, calling
                // upload() in io-upload-iframe.
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 653);
return io.upload(transaction, uri, config);
            } else {
                // Serialize HTML form data into a key-value string.
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 656);
data = io._serialize(config.form, data);
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 660);
if (data) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 661);
switch (method) {
                case 'GET':
                case 'HEAD':
                case 'DELETE':
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 665);
u = io._concat(u, data);
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 666);
data = '';
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 667);
break;
                case 'POST':
                case 'PUT':
                    // If Content-Type is defined in the configuration object, or
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 673);
config.headers = Y.merge({
                        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
                    }, config.headers);
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 676);
break;
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 680);
if (transaction.xdr) {
            // Route data to io-xdr module for flash and XDomainRequest.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 682);
return io.xdr(u, transaction, config);
        }
        else {_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 684);
if (transaction.notify) {
            // Route data to custom transport
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 686);
return transaction.c.send(transaction, uri, config);
        }}

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 689);
if (!sync && !transaction.upload) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 690);
transaction.c.onreadystatechange = function() {
                _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "onreadystatechange", 690);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 691);
io._rS(transaction, config);
            };
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 695);
try {
            // Determine if request is to be set as
            // synchronous or asynchronous.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 698);
transaction.c.open(method, u, !sync, config.username || null, config.password || null);
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 699);
io._setHeaders(transaction.c, config.headers || {});
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 700);
io.start(transaction, config);

            // Will work only in browsers that implement the
            // Cross-Origin Resource Sharing draft.
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 704);
if (config.xdr && config.xdr.credentials) {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 705);
if (!Y.UA.ie) {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 706);
transaction.c.withCredentials = true;
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 712);
transaction.c.send(data);

            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 714);
if (sync) {
                // Create a response object for synchronous transactions,
                // mixing id and arguments properties with the xhr
                // properties whitelist.
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 718);
for (i = 0, len = XHR_PROPS.length; i < len; ++i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 719);
response[XHR_PROPS[i]] = transaction.c[XHR_PROPS[i]];
                }

                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 722);
response.getAllResponseHeaders = function() {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "getAllResponseHeaders", 722);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 723);
return transaction.c.getAllResponseHeaders();
                };

                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 726);
response.getResponseHeader = function(name) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "getResponseHeader", 726);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 727);
return transaction.c.getResponseHeader(name);
                };

                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 730);
io.complete(transaction, config);
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 731);
io._result(transaction, config);

                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 733);
return response;
            }
        } catch(e) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 736);
if (transaction.xdr) {
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 743);
return io._retry(transaction, uri, config);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 745);
io.complete(transaction, config);
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 746);
io._result(transaction, config);
            }
        }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 752);
if (config.timeout) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 753);
io._startTimeout(transaction, config.timeout);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 756);
return {
            id: transaction.id,
            abort: function() {
                _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "abort", 758);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 759);
return transaction.c ? io._abort(transaction, 'abort') : false;
            },
            isInProgress: function() {
                _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "isInProgress", 761);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 762);
...
@for YUI
**/
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 874);
Y.io = function(url, config) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "io", 874);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 877);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 878);
...
@static
**/
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 892);
Y.io.header = function(name, value) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "header", 892);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 895);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 896);
transaction.setHeader(name, value);
};

_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 899);
Y.IO = IO;
// Map of all IO instances created.
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 901);
Y.io._map = {};
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 902);
var XHR = win && win.XMLHttpRequest,
    XDR = win && win.XDomainRequest,
    AX = win && win.ActiveXObject;


_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 907);
Y.mix(Y.IO, {
    /**
    ...
    */
    defaultTransport: function(id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "defaultTransport", 922);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 923);
if (id) {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 924);
Y.IO._default = id;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 926);
var o = {
                c: Y.IO.transports[Y.IO._default](),
                notify: Y.IO._default === 'xhr' ? false : true
            };
            _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 930);
return o;
        }
    },
    /**
    ...
    */
    transports: {
        xhr: function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "xhr", 940);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 941);
return XHR ? new XMLHttpRequest() :
                AX ? new ActiveXObject('Microsoft.XMLHTTP') : null;
        },
        xdr: function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "xdr", 944);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 945);
return XDR ? new XDomainRequest() : null;
        },
        iframe: function () { _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "iframe", 947);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 947);
return {}; },
        flash: null,
        nodejs: null
    },
    ...
    */
    customTransport: function(id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "customTransport", 957);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 958);
var o = { c: Y.IO.transports[id]() };

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 960);
o[(id === 'xdr' || id === 'flash') ? 'xdr' : 'notify'] = true;
        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 961);
return o;
    }
});

_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 965);
Y.mix(Y.IO.prototype, {
    ...
    */
    notify: function(event, transaction, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/io/build_tmp/io-base.js", "notify", 974);
_yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 975);
var io = this;

        _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 977);
switch (event) {
            case 'timeout':
            case 'abort':
            case 'transport error':
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 981);
transaction.c = { status: 0, statusText: event };
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 982);
event = 'failure';
            default:
                _yuitest_coverline("/home/yui/src/yui3/src/io/build_tmp/io-base.js", 984);
