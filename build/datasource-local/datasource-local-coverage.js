...
_yuitest_coverage["/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @constructor
 */    
_yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 26);
var LANG = Y.Lang,

DSLocal = function() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "DSLocal", 28);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 29);
DSLocal.superclass.constructor.apply(this, arguments);
    ...
    //
    /////////////////////////////////////////////////////////////////////////////
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 37);
Y.mix(DSLocal, {
    /**
     * Class name.
     *
    ...
    issueCallback: function (e, caller) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "issueCallback", 95);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 96);
var callbacks = e.on || e.callback,
            callback = callbacks && callbacks.success,
            payload = e.details[0];

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 100);
payload.error = (e.error || e.response.error);

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 102);
if (payload.error) {
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 103);
caller.fire("error", payload);
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 104);
callback = callbacks && callbacks.failure;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 107);
if (callback) {
            //TODO: this should be executed from a specific context
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 109);
callback(payload);
        }
    }
});
    
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 114);
Y.extend(DSLocal, Y.Base, {
    ...
    */
    initializer: function(config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "initializer", 122);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 123);
this._initEvents();
    },
    ...
    */
    _initEvents: function() {
         ...
         */
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "_initEvents", 131);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 148);
this.publish("request", {defaultFn: Y.bind("_defRequestFn", this), queuable:true});
         ...
         */
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 172);
this.publish("data", {defaultFn: Y.bind("_defDataFn", this), queuable:true});
         ...
         */
         _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 206);
this.publish("response", {defaultFn: Y.bind("_defResponseFn", this), queuable:true});
    ...
    _defRequestFn: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "_defRequestFn", 265);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 266);
var data = this.get("source"),
            payload = e.details[0];
        
        // Problematic data
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 270);
if(LANG.isUndefined(data)) {
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 271);
payload.error = new Error("Local source undefined");
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 274);
payload.data = data;
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 275);
this.fire("data", payload);
    ...
    _defDataFn: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "_defDataFn", 300);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 301);
var data = e.data,
            meta = e.meta,
            response = {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 309);
payload.response = response;
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 310);
this.fire("response", payload);
    ...
    _defResponseFn: function(e) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "_defResponseFn", 342);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 344);
DSLocal.issueCallback(e, this);
    ...
    sendRequest: function(request) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", "sendRequest", 374);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 375);
var tId = DSLocal._tId++,
            callbacks;

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 378);
request = request || {};

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 380);
callbacks = request.on || request.callback;

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 382);
this.fire("request", {
            tId: tId,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 391);
return tId;
    }
});
    
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-local.js", 395);
