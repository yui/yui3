...
YUI.add('frame', function (Y, NAME) {
    ...
    _yuitest_coverfunc("frame", "(anonymous 1)", 1);
_yuitest_coverline("frame", 15);
var Frame = function() {
        _yuitest_coverfunc("frame", "Frame", 15);
_yuitest_coverline("frame", 16);
Frame.superclass.constructor.apply(this, arguments);
    }, LAST_CHILD = ':last-child', BODY = 'body';
    

    _yuitest_coverline("frame", 20);
...
html = Y.substitute(Frame.PAGE_HTML, {
                ...
                _yuitest_coverline("frame", 81);
if (Y.config.doc.compatMode != 'BackCompat') {
                    
                    //html = Frame.DOC_TYPE + "\n" + html;
                    _yuitest_coverline("frame", 84);
html = Frame.getDocType() + "\n" + html;
            ...
            _yuitest_coverline("frame", 90);
res = this._resolveWinDoc();

            _yuitest_coverline("frame", 92);
if (html) {
                _yuitest_coverline("frame", 93);
res.doc.open();
                _yuitest_coverline("frame", 94);
res.doc.write(html);
                _yuitest_coverline("frame", 95);
res.doc.close();
            }

            _yuitest_coverline("frame", 98);
if (!res.doc.documentElement) {
                _yuitest_coverline("frame", 99);
var timer = Y.later(1, this, function() {
                    _yuitest_coverfunc("frame", "(anonymous 2)", 99);
_yuitest_coverline("frame", 100);
if (res.doc && res.doc.documentElement) {
                        _yuitest_coverline("frame", 101);
cb(res);
                        _yuitest_coverline("frame", 102);
timer.cancel();
                    }
                }, null, true);
            } else {
                _yuitest_coverline("frame", 106);
cb(res);
            }
        ...
        */
        _resolveWinDoc: function(c) {
            _yuitest_coverfunc("frame", "_resolveWinDoc", 117);
_yuitest_coverline("frame", 118);
var config = (c) ? c : {};
            _yuitest_coverline("frame", 119);
config.win = Y.Node.getDOMNode(this._iframe.get('contentWindow'));
            _yuitest_coverline("frame", 120);
config.doc = Y.Node.getDOMNode(this._iframe.get('contentWindow.document'));
            _yuitest_coverline("frame", 121);
if (!config.doc) {
                _yuitest_coverline("frame", 122);
config.doc = Y.config.doc;
            }
            _yuitest_coverline("frame", 124);
if (!config.win) {
                _yuitest_coverline("frame", 125);
config.win = Y.config.win;
            }
            _yuitest_coverline("frame", 127);
return config;
        },
        /**
        * @private
        ...
        */
        _onDomEvent: function(e) {
            _yuitest_coverfunc("frame", "_onDomEvent", 138);
_yuitest_coverline("frame", 139);
var xy, node;
            
            _yuitest_coverline("frame", 141);
if (!Y.Node.getDOMNode(this._iframe)) {
                //The iframe is null for some reason, bail on sending events.
                _yuitest_coverline("frame", 143);
return;
            }

            _yuitest_coverline("frame", 146);
e.frameX = e.frameY = 0;

            _yuitest_coverline("frame", 148);
if (e.pageX > 0 || e.pageY > 0) {
                _yuitest_coverline("frame", 149);
if (e.type.substring(0, 3) !== 'key') {
                    _yuitest_coverline("frame", 150);
node = this._instance.one('win');
                    _yuitest_coverline("frame", 151);
xy = this._iframe.getXY();
                    _yuitest_coverline("frame", 152);
e.frameX = xy[0] + e.pageX - node.get('scrollLeft');
                    _yuitest_coverline("frame", 153);
e.frameY = xy[1] + e.pageY - node.get('scrollTop');
                }
            }

            _yuitest_coverline("frame", 157);
e.frameTarget = e.target;
            _yuitest_coverline("frame", 158);
e.frameCurrentTarget = e.currentTarget;
            _yuitest_coverline("frame", 159);
e.frameEvent = e;

            _yuitest_coverline("frame", 161);
this.fire('dom:' + e.type, e);
        },
        initializer: function() {
            _yuitest_coverfunc("frame", "initializer", 163);
_yuitest_coverline("frame", 164);
this.publish('ready', {
                emitFacade: true,
        ...
        destructor: function() {
            _yuitest_coverfunc("frame", "destructor", 169);
_yuitest_coverline("frame", 170);
var inst = this.getInstance();

            _yuitest_coverline("frame", 172);
inst.one('doc').detachAll();
            _yuitest_coverline("frame", 173);
inst = null;
            _yuitest_coverline("frame", 174);
this._iframe.remove();
        },
        /**
        * @private
        ...
        */
        _DOMPaste: function(e) {
            _yuitest_coverfunc("frame", "_DOMPaste", 182);
_yuitest_coverline("frame", 183);
var inst = this.getInstance(),
                data = '', win = inst.config.win;

            _yuitest_coverline("frame", 186);
if (e._event.originalTarget) {
                _yuitest_coverline("frame", 187);
data = e._event.originalTarget;
            }
            _yuitest_coverline("frame", 189);
if (e._event.clipboardData) {
                _yuitest_coverline("frame", 190);
data = e._event.clipboardData.getData('Text');
            }
            
            _yuitest_coverline("frame", 193);
if (win.clipboardData) {
                _yuitest_coverline("frame", 194);
data = win.clipboardData.getData('Text');
                _yuitest_coverline("frame", 195);
if (data === '') { // Could be empty, or failed
                    // Verify failure
                    _yuitest_coverline("frame", 197);
if (!win.clipboardData.setData('Text', data)) {
                        _yuitest_coverline("frame", 198);
data = null;
                    }
                }
            }
            ...
            _yuitest_coverline("frame", 204);
e.frameTarget = e.target;
            _yuitest_coverline("frame", 205);
e.frameCurrentTarget = e.currentTarget;
            _yuitest_coverline("frame", 206);
e.frameEvent = e;
            
            _yuitest_coverline("frame", 208);
if (data) {
                _yuitest_coverline("frame", 209);
e.clipboardData = {
                    data: data,
                    getData: function() {
                        _yuitest_coverfunc("frame", "getData", 211);
_yuitest_coverline("frame", 212);
return data;
                    }
                };
            } else {
                _yuitest_coverline("frame", 216);
e.clipboardData = null;
            }

            _yuitest_coverline("frame", 219);
this.fire('dom:paste', e);
        ...
        */
        _defReadyFn: function() {
            _yuitest_coverfunc("frame", "_defReadyFn", 226);
_yuitest_coverline("frame", 227);
var inst = this.getInstance();

            _yuitest_coverline("frame", 229);
Y.each(Frame.DOM_EVENTS, function(v, k) {
                _yuitest_coverfunc("frame", "(anonymous 3)", 229);
_yuitest_coverline("frame", 230);
var fn = Y.bind(this._onDomEvent, this),
                    kfn = ((Y.UA.ie && Frame.THROTTLE_TIME > 0) ? Y.throttle(fn, Frame.THROTTLE_TIME) : fn);

                _yuitest_coverline("frame", 233);
if (!inst.Node.DOM_EVENTS[k]) {
                    _yuitest_coverline("frame", 234);
inst.Node.DOM_EVENTS[k] = 1;
                }
                _yuitest_coverline("frame", 236);
if (v === 1) {
                    _yuitest_coverline("frame", 237);
if (k !== 'focus' && k !== 'blur' && k !== 'paste') {
                        _yuitest_coverline("frame", 238);
if (k.substring(0, 3) === 'key') {
                            //Throttle key events in IE
                            _yuitest_coverline("frame", 240);
inst.on(k, kfn, inst.config.doc);
                        } else {
                            _yuitest_coverline("frame", 242);
...
if (Y.UA.ie) {
        ...
        */
        _fixIECursors: function() {
            _yuitest_coverfunc("frame", "_fixIECursors", 275);
_yuitest_coverline("frame", 276);
var inst = this.getInstance(),
                tables = inst.all('table'),
                brs = inst.all('br'), si;

            _yuitest_coverline("frame", 280);
if (tables.size() && brs.size()) {
                //First Table
                _yuitest_coverline("frame", 282);
si = tables.item(0).get('sourceIndex');
                _yuitest_coverline("frame", 283);
brs.each(function(n) {
                    _yuitest_coverfunc("frame", "(anonymous 4)", 283);
_yuitest_coverline("frame", 284);
var p = n.get('parentNode'),
                        c = p.get('children'), b = p.all('>br');
                    
                    _yuitest_coverline("frame", 287);
if (p.test('div')) {
                        _yuitest_coverline("frame", 288);
if (c.size() > 2) {
                            _yuitest_coverline("frame", 289);
n.replace(inst.Node.create('<wbr>'));
                        } else {
                            _yuitest_coverline("frame", 291);
if (n.get('sourceIndex') > si) {
                                _yuitest_coverline("frame", 292);
if (b.size()) {
                                    _yuitest_coverline("frame", 293);
n.replace(inst.Node.create('<wbr>'));
                                }
                            } else {
                                _yuitest_coverline("frame", 296);
if (b.size() > 1) {
                                    _yuitest_coverline("frame", 297);
n.replace(inst.Node.create('<wbr>'));
                                }
                            }
                        }
        ...
        */
        _onContentReady: function(e) {
            _yuitest_coverfunc("frame", "_onContentReady", 312);
_yuitest_coverline("frame", 313);
if (!this._ready) {
                _yuitest_coverline("frame", 314);
this._ready = true;
                _yuitest_coverline("frame", 315);
var inst = this.getInstance(),
                    args = Y.clone(this.get('use'));
                
                _yuitest_coverline("frame", 318);
this.fire('contentready');

                _yuitest_coverline("frame", 320);
if (e) {
                    _yuitest_coverline("frame", 321);
inst.config.doc = Y.Node.getDOMNode(e.target);
                }
                //TODO Circle around and deal with CSS loading...
                _yuitest_coverline("frame", 324);
args.push(Y.bind(function() {
                    _yuitest_coverfunc("frame", "(anonymous 5)", 324);
_yuitest_coverline("frame", 325);
if (inst.EditorSelection) {
                        _yuitest_coverline("frame", 326);
inst.EditorSelection.DEFAULT_BLOCK_TAG = this.get('defaultblock');
                    ...
                    _yuitest_coverline("frame", 329);
if (this.get('designMode')) {
                        _yuitest_coverline("frame", 330);
if(Y.UA.ie) {
                            _yuitest_coverline("frame", 331);
inst.config.doc.body.contentEditable = 'true';
                            _yuitest_coverline("frame", 332);
this._ieSetBodyHeight();
                            _yuitest_coverline("frame", 333);
inst.on('keyup', Y.bind(this._ieSetBodyHeight, this), inst.config.doc);
                        } else {
                            _yuitest_coverline("frame", 335);
inst.config.doc.designMode = 'on';
                        }
                    }
                    _yuitest_coverline("frame", 338);
this.fire('ready');
                }, this));
                _yuitest_coverline("frame", 340);
inst.use.apply(inst, args);

                _yuitest_coverline("frame", 342);
inst.one('doc').get('documentElement').addClass('yui-js-enabled');
        ...
        */
        _ieSetBodyHeight: function(e) {
            _yuitest_coverfunc("frame", "_ieSetBodyHeight", 353);
_yuitest_coverline("frame", 354);
if (!this._ieHeightCounter) {
                _yuitest_coverline("frame", 355);
this._ieHeightCounter = 0;
            }
            _yuitest_coverline("frame", 357);
this._ieHeightCounter++;
            _yuitest_coverline("frame", 358);
var run = false;
            _yuitest_coverline("frame", 359);
if (!e) {
                _yuitest_coverline("frame", 360);
run = true;
            }
            _yuitest_coverline("frame", 362);
if (e) {
                _yuitest_coverline("frame", 363);
switch (e.keyCode) {
                    case 8:
                    case 13:
                        _yuitest_coverline("frame", 366);
run = true;
                        _yuitest_coverline("frame", 367);
break;
                }
                _yuitest_coverline("frame", 369);
if (e.ctrlKey || e.shiftKey) {
                    _yuitest_coverline("frame", 370);
run = true;
                }
            }
            _yuitest_coverline("frame", 373);
if (run) {
                _yuitest_coverline("frame", 374);
try {
                    _yuitest_coverline("frame", 375);
var inst = this.getInstance();
                    _yuitest_coverline("frame", 376);
var h = this._iframe.get('offsetHeight');
                    _yuitest_coverline("frame", 377);
var bh = inst.config.doc.body.scrollHeight;
                    _yuitest_coverline("frame", 378);
if (h > bh) {
                        _yuitest_coverline("frame", 379);
h = (h - 15) + 'px';
                        _yuitest_coverline("frame", 380);
inst.config.doc.body.style.height = h;
                    } else {
                        _yuitest_coverline("frame", 382);
inst.config.doc.body.style.height = 'auto';
                    }
                } catch (e) {
                    _yuitest_coverline("frame", 385);
if (this._ieHeightCounter < 100) {
                        _yuitest_coverline("frame", 386);
Y.later(200, this, this._ieSetBodyHeight);
        ...
        */
        _resolveBaseHref: function(href) {
            _yuitest_coverfunc("frame", "_resolveBaseHref", 399);
_yuitest_coverline("frame", 400);
if (!href || href === '') {
                _yuitest_coverline("frame", 401);
href = Y.config.doc.location.href;
                _yuitest_coverline("frame", 402);
if (href.indexOf('?') !== -1) { //Remove the query string
                    _yuitest_coverline("frame", 403);
href = href.substring(0, href.indexOf('?'));
                }
                _yuitest_coverline("frame", 405);
href = href.substring(0, href.lastIndexOf('/')) + '/';
            }
            _yuitest_coverline("frame", 407);
return href;
        },
        /**
        * @private
        ...
        */
        _getHTML: function(html) {
            _yuitest_coverfunc("frame", "_getHTML", 416);
_yuitest_coverline("frame", 417);
if (this._ready) {
                _yuitest_coverline("frame", 418);
var inst = this.getInstance();
                _yuitest_coverline("frame", 419);
html = inst.one('body').get('innerHTML');
            }
            _yuitest_coverline("frame", 421);
return html;
        },
        /**
        * @private
        ...
        */
        _setHTML: function(html) {
            _yuitest_coverfunc("frame", "_setHTML", 430);
_yuitest_coverline("frame", 431);
if (this._ready) {
                _yuitest_coverline("frame", 432);
var inst = this.getInstance();
                _yuitest_coverline("frame", 433);
inst.one('body').set('innerHTML', html);
            } else {
                //This needs to be wrapped in a contentready callback for the !_ready state
                _yuitest_coverline("frame", 436);
this.on('contentready', Y.bind(function(html, e) {
                    _yuitest_coverfunc("frame", "(anonymous 6)", 436);
_yuitest_coverline("frame", 437);
var inst = this.getInstance();
                    _yuitest_coverline("frame", 438);
inst.one('body').set('innerHTML', html);
                }, this, html));
            }
            _yuitest_coverline("frame", 441);
return html;
        },
        /**
        * @private
        ...
        */
        _getLinkedCSS: function(urls) {
            _yuitest_coverfunc("frame", "_getLinkedCSS", 448);
_yuitest_coverline("frame", 449);
if (!Y.Lang.isArray(urls)) {
                _yuitest_coverline("frame", 450);
urls = [urls];
            }
            _yuitest_coverline("frame", 452);
var str = '';
            _yuitest_coverline("frame", 453);
if (!this._ready) {
                _yuitest_coverline("frame", 454);
Y.each(urls, function(v) {
                    _yuitest_coverfunc("frame", "(anonymous 7)", 454);
_yuitest_coverline("frame", 455);
if (v !== '') {
                        _yuitest_coverline("frame", 456);
str += '<link rel="stylesheet" href="' + v + '" type="text/css">';
                    }
                });
            } else {
                _yuitest_coverline("frame", 460);
str = urls;
            }
            _yuitest_coverline("frame", 462);
return str;
        },
        /**
        * @private
        ...
        */
        _setLinkedCSS: function(css) {
            _yuitest_coverfunc("frame", "_setLinkedCSS", 469);
_yuitest_coverline("frame", 470);
if (this._ready) {
                _yuitest_coverline("frame", 471);
var inst = this.getInstance();
                _yuitest_coverline("frame", 472);
inst.Get.css(css);
            }
            _yuitest_coverline("frame", 474);
return css;
        },
        /**
        * @private
        ...
        */
        _setExtraCSS: function(css) {
            _yuitest_coverfunc("frame", "_setExtraCSS", 481);
_yuitest_coverline("frame", 482);
if (this._ready) {
                _yuitest_coverline("frame", 483);
var inst = this.getInstance(),
                    node = inst.one('#extra_css');
                
                _yuitest_coverline("frame", 486);
node.remove();
                _yuitest_coverline("frame", 487);
inst.one('head').append('<style id="extra_css">' + css + '</style>');
            }
            _yuitest_coverline("frame", 489);
return css;
        },
        /**
        * @private
        ...
        */
        _instanceLoaded: function(inst) {
            _yuitest_coverfunc("frame", "_instanceLoaded", 498);
_yuitest_coverline("frame", 499);
this._instance = inst;
            _yuitest_coverline("frame", 500);
this._onContentReady();
            
            _yuitest_coverline("frame", 502);
var doc = this._instance.config.doc;

            _yuitest_coverline("frame", 504);
if (this.get('designMode')) {
                _yuitest_coverline("frame", 505);
if (!Y.UA.ie) {
                    _yuitest_coverline("frame", 506);
try {
                        //Force other browsers into non CSS styling
                        _yuitest_coverline("frame", 508);
doc.execCommand('styleWithCSS', false, false);
                        _yuitest_coverline("frame", 509);
doc.execCommand('insertbronreturn', false, false);
        ...
        */
        use: function() {
            _yuitest_coverfunc("frame", "use", 520);
_yuitest_coverline("frame", 521);
var inst = this.getInstance(),
                args = Y.Array(arguments),
                cb = false;

            _yuitest_coverline("frame", 525);
if (Y.Lang.isFunction(args[args.length - 1])) {
                _yuitest_coverline("frame", 526);
cb = args.pop();
            }
            _yuitest_coverline("frame", 528);
if (cb) {
                _yuitest_coverline("frame", 529);
args.push(function() {
                    _yuitest_coverfunc("frame", "(anonymous 8)", 529);
_yuitest_coverline("frame", 530);
cb.apply(inst, arguments);

                });
            }
            _yuitest_coverline("frame", 534);
inst.__use.apply(inst, args);
        ...
        */
        delegate: function(type, fn, cont, sel) {
            _yuitest_coverfunc("frame", "delegate", 545);
_yuitest_coverline("frame", 546);
var inst = this.getInstance();
            _yuitest_coverline("frame", 547);
if (!inst) {
                _yuitest_coverline("frame", 548);
return false;
            }
            _yuitest_coverline("frame", 550);
if (!sel) {
                _yuitest_coverline("frame", 551);
sel = cont;
                _yuitest_coverline("frame", 552);
cont = 'body';
            }
            _yuitest_coverline("frame", 554);
return inst.delegate(type, fn, cont, sel);
        ...
        */
        getInstance: function() {
            _yuitest_coverfunc("frame", "getInstance", 561);
_yuitest_coverline("frame", 562);
return this._instance;
        ...
        */
        render: function(node) {
            _yuitest_coverfunc("frame", "render", 571);
_yuitest_coverline("frame", 572);
if (this._rendered) {
                _yuitest_coverline("frame", 573);
return this;
            }
            _yuitest_coverline("frame", 575);
this._rendered = true;
            _yuitest_coverline("frame", 576);
if (node) {
                _yuitest_coverline("frame", 577);
this.set('container', node);
            }

            _yuitest_coverline("frame", 580);
this._create(Y.bind(function(res) {

                _yuitest_coverfunc("frame", "(anonymous 9)", 580);
_yuitest_coverline("frame", 582);
var inst, timer,
                    cb = Y.bind(function(i) {
                        _yuitest_coverfunc("frame", "(anonymous 10)", 583);
_yuitest_coverline("frame", 584);
this._instanceLoaded(i);
                    ...
                    fn = Y.bind(function() {
                        _yuitest_coverfunc("frame", "(anonymous 11)", 592);
_yuitest_coverline("frame", 593);
config = this._resolveWinDoc(config);
                        _yuitest_coverline("frame", 594);
inst = YUI(config);
                        _yuitest_coverline("frame", 595);
inst.host = this.get('host'); //Cross reference to Editor

                        _yuitest_coverline("frame", 597);
try {
                            _yuitest_coverline("frame", 598);
inst.use('node-base', cb);
                            _yuitest_coverline("frame", 599);
if (timer) {
                                _yuitest_coverline("frame", 600);
clearInterval(timer);
                            }
                        } catch (e) {
                            _yuitest_coverline("frame", 603);
timer = setInterval(function() {
                                _yuitest_coverfunc("frame", "(anonymous 12)", 603);
_yuitest_coverline("frame", 604);
fn();
                            }, 350);
                        }
                    }, this);

                _yuitest_coverline("frame", 609);
args.push(fn);

                _yuitest_coverline("frame", 611);
Y.use.apply(Y, args);

            }, this));

            _yuitest_coverline("frame", 615);
return this;
        },
        /**
        * @private
        ...
        */
        _handleFocus: function() {
            _yuitest_coverfunc("frame", "_handleFocus", 622);
_yuitest_coverline("frame", 623);
var inst = this.getInstance(),
                sel = new inst.EditorSelection();

            _yuitest_coverline("frame", 626);
if (sel.anchorNode) {
                _yuitest_coverline("frame", 627);
var n = sel.anchorNode, c;
                
                _yuitest_coverline("frame", 629);
if (n.test('p') && n.get('innerHTML') === '') {
                    _yuitest_coverline("frame", 630);
n = n.get('parentNode');
                }
                _yuitest_coverline("frame", 632);
c = n.get('childNodes');
                
                _yuitest_coverline("frame", 634);
if (c.size()) {
                    _yuitest_coverline("frame", 635);
if (c.item(0).test('br')) {
                        _yuitest_coverline("frame", 636);
sel.selectNode(n, true, false);
                    } else {_yuitest_coverline("frame", 637);
if (c.item(0).test('p')) {
                        _yuitest_coverline("frame", 638);
n = c.item(0).one('br.yui-cursor');
                        _yuitest_coverline("frame", 639);
if (n) {
                            _yuitest_coverline("frame", 640);
n = n.get('parentNode');
                        }
                        _yuitest_coverline("frame", 642);
if (!n) {
                            _yuitest_coverline("frame", 643);
n = c.item(0).get('firstChild');
                        }
                        _yuitest_coverline("frame", 645);
if (!n) {
                            _yuitest_coverline("frame", 646);
n = c.item(0);
                        }
                        _yuitest_coverline("frame", 648);
if (n) {
                            _yuitest_coverline("frame", 649);
sel.selectNode(n, true, false);
                        }
                    } else {
                        _yuitest_coverline("frame", 652);
var b = inst.one('br.yui-cursor');
                        _yuitest_coverline("frame", 653);
if (b) {
                            _yuitest_coverline("frame", 654);
var par = b.get('parentNode');
                            _yuitest_coverline("frame", 655);
if (par) {
                                _yuitest_coverline("frame", 656);
sel.selectNode(par, true, false);
        ...
        */
        focus: function(fn) {
            _yuitest_coverfunc("frame", "focus", 670);
_yuitest_coverline("frame", 671);
if (Y.UA.ie && Y.UA.ie < 9) {
                _yuitest_coverline("frame", 672);
try {
                    _yuitest_coverline("frame", 673);
Y.one('win').focus();
                    _yuitest_coverline("frame", 674);
if (this.getInstance()) {
                        _yuitest_coverline("frame", 675);
if (this.getInstance().one('win')) {
                            _yuitest_coverline("frame", 676);
this.getInstance().one('win').focus();
                        }
                    }
                } catch (ierr) {
                }
                _yuitest_coverline("frame", 681);
if (fn === true) {
                    _yuitest_coverline("frame", 682);
this._handleFocus();
                }
                _yuitest_coverline("frame", 684);
if (Y.Lang.isFunction(fn)) {
                    _yuitest_coverline("frame", 685);
fn();
                }
            } else {
                _yuitest_coverline("frame", 688);
try {
                    _yuitest_coverline("frame", 689);
Y.one('win').focus();
                    _yuitest_coverline("frame", 690);
Y.later(100, this, function() {
                        _yuitest_coverfunc("frame", "(anonymous 13)", 690);
_yuitest_coverline("frame", 691);
if (this.getInstance()) {
                            _yuitest_coverline("frame", 692);
if (this.getInstance().one('win')) {
                                _yuitest_coverline("frame", 693);
this.getInstance().one('win').focus();
                            }
                        }
                        _yuitest_coverline("frame", 696);
if (fn === true) {
                            _yuitest_coverline("frame", 697);
this._handleFocus();
                        }
                        _yuitest_coverline("frame", 699);
if (Y.Lang.isFunction(fn)) {
                            _yuitest_coverline("frame", 700);
fn();
                        }
                    });
                } catch (ferr) {
...
return this;
        ...
        */
        show: function() {
            _yuitest_coverfunc("frame", "show", 714);
_yuitest_coverline("frame", 715);
this._iframe.setStyles({
                position: 'static',
                left: ''
            });
            _yuitest_coverline("frame", 719);
if (Y.UA.gecko) {
                _yuitest_coverline("frame", 720);
try {
                    _yuitest_coverline("frame", 721);
if (this.getInstance()) {
                        _yuitest_coverline("frame", 722);
this.getInstance().config.doc.designMode = 'on';
                    }
                } catch (e) { }
                _yuitest_coverline("frame", 725);
this.focus();
            }           
            _yuitest_coverline("frame", 727);
return this;
        },
        /**
        * @method hide
        ...
        */
        hide: function() {
            _yuitest_coverfunc("frame", "hide", 735);
_yuitest_coverline("frame", 736);
this._iframe.setStyles({
                position: 'absolute',
                left: '-999999px'
            });
            _yuitest_coverline("frame", 740);
return this;
        }
    }, {
        /**
        ...
        */
        getDocType: function() {
            _yuitest_coverfunc("frame", "getDocType", 804);
_yuitest_coverline("frame", 805);
var dt = Y.config.doc.doctype,
                str = Frame.DOC_TYPE;

            _yuitest_coverline("frame", 808);
if (dt) {
                _yuitest_coverline("frame", 809);
str = '<!DOCTYPE ' + dt.name + ((dt.publicId) ? ' ' + dt.publicId : '') + ((dt.systemId) ? ' ' + dt.systemId : '') + '>';
            } else {
                _yuitest_coverline("frame", 811);
if (Y.config.doc.all) {
                    _yuitest_coverline("frame", 812);
dt = Y.config.doc.all[0];
                    _yuitest_coverline("frame", 813);
if (dt.nodeType) {
                        _yuitest_coverline("frame", 814);
if (dt.nodeType === 8) {
                            _yuitest_coverline("frame", 815);
if (dt.nodeValue) {
                                _yuitest_coverline("frame", 816);
if (dt.nodeValue.toLowerCase().indexOf('doctype') !== -1) {
                                    _yuitest_coverline("frame", 817);
str = '<!' + dt.nodeValue + '>';
                                }
                            }
                        }
        ...
        ATTRS: {
            ...
            */
            container: {
                value: 'body',
                setter: function(n) {
                    _yuitest_coverfunc("frame", "setter", 928);
_yuitest_coverline("frame", 929);
return Y.one(n);
                }
            },
            /**
            ...
            */
            node: {
                ...
                value: null,
                getter: function() {
                    _yuitest_coverfunc("frame", "getter", 940);
_yuitest_coverline("frame", 941);
return this._iframe;
                }
            },
            /**
            ...
            */
            id: {
                writeOnce: true,
                getter: function(id) {
                    _yuitest_coverfunc("frame", "getter", 952);
_yuitest_coverline("frame", 953);
if (!id) {
                        _yuitest_coverline("frame", 954);
id = 'iframe-' + Y.guid();
                    }
                    _yuitest_coverline("frame", 956);
return id;
                }
            },
            /**
