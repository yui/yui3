...
return this;
        ...
        */
        getDocType: function() {
            _yuitest_coverfunc("build/frame/frame.js", "getDocType", 812);
...
if (Y.config.doc.all) {
                    _yuitest_coverline("build/frame/frame.js", 820);
dt = Y.config.doc.all[0];
                    _yuitest_coverline("build/frame/frame.js", 821);
if (dt.nodeType) {
...
str = '<!' + dt.nodeValue + '>';
            ...
            _yuitest_coverline("build/frame/frame.js", 832);
return str;
        },
        /**
        * @static
        ...
        ATTRS: {
            ...
            */
            container: {
                value: 'body',
                setter: function(n) {
                    _yuitest_coverfunc("build/frame/frame.js", "setter", 936);
_yuitest_coverline("build/frame/frame.js", 937);
return Y.one(n);
                }
            },
            /**
            ...
            */
            node: {
                ...
                value: null,
                getter: function() {
                    _yuitest_coverfunc("build/frame/frame.js", "getter", 948);
...
return this._iframe;
            ...
            */
            id: {
                writeOnce: true,
                getter: function(id) {
                    _yuitest_coverfunc("build/frame/frame.js", "getter", 960);
_yuitest_coverline("build/frame/frame.js", 961);
if (!id) {
                        _yuitest_coverline("build/frame/frame.js", 962);
id = 'iframe-' + Y.guid();
                    }
                    _yuitest_coverline("build/frame/frame.js", 964);
return id;
                }
            },
            /**
    ...
    _yuitest_coverline("build/frame/frame.js", 1006);
Y.Frame = Frame;
