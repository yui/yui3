...
_yuitest_coverfunc("yui-core", "(anonymous 1)", 1);
_yuitest_coverline("yui-core", 23);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("yui-core", 71);
L._isNative = function (fn) {
    _yuitest_coverfunc("yui-core", "_isNative", 71);
_yuitest_coverline("yui-core", 72);
 ...
 * @static
 */
_yuitest_coverline("yui-core", 89);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("yui-core", "isArray", 89);
_yuitest_coverline("yui-core", 90);
 ...
 */
_yuitest_coverline("yui-core", 100);
L.isBoolean = function(o) {
    _yuitest_coverfunc("yui-core", "isBoolean", 100);
_yuitest_coverline("yui-core", 101);
 ...
 */
_yuitest_coverline("yui-core", 111);
L.isDate = function(o) {
    _yuitest_coverfunc("yui-core", "isDate", 111);
_yuitest_coverline("yui-core", 112);
 ...
 */
_yuitest_coverline("yui-core", 139);
L.isFunction = function(o) {
    _yuitest_coverfunc("yui-core", "isFunction", 139);
_yuitest_coverline("yui-core", 140);
 ...
 */
_yuitest_coverline("yui-core", 150);
L.isNull = function(o) {
    _yuitest_coverfunc("yui-core", "isNull", 150);
_yuitest_coverline("yui-core", 151);
return o === null;
};
 ...
 */
_yuitest_coverline("yui-core", 161);
L.isNumber = function(o) {
    _yuitest_coverfunc("yui-core", "isNumber", 161);
_yuitest_coverline("yui-core", 162);
 ...
 * @see isPlainObject
 */
_yuitest_coverline("yui-core", 176);
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("yui-core", "isObject", 176);
_yuitest_coverline("yui-core", 177);
var t = typeof o;
    _yuitest_coverline("yui-core", 178);
return (o && (t === 'object' ||
 ...
 */
_yuitest_coverline("yui-core", 189);
L.isString = function(o) {
    _yuitest_coverfunc("yui-core", "isString", 189);
_yuitest_coverline("yui-core", 190);
 ...
 */
_yuitest_coverline("yui-core", 200);
L.isUndefined = function(o) {
    _yuitest_coverfunc("yui-core", "isUndefined", 200);
_yuitest_coverline("yui-core", 201);
 ...
 */
_yuitest_coverline("yui-core", 213);
L.isValue = function(o) {
    _yuitest_coverfunc("yui-core", "isValue", 213);
_yuitest_coverline("yui-core", 214);
var t = L.type(o);

    _yuitest_coverline("yui-core", 216);
switch (t) {
        case 'number':
            _yuitest_coverline("yui-core", 218);
return isFinite(o);

        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("yui-core", 222);
return false;

        default:
            _yuitest_coverline("yui-core", 225);
return !!t;
    }
};
 ...
 * @since 3.3.0
 */
_yuitest_coverline("yui-core", 237);
L.now = Date.now || function () {
    _yuitest_coverfunc("yui-core", "(anonymous 2)", 237);
_yuitest_coverline("yui-core", 238);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("yui-core", 252);
L.sub = function(s, o) {
    _yuitest_coverfunc("yui-core", "sub", 252);
_yuitest_coverline("yui-core", 253);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("yui-core", "(anonymous 3)", 253);
_yuitest_coverline("yui-core", 254);
 ...
 */
_yuitest_coverline("yui-core", 266);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("yui-core", "(anonymous 4)", 266);
_yuitest_coverline("yui-core", 267);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("yui-core", "}", 268);
_yuitest_coverline("yui-core", 269);
try {
        _yuitest_coverline("yui-core", 270);
return s.replace(TRIMREGEX, '');
    } catch (e) {
        _yuitest_coverline("yui-core", 272);
return s;
    }
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("yui-core", 283);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("yui-core", "(anonymous 5)", 283);
_yuitest_coverline("yui-core", 284);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("yui-core", "}", 285);
_yuitest_coverline("yui-core", 286);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("yui-core", 296);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("yui-core", "(anonymous 6)", 296);
_yuitest_coverline("yui-core", 297);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("yui-core", "}", 298);
_yuitest_coverline("yui-core", 299);
return s.replace(/\s+$/, '');
};
...
@static
**/
_yuitest_coverline("yui-core", 329);
L.type = function(o) {
    _yuitest_coverfunc("yui-core", "type", 329);
_yuitest_coverline("yui-core", 330);
...
_yuitest_coverline("yui-core", 337);
var Lang   = Y.Lang,
...
@return {Array} A native array created from _thing_, according to the rules
  described above.
**/
_yuitest_coverline("yui-core", 370);
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("yui-core", "YArray", 370);
_yuitest_coverline("yui-core", 371);
var len, result;

    _yuitest_coverline("yui-core", 373);
startIndex || (startIndex = 0);

    _yuitest_coverline("yui-core", 375);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("yui-core", 377);
try {
            _yuitest_coverline("yui-core", 378);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("yui-core", 380);
result = [];

            _yuitest_coverline("yui-core", 382);
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("yui-core", 383);
result.push(thing[startIndex]);
            }

            _yuitest_coverline("yui-core", 386);
return result;
        }
    }

    _yuitest_coverline("yui-core", 390);
return [thing];
}

_yuitest_coverline("yui-core", 393);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("yui-core", 409);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("yui-core", "dedupe", 409);
_yuitest_coverline("yui-core", 410);
var hash    = {},
        results = [],
        i, item, len;

    _yuitest_coverline("yui-core", 414);
for (i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("yui-core", 415);
item = array[i];

        _yuitest_coverline("yui-core", 417);
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("yui-core", 418);
hash[item] = 1;
            _yuitest_coverline("yui-core", 419);
results.push(item);
        }
    }

    _yuitest_coverline("yui-core", 423);
return results;
};
...
@static
**/
_yuitest_coverline("yui-core", 441);
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("yui-core", "(anonymous 7)", 441);
_yuitest_coverline("yui-core", 442);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("yui-core", 443);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("yui-core", "}", 444);
_yuitest_coverline("yui-core", 445);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("yui-core", 446);
if (i in array) {
            _yuitest_coverline("yui-core", 447);
fn.call(thisObj || Y, array[i], i, array);
        }
    }

    _yuitest_coverline("yui-core", 451);
return Y;
};
...
@static
**/
_yuitest_coverline("yui-core", 478);
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("yui-core", "hash", 478);
_yuitest_coverline("yui-core", 479);
var hash = {},
        vlen = (values && values.length) || 0,
        i, len;

    _yuitest_coverline("yui-core", 483);
for (i = 0, len = keys.length; i < len; ++i) {
        _yuitest_coverline("yui-core", 484);
if (i in keys) {
            _yuitest_coverline("yui-core", 485);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("yui-core", 489);
return hash;
};
...
@static
**/
_yuitest_coverline("yui-core", 506);
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("yui-core", "(anonymous 8)", 506);
_yuitest_coverline("yui-core", 507);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("yui-core", "}", 508);
_yuitest_coverline("yui-core", 510);
var len = array.length;

    _yuitest_coverline("yui-core", 512);
from = +from || 0;
    _yuitest_coverline("yui-core", 513);
from = (from > 0 || -1) * Math.floor(Math.abs(from));

    _yuitest_coverline("yui-core", 515);
if (from < 0) {
        _yuitest_coverline("yui-core", 516);
from += len;

        _yuitest_coverline("yui-core", 518);
if (from < 0) {
            _yuitest_coverline("yui-core", 519);
from = 0;
        }
    }

    _yuitest_coverline("yui-core", 523);
for (; from < len; ++from) {
        _yuitest_coverline("yui-core", 524);
if (from in array && array[from] === value) {
            _yuitest_coverline("yui-core", 525);
return from;
        }
    }

    _yuitest_coverline("yui-core", 529);
return -1;
};
...
@static
**/
_yuitest_coverline("yui-core", 551);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("yui-core", "numericSort", 551);
_yuitest_coverline("yui-core", 552);
return a - b;
};
...
@static
**/
_yuitest_coverline("yui-core", 571);
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("yui-core", "(anonymous 9)", 571);
_yuitest_coverline("yui-core", 572);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("yui-core", "}", 573);
_yuitest_coverline("yui-core", 574);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("yui-core", 575);
if (i in array && fn.call(thisObj, array[i], i, array)) {
            _yuitest_coverline("yui-core", 576);
return true;
        }
    }

    _yuitest_coverline("yui-core", 580);
return false;
};
...
@static
**/
_yuitest_coverline("yui-core", 601);
YArray.test = function (obj) {
    _yuitest_coverfunc("yui-core", "test", 601);
_yuitest_coverline("yui-core", 602);
var result = 0;

    _yuitest_coverline("yui-core", 604);
if (Lang.isArray(obj)) {
        _yuitest_coverline("yui-core", 605);
result = 1;
    } else {_yuitest_coverline("yui-core", 606);
if (Lang.isObject(obj)) {
        _yuitest_coverline("yui-core", 607);
try {
            // indexed, but no tagName (element) or alert (window),
            // or functions without apply/call (Safari
            // HTMLElementCollection bug).
            _yuitest_coverline("yui-core", 611);
if ('length' in obj && !obj.tagName && !obj.alert && !obj.apply) {
                _yuitest_coverline("yui-core", 612);
result = 2;
            }
        } catch (ex) {}
    }}

    _yuitest_coverline("yui-core", 617);
return result;
};
/**
 * The YUI module contains the components required for building the YUI
 ...
 */
_yuitest_coverline("yui-core", 635);
function Queue() {
    _yuitest_coverfunc("yui-core", "Queue", 635);
_yuitest_coverline("yui-core", 636);
this._init();
    _yuitest_coverline("yui-core", 637);
this.add.apply(this, arguments);
}

_yuitest_coverline("yui-core", 640);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("yui-core", "_init", 647);
_yuitest_coverline("yui-core", 655);
this._q = [];
    },
     ...
     */
    next: function() {
        _yuitest_coverfunc("yui-core", "next", 664);
_yuitest_coverline("yui-core", 665);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("yui-core", "last", 674);
_yuitest_coverline("yui-core", 675);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("yui-core", "add", 685);
_yuitest_coverline("yui-core", 686);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("yui-core", 688);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("yui-core", "size", 697);
_yuitest_coverline("yui-core", 698);
return this._q.length;
    }
};

_yuitest_coverline("yui-core", 702);
Y.Queue = Queue;

_yuitest_coverline("yui-core", 704);
...
_yuitest_coverline("yui-core", 715);
...
@for YUI
**/
_yuitest_coverline("yui-core", 744);
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("yui-core", "cached", 744);
_yuitest_coverline("yui-core", 745);
cache || (cache = {});

    _yuitest_coverline("yui-core", 747);
return function (arg) {
        _yuitest_coverfunc("yui-core", "(anonymous 10)", 747);
_yuitest_coverline("yui-core", 748);
var key = arguments.length > 1 ?
                Array.prototype.join.call(arguments, CACHED_DELIMITER) :
                String(arg);

        _yuitest_coverline("yui-core", 752);
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("yui-core", 753);
cache[key] = source.apply(source, arguments);
        }

        _yuitest_coverline("yui-core", 756);
return cache[key];
    };
};
...
@since 3.5.0
**/
_yuitest_coverline("yui-core", 776);
Y.getLocation = function () {
    // It is safer to look this up every time because yui-base is attached to a
    // YUI instance before a user's config is applied; i.e. `Y.config.win` does
    // not point the correct window object when this file is loaded.
    _yuitest_coverfunc("yui-core", "getLocation", 776);
_yuitest_coverline("yui-core", 780);
var win = Y.config.win;
    ...
    _yuitest_coverline("yui-core", 786);
...
**/
_yuitest_coverline("yui-core", 801);
Y.merge = function () {
    _yuitest_coverfunc("yui-core", "merge", 801);
_yuitest_coverline("yui-core", 802);
var args   = arguments,
        i      = 0,
        len    = args.length,
        result = {};

    _yuitest_coverline("yui-core", 807);
for (; i < len; ++i) {
        _yuitest_coverline("yui-core", 808);
Y.mix(result, args[i], true);
    }

    _yuitest_coverline("yui-core", 811);
return result;
};
...
**/
_yuitest_coverline("yui-core", 848);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("yui-core", "mix", 848);
_yuitest_coverline("yui-core", 849);
var alwaysOverwrite, exists, from, i, key, len, to;

    // If no supplier is given, we return the receiver. If no receiver is given,
    // we return Y. Returning Y doesn't make much sense to me, but it's
    // grandfathered in for backcompat reasons.
    _yuitest_coverline("yui-core", 854);
if (!receiver || !supplier) {
        _yuitest_coverline("yui-core", 855);
return receiver || Y;
    }

    _yuitest_coverline("yui-core", 858);
if (mode) {
        // In mode 2 (prototype to prototype and object to object), we recurse
        // once to do the proto to proto mix. The object to object mix will be
        // handled later on.
        _yuitest_coverline("yui-core", 862);
if (mode === 2) {
            _yuitest_coverline("yui-core", 863);
Y.mix(receiver.prototype, supplier.prototype, overwrite,
        ...
        _yuitest_coverline("yui-core", 869);
from = mode === 1 || mode === 3 ? supplier.prototype : supplier;
        _yuitest_coverline("yui-core", 870);
to   = mode === 1 || mode === 4 ? receiver.prototype : receiver;

        // If either the supplier or receiver doesn't actually have a
        // prototype property, then we could end up with an undefined `from`
        // or `to`. If that happens, we abort and return the receiver.
        _yuitest_coverline("yui-core", 875);
if (!from || !to) {
            _yuitest_coverline("yui-core", 876);
return receiver;
        }
    } else {
        _yuitest_coverline("yui-core", 879);
from = supplier;
        _yuitest_coverline("yui-core", 880);
to   = receiver;
    }

    // If `overwrite` is truthy and `merge` is falsy, then we can skip a
    // property existence check on each iteration and save some time.
    _yuitest_coverline("yui-core", 885);
alwaysOverwrite = overwrite && !merge;

    _yuitest_coverline("yui-core", 887);
if (whitelist) {
        _yuitest_coverline("yui-core", 888);
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("yui-core", 889);
key = whitelist[i];
            ...
            // method.
            _yuitest_coverline("yui-core", 896);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("yui-core", 897);
continue;
            }
            ...
            _yuitest_coverline("yui-core", 903);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("yui-core", 905);
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("yui-core", 915);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("yui-core", 916);
if (overwrite || !exists) {
                // We're not in merge mode, so we'll only copy the `from` value
                // to the `to` value if we're in overwrite mode or if the
                // current key doesn't exist on the `to` object.
                _yuitest_coverline("yui-core", 920);
to[key] = from[key];
            }}
        }
    } else {
        _yuitest_coverline("yui-core", 924);
for (key in from) {
            ...
            _yuitest_coverline("yui-core", 930);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("yui-core", 931);
continue;
            }
            ...
            // compatibility reasons. It prevents undesired shadowing of
            // prototype members on `to`.
            _yuitest_coverline("yui-core", 937);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("yui-core", 939);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("yui-core", 941);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("yui-core", 942);
if (overwrite || !exists) {
                _yuitest_coverline("yui-core", 943);
to[key] = from[key];
            }}
        }
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("yui-core", 950);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("yui-core", 951);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("yui-core", 955);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
_yuitest_coverline("yui-core", 971);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("yui-core", "(anonymous 11)", 987);
_yuitest_coverline("yui-core", 993);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("yui-core", "(anonymous 12)", 994);
_yuitest_coverline("yui-core", 996);
function F() {}

    // The actual shim.
    _yuitest_coverline("yui-core", 999);
return function (obj) {
        _yuitest_coverfunc("yui-core", "(anonymous 13)", 999);
_yuitest_coverline("yui-core", 1000);
F.prototype = obj;
        _yuitest_coverline("yui-core", 1001);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("yui-core", "owns", 1062);
_yuitest_coverline("yui-core", 1063);
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1075);
O.hasKey = owns;
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1098);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("yui-core", "keys", 1098);
_yuitest_coverline("yui-core", 1099);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("yui-core", 1100);
throw new TypeError('Object.keys called on a non-object');
    }

    _yuitest_coverline("yui-core", 1103);
var keys = [],
        i, key, len;

    _yuitest_coverline("yui-core", 1106);
if (hasProtoEnumBug && typeof obj === 'function') {
        _yuitest_coverline("yui-core", 1107);
for (key in obj) {
            _yuitest_coverline("yui-core", 1108);
if (owns(obj, key) && key !== 'prototype') {
                _yuitest_coverline("yui-core", 1109);
keys.push(key);
            }
        }
    } else {
        _yuitest_coverline("yui-core", 1113);
for (key in obj) {
            _yuitest_coverline("yui-core", 1114);
if (owns(obj, key)) {
                _yuitest_coverline("yui-core", 1115);
keys.push(key);
            }
        }
    }

    _yuitest_coverline("yui-core", 1120);
if (hasEnumBug) {
        _yuitest_coverline("yui-core", 1121);
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("yui-core", 1122);
key = forceEnum[i];

            _yuitest_coverline("yui-core", 1124);
if (owns(obj, key)) {
                _yuitest_coverline("yui-core", 1125);
keys.push(key);
            }
        }
    }

    _yuitest_coverline("yui-core", 1130);
return keys;
};
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1150);
O.values = function (obj) {
    _yuitest_coverfunc("yui-core", "values", 1150);
_yuitest_coverline("yui-core", 1151);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];

    _yuitest_coverline("yui-core", 1156);
for (; i < len; ++i) {
        _yuitest_coverline("yui-core", 1157);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("yui-core", 1160);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1171);
O.size = function (obj) {
    _yuitest_coverfunc("yui-core", "size", 1171);
_yuitest_coverline("yui-core", 1172);
try {
        _yuitest_coverline("yui-core", 1173);
return O.keys(obj).length;
    } catch (ex) {
        _yuitest_coverline("yui-core", 1175);
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1189);
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("yui-core", "hasValue", 1189);
_yuitest_coverline("yui-core", 1190);
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1213);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("yui-core", "each", 1213);
_yuitest_coverline("yui-core", 1214);
var key;

    _yuitest_coverline("yui-core", 1216);
for (key in obj) {
        _yuitest_coverline("yui-core", 1217);
if (proto || owns(obj, key)) {
            _yuitest_coverline("yui-core", 1218);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("yui-core", 1222);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("yui-core", 1245);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("yui-core", "some", 1245);
_yuitest_coverline("yui-core", 1246);
var key;

    _yuitest_coverline("yui-core", 1248);
for (key in obj) {
        _yuitest_coverline("yui-core", 1249);
if (proto || owns(obj, key)) {
            _yuitest_coverline("yui-core", 1250);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("yui-core", 1251);
return true;
            }
        }
    }

    _yuitest_coverline("yui-core", 1256);
return false;
};
 ...
 */
_yuitest_coverline("yui-core", 1272);
O.getValue = function(o, path) {
    _yuitest_coverfunc("yui-core", "getValue", 1272);
_yuitest_coverline("yui-core", 1273);
if (!Lang.isObject(o)) {
        _yuitest_coverline("yui-core", 1274);
return UNDEFINED;
    }

    _yuitest_coverline("yui-core", 1277);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("yui-core", 1281);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("yui-core", 1282);
o = o[p[i]];
    }

    _yuitest_coverline("yui-core", 1285);
return o;
};
 ...
 */
_yuitest_coverline("yui-core", 1302);
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("yui-core", "setValue", 1302);
_yuitest_coverline("yui-core", 1303);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;

    _yuitest_coverline("yui-core", 1308);
if (leafIdx >= 0) {
        _yuitest_coverline("yui-core", 1309);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("yui-core", 1310);
ref = ref[p[i]];
        }

        _yuitest_coverline("yui-core", 1313);
if (ref !== UNDEFINED) {
            _yuitest_coverline("yui-core", 1314);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("yui-core", 1316);
return UNDEFINED;
        }
    }

    _yuitest_coverline("yui-core", 1320);
return o;
};
 ...
 * @since 3.2.0
 */
_yuitest_coverline("yui-core", 1332);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("yui-core", "isEmpty", 1332);
_yuitest_coverline("yui-core", 1333);
...
*/
_yuitest_coverline("yui-core", 1368);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("yui-core", "parseUA", 1368);
_yuitest_coverline("yui-core", 1370);
var numberify = function(s) {
            _yuitest_coverfunc("yui-core", "numberify", 1370);
_yuitest_coverline("yui-core", 1371);
var c = 0;
            _yuitest_coverline("yui-core", 1372);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("yui-core", "(anonymous 15)", 1372);
_yuitest_coverline("yui-core", 1373);
return (c++ == 1) ? '' : '.';
            }));
        },
    ...
    * @static
    */
    _yuitest_coverline("yui-core", 1600);
o.userAgent = ua;


    _yuitest_coverline("yui-core", 1603);
o.secure = href && (href.toLowerCase().indexOf('https') === 0);

    _yuitest_coverline("yui-core", 1605);
if (ua) {

        _yuitest_coverline("yui-core", 1607);
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("yui-core", 1608);
o.os = 'windows';
        } else {_yuitest_coverline("yui-core", 1609);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("yui-core", 1610);
o.os = 'macintosh';
        } else {_yuitest_coverline("yui-core", 1611);
if ((/android/i).test(ua)) {
            _yuitest_coverline("yui-core", 1612);
o.os = 'android';
        } else {_yuitest_coverline("yui-core", 1613);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("yui-core", 1614);
o.os = 'symbos';
        } else {_yuitest_coverline("yui-core", 1615);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("yui-core", 1616);
o.os = 'linux';
        } else {_yuitest_coverline("yui-core", 1617);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("yui-core", 1618);
o.os = 'rhino';
        }}}}}}

        // Modern KHTML browsers should qualify as Safari X-Grade
        _yuitest_coverline("yui-core", 1622);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("yui-core", 1623);
o.webkit = 1;
        }
        _yuitest_coverline("yui-core", 1625);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("yui-core", 1626);
o.mobile = 'windows';
        }
        _yuitest_coverline("yui-core", 1628);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("yui-core", 1629);
o.mobile = 'gecko';
        }
        // Modern WebKit browsers are at least X-Grade
        _yuitest_coverline("yui-core", 1632);
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("yui-core", 1633);
if (m && m[1]) {
            _yuitest_coverline("yui-core", 1634);
o.webkit = numberify(m[1]);
            _yuitest_coverline("yui-core", 1635);
o.safari = o.webkit;
            
            _yuitest_coverline("yui-core", 1637);
if (/PhantomJS/.test(ua)) {
                _yuitest_coverline("yui-core", 1638);
m = ua.match(/PhantomJS\/([^\s]*)/);
                _yuitest_coverline("yui-core", 1639);
if (m && m[1]) {
                    _yuitest_coverline("yui-core", 1640);
o.phantomjs = numberify(m[1]);
                }
            }

            // Mobile browser check
            _yuitest_coverline("yui-core", 1645);
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("yui-core", 1646);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("yui-core", 1648);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("yui-core", 1649);
if (m && m[1]) {
                    _yuitest_coverline("yui-core", 1650);
m = numberify(m[1].replace('_', '.'));
                }
                _yuitest_coverline("yui-core", 1652);
o.ios = m;
                _yuitest_coverline("yui-core", 1653);
o.os = 'ios';
                _yuitest_coverline("yui-core", 1654);
o.ipad = o.ipod = o.iphone = 0;

                _yuitest_coverline("yui-core", 1656);
m = ua.match(/iPad|iPod|iPhone/);
                _yuitest_coverline("yui-core", 1657);
if (m && m[0]) {
                    _yuitest_coverline("yui-core", 1658);
o[m[0].toLowerCase()] = o.ios;
                }
            } else {
                _yuitest_coverline("yui-core", 1661);
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("yui-core", 1662);
if (m) {
                    // Nokia N-series, webOS, ex: NokiaN95
                    _yuitest_coverline("yui-core", 1664);
o.mobile = m[0];
                }
                _yuitest_coverline("yui-core", 1666);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("yui-core", 1667);
o.mobile = 'WebOS';
                    _yuitest_coverline("yui-core", 1668);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("yui-core", 1669);
if (m && m[1]) {
                        _yuitest_coverline("yui-core", 1670);
o.webos = numberify(m[1]);
                    }
                }
                _yuitest_coverline("yui-core", 1673);
if (/ Android/.test(ua)) {
                    _yuitest_coverline("yui-core", 1674);
if (/Mobile/.test(ua)) {
                        _yuitest_coverline("yui-core", 1675);
o.mobile = 'Android';
                    }
                    _yuitest_coverline("yui-core", 1677);
m = ua.match(/Android ([^\s]*);/);
                    _yuitest_coverline("yui-core", 1678);
if (m && m[1]) {
                        _yuitest_coverline("yui-core", 1679);
o.android = numberify(m[1]);
                    }

                }
                _yuitest_coverline("yui-core", 1683);
if (/Silk/.test(ua)) {
                    _yuitest_coverline("yui-core", 1684);
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("yui-core", 1685);
if (m && m[1]) {
                        _yuitest_coverline("yui-core", 1686);
o.silk = numberify(m[1]);
                    }
                    _yuitest_coverline("yui-core", 1688);
if (!o.android) {
                        _yuitest_coverline("yui-core", 1689);
o.android = 2.34; //Hack for desktop mode in Kindle
                        _yuitest_coverline("yui-core", 1690);
o.os = 'Android';
                    }
                    _yuitest_coverline("yui-core", 1692);
if (/Accelerated=true/.test(ua)) {
                        _yuitest_coverline("yui-core", 1693);
o.accel = true;
                    }
                }
            }

            _yuitest_coverline("yui-core", 1698);
m = ua.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/);
            _yuitest_coverline("yui-core", 1699);
if (m && m[1] && m[2]) {
                _yuitest_coverline("yui-core", 1700);
o.chrome = numberify(m[2]); // Chrome
                _yuitest_coverline("yui-core", 1701);
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("yui-core", 1702);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("yui-core", 1703);
o.mobile = 'chrome';
                }
            } else {
                _yuitest_coverline("yui-core", 1706);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("yui-core", 1707);
if (m) {
                    _yuitest_coverline("yui-core", 1708);
o.air = m[0]; // Adobe AIR 1.0 or better
                }
            }
        }

        _yuitest_coverline("yui-core", 1713);
if (!o.webkit) { // not webkit
// @todo check Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1316; fi; U; ssr)
            _yuitest_coverline("yui-core", 1715);
if (/Opera/.test(ua)) {
                _yuitest_coverline("yui-core", 1716);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("yui-core", 1717);
if (m && m[1]) {
                    _yuitest_coverline("yui-core", 1718);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("yui-core", 1720);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("yui-core", 1721);
if (m && m[1]) {
                    _yuitest_coverline("yui-core", 1722);
o.opera = numberify(m[1]); // opera 10+
                }

                _yuitest_coverline("yui-core", 1725);
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("yui-core", 1726);
o.mobile = 'opera';
                    _yuitest_coverline("yui-core", 1727);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("yui-core", 1728);
if (m && m[1]) {
                        _yuitest_coverline("yui-core", 1729);
o.opera = numberify(m[1]);
                    }
                }
                _yuitest_coverline("yui-core", 1732);
m = ua.match(/Opera Mini[^;]*/);

                _yuitest_coverline("yui-core", 1734);
if (m) {
                    _yuitest_coverline("yui-core", 1735);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("yui-core", 1738);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("yui-core", 1739);
if (m && m[1]) {
                    _yuitest_coverline("yui-core", 1740);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("yui-core", 1742);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("yui-core", 1743);
if (m) {
                        _yuitest_coverline("yui-core", 1744);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("yui-core", 1745);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("yui-core", 1746);
if (m && m[1]) {
                            _yuitest_coverline("yui-core", 1747);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("yui-core", 1756);
if (!subUA) {

        _yuitest_coverline("yui-core", 1758);
if (typeof process == 'object') {

            _yuitest_coverline("yui-core", 1760);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("yui-core", 1762);
o.os = process.platform;
                _yuitest_coverline("yui-core", 1763);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("yui-core", 1767);
YUI.Env.UA = o;

    }

    _yuitest_coverline("yui-core", 1771);
return o;
};


_yuitest_coverline("yui-core", 1775);
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("yui-core", 1797);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("yui-core", "compareVersions", 1797);
_yuitest_coverline("yui-core", 1798);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("yui-core", 1800);
if (a === b) {
        _yuitest_coverline("yui-core", 1801);
return 0;
    }

    _yuitest_coverline("yui-core", 1804);
aParts = (a + '').split('.');
    _yuitest_coverline("yui-core", 1805);
bParts = (b + '').split('.');

    _yuitest_coverline("yui-core", 1807);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("yui-core", 1808);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("yui-core", 1809);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("yui-core", 1811);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("yui-core", 1812);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("yui-core", 1814);
if (aPart < bPart) {
            _yuitest_coverline("yui-core", 1815);
return -1;
        }

        _yuitest_coverline("yui-core", 1818);
if (aPart > bPart) {
            _yuitest_coverline("yui-core", 1819);
return 1;
        }
    }

    _yuitest_coverline("yui-core", 1823);
return 0;
};
_yuitest_coverline("yui-core", 1825);
YUI.Env.aliases = {
