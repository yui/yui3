 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 2744);
YUITest.ComparisonFailure = function (message, expected, actual){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ComparisonFailure", 2744);
...
this.actual = actual;
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 2768);
...
//restore constructor
_yuitest_coverline("/build/test/test.js", 2776);
...
YUITest.ComparisonFailure.prototype.getMessage = function(){
    _yuitest_coverfunc("/build/test/test.js", "getMessage", 2784);
_yuitest_coverline("/build/test/test.js", 2785);
return this.message + "\nExpected: " + this.expected + " (" + (typeof this.expected) + ")"  +
 ...
 * @static
 */
_yuitest_coverline("/build/test/test.js", 2795);
YUITest.CoverageFormat = {
    ...
    JSON: function(coverage){
        _yuitest_coverfunc("/build/test/test.js", "JSON", 2805);
_yuitest_coverline("/build/test/test.js", 2806);
return YUITest.Util.JSON.stringify(coverage);
    ...
    XdebugJSON: function(coverage){
        ...
        _yuitest_coverfunc("/build/test/test.js", "XdebugJSON", 2819);
...
if (coverage.hasOwnProperty(prop)){
                _yuitest_coverline("/build/test/test.js", 2824);
...
_yuitest_coverline("/build/test/test.js", 2843);
YUITest.DateAssert = {
    ...
    datesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("/build/test/test.js", "datesAreEqual", 2853);
_yuitest_coverline("/build/test/test.js", 2854);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 2855);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("/build/test/test.js", 2856);
var msg = "";
...
throw new TypeError("YUITest.DateAssert.datesAreEqual(): Expected and actual values must be Date objects.");
    ...
    timesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("/build/test/test.js", "timesAreEqual", 2889);
_yuitest_coverline("/build/test/test.js", 2890);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2891);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("/build/test/test.js", 2892);
var msg = "";
...
YUITest.Mock = function(template){
    ...
    _yuitest_coverfunc("/build/test/test.js", "Mock", 2927);
...
try {
        _yuitest_coverline("/build/test/test.js", 2938);
function f(){}
...
mock[name] = function(name){
                    _yuitest_coverfunc("/build/test/test.js", "]", 2949);
_yuitest_coverline("/build/test/test.js", 2950);
return function(){
                        _yuitest_coverfunc("/build/test/test.js", "(anonymous 11)", 2950);
...
YUITest.Assert.fail("Method " + name + "() was called but was not expected to be.");
    ...
    //return it
    _yuitest_coverline("/build/test/test.js", 2959);
return mock;    
};
...
YUITest.Mock.expect = function(mock /*:Object*/, expectation /*:Object*/){
    ...
    _yuitest_coverfunc("/build/test/test.js", "expect", 2982);
...
if (expectation.method){
        _yuitest_coverline("/build/test/test.js", 2991);
...
mock.__expectations[name] = expectation;
        _yuitest_coverline("/build/test/test.js", 3002);
...
mock[name] = function(){   
                _yuitest_coverfunc("/build/test/test.js", "]", 3014);
...
runResult = run.apply(this, arguments);
                    ...
                    _yuitest_coverline("/build/test/test.js", 3024);
if (error){
...
return expectation.hasOwnProperty('returns') ? result : runResult;
            ...
            _yuitest_coverline("/build/test/test.js", 3039);
mock[name] = function(){
                _yuitest_coverfunc("/build/test/test.js", "]", 3039);
_yuitest_coverline("/build/test/test.js", 3040);
try {
...
YUITest.TestRunner._handleError(ex);
    ...
    } else {_yuitest_coverline("/build/test/test.js", 3048);
if (expectation.property){
        //save expectations
        _yuitest_coverline("/build/test/test.js", 3050);
...
YUITest.Mock.verify = function(mock){    
    _yuitest_coverfunc("/build/test/test.js", "verify", 3062);
...
YUITest.Assert.areEqual(expectation.callCount, expectation.actualCallCount, "Method " + expectation.method + "() wasn't called the expected number of times.");
                } else {_yuitest_coverline("/build/test/test.js", 3070);
if (expectation.property){
...
YUITest.Assert.areEqual(expectation.value, mock[expectation.property], "Property " + expectation.property + " wasn't set to the correct value."); 
        ...
        //route through TestRunner for proper handling
        _yuitest_coverline("/build/test/test.js", 3078);
YUITest.TestRunner._handleError(ex);
    }
};
...
YUITest.Mock.Value = function(method, originalArgs, message){
    _yuitest_coverfunc("/build/test/test.js", "Value", 3092);
...
this.verify = function(value){
            _yuitest_coverfunc("/build/test/test.js", "verify", 3094);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3111);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3119);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3127);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3135);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3143);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3151);
 ...
 * @static
 */
_yuitest_coverline("/build/test/test.js", 3161);
YUITest.ObjectAssert = {
     ...
     */
    areEqual: function(expected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "areEqual", 3173);
_yuitest_coverline("/build/test/test.js", 3174);
YUITest.Assert._increment();         
        
        _yuitest_coverline("/build/test/test.js", 3176);
...
for (var name in expected){
            _yuitest_coverline("/build/test/test.js", 3186);
if (expected.hasOwnProperty(name)){
                _yuitest_coverline("/build/test/test.js", 3187);
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be equal for property " + name), expected[name], actual[name]);
    ...
    hasKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "hasKey", 3203);
_yuitest_coverline("/build/test/test.js", 3204);
YUITest.ObjectAssert.ownsOrInheritsKey(propertyName, object, message);   
    ...
    hasKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "hasKeys", 3216);
_yuitest_coverline("/build/test/test.js", 3217);
YUITest.ObjectAssert.ownsOrInheritsKeys(properties, object, message);
    ...
    inheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "inheritsKey", 3228);
_yuitest_coverline("/build/test/test.js", 3229);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3230);
if (!(propertyName in object && !object.hasOwnProperty(propertyName))){
            _yuitest_coverline("/build/test/test.js", 3231);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
    ...
    inheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "inheritsKeys", 3243);
_yuitest_coverline("/build/test/test.js", 3244);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 3245);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3246);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
    ...
    ownsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsKey", 3260);
_yuitest_coverline("/build/test/test.js", 3261);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3262);
if (!object.hasOwnProperty(propertyName)){
            _yuitest_coverline("/build/test/test.js", 3263);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
        }     
    },
    ...
    ownsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsKeys", 3275);
_yuitest_coverline("/build/test/test.js", 3276);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 3277);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3278);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
    ...
    ownsNoKeys : function (object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsNoKeys", 3291);
...
if (count !== 0){
            _yuitest_coverline("/build/test/test.js", 3302);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Object owns " + count + " properties but should own none."));        
    ...
    ownsOrInheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsOrInheritsKey", 3315);
_yuitest_coverline("/build/test/test.js", 3316);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3317);
if (!(propertyName in object)){
            _yuitest_coverline("/build/test/test.js", 3318);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object."));
    ...
    ownsOrInheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsOrInheritsKeys", 3330);
_yuitest_coverline("/build/test/test.js", 3331);
YUITest.Assert._increment();  
        _yuitest_coverline("/build/test/test.js", 3332);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3333);
...
YUITest.Results = function(name){
     ...
     * @property name
     */
    _yuitest_coverfunc("/build/test/test.js", "Results", 3349);
...
this.total = 0;
     ...
     * @property duration
     */
    _yuitest_coverline("/build/test/test.js", 3398);
this.duration = 0;
}
...
YUITest.Results.prototype.include = function(results){
    _yuitest_coverfunc("/build/test/test.js", "include", 3407);
...
YUITest.ShouldError = function (message){
    ...
    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ShouldError", 3425);
...
YUITest.AssertionError.call(this, message || "This test should have thrown an error but didn't.");
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 3435);
...
YUITest.ShouldFail = function (message){
    ...
    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ShouldFail", 3455);
...
YUITest.AssertionError.call(this, message || "This test should fail but didn't.");
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 3465);
...
YUITest.UnexpectedError = function (cause){
    ...
    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "UnexpectedError", 3487);
...
this.name = "UnexpectedError";
     ...
     * @property stack
     */
    _yuitest_coverline("/build/test/test.js", 3511);
...
YUITest.UnexpectedValue = function (message, unexpected){
    ...
    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "UnexpectedValue", 3534);
...
this.unexpected = unexpected;
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 3551);
 ...
 * @return {String} A string describing the error.
 */
_yuitest_coverline("/build/test/test.js", 3567);
YUITest.UnexpectedValue.prototype.getMessage = function(){
    _yuitest_coverfunc("/build/test/test.js", "getMessage", 3567);
_yuitest_coverline("/build/test/test.js", 3568);
...
YUITest.Wait = function (segment, delay) {
     ...
     * @property segment
     */
    _yuitest_coverfunc("/build/test/test.js", "Wait", 3582);
...
Y.Object.each(YUITest, function(item, name) {
    _yuitest_coverfunc("/build/test/test.js", "(anonymous 14)", 3602);
...
Y.Test.ArrayAssert.itemsAreEqual = function(expected, actual, message) {
    _yuitest_coverfunc("/build/test/test.js", "itemsAreEqual", 3621);
...
Y.assert = function(condition, message){
    _yuitest_coverfunc("/build/test/test.js", "assert", 3635);
_yuitest_coverline("/build/test/test.js", 3636);
Y.Assert._increment();
    _yuitest_coverline("/build/test/test.js", 3637);
if (!condition){
...
Y.Test.Runner.disableLogging = function() {
    _yuitest_coverfunc("/build/test/test.js", "disableLogging", 3653);
...
Y.Test.Runner.enableLogging = function() {
    _yuitest_coverfunc("/build/test/test.js", "enableLogging", 3657);
...
var logEvent = function(event) {
        ...
        //data variables
        _yuitest_coverfunc("/build/test/test.js", "logEvent", 3677);
