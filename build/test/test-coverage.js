...
_yuitest_coverline("/build/test/test.js", 25);
Y.namespace('Test');


//Using internal YUI methods here
_yuitest_coverline("/build/test/test.js", 29);
YUITest.Object = Y.Object;
_yuitest_coverline("/build/test/test.js", 30);
YUITest.Array = Y.Array;
_yuitest_coverline("/build/test/test.js", 31);
YUITest.Util = {
    mix: Y.mix,
    JSON: Y.JSON
};
 ...
 * @constructor
 */
_yuitest_coverline("/build/test/test.js", 43);
YUITest.EventTarget = function(){
     ...
     * @static
     */
    _yuitest_coverfunc("/build/test/test.js", "EventTarget", 43);
_yuitest_coverline("/build/test/test.js", 52);
this._handlers = {};

};
    
_yuitest_coverline("/build/test/test.js", 56);
YUITest.EventTarget.prototype = {
    ...
    attach: function(type, listener){
        _yuitest_coverfunc("/build/test/test.js", "attach", 72);
_yuitest_coverline("/build/test/test.js", 73);
if (typeof this._handlers[type] == "undefined"){
            _yuitest_coverline("/build/test/test.js", 74);
this._handlers[type] = [];
        }
...
this._handlers[type].push(listener);
    ...
    subscribe: function(type, listener){
        _yuitest_coverfunc("/build/test/test.js", "subscribe", 88);
_yuitest_coverline("/build/test/test.js", 89);
this.attach.apply(this, arguments);
     ...
     */    
    fire: function(event){
        _yuitest_coverfunc("/build/test/test.js", "fire", 99);
_yuitest_coverline("/build/test/test.js", 100);
if (typeof event == "string"){
            _yuitest_coverline("/build/test/test.js", 101);
event = { type: event };
        }
...
if (!event.type){
            _yuitest_coverline("/build/test/test.js", 108);
...
handlers[i].call(this, event);
    ...
    detach: function(type, listener){
        _yuitest_coverfunc("/build/test/test.js", "detach", 126);
_yuitest_coverline("/build/test/test.js", 127);
if (this._handlers[type] instanceof Array){
            _yuitest_coverline("/build/test/test.js", 128);
var handlers = this._handlers[type];
            _yuitest_coverline("/build/test/test.js", 129);
for (var i=0, len=handlers.length; i < len; i++){
...
break;
    ...
    unsubscribe: function(type, listener){
        _yuitest_coverfunc("/build/test/test.js", "unsubscribe", 146);
_yuitest_coverline("/build/test/test.js", 147);
 ...
 * @constructor
 */
_yuitest_coverline("/build/test/test.js", 162);
YUITest.TestSuite = function (data) {
     ...
     * @property name
     */
    _yuitest_coverfunc("/build/test/test.js", "TestSuite", 162);
_yuitest_coverline("/build/test/test.js", 169);
this.name = "";
     ...
     * @private
     */
    _yuitest_coverline("/build/test/test.js", 177);
this.items = [];

    //initialize the properties
    _yuitest_coverline("/build/test/test.js", 180);
if (typeof data == "string"){
        _yuitest_coverline("/build/test/test.js", 181);
this.name = data;
    } else {_yuitest_coverline("/build/test/test.js", 182);
if (data instanceof Object){
        _yuitest_coverline("/build/test/test.js", 183);
for (var prop in data){
            _yuitest_coverline("/build/test/test.js", 184);
if (data.hasOwnProperty(prop)){
                _yuitest_coverline("/build/test/test.js", 185);
this[prop] = data[prop];
            }
        }
    }}
    ...
    //double-check name
    _yuitest_coverline("/build/test/test.js", 191);
if (this.name === ""){
...
_yuitest_coverline("/build/test/test.js", 197);
YUITest.TestSuite.prototype = {
    ...
    add : function (testObject) {
        _yuitest_coverfunc("/build/test/test.js", "add", 208);
_yuitest_coverline("/build/test/test.js", 209);
if (testObject instanceof YUITest.TestSuite || testObject instanceof YUITest.TestCase) {
            _yuitest_coverline("/build/test/test.js", 210);
 ...
 * @constructor
 */
_yuitest_coverline("/build/test/test.js", 245);
YUITest.TestCase = function (template) {
     ...
     */
    _yuitest_coverfunc("/build/test/test.js", "TestCase", 245);
_yuitest_coverline("/build/test/test.js", 252);
this._should = {};
    
    //copy over all properties from the template to this object
    _yuitest_coverline("/build/test/test.js", 255);
for (var prop in template) {
        _yuitest_coverline("/build/test/test.js", 256);
this[prop] = template[prop];
    }    
    
    //check for a valid name
    _yuitest_coverline("/build/test/test.js", 260);
...
YUITest.TestCase.prototype = {  
     ...
     */
    callback: function(){
        _yuitest_coverfunc("/build/test/test.js", "callback", 278);
...
return YUITest.TestRunner.callback.apply(YUITest.TestRunner,arguments);
     ...
     */
    resume : function (segment) {
        _yuitest_coverfunc("/build/test/test.js", "resume", 289);
_yuitest_coverline("/build/test/test.js", 290);
YUITest.TestRunner.resume(segment);
    ...
    wait : function (segment, delay){
        ...
        _yuitest_coverfunc("/build/test/test.js", "wait", 303);
_yuitest_coverline("/build/test/test.js", 305);
var actualDelay = (typeof segment == "number" ? segment : delay);
        _yuitest_coverline("/build/test/test.js", 306);
actualDelay = (typeof actualDelay == "number" ? actualDelay : 10000);
    
		_yuitest_coverline("/build/test/test.js", 308);
if (typeof segment == "function"){
            _yuitest_coverline("/build/test/test.js", 309);
throw new YUITest.Wait(segment, actualDelay);
        } else {
            _yuitest_coverline("/build/test/test.js", 311);
throw new YUITest.Wait(function(){
                _yuitest_coverfunc("/build/test/test.js", "(anonymous 2)", 311);
...
YUITest.Assert.fail("Timeout: wait() called but resume() never called.");
    ...
    assert : function (condition, message){
        _yuitest_coverfunc("/build/test/test.js", "assert", 328);
_yuitest_coverline("/build/test/test.js", 329);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 330);
if (!condition){
            _yuitest_coverline("/build/test/test.js", 331);
throw new YUITest.AssertionError(YUITest.Assert._formatMessage(message, "Assertion failed."));
    ...
    fail: function (message) {    
        _yuitest_coverfunc("/build/test/test.js", "fail", 340);
_yuitest_coverline("/build/test/test.js", 341);
 ...
 * @static
 */
_yuitest_coverline("/build/test/test.js", 391);
YUITest.TestFormat = function(){
     ...
     */
    _yuitest_coverfunc("/build/test/test.js", "TestFormat", 391);
_yuitest_coverline("/build/test/test.js", 399);
function xmlEscape(text){
    
        _yuitest_coverfunc("/build/test/test.js", "xmlEscape", 399);
_yuitest_coverline("/build/test/test.js", 401);
return text.replace(/[<>"'&]/g, function(value){
            _yuitest_coverfunc("/build/test/test.js", "(anonymous 3)", 401);
_yuitest_coverline("/build/test/test.js", 402);
switch(value){
                case "<":   _yuitest_coverline("/build/test/test.js", 403);
return "&lt;";
                case ">":   _yuitest_coverline("/build/test/test.js", 404);
return "&gt;";
                case "\"":  _yuitest_coverline("/build/test/test.js", 405);
return "&quot;";
                case "'":   _yuitest_coverline("/build/test/test.js", 406);
return "&apos;";
                case "&":   _yuitest_coverline("/build/test/test.js", 407);
return "&amp;";
            }
        });
...
return {
        ...
        JSON: function(results) {
            _yuitest_coverfunc("/build/test/test.js", "JSON", 423);
_yuitest_coverline("/build/test/test.js", 424);
return YUITest.Util.JSON.stringify(results);
        ...
        XML: function(results) {
            ...
            _yuitest_coverfunc("/build/test/test.js", "XML", 434);
_yuitest_coverline("/build/test/test.js", 436);
function serializeToXML(results){
                _yuitest_coverfunc("/build/test/test.js", "serializeToXML", 436);
_yuitest_coverline("/build/test/test.js", 437);
var xml = "<" + results.type + " name=\"" + xmlEscape(results.name) + "\"";
                
                _yuitest_coverline("/build/test/test.js", 439);
if (typeof(results.duration)=="number"){
                    _yuitest_coverline("/build/test/test.js", 440);
...
for (var prop in results){
                        _yuitest_coverline("/build/test/test.js", 448);
...
xml += "</" + results.type + ">";
                ...
                _yuitest_coverline("/build/test/test.js", 458);
return xml;    
            }
...
return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + serializeToXML(results);
        ...
        JUnitXML: function(results) {
            ...
            _yuitest_coverfunc("/build/test/test.js", "JUnitXML", 473);
_yuitest_coverline("/build/test/test.js", 475);
function serializeToJUnitXML(results){
                _yuitest_coverfunc("/build/test/test.js", "serializeToJUnitXML", 475);
_yuitest_coverline("/build/test/test.js", 476);
var xml = "";
                    
                _yuitest_coverline("/build/test/test.js", 478);
switch (results.type){
                    //equivalent to testcase in JUnit
                    case "test":
                        _yuitest_coverline("/build/test/test.js", 481);
...
if (results.result == "fail"){
                                _yuitest_coverline("/build/test/test.js", 484);
xml += "<failure message=\"" + xmlEscape(results.message) + "\"><![CDATA[" + results.message + "]]></failure>";
                            }
                            _yuitest_coverline("/build/test/test.js", 486);
xml+= "</testcase>";
                        }
...
if (results[prop] && typeof results[prop] == "object" && !(results[prop] instanceof Array)){
                                    _yuitest_coverline("/build/test/test.js", 498);
...
break;
                    ...
                    case "report":
                        ...
                        _yuitest_coverline("/build/test/test.js", 520);
xml = "<testsuites>";
...
if (results[prop] && typeof results[prop] == "object" && !(results[prop] instanceof Array)){
                                    _yuitest_coverline("/build/test/test.js", 525);
xml += serializeToJUnitXML(results[prop]);
                                }
                            }
                        }            
...
return xml;
            ...
            _yuitest_coverline("/build/test/test.js", 539);
return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + serializeToJUnitXML(results);
        ...
        TAP: function(results) {
            ...
            _yuitest_coverfunc("/build/test/test.js", "TAP", 550);
_yuitest_coverline("/build/test/test.js", 552);
var currentTestNum = 1;

            _yuitest_coverline("/build/test/test.js", 554);
function serializeToTAP(results){
                _yuitest_coverfunc("/build/test/test.js", "serializeToTAP", 554);
_yuitest_coverline("/build/test/test.js", 555);
var text = "";
                    
                _yuitest_coverline("/build/test/test.js", 557);
switch (results.type){

                    case "test":
                        _yuitest_coverline("/build/test/test.js", 560);
if (results.result != "ignore"){
...
break;
                    ...
                    case "testcase":
                        ...
                        _yuitest_coverline("/build/test/test.js", 576);
...
if (results.hasOwnProperty(prop)){
                                _yuitest_coverline("/build/test/test.js", 580);
if (results[prop] && typeof results[prop] == "object" && !(results[prop] instanceof Array)){
...
text = "#Begin testsuite " + results.name + "(" + results.failed + " failed of " + results.total + ")\n";                
                        ...
                        _yuitest_coverline("/build/test/test.js", 595);
for (var prop in results){
                            _yuitest_coverline("/build/test/test.js", 596);
if (results.hasOwnProperty(prop)){
                                _yuitest_coverline("/build/test/test.js", 597);
if (results[prop] && typeof results[prop] == "object" && !(results[prop] instanceof Array)){
                                    _yuitest_coverline("/build/test/test.js", 598);
text += serializeToTAP(results[prop]);
                                }
                            }
                        }                                                      
...
text += serializeToTAP(results[prop]);
                ...
                _yuitest_coverline("/build/test/test.js", 619);
return text;
 ...
 * @class Reporter
     */
    _yuitest_coverline("/build/test/test.js", 639);
YUITest.Reporter = function(url, format) {
         ...
         * @property url
         */
        _yuitest_coverfunc("/build/test/test.js", "Reporter", 639);
...
this.format = format || YUITest.TestFormat.XML;
         ...
         * @private
         */
        _yuitest_coverline("/build/test/test.js", 661);
this._fields = new Object();
         ...
         * @private
         */
        _yuitest_coverline("/build/test/test.js", 669);
this._form = null;
         ...
         * @private
         */
        _yuitest_coverline("/build/test/test.js", 677);
this._iframe = null;
    };
    
    _yuitest_coverline("/build/test/test.js", 680);
YUITest.Reporter.prototype = {
        ...
        addField : function (name, value){
            _yuitest_coverfunc("/build/test/test.js", "addField", 692);
...
this._fields[name] = value;    
        ...
        clearFields : function(){
            _yuitest_coverfunc("/build/test/test.js", "clearFields", 701);
_yuitest_coverline("/build/test/test.js", 702);
this._fields = new Object();
        },
         ...
         */
        destroy : function() {
            _yuitest_coverfunc("/build/test/test.js", "destroy", 711);
_yuitest_coverline("/build/test/test.js", 712);
if (this._form){
                _yuitest_coverline("/build/test/test.js", 713);
this._form.parentNode.removeChild(this._form);
                _yuitest_coverline("/build/test/test.js", 714);
this._form = null;
            }        
            _yuitest_coverline("/build/test/test.js", 716);
if (this._iframe){
                _yuitest_coverline("/build/test/test.js", 717);
this._iframe.parentNode.removeChild(this._iframe);
                _yuitest_coverline("/build/test/test.js", 718);
this._iframe = null;
            }
...
this._fields = null;
        ...
        report : function(results){
            ...
            _yuitest_coverfunc("/build/test/test.js", "report", 729);
_yuitest_coverline("/build/test/test.js", 732);
if (!this._form){
                _yuitest_coverline("/build/test/test.js", 733);
this._form = document.createElement("form");
                _yuitest_coverline("/build/test/test.js", 734);
this._form.method = "post";
                _yuitest_coverline("/build/test/test.js", 735);
this._form.style.visibility = "hidden";
                _yuitest_coverline("/build/test/test.js", 736);
this._form.style.position = "absolute";
                _yuitest_coverline("/build/test/test.js", 737);
this._form.style.top = 0;
                _yuitest_coverline("/build/test/test.js", 738);
...
this._form.removeChild(this._form.lastChild);
            ...
            _yuitest_coverline("/build/test/test.js", 766);
...
for (var prop in this._fields){
                _yuitest_coverline("/build/test/test.js", 772);
...
input.type = "hidden";
                    _yuitest_coverline("/build/test/test.js", 776);
input.name = prop;
                    _yuitest_coverline("/build/test/test.js", 777);
input.value = value;
 ...
 * @class TestRunner
     * @static
     */
    _yuitest_coverline("/build/test/test.js", 803);
YUITest.TestRunner = function(){
         ...
         */
        _yuitest_coverfunc("/build/test/test.js", "TestRunner", 803);
_yuitest_coverline("/build/test/test.js", 812);
function inGroups(testGroups, filter){
            _yuitest_coverfunc("/build/test/test.js", "inGroups", 812);
_yuitest_coverline("/build/test/test.js", 813);
if (!filter.length){
                _yuitest_coverline("/build/test/test.js", 814);
return true;
            } else {                
                _yuitest_coverline("/build/test/test.js", 816);
if (testGroups){
                    _yuitest_coverline("/build/test/test.js", 817);
for (var i=0, len=testGroups.length; i < len; i++){
                        _yuitest_coverline("/build/test/test.js", 818);
...
function TestNode(testObject){
             ...
             * @property testObject
             */
            _yuitest_coverfunc("/build/test/test.js", "TestNode", 836);
...
this.results = new YUITest.Results();
            ...
            //initialize results
            _yuitest_coverline("/build/test/test.js", 881);
if (testObject instanceof YUITest.TestSuite){
                _yuitest_coverline("/build/test/test.js", 882);
this.results.type = "testsuite";
                _yuitest_coverline("/build/test/test.js", 883);
this.results.name = testObject.name;
            } else {_yuitest_coverline("/build/test/test.js", 884);
if (testObject instanceof YUITest.TestCase){
                _yuitest_coverline("/build/test/test.js", 885);
this.results.type = "testcase";
                _yuitest_coverline("/build/test/test.js", 886);
this.results.name = testObject.name;
            }}
...
TestNode.prototype = {
            ...
            appendChild : function (testObject){
                _yuitest_coverfunc("/build/test/test.js", "appendChild", 900);
_yuitest_coverline("/build/test/test.js", 901);
var node = new TestNode(testObject);
                _yuitest_coverline("/build/test/test.js", 902);
if (this.firstChild === null){
                    _yuitest_coverline("/build/test/test.js", 903);
this.firstChild = this.lastChild = node;
                } else {
                    _yuitest_coverline("/build/test/test.js", 905);
this.lastChild.next = node;
                    _yuitest_coverline("/build/test/test.js", 906);
this.lastChild = node;
                }
...
function TestRunner(){
            ...
            _yuitest_coverfunc("/build/test/test.js", "TestRunner", 921);
_yuitest_coverline("/build/test/test.js", 924);
YUITest.EventTarget.call(this);
             ...
             * @private
             */
            _yuitest_coverline("/build/test/test.js", 933);
this.masterSuite = new YUITest.TestSuite("yuitests" + (new Date()).getTime());        
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 942);
this._cur = null;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 951);
this._root = null;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 960);
this._log = true;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 970);
this._waiting = false;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 979);
this._running = false;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 989);
this._lastResults = null;       
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 998);
this._context = null;
             ...
             * @static
             */
            _yuitest_coverline("/build/test/test.js", 1009);
this._groups = "";

        }
        
        _yuitest_coverline("/build/test/test.js", 1013);
TestRunner.prototype = YUITest.Util.mix(new YUITest.EventTarget(), {
           ...
           _addTestCaseToTestTree : function (parentNode, testCase){
                ...
                //add the test suite
                _yuitest_coverfunc("/build/test/test.js", "_addTestCaseToTestTree", 1117);
_yuitest_coverline("/build/test/test.js", 1120);
var node = parentNode.appendChild(testCase),
                    prop,
                    testName;
                
                //iterate over the items in the test case
                _yuitest_coverline("/build/test/test.js", 1125);
for (prop in testCase){
                    _yuitest_coverline("/build/test/test.js", 1126);
...
node.appendChild(prop);
            ...
            _addTestSuiteToTestTree : function (parentNode, testSuite) {
                ...
                //add the test suite
                _yuitest_coverfunc("/build/test/test.js", "_addTestSuiteToTestTree", 1142);
_yuitest_coverline("/build/test/test.js", 1145);
var node = parentNode.appendChild(testSuite);
                
                //iterate over the items in the master suite
                _yuitest_coverline("/build/test/test.js", 1148);
for (var i=0; i < testSuite.items.length; i++){
                    _yuitest_coverline("/build/test/test.js", 1149);
if (testSuite.items[i] instanceof YUITest.TestSuite) {
                        _yuitest_coverline("/build/test/test.js", 1150);
this._addTestSuiteToTestTree(node, testSuite.items[i]);
                    } else {_yuitest_coverline("/build/test/test.js", 1151);
...
this._addTestCaseToTestTree(node, testSuite.items[i]);
            ...
            _buildTestTree : function () {
                ...
                _yuitest_coverfunc("/build/test/test.js", "_buildTestTree", 1166);
_yuitest_coverline("/build/test/test.js", 1168);
this._root = new TestNode(this.masterSuite);
                //this._cur = this._root;
                
                //iterate over the items in the master suite
                _yuitest_coverline("/build/test/test.js", 1172);
for (var i=0; i < this.masterSuite.items.length; i++){
                    _yuitest_coverline("/build/test/test.js", 1173);
if (this.masterSuite.items[i] instanceof YUITest.TestSuite) {
                        _yuitest_coverline("/build/test/test.js", 1174);
this._addTestSuiteToTestTree(this._root, this.masterSuite.items[i]);
                    } else {_yuitest_coverline("/build/test/test.js", 1175);
if (this.masterSuite.items[i] instanceof YUITest.TestCase) {
                        _yuitest_coverline("/build/test/test.js", 1176);
this._addTestCaseToTestTree(this._root, this.masterSuite.items[i]);
            ...
            _handleTestObjectComplete : function (node) {
                _yuitest_coverfunc("/build/test/test.js", "_handleTestObjectComplete", 1194);
_yuitest_coverline("/build/test/test.js", 1195);
var parentNode;
                
                _yuitest_coverline("/build/test/test.js", 1197);
if (node && (typeof node.testObject == "object")) {
                    _yuitest_coverline("/build/test/test.js", 1198);
parentNode = node.parent;
                
                    _yuitest_coverline("/build/test/test.js", 1200);
if (parentNode){
                        _yuitest_coverline("/build/test/test.js", 1201);
...
if (node.testObject instanceof YUITest.TestSuite){
                        _yuitest_coverline("/build/test/test.js", 1206);
...
this.fire({ type: this.TEST_SUITE_COMPLETE_EVENT, testSuite: node.testObject, results: node.results});
                    } else {_yuitest_coverline("/build/test/test.js", 1209);
...
this.fire({ type: this.TEST_CASE_COMPLETE_EVENT, testCase: node.testObject, results: node.results});
            ...
            _next : function () {
                ...
                _yuitest_coverfunc("/build/test/test.js", "_next", 1228);
_yuitest_coverline("/build/test/test.js", 1230);
if (this._cur === null){
                    _yuitest_coverline("/build/test/test.js", 1231);
this._cur = this._root;
                } else {_yuitest_coverline("/build/test/test.js", 1232);
if (this._cur.firstChild) {
                    _yuitest_coverline("/build/test/test.js", 1233);
this._cur = this._cur.firstChild;
                } else {_yuitest_coverline("/build/test/test.js", 1234);
if (this._cur.next) {
                    _yuitest_coverline("/build/test/test.js", 1235);
...
this._handleTestObjectComplete(this._cur);
                        _yuitest_coverline("/build/test/test.js", 1239);
...
this._cur.results.timestamp = (new Date()).toLocaleString();
                        _yuitest_coverline("/build/test/test.js", 1247);
...
this._cur = null;
                    } else {_yuitest_coverline("/build/test/test.js", 1252);
if (this._cur) {
...
return this._cur;
            ...
            _execNonTestMethod: function(node, methodName, allowAsync){
                _yuitest_coverfunc("/build/test/test.js", "_execNonTestMethod", 1271);
_yuitest_coverline("/build/test/test.js", 1272);
var testObject = node.testObject,
                    event = { type: this.ERROR_EVENT };
                _yuitest_coverline("/build/test/test.js", 1274);
try {
                    _yuitest_coverline("/build/test/test.js", 1275);
if (allowAsync && testObject["async:" + methodName]){
                        _yuitest_coverline("/build/test/test.js", 1276);
testObject["async:" + methodName](this._context);
                        _yuitest_coverline("/build/test/test.js", 1277);
return true;
                    } else {
...
this.fire(event);
                ...
                _yuitest_coverline("/build/test/test.js", 1294);
return false;
            },
            ...
            _run : function () {
                ...
                _yuitest_coverfunc("/build/test/test.js", "_run", 1305);
_yuitest_coverline("/build/test/test.js", 1308);
var shouldWait = false;
                
                //get the next test node
                _yuitest_coverline("/build/test/test.js", 1311);
var node = this._next();
                
                _yuitest_coverline("/build/test/test.js", 1313);
if (node !== null) {
                
                    //set flag to say the testrunner is running
                    _yuitest_coverline("/build/test/test.js", 1316);
this._running = true;
                    
                    //eliminate last results
                    _yuitest_coverline("/build/test/test.js", 1319);
...
node._start = new Date();
                            ...
                            _yuitest_coverline("/build/test/test.js", 1345);
if(this._execNonTestMethod(node, "init", true)){
                                _yuitest_coverline("/build/test/test.js", 1346);
return;
                            }
                        }}
                        
                        //some environments don't support setTimeout
                        _yuitest_coverline("/build/test/test.js", 1351);
if (typeof setTimeout != "undefined"){                    
                            _yuitest_coverline("/build/test/test.js", 1352);
setTimeout(function(){
                                _yuitest_coverfunc("/build/test/test.js", "(anonymous 4)", 1352);
_yuitest_coverline("/build/test/test.js", 1353);
YUITest.TestRunner._run();
                            }, 0);
                        } else {
                            _yuitest_coverline("/build/test/test.js", 1356);
this._run();
                        }
                    } else {
...
this._runTest(node);
            ...
            _resumeTest : function (segment) {
                ...
                //get relevant information
                _yuitest_coverfunc("/build/test/test.js", "_resumeTest", 1365);
_yuitest_coverline("/build/test/test.js", 1368);
var node = this._cur;                
                
                //we know there's no more waiting now
                _yuitest_coverline("/build/test/test.js", 1371);
this._waiting = false;
                
                //if there's no node, it probably means a wait() was called after resume()
                _yuitest_coverline("/build/test/test.js", 1374);
if (!node){
...
var shouldError = (testCase._should.error || {})[testName];
                ...
                _yuitest_coverline("/build/test/test.js", 1396);
var failed = false;
                _yuitest_coverline("/build/test/test.js", 1397);
var error = null;
...
throw new YUITest.AssertionError("Test has no asserts.");
                    ...
                    //if it should fail, and it got here, then it's a fail because it didn't
                     else {_yuitest_coverline("/build/test/test.js", 1410);
if (shouldFail){
                        _yuitest_coverline("/build/test/test.js", 1411);
error = new YUITest.ShouldFail();
                        _yuitest_coverline("/build/test/test.js", 1412);
failed = true;
                    } else {_yuitest_coverline("/build/test/test.js", 1413);
if (shouldError){
                        _yuitest_coverline("/build/test/test.js", 1414);
error = new YUITest.ShouldError();
                        _yuitest_coverline("/build/test/test.js", 1415);
failed = true;
                    }}}
...
clearTimeout(testCase.__yui_wait);
                        _yuitest_coverline("/build/test/test.js", 1423);
delete testCase.__yui_wait;
                    }                    
...
failed = true;
                    ...
                    } else {_yuitest_coverline("/build/test/test.js", 1432);
...
if (typeof thrown.delay == "number"){
                                ...
                                //some environments don't support setTimeout
                                _yuitest_coverline("/build/test/test.js", 1438);
if (typeof setTimeout != "undefined"){
                                    _yuitest_coverline("/build/test/test.js", 1439);
testCase.__yui_wait = setTimeout(function(){
                                        _yuitest_coverfunc("/build/test/test.js", "(anonymous 5)", 1439);
...
this._waiting = true;
                                    ...
                                    _yuitest_coverline("/build/test/test.js", 1444);
...
error = new YUITest.UnexpectedError(thrown);
                                    _yuitest_coverline("/build/test/test.js", 1463);
failed = true;                                    
                                }
                            } else {_yuitest_coverline("/build/test/test.js", 1465);
...
failed = true;
                            ...
                            } else {_yuitest_coverline("/build/test/test.js", 1473);
...
if (!(thrown instanceof shouldError.constructor) || 
                                    ...
                                    _yuitest_coverline("/build/test/test.js", 1478);
error = new YUITest.UnexpectedError(thrown);
                                    _yuitest_coverline("/build/test/test.js", 1479);
failed = true;                                    
                                }
                ...
                _yuitest_coverline("/build/test/test.js", 1490);
if (failed) {
...
this.fire({ type: this.TEST_FAIL_EVENT, testCase: testCase, testName: testName, error: error });
                    ...
                    _yuitest_coverline("/build/test/test.js", 1493);
...
node.parent.results[testName] = { 
                ...
                _yuitest_coverline("/build/test/test.js", 1514);
if (failed){
                    _yuitest_coverline("/build/test/test.js", 1515);
node.parent.results.failed++;
                } else {
                    _yuitest_coverline("/build/test/test.js", 1517);
...
if (typeof setTimeout != "undefined"){
                    _yuitest_coverline("/build/test/test.js", 1523);
setTimeout(function(){
                        _yuitest_coverfunc("/build/test/test.js", "(anonymous 6)", 1523);
...
this._run();
            ...
            _handleError: function(error){
                ...
                _yuitest_coverfunc("/build/test/test.js", "_handleError", 1545);
_yuitest_coverline("/build/test/test.js", 1547);
if (this._waiting){
                    _yuitest_coverline("/build/test/test.js", 1548);
this._resumeTest(function(){
                        _yuitest_coverfunc("/build/test/test.js", "(anonymous 7)", 1548);
_yuitest_coverline("/build/test/test.js", 1549);
throw error;
                    });
                } else {
                    _yuitest_coverline("/build/test/test.js", 1552);
throw error;
                }           
            ...
            _runTest : function (node) {
                ...
                //get relevant information
                _yuitest_coverfunc("/build/test/test.js", "_runTest", 1565);
_yuitest_coverline("/build/test/test.js", 1568);
var testName = node.testObject,
                ...
                _yuitest_coverline("/build/test/test.js", 1578);
if (shouldIgnore){
...
node.parent.results.ignored++;
                    _yuitest_coverline("/build/test/test.js", 1589);
node.parent.results.total++;
...
setTimeout(function(){
                            _yuitest_coverfunc("/build/test/test.js", "(anonymous 8)", 1595);
_yuitest_coverline("/build/test/test.js", 1596);
YUITest.TestRunner._run();
                        }, 0);              
                    } else {
                        _yuitest_coverline("/build/test/test.js", 1599);
this._run();
                    }
                    ...
                    //mark the start time
                    _yuitest_coverline("/build/test/test.js", 1605);
node._start = new Date();
...
this._execNonTestMethod(node.parent, "setUp", false);
                    ...
                    _yuitest_coverline("/build/test/test.js", 1611);
this._resumeTest(test);                
             ...
             */
            getName: function(){
                _yuitest_coverfunc("/build/test/test.js", "getName", 1625);
_yuitest_coverline("/build/test/test.js", 1626);
return this.masterSuite.name;
            ...
            setName: function(name){
                _yuitest_coverfunc("/build/test/test.js", "setName", 1636);
_yuitest_coverline("/build/test/test.js", 1637);
this.masterSuite.name = name;
             ...
             */
            add : function (testObject) {
                _yuitest_coverfunc("/build/test/test.js", "add", 1651);
_yuitest_coverline("/build/test/test.js", 1652);
this.masterSuite.add(testObject);
                _yuitest_coverline("/build/test/test.js", 1653);
return this;
            },
             ...
             */
            clear : function () {
                _yuitest_coverfunc("/build/test/test.js", "clear", 1662);
_yuitest_coverline("/build/test/test.js", 1663);
this.masterSuite = new YUITest.TestSuite("yuitests" + (new Date()).getTime());
            },
             ...
             */
            isWaiting: function() {
                _yuitest_coverfunc("/build/test/test.js", "isWaiting", 1672);
_yuitest_coverline("/build/test/test.js", 1673);
return this._waiting;
             ...
             */
            isRunning: function(){
                _yuitest_coverfunc("/build/test/test.js", "isRunning", 1682);
_yuitest_coverline("/build/test/test.js", 1683);
return this._running;
            ...
            getResults: function(format){
                _yuitest_coverfunc("/build/test/test.js", "getResults", 1695);
_yuitest_coverline("/build/test/test.js", 1696);
if (!this._running && this._lastResults){
                    _yuitest_coverline("/build/test/test.js", 1697);
if (typeof format == "function"){
                        _yuitest_coverline("/build/test/test.js", 1698);
return format(this._lastResults);                    
                    } else {
                        _yuitest_coverline("/build/test/test.js", 1700);
...
return null;
            ...
            getCoverage: function(format){
                _yuitest_coverfunc("/build/test/test.js", "getCoverage", 1717);
_yuitest_coverline("/build/test/test.js", 1718);
if (!this._running && typeof _yuitest_coverage == "object"){
                    _yuitest_coverline("/build/test/test.js", 1719);
if (typeof format == "function"){
                        _yuitest_coverline("/build/test/test.js", 1720);
return format(_yuitest_coverage);                    
                    } else {
                        _yuitest_coverline("/build/test/test.js", 1722);
...
return null;
             ...
             */
            callback: function(){
                _yuitest_coverfunc("/build/test/test.js", "callback", 1740);
_yuitest_coverline("/build/test/test.js", 1741);
var names   = arguments,
                    data    = this._context,
                    that    = this;
                    
                _yuitest_coverline("/build/test/test.js", 1745);
return function(){
                    _yuitest_coverfunc("/build/test/test.js", "(anonymous 9)", 1745);
_yuitest_coverline("/build/test/test.js", 1746);
for (var i=0; i < arguments.length; i++){
                        _yuitest_coverline("/build/test/test.js", 1747);
data[names[i]] = arguments[i];
                    }
                    _yuitest_coverline("/build/test/test.js", 1749);
that._run();
                };
            },
             ...
             */
            resume : function (segment) {
                _yuitest_coverfunc("/build/test/test.js", "resume", 1761);
_yuitest_coverline("/build/test/test.js", 1762);
if (this._waiting){
                    _yuitest_coverline("/build/test/test.js", 1763);
this._resumeTest(segment || function(){});
                } else {
                    _yuitest_coverline("/build/test/test.js", 1765);
throw new Error("resume() called without wait().");
            ...
            run : function (options) {
                ...
                _yuitest_coverfunc("/build/test/test.js", "run", 1779);
_yuitest_coverline("/build/test/test.js", 1781);
options = options || {};
                
                //pointer to runner to avoid scope issues 
                _yuitest_coverline("/build/test/test.js", 1784);
var runner  = YUITest.TestRunner,
                    oldMode = options.oldMode;
                
                
                //if there's only one suite on the masterSuite, move it up
                _yuitest_coverline("/build/test/test.js", 1789);
if (!oldMode && this.masterSuite.items.length == 1 && this.masterSuite.items[0] instanceof YUITest.TestSuite){
                    _yuitest_coverline("/build/test/test.js", 1790);
...
runner._context = {};
                _yuitest_coverline("/build/test/test.js", 1799);
...
YUITest.ArrayAssert = {
    ...
    _indexOf: function(haystack, needle){
        _yuitest_coverfunc("/build/test/test.js", "_indexOf", 1837);
_yuitest_coverline("/build/test/test.js", 1838);
if (haystack.indexOf){
            _yuitest_coverline("/build/test/test.js", 1839);
return haystack.indexOf(needle);
        } else {
            _yuitest_coverline("/build/test/test.js", 1841);
for (var i=0; i < haystack.length; i++){
                _yuitest_coverline("/build/test/test.js", 1842);
if (haystack[i] === needle){
                    _yuitest_coverline("/build/test/test.js", 1843);
return i;
                }
            }
...
return -1;
    ...
    _some: function(haystack, matcher){
        _yuitest_coverfunc("/build/test/test.js", "_some", 1860);
_yuitest_coverline("/build/test/test.js", 1861);
if (haystack.some){
            _yuitest_coverline("/build/test/test.js", 1862);
return haystack.some(matcher);
        } else {
            _yuitest_coverline("/build/test/test.js", 1864);
for (var i=0; i < haystack.length; i++){
                _yuitest_coverline("/build/test/test.js", 1865);
if (matcher(haystack[i])){
                    _yuitest_coverline("/build/test/test.js", 1866);
return true;
                }
            }
...
return false;
    ...
    contains : function (needle, haystack, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "contains", 1882);
_yuitest_coverline("/build/test/test.js", 1885);
YUITest.Assert._increment();               

        _yuitest_coverline("/build/test/test.js", 1887);
if (this._indexOf(haystack, needle) == -1){
            _yuitest_coverline("/build/test/test.js", 1888);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value " + needle + " (" + (typeof needle) + ") not found in array [" + haystack + "]."));
    ...
    containsItems : function (needles, haystack, 
                           message) {
        _yuitest_coverfunc("/build/test/test.js", "containsItems", 1902);
_yuitest_coverline("/build/test/test.js", 1904);
YUITest.Assert._increment();               

        //begin checking values
        _yuitest_coverline("/build/test/test.js", 1907);
for (var i=0; i < needles.length; i++){
            _yuitest_coverline("/build/test/test.js", 1908);
if (this._indexOf(haystack, needles[i]) == -1){
                _yuitest_coverline("/build/test/test.js", 1909);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value " + needles[i] + " (" + (typeof needles[i]) + ") not found in array [" + haystack + "]."));
    ...
    containsMatch : function (matcher, haystack, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "containsMatch", 1923);
_yuitest_coverline("/build/test/test.js", 1926);
YUITest.Assert._increment();               
        //check for valid matcher
        _yuitest_coverline("/build/test/test.js", 1928);
if (typeof matcher != "function"){
            _yuitest_coverline("/build/test/test.js", 1929);
throw new TypeError("ArrayAssert.containsMatch(): First argument must be a function.");
        }
        
        _yuitest_coverline("/build/test/test.js", 1932);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "No match found in array [" + haystack + "]."));
    ...
    doesNotContain : function (needle, haystack, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "doesNotContain", 1947);
_yuitest_coverline("/build/test/test.js", 1950);
YUITest.Assert._increment();               

        _yuitest_coverline("/build/test/test.js", 1952);
if (this._indexOf(haystack, needle) > -1){
            _yuitest_coverline("/build/test/test.js", 1953);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
    ...
    doesNotContainItems : function (needles, haystack, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "doesNotContainItems", 1967);
_yuitest_coverline("/build/test/test.js", 1970);
YUITest.Assert._increment();               

        _yuitest_coverline("/build/test/test.js", 1972);
for (var i=0; i < needles.length; i++){
            _yuitest_coverline("/build/test/test.js", 1973);
if (this._indexOf(haystack, needles[i]) > -1){
                _yuitest_coverline("/build/test/test.js", 1974);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
            }
        }
    ...
    doesNotContainMatch : function (matcher, haystack, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "doesNotContainMatch", 1989);
_yuitest_coverline("/build/test/test.js", 1992);
YUITest.Assert._increment();     
      
        //check for valid matcher
        _yuitest_coverline("/build/test/test.js", 1995);
if (typeof matcher != "function"){
            _yuitest_coverline("/build/test/test.js", 1996);
throw new TypeError("ArrayAssert.doesNotContainMatch(): First argument must be a function.");
        }
        
        _yuitest_coverline("/build/test/test.js", 1999);
if (this._some(haystack, matcher)){
            _yuitest_coverline("/build/test/test.js", 2000);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value found in array [" + haystack + "]."));
        }
    },
    ...
    indexOf : function (needle, haystack, index, message) {
        ...
        _yuitest_coverfunc("/build/test/test.js", "indexOf", 2014);
_yuitest_coverline("/build/test/test.js", 2016);
YUITest.Assert._increment();     

        //try to find the value in the array
        _yuitest_coverline("/build/test/test.js", 2019);
for (var i=0; i < haystack.length; i++){
            _yuitest_coverline("/build/test/test.js", 2020);
if (haystack[i] === needle){
                _yuitest_coverline("/build/test/test.js", 2021);
if (index != i){
                    _yuitest_coverline("/build/test/test.js", 2022);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value exists at index " + i + " but should be at index " + index + "."));                    
                }
                _yuitest_coverline("/build/test/test.js", 2024);
return;
            }
        }
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value doesn't exist in array [" + haystack + "]."));
    ...
    itemsAreEqual : function (expected, actual, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "itemsAreEqual", 2043);
_yuitest_coverline("/build/test/test.js", 2046);
YUITest.Assert._increment();     
        
        //first make sure they're array-like (this can probably be improved)
        _yuitest_coverline("/build/test/test.js", 2049);
if (typeof expected != "object" || typeof actual != "object"){
            _yuitest_coverline("/build/test/test.js", 2050);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value should be an array."));
        }
        
        //next check array length
        _yuitest_coverline("/build/test/test.js", 2054);
if (expected.length != actual.length){
            _yuitest_coverline("/build/test/test.js", 2055);
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not equal."), expected[i], actual[i]);
    ...
    itemsAreEquivalent : function (expected, actual, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "itemsAreEquivalent", 2080);
_yuitest_coverline("/build/test/test.js", 2083);
YUITest.Assert._increment();     

        //make sure the comparator is valid
        _yuitest_coverline("/build/test/test.js", 2086);
if (typeof comparator != "function"){
            _yuitest_coverline("/build/test/test.js", 2087);
throw new TypeError("ArrayAssert.itemsAreEquivalent(): Third argument must be a function.");
        }
        
        //first check array length
        _yuitest_coverline("/build/test/test.js", 2091);
if (expected.length != actual.length){
            _yuitest_coverline("/build/test/test.js", 2092);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length));
        }
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not equivalent."), expected[i], actual[i]);
    ...
    isEmpty : function (actual, message) {        
        _yuitest_coverfunc("/build/test/test.js", "isEmpty", 2110);
_yuitest_coverline("/build/test/test.js", 2111);
YUITest.Assert._increment();     
        _yuitest_coverline("/build/test/test.js", 2112);
if (actual.length > 0){
            _yuitest_coverline("/build/test/test.js", 2113);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should be empty."));
    ...
    isNotEmpty : function (actual, message) {        
        _yuitest_coverfunc("/build/test/test.js", "isNotEmpty", 2124);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should not be empty."));
    ...
    itemsAreSame : function (expected, actual, 
        ...
        _yuitest_coverfunc("/build/test/test.js", "itemsAreSame", 2142);
_yuitest_coverline("/build/test/test.js", 2145);
YUITest.Assert._increment();     

        //first check array length
        _yuitest_coverline("/build/test/test.js", 2148);
if (expected.length != actual.length){
            _yuitest_coverline("/build/test/test.js", 2149);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length));
        }
                    
        //begin checking values
        _yuitest_coverline("/build/test/test.js", 2153);
for (var i=0; i < expected.length; i++){
            _yuitest_coverline("/build/test/test.js", 2154);
if (expected[i] !== actual[i]){
...
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values in position " + i + " are not the same."), expected[i], actual[i]);
    ...
    lastIndexOf : function (needle, haystack, index, message) {
        ...
        //try to find the value in the array
        _yuitest_coverfunc("/build/test/test.js", "lastIndexOf", 2171);
_yuitest_coverline("/build/test/test.js", 2174);
for (var i=haystack.length; i >= 0; i--){
            _yuitest_coverline("/build/test/test.js", 2175);
if (haystack[i] === needle){
                _yuitest_coverline("/build/test/test.js", 2176);
if (index != i){
                    _yuitest_coverline("/build/test/test.js", 2177);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Value exists at index " + i + " but should be at index " + index + "."));                    
                }
                _yuitest_coverline("/build/test/test.js", 2179);
return;
            }
        }
...
YUITest.Assert = {
    ...
    _formatMessage : function (customMessage, defaultMessage) {
        _yuitest_coverfunc("/build/test/test.js", "_formatMessage", 2222);
_yuitest_coverline("/build/test/test.js", 2223);
if (typeof customMessage == "string" && customMessage.length > 0){
            _yuitest_coverline("/build/test/test.js", 2224);
return customMessage.replace("{message}", defaultMessage);
        } else {
            _yuitest_coverline("/build/test/test.js", 2226);
return defaultMessage;
     ...
     */
    _getCount: function(){
        _yuitest_coverfunc("/build/test/test.js", "_getCount", 2236);
...
return this._asserts;
     ...
     */
    _increment: function(){
        _yuitest_coverfunc("/build/test/test.js", "_increment", 2246);
_yuitest_coverline("/build/test/test.js", 2247);
this._asserts++;
    },
     ...
     */
    _reset: function(){
        _yuitest_coverfunc("/build/test/test.js", "_reset", 2256);
_yuitest_coverline("/build/test/test.js", 2257);
this._asserts = 0;
    },
     ...
     */
    fail : function (message) {
        _yuitest_coverfunc("/build/test/test.js", "fail", 2270);
...
throw new YUITest.AssertionError(YUITest.Assert._formatMessage(message, "Test force-failed."));
    ...
    pass : function (message) {
        _yuitest_coverfunc("/build/test/test.js", "pass", 2279);
_yuitest_coverline("/build/test/test.js", 2280);
YUITest.Assert._increment();
    },       
    ...
    areEqual : function (expected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "areEqual", 2296);
_yuitest_coverline("/build/test/test.js", 2297);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2298);
if (expected != actual) {
            _yuitest_coverline("/build/test/test.js", 2299);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be equal."), expected, actual);
        }
    },
    ...
    areNotEqual : function (unexpected, actual, 
                         message) {
        _yuitest_coverfunc("/build/test/test.js", "areNotEqual", 2312);
_yuitest_coverline("/build/test/test.js", 2314);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2315);
if (unexpected == actual) {
            _yuitest_coverline("/build/test/test.js", 2316);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be equal."), unexpected);
    ...
    areNotSame : function (unexpected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "areNotSame", 2329);
_yuitest_coverline("/build/test/test.js", 2330);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2331);
if (unexpected === actual) {
            _yuitest_coverline("/build/test/test.js", 2332);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be the same."), unexpected);
    ...
    areSame : function (expected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "areSame", 2345);
_yuitest_coverline("/build/test/test.js", 2346);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2347);
if (expected !== actual) {
            _yuitest_coverline("/build/test/test.js", 2348);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be the same."), expected, actual);
        }
    },    
    ...
    isFalse : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isFalse", 2364);
_yuitest_coverline("/build/test/test.js", 2365);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2366);
if (false !== actual) {
            _yuitest_coverline("/build/test/test.js", 2367);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be false."), false, actual);
    ...
    isTrue : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isTrue", 2379);
_yuitest_coverline("/build/test/test.js", 2380);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2381);
if (true !== actual) {
            _yuitest_coverline("/build/test/test.js", 2382);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be true."), true, actual);
    ...
    isNaN : function (actual, message){
        _yuitest_coverfunc("/build/test/test.js", "isNaN", 2398);
_yuitest_coverline("/build/test/test.js", 2399);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2400);
if (!isNaN(actual)){
            _yuitest_coverline("/build/test/test.js", 2401);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be NaN."), NaN, actual);
    ...
    isNotNaN : function (actual, message){
        _yuitest_coverfunc("/build/test/test.js", "isNotNaN", 2412);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be NaN."), NaN);
    ...
    isNotNull : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isNotNull", 2427);
_yuitest_coverline("/build/test/test.js", 2428);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2429);
if (actual === null) {
            _yuitest_coverline("/build/test/test.js", 2430);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Values should not be null."), null);
    ...
    isNotUndefined : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isNotUndefined", 2442);
_yuitest_coverline("/build/test/test.js", 2443);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2444);
if (typeof actual == "undefined") {
            _yuitest_coverline("/build/test/test.js", 2445);
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should not be undefined."), undefined);
    ...
    isNull : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isNull", 2457);
_yuitest_coverline("/build/test/test.js", 2458);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2459);
if (actual !== null) {
            _yuitest_coverline("/build/test/test.js", 2460);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be null."), null, actual);
    ...
    isUndefined : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isUndefined", 2472);
_yuitest_coverline("/build/test/test.js", 2473);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2474);
if (typeof actual != "undefined") {
            _yuitest_coverline("/build/test/test.js", 2475);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be undefined."), undefined, actual);
    ...
    isArray : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isArray", 2490);
_yuitest_coverline("/build/test/test.js", 2491);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2492);
var shouldFail = false;
        _yuitest_coverline("/build/test/test.js", 2493);
if (Array.isArray){
            _yuitest_coverline("/build/test/test.js", 2494);
shouldFail = !Array.isArray(actual);
        } else {
            _yuitest_coverline("/build/test/test.js", 2496);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be an array."), actual);
    ...
    isBoolean : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isBoolean", 2510);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a Boolean."), actual);
    ...
    isFunction : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isFunction", 2524);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a function."), actual);
    ...
    isInstanceOf : function (expected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isInstanceOf", 2541);
_yuitest_coverline("/build/test/test.js", 2542);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2543);
if (!(actual instanceof expected)){
            _yuitest_coverline("/build/test/test.js", 2544);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value isn't an instance of expected type."), expected, actual);
    ...
    isNumber : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isNumber", 2555);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a number."), actual);
    ...
    isObject : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isObject", 2569);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be an object."), actual);
    ...
    isString : function (actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "isString", 2583);
...
throw new YUITest.UnexpectedValue(YUITest.Assert._formatMessage(message, "Value should be a string."), actual);
    ...
    isTypeOf : function (expectedType, actualValue, message){
        _yuitest_coverfunc("/build/test/test.js", "isTypeOf", 2598);
_yuitest_coverline("/build/test/test.js", 2599);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2600);
if (typeof actualValue != expectedType){
            _yuitest_coverline("/build/test/test.js", 2601);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Value should be of type " + expectedType + "."), expectedType, typeof actualValue);
    ...
    throwsError: function(expectedError, method, message){
        _yuitest_coverfunc("/build/test/test.js", "throwsError", 2624);
_yuitest_coverline("/build/test/test.js", 2625);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2626);
var error = false;
    
        _yuitest_coverline("/build/test/test.js", 2628);
try {
            _yuitest_coverline("/build/test/test.js", 2629);
method();        
        } catch (thrown) {
...
if (thrown.message != expectedError){
                    _yuitest_coverline("/build/test/test.js", 2637);
error = true;
                }
            } else {_yuitest_coverline("/build/test/test.js", 2639);
...
if (error){
                _yuitest_coverline("/build/test/test.js", 2659);
throw new YUITest.UnexpectedError(thrown);                    
            } else {
                _yuitest_coverline("/build/test/test.js", 2661);
return;
            }
        }
 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 2681);
YUITest.AssertionError = function (message){
     ...
     * @property message
     */
    _yuitest_coverfunc("/build/test/test.js", "AssertionError", 2681);
...
_yuitest_coverline("/build/test/test.js", 2698);
YUITest.AssertionError.prototype = {
     ...
     */
    getMessage : function () {
        _yuitest_coverfunc("/build/test/test.js", "getMessage", 2709);
_yuitest_coverline("/build/test/test.js", 2710);
return this.message;
    },
     ...
     */
    toString : function () {
        _yuitest_coverfunc("/build/test/test.js", "toString", 2718);
_yuitest_coverline("/build/test/test.js", 2719);
 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 2737);
YUITest.ComparisonFailure = function (message, expected, actual){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ComparisonFailure", 2737);
_yuitest_coverline("/build/test/test.js", 2740);
YUITest.AssertionError.call(this, message);
     ...
     * @property expected
     */
    _yuitest_coverline("/build/test/test.js", 2747);
this.expected = expected;
     ...
     * @property actual
     */
    _yuitest_coverline("/build/test/test.js", 2754);
this.actual = actual;
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 2761);
...
//restore constructor
_yuitest_coverline("/build/test/test.js", 2769);
 ...
 * @return {String} A string describing the error.
 */
_yuitest_coverline("/build/test/test.js", 2777);
YUITest.ComparisonFailure.prototype.getMessage = function(){
    _yuitest_coverfunc("/build/test/test.js", "getMessage", 2777);
 ...
 * @static
 */
_yuitest_coverline("/build/test/test.js", 2788);
YUITest.CoverageFormat = {
    ...
    JSON: function(coverage){
        _yuitest_coverfunc("/build/test/test.js", "JSON", 2798);
_yuitest_coverline("/build/test/test.js", 2799);
return YUITest.Util.JSON.stringify(coverage);
    ...
    XdebugJSON: function(coverage){
        ...
        _yuitest_coverfunc("/build/test/test.js", "XdebugJSON", 2812);
_yuitest_coverline("/build/test/test.js", 2814);
var report = {};
        _yuitest_coverline("/build/test/test.js", 2815);
for (var prop in coverage){
            _yuitest_coverline("/build/test/test.js", 2816);
if (coverage.hasOwnProperty(prop)){
                _yuitest_coverline("/build/test/test.js", 2817);
...
_yuitest_coverline("/build/test/test.js", 2836);
YUITest.DateAssert = {
    ...
    datesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("/build/test/test.js", "datesAreEqual", 2846);
_yuitest_coverline("/build/test/test.js", 2847);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 2848);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("/build/test/test.js", 2849);
var msg = "";
...
msg = "Days of month should be equal.";
            ...
            _yuitest_coverline("/build/test/test.js", 2866);
if (msg.length){
...
throw new TypeError("YUITest.DateAssert.datesAreEqual(): Expected and actual values must be Date objects.");
    ...
    timesAreEqual : function (expected, actual, message){
        _yuitest_coverfunc("/build/test/test.js", "timesAreEqual", 2882);
_yuitest_coverline("/build/test/test.js", 2883);
YUITest.Assert._increment();
        _yuitest_coverline("/build/test/test.js", 2884);
if (expected instanceof Date && actual instanceof Date){
            _yuitest_coverline("/build/test/test.js", 2885);
var msg = "";
...
msg = "Seconds should be equal.";
            ...
            _yuitest_coverline("/build/test/test.js", 2902);
if (msg.length){
 ...
 */
_yuitest_coverline("/build/test/test.js", 2920);
YUITest.Mock = function(template){

    //use blank object is nothing is passed in
    _yuitest_coverfunc("/build/test/test.js", "Mock", 2920);
_yuitest_coverline("/build/test/test.js", 2923);
template = template || {};
    
    _yuitest_coverline("/build/test/test.js", 2925);
var mock,
        name;
...
function f(){}
        _yuitest_coverline("/build/test/test.js", 2932);
...
mock[name] = function(name){
                    _yuitest_coverfunc("/build/test/test.js", "]", 2942);
_yuitest_coverline("/build/test/test.js", 2943);
return function(){
                        _yuitest_coverfunc("/build/test/test.js", "(anonymous 11)", 2943);
 ...
 * @static
 */ 
_yuitest_coverline("/build/test/test.js", 2975);
YUITest.Mock.expect = function(mock /*:Object*/, expectation /*:Object*/){

    //make sure there's a place to store the expectations
    _yuitest_coverfunc("/build/test/test.js", "expect", 2975);
_yuitest_coverline("/build/test/test.js", 2978);
...
if (expectation.method){
        _yuitest_coverline("/build/test/test.js", 2984);
...
expectation.callCount = callCount;
        _yuitest_coverline("/build/test/test.js", 2996);
...
if (!(args[i] instanceof YUITest.Mock.Value)){
                _yuitest_coverline("/build/test/test.js", 3001);
...
mock[name] = function(){   
                _yuitest_coverfunc("/build/test/test.js", "]", 3007);
_yuitest_coverline("/build/test/test.js", 3008);
try {
...
mock[name] = function(){
                _yuitest_coverfunc("/build/test/test.js", "]", 3032);
_yuitest_coverline("/build/test/test.js", 3033);
try {
                    _yuitest_coverline("/build/test/test.js", 3034);
...
YUITest.TestRunner._handleError(ex);
    ...
    } else {_yuitest_coverline("/build/test/test.js", 3041);
 ...
 * @static
 */ 
_yuitest_coverline("/build/test/test.js", 3055);
YUITest.Mock.verify = function(mock){    
    _yuitest_coverfunc("/build/test/test.js", "verify", 3055);
_yuitest_coverline("/build/test/test.js", 3056);
try {
    
        _yuitest_coverline("/build/test/test.js", 3058);
...
var expectation = mock.__expectations[name];
                _yuitest_coverline("/build/test/test.js", 3061);
if (expectation.method) {
...
YUITest.Assert.areEqual(expectation.callCount, expectation.actualCallCount, "Method " + expectation.method + "() wasn't called the expected number of times.");
                } else {_yuitest_coverline("/build/test/test.js", 3063);
if (expectation.property){
 ...
 * @constructor
 */
_yuitest_coverline("/build/test/test.js", 3085);
YUITest.Mock.Value = function(method, originalArgs, message){
    _yuitest_coverfunc("/build/test/test.js", "Value", 3085);
_yuitest_coverline("/build/test/test.js", 3086);
if (this instanceof YUITest.Mock.Value){
        _yuitest_coverline("/build/test/test.js", 3087);
this.verify = function(value){
            _yuitest_coverfunc("/build/test/test.js", "verify", 3087);
_yuitest_coverline("/build/test/test.js", 3088);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3112);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3120);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3128);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3136);
 ...
 * @type Function
 */
_yuitest_coverline("/build/test/test.js", 3144);
...
YUITest.ObjectAssert = {
     ...
     */
    areEqual: function(expected, actual, message) {
        _yuitest_coverfunc("/build/test/test.js", "areEqual", 3166);
_yuitest_coverline("/build/test/test.js", 3167);
YUITest.Assert._increment();         
        
        _yuitest_coverline("/build/test/test.js", 3169);
...
if (expectedKeys.length != actualKeys.length){
            _yuitest_coverline("/build/test/test.js", 3174);
...
if (expected[name] != actual[name]){
                    _yuitest_coverline("/build/test/test.js", 3181);
throw new YUITest.ComparisonFailure(YUITest.Assert._formatMessage(message, "Values should be equal for property " + name), expected[name], actual[name]);
    ...
    hasKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "hasKey", 3196);
_yuitest_coverline("/build/test/test.js", 3197);
YUITest.ObjectAssert.ownsOrInheritsKey(propertyName, object, message);   
    ...
    hasKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "hasKeys", 3209);
_yuitest_coverline("/build/test/test.js", 3210);
YUITest.ObjectAssert.ownsOrInheritsKeys(properties, object, message);
    ...
    inheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "inheritsKey", 3221);
_yuitest_coverline("/build/test/test.js", 3222);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3223);
if (!(propertyName in object && !object.hasOwnProperty(propertyName))){
            _yuitest_coverline("/build/test/test.js", 3224);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
    ...
    inheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "inheritsKeys", 3236);
_yuitest_coverline("/build/test/test.js", 3237);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 3238);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3239);
if (!(propertyName in object && !object.hasOwnProperty(properties[i]))){
                _yuitest_coverline("/build/test/test.js", 3240);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
    ...
    ownsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsKey", 3253);
_yuitest_coverline("/build/test/test.js", 3254);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3255);
if (!object.hasOwnProperty(propertyName)){
            _yuitest_coverline("/build/test/test.js", 3256);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object instance."));
        }     
    },
    ...
    ownsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsKeys", 3268);
_yuitest_coverline("/build/test/test.js", 3269);
YUITest.Assert._increment();        
        _yuitest_coverline("/build/test/test.js", 3270);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3271);
if (!object.hasOwnProperty(properties[i])){
                _yuitest_coverline("/build/test/test.js", 3272);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + properties[i] + "' not found on object instance."));
            }      
        }
    },
    ...
    ownsNoKeys : function (object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsNoKeys", 3284);
_yuitest_coverline("/build/test/test.js", 3285);
YUITest.Assert._increment();  
        _yuitest_coverline("/build/test/test.js", 3286);
var count = 0,
            name;
        _yuitest_coverline("/build/test/test.js", 3288);
for (name in object){
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Object owns " + count + " properties but should own none."));        
    ...
    ownsOrInheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsOrInheritsKey", 3308);
_yuitest_coverline("/build/test/test.js", 3309);
YUITest.Assert._increment();               
        _yuitest_coverline("/build/test/test.js", 3310);
if (!(propertyName in object)){
            _yuitest_coverline("/build/test/test.js", 3311);
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object."));
    ...
    ownsOrInheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("/build/test/test.js", "ownsOrInheritsKeys", 3323);
_yuitest_coverline("/build/test/test.js", 3324);
YUITest.Assert._increment();  
        _yuitest_coverline("/build/test/test.js", 3325);
for (var i=0; i < properties.length; i++){
            _yuitest_coverline("/build/test/test.js", 3326);
if (!(properties[i] in object)){
                _yuitest_coverline("/build/test/test.js", 3327);
 ...
 */
_yuitest_coverline("/build/test/test.js", 3342);
YUITest.Results = function(name){
     ...
     * @property name
     */
    _yuitest_coverfunc("/build/test/test.js", "Results", 3342);
_yuitest_coverline("/build/test/test.js", 3349);
this.name = name;
     ...
     * @property passed
     */
    _yuitest_coverline("/build/test/test.js", 3356);
this.passed = 0;
     ...
     * @property failed
     */
    _yuitest_coverline("/build/test/test.js", 3363);
this.failed = 0;
     ...
     * @property errors
     */
    _yuitest_coverline("/build/test/test.js", 3370);
this.errors = 0;
     ...
     * @property ignored
     */
    _yuitest_coverline("/build/test/test.js", 3377);
this.ignored = 0;
     ...
     * @property total
     */
    _yuitest_coverline("/build/test/test.js", 3384);
this.total = 0;
     ...
     * @property duration
     */
    _yuitest_coverline("/build/test/test.js", 3391);
this.duration = 0;
}
 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 3418);
YUITest.ShouldError = function (message){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ShouldError", 3418);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("/build/test/test.js", 3433);
 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 3448);
YUITest.ShouldFail = function (message){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "ShouldFail", 3448);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("/build/test/test.js", 3463);
 ...
 * @constructor
 */  
_yuitest_coverline("/build/test/test.js", 3480);
YUITest.UnexpectedError = function (cause){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "UnexpectedError", 3480);
...
this.cause = cause;
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 3497);
this.name = "UnexpectedError";
     ...
     * @property stack
     */
    _yuitest_coverline("/build/test/test.js", 3504);
this.stack = cause.stack;
    
};

//inherit from YUITest.AssertionError
_yuitest_coverline("/build/test/test.js", 3509);
 ...
 * @constructor
 */ 
_yuitest_coverline("/build/test/test.js", 3527);
YUITest.UnexpectedValue = function (message, unexpected){

    //call superclass
    _yuitest_coverfunc("/build/test/test.js", "UnexpectedValue", 3527);
...
this.unexpected = unexpected;
     ...
     * @property name
     */
    _yuitest_coverline("/build/test/test.js", 3544);
this.name = "UnexpectedValue";
    
};

//inherit from YUITest.AssertionError
_yuitest_coverline("/build/test/test.js", 3549);
...
YUITest.UnexpectedValue.prototype.getMessage = function(){
    _yuitest_coverfunc("/build/test/test.js", "getMessage", 3560);
_yuitest_coverline("/build/test/test.js", 3561);
 ...
 *
 */
_yuitest_coverline("/build/test/test.js", 3575);
YUITest.Wait = function (segment, delay) {
     ...
     * @property segment
     */
    _yuitest_coverfunc("/build/test/test.js", "Wait", 3575);
_yuitest_coverline("/build/test/test.js", 3582);
this.segment = (typeof segment == "function" ? segment : null);
     ...
     * @property delay
     */
    _yuitest_coverline("/build/test/test.js", 3589);
this.delay = (typeof delay == "number" ? delay : 0);        
};


//Setting up our aliases..
_yuitest_coverline("/build/test/test.js", 3594);
Y.Test = YUITest;
_yuitest_coverline("/build/test/test.js", 3595);
Y.Object.each(YUITest, function(item, name) {
    _yuitest_coverfunc("/build/test/test.js", "(anonymous 14)", 3595);
_yuitest_coverline("/build/test/test.js", 3596);
...
_yuitest_coverline("/build/test/test.js", 3602);
Y.Assert = YUITest.Assert;
_yuitest_coverline("/build/test/test.js", 3603);
...
Y.Test.ArrayAssert.itemsAreEqual = function(expected, actual, message) {
    _yuitest_coverfunc("/build/test/test.js", "itemsAreEqual", 3614);
 ...
 * @static
 */
_yuitest_coverline("/build/test/test.js", 3628);
Y.assert = function(condition, message){
    _yuitest_coverfunc("/build/test/test.js", "assert", 3628);
_yuitest_coverline("/build/test/test.js", 3629);
Y.Assert._increment();
    _yuitest_coverline("/build/test/test.js", 3630);
if (!condition){
...
_yuitest_coverline("/build/test/test.js", 3644);
...
Y.Test.Runner.disableLogging = function() {
    _yuitest_coverfunc("/build/test/test.js", "disableLogging", 3646);
...
Y.Test.Runner.enableLogging = function() {
    _yuitest_coverfunc("/build/test/test.js", "enableLogging", 3650);
...
var logEvent = function(event) {
        ...
        //data variables
        _yuitest_coverfunc("/build/test/test.js", "logEvent", 3670);
