 ...
 * @constructor
 */
_yuitest_coverline("build/test/test.js", 3768);
YUITest.WinJS = function (jsonObj) {
    _yuitest_coverfunc("build/test/test.js", "WinJS", 3768);
_yuitest_coverline("build/test/test.js", 3769);
this.tests = jsonObj.tests || [];
    _yuitest_coverline("build/test/test.js", 3770);
this.results = {};

    _yuitest_coverline("build/test/test.js", 3772);
this.listen();
...
YUITest.WinJS.prototype = {
    ...
    read: function() {
        _yuitest_coverfunc("build/test/test.js", "read", 3782);
_yuitest_coverline("build/test/test.js", 3783);
var o = WinJS.Application.local.readText("YUI.Tests", JSON.stringify({
            tests: []
        }));

        _yuitest_coverline("build/test/test.js", 3787);
this.tests = o.tests;
    },

    //pop the first element off tests array and save it to local storage
    pop: function() {
        _yuitest_coverfunc("build/test/test.js", "pop", 3791);
_yuitest_coverline("build/test/test.js", 3792);
this.tests.pop();
    },

    //Listen for TestRunner Events and append to a testResults array
    listen: function() {
        _yuitest_coverfunc("build/test/test.js", "listen", 3796);
_yuitest_coverline("build/test/test.js", 3797);
var runner = YUI.YUITest.TestRunner;
        _yuitest_coverline("build/test/test.js", 3798);
runner.subscribe(runner.COMPLETE_EVENT, function() {
            _yuitest_coverfunc("build/test/test.js", "(anonymous 15)", 3798);
_yuitest_coverline("build/test/test.js", 3799);
console.log("Test Suite Completed.")
        });

        _yuitest_coverline("build/test/test.js", 3802);
runner.subscribe(runner.BEGIN_EVENT, function() {
            _yuitest_coverfunc("build/test/test.js", "(anonymous 16)", 3802);
_yuitest_coverline("build/test/test.js", 3803);
