...
node.onload  = onLoad;
            ...
            _yuitest_coverline("build/get/get.js", 1126);
if (!env.cssFail && !isScript) {
                _yuitest_coverline("build/get/get.js", 1127);
...
insertBefore.parentNode.insertBefore(node, insertBefore);
    ...
    _next: function () {
        _yuitest_coverfunc("build/get/get.js", "_next", 1135);
...
this._insert(this._queue.shift());
        } else {_yuitest_coverline("build/get/get.js", 1146);
if (!this._reqsWaiting) {
            _yuitest_coverline("build/get/get.js", 1147);
this._finish();
        }}
    },

    _poll: function (newReq) {
        _yuitest_coverfunc("build/get/get.js", "_poll", 1151);
_yuitest_coverline("build/get/get.js", 1152);
var self       = this,
...
if (self._pollTimer) {
                ...
                // new one.
                _yuitest_coverline("build/get/get.js", 1164);
return;
            }
        }

        _yuitest_coverline("build/get/get.js", 1168);
...
nodeHref = req.node.href;
                ...
                _yuitest_coverline("build/get/get.js", 1183);
while (--j >= 0) {
                    _yuitest_coverline("build/get/get.js", 1184);
if (sheets[j].href === nodeHref) {
                        _yuitest_coverline("build/get/get.js", 1185);
pendingCSS.splice(i, 1);
                        _yuitest_coverline("build/get/get.js", 1186);
i -= 1;
...
hasRules = !!req.node.sheet.cssRules;
                    ...
                    _yuitest_coverline("build/get/get.js", 1205);
pendingCSS.splice(i, 1);
...
self._pollTimer = setTimeout(function () {
                _yuitest_coverfunc("build/get/get.js", "(anonymous 3)", 1215);
...
self._poll.call(self);
    ...
    _progress: function (err, req) {
        _yuitest_coverfunc("build/get/get.js", "_progress", 1221);
_yuitest_coverline("build/get/get.js", 1222);
var options = this.options;

        _yuitest_coverline("build/get/get.js", 1224);
if (err) {
            _yuitest_coverline("build/get/get.js", 1225);
req.error = err;
...
this.errors.push({
        ...
        _yuitest_coverline("build/get/get.js", 1234);
...
this._pending = null;
        ...
        _yuitest_coverline("build/get/get.js", 1253);
this._reqsWaiting -= 1;
