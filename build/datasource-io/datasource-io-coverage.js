...
_yuitest_coverage["/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @constructor
 */    
_yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 16);
var DSIO = function() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "DSIO", 16);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 17);
DSIO.superclass.constructor.apply(this, arguments);
    ...
    //
    /////////////////////////////////////////////////////////////////////////////
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 26);
Y.mix(DSIO, {
    /**
     * Class name.
     *
...
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 71);
Y.extend(DSIO, Y.DataSource.Local, {
    ...
    */
    initializer: function(config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "initializer", 79);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 80);
this._queue = {interval:null, conn:null, requests:[]};
    ...
    */
    successHandler: function (id, response, e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "successHandler", 92);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 93);
var defIOConfig = this.get("ioConfig"),
            payload = e.details[0];

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 96);
delete Y.DataSource.Local.transactions[e.tId];

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 98);
payload.data = response;
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 99);
this.fire("data", payload);


        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 102);
if (defIOConfig && defIOConfig.on && defIOConfig.on.success) {
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 103);
defIOConfig.on.success.apply(defIOConfig.context || Y, arguments);
    ...
    */
    failureHandler: function (id, response, e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "failureHandler", 116);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 117);
var defIOConfig = this.get("ioConfig"),
            payload = e.details[0];
        
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 120);
delete Y.DataSource.Local.transactions[e.tId];

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 122);
payload.error = new Error("IO data failure");

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 124);
payload.data = response;
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 125);
this.fire("data", payload);


        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 128);
if (defIOConfig && defIOConfig.on && defIOConfig.on.failure) {
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 129);
defIOConfig.on.failure.apply(defIOConfig.context || Y, arguments);
    ...
    */
    ...
    _defRequestFn: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", "_defRequestFn", 170);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 171);
var uri = this.get("source"),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 185);
if(Y.Lang.isString(request)) {
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 186);
if(cfg.method && (cfg.method.toUpperCase() === "POST")) {
                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 187);
cfg.data = cfg.data ? cfg.data+request : request;
            }
            else {
                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 190);
uri += request;
            }
        }
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 193);
Y.DataSource.Local.transactions[e.tId] = io(uri, cfg);
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 194);
return e.tId;
    }
});
  
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-io.js", 198);
