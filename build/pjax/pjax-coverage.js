...
_yuitest_coverline("/build/pjax/pjax.js", 43);
var EVT_ERROR = 'error',
...
_yuitest_coverline("/build/pjax/pjax.js", 62);
Y.Pjax = Y.Base.create('pjax', Y.Router, [Y.PjaxBase], {
    // -- Lifecycle Methods ----------------------------------------------------
    initializer: function () {
        _yuitest_coverfunc("/build/pjax/pjax.js", "initializer", 64);
_yuitest_coverline("/build/pjax/pjax.js", 65);
this.publish(EVT_ERROR, {defaultFn: this._defCompleteFn});
        _yuitest_coverline("/build/pjax/pjax.js", 66);
this.publish(EVT_LOAD,  {defaultFn: this._defCompleteFn});
    ...
    **/
    getContent: function (responseText) {
        _yuitest_coverfunc("/build/pjax/pjax.js", "getContent", 92);
_yuitest_coverline("/build/pjax/pjax.js", 93);
var content         = {},
...
if (contentSelector) {
            _yuitest_coverline("/build/pjax/pjax.js", 100);
content.node = Y.one(frag.all(contentSelector).toFrag());
        } else {
            _yuitest_coverline("/build/pjax/pjax.js", 102);
content.node = frag;
        }

        _yuitest_coverline("/build/pjax/pjax.js", 105);
if (titleSelector) {
            _yuitest_coverline("/build/pjax/pjax.js", 106);
titleNode = frag.one(titleSelector);

            _yuitest_coverline("/build/pjax/pjax.js", 108);
if (titleNode) {
                _yuitest_coverline("/build/pjax/pjax.js", 109);
content.title = titleNode.get('text');
            }
        }

        _yuitest_coverline("/build/pjax/pjax.js", 113);
return content;
    },
    ...
    **/
    _defaultRoute: function (req) {
        _yuitest_coverfunc("/build/pjax/pjax.js", "_defaultRoute", 126);
_yuitest_coverline("/build/pjax/pjax.js", 127);
var url = req.url;
...
if (this.get('addPjaxParam')) {
            ...
            _yuitest_coverline("/build/pjax/pjax.js", 137);
url = url.replace(/([^#]*)(#.*)?$/, function (match, path, hash) {
                _yuitest_coverfunc("/build/pjax/pjax.js", "(anonymous 2)", 137);
_yuitest_coverline("/build/pjax/pjax.js", 138);
path += (path.indexOf('?') > -1 ? '&' : '?') + 'pjax=1';
                _yuitest_coverline("/build/pjax/pjax.js", 139);
return path + (hash || '');
            });
        }

        // Send a request.
        _yuitest_coverline("/build/pjax/pjax.js", 144);
this._request = Y.io(url, {
    ...
    **/
    _defCompleteFn: function (e) {
        _yuitest_coverfunc("/build/pjax/pjax.js", "_defCompleteFn", 170);
_yuitest_coverline("/build/pjax/pjax.js", 171);
var container = this.get('container'),
            content   = e.content;

        _yuitest_coverline("/build/pjax/pjax.js", 174);
if (container && content.node) {
            _yuitest_coverline("/build/pjax/pjax.js", 175);
container.setContent(content.node);
        }

        _yuitest_coverline("/build/pjax/pjax.js", 178);
if (content.title && Y.config.doc) {
            _yuitest_coverline("/build/pjax/pjax.js", 179);
Y.config.doc.title = content.title;
    ...
    **/
    _onPjaxIOEnd: function () {
        _yuitest_coverfunc("/build/pjax/pjax.js", "_onPjaxIOEnd", 190);
_yuitest_coverline("/build/pjax/pjax.js", 191);
this._request = null;
    },
    ...
    **/
    _onPjaxIOFailure: function (id, res, details) {
        _yuitest_coverfunc("/build/pjax/pjax.js", "_onPjaxIOFailure", 201);
_yuitest_coverline("/build/pjax/pjax.js", 202);
var content = this.getContent(res.responseText);

        _yuitest_coverline("/build/pjax/pjax.js", 204);
this.fire(EVT_ERROR, {
            content     : content,
    ...
    **/
    _onPjaxIOSuccess: function (id, res, details) {
        _yuitest_coverfunc("/build/pjax/pjax.js", "_onPjaxIOSuccess", 219);
_yuitest_coverline("/build/pjax/pjax.js", 220);
var content = this.getContent(res.responseText);

        _yuitest_coverline("/build/pjax/pjax.js", 222);
this.fire(EVT_LOAD, {
            content     : content,
            responseText: res.responseText,
            status      : res.status,
        ...
        **/
        container: {
            ...
            setter: function (node) {
                _yuitest_coverfunc("/build/pjax/pjax.js", "setter", 269);
_yuitest_coverline("/build/pjax/pjax.js", 270);
