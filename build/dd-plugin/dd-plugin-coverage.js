...
YUI.add('dd-plugin', function (Y, NAME) {
        ...
        * @namespace Plugin
        */
        _yuitest_coverfunc("dd-plugin", "(anonymous 1)", 1);
_yuitest_coverline("dd-plugin", 17);
var Drag = function(config) {
                _yuitest_coverfunc("dd-plugin", "Drag", 17);
_yuitest_coverline("dd-plugin", 18);
if (Y.Widget && config.host instanceof Y.Widget) {
                        _yuitest_coverline("dd-plugin", 19);
config.node = config.host.get('boundingBox');
                        _yuitest_coverline("dd-plugin", 20);
config.widget = config.host;
                } else {
                        _yuitest_coverline("dd-plugin", 22);
config.node = config.host;
                        _yuitest_coverline("dd-plugin", 23);
config.widget = false;
                }
                _yuitest_coverline("dd-plugin", 25);
Drag.superclass.constructor.call(this, config);
        ...
        * @type {String}
        */
        _yuitest_coverline("dd-plugin", 37);
Drag.NAME = "dd-plugin";
        ...
        * @type {String}
        */
        _yuitest_coverline("dd-plugin", 44);
Drag.NS = "dd";

        _yuitest_coverline("dd-plugin", 46);
Y.extend(Drag, Y.DD.Drag, {
                ...
                */
                _usesWidgetPosition: function(widget) {
                        _yuitest_coverfunc("dd-plugin", "_usesWidgetPosition", 74);
_yuitest_coverline("dd-plugin", 75);
var r = false;
                        _yuitest_coverline("dd-plugin", 76);
if (widget) {
                                _yuitest_coverline("dd-plugin", 77);
r = (widget.hasImpl && widget.hasImpl(Y.WidgetPosition)) ? true : false;
                        }
                        _yuitest_coverline("dd-plugin", 79);
return r;
                },
                /**
                ...
                */
                _checkEvents: function() {
                    _yuitest_coverfunc("dd-plugin", "_checkEvents", 88);
_yuitest_coverline("dd-plugin", 89);
if (this._widget) {
                        //It's a widget
                        _yuitest_coverline("dd-plugin", 91);
if (this.proxy) {
                            //It's a proxy
                            _yuitest_coverline("dd-plugin", 93);
if (this._widgetHandles.length > 0) {
                                //Remove Listeners
                                _yuitest_coverline("dd-plugin", 95);
this._removeWidgetListeners();
                            }
                        } else {
                            _yuitest_coverline("dd-plugin", 98);
if (this._widgetHandles.length === 0) {
                                _yuitest_coverline("dd-plugin", 99);
this._attachWidgetListeners();
                ...
                */
                _removeWidgetListeners: function() {
                    _yuitest_coverfunc("dd-plugin", "_removeWidgetListeners", 109);
_yuitest_coverline("dd-plugin", 110);
Y.Array.each(this._widgetHandles, function(handle) {
                        _yuitest_coverfunc("dd-plugin", "(anonymous 2)", 110);
_yuitest_coverline("dd-plugin", 111);
handle.detach();
                    });
                    _yuitest_coverline("dd-plugin", 113);
this._widgetHandles = [];
                },
                /**
...
this._widgetHandles.push(this.on(EV_DRAG_END, this._updateStopPosition)); 
                ...
                */
                initializer: function(config) {
                        ...
                        _yuitest_coverfunc("dd-plugin", "initializer", 137);
_yuitest_coverline("dd-plugin", 139);
this._widgetHandles = [];

                        _yuitest_coverline("dd-plugin", 141);
this._widget = config.widget;

                        _yuitest_coverline("dd-plugin", 143);
this.on(EV_START, this._checkEvents); //Always run, don't check
                        
                        _yuitest_coverline("dd-plugin", 145);
this._attachWidgetListeners();
                ...
                */
                _setWidgetCoords: function(e) {
                        ...
                        _yuitest_coverfunc("dd-plugin", "_setWidgetCoords", 156);
_yuitest_coverline("dd-plugin", 159);
var nodeXY = this._stoppedPosition || e.target.nodeXY,
                         ...
                         _yuitest_coverline("dd-plugin", 166);
if (movedXY[0] !== 0 && movedXY[1] !== 0) {
                                 _yuitest_coverline("dd-plugin", 167);
this._widget.set('xy', realXY);
                         }

                         //if only x is 0, set the Y
                         else {_yuitest_coverline("dd-plugin", 171);
if (movedXY[0] === 0) {
                                 _yuitest_coverline("dd-plugin", 172);
this._widget.set('y',realXY[1]);
                         }

                         //otherwise, y is 0, so set X
                         else {_yuitest_coverline("dd-plugin", 176);
if (movedXY[1] === 0){
                                 _yuitest_coverline("dd-plugin", 177);
this._widget.set('x', realXY[0]);
                ...
                */
                _updateStopPosition: function(e) {
                        _yuitest_coverfunc("dd-plugin", "_updateStopPosition", 188);
_yuitest_coverline("dd-plugin", 189);
this._stoppedPosition = e.target.realXY;
                }
        });

        _yuitest_coverline("dd-plugin", 193);
Y.namespace('Plugin');
        _yuitest_coverline("dd-plugin", 194);
Y.Plugin.Drag = Drag;
