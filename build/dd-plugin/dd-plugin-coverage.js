...
_yuitest_coverage["/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('dd-plugin', function(Y) {
        ...
        * @namespace Plugin
        */
        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 17);
var Drag = function(config) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "Drag", 17);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 18);
if (Y.Widget && config.host instanceof Y.Widget) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 19);
config.node = config.host.get('boundingBox');
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 20);
config.widget = config.host;
                } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 22);
config.node = config.host;
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 23);
config.widget = false;
                }
                _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 25);
Drag.superclass.constructor.call(this, config);
        ...
        * @type {String}
        */
        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 37);
Drag.NAME = "dd-plugin";
        ...
        * @type {String}
        */
        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 44);
Drag.NS = "dd";

        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 46);
Y.extend(Drag, Y.DD.Drag, {
                ...
                */
                _usesWidgetPosition: function(widget) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_usesWidgetPosition", 74);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 75);
var r = false;
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 76);
if (widget) {
                                _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 77);
r = (widget.hasImpl && widget.hasImpl(Y.WidgetPosition)) ? true : false;
                        }
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 79);
return r;
                },
                /**
                ...
                */
                _checkEvents: function() {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_checkEvents", 88);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 89);
if (this._widget) {
                        //It's a widget
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 91);
if (this.proxy) {
                            //It's a proxy
                            _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 93);
if (this._widgetHandles.length > 0) {
                                //Remove Listeners
                                _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 95);
this._removeWidgetListeners();
                            }
                        } else {
                            _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 98);
if (this._widgetHandles.length === 0) {
                                _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 99);
this._attachWidgetListeners();
                ...
                */
                _removeWidgetListeners: function() {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_removeWidgetListeners", 109);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 110);
Y.Array.each(this._widgetHandles, function(handle) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "(anonymous 2)", 110);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 111);
handle.detach();
                    });
                    _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 113);
this._widgetHandles = [];
                },
                /**
                ...
                */
                _attachWidgetListeners: function() {
                        ...
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_attachWidgetListeners", 120);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 122);
if (this._usesWidgetPosition(this._widget)) {
                               
                               //set the x,y on the widget's ATTRS
                               _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 125);
this._widgetHandles.push(this.on(EV_DRAG, this._setWidgetCoords));

                               //store the new position that the widget ends up on
                               _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 128);
this._widgetHandles.push(this.on(EV_DRAG_END, this._updateStopPosition)); 
                ...
                */
                initializer: function(config) {
                        ...
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "initializer", 137);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 139);
this._widgetHandles = [];

                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 141);
this._widget = config.widget;

                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 143);
this.on(EV_START, this._checkEvents); //Always run, don't check
                        
                        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 145);
this._attachWidgetListeners();
                ...
                */
                _setWidgetCoords: function(e) {
                        ...
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_setWidgetCoords", 156);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 159);
var nodeXY = this._stoppedPosition || e.target.nodeXY,
                         ...
                         _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 166);
if (movedXY[0] !== 0 && movedXY[1] !== 0) {
                                 _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 167);
this._widget.set('xy', realXY);
                         }

                         //if only x is 0, set the Y
                         else {_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 171);
if (movedXY[0] === 0) {
                                 _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 172);
this._widget.set('y',realXY[1]);
                         }

                         //otherwise, y is 0, so set X
                         else {_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 176);
if (movedXY[1] === 0){
                                 _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 177);
this._widget.set('x', realXY[0]);
                ...
                */
                _updateStopPosition: function(e) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", "_updateStopPosition", 188);
_yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 189);
this._stoppedPosition = e.target.realXY;
                }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 193);
Y.namespace('Plugin');
        _yuitest_coverline("/home/yui/src/yui3/src/dd/build_tmp/dd-plugin.js", 194);
Y.Plugin.Drag = Drag;
