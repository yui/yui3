...
_yuitest_coverage["/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@static
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 21);
var LANG = Y.Lang,
    ...
    SchemaArray = {
        ...
        **/
        apply: function(schema, data) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", "apply", 121);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 122);
var data_in = data,
                data_out = {results:[],meta:{}};

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 125);
if(LANG.isArray(data_in)) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 126);
if(schema && LANG.isArray(schema.resultFields)) {
                    // Parse results data
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 128);
data_out = SchemaArray._parseResults.call(this, schema.resultFields, data_in, data_out);
                }
                else {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 131);
data_out.results = data_in;
                }
            }
            else {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 135);
data_out.error = new Error("Array schema parse failure");
            }

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 138);
return data_out;
        },
        ...
        _parseResults: function(fields, array_in, data_out) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", "_parseResults", 152);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 153);
var results = [],
                result, item, type, field, key, value, i, j;

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 156);
for(i=array_in.length-1; i>-1; i--) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 157);
result = {};
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 158);
item = array_in[i];
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 159);
type = (LANG.isObject(item) && !LANG.isFunction(item)) ? 2 : (LANG.isArray(item)) ? 1 : (LANG.isString(item)) ? 0 : -1;
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 160);
if(type > 0) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 161);
for(j=fields.length-1; j>-1; j--) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 162);
field = fields[j];
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 163);
key = (!LANG.isUndefined(field.key)) ? field.key : field;
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 164);
value = (!LANG.isUndefined(item[key])) ? item[key] : item[j];
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 165);
result[key] = Y.DataSchema.Base.parse.call(this, value, field);
                    }
                }
                else {_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 168);
if(type === 0) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 169);
result = item;
                }
                else {
                    //TODO: null or {}?
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 173);
result = null;
                }}
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 175);
results[i] = result;
            }
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 177);
data_out.results = results;

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 179);
return data_out;
        }
    };

_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-array.js", 183);
