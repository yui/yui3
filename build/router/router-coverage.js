...
this._historyEvents && this._historyEvents.detach();
    ...
    **/
    dispatch: function () {
        _yuitest_coverfunc("/build/router/router.js", "dispatch", 216);
_yuitest_coverline("/build/router/router.js", 217);
this.once(EVT_READY, function () {
            _yuitest_coverfunc("/build/router/router.js", "(anonymous 5)", 217);
...
this._dispatch(this._getPath(), this._getURL());
        ...
        _yuitest_coverline("/build/router/router.js", 227);
return this;
    },
    ...
    **/
    getPath: function () {
        _yuitest_coverfunc("/build/router/router.js", "getPath", 236);
_yuitest_coverline("/build/router/router.js", 237);
return this._getPath();
    ...
    **/
    hasRoute: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "hasRoute", 253);
_yuitest_coverline("/build/router/router.js", 254);
var path;
...
return false;
        ...
        _yuitest_coverline("/build/router/router.js", 260);
if (!this._html5) {
            _yuitest_coverline("/build/router/router.js", 261);
url = this._upgradeURL(url);
        }

        _yuitest_coverline("/build/router/router.js", 264);
...
return !!this.match(path).length;
    ...
    **/
    match: function (path) {
        _yuitest_coverfunc("/build/router/router.js", "match", 296);
_yuitest_coverline("/build/router/router.js", 297);
return YArray.filter(this._routes, function (route) {
            _yuitest_coverfunc("/build/router/router.js", "(anonymous 6)", 297);
_yuitest_coverline("/build/router/router.js", 298);
return path.search(route.regex) > -1;
    ...
    **/
    removeRoot: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "removeRoot", 310);
_yuitest_coverline("/build/router/router.js", 311);
...
url = url.replace(this._regexUrlOrigin, '');
        ...
        _yuitest_coverline("/build/router/router.js", 317);
if (root && url.indexOf(root) === 0) {
            _yuitest_coverline("/build/router/router.js", 318);
...
return url.charAt(0) === '/' ? url : '/' + url;
    ...
    **/
    removeQuery: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "removeQuery", 332);
_yuitest_coverline("/build/router/router.js", 333);
return url.replace(/\?.*$/, '');
    },
    ...
    **/
    replace: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "replace", 366);
_yuitest_coverline("/build/router/router.js", 367);
return this._queue(url, true);
    ...
    **/
    route: function (path, callback) {
        _yuitest_coverfunc("/build/router/router.js", "route", 443);
_yuitest_coverline("/build/router/router.js", 444);
var keys = [];

        _yuitest_coverline("/build/router/router.js", 446);
this._routes.push({
            callback: callback,
            keys    : keys,
            path    : path,
        ...
        _yuitest_coverline("/build/router/router.js", 453);
return this;
    },
    ...
    **/
    save: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "save", 486);
_yuitest_coverline("/build/router/router.js", 487);
return this._queue(url);
    ...
    **/
    upgrade: function () {
        _yuitest_coverfunc("/build/router/router.js", "upgrade", 497);
_yuitest_coverline("/build/router/router.js", 498);
if (!this._html5) {
            _yuitest_coverline("/build/router/router.js", 499);
return false;
        }

        // Get the resolve hash path.
        _yuitest_coverline("/build/router/router.js", 503);
var hashPath = this._getHashPath();

        _yuitest_coverline("/build/router/router.js", 505);
if (hashPath) {
            ...
            // trigger a dispatch.
            _yuitest_coverline("/build/router/router.js", 510);
this.once(EVT_READY, function () {
                _yuitest_coverfunc("/build/router/router.js", "(anonymous 7)", 510);
_yuitest_coverline("/build/router/router.js", 511);
this.replace(hashPath);
            });

            _yuitest_coverline("/build/router/router.js", 514);
return true;
        }

        _yuitest_coverline("/build/router/router.js", 517);
return false;
    },
    ...
    **/
    _decode: function (string) {
        _yuitest_coverfunc("/build/router/router.js", "_decode", 531);
_yuitest_coverline("/build/router/router.js", 532);
return decodeURIComponent(string.replace(/\+/g, ' '));
    ...
    **/
    _dequeue: function () {
        _yuitest_coverfunc("/build/router/router.js", "_dequeue", 544);
...
var self = this,
        ...
        _yuitest_coverline("/build/router/router.js", 551);
if (!YUI.Env.windowLoaded) {
            _yuitest_coverline("/build/router/router.js", 552);
Y.once('load', function () {
                _yuitest_coverfunc("/build/router/router.js", "(anonymous 8)", 552);
...
return fn ? fn() : this;
    ...
    **/
    _dispatch: function (path, url, src) {
        _yuitest_coverfunc("/build/router/router.js", "_dispatch", 577);
_yuitest_coverline("/build/router/router.js", 578);
var self   = this,
            routes = self.match(path),
            req, res;

        _yuitest_coverline("/build/router/router.js", 582);
self._dispatching = self._dispatched = true;

        _yuitest_coverline("/build/router/router.js", 584);
if (!routes || !routes.length) {
            _yuitest_coverline("/build/router/router.js", 585);
self._dispatching = false;
            _yuitest_coverline("/build/router/router.js", 586);
return self;
        }

        _yuitest_coverline("/build/router/router.js", 589);
req = self._getRequest(path, url, src);
        _yuitest_coverline("/build/router/router.js", 590);
res = self._getResponse(req);

        _yuitest_coverline("/build/router/router.js", 592);
req.next = function (err) {
            _yuitest_coverfunc("/build/router/router.js", "next", 592);
...
Y.error(err);
            } else {_yuitest_coverline("/build/router/router.js", 597);
...
callback = typeof route.callback === 'string' ?
                ...
                _yuitest_coverline("/build/router/router.js", 604);
if (matches.length === route.keys.length + 1) {
                    _yuitest_coverline("/build/router/router.js", 605);
req.params = YArray.hash(route.keys, matches.slice(1));
                } else {
                    _yuitest_coverline("/build/router/router.js", 607);
req.params = matches.concat();
                }

                _yuitest_coverline("/build/router/router.js", 610);
req.pendingRoutes = routes.length;

                _yuitest_coverline("/build/router/router.js", 612);
callback.call(self, req, res, req.next);
            }}
        };

        _yuitest_coverline("/build/router/router.js", 616);
req.next();

        _yuitest_coverline("/build/router/router.js", 618);
self._dispatching = false;
        _yuitest_coverline("/build/router/router.js", 619);
return self._dequeue();
    ...
    **/
    _getHashPath: function (hash) {
        _yuitest_coverfunc("/build/router/router.js", "_getHashPath", 632);
...
return '';
    ...
    **/
    _getOrigin: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getOrigin", 653);
...
return location.origin || (location.protocol + '//' + location.host);
    ...
    **/
    _getPath: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getPath", 665);
...
return this.removeQuery(this.removeRoot(path));
    ...
    **/
    _getPathRoot: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getPathRoot", 683);
_yuitest_coverline("/build/router/router.js", 684);
var slash = '/',
...
if (path.charAt(path.length - 1) === slash) {
            _yuitest_coverline("/build/router/router.js", 689);
return path;
        }

        _yuitest_coverline("/build/router/router.js", 692);
segments = path.split(slash);
        _yuitest_coverline("/build/router/router.js", 693);
segments.pop();
...
return segments.join(slash) + slash;
    ...
    **/
    _getQuery: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getQuery", 705);
...
if (this._html5) {
            _yuitest_coverline("/build/router/router.js", 710);
return location.search.substring(1);
        }

        _yuitest_coverline("/build/router/router.js", 713);
hash    = HistoryHash.getHash();
        _yuitest_coverline("/build/router/router.js", 714);
...
return hash && matches ? matches[1] : location.search.substring(1);
    ...
    **/
    _getRegex: function (path, keys) {
        _yuitest_coverfunc("/build/router/router.js", "_getRegex", 730);
...
return path;
        ...
        _yuitest_coverline("/build/router/router.js", 736);
if (path === '*') {
            _yuitest_coverline("/build/router/router.js", 737);
return (/.*/);
        }

        _yuitest_coverline("/build/router/router.js", 740);
path = path.replace(this._regexPathParam, function (match, operator, key) {
            ...
            _yuitest_coverfunc("/build/router/router.js", "(anonymous 9)", 740);
_yuitest_coverline("/build/router/router.js", 743);
if (!key) {
                _yuitest_coverline("/build/router/router.js", 744);
return operator === '*' ? '.*' : match;
            }

            _yuitest_coverline("/build/router/router.js", 747);
keys.push(key);
            _yuitest_coverline("/build/router/router.js", 748);
return operator === '*' ? '(.*?)' : '([^/#?]*)';
        });
...
return new RegExp('^' + path + '$');
    ...
    **/
    _getRequest: function (path, url, src) {
        _yuitest_coverfunc("/build/router/router.js", "_getRequest", 764);
...
return {
    ...
    **/
    _getResponse: function (req) {
        ...
        _yuitest_coverfunc("/build/router/router.js", "_getResponse", 781);
_yuitest_coverline("/build/router/router.js", 784);
var res = function () {
            _yuitest_coverfunc("/build/router/router.js", "res", 784);
_yuitest_coverline("/build/router/router.js", 785);
return req.next.apply(this, arguments);
        };

        _yuitest_coverline("/build/router/router.js", 788);
res.req = req;
...
return res;
    ...
    **/
    _getRoutes: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getRoutes", 799);
...
return this._routes.concat();
    ...
    **/
    _getURL: function () {
        _yuitest_coverfunc("/build/router/router.js", "_getURL", 810);
...
return Y.getLocation().toString();
    ...
    **/
    _hasSameOrigin: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "_hasSameOrigin", 826);
...
var origin = ((url && url.match(this._regexUrlOrigin)) || [])[0];
        ...
        _yuitest_coverline("/build/router/router.js", 830);
if (origin && origin.indexOf('//') === 0) {
            _yuitest_coverline("/build/router/router.js", 831);
...
return !origin || origin === this._getOrigin();
    ...
    **/
    _joinURL: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "_joinURL", 855);
_yuitest_coverline("/build/router/router.js", 856);
var root = this.get('root');

        // Causes `url` to _always_ begin with a "/".
        _yuitest_coverline("/build/router/router.js", 859);
url = this.removeRoot(url);

        _yuitest_coverline("/build/router/router.js", 861);
if (url.charAt(0) === '/') {
            _yuitest_coverline("/build/router/router.js", 862);
url = url.substring(1);
        }
...
return root && root.charAt(root.length - 1) === '/' ?
    ...
    **/
    _normalizePath: function (path) {
        _yuitest_coverfunc("/build/router/router.js", "_normalizePath", 880);
_yuitest_coverline("/build/router/router.js", 881);
var dots  = '..',
            slash = '/',
            i, len, normalized, segments, segment, stack;

        _yuitest_coverline("/build/router/router.js", 885);
if (!path || path === slash) {
...
stack    = [];
        ...
        _yuitest_coverline("/build/router/router.js", 892);
for (i = 0, len = segments.length; i < len; ++i) {
            _yuitest_coverline("/build/router/router.js", 893);
segment = segments[i];

            _yuitest_coverline("/build/router/router.js", 895);
if (segment === dots) {
                _yuitest_coverline("/build/router/router.js", 896);
stack.pop();
            } else {_yuitest_coverline("/build/router/router.js", 897);
if (segment) {
                _yuitest_coverline("/build/router/router.js", 898);
stack.push(segment);
            }}
        }
...
return normalized;
    ...
    **/
    _parseQuery: QS && QS.parse ? QS.parse : function (query) {
        _yuitest_coverfunc("/build/router/router.js", "parse", 921);
_yuitest_coverline("/build/router/router.js", 922);
var decode = this._decode,
        ...
        _yuitest_coverline("/build/router/router.js", 929);
for (; i < len; ++i) {
            _yuitest_coverline("/build/router/router.js", 930);
param = params[i].split('=');

            _yuitest_coverline("/build/router/router.js", 932);
if (param[0]) {
                _yuitest_coverline("/build/router/router.js", 933);
...
return result;
    ...
    **/
    _queue: function () {
        _yuitest_coverfunc("/build/router/router.js", "_queue", 956);
_yuitest_coverline("/build/router/router.js", 957);
var args = arguments,
            self = this;

        _yuitest_coverline("/build/router/router.js", 960);
saveQueue.push(function () {
            _yuitest_coverfunc("/build/router/router.js", "(anonymous 10)", 960);
...
setTimeout(function () {
                        _yuitest_coverfunc("/build/router/router.js", "(anonymous 11)", 970);
...
self._dispatching = true; // otherwise we'll dequeue too quickly
                _yuitest_coverline("/build/router/router.js", 976);
self._save.apply(self, args);
            }

            _yuitest_coverline("/build/router/router.js", 979);
return self;
        });

        _yuitest_coverline("/build/router/router.js", 982);
return !this._dispatching ? this._dequeue() : this;
    ...
    **/
    _resolvePath: function (path) {
        _yuitest_coverfunc("/build/router/router.js", "_resolvePath", 995);
_yuitest_coverline("/build/router/router.js", 996);
if (!path) {
            _yuitest_coverline("/build/router/router.js", 997);
return Y.getLocation().pathname;
        }

        _yuitest_coverline("/build/router/router.js", 1000);
if (path.charAt(0) !== '/') {
...
return this._normalizePath(path);
    ...
    **/
    _resolveURL: function (url) {
        _yuitest_coverfunc("/build/router/router.js", "_resolveURL", 1022);
_yuitest_coverline("/build/router/router.js", 1023);
var parts    = url && url.match(this._regexURL),
            origin, path, query, hash, resolved;

        _yuitest_coverline("/build/router/router.js", 1026);
if (!parts) {
            _yuitest_coverline("/build/router/router.js", 1027);
return this._getURL();
        }
...
query  = parts[3];
        _yuitest_coverline("/build/router/router.js", 1033);
hash   = parts[4];
...
if (origin) {
            ...
            _yuitest_coverline("/build/router/router.js", 1038);
if (origin.indexOf('//') === 0) {
...
resolved = this._getOrigin() + this._resolvePath(path);
        ...
        _yuitest_coverline("/build/router/router.js", 1049);
if (path || query) {
...
query = this._getQuery();
        ...
        _yuitest_coverline("/build/router/router.js", 1055);
return resolved + (query ? ('?' + query) : '') + (hash || '');
    ...
    **/
    _save: function (url, replace) {
        _yuitest_coverfunc("/build/router/router.js", "_save", 1072);
_yuitest_coverline("/build/router/router.js", 1073);
var urlIsString = typeof url === 'string',
            currentPath, root;

        // Perform same-origin check on the specified URL.
        _yuitest_coverline("/build/router/router.js", 1077);
...
urlIsString && (url = this._joinURL(url));
        ...
        _yuitest_coverline("/build/router/router.js", 1087);
this._ready = true;

        _yuitest_coverline("/build/router/router.js", 1089);
if (this._html5) {
            _yuitest_coverline("/build/router/router.js", 1090);
...
currentPath = Y.getLocation().pathname;
            _yuitest_coverline("/build/router/router.js", 1093);
root        = this.get('root');
...
return this;
    ...
    **/
    _setRoutes: function (routes) {
        _yuitest_coverfunc("/build/router/router.js", "_setRoutes", 1123);
_yuitest_coverline("/build/router/router.js", 1124);
this._routes = [];

        _yuitest_coverline("/build/router/router.js", 1126);
YArray.each(routes, function (route) {
            _yuitest_coverfunc("/build/router/router.js", "(anonymous 12)", 1126);
_yuitest_coverline("/build/router/router.js", 1127);
...
return this._routes.concat();
    ...
    **/
    _upgradeURL: function (url) {
        ...
        _yuitest_coverfunc("/build/router/router.js", "_upgradeURL", 1149);
_yuitest_coverline("/build/router/router.js", 1151);
if (!this._hasSameOrigin(url)) {
...
return url;
    ...
    **/
    _afterHistoryChange: function (e) {
        _yuitest_coverfunc("/build/router/router.js", "_afterHistoryChange", 1183);
_yuitest_coverline("/build/router/router.js", 1184);
var self       = this,
            src        = e.src,
            prevURL    = self._url,
...
self._dispatch(self._getPath(), currentURL, src);
    ...
    **/
    _defReadyFn: function (e) {
        _yuitest_coverfunc("/build/router/router.js", "_defReadyFn", 1214);
_yuitest_coverline("/build/router/router.js", 1215);
this._ready = true;
    }
}, {
    // -- Static Properties ----------------------------------------------------
    ...
    ATTRS: {
        ...
        **/
        html5: {
            ...
            valueFn: function () { _yuitest_coverfunc("/build/router/router.js", "valueFn", 1239);
...
return Y.Router.html5; },
    ...
    **/
    dispatch: function () {
        _yuitest_coverfunc("/build/router/router.js", "dispatch", 1307);
_yuitest_coverline("/build/router/router.js", 1308);
var i, len, router;

        _yuitest_coverline("/build/router/router.js", 1310);
for (i = 0, len = instances.length; i < len; i += 1) {
            _yuitest_coverline("/build/router/router.js", 1311);
router = instances[i];

            _yuitest_coverline("/build/router/router.js", 1313);
if (router) {
                _yuitest_coverline("/build/router/router.js", 1314);
...
@see Router
**/
_yuitest_coverline("/build/router/router.js", 1331);
