...
_yuitest_coverage["/home/yui/src/yui3/src/substitute/build_tmp/substitute.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 */
    ...
    _yuitest_coverfunc("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 10);
var L = Y.Lang, DUMP = 'dump', SPACE = ' ', LBRACE = '{', RBRACE = '}',
    ...
    **/
    ...
    substitute = function(s, o, f, recurse) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", "substitute", 74);
_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 75);
var i, j, k, key, v, meta, saved = [], token, dump,
            lidx = s.length;

        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 78);
for (;;) {
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 79);
i = s.lastIndexOf(LBRACE, lidx);
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 80);
if (i < 0) {
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 81);
break;
            }
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 83);
j = s.indexOf(RBRACE, i);
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 84);
if (i + 1 >= j) {
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 85);
break;
            }

            //Extract key and meta info
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 89);
token = s.substring(i + 1, j);
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 90);
key = token;
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 91);
meta = null;
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 92);
k = key.indexOf(SPACE);
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 93);
if (k > -1) {
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 94);
meta = key.substring(k + 1);
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 95);
key = key.substring(0, k);
            }

            // lookup the value
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 99);
v = o[key];

            // if a substitution function was provided, execute it
            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 102);
if (f) {
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 103);
v = f(key, v, meta);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 106);
if (L.isObject(v)) {
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 107);
if (!Y.dump) {
                    _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 108);
v = v.toString();
                } else {
                    _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 110);
if (L.isArray(v)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 111);
v = Y.dump(v, parseInt(meta, 10));
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 113);
meta = meta || '';

                        // look for the keyword 'dump', if found force obj dump
                        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 116);
dump = meta.indexOf(DUMP);
                        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 117);
if (dump > -1) {
                            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 118);
meta = meta.substring(4);
                        }

                        // use the toString if it is not the Object toString
                        // and the 'dump' meta info was not found
                        _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 123);
if (v.toString === Object.prototype.toString ||
                            dump > -1) {
                            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 125);
v = Y.dump(v, parseInt(meta, 10));
                        } else {
                            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 127);
v = v.toString();
                        }
                    }
                }
			} else {_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 131);
if (L.isUndefined(v)) {
                // This {block} has no replace string. Save it for later.
                _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 133);
v = '~-' + saved.length + '-~';
					_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 134);
saved.push(token);

                // break;
            }}

            _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 139);
s = s.substring(0, i) + v + s.substring(j + 1);

			_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 141);
if (!recurse) {
				_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 142);
lidx = i - 1;
			} 
		}
		// restore saved {block}s and escaped braces

		_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 147);
return s
			.replace(savedRegExp, function (str, p1, p2) {
				_yuitest_coverfunc("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", "(anonymous 2)", 148);
_yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 149);
return LBRACE + saved[parseInt(p2,10)] + RBRACE;
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 156);
Y.substitute = substitute;
    _yuitest_coverline("/home/yui/src/yui3/src/substitute/build_tmp/substitute.js", 157);
