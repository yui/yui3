...
_yuitest_coverage["/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @class ClickableRail
 */
_yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 17);
function ClickableRail() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "ClickableRail", 17);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 18);
this._initClickableRail();
}

_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 21);
Y.ClickableRail = Y.mix(ClickableRail, {
    ...
    prototype: {
        ...
        _initClickableRail: function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_initClickableRail", 32);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 33);
this._evtGuid = this._evtGuid || (Y.guid() + '|');
             ...
             */
            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 45);
this.publish('railMouseDown', {
                defaultFn: this._defRailMouseDownFn
            });

            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 49);
this.after('render', this._bindClickableRail);
            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 50);
this.on('destroy', this._unbindClickableRail);
        ...
        _bindClickableRail: function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_bindClickableRail", 59);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 60);
this._dd.addHandle(this.rail);

            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 62);
this.rail.on(this._evtGuid + Y.DD.Drag.START_EVENT,
        ...
        _unbindClickableRail: function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_unbindClickableRail", 72);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 73);
if (this.get('rendered')) {
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 74);
var contentBox = this.get('contentBox'),
                    rail = contentBox.one('.' + this.getClassName('rail'));

                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 77);
rail.detach(this.evtGuid + '*');
        ...
        _onRailMouseDown: function (e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_onRailMouseDown", 88);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 89);
if (this.get('clickableRail') && !this.get('disabled')) {
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 90);
this.fire('railMouseDown', { ev: e });
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 91);
this.thumb.focus();
            }
        },
        ...
        _defRailMouseDownFn: function (e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_defRailMouseDownFn", 104);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 105);
e = e.ev;

            // Logic that determines which thumb should be used is abstracted
            // to someday support multi-thumb sliders
            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 109);
var dd     = this._resolveThumb(e),
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 116);
if (dd) {
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 117);
thumb = dd.get('dragNode');
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 118);
thumbSize = parseFloat(thumb.getStyle(this._key.dim), 10);

                // Step 1. Allow for aligning to thumb center or edge, etc
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 121);
xy = this._getThumbDestination(e, thumb);

                // Step 2. Remove page offsets to give just top/left style val
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 124);
xy = xy[ i ] - this.rail.getXY()[i];
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 128);
xy = Math.min(
                        Math.max(xy, 0),
                        (length - thumbSize));

                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 132);
this._uiMoveThumb(xy, { source: 'rail' });
                ...
                // Slider moves).
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 140);
e.target = this.thumb.one('img') || this.thumb;

                // Delegate to DD's natural behavior
                _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 143);
dd._handleMouseDownEvent(e);
        ...
        _resolveThumb: function (e) {
             ...
             */
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_resolveThumb", 161);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 168);
return this._dd;
        },
        ...
        _getThumbDestination: function (e, node) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", "_getThumbDestination", 181);
_yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 182);
var offsetWidth  = node.get('offsetWidth'),
                offsetHeight = node.get('offsetHeight');

            // center
            _yuitest_coverline("/home/yui/src/yui3/src/slider/build_tmp/clickable-rail.js", 186);
return [
