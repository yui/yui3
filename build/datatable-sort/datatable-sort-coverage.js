...
_yuitest_coverage["build/datatable-sort/datatable-sort.js"].lines = {"1":0,"11":0,"108":0,"110":0,"173":0,"215":0,"246":0,"251":0,"252":0,"253":0,"254":0,"257":0,"258":0,"260":0,"261":0,"262":0,"264":0,"265":0,"266":0,"267":0,"272":0,"273":0,"274":0,"275":0,"276":0,"282":0,"303":0,"306":0,"307":0,"308":0,"311":0,"329":0,"330":0,"344":0,"346":0,"347":0,"348":0,"349":0,"363":0,"365":0,"366":0,"371":0,"372":0,"387":0,"420":0,"423":0,"426":0,"427":0,"429":0,"430":0,"431":0,"438":0,"440":0,"453":0,"455":0,"457":0,"459":0,"461":0,"463":0,"470":0,"474":0,"488":0,"496":0,"497":0,"500":0,"501":0,"502":0,"505":0,"506":0,"509":0,"510":0,"511":0,"512":0,"513":0,"515":0,"519":0,"522":0,"523":0,"526":0,"530":0,"543":0,"557":0,"561":0,"562":0,"567":0,"569":0,"570":0,"571":0,"573":0,"574":0,"575":0,"576":0,"579":0,"580":0,"584":0,"585":0,"588":0,"590":0,"593":0,"609":0,"613":0,"614":0,"615":0,"619":0,"620":0,"623":0,"624":0,"627":0,"628":0,"630":0,"631":0,"632":0,"633":0,"639":0,"650":0,"652":0,"665":0,"670":0,"673":0,"674":0,"676":0,"678":0,"680":0,"684":0,"686":0,"687":0,"688":0,"690":0,"691":0,"693":0,"694":0,"695":0,"696":0,"701":0,"706":0,"708":0,"709":0,"711":0,"712":0,"715":0,"717":0,"758":0,"773":0,"782":0,"786":0,"787":0,"791":0,"792":0,"796":0,"797":0,"798":0,"802":0,"806":0,"807":0,"810":0,"812":0,"813":0,"818":0,"819":0,"820":0,"821":0,"823":0,"824":0,"826":0,"828":0,"829":0,"831":0,"833":0,"837":0,"838":0,"844":0,"846":0,"849":0,"861":0,"864":0,"879":0,"892":0,"900":0,"902":0};
_yuitest_coverage["build/datatable-sort/datatable-sort.js"].functions = {"Sortable:108":0,"sort:202":0,"toggleSort:245":0,"_afterSortByChange:298":0,"_afterSortDataChange:324":0,"_afterSortRecordChange:343":0,"_bindSortUI:362":0,"_defSortFn:386":0,"_getSortBy:419":0,"initializer:452":0,"_compare:496":0,"_initSortFn:487":0,"_initSortStrings:541":0,"_onUITriggerSort:556":0,"_parseSortable:608":0,"_renderSortable:649":0,"_setSortBy:664":0,"_sortComparator:756":0,"(anonymous 2):791":0,"_uiSetSortable:772":0,"_validateSortable:878":0,"_validateSortBy:891":0,"(anonymous 1):1":0};
_yuitest_coverage["build/datatable-sort/datatable-sort.js"].coveredLines = 179;
...
var id = e.currentTarget.getAttribute('data-yui3-col-id'),
        ...
        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 561);
...
if (!isObject(sortBy[i])) {
                            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 576);
sortBy[i] = {};
                        }
...
if (i >= len) {
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 585);
sortBy.push(column._id);
                }
            } else {
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 588);
sortBy = [{}];
...
sortBy[0][id] = -(column.sortDir||0) || 1;
            ...
            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 593);
this.fire('sort', {
                originEvent: e,
                sortBy: sortBy
            });
    ...
    **/
    _parseSortable: function () {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_parseSortable", 608);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 609);
...
if (isArray(sortable)) {
            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 614);
for (i = 0, len = sortable.length; i < len; ++i) {
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 615);
col = sortable[i];

                // isArray is called because arrays are objects, but will rely
                // on getColumn to nullify them for the subsequent if (col)
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 619);
...
columns.push(col);
        ...
        } else {_yuitest_coverline("build/datatable-sort/datatable-sort.js", 627);
if (sortable) {
...
if (sortable === 'auto') {
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 631);
for (i = columns.length - 1; i >= 0; --i) {
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 632);
if (!columns[i].sortable) {
                        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 633);
columns.splice(i, 1);
                    }
                }
            }
        ...
        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 639);
this._sortable = columns;
    ...
    **/
    _renderSortable: function () {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_renderSortable", 649);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 650);
this._uiSetSortable();

        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 652);
this._bindSortUI();
    },
    ...
    **/
    _setSortBy: function () {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_setSortBy", 664);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 665);
...
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 674);
column = columns[i];

            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 676);
delete column.sortDir;

            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 678);
if (column.className) {
...
if (field.hasOwnProperty(name)) {
                        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 695);
dir = dirMap[field[name]];
                        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 696);
break;
                    }
                }
            }
...
column.sortDir = dir;
                    ...
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 711);
if (!column.className) {
                        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 712);
column.className = '';
                    }

                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 715);
column.className += sortedClass;

                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 717);
this._sortBy.push(column);
    ...
    **/
    _sortComparator: function (item) {
        ...
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_sortComparator", 756);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 758);
return item;
    },
    ...
    **/
    _uiSetSortable: function () {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_uiSetSortable", 772);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 773);
var columns       = this._sortable || [],
        ...
        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 782);
this.get('boundingBox').toggleClass(
            this.getClassName('sortable'),
            columns.length);

        _yuitest_coverline("build/datatable-sort/datatable-sort.js", 786);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 787);
...
this._theadNode.all('.' + sortableClass).each(function (node) {
            _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "(anonymous 2)", 791);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 792);
var col       = sortableCols[node.get('id')],
                liner     = node.one('.' + linerClass),
                indicator;

            _yuitest_coverline("build/datatable-sort/datatable-sort.js", 796);
if (col) {
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 797);
if (!col.sortDir) {
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 798);
node.removeClass(ascClass)
                        .removeClass(descClass);
                }
            } else {
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 802);
...
if (col.sortDir) {
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 829);
node.addClass(ascClass);

                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 831);
node.toggleClass(descClass, desc);

                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 833);
...
if (!liner) {
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 838);
liner = Y.Node.create(Y.Lang.sub(
                    ...
                    _yuitest_coverline("build/datatable-sort/datatable-sort.js", 844);
...
node.append(liner);
                ...
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 849);
title = sub(this.getString(
                ...
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 861);
node.setAttribute('title', title);
                // To combat VoiceOver from reading the sort title as the
                // column header
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 864);
node.setAttribute('aria-labelledby', col.id);
    ...
    **/
    _validateSortable: function (val) {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_validateSortable", 878);
...
return val === 'auto' || isBoolean(val) || isArray(val);
    ...
    **/
    _validateSortBy: function (val) {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_validateSortBy", 891);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 892);
return val === null ||
               isString(val) ||
               isObject(val, true) ||
...
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 900);
Y.DataTable.Sortable = Sortable;

_yuitest_coverline("build/datatable-sort/datatable-sort.js", 902);
