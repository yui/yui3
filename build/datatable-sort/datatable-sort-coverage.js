...
node.setAttribute('title', title);
                ...
                // column header
                _yuitest_coverline("build/datatable-sort/datatable-sort.js", 858);
node.setAttribute('aria-labelledby', col.id);
    ...
    **/
    _validateSortable: function (val) {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_validateSortable", 872);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 873);
return val === 'auto' || isBoolean(val) || isArray(val);
    ...
    **/
    _validateSortBy: function (val) {
        _yuitest_coverfunc("build/datatable-sort/datatable-sort.js", "_validateSortBy", 885);
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 886);
return val === null ||
               isString(val) ||
               isObject(val, true) ||
...
_yuitest_coverline("build/datatable-sort/datatable-sort.js", 894);
Y.DataTable.Sortable = Sortable;

_yuitest_coverline("build/datatable-sort/datatable-sort.js", 896);
