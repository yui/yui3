...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 11);
var YLang     = Y.Lang,
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 108);
function Sortable() {}

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 110);
Sortable.ATTRS = {
...
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 173);
Y.mix(Sortable.prototype, {
    ...
    **/
    sort: function (fields, payload) {
        ...
        **/
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "sort", 202);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 215);
return this.fire('sort', Y.merge((payload || {}), {
    ...
    **/
    toggleSort: function (columns, payload) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "toggleSort", 245);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 246);
var current = this._sortBy,
            sortBy = [],
            i, len, j, col, index;

        // To avoid updating column configs or sortBy directly
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 251);
for (i = 0, len = current.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 252);
col = {};
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 253);
col[current[i]._id] = current[i].sortDir;
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 254);
sortBy.push(col);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 257);
if (columns) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 258);
columns = toArray(columns);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 260);
for (i = 0, len = columns.length; i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 261);
col = columns[i];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 262);
index = -1;

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 264);
for (j = sortBy.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 265);
if (sortBy[j][col]) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 266);
sortBy[j][col] *= -1;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 267);
break;
                    }
                }
            }
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 272);
for (i = 0, len = sortBy.length; i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 273);
for (col in sortBy[i]) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 274);
if (sortBy[i].hasOwnProperty(col)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 275);
sortBy[i][col] *= -1;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 276);
break;
                    }
                }
            }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 282);
return this.fire('sort', Y.merge((payload || {}), {
            sortBy: sortBy
        }));
    },
    ...
    **/
    _afterSortByChange: function (e) {
        ...
        // fail.
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_afterSortByChange", 298);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 303);
this._setSortBy();

        // Don't sort unless sortBy has been set
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 306);
if (this._sortBy.length) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 307);
if (!this.data.comparator) {
                 _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 308);
this.data.comparator = this._sortComparator;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 311);
this.data.sort();
        }
    },
    ...
    **/
    _afterSortDataChange: function (e) {
        ...
        // ModelList.
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_afterSortDataChange", 324);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 329);
if (e.prevVal !== e.newVal || e.newVal.hasOwnProperty('_compare')) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 330);
this._initSortFn();
        }
    },
    ...
    **/
    _afterSortRecordChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_afterSortRecordChange", 343);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 344);
var i, len;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 346);
for (i = 0, len = this._sortBy.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 347);
if (e.changed[this._sortBy[i].key]) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 348);
this.data.sort();
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 349);
break;
            }
        }
    },
    ...
    **/
    _bindSortUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_bindSortUI", 362);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 363);
var handles = this._eventHandles;
        
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 365);
if (!handles.sortAttrs) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 366);
handles.sortAttrs = this.after(
                ['sortableChange', 'sortByChange', 'columnsChange'],
                Y.bind('_uiSetSortable', this));
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 371);
if (!handles.sortUITrigger && this._theadNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 372);
handles.sortUITrigger = this.delegate(['click','keydown'],
    ...
    **/
    _defSortFn: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_defSortFn", 386);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 387);
this.set.apply(this, ['sortBy', e.sortBy].concat(e.details));
    ...
    **/
    _getSortBy: function (val, detail) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_getSortBy", 419);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 420);
var state, i, len, col;

        // "sortBy." is 7 characters. Used to catch 
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 423);
detail = detail.slice(7);

        // TODO: table.get('sortBy.asObject')? table.get('sortBy.json')?
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 426);
if (detail === 'state') {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 427);
state = [];

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 429);
for (i = 0, len = this._sortBy.length; i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 430);
col = this._sortBy[i];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 431);
state.push({
                    column: col._id,
                    dir: col.sortDir
                });
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 438);
return { state: (state.length === 1) ? state[0] : state };
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 440);
return val;
        }
    },
    ...
    **/
    initializer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "initializer", 452);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 453);
var boundParseSortable = Y.bind('_parseSortable', this);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 455);
this._parseSortable();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 457);
this._setSortBy();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 459);
this._initSortFn();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 461);
this._initSortStrings();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 463);
this.after({
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 470);
this.data.after(this.data.model.NAME + ":change",
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 474);
this.publish('sort', {
    ...
    **/
    _initSortFn: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_initSortFn", 487);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 488);
var self = this;
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 496);
this.data._compare = function (a, b) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_compare", 496);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 497);
var cmp = 0,
                i, len, col, dir, aa, bb;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 500);
for (i = 0, len = self._sortBy.length; !cmp && i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 501);
col = self._sortBy[i];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 502);
dir = col.sortDir;

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 504);
if (col.sortFn) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 505);
cmp = col.sortFn(a, b, (dir === -1));
                } else {
                    // FIXME? Requires columns without sortFns to have key
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 508);
aa = a.get(col.key) || '';
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 509);
bb = b.get(col.key) || '';

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 511);
cmp = (aa > bb) ? dir : ((aa < bb) ? -dir : 0);
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 515);
return cmp;
        };

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 518);
if (this._sortBy.length) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 519);
this.data.comparator = this._sortComparator;

            // TODO: is this necessary? Should it be elsewhere?
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 522);
this.data.sort();
        } else {
            // Leave the _compare method in place to avoid having to set it
            // up again.  Mistake?
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 526);
delete this.data.comparator;
    ...
    **/
    _initSortStrings: function () {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_initSortStrings", 537);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 539);
this.set('strings', Y.mix((this.get('strings') || {}), 
    ...
    **/
    _onUITriggerSort: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_onUITriggerSort", 552);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 553);
var id = e.currentTarget.getAttribute('data-yui3-col-id'),
            sortBy = e.shiftKey ? this.get('sortBy') : [{}],
            column = id && this.getColumn(id),
            i, len;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 558);
if (e.type === 'keydown' && e.keyCode !== 32) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 559);
return;
        }

        // In case a headerTemplate injected a link
        // TODO: Is this overreaching?
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 564);
e.preventDefault();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 566);
if (column) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 567);
if (e.shiftKey) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 568);
for (i = 0, len = sortBy.length; i < len; ++i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 569);
if (id === sortBy[i] || Math.abs(sortBy[i][id] === 1)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 570);
if (!isObject(sortBy[i])) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 571);
sortBy[i] = {};
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 574);
sortBy[i][id] = -(column.sortDir|0) || 1;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 575);
break;
                    }
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 579);
if (i >= len) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 580);
sortBy.push(column._id);
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 583);
sortBy[0][id] = -(column.sortDir|0) || 1;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 586);
this.fire('sort', {
                originEvent: e,
                sortBy: sortBy
            });
    ...
    **/
    _parseSortable: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_parseSortable", 601);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 602);
var sortable = this.get('sortable'),
            columns  = [],
            i, len, col;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 606);
if (isArray(sortable)) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 607);
for (i = 0, len = sortable.length; i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 608);
col = sortable[i];

                // isArray is called because arrays are objects, but will rely
                // on getColumn to nullify them for the subsequent if (col)
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 612);
if (!isObject(col, true) || isArray(col)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 613);
col = this.getColumn(col);
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 616);
if (col) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 617);
columns.push(col);
                }
            }
        } else {_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 620);
if (sortable) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 621);
columns = this._displayColumns.slice();

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 623);
if (sortable === 'auto') {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 624);
for (i = columns.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 625);
if (!columns[i].sortable) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 626);
columns.splice(i, 1);
                    }
                }
            }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 632);
this._sortable = columns;
    ...
    **/
    _renderSortable: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_renderSortable", 642);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 643);
this._uiSetSortable();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 645);
this._bindSortUI();
    },
    ...
    **/
    _setSortBy: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_setSortBy", 657);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 658);
var columns     = this._displayColumns,
            sortBy      = this.get('sortBy') || [],
            sortedClass = ' ' + this.getClassName('sorted'),
            i, len, name, dir, field, column;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 663);
this._sortBy = [];

        // Purge current sort state from column configs
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 666);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 667);
column = columns[i];

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 669);
delete column.sortDir;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 671);
if (column.className) {
                // TODO: be more thorough
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 673);
column.className = column.className.replace(sortedClass, '');
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 677);
sortBy = toArray(sortBy);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 679);
for (i = 0, len = sortBy.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 680);
name = sortBy[i];
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 681);
dir  = 1;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 683);
if (isObject(name)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 684);
field = name;
                // Have to use a for-in loop to process sort({ foo: -1 })
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 686);
for (name in field) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 687);
if (field.hasOwnProperty(name)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 688);
dir = dirMap[field[name]];
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 689);
break;
                    }
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 694);
if (name) {
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 699);
column = this.getColumn(name) || { _id: name, key: name };

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 701);
if (column) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 702);
column.sortDir = dir;

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 704);
if (!column.className) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 705);
column.className = '';
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 708);
column.className += sortedClass;

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 710);
this._sortBy.push(column);
    ...
    **/
    _sortComparator: function (item) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_sortComparator", 749);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 751);
return item;
    },
    ...
    **/
    _uiSetSortable: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_uiSetSortable", 765);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 766);
var columns       = this._sortable || [],
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 775);
this.get('boundingBox').toggleClass(
            this.getClassName('sortable'),
            columns.length);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 779);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 780);
sortableCols[columns[i].id] = columns[i];
        }

        // TODO: this.head.render() + decorate cells?
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 784);
this._theadNode.all('.' + sortableClass).each(function (node) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "(anonymous 2)", 784);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 785);
var col       = sortableCols[node.get('id')],
                liner     = node.one('.' + linerClass),
                indicator;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 789);
if (col) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 790);
if (!col.sortDir) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 791);
node.removeClass(ascClass)
                        .removeClass(descClass);
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 795);
node.removeClass(sortableClass)
                    .removeClass(ascClass)
                    .removeClass(descClass);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 799);
if (liner) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 800);
liner.replace(liner.get('childNodes').toFrag());
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 803);
indicator = node.one('.' + indicatorClass);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 805);
if (indicator) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 806);
indicator.remove().destroy(true);
                }
            }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 811);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 812);
col  = columns[i];
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 813);
node = this._theadNode.one('#' + col.id);
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 814);
desc = col.sortDir === -1;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 816);
if (node) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 817);
liner = node.one('.' + linerClass);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 819);
node.addClass(sortableClass);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 821);
if (col.sortDir) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 822);
node.addClass(ascClass);

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 824);
node.toggleClass(descClass, desc);

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 826);
node.setAttribute('aria-sort', desc ?
                        'descending' : 'ascending');
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 830);
if (!liner) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 831);
liner = Y.Node.create(Y.Lang.sub(
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 837);
liner.prepend(node.get('childNodes').toFrag());

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 839);
node.append(liner);
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 842);
title = sub(this.getString(
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 848);
node.setAttribute('title', title);
                // To combat VoiceOver from reading the sort title as the
                // column header
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 851);
node.setAttribute('aria-labelledby', col.id);
    ...
    **/
    _validateSortable: function (val) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_validateSortable", 865);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 866);
return val === 'auto' || isBoolean(val) || isArray(val);
    ...
    **/
    _validateSortBy: function (val) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", "_validateSortBy", 878);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 879);
return val === null ||
               isString(val) ||
               isObject(val, true) ||
...
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 887);
Y.DataTable.Sortable = Sortable;

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-sort.js", 889);
