...
CanvasDrawing.prototype = {
    ...
    _toRGBA: function(val, alpha) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toRGBA", 84);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 85);
alpha = (alpha !== undefined) ? alpha : 1;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 86);
if (!Y_Color.re_RGB.test(val)) {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 87);
val = TOHEX(val);
        }
...
val = 'rgba(' + [
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 97);
return val;
    },
     ...
     */
    _toRGB: function(val) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toRGB", 107);
...
return TORGB(val);
	...
	setSize: function(w, h) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setSize", 119);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 120);
if(this.get("autoSize"))
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 122);
...
this.node.setAttribute("height", h);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_updateCoords", 143);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 145);
this._xcoords.push(x);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 146);
this._ycoords.push(y);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 147);
this._currentX = x;
...
this._currentY = y;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_clearAndUpdateCoords", 157);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 159);
var x = this._xcoords.pop() || 0,
            y = this._ycoords.pop() || 0;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 161);
this._updateCoords(x, y);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_updateNodePosition", 170);
...
node.style.left = (x + this._left) + "px";
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 177);
node.style.top = (y + this._top) + "px";
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_updateDrawingQueue", 189);
...
this._methods.push(val);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "lineTo", 201);
...
if (typeof point1 === 'string' || typeof point1 === 'number') {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 214);
args = [[point1, point2]];
        }

        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 217);
len = args.length;
...
if(args[i])
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 222);
x = args[i][0];
...
return this;
     ...
     */
    moveTo: function(x, y) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "moveTo", 242);
...
return this;
     ...
     */
    curveTo: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "curveTo", 265);
...
this._curveTo.apply(this, [Y.Array(arguments), false]);
    ...
    relativeCurveTo: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "relativeCurveTo", 280);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 281);
this._curveTo.apply(this, [Y.Array(arguments), true]);
    },
    
    _curveTo: function(args, relative) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_curveTo", 284);
...
len = args.length - 5;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 297);
for(; i < len; i = i + 6)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 299);
cp1x = parseFloat(args[i]) + relativeX;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 300);
cp1y = parseFloat(args[i + 1]) + relativeY;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 301);
cp2x = parseFloat(args[i + 2]) + relativeX;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 302);
...
y = parseFloat(args[i + 5]) + relativeY;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 305);
...
bottom = Math.max(y, Math.max(cp1y, cp2y));
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 309);
left = Math.min(x, Math.min(cp1x, cp2x));
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 310);
...
this._currentY = y;
    ...
    quadraticCurveTo: function(cpx, cpy, x, y) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "quadraticCurveTo", 329);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 330);
var w,
            h,
            pts,
            right,
...
right = Math.max(x, cpx);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 341);
...
top = Math.min(y, cpy);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 344);
w = Math.abs(right - left);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 345);
h = Math.abs(bottom - top);
...
this._updateCoords(x, y);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 349);
return this;
    },
	...
	drawCircle: function(x, y, radius) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawCircle", 361);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 362);
var startAngle = 0,
            endAngle = 2 * Math.PI,
            wt = this._stroke && this._strokeWeight ? this._strokeWeight : 0,
            circum = radius * 2;
...
return this;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawDiamond", 385);
...
return this;
	...
	drawEllipse: function(x, y, w, h) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawEllipse", 407);
...
cx = centerX + Math.cos(angleMid) * (radius / Math.cos(theta / 2));
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 430);
cy = centerY + Math.sin(angleMid) * (yRadius / Math.cos(theta / 2));
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 431);
this._updateDrawingQueue(["quadraticCurveTo", cx, cy, bx, by]);
        }
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 433);
this._trackSize(x + w + wt, y + h + wt);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 434);
this._trackSize(x - wt, y - wt);
...
return this;
    ...
    drawRect: function(x, y, w, h) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawRect", 448);
...
return this;
    ...
    drawRoundRect: function(x, y, w, h, ew, eh) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawRoundRect", 470);
...
return this;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "drawWedge", 497);
...
this._drawingComplete = false;
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 516);
this._updateDrawingQueue(["moveTo", x, y]);
...
if(Math.abs(arc) > 360)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 523);
arc = 360;
        }
...
return this;
     ...
     */
        ...
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "end", 571);
...
return this;
    ...
    closePath: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "closePath", 581);
...
this._updateDrawingQueue(["beginPath"]);
    ...
    _getLinearGradient: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getLinearGradient", 600);
...
if(r > 90 && r < 270)
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 640);
x1 = x + w;
...
x1 = x;
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 646);
x2 = x + w;
            }
...
return gradient;
    ...
    _getRadialGradient: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getRadialGradient", 680);
...
y2 = y + h/2;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 708);
r2 = w * r;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 709);
d = Math.sqrt( Math.pow(Math.abs(xc - x1), 2) + Math.pow(Math.abs(yc - y1), 2) );
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 710);
if(d >= r2)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 712);
ratio = d/r2;
...
if(r >= 0.5)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 731);
gradient = this._context.createRadialGradient(x1, y1, r, x2, y2, r * w);
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 732);
stopMultiplier = 1;
        }
        else
        {
...
offset *= stopMultiplier;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 756);
if(offset <= 1)
            {
...
return gradient;
     ...
     */
    _initProps: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_initProps", 771);
...
this._currentY = 0;
    ...
    _createGraphic: function(config) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_createGraphic", 802);
...
return graphic;
    ...
    getBezierData: function(points, t) {  
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getBezierData", 816);
...
return [ tmp[0][0], tmp[0][1] ]; 
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_setCurveBoundingBox", 844);
...
this._trackSize(left - wt, top - wt);
    ...
    _trackSize: function(w, h) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_trackSize", 879);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 880);
if (w > this._right) {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 881);
this._right = w;
        }
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 883);
if(w < this._left)
        {
...
{
    _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasShape", 911);
...
this.matrix = new Y.Matrix();
    _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 915);
...
Y.extend(CanvasShape, Y.GraphicBase, Y.mix({
    ...
    init: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "init", 928);
...
this.initializer.apply(this, arguments);
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "initializer", 939);
...
if(data)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 954);
...
host._updateHandler();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_setGraphic", 967);
...
this._graphic = graphic;
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "addClass", 991);
...
node.addClass(className);
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "removeClass", 1003);
...
node.removeClass(className);
	...
	getXY: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getXY", 1015);
...
return [parentXY[0] + x, parentXY[1] + y];
	...
	setXY: function(xy)
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setXY", 1030);
...
this._updateNodePosition(x, y);
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "contains", 1048);
...
return needle === Y.one(this.node);
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "test", 1060);
...
return Y.one(this.get("node")).test(selector);
	...
	compareTo: function(refNode) {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "compareTo", 1073);
...
return node === refNode;
	...
	_getDefaultFill: function() {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getDefaultFill", 1085);
...
return {
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getDefaultStroke", 1103);
...
return {
	...
	createNode: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "createNode", 1156);
...
id = "#" + id;
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1169);
this.node = node;
...
this.addClass(_getClassName(SHAPE) + " " + _getClassName(this.name)); 
	...
	on: function(type, fn)
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "on", 1182);
...
return Y.on.apply(this, arguments);
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_setStrokeProps", 1198);
...
linejoin = stroke.linejoin || "round";
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1212);
linecap = stroke.linecap || "butt";
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1213);
dashstyle = stroke.dashstyle;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1214);
this._miterlimit = null;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1215);
...
if (IS_NUMBER(weight) && weight > 0) 
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1220);
this._stroke = 1;
            } 
            else 
            {
...
if(linejoin == "round" || linejoin == "bevel")
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1236);
...
this._miterlimit =  Math.max(linejoin, 1);
                    _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1244);
...
this._stroke = 0;
	...
	set: function() 
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "set", 1263);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1265);
var host = this,
			val = arguments[0];
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1267);
AttributeLite.prototype.set.apply(host, arguments);
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1268);
if(host.initialized)
		{
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1270);
host._updateHandler();
		}
	},
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_setFillProps", 1281);
...
this._fillType = type;
            ...
            else {_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1295);
if(color)
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1297);
opacity = fill.opacity;
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1298);
if (isNumber(opacity)) 
                {
...
this._fillColor = null;
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "translate", 1330);
...
this._addTransform("translate", arguments);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "translateX", 1344);
...
this._addTransform("translateX", arguments);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "translateY", 1357);
...
this._addTransform("translateY", arguments);
    ...
    skew: function(x, y)
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "skew", 1370);
...
this._addTransform("skew", arguments);
	 ...
	 */
	 skewX: function(x)
	 {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "skewX", 1381);
...
this._addTransform("skewX", arguments);
	 ...
	 */
	 skewY: function(y)
	 {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "skewY", 1392);
...
this._addTransform("skewY", arguments);
	 ...
	 */
	 rotate: function(deg)
	 {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "rotate", 1403);
...
this._addTransform("rotate", arguments);
	...
	scale: function(x, y)
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "scale", 1415);
...
this._addTransform("scale", arguments);
	...
	{
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_addTransform", 1446);
...
this._updateTransform();
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_updateTransform", 1464);
...
transform = matrix.toCSSText();
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1487);
this._graphic.addToRedrawQueue(this);    
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1488);
...
this._transforms = [];
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_updateHandler", 1515);
...
this._updateTransform();
	...
	_draw: function()
	{
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 1527);
...
node.style.top = this.get("y") + "px";
	...
	_closePath: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_closePath", 1542);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1544);
if(!this._methods)
		{
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1546);
return;
		}
...
var node = this.get("node"),
            ...
            argsLen,
			len = 0;
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1560);
...
this._methods = cachedMethods;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_strokeAndFill", 1628);
...
context.fillStyle = this._getLinearGradient();
            ...
            else {_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1636);
...
context.stroke();
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_drawDashedLine", 1674);
...
context.moveTo(xEnd, yEnd);
    ...
    clear: function() {
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "clear", 1716);
...
return this;
	...
	getBounds: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getBounds", 1734);
...
return this._getContentRect(w, h, x, y);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getContentRect", 1761);
...
transformX = !isNaN(transformX) ? transformX : 0;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1779);
transformY = !isNaN(transformY) ? transformY : 0;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1780);
matrix.translate(transformX, transformY);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1781);
for(; i < len; i = i + 1)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1783);
transform = transforms[i];
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1784);
key = transform.shift();
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1785);
if(key)
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1787);
...
return contentRect;
    ...
    toFront: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "toFront", 1800);
...
graphic._toFront(this);
    ...
    toBack: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "toBack", 1814);
...
graphic._toBack(this);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_parsePathData", 1830);
...
this.end();
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "destroy", 1864);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1866);
var graphic = this.get("graphic");
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1867);
if(graphic)
        {
...
graphic.removeShape(this);
        ...
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1873);
this._destroy();
        }
    },
    ...
    _destroy: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_destroy", 1883);
...
CanvasShape.ATTRS =  {
	...
	transformOrigin: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "valueFn", 1903);
...
return [0.5, 0.5];
	...
	transform: {
		setter: function(val)
		{
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 1939);
...
this._transforms = this.matrix.getTransformArray(val);
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1943);
this._transform = val;
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 1947);
...
return this._transform;
	...
	node: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 1963);
...
return this.node;
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "valueFn", 1976);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 1981);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1983);
var node = this.node;
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 1984);
if(node)
			{
...
return val;
	...
	visible: {
		...
		setter: function(val){
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2041);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2042);
var node = this.get("node"),
                visibility = val ? "visible" : "hidden";
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2044);
if(node)
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2046);
node.style.visibility = visibility;
            }
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2048);
return val;
		}
	},
	...
	fill: {
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2098);
...
return fill;
	...
	stroke: {
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2146);
...
if(val && val.hasOwnProperty("weight"))
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2152);
...
val.weight = wt;
			...
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2158);
val = (val) ? Y.merge(tmpl, val) : null;
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2159);
this._setStrokeProps(val);
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2160);
return val;
		}
	},
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2186);
...
return val;
	...
	graphic: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2205);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasPath", 2223);
...
Y.extend(CanvasPath, Y.CanvasShape, {
    ...
    _draw: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2244);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2246);
this._closePath();
...
this._updateTransform();
	...
	createNode: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "createNode", 2257);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2259);
var node = Y.config.doc.createElement('canvas'),
			id = this.get("id");
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2261);
this._context = node.getContext('2d');
		_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2262);
node.setAttribute("overflow", "visible");
...
this.addClass(_getClassName(SHAPE) + " " + _getClassName(this.name)); 
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "end", 2277);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2279);
this._draw();
    }
});

_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2283);
CanvasPath.ATTRS = Y.merge(Y.CanvasShape.ATTRS, {
	...
	width: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2291);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2293);
var offset = this._stroke && this._strokeWeight ? (this._strokeWeight * 2) : 0;
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2294);
return this._width - offset;
		},

		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2297);
...
return val;
	...
	height: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2311);
...
return this._height - offset;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2317);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2319);
this._height = val;
...
return val;
	...
	path: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2334);
 ...
 * @constructor
 */
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2352);
CanvasRect = function()
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasRect", 2352);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2354);
CanvasRect.superclass.constructor.apply(this, arguments);
};
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2356);
...
Y.extend(CanvasRect, Y.CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2373);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasEllipse", 2395);
...
Y.extend(CanvasEllipse, CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2418);
...
CanvasEllipse.ATTRS = Y.merge(CanvasShape.ATTRS, {
	...
	xRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2435);
...
this.set("width", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2440);
...
val *= 0.5;
			...
			_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2447);
return val;
		}
	},
	...
	yRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2459);
...
this.set("height", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2464);
...
if(val) 
			{
				_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2469);
val *= 0.5;
			}
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasCircle", 2487);
...
Y.extend(CanvasCircle, Y.CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2510);
...
CanvasCircle.ATTRS = Y.merge(Y.CanvasShape.ATTRS, {
	...
	width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2530);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2532);
this.set("radius", val/2);
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2533);
return val;
        },

		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2536);
...
return this.get("radius") * 2;
	...
	height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2549);
...
return val;
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2555);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasPieSlice", 2579);
...
Y.extend(CanvasPieSlice, Y.CanvasShape, {
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2600);
...
var x = this.get("cx"),
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2607);
this.clear();
 ...
 * @constructor
 */
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2666);
function CanvasGraphic(config) {
    
    _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasGraphic", 2666);
...
CanvasGraphic.ATTRS = {
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "valueFn", 2689);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2694);
...
return val;
    ...
    shapes: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2715);
...
return this._shapes;
    ...
    contentBounds: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2731);
...
return this._contentBounds;
    ...
    node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2747);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2749);
return this._node;
        }
    },
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2760);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2762);
if(this._node)
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2764);
...
return val;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2777);
...
this._node.style.height = val + "px";
            ...
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2783);
return val;
        }
    },
...
return val;
    ...
    y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2874);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2879);
...
return val;
    ...
    visible: {
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2912);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2914);
...
Y.extend(CanvasGraphic, Y.GraphicBase, {
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "set", 2930);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2932);
var host = this,
            redrawAttrs = {
                autoDraw: true,
                autoSize: true,
...
AttributeLite.prototype.set.apply(host, arguments);	
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2942);
if(host._state.autoDraw === true && Y.Object.size(this._shapes) > 0)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2944);
if(Y_LANG.isString && redrawAttrs[attr])
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2946);
forceRedraw = true;
            }
            else {_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2948);
if(Y_LANG.isObject(attr))
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2950);
...
break;
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2960);
if(forceRedraw)
        {
...
host._redraw();
    ...
    getXY: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getXY", 2990);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2992);
var node = Y.one(this._node),
            xy;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2994);
if(node)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2996);
xy = node.getXY();
        }
...
return xy;
    ...
    initializer: function(config) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "initializer", 3008);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3009);
var render = this.get("render"),
            visibility = this.get("visible") ? "visible" : "hidden",
            w = this.get("width") || 0,
            h = this.get("height") || 0;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3013);
this._shapes = {};
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3014);
this._redrawQueue = {};
...
this.render(render);
    ...
    render: function(render) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "render", 3038);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3039);
var parentNode = Y.one(render),
            node = this._node,
            w = this.get("width") || parseInt(parentNode.getComputedStyle("width"), 10),
            h = this.get("height") || parseInt(parentNode.getComputedStyle("height"), 10);
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3043);
...
this.parentNode = parentNode;
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3052);
return this;
    },
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "destroy", 3060);
...
Y.one(this._node).destroy();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "addShape", 3077);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_appendShape", 3097);
...
if(this.get("autoDraw")) 
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3103);
parentNode.appendChild(node);
        }
        else
        {
...
this._getDocFrag().appendChild(node);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "removeShape", 3117);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "removeAllShapes", 3143);
...
this._shapes = {};
     ...
     */
    clear: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "clear", 3162);
...
this.removeAllShapes();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_removeChildren", 3173);
...
node.removeChild(child);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toggleVisible", 3194);
...
this._node.style.visibility = visibility;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getShapeClass", 3223);
...
return shape;
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3230);
return val;
    },
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getShapeById", 3255);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "batch", 3267);
...
this.set("autoDraw", autoDraw);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getDocFrag", 3283);
...
return this._frag;
    ...
    _redraw: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_redraw", 3298);
...
xScale = yScale = h/contentHeight;
                            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3339);
...
this.set("height", box.bottom);
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3356);
if(this._frag)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3358);
...
this._frag = null;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_calculateTranslate", 3373);
...
coord = ratio;
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3384);
break;
            default :
...
return coord;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "addToRedrawQueue", 3400);
...
if(this.get("autoDraw")) 
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3417);
this._redraw();
        }
    },
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getUpdatedContentBounds", 3428);
...
return box;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toFront", 3462);
...
contentNode.appendChild(shape);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toBack", 3482);
...
if(shape instanceof Y.CanvasShape)
        {
            _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3488);
shape = shape.get("node");
        }
