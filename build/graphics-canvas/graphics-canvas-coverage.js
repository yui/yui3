...
return val;
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2306);
...
return val;
	...
	graphic: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2325);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2327);
return this._graphic;
		}
    }
};
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2331);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasPath", 2343);
...
this._updateTransform();
	...
	createNode: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "createNode", 2377);
...
host.addClass(_getClassName(SHAPE) + " " + _getClassName(concat(IMPLEMENTATION, SHAPE)) + " " + _getClassName(name) + " " + _getClassName(concat(IMPLEMENTATION, name))); 
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "end", 2400);
...
CanvasPath.ATTRS = Y.merge(Y.CanvasShape.ATTRS, {
	...
	width: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2414);
...
return this._width - offset;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2420);
...
return val;
	...
	height: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2434);
...
return this._height - offset;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2440);
...
return val;
	...
	path: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2457);
...
CanvasRect = function()
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasRect", 2475);
...
Y.extend(CanvasRect, Y.CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2496);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasEllipse", 2518);
...
Y.extend(CanvasEllipse, CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2541);
...
CanvasEllipse.ATTRS = Y.merge(CanvasShape.ATTRS, {
	...
	xRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2558);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2560);
this.set("width", val * 2);
		},

		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2563);
...
return val;
	...
	yRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2582);
...
this.set("height", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2587);
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasCircle", 2610);
...
Y.extend(CanvasCircle, Y.CanvasShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2633);
...
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2645);
CanvasCircle.ATTRS = Y.merge(Y.CanvasShape.ATTRS, {
	...
	width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2653);
...
return val;
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2659);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2661);
return this.get("radius") * 2;
	...
	height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2672);
...
return val;
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2678);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2680);
return this.get("radius") * 2;
		}
	},
...
{
	_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasPieSlice", 2702);
...
Y.extend(CanvasPieSlice, Y.CanvasShape, {
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_draw", 2723);
...
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2739);
...
function CanvasGraphic(config) {
    ...
    _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "CanvasGraphic", 2789);
...
CanvasGraphic.ATTRS = {
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "valueFn", 2812);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2817);
...
return val;
    ...
    shapes: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2838);
...
return this._shapes;
    ...
    contentBounds: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2854);
...
return this._contentBounds;
    ...
    node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2870);
...
return this._node;
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2883);
...
return val;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2900);
...
return val;
    ...
    x: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2974);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 2976);
return this._x;
        },

        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 2979);
...
return val;
    ...
    y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getter", 2997);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 3002);
...
return val;
    ...
    visible: {
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "setter", 3035);
...
Y.extend(CanvasGraphic, Y.GraphicBase, {
	...
	{
		_yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "set", 3053);
...
forceRedraw = true;
            ...
            else {_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3071);
...
host._redraw();
    ...
    getXY: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getXY", 3113);
...
return xy;
    ...
    initializer: function(config) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "initializer", 3131);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3132);
...
this.render(render);
    ...
    render: function(render) {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "render", 3161);
...
return this;
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "destroy", 3183);
...
Y.one(this._node).destroy();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "addShape", 3200);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_appendShape", 3220);
...
this._getDocFrag().appendChild(node);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "removeShape", 3240);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "removeAllShapes", 3266);
...
shapes[i].destroy();
        ...
        _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3277);
this._shapes = {};
    },
     ...
     */
    clear: function() {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "clear", 3285);
...
this.removeAllShapes();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_removeChildren", 3296);
...
node.removeChild(child);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toggleVisible", 3317);
...
this._node.style.visibility = visibility;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getShapeClass", 3346);
...
return val;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "getShapeById", 3378);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "batch", 3390);
...
this.set("autoDraw", autoDraw);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getDocFrag", 3405);
...
return this._frag;
    ...
    _redraw: function()
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_redraw", 3420);
_yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3422);
...
this._frag = null;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_calculateTranslate", 3495);
...
return coord;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "addToRedrawQueue", 3522);
...
this._redraw();
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_getUpdatedContentBounds", 3550);
...
return box;
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toFront", 3584);
...
contentNode.appendChild(shape);
    ...
    {
        _yuitest_coverfunc("build/graphics-canvas/graphics-canvas.js", "_toBack", 3604);
...
contentNode.insertBefore(shape, targetNode);
            ...
            {
                _yuitest_coverline("build/graphics-canvas/graphics-canvas.js", 3621);
contentNode.appendChild(shape);
            }
        }
    }
