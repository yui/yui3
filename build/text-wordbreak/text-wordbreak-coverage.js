...
_yuitest_coverage["/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
    coveredFunctions: 0,
    calledFunctions: 0,
    path: "/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js",
    code: []
};
...
_yuitest_coverage["/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js"].functions = {"getWords:107":0,"getUniqueWords:168":0,"isWordBoundary:192":0,"_classify:207":0,"_isWordBoundary:257":0,"(anonymous 1):1":0};
_yuitest_coverage["/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js"].coveredLines = 64;
_yuitest_coverage["/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js"].coveredFunctions = 6;
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 1);
...
_yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 33);
var Text   = Y.Text,
...
WordBreak = {
    ...
    getWords: function (string, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "getWords", 107);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 108);
var i     = 0,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 117);
if (!options) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 118);
options = {};
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 121);
if (options.ignoreCase) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 122);
string = string.toLowerCase();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 125);
includePunctuation = options.includePunctuation;
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 126);
includeWhitespace  = options.includeWhitespace;
        ...
        // words as we go.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 131);
for (; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 132);
chr = string.charAt(i);

            // Append this character to the current word.
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 135);
word.push(chr);
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 140);
if (WordBreak._isWordBoundary(map, i)) {
                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 141);
word = word.join(EMPTY_STRING);

                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 143);
if (word &&
                        (includeWhitespace  || !WHITESPACE.test(word)) &&
                        (includePunctuation || !PUNCTUATION.test(word))) {
                    _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 146);
words.push(word);
                }

                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 149);
word = [];
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 153);
return words;
    },
    ...
    getUniqueWords: function (string, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "getUniqueWords", 168);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 169);
return Y.Array.unique(WordBreak.getWords(string, options));
    ...
    isWordBoundary: function (string, index) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "isWordBoundary", 192);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 193);
return WordBreak._isWordBoundary(WordBreak._classify(string), index);
    ...
    _classify: function (string) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "_classify", 207);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 208);
var chr,
            map          = [],
            i            = 0,
            j,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 217);
for (; i < stringLength; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 218);
chr  = string.charAt(i);
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 219);
type = OTHER;

            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 221);
for (j = 0; j < setsLength; ++j) {
                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 222);
set = SETS[j];

                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 224);
if (set && set.test(chr)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 225);
type = j;
                    _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 226);
break;
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 230);
map.push(type);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 233);
return map;
    },
    ...
    _isWordBoundary: function (map, index) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", "_isWordBoundary", 257);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 258);
var prevType,
            type     = map[index],
            nextType = map[index + 1],
            nextNextType;

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 263);
if (index < 0 || (index > map.length - 1 && index !== 0)) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 264);
return false;
        }

        // WB5. Don't break between most letters.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 268);
if (type === ALETTER && nextType === ALETTER) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 269);
return false;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 272);
nextNextType = map[index + 2];

        // WB6. Don't break letters across certain punctuation.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 275);
if (type === ALETTER &&
                (nextType === MIDLETTER || nextType === MIDNUMLET) &&
                nextNextType === ALETTER) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 278);
return false;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 281);
prevType = map[index - 1];

        // WB7. Don't break letters across certain punctuation.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 284);
if ((type === MIDLETTER || type === MIDNUMLET) &&
                nextType === ALETTER &&
                prevType === ALETTER) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 287);
return false;
        }

        // WB8/WB9/WB10. Don't break inside sequences of digits or digits
        // adjacent to letters.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 292);
if ((type === NUMERIC || type === ALETTER) &&
                (nextType === NUMERIC || nextType === ALETTER)) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 294);
return false;
        }

        // WB11. Don't break inside numeric sequences like "3.2" or
        // "3,456.789".
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 299);
if ((type === MIDNUM || type === MIDNUMLET) &&
                nextType === NUMERIC &&
                prevType === NUMERIC) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 302);
return false;
        }

        // WB12. Don't break inside numeric sequences like "3.2" or
        // "3,456.789".
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 307);
if (type === NUMERIC &&
                (nextType === MIDNUM || nextType === MIDNUMLET) &&
                nextNextType === NUMERIC) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 310);
return false;
        }

        // WB4. Ignore format and extend characters.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 314);
if (type === EXTEND || type === FORMAT ||
                prevType === EXTEND || prevType === FORMAT ||
                nextType === EXTEND || nextType === FORMAT) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 317);
return false;
        }

        // WB3. Don't break inside CRLF.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 321);
if (type === CR && nextType === LF) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 322);
return false;
        }

        // WB3a. Break before newlines (including CR and LF).
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 326);
if (type === NEWLINE || type === CR || type === LF) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 327);
return true;
        }

        // WB3b. Break after newlines (including CR and LF).
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 331);
if (nextType === NEWLINE || nextType === CR || nextType === LF) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 332);
return true;
        }

        // WB13. Don't break between Katakana characters.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 336);
if (type === KATAKANA && nextType === KATAKANA) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 337);
return false;
        }

        // WB13a. Don't break from extenders.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 341);
if (nextType === EXTENDNUMLET &&
                (type === ALETTER || type === NUMERIC || type === KATAKANA ||
                type === EXTENDNUMLET)) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 344);
return false;
        }

        // WB13b. Don't break from extenders.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 348);
if (type === EXTENDNUMLET &&
                (nextType === ALETTER || nextType === NUMERIC ||
                nextType === KATAKANA)) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 351);
return false;
        }

        // Break after any character not covered by the rules above.
        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 355);
return true;
    }
};

_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-wordbreak.js", 359);
