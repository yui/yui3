...
_yuitest_coverage["/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 9);
...
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 17);
function RecordsetSort(field, desc, sorter) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "RecordsetSort", 17);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 18);
RecordsetSort.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 21);
Y.mix(RecordsetSort, {
    NS: "sort",
        ...
        */
        lastSortProperties: {
            ...
            validator: function(v) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "validator", 41);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 42);
        ...
        */
        defaultSorter: {
            value: function(recA, recB, field, desc) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "value", 56);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 57);
var sorted = Compare(recA.getValue(field), recB.getValue(field), desc);
                _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 58);
if (sorted === 0) {
                    _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 59);
return Compare(recA.get("id"), recB.get("id"), desc);
                }
                else {
                    _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 62);
return sorted;
                }
            }
        },
...
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 80);
Y.extend(RecordsetSort, Y.Plugin.Base, {
    ...
    initializer: function(config) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "initializer", 88);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 90);
var self = this,
        host = this.get('host');


        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 94);
this.publish("sort", {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 100);
this.on("sort",
        function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "(anonymous 2)", 101);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 102);
self.set('isSorted', true);
        });

        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 105);
this.onHostEvent('add',
        function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "(anonymous 3)", 106);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 107);
self.set('isSorted', false);
        },
        host);
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 110);
this.onHostEvent('update',
        function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "(anonymous 4)", 111);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 112);
self.set('isSorted', false);
        },
        host);
    ...
    _defSortFn: function(e) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "_defSortFn", 129);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 131);
this.get("host")._items.sort(function(a, b) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "(anonymous 5)", 131);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 132);
return (e.sorter)(a, b, e.field, e.desc);
        });
        
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 135);
this.set('lastSortProperties', e);
    ...
    sort: function(field, desc, sorter) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "sort", 146);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 147);
this.fire("sort", {
            field: field,
            desc: desc,
     ...
     */
    resort: function() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "resort", 160);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 161);
var p = this.get('lastSortProperties');
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 162);
this.fire("sort", {
            field: p.field,
            desc: p.desc,
     ...
     */
    reverse: function() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "reverse", 175);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 176);
this.get('host')._items.reverse();
     ...
     */
    flip: function() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", "flip", 185);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 186);
var p = this.get('lastSortProperties');

        //If a predefined field is not provided by which to sort by, throw an error
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 189);
if (isValue(p.field)) {
            _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 190);
this.fire("sort", {
                field: p.field,
                desc: !p.desc,
                sorter: p.sorter || this.get("defaultSorter")
...
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-sort.js", 201);
