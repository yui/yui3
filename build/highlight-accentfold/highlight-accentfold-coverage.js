...
_yuitest_coverage["/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 15);
...
Highlight = Y.mix(Y.Highlight, {
    ...
    **/
    allFold: function (haystack, needles, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "allFold", 36);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 37);
var template = Highlight._TEMPLATE,
            results  = [],
            startPos = 0,
            chunk, i, len, match, result;

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 42);
options = Y.merge({
            ...
            replacer: function (match, p1, foldedNeedle, pos) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "replacer", 58);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 59);
var len;

                // Ignore matches inside HTML entities.
                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 62);
if (p1 && !(/\s/).test(foldedNeedle)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 63);
return match;
                }

                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 66);
len = foldedNeedle.length;

                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 68);
results.push([
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 73);
startPos = pos + len;
            }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 80);
Highlight.all(AccentFold.fold(haystack), AccentFold.fold(needles), options);
        ...
        // any.
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 84);
if (startPos < haystack.length) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 85);
results.push([haystack.substr(startPos)]);
        }

        // Highlight and escape the string.
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 89);
for (i = 0, len = results.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 90);
chunk = Escape.html(results[i][0]);

            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 92);
if ((match = results[i][1])) {
                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 93);
chunk += template.replace(/\{s\}/g, Escape.html(match));
            }

            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 96);
results[i] = chunk;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 99);
return results.join('');
    },
    ...
    **/
    startFold: function (haystack, needles) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "startFold", 112);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 113);
return Highlight.allFold(haystack, needles, {startsWith: true});
    ...
    **/
    wordsFold: function (haystack, needles) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "wordsFold", 128);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 129);
var template = Highlight._TEMPLATE;

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 131);
return Highlight.words(haystack, AccentFold.fold(needles), {
            mapper: function (word, needles) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", "mapper", 132);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 133);
if (needles.hasOwnProperty(AccentFold.fold(word))) {
                    _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 134);
return template.replace(/\{s\}/g, Escape.html(word));
                }

                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-accentfold.js", 137);
