...
_yuitest_coverage["/home/yui/src/yui3/src/app/build_tmp/app-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 40);
var Lang    = Y.Lang,
    YObject = Y.Object,
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 75);
AppBase = Y.Base.create('app', Y.Base, [View, Router, PjaxBase], {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "initializer", 150);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 151);
config || (config = {});

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 153);
var views = {};

        // Merges-in specified view metadata into local `views` object.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 156);
function mergeViewConfig(view, name) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "mergeViewConfig", 156);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 157);
views[name] = Y.merge(views[name], view);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 162);
YObject.each(this.views, mergeViewConfig);

        // Then, each view in the specified `config.views` object gets its
        // metadata merged-in.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 166);
YObject.each(config.views, mergeViewConfig);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 170);
this.views        = views;
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 171);
this._viewInfoMap = {};

        // Using `bind()` to aid extensibility.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 174);
this.after('activeViewChange', Y.bind('_afterActiveViewChange', this));
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 178);
if (!this.get('serverRouting')) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 179);
this._pjaxBindUI();
        }
    },
    ...
    **/
    createView: function (name, config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "createView", 201);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 202);
var viewInfo = this.getViewInfo(name),
            type     = (viewInfo && viewInfo.type) || View,
            ViewConstructor, view;

        // Looks for a namespaced constructor function on `Y`.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 207);
ViewConstructor = Lang.isString(type) ?
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 211);
view = new ViewConstructor(config);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 212);
this._viewInfoMap[Y.stamp(view, true)] = viewInfo;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 214);
return view;
    },
    ...
    **/
    getViewInfo: function (view) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "getViewInfo", 228);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 229);
if (Lang.isString(view)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 230);
return this.views[view];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 233);
return view && this._viewInfoMap[Y.stamp(view, true)];
    ...
    **/
    render: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "render", 285);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 286);
var CLASS_NAMES         = Y.App.CLASS_NAMES,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 293);
container.addClass(CLASS_NAMES.app);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 294);
viewContainer.addClass(CLASS_NAMES.views);

        // Prevents needless shuffling around of nodes and maintains DOM order.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 297);
if (activeView && !viewContainer.contains(activeViewContainer)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 298);
viewContainer.appendChild(activeViewContainer);
        }

        // Prevents needless shuffling around of nodes and maintains DOM order.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 302);
if (!container.contains(viewContainer) && !areSame) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 303);
container.appendChild(viewContainer);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 306);
return this;
    },
    ...
    **/
    showView: function (view, config, options, callback) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "showView", 375);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 376);
var viewInfo, created;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 378);
options || (options = {});

        // Support the callback function being either the third or fourth arg.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 381);
if (callback) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 382);
options = Y.merge(options, {callback: callback});
        } else {_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 383);
if (Lang.isFunction(options)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 384);
options = {callback: options};
        }}

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 387);
if (Lang.isString(view)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 388);
viewInfo = this.getViewInfo(view);
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 394);
if (viewInfo && viewInfo.preserve && viewInfo.instance) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 395);
view = viewInfo.instance;

                // Make sure there's a mapping back to the view metadata.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 398);
this._viewInfoMap[Y.stamp(view, true)] = viewInfo;
            } else {
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 406);
view    = this.createView(view, config);
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 407);
created = true;
            }
        }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 413);
if (options.update && !created) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 414);
view.setAttrs(config);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 423);
if ('render' in options) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 424);
options.render && view.render();
        } else {_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 425);
if (created) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 426);
view.render();
        }}

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 429);
return this._set('activeView', view, {options: options});
    ...
    **/
    _attachView: function (view, prepend) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_attachView", 446);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 447);
if (!view) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 448);
return;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 451);
var viewInfo      = this.getViewInfo(view),
            viewContainer = this.get('viewContainer');

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 454);
view.addTarget(this);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 455);
viewInfo && (viewInfo.instance = view);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 464);
viewContainer[prepend ? 'prepend' : 'append'](view.get('container'));
    ...
    **/
    _destroyContainer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_destroyContainer", 475);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 476);
var CLASS_NAMES   = Y.App.CLASS_NAMES,
            container     = this.get('container'),
            viewContainer = this.get('viewContainer'),
            areSame       = container.compareTo(viewContainer);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 482);
if (Y.one('body').compareTo(container)) {
            // Just clean-up our events listeners.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 484);
this.detachEvents();

            // Clean-up `yui3-app` CSS class on the `container`.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 487);
container && container.removeClass(CLASS_NAMES.app);

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 489);
if (areSame) {
                // Clean-up `yui3-app-views` CSS class on the `container`.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 491);
container && container.removeClass(CLASS_NAMES.views);
            } else {
                // Destroy and purge the `viewContainer`.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 494);
viewContainer && viewContainer.remove(true);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 497);
return;
        }

        // Remove and purge events from both containers.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 501);
viewContainer && viewContainer.remove(true);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 502);
!areSame && container && container.remove(true);
    ...
    **/
    _detachView: function (view) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_detachView", 516);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 517);
if (!view) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 518);
return;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 521);
var viewInfo = this.getViewInfo(view) || {};

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 523);
if (viewInfo.preserve) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 524);
view.remove();
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 529);
view.destroy({remove: true});
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 535);
delete this._viewInfoMap[Y.stamp(view, true)];

            // Remove from view-info instance property.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 538);
if (view === viewInfo.instance) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 539);
delete viewInfo.instance;
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 543);
view.removeTarget(this);
    ...
    **/
    _getViewContainer: function (value) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_getViewContainer", 555);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 560);
if (!value && !this._viewContainer) {
            ...
            // recursion.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 564);
value = this._viewContainer = this.create();
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 565);
this._set('viewContainer', value);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 568);
return value;
    },
    ...
    **/
    _initHtml5: function () {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_initHtml5", 586);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 589);
if (this.get('serverRouting') === false) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 590);
return false;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 592);
return Router.html5;
        }
    },
    ...
    **/
    _isChildView: function (view, parent) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_isChildView", 611);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 612);
var viewInfo   = this.getViewInfo(view),
            parentInfo = this.getViewInfo(parent);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 615);
if (viewInfo && parentInfo) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 616);
return this.getViewInfo(viewInfo.parent) === parentInfo;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 619);
return false;
    },
    ...
    **/
    _isParentView: function (view, child) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_isParentView", 637);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 638);
var viewInfo  = this.getViewInfo(view),
            childInfo = this.getViewInfo(child);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 641);
if (viewInfo && childInfo) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 642);
return this.getViewInfo(childInfo.parent) === viewInfo;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 645);
return false;
    },
    ...
    **/
    _navigate: function (url, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_navigate", 667);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 668);
if (!this.get('serverRouting')) {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 672);
options = Y.merge({force: true}, options);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 675);
return PjaxBase.prototype._navigate.call(this, url, options);
    ...
    **/
    _save: function (url, replace) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_save", 700);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 703);
if (this.get('serverRouting') && !this.get('html5')) {
            // Perform same-origin check on the specified URL.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 705);
if (!this._hasSameOrigin(url)) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 706);
Y.error('Security error: The new URL must be of the same origin as the current URL.');
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 707);
return this;
            }

            // Results in the URL's full path starting with '/'.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 711);
url = this._joinURL(url || '');

            // Either replace the current history entry or create a new one
            // while navigating to the `url`.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 715);
if (replace) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 716);
win && win.location.replace(url);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 718);
win && (win.location = url);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 721);
return this;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 724);
return Router.prototype._save.apply(this, arguments);
    ...
    **/
    _uiSetActiveView: function (newView, oldView, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_uiSetActiveView", 763);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 764);
options || (options = {});

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 766);
var callback = options.callback,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 773);
if (newView === oldView) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 774);
return callback && callback.call(this, newView);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 777);
this._attachView(newView, prepend);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 778);
this._detachView(oldView);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 780);
callback && callback.call(this, newView);
    ...
    **/
    _afterActiveViewChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "_afterActiveViewChange", 798);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 799);
this._uiSetActiveView(e.newVal, e.prevVal, e.options);
    ...
    ATTRS: {
        ...
        **/
        container: {
            valueFn: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "valueFn", 851);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 852);
return Y.one('body');
            }
        },
        ...
        **/
        serverRouting: {
            valueFn  : function () { _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-base.js", "valueFn", 967);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 967);
...
// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 1018);
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 1051);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-base.js", 1062);
Y.App.CLASS_NAMES = {
