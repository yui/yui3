...
_yuitest_coverage["/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('editor-bidi', function(Y) {
    ...
    _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 14);
var EditorBidi = function() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "EditorBidi", 14);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 15);
EditorBidi.superclass.constructor.apply(this, arguments);
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 19);
Y.extend(EditorBidi, Y.Base, {
        ...
        */
        _checkForChange: function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "_checkForChange", 38);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 39);
var host = this.get(HOST),
                inst = host.getInstance(),
                sel = new inst.EditorSelection(),
                node, direction;
            
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 44);
if (sel.isCollapsed) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 45);
node = EditorBidi.blockParent(sel.focusNode);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 46);
if (node) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 47);
direction = node.getStyle('direction');
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 48);
if (direction !== this.lastDirection) {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 49);
host.fire(B_C_CHANGE, { changedTo: direction });
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 50);
this.lastDirection = direction;
                    }
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 54);
host.fire(B_C_CHANGE, { changedTo: 'select' });
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 55);
this.lastDirection = null;
        ...
        */
        _afterNodeChange: function(e) { 
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "_afterNodeChange", 64);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 66);
if (this.firstEvent || EditorBidi.EVENTS[e.changedType]) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 67);
this._checkForChange();
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 68);
this.firstEvent = false;
        ...
        */
        _afterMouseUp: function(e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "_afterMouseUp", 77);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 78);
this._checkForChange();
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 79);
this.firstEvent = false;
        },
        initializer: function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "initializer", 81);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 82);
var host = this.get(HOST);

            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 84);
this.firstEvent = true;
            
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 86);
host.after(NODE_CHANGE, Y.bind(this._afterNodeChange, this));
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 87);
host.after('dom:mouseup', Y.bind(this._afterMouseUp, this));
        ...
        */
        blockParent: function(node, wrap) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "blockParent", 131);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 132);
var parent = node, divNode, firstChild;
            
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 134);
if (!parent) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 135);
parent = Y.one(BODY);
            }
            
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 138);
if (!parent.test(EditorBidi.BLOCKS)) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 139);
parent = parent.ancestor(EditorBidi.BLOCKS);
            }
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 141);
if (wrap && parent.test(BODY)) {
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 148);
divNode = Y.Node.create(EditorBidi.DIV_WRAPPER);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 149);
parent.get('children').each(function(node, index) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "(anonymous 2)", 149);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 150);
if (index === 0) {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 151);
firstChild = node;
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 153);
divNode.append(node);
                    }
                });
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 156);
firstChild.replace(divNode);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 157);
divNode.prepend(firstChild);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 158);
parent = divNode;
            }
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 160);
return parent;
        },
        /**
        ...
        */
        addParents: function(nodeArray) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "addParents", 173);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 174);
var i, parent, addParent;

            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 176);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 177);
nodeArray[i].setData(EditorBidi._NODE_SELECTED, true);
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 185);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 186);
parent = nodeArray[i].get('parentNode');
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 191);
if (!parent.test(BODY) && !parent.getData(EditorBidi._NODE_SELECTED)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 192);
addParent = true;
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 193);
parent.get('children').some(function(sibling) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "(anonymous 3)", 193);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 194);
if (!sibling.getData(EditorBidi._NODE_SELECTED)) {
                            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 195);
addParent = false;
                            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 196);
return true; // stop more processing
                        }
                    });
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 199);
if (addParent) {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 200);
nodeArray.push(parent);
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 201);
parent.setData(EditorBidi._NODE_SELECTED, true);
                    }
                }
            }   

            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 206);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 207);
nodeArray[i].clearData(EditorBidi._NODE_SELECTED);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 210);
return nodeArray;
        },
        ...
        */
        removeTextAlign: function(n) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "removeTextAlign", 242);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 243);
if (n) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 244);
if (n.getAttribute(STYLE).match(EditorBidi.RE_TEXT_ALIGN)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 245);
n.setAttribute(STYLE, n.getAttribute(STYLE).replace(EditorBidi.RE_TEXT_ALIGN, ''));
                }
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 247);
if (n.hasAttribute('align')) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 248);
n.removeAttribute('align');
                }
            }
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 251);
return n;
        }
    });
    
    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 255);
Y.namespace('Plugin');
    
    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 257);
Y.Plugin.EditorBidi = EditorBidi;
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 268);
Y.Plugin.ExecCommand.COMMANDS.bidi = function(cmd, direction) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "bidi", 268);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 269);
var inst = this.getInstance(),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 275);
if (!ns) {
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 276);
Y.error('bidi execCommand is not available without the EditorBiDi plugin.');
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 277);
return;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 280);
inst.EditorSelection.filterBlocks();

        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 282);
if (sel.isCollapsed) { // No selection
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 283);
block = EditorBidi.blockParent(sel.anchorNode);
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 284);
if (!block) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 285);
block = inst.one('body').one(inst.EditorSelection.BLOCKS);
            }
            //Remove text-align attribute if it exists
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 288);
block = EditorBidi.removeTextAlign(block);
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 289);
if (!direction) {
                //If no direction is set, auto-detect the proper setting to make it "toggle"
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 291);
dir = block.getAttribute(DIR);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 292);
if (!dir || dir == 'ltr') {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 293);
direction = 'rtl';
                } else {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 295);
direction = 'ltr';
                }
            }
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 298);
block.setAttribute(DIR, direction);
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 299);
if (Y.UA.ie) {
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 300);
var b = block.all('br.yui-cursor');
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 301);
if (b.size() === 1 && block.get('childNodes').size() == 1) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 302);
b.remove();
                }
            }
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 305);
returnValue = block;
        } else { // some text is selected
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 307);
selected = sel.getSelected();
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 308);
selectedBlocks = [];
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 309);
selected.each(function(node) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "(anonymous 4)", 309);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 310);
selectedBlocks.push(EditorBidi.blockParent(node));
            });
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 312);
selectedBlocks = inst.all(EditorBidi.addParents(selectedBlocks));
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 313);
selectedBlocks.each(function(n) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", "(anonymous 5)", 313);
_yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 314);
var d = direction;
                //Remove text-align attribute if it exists
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 316);
n = EditorBidi.removeTextAlign(n);
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 317);
if (!d) {
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 318);
dir = n.getAttribute(DIR);
                    _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 319);
if (!dir || dir == 'ltr') {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 320);
d = 'rtl';
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 322);
d = 'ltr';
                    }
                }
                _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 325);
n.setAttribute(DIR, d);
            });
            _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 327);
returnValue = selectedBlocks;
        }
        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 329);
ns._checkForChange();
        _yuitest_coverline("/home/yui/src/yui3/src/editor/build_tmp/editor-bidi.js", 330);
return returnValue;
    };
