...
YUI.add('editor-bidi', function (Y, NAME) {
    ...
    _yuitest_coverfunc("editor-bidi", "(anonymous 1)", 1);
_yuitest_coverline("editor-bidi", 14);
var EditorBidi = function() {
        _yuitest_coverfunc("editor-bidi", "EditorBidi", 14);
_yuitest_coverline("editor-bidi", 15);
EditorBidi.superclass.constructor.apply(this, arguments);
    ...
    _yuitest_coverline("editor-bidi", 19);
Y.extend(EditorBidi, Y.Base, {
        ...
        */
        _checkForChange: function() {
            _yuitest_coverfunc("editor-bidi", "_checkForChange", 38);
_yuitest_coverline("editor-bidi", 39);
var host = this.get(HOST),
                inst = host.getInstance(),
                sel = new inst.EditorSelection(),
                node, direction;
            
            _yuitest_coverline("editor-bidi", 44);
if (sel.isCollapsed) {
                _yuitest_coverline("editor-bidi", 45);
node = EditorBidi.blockParent(sel.focusNode);
                _yuitest_coverline("editor-bidi", 46);
if (node) {
                    _yuitest_coverline("editor-bidi", 47);
direction = node.getStyle('direction');
                    _yuitest_coverline("editor-bidi", 48);
if (direction !== this.lastDirection) {
                        _yuitest_coverline("editor-bidi", 49);
host.fire(B_C_CHANGE, { changedTo: direction });
                        _yuitest_coverline("editor-bidi", 50);
this.lastDirection = direction;
                    }
                }
            } else {
                _yuitest_coverline("editor-bidi", 54);
host.fire(B_C_CHANGE, { changedTo: 'select' });
                _yuitest_coverline("editor-bidi", 55);
this.lastDirection = null;
        ...
        */
        _afterNodeChange: function(e) { 
            ...
            _yuitest_coverfunc("editor-bidi", "_afterNodeChange", 64);
_yuitest_coverline("editor-bidi", 66);
if (this.firstEvent || EditorBidi.EVENTS[e.changedType]) {
                _yuitest_coverline("editor-bidi", 67);
this._checkForChange();
                _yuitest_coverline("editor-bidi", 68);
this.firstEvent = false;
        ...
        */
        _afterMouseUp: function(e) {
            _yuitest_coverfunc("editor-bidi", "_afterMouseUp", 77);
_yuitest_coverline("editor-bidi", 78);
this._checkForChange();
            _yuitest_coverline("editor-bidi", 79);
this.firstEvent = false;
        },
        initializer: function() {
            _yuitest_coverfunc("editor-bidi", "initializer", 81);
_yuitest_coverline("editor-bidi", 82);
var host = this.get(HOST);

            _yuitest_coverline("editor-bidi", 84);
this.firstEvent = true;
            
            _yuitest_coverline("editor-bidi", 86);
host.after(NODE_CHANGE, Y.bind(this._afterNodeChange, this));
            _yuitest_coverline("editor-bidi", 87);
host.after('dom:mouseup', Y.bind(this._afterMouseUp, this));
        ...
        */
        blockParent: function(node, wrap) {
            _yuitest_coverfunc("editor-bidi", "blockParent", 131);
_yuitest_coverline("editor-bidi", 132);
var parent = node, divNode, firstChild;
            
            _yuitest_coverline("editor-bidi", 134);
if (!parent) {
                _yuitest_coverline("editor-bidi", 135);
parent = Y.one(BODY);
            }
            
            _yuitest_coverline("editor-bidi", 138);
if (!parent.test(EditorBidi.BLOCKS)) {
                _yuitest_coverline("editor-bidi", 139);
parent = parent.ancestor(EditorBidi.BLOCKS);
            }
            _yuitest_coverline("editor-bidi", 141);
if (wrap && parent.test(BODY)) {
                ...
                _yuitest_coverline("editor-bidi", 148);
divNode = Y.Node.create(EditorBidi.DIV_WRAPPER);
                _yuitest_coverline("editor-bidi", 149);
parent.get('children').each(function(node, index) {
                    _yuitest_coverfunc("editor-bidi", "(anonymous 2)", 149);
_yuitest_coverline("editor-bidi", 150);
if (index === 0) {
                        _yuitest_coverline("editor-bidi", 151);
firstChild = node;
                    } else {
                        _yuitest_coverline("editor-bidi", 153);
divNode.append(node);
                    }
                });
                _yuitest_coverline("editor-bidi", 156);
firstChild.replace(divNode);
                _yuitest_coverline("editor-bidi", 157);
divNode.prepend(firstChild);
                _yuitest_coverline("editor-bidi", 158);
parent = divNode;
            }
            _yuitest_coverline("editor-bidi", 160);
return parent;
        },
        /**
        ...
        */
        addParents: function(nodeArray) {
            _yuitest_coverfunc("editor-bidi", "addParents", 173);
_yuitest_coverline("editor-bidi", 174);
var i, parent, addParent;

            _yuitest_coverline("editor-bidi", 176);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("editor-bidi", 177);
nodeArray[i].setData(EditorBidi._NODE_SELECTED, true);
            ...
            _yuitest_coverline("editor-bidi", 185);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("editor-bidi", 186);
parent = nodeArray[i].get('parentNode');
                ...
                _yuitest_coverline("editor-bidi", 191);
if (!parent.test(BODY) && !parent.getData(EditorBidi._NODE_SELECTED)) {
                    _yuitest_coverline("editor-bidi", 192);
addParent = true;
                    _yuitest_coverline("editor-bidi", 193);
parent.get('children').some(function(sibling) {
                        _yuitest_coverfunc("editor-bidi", "(anonymous 3)", 193);
_yuitest_coverline("editor-bidi", 194);
if (!sibling.getData(EditorBidi._NODE_SELECTED)) {
                            _yuitest_coverline("editor-bidi", 195);
addParent = false;
                            _yuitest_coverline("editor-bidi", 196);
return true; // stop more processing
                        }
                    });
                    _yuitest_coverline("editor-bidi", 199);
if (addParent) {
                        _yuitest_coverline("editor-bidi", 200);
nodeArray.push(parent);
                        _yuitest_coverline("editor-bidi", 201);
parent.setData(EditorBidi._NODE_SELECTED, true);
                    }
                }
            }   

            _yuitest_coverline("editor-bidi", 206);
for (i = 0; i < nodeArray.length; i += 1) {
                _yuitest_coverline("editor-bidi", 207);
nodeArray[i].clearData(EditorBidi._NODE_SELECTED);
            }

            _yuitest_coverline("editor-bidi", 210);
return nodeArray;
        },
        ...
        */
        removeTextAlign: function(n) {
            _yuitest_coverfunc("editor-bidi", "removeTextAlign", 242);
_yuitest_coverline("editor-bidi", 243);
if (n) {
                _yuitest_coverline("editor-bidi", 244);
if (n.getAttribute(STYLE).match(EditorBidi.RE_TEXT_ALIGN)) {
                    _yuitest_coverline("editor-bidi", 245);
n.setAttribute(STYLE, n.getAttribute(STYLE).replace(EditorBidi.RE_TEXT_ALIGN, ''));
                }
                _yuitest_coverline("editor-bidi", 247);
if (n.hasAttribute('align')) {
                    _yuitest_coverline("editor-bidi", 248);
n.removeAttribute('align');
                }
            }
            _yuitest_coverline("editor-bidi", 251);
return n;
        }
    });
    
    _yuitest_coverline("editor-bidi", 255);
Y.namespace('Plugin');
    
    _yuitest_coverline("editor-bidi", 257);
Y.Plugin.EditorBidi = EditorBidi;
    ...
    _yuitest_coverline("editor-bidi", 268);
Y.Plugin.ExecCommand.COMMANDS.bidi = function(cmd, direction) {
        _yuitest_coverfunc("editor-bidi", "bidi", 268);
_yuitest_coverline("editor-bidi", 269);
var inst = this.getInstance(),
        ...
        _yuitest_coverline("editor-bidi", 275);
if (!ns) {
            _yuitest_coverline("editor-bidi", 276);
Y.error('bidi execCommand is not available without the EditorBiDi plugin.');
            _yuitest_coverline("editor-bidi", 277);
return;
        }

        _yuitest_coverline("editor-bidi", 280);
inst.EditorSelection.filterBlocks();

        _yuitest_coverline("editor-bidi", 282);
if (sel.isCollapsed) { // No selection
            _yuitest_coverline("editor-bidi", 283);
block = EditorBidi.blockParent(sel.anchorNode);
            _yuitest_coverline("editor-bidi", 284);
if (!block) {
                _yuitest_coverline("editor-bidi", 285);
block = inst.one('body').one(inst.EditorSelection.BLOCKS);
            }
            //Remove text-align attribute if it exists
            _yuitest_coverline("editor-bidi", 288);
block = EditorBidi.removeTextAlign(block);
            _yuitest_coverline("editor-bidi", 289);
if (!direction) {
                //If no direction is set, auto-detect the proper setting to make it "toggle"
                _yuitest_coverline("editor-bidi", 291);
dir = block.getAttribute(DIR);
                _yuitest_coverline("editor-bidi", 292);
if (!dir || dir == 'ltr') {
                    _yuitest_coverline("editor-bidi", 293);
direction = 'rtl';
                } else {
                    _yuitest_coverline("editor-bidi", 295);
direction = 'ltr';
                }
            }
            _yuitest_coverline("editor-bidi", 298);
block.setAttribute(DIR, direction);
            _yuitest_coverline("editor-bidi", 299);
if (Y.UA.ie) {
                _yuitest_coverline("editor-bidi", 300);
var b = block.all('br.yui-cursor');
                _yuitest_coverline("editor-bidi", 301);
if (b.size() === 1 && block.get('childNodes').size() == 1) {
                    _yuitest_coverline("editor-bidi", 302);
b.remove();
                }
            }
            _yuitest_coverline("editor-bidi", 305);
returnValue = block;
        } else { // some text is selected
            _yuitest_coverline("editor-bidi", 307);
selected = sel.getSelected();
            _yuitest_coverline("editor-bidi", 308);
selectedBlocks = [];
            _yuitest_coverline("editor-bidi", 309);
selected.each(function(node) {
                _yuitest_coverfunc("editor-bidi", "(anonymous 4)", 309);
_yuitest_coverline("editor-bidi", 310);
selectedBlocks.push(EditorBidi.blockParent(node));
            });
            _yuitest_coverline("editor-bidi", 312);
selectedBlocks = inst.all(EditorBidi.addParents(selectedBlocks));
            _yuitest_coverline("editor-bidi", 313);
selectedBlocks.each(function(n) {
                _yuitest_coverfunc("editor-bidi", "(anonymous 5)", 313);
_yuitest_coverline("editor-bidi", 314);
var d = direction;
                //Remove text-align attribute if it exists
                _yuitest_coverline("editor-bidi", 316);
n = EditorBidi.removeTextAlign(n);
                _yuitest_coverline("editor-bidi", 317);
if (!d) {
                    _yuitest_coverline("editor-bidi", 318);
dir = n.getAttribute(DIR);
                    _yuitest_coverline("editor-bidi", 319);
if (!dir || dir == 'ltr') {
                        _yuitest_coverline("editor-bidi", 320);
d = 'rtl';
                    } else {
                        _yuitest_coverline("editor-bidi", 322);
d = 'ltr';
                    }
                }
                _yuitest_coverline("editor-bidi", 325);
n.setAttribute(DIR, d);
            });
            _yuitest_coverline("editor-bidi", 327);
returnValue = selectedBlocks;
        }
        _yuitest_coverline("editor-bidi", 329);
ns._checkForChange();
        _yuitest_coverline("editor-bidi", 330);
return returnValue;
    };
