...
paginator.scrollToIndex(paginator.get(INDEX));
    ...
    _beforeHostMousewheel: function (e) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_beforeHostMousewheel", 316);
...
var paginator = this,
        ...
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 325);
host._gesture = {
            axis: DIM_Y
        };
...
return new Y.Do.Prevent();
    ...
    _beforeHostFlick: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_beforeHostFlick", 351);
...
return new Y.Do.Prevent();
    ...
    _afterHostScrollEnded: function (e) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_afterHostScrollEnded", 394);
...
paginator._optimize();
    ...
    _afterIndexChange: function (e) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_afterIndexChange", 418);
...
return {
    ...
    _showNodes: function (nodeList) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_showNodes", 495);
...
nodeList.removeClass(CLASS_HIDDEN).setStyle('visibility', '');
    ...
    _hideNodes: function (nodeList) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_hideNodes", 508);
...
nodeList.addClass(CLASS_HIDDEN).setStyle('visibility', 'hidden');
    ...
    _getPageNodes: function () {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_getPageNodes", 521);
...
return pageNodes;
     ...
     */
    next: function () {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "next", 536);
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 537);
var paginator = this,
            index = paginator._cIndex,
            target = index + 1,
...
return;
        ...
        // Update the index
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 547);
paginator.set(INDEX, target);
     ...
     */
    prev: function () {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "prev", 555);
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 556);
var paginator = this,
            index = paginator._cIndex,
            target = index - 1;

        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 560);
if (target < 0) {
...
return;
        ...
        // Update the index
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 565);
paginator.set(INDEX, target);
    },
     ...
     */
    scrollTo: function () {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "scrollTo", 572);
...
return this.scrollToIndex.apply(this, arguments);
    ...
    scrollToIndex: function (index, duration, easing) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "scrollToIndex", 584);
...
easing = (easing !== undefined) ? duration : PaginatorPlugin.TRANSITION.easing;
        ...
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 595);
paginator.set(INDEX, index);

        // Makes sure the viewport nodes are visible
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 598);
paginator._showNodes(pageNode);

        // Scroll to the offset
        _yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 601);
host.set(scrollAxis, scrollOffset, {
    ...
    _axisSetter: function (val, name) {
        ...
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_axisSetter", 617);
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 620);
...
return {
    ...
    _afterAxisChange: function (e) {
        _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "_afterAxisChange", 636);
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 637);
    ...
    ATTRS: {
        ...
        index: {
            ...
            validator: function (val) {
                ...
                _yuitest_coverfunc("build/scrollview-paginator/scrollview-paginator.js", "validator", 710);
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 713);
return true;
            }
        },
...
_yuitest_coverline("build/scrollview-paginator/scrollview-paginator.js", 744);
