...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 11);
var isNumber = Y.Lang.isNumber,
    arrayIndex = Y.Array.indexOf;

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 14);
Y.Features.add('table', 'badColWidth', {
    test: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "test", 15);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 16);
var body = Y.one('body'),
            node, broken;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 19);
if (body) {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 25);
node = body.insertBefore(
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 38);
broken = node.one('td').getComputedStyle('width') !== '1px';

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 40);
node.remove(true);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 43);
return broken;
    }
});
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 117);
function ColumnWidths() {}

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 119);
Y.mix(ColumnWidths.prototype, {
    ...
    **/
    setColumnWidth: function (id, width) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "setColumnWidth", 157);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 158);
var col = this.getColumn(id),
            index = col && arrayIndex(this._displayColumns, col);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 161);
if (index > -1) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 162);
if (isNumber(width)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 163);
width += 'px';
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 166);
col.width = width;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 168);
this._setColumnWidth(index, width);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 171);
return this;
    },
    ...
    **/
    _createColumnGroup: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "_createColumnGroup", 184);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 185);
return Y.Node.create(this.COLGROUP_TEMPLATE);
    ...
    **/
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "initializer", 196);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 197);
this.after(['renderView', 'columnsChange'], this._uiSetColumnWidths);
    ...
    **/
    ...
    _setColumnWidth: function (colIndex, width) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "_setColumnWidth", 216);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 222);
var colgroup  = this._colgroupNode,
            col       = colgroup && colgroup.all('col').item(colIndex),
            cell, getCStyle;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 226);
if (col) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 227);
if (width && isNumber(width)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 228);
width += 'px';
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 231);
col.setStyle('width', width);

            // Adjust the width for browsers that make
            // td.style.width === col.style.width
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 235);
if  (width && Y.Features.test('table', 'badColWidth')) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 236);
cell = this.getCell([0, colIndex]);
                
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 238);
if (cell) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 239);
getCStyle = function (prop) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "getCStyle", 239);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 240);
return parseInt(cell.getComputedStyle(prop), 10)|0;
                    };

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 243);
col.setStyle('width',
                        // I hate this
                        parseInt(width, 10) -
    ...
    **/
    _uiSetColumnWidths: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", "_uiSetColumnWidths", 265);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 266);
if (!this.view) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 267);
return;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 270);
var template = this.COL_TEMPLATE,
            colgroup = this._colgroupNode,
            columns  = this._displayColumns,
            i, len;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 275);
if (!colgroup) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 276);
colgroup = this._colgroupNode = this._createColumnGroup();

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 278);
this._tableNode.insertBefore(
                colgroup,
                this._tableNode.one('> thead, > tfoot, > tbody'));
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 282);
colgroup.empty();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 285);
for (i = 0, len = columns.length; i < len; ++i) {

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 287);
colgroup.append(template);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 289);
this._setColumnWidth(i, columns[i].width);
        }
    }
}, true);

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 294);
Y.DataTable.ColumnWidths = ColumnWidths;

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-column-widths.js", 296);
