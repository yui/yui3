...
_yuitest_coverage["/home/yui/src/yui3/src/history/build_tmp/history-hash.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 19);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 33);
function HistoryHash() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "HistoryHash", 33);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 34);
HistoryHash.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 37);
Y.extend(HistoryHash, HistoryBase, {
    // -- Initialization -------------------------------------------------------
    _init: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "_init", 39);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 40);
var bookmarkedState = HistoryHash.parseHash();
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 44);
config = config || {};

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 46);
this._initialState = config.initialState ?
        ...
        // changes.
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 51);
Y.after('hashchange', Y.bind(this._afterHashChange, this), win);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 53);
HistoryHash.superclass._init.apply(this, arguments);
    ...
    _change: function (src, state, options) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "_change", 57);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 60);
YObject.each(state, function (value, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 2)", 60);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 61);
if (Lang.isValue(value)) {
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 62);
state[key] = value.toString();
            }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 66);
return HistoryHash.superclass._change.call(this, src, state, options);
    },

    _storeState: function (src, newState) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "_storeState", 69);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 70);
var decode  = HistoryHash.decode,
            newHash = HistoryHash.createHash(newState);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 73);
HistoryHash.superclass._storeState.apply(this, arguments);
        ...
        // HistoryHash.
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 82);
if (src !== SRC_HASH && decode(HistoryHash.getHash()) !== decode(newHash)) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 83);
HistoryHash[src === HistoryBase.SRC_REPLACE ? 'replaceHash' : 'setHash'](newHash);
    ...
    _afterHashChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "_afterHashChange", 96);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 97);
this._resolveChanges(SRC_HASH, HistoryHash.parseHash(e.newHash), {});
    ...
    createHash: function (params) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "createHash", 161);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 162);
var encode = HistoryHash.encode,
            hash   = [];

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 165);
YObject.each(params, function (value, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 3)", 165);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 166);
if (Lang.isValue(value)) {
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 167);
hash.push(encode(key) + '=' + encode(value));
            }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 171);
return hash.join('&');
    },
    ...
    decode: function (string) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "decode", 183);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 184);
return decodeURIComponent(string.replace(/\+/g, ' '));
    ...
    encode: function (string) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "encode", 196);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 197);
return encodeURIComponent(string).replace(/%20/g, '+');
    ...
    getHash: (Y.UA.gecko ? function () {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 4)", 208);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 214);
var location = Y.getLocation(),
            matches  = /#(.*)$/.exec(location.href),
            hash     = matches && matches[1] || '',
            prefix   = HistoryHash.hashPrefix;

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 219);
return prefix && hash.indexOf(prefix) === 0 ?
                    hash.replace(prefix, '') : hash;
    } : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "}", 221);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 222);
var location = Y.getLocation(),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 230);
return prefix && hash.indexOf(prefix) === 0 ?
                    hash.replace(prefix, '') : hash;
    }),
     ...
     */
    getUrl: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "getUrl", 241);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 242);
return location.href;
    ...
    parseHash: function (hash) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "parseHash", 255);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 256);
var decode = HistoryHash.decode,
            i,
            len,
            matches,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 265);
hash = Lang.isValue(hash) ? hash : HistoryHash.getHash();

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 267);
if (prefix) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 268);
prefixIndex = hash.indexOf(prefix);

            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 270);
if (prefixIndex === 0 || (prefixIndex === 1 && hash.charAt(0) === '#')) {
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 271);
hash = hash.replace(prefix, '');
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 275);
matches = hash.match(HistoryHash._REGEX_HASH) || [];

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 277);
for (i = 0, len = matches.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 278);
param = matches[i].split('=');
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 279);
params[decode(param[0])] = decode(param[1]);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 282);
return params;
    },
    ...
    replaceHash: function (hash) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "replaceHash", 295);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 296);
var location = Y.getLocation(),
            base     = location.href.replace(/#.*$/, '');

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 299);
if (hash.charAt(0) === '#') {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 300);
hash = hash.substring(1);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 303);
location.replace(base + '#' + (HistoryHash.hashPrefix || '') + hash);
    ...
    setHash: function (hash) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "setHash", 314);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 315);
var location = Y.getLocation();

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 317);
if (hash.charAt(0) === '#') {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 318);
hash = hash.substring(1);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 321);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 376);
hashNotifiers = GlobalEnv._notifiers;

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 378);
if (!hashNotifiers) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 379);
hashNotifiers = GlobalEnv._notifiers = [];
}

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 382);
Y.Event.define('hashchange', {
    on: function (node, subscriber, notifier) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "on", 383);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 388);
if (node.compareTo(win) || node.compareTo(Y.config.doc.body)) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 389);
hashNotifiers.push(notifier);
        }
    },

    detach: function (node, subscriber, notifier) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "detach", 393);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 394);
var index = YArray.indexOf(hashNotifiers, notifier);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 396);
if (index !== -1) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 397);
hashNotifiers.splice(index, 1);
        }
    }
});

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 402);
oldHash = HistoryHash.getHash();
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 403);
oldUrl  = HistoryHash.getUrl();

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 405);
if (HistoryBase.nativeHashChange) {
    // Wrap the browser's native hashchange event if there's not already a
    // global listener.
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 408);
if (!GlobalEnv._hashHandle) {
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 409);
GlobalEnv._hashHandle = Y.Event.attach('hashchange', function (e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 5)", 409);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 410);
var newHash = HistoryHash.getHash(),
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 415);
YArray.each(hashNotifiers.concat(), function (notifier) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 6)", 415);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 416);
notifier.fire({
                    _event : e,
                    oldHash: oldHash,
                    oldUrl : oldUrl,
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 425);
oldHash = newHash;
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 426);
oldUrl  = newUrl;
        }, win);
    }
} else {
    ...
    // poll running.
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 432);
if (!GlobalEnv._hashPoll) {
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 433);
GlobalEnv._hashPoll = Y.later(50, null, function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 7)", 433);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 434);
var newHash = HistoryHash.getHash(),
                facade, newUrl;

            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 437);
if (oldHash !== newHash) {
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 438);
newUrl = HistoryHash.getUrl();

                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 440);
facade = {
                    oldHash: oldHash,
                    oldUrl : oldUrl,
                    newHash: newHash,
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 447);
oldHash = newHash;
                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 448);
oldUrl  = newUrl;

                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 450);
YArray.each(hashNotifiers.concat(), function (notifier) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", "(anonymous 8)", 450);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 451);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 458);
Y.HistoryHash = HistoryHash;

// HistoryHash will never win over HistoryHTML5 unless useHistoryHTML5 is false.
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 461);
if (useHistoryHTML5 === false || (!Y.History && useHistoryHTML5 !== true &&
        (!HistoryBase.html5 || !Y.HistoryHTML5))) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash.js", 463);
