...
this.set('value', this._maxValue);
                ...
                _yuitest_coverline("build/dial/dial.js", 760);
if (e.type !== "drag:drag") {
...
this._prevAng = this._getAngleFromValue(this._maxValue);  // #2530766 need for mousedown on the ring; causes prob for drag
            ...
            } else {_yuitest_coverline("build/dial/dial.js", 763);
if(newValue < this._minValue){
                _yuitest_coverline("build/dial/dial.js", 764);
this.set('value', this._minValue);
                // HACK, just for testing. Not the root cause fix
                _yuitest_coverline("build/dial/dial.js", 766);
if (e.type !== "drag:drag") {
...
this._prevAng = this._getAngleFromValue(this._minValue);
        ...
        _handleDragStart : function(e){
            _yuitest_coverfunc("build/dial/dial.js", "_handleDragStart", 779);
_yuitest_coverline("build/dial/dial.js", 780);
this._markerNode.removeClass(Dial.CSS_CLASSES.hidden);
        ...
        _handleDragEnd : function(){
            _yuitest_coverfunc("build/dial/dial.js", "_handleDragEnd", 794);
...
node.transition({
                    ...
                    top: this._setNodeToFixedRadius(this._handleNode, true)[1] + 'px'
                        ...
                        _yuitest_coverfunc("build/dial/dial.js", "(anonymous 2)", 801);
...
this._prevAng = this._getAngleFromValue(value); //#2530766 secondary bug when drag past max + cross wrapping boundry
         ...
         */
         _setNodeToFixedRadius : function(obj, typeArray){
            _yuitest_coverfunc("build/dial/dial.js", "_setNodeToFixedRadius", 827);
...
newY = newY - (dia * 0.5);
            _yuitest_coverline("build/dial/dial.js", 835);
newX = newX - (dia * 0.5);
            _yuitest_coverline("build/dial/dial.js", 836);
if(typeArray){ // just need the style for css transform left and top to animate the handle drag:end
                _yuitest_coverline("build/dial/dial.js", 837);
return [(this._ringNodeRadius + newX), (this._ringNodeRadius + newY)];
            }else{
                _yuitest_coverline("build/dial/dial.js", 839);
...
obj.setStyle('top', (this._ringNodeRadius + newY) + 'px');
        ...
        syncUI : function() {
            ...
            _yuitest_coverfunc("build/dial/dial.js", "syncUI", 849);
_yuitest_coverline("build/dial/dial.js", 853);
this._setSizes();
            _yuitest_coverline("build/dial/dial.js", 854);
this._calculateDialCenter(); // #2531111 initialize center of dial
            _yuitest_coverline("build/dial/dial.js", 855);
this._setBorderRadius();
            _yuitest_coverline("build/dial/dial.js", 856);
this._uiSetValue(this.get("value"));
            _yuitest_coverline("build/dial/dial.js", 857);
this._markerNode.addClass(Dial.CSS_CLASSES.hidden);
            _yuitest_coverline("build/dial/dial.js", 858);
this._resetString.addClass(Dial.CSS_CLASSES.hidden);
        },
         ...
         */
        _setSizes : function(){
            _yuitest_coverfunc("build/dial/dial.js", "_setSizes", 871);
...
var dia = this.get('diameter'),
            ...
            setSize = function(node, dia, percent){
                _yuitest_coverfunc("build/dial/dial.js", "setSize", 874);
...
this._handleDistance = this._ringNodeRadius * this.get('handleDistance');
            ...
            _yuitest_coverline("build/dial/dial.js", 894);
offset = (this._ringNodeRadius - this._centerButtonNodeRadius);
            _yuitest_coverline("build/dial/dial.js", 895);
this._centerButtonNode.setStyle('left', offset + 'px');
            _yuitest_coverline("build/dial/dial.js", 896);
...
this._resetString.setStyles({'left':offsetResetX + 'px', 'top':offsetResetY + 'px'});
        ...
        _renderLabel : function() {
            _yuitest_coverfunc("build/dial/dial.js", "_renderLabel", 915);
_yuitest_coverline("build/dial/dial.js", 916);
var contentBox = this.get("contentBox"),
                label = contentBox.one("." + Dial.CSS_CLASSES.label);
            _yuitest_coverline("build/dial/dial.js", 918);
if (!label) {
                _yuitest_coverline("build/dial/dial.js", 919);
...
this._valueStringNode = this._labelNode.one("." + Dial.CSS_CLASSES.valueString);
        ...
        _renderRing : function() {
            _yuitest_coverfunc("build/dial/dial.js", "_renderRing", 932);
_yuitest_coverline("build/dial/dial.js", 933);
var contentBox = this.get("contentBox"),
                ring = contentBox.one("." + Dial.CSS_CLASSES.ring);
            _yuitest_coverline("build/dial/dial.js", 935);
if (!ring) {
                _yuitest_coverline("build/dial/dial.js", 936);
...
this._ringNode = ring;
        ...
        _renderMarker : function() {
            _yuitest_coverfunc("build/dial/dial.js", "_renderMarker", 949);
_yuitest_coverline("build/dial/dial.js", 950);
var contentBox = this.get("contentBox"),
...
this._markerNode = marker;
        ...
        _renderCenterButton : function() {
            _yuitest_coverfunc("build/dial/dial.js", "_renderCenterButton", 964);
_yuitest_coverline("build/dial/dial.js", 965);
var contentBox = this.get("contentBox"),
                centerButton = contentBox.one("." + Dial.CSS_CLASSES.centerButton);
            _yuitest_coverline("build/dial/dial.js", 967);
if (!centerButton) {
                _yuitest_coverline("build/dial/dial.js", 968);
...
contentBox.one('.' + Dial.CSS_CLASSES.ring).append(centerButton);
            ...
            _yuitest_coverline("build/dial/dial.js", 971);
...
this._resetString = this._centerButtonNode.one('.' + Dial.CSS_CLASSES.resetString);
        ...
        _renderHandle : function() {
            _yuitest_coverfunc("build/dial/dial.js", "_renderHandle", 981);
...
this._labelNode.one('.' + Dial.CSS_CLASSES.labelString).setAttribute('id', labelId);  // When handle gets focus, screen reader will include label text when reading the value.
                _yuitest_coverline("build/dial/dial.js", 989);
...
this._handleNode = handle;
        ...
        _setLabelString : function(str) {
            _yuitest_coverfunc("build/dial/dial.js", "_setLabelString", 1003);
...
this.get("contentBox").one("." + Dial.CSS_CLASSES.labelString).setHTML(str);
        ...
        _setResetString : function(str) {
             _yuitest_coverfunc("build/dial/dial.js", "_setResetString", 1015);
_yuitest_coverline("build/dial/dial.js", 1016);
this.get("contentBox").one("." + Dial.CSS_CLASSES.resetString).setHTML(str);
        ...
        _setTooltipString : function(str) {
            _yuitest_coverfunc("build/dial/dial.js", "_setTooltipString", 1029);
_yuitest_coverline("build/dial/dial.js", 1030);
this._handleNode.set('title', str);
        ...
        _onDirectionKey : function(e) {
            _yuitest_coverfunc("build/dial/dial.js", "_onDirectionKey", 1043);
...
break;
                case 33: // page up
                    _yuitest_coverline("build/dial/dial.js", 1059);
this._incrMajor();
                    _yuitest_coverline("build/dial/dial.js", 1060);
break;
                case 34: // page down
...
break;
        ...
        _onLeftRightKey : function(e) {
            _yuitest_coverfunc("build/dial/dial.js", "_onLeftRightKey", 1074);
_yuitest_coverline("build/dial/dial.js", 1075);
e.preventDefault();
            _yuitest_coverline("build/dial/dial.js", 1076);
switch (e.charCode) {
                case 37: // left
                    _yuitest_coverline("build/dial/dial.js", 1078);
this._decrMinor();
                    _yuitest_coverline("build/dial/dial.js", 1079);
break;
                case 39: // right
...
break;
        ...
        _onLeftRightKeyMeta : function(e) {
            _yuitest_coverfunc("build/dial/dial.js", "_onLeftRightKeyMeta", 1093);
_yuitest_coverline("build/dial/dial.js", 1094);
e.preventDefault();
            _yuitest_coverline("build/dial/dial.js", 1095);
switch (e.charCode) {
                case 37: // left + meta
                    _yuitest_coverline("build/dial/dial.js", 1097);
this._setToMin();
                    _yuitest_coverline("build/dial/dial.js", 1098);
break;
                case 39: // right + meta
...
break;
         ...
         */
        _incrMinor : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_incrMinor", 1111);
_yuitest_coverline("build/dial/dial.js", 1112);
var newVal = (this.get('value') + this.get("minorStep"));
                _yuitest_coverline("build/dial/dial.js", 1113);
...
this.set('value', newVal.toFixed(this.get('decimalPlaces')) - 0);
         ...
         */
        _decrMinor : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_decrMinor", 1127);
...
this.set('value', newVal.toFixed(this.get('decimalPlaces')) - 0);
         ...
         */
        _incrMajor : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_incrMajor", 1139);
...
this.set('value', newVal.toFixed(this.get('decimalPlaces')) - 0);
         ...
         */
        _decrMajor : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_decrMajor", 1151);
_yuitest_coverline("build/dial/dial.js", 1152);
var newVal = (this.get('value') - this.get("majorStep"));
                _yuitest_coverline("build/dial/dial.js", 1153);
newVal = Math.max(newVal, this.get("min"));
                _yuitest_coverline("build/dial/dial.js", 1154);
this.set('value', newVal.toFixed(this.get('decimalPlaces')) - 0);
        },
         ...
         */
        _setToMax : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_setToMax", 1163);
_yuitest_coverline("build/dial/dial.js", 1164);
this.set('value', this.get("max"));
         ...
         */
        _setToMin : function(){
                _yuitest_coverfunc("build/dial/dial.js", "_setToMin", 1173);
...
this.set('value', this.get("min"));
        ...
        _resetDial : function(e){
            _yuitest_coverfunc("build/dial/dial.js", "_resetDial", 1183);
_yuitest_coverline("build/dial/dial.js", 1184);
if(e){
                _yuitest_coverline("build/dial/dial.js", 1185);
e.stopPropagation(); //[#2530206] need to add so mousedown doesn't propagate to ring and move the handle
            }
            _yuitest_coverline("build/dial/dial.js", 1187);
this.set('value', this._originalValue);
            _yuitest_coverline("build/dial/dial.js", 1188);
...
this._handleNode.focus();
        ...
        _getAngleFromValue : function(newVal){
            _yuitest_coverfunc("build/dial/dial.js", "_getAngleFromValue", 1201);
_yuitest_coverline("build/dial/dial.js", 1202);
...
return (angleFromValue < 0) ? (angleFromValue + 360) : angleFromValue;
        ...
        _getValueFromAngle : function(angle){
            _yuitest_coverfunc("build/dial/dial.js", "_getValueFromAngle", 1215);
_yuitest_coverline("build/dial/dial.js", 1216);
if(angle < 0){
                _yuitest_coverline("build/dial/dial.js", 1217);
angle = (360 + angle);
            }else {_yuitest_coverline("build/dial/dial.js", 1218);
if(angle === 0){
                _yuitest_coverline("build/dial/dial.js", 1219);
angle = 360;
            }}
            _yuitest_coverline("build/dial/dial.js", 1221);
...
value = (value + (this._timesWrapped * this._stepsPerRevolution));
            ...
            _yuitest_coverline("build/dial/dial.js", 1224);
return value.toFixed(this.get('decimalPlaces')) - 0;
        ...
        _afterValueChange : function(e) {
            _yuitest_coverfunc("build/dial/dial.js", "_afterValueChange", 1234);
_yuitest_coverline("build/dial/dial.js", 1235);
this._uiSetValue(e.newVal);
        ...
        _uiSetValue : function(val) { // [#2530206] cleaned up and better user feedback of when it's max or min.
            _yuitest_coverfunc("build/dial/dial.js", "_uiSetValue", 1259);
...
this._markerNode.addClass(Dial.CSS_CLASSES.hidden);
        ...
        _validateValue: function(val) {
            _yuitest_coverfunc("build/dial/dial.js", "_validateValue", 1295);
_yuitest_coverline("build/dial/dial.js", 1296);
var min = this.get("min"),
                max = this.get("max");
            _yuitest_coverline("build/dial/dial.js", 1298);
return (Lang.isNumber(val) && val >= min && val <= max);
        }
    });
    _yuitest_coverline("build/dial/dial.js", 1301);
Y.Dial = Dial;
