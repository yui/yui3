...
_yuitest_coverage["dd-constrain"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('dd-constrain', function (Y, NAME) {
    ...
    _yuitest_coverfunc("dd-constrain", "(anonymous 1)", 1);
_yuitest_coverline("dd-constrain", 18);
var DRAG_NODE = 'dragNode',
        ...
        */
        ...
        C = function(config) {
            _yuitest_coverfunc("dd-constrain", "C", 48);
_yuitest_coverline("dd-constrain", 49);
this._lazyAddAttrs = false;
            _yuitest_coverline("dd-constrain", 50);
C.superclass.constructor.apply(this, arguments);
        };

    _yuitest_coverline("dd-constrain", 53);
C.NAME = 'ddConstrained';
    ...
    * @type {String}
*/
    _yuitest_coverline("dd-constrain", 63);
C.NS = 'con';

    _yuitest_coverline("dd-constrain", 65);
C.ATTRS = {
        host: {
        },
        /**
        ...
        */
        gutter: {
            ...
            setter: function(gutter) {
                _yuitest_coverfunc("dd-constrain", "setter", 123);
_yuitest_coverline("dd-constrain", 124);
return Y.DD.DDM.cssSizestoObject(gutter);
        ...
        */
        constrain: {
            value: VIEW,
            setter: function(con) {
                _yuitest_coverfunc("dd-constrain", "setter", 137);
_yuitest_coverline("dd-constrain", 138);
var node = Y.one(con);
                _yuitest_coverline("dd-constrain", 139);
if (node) {
                    _yuitest_coverline("dd-constrain", 140);
con = node;
                }
                _yuitest_coverline("dd-constrain", 142);
return con;
            }
        },
        /**
        ...
        */
        constrain2region: {
            setter: function(r) {
                _yuitest_coverfunc("dd-constrain", "setter", 152);
_yuitest_coverline("dd-constrain", 153);
return this.set('constrain', r);
        ...
        */
        constrain2node: {
            setter: function(n) {
                _yuitest_coverfunc("dd-constrain", "setter", 163);
_yuitest_coverline("dd-constrain", 164);
return this.set('constrain', Y.one(n));
        ...
        */
        constrain2view: {
            setter: function(n) {
                _yuitest_coverfunc("dd-constrain", "setter", 174);
_yuitest_coverline("dd-constrain", 175);
return this.set('constrain', VIEW);
    ...
    _yuitest_coverline("dd-constrain", 188);
proto = {
        _lastTickXFired: null,
        _lastTickYFired: null,

        initializer: function() {
            _yuitest_coverfunc("dd-constrain", "initializer", 192);
_yuitest_coverline("dd-constrain", 193);
this._createEvents();

            _yuitest_coverline("dd-constrain", 195);
this._eventHandles = [
        ...
        destructor: function() {
            _yuitest_coverfunc("dd-constrain", "destructor", 202);
_yuitest_coverline("dd-constrain", 203);
Y.each(
                this._eventHandles,
                function(handle, index) {
                    _yuitest_coverfunc("dd-constrain", "(anonymous 2)", 205);
_yuitest_coverline("dd-constrain", 206);
handle.detach();
                }
            );

            _yuitest_coverline("dd-constrain", 210);
this._eventHandles.length = 0;
        ...
        */
        _createEvents: function() {
            _yuitest_coverfunc("dd-constrain", "_createEvents", 217);
_yuitest_coverline("dd-constrain", 218);
var ev = [
                EV_TICK_ALIGN_X,
                EV_TICK_ALIGN_Y
            ];

            _yuitest_coverline("dd-constrain", 223);
Y.each(ev, function(v, k) {
                _yuitest_coverfunc("dd-constrain", "(anonymous 3)", 223);
_yuitest_coverline("dd-constrain", 224);
this.publish(v, {
                    type: v,
                    emitFacade: true,
                    bubbles: true,
        ...
        */
        _handleEnd: function() {
            _yuitest_coverfunc("dd-constrain", "_handleEnd", 238);
_yuitest_coverline("dd-constrain", 239);
this._lastTickYFired = null;
            _yuitest_coverline("dd-constrain", 240);
this._lastTickXFired = null;
        ...
        */
        _handleStart: function() {
            _yuitest_coverfunc("dd-constrain", "_handleStart", 247);
_yuitest_coverline("dd-constrain", 248);
this.resetCache();
        },
        /**
        * @private
        ...
        */
        _cacheRegion: function() {
            _yuitest_coverfunc("dd-constrain", "_cacheRegion", 262);
_yuitest_coverline("dd-constrain", 263);
this._regionCache = this.get('constrain').get('region');
        ...
        */
        resetCache: function() {
            _yuitest_coverfunc("dd-constrain", "resetCache", 269);
_yuitest_coverline("dd-constrain", 270);
this._regionCache = null;
        ...
        */
        _getConstraint: function() {
            _yuitest_coverfunc("dd-constrain", "_getConstraint", 277);
_yuitest_coverline("dd-constrain", 278);
var con = this.get('constrain'),
                g = this.get('gutter'),
                region;

            _yuitest_coverline("dd-constrain", 282);
if (con) {
                _yuitest_coverline("dd-constrain", 283);
if (con instanceof Y.Node) {
                    _yuitest_coverline("dd-constrain", 284);
if (!this._regionCache) {
                        _yuitest_coverline("dd-constrain", 285);
this._eventHandles.push(Y.on('resize', Y.bind(this._cacheRegion, this), Y.config.win));
                        _yuitest_coverline("dd-constrain", 286);
this._cacheRegion();
                    }
                    _yuitest_coverline("dd-constrain", 288);
region = Y.clone(this._regionCache);
                    _yuitest_coverline("dd-constrain", 289);
if (!this.get('cacheRegion')) {
                        _yuitest_coverline("dd-constrain", 290);
this.resetCache();
                    }
                } else {_yuitest_coverline("dd-constrain", 292);
if (Y.Lang.isObject(con)) {
                    _yuitest_coverline("dd-constrain", 293);
region = Y.clone(con);
                }}
            }
            _yuitest_coverline("dd-constrain", 296);
if (!con || !region) {
                _yuitest_coverline("dd-constrain", 297);
con = VIEW;
            }
            _yuitest_coverline("dd-constrain", 299);
if (con === VIEW) {
                _yuitest_coverline("dd-constrain", 300);
region = this.get(HOST).get(DRAG_NODE).get('viewportRegion');
            }

            _yuitest_coverline("dd-constrain", 303);
Y.each(g, function(i, n) {
                _yuitest_coverfunc("dd-constrain", "(anonymous 4)", 303);
_yuitest_coverline("dd-constrain", 304);
if ((n == RIGHT) || (n == BOTTOM)) {
                    _yuitest_coverline("dd-constrain", 305);
region[n] -= i;
                } else {
                    _yuitest_coverline("dd-constrain", 307);
region[n] += i;
                }
            });
            _yuitest_coverline("dd-constrain", 310);
return region;
        },
        ...
        */
        getRegion: function(inc) {
            _yuitest_coverfunc("dd-constrain", "getRegion", 319);
_yuitest_coverline("dd-constrain", 320);
var r = {}, oh = null, ow = null,
                host = this.get(HOST);

            _yuitest_coverline("dd-constrain", 323);
r = this._getConstraint();

            _yuitest_coverline("dd-constrain", 325);
if (inc) {
                _yuitest_coverline("dd-constrain", 326);
oh = host.get(DRAG_NODE).get(OFFSET_HEIGHT);
                _yuitest_coverline("dd-constrain", 327);
ow = host.get(DRAG_NODE).get(OFFSET_WIDTH);
                _yuitest_coverline("dd-constrain", 328);
r[RIGHT] = r[RIGHT] - ow;
                _yuitest_coverline("dd-constrain", 329);
r[BOTTOM] = r[BOTTOM] - oh;
            }
            _yuitest_coverline("dd-constrain", 331);
return r;
        },
        /**
        * @private
        ...
        */
        _checkRegion: function(_xy) {
            _yuitest_coverfunc("dd-constrain", "_checkRegion", 340);
_yuitest_coverline("dd-constrain", 341);
var oxy = _xy,
                r = this.getRegion(),
                host = this.get(HOST),
                oh = host.get(DRAG_NODE).get(OFFSET_HEIGHT),
                ...
                _yuitest_coverline("dd-constrain", 347);
if (oxy[1] > (r[BOTTOM] - oh)) {
                    _yuitest_coverline("dd-constrain", 348);
_xy[1] = (r[BOTTOM] - oh);
                }
                _yuitest_coverline("dd-constrain", 350);
if (r[TOP] > oxy[1]) {
                    _yuitest_coverline("dd-constrain", 351);
_xy[1] = r[TOP];

                }
                _yuitest_coverline("dd-constrain", 354);
if (oxy[0] > (r[RIGHT] - ow)) {
                    _yuitest_coverline("dd-constrain", 355);
_xy[0] = (r[RIGHT] - ow);
                }
                _yuitest_coverline("dd-constrain", 357);
if (r[LEFT] > oxy[0]) {
                    _yuitest_coverline("dd-constrain", 358);
_xy[0] = r[LEFT];
                }

            _yuitest_coverline("dd-constrain", 361);
return _xy;
        },
        /**
        * @method inRegion
        ...
        */
        inRegion: function(xy) {
            _yuitest_coverfunc("dd-constrain", "inRegion", 369);
_yuitest_coverline("dd-constrain", 370);
xy = xy || this.get(HOST).get(DRAG_NODE).getXY();

            _yuitest_coverline("dd-constrain", 372);
var _xy = this._checkRegion([xy[0], xy[1]]),
                inside = false;
                _yuitest_coverline("dd-constrain", 374);
if ((xy[0] === _xy[0]) && (xy[1] === _xy[1])) {
                    _yuitest_coverline("dd-constrain", 375);
inside = true;
                }
            _yuitest_coverline("dd-constrain", 377);
return inside;
        },
        /**
        * @method align
        ...
        */
        align: function() {
            _yuitest_coverfunc("dd-constrain", "align", 383);
_yuitest_coverline("dd-constrain", 384);
var host = this.get(HOST),
                _xy = [host.actXY[0], host.actXY[1]],
                r = this.getRegion(true);

            _yuitest_coverline("dd-constrain", 388);
if (this.get('stickX')) {
                _yuitest_coverline("dd-constrain", 389);
_xy[1] = (host.startXY[1] - host.deltaXY[1]);
            }
            _yuitest_coverline("dd-constrain", 391);
if (this.get('stickY')) {
                _yuitest_coverline("dd-constrain", 392);
_xy[0] = (host.startXY[0] - host.deltaXY[0]);
            }

            _yuitest_coverline("dd-constrain", 395);
if (r) {
                _yuitest_coverline("dd-constrain", 396);
_xy = this._checkRegion(_xy);
            }

            _yuitest_coverline("dd-constrain", 399);
_xy = this._checkTicks(_xy, r);

            _yuitest_coverline("dd-constrain", 401);
host.actXY = _xy;
        },
        /**
        * @method drag
        ...
        */
        drag: function(event) {
            _yuitest_coverfunc("dd-constrain", "drag", 407);
_yuitest_coverline("dd-constrain", 408);
var host = this.get(HOST),
                xt = this.get('tickX'),
                yt = this.get('tickY'),
                _xy = [host.actXY[0], host.actXY[1]];

            _yuitest_coverline("dd-constrain", 413);
if ((Y.Lang.isNumber(xt) || this.get(TICK_X_ARRAY)) && (this._lastTickXFired !== _xy[0])) {
                _yuitest_coverline("dd-constrain", 414);
this._tickAlignX();
                _yuitest_coverline("dd-constrain", 415);
this._lastTickXFired = _xy[0];
            }

            _yuitest_coverline("dd-constrain", 418);
if ((Y.Lang.isNumber(yt) || this.get(TICK_Y_ARRAY)) && (this._lastTickYFired !== _xy[1])) {
                _yuitest_coverline("dd-constrain", 419);
this._tickAlignY();
                _yuitest_coverline("dd-constrain", 420);
this._lastTickYFired = _xy[1];
        ...
        */
        _checkTicks: function(xy, r) {
            _yuitest_coverfunc("dd-constrain", "_checkTicks", 431);
_yuitest_coverline("dd-constrain", 432);
var host = this.get(HOST),
                lx = (host.startXY[0] - host.deltaXY[0]),
                ly = (host.startXY[1] - host.deltaXY[1]),
                xt = this.get('tickX'),
                yt = this.get('tickY');
                _yuitest_coverline("dd-constrain", 437);
if (xt && !this.get(TICK_X_ARRAY)) {
                    _yuitest_coverline("dd-constrain", 438);
xy[0] = DDM._calcTicks(xy[0], lx, xt, r[LEFT], r[RIGHT]);
                }
                _yuitest_coverline("dd-constrain", 440);
if (yt && !this.get(TICK_Y_ARRAY)) {
                    _yuitest_coverline("dd-constrain", 441);
xy[1] = DDM._calcTicks(xy[1], ly, yt, r[TOP], r[BOTTOM]);
                }
                _yuitest_coverline("dd-constrain", 443);
if (this.get(TICK_X_ARRAY)) {
                    _yuitest_coverline("dd-constrain", 444);
xy[0] = DDM._calcTickArray(xy[0], this.get(TICK_X_ARRAY), r[LEFT], r[RIGHT]);
                }
                _yuitest_coverline("dd-constrain", 446);
if (this.get(TICK_Y_ARRAY)) {
                    _yuitest_coverline("dd-constrain", 447);
xy[1] = DDM._calcTickArray(xy[1], this.get(TICK_Y_ARRAY), r[TOP], r[BOTTOM]);
                }

            _yuitest_coverline("dd-constrain", 450);
return xy;
        },
        /**
        * @private
        ...
        */
        _tickAlignX: function() {
            _yuitest_coverfunc("dd-constrain", "_tickAlignX", 457);
_yuitest_coverline("dd-constrain", 458);
this.fire(EV_TICK_ALIGN_X);
        ...
        */
        _tickAlignY: function() {
            _yuitest_coverfunc("dd-constrain", "_tickAlignY", 465);
_yuitest_coverline("dd-constrain", 466);
this.fire(EV_TICK_ALIGN_Y);
        }
    };

    _yuitest_coverline("dd-constrain", 470);
Y.namespace('Plugin');
    _yuitest_coverline("dd-constrain", 471);
Y.extend(C, Y.Base, proto);
    _yuitest_coverline("dd-constrain", 472);
Y.Plugin.DDConstrained = C;

    _yuitest_coverline("dd-constrain", 474);
Y.mix(DDM, {
        /**
        * @for DDM
        * @namespace DD
        ...
        */
        _calcTicks: function(pos, start, tick, off1, off2) {
            _yuitest_coverfunc("dd-constrain", "_calcTicks", 488);
_yuitest_coverline("dd-constrain", 489);
var ix = ((pos - start) / tick),
                min = Math.floor(ix),
                max = Math.ceil(ix);
                _yuitest_coverline("dd-constrain", 492);
if ((min !== 0) || (max !== 0)) {
                    _yuitest_coverline("dd-constrain", 493);
if ((ix >= min) && (ix <= max)) {
                        _yuitest_coverline("dd-constrain", 494);
pos = (start + (tick * min));
                        _yuitest_coverline("dd-constrain", 495);
if (off1 && off2) {
                            _yuitest_coverline("dd-constrain", 496);
if (pos < off1) {
                                _yuitest_coverline("dd-constrain", 497);
pos = (start + (tick * (min + 1)));
                            }
                            _yuitest_coverline("dd-constrain", 499);
if (pos > off2) {
                                _yuitest_coverline("dd-constrain", 500);
pos = (start + (tick * (min - 1)));
                            }
                        }
                    }
                }
                _yuitest_coverline("dd-constrain", 505);
return pos;
        },
        /**
        * @for DDM
        ...
        */
        _calcTickArray: function(pos, ticks, off1, off2) {
            _yuitest_coverfunc("dd-constrain", "_calcTickArray", 519);
_yuitest_coverline("dd-constrain", 520);
var i = 0, len = ticks.length, next = 0,
                diff1, diff2, ret;

            _yuitest_coverline("dd-constrain", 523);
if (!ticks || (ticks.length === 0)) {
                _yuitest_coverline("dd-constrain", 524);
return pos;
            } else {_yuitest_coverline("dd-constrain", 525);
if (ticks[0] >= pos) {
                _yuitest_coverline("dd-constrain", 526);
return ticks[0];
            } else {
                _yuitest_coverline("dd-constrain", 528);
for (i = 0; i < len; i++) {
                    _yuitest_coverline("dd-constrain", 529);
next = (i + 1);
                    _yuitest_coverline("dd-constrain", 530);
if (ticks[next] && ticks[next] >= pos) {
                        _yuitest_coverline("dd-constrain", 531);
diff1 = pos - ticks[i];
                        _yuitest_coverline("dd-constrain", 532);
diff2 = ticks[next] - pos;
                        _yuitest_coverline("dd-constrain", 533);
ret = (diff2 > diff1) ? ticks[i] : ticks[next];
                        _yuitest_coverline("dd-constrain", 534);
if (off1 && off2) {
                            _yuitest_coverline("dd-constrain", 535);
if (ret > off2) {
                                _yuitest_coverline("dd-constrain", 536);
if (ticks[i]) {
                                    _yuitest_coverline("dd-constrain", 537);
ret = ticks[i];
                                } else {
                                    _yuitest_coverline("dd-constrain", 539);
ret = ticks[len - 1];
                                }
                            }
                        }
                        _yuitest_coverline("dd-constrain", 543);
return ret;
                    }

                }
                _yuitest_coverline("dd-constrain", 547);
