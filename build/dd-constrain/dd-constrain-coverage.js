...
return pos;
            } else {_yuitest_coverline("/build/dd-constrain/dd-constrain.js", 525);
if (ticks[0] >= pos) {
                _yuitest_coverline("/build/dd-constrain/dd-constrain.js", 526);
return ticks[0];
            } else {
                _yuitest_coverline("/build/dd-constrain/dd-constrain.js", 528);
for (i = 0; i < len; i++) {
                    _yuitest_coverline("/build/dd-constrain/dd-constrain.js", 529);
next = (i + 1);
...
return ret;
                ...
                _yuitest_coverline("/build/dd-constrain/dd-constrain.js", 547);
