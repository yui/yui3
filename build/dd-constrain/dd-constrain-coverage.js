...
if (ticks[0] >= pos) {
                _yuitest_coverline("dd-constrain", 527);
return ticks[0];
            }
...
if (ret > off2) {
                            _yuitest_coverline("dd-constrain", 538);
if (ticks[i]) {
                                _yuitest_coverline("dd-constrain", 539);
ret = ticks[i];
                            } else {
                                _yuitest_coverline("dd-constrain", 541);
ret = ticks[len - 1];
                            }
                        }
                    }
                    _yuitest_coverline("dd-constrain", 545);
return ret;
                }

            }
            _yuitest_coverline("dd-constrain", 549);
