...
_yuitest_coverage["/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 27);
var YArray    = Y.Array,
    Escape    = Y.Escape,
...
Highlight = {
    ...
    **/
    _REPLACER: function (match, p1, p2) {
         ...
         _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "_REPLACER", 75);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 79);
return p1 && !(/\s/).test(p2) ? match :
    ...
    **/
    all: function (haystack, needles, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "all", 133);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 134);
var validNeedles = [],
            esc, i, len, needle, regex, replacer;

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 137);
if (!options) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 138);
options = EMPTY_OBJECT;
        }

        // TODO: document options.replacer
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 142);
esc      = options.escapeHTML !== false;
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 143);
regex    = options.startsWith ? Highlight._START_REGEX : Highlight._REGEX;
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 144);
replacer = options.replacer || Highlight._REPLACER;
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 145);
needles  = isArray(needles) ? needles : [needles];
        ...
        // escaped haystack.
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 150);
for (i = 0, len = needles.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 151);
needle = needles[i];

            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 153);
if (needle) {
                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 154);
validNeedles.push(Escape.regex(esc ? Escape.html(needle) : needle));
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 159);
if (esc) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 160);
haystack = Escape.html(haystack);
        }

        // No point continuing if there are no needles.
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 164);
if (!validNeedles.length) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 165);
return haystack;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 168);
return haystack.replace(
    ...
    **/
    allCase: function (haystack, needles, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "allCase", 188);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 189);
return Highlight.all(haystack, needles,
    ...
    **/
    start: function (haystack, needles, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "start", 208);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 209);
return Highlight.all(haystack, needles,
    ...
    **/
    startCase: function (haystack, needles) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "startCase", 223);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 227);
return Highlight.start(haystack, needles, {caseSensitive: true});
    ...
    **/
    words: function (haystack, needles, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "words", 247);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 248);
var caseSensitive,
            mapper,
            template = Highlight._TEMPLATE,
            words;

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 253);
if (!options) {
            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 254);
options = EMPTY_OBJECT;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 257);
caseSensitive = !!options.caseSensitive;

        // Convert needles to a hash for faster lookups.
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 260);
needles = YArray.hash(
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 269);
mapper = options.mapper || function (word, needles) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "(anonymous 2)", 269);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 270);
if (needles.hasOwnProperty(caseSensitive ? word : word.toLowerCase())) {
                _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 271);
return template.replace(/\{s\}/g, Escape.html(word));
            }

            _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 274);
return Escape.html(word);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 279);
words = WordBreak.getWords(haystack, {
            includePunctuation: true,
            includeWhitespace : true
        });

        _yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 284);
return YArray.map(words, function (word) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "(anonymous 3)", 284);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 285);
return mapper(word, needles);
    ...
    **/
    wordsCase: function (haystack, needles) {
        ...
        // ever supports more options than caseSensitive, then we'll start
        // passing the options through.
        _yuitest_coverfunc("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", "wordsCase", 301);
_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 305);
return Highlight.words(haystack, needles, {caseSensitive: true});
    }
};

_yuitest_coverline("/home/yui/src/yui3/src/highlight/build_tmp/highlight-base.js", 309);
