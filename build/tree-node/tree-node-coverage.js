...
_yuitest_coverline("build/tree-node/tree-node.js", 64);
TreeNode.prototype = {
    // -- Public Properties ----------------------------------------------------
    ...
    **/
    append: function (node, options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "append", 197);
_yuitest_coverline("build/tree-node/tree-node.js", 198);
return this.tree.appendNode(this, node, options);
    ...
    **/
    close: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "close", 212);
_yuitest_coverline("build/tree-node/tree-node.js", 213);
this.tree.closeNode(this, options);
        _yuitest_coverline("build/tree-node/tree-node.js", 214);
return this;
    },
    ...
    **/
    empty: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "empty", 230);
...
return this.tree.emptyNode(this, options);
    ...
    **/
    hasChildren: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "hasChildren", 241);
_yuitest_coverline("build/tree-node/tree-node.js", 242);
return !!this.children.length;
    ...
    **/
    index: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "index", 253);
...
return this.parent ? this.parent.indexOf(this) : -1;
    ...
    **/
    indexOf: function (node) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "indexOf", 266);
_yuitest_coverline("build/tree-node/tree-node.js", 267);
var index;

        _yuitest_coverline("build/tree-node/tree-node.js", 269);
if (this._isIndexStale) {
            _yuitest_coverline("build/tree-node/tree-node.js", 270);
this._reindex();
        }
...
return typeof index === 'undefined' ? -1 : index;
    ...
    **/
    insert: function (node, options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "insert", 300);
...
return this.tree.insertNode(this, node, options);
    ...
    **/
    isInTree: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isInTree", 312);
_yuitest_coverline("build/tree-node/tree-node.js", 313);
if (this.tree.rootNode === this) {
            _yuitest_coverline("build/tree-node/tree-node.js", 314);
return true;
        }
...
return !!(this.parent && this.parent.isInTree());
    ...
    **/
    isOpen: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isOpen", 326);
_yuitest_coverline("build/tree-node/tree-node.js", 327);
return !!this.state.open || this.isRoot();
    ...
    **/
    isRoot: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isRoot", 337);
_yuitest_coverline("build/tree-node/tree-node.js", 338);
return this.tree.rootNode === this;
    ...
    **/
    isSelected: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isSelected", 348);
_yuitest_coverline("build/tree-node/tree-node.js", 349);
return !!this.state.selected;
    ...
    **/
    open: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "open", 361);
...
return this;
    ...
    **/
    prepend: function (node, options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "prepend", 382);
_yuitest_coverline("build/tree-node/tree-node.js", 383);
return this.tree.prependNode(this, node, options);
    ...
    **/
    remove: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "remove", 398);
...
return this.tree.removeNode(this, options);
    ...
    **/
    select: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "select", 411);
...
return this;
    ...
    **/
    size: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "size", 424);
...
for (var i = 0; i < len; i++) {
            _yuitest_coverline("build/tree-node/tree-node.js", 430);
...
return total;
    ...
    **/
    toggle: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "toggle", 445);
...
return this;
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "toJSON", 456);
...
var obj   = {},
        ...
        _yuitest_coverline("build/tree-node/tree-node.js", 462);
if (state.destroyed) {
...
return null;
        ...
        _yuitest_coverline("build/tree-node/tree-node.js", 467);
...
if (key in this) {
                _yuitest_coverline("build/tree-node/tree-node.js", 471);
obj[key] = this[key];
            }
        }
...
obj.state = {};
        ...
        _yuitest_coverline("build/tree-node/tree-node.js", 478);
if (state.open) {
            _yuitest_coverline("build/tree-node/tree-node.js", 479);
obj.state.open = true;
        }
...
obj.state.selected = true;
        ...
        _yuitest_coverline("build/tree-node/tree-node.js", 487);
...
for (i = 0, len = this.children.length; i < len; i++) {
                _yuitest_coverline("build/tree-node/tree-node.js", 491);
obj.children.push(this.children[i].toJSON());
            }
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 495);
return obj;
    },
    ...
    **/
    unselect: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "unselect", 507);
_yuitest_coverline("build/tree-node/tree-node.js", 508);
this.tree.unselectNode(this, options);
        _yuitest_coverline("build/tree-node/tree-node.js", 509);
return this;
    },

    // -- Protected Methods ----------------------------------------------------
    _reindex: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "_reindex", 513);
_yuitest_coverline("build/tree-node/tree-node.js", 514);
var children = this.children,
            indexMap = {},
            i, len;

        _yuitest_coverline("build/tree-node/tree-node.js", 518);
for (i = 0, len = children.length; i < len; i++) {
            _yuitest_coverline("build/tree-node/tree-node.js", 519);
indexMap[children[i].id] = i;
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 522);
this._indexMap     = indexMap;
        _yuitest_coverline("build/tree-node/tree-node.js", 523);
this._isIndexStale = false;
    }
};

_yuitest_coverline("build/tree-node/tree-node.js", 527);
