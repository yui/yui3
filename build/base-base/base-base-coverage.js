...
_yuitest_coverage["/home/yui/src/yui3/src/base/build_tmp/base-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('base-base', function(Y) {
     ...
     * @submodule base-base
     */
    _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 34);
var L = Y.Lang,
     ...
     * </dl>
     */
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 89);
function Base() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "Base", 89);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 90);
BaseCore.apply(this, arguments);
     ...
     * @private
     */
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 102);
Base._ATTR_CFG = Attribute._ATTR_CFG.concat("cloneDefaultValue");
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 103);
Base._ATTR_CFG_HASH = Y.Array.hash(Base._ATTR_CFG);
     ...
     * @private
     */
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 120);
Base._NON_ATTRS_CFG = BaseCore._NON_ATTRS_CFG.concat(["on", "after", "bubbleTargets"]);
     ...
     * @static
     */
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 136);
Base.NAME = "base";
     ...
     * @static
     */
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 152);
Base.ATTRS = AttributeCore.prototype._protectAttrs(BaseCore.ATTRS);

    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 154);
Base.prototype = {
        ...
        _initBase: function(cfg) {
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_initBase", 163);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 165);
this._eventPrefix = this.constructor.EVENT_PREFIX || this.constructor.NAME;

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 167);
Y.BaseCore.prototype._initBase.call(this, cfg);
        ...
        _initAttribute: function(cfg) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_initAttribute", 176);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 177);
Attribute.call(this);
            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 178);
this._yuievt.config.prefix = this._eventPrefix;
        ...
        _attrCfgHash: function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_attrCfgHash", 188);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 189);
return Base._ATTR_CFG_HASH;
        ...
        init: function(config) {
             ...
             */
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "init", 202);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 220);
this.publish(INIT, {
                queuable:false,
                fireOnce:true,
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 227);
this._preInitEventCfg(config);

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 229);
this.fire(INIT, {cfg: config});

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 231);
return this;
        },
        ...
        _preInitEventCfg : function(config) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_preInitEventCfg", 243);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 244);
if (config) {
                _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 245);
if (config.on) {
                    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 246);
this.on(config.on);
                }
                _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 248);
if (config.after) {
                    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 249);
this.after(config.after);
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 253);
var i, l, target,
                userTargets = (config && BUBBLETARGETS in config);

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 256);
if (userTargets || _BUBBLETARGETS in this) {
                _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 257);
target = userTargets ? (config && config.bubbleTargets) : this._bubbleTargets;
                _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 258);
if (L.isArray(target)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 259);
for (i = 0, l = target.length; i < l; i++) { 
                        _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 260);
this.addTarget(target[i]);
                    }
                } else {_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 262);
if (target) {
                    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 263);
this.addTarget(target);
        ...
        destroy: function() {
             ...
             */
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "destroy", 283);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 301);
this.publish(DESTROY, {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 307);
this.fire(DESTROY);

            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 309);
this.detachAll();
            _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 310);
return this;
        },
        ...
        _defInitFn : function(e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_defInitFn", 321);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 322);
this._baseInit(e.cfg);
        ...
        _defDestroyFn : function(e) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/base/build_tmp/base-base.js", "_defDestroyFn", 332);
_yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 333);
this._baseDestroy(e.cfg);
        }
    };

    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 337);
Y.mix(Base, Attribute, false, null, 1);
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 338);
Y.mix(Base, BaseCore, false, null, 1);

    // Fix constructor
    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 341);
Base.prototype.constructor = Base;

    _yuitest_coverline("/home/yui/src/yui3/src/base/build_tmp/base-base.js", 343);
Y.Base = Base;
