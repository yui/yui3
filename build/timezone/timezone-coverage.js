...
_yuitest_coverline("build/timezone/timezone.js", 3145);
var MODULE_NAME = "timezone";
    
_yuitest_coverline("build/timezone/timezone.js", 3147);
AjxTimezone = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "AjxTimezone", 3147);
_yuitest_coverline("build/timezone/timezone.js", 3148);
...
_yuitest_coverline("build/timezone/timezone.js", 3155);
AjxTimezone.getTransition = function(onset, year) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getTransition", 3155);
_yuitest_coverline("build/timezone/timezone.js", 3156);
var trans = [ year || new Date().getFullYear(), onset.mon, 1 ];
    _yuitest_coverline("build/timezone/timezone.js", 3157);
if (onset.mday) {
        _yuitest_coverline("build/timezone/timezone.js", 3158);
trans[2] = onset.mday;
    }
    else {_yuitest_coverline("build/timezone/timezone.js", 3160);
if (onset.wkday) {
        _yuitest_coverline("build/timezone/timezone.js", 3161);
var date = new Date(year, onset.mon - 1, 1, onset.hour, onset.min, onset.sec);

        // last wkday of month
        _yuitest_coverline("build/timezone/timezone.js", 3164);
var wkday, adjust;
        _yuitest_coverline("build/timezone/timezone.js", 3165);
if (onset.week == -1) {
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3169);
...
trans[2] = count - adjust;
        ...
        // Nth wkday of month
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3178);
wkday = date.getDay() + 1;
...
trans[2] = onset.wkday + 7 * (onset.week - adjust) - wkday + 1;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3183);
return trans;
};

_yuitest_coverline("build/timezone/timezone.js", 3186);
AjxTimezone.addWkDayTransition = function(onset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "addWkDayTransition", 3186);
...
var mon = trans[1];
    _yuitest_coverline("build/timezone/timezone.js", 3189);
var monDay = trans[2];
    _yuitest_coverline("build/timezone/timezone.js", 3190);
var week = Math.floor((monDay - 1) / 7);
    _yuitest_coverline("build/timezone/timezone.js", 3191);
var date = new Date(trans[0], trans[1] - 1, trans[2], 12, 0, 0);

    // NOTE: This creates a date of the *last* day of specified month by
    //       setting the month to *next* month and setting day of month
    //       to zero (i.e. the day *before* the first day).
    _yuitest_coverline("build/timezone/timezone.js", 3196);
var count = new Date(new Date(date.getTime()).setMonth(mon - 1, 0)).getDate();
    _yuitest_coverline("build/timezone/timezone.js", 3197);
var last = count - monDay < 7;

    // set onset values
    _yuitest_coverline("build/timezone/timezone.js", 3200);
onset.mon =  mon;
...
_yuitest_coverline("build/timezone/timezone.js", 3209);
AjxTimezone.createTransitionDate = function(onset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "createTransitionDate", 3209);
_yuitest_coverline("build/timezone/timezone.js", 3210);
...
date.setDate(onset.mday);
    ...
    else {_yuitest_coverline("build/timezone/timezone.js", 3214);
if (onset.week == -1) {
...
break;
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3228);
date.setDate(date.getDate() + 1);
        }
...
_yuitest_coverline("build/timezone/timezone.js", 3236);
AjxTimezone.prototype.getShortName = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getShortName", 3236);
_yuitest_coverline("build/timezone/timezone.js", 3237);
var shortName = this.localeData[tzId + "_Z_short"] || ["GMT",AjxTimezone._SHORT_NAMES[tzId]].join("");
    _yuitest_coverline("build/timezone/timezone.js", 3238);
return shortName;
};
_yuitest_coverline("build/timezone/timezone.js", 3240);
AjxTimezone.prototype.getMediumName = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getMediumName", 3240);
...
var mediumName = this.localeData[tzId + "_Z_abbreviated"] || ['(',this.getShortName(tzId),') ',tzId].join("");
    _yuitest_coverline("build/timezone/timezone.js", 3242);
return mediumName;
};
_yuitest_coverline("build/timezone/timezone.js", 3244);
AjxTimezone.prototype.getLongName = AjxTimezone.prototype.getMediumName;

_yuitest_coverline("build/timezone/timezone.js", 3246);
AjxTimezone.addRule = function(rule) {
    _yuitest_coverfunc("build/timezone/timezone.js", "addRule", 3246);
_yuitest_coverline("build/timezone/timezone.js", 3247);
var tzId = rule.tzId;

    _yuitest_coverline("build/timezone/timezone.js", 3249);
AjxTimezone._SHORT_NAMES[tzId] = AjxTimezone._generateShortName(rule.standard.offset);
    _yuitest_coverline("build/timezone/timezone.js", 3250);
...
for (var j = 0; j < names.length; j++) {
                _yuitest_coverline("build/timezone/timezone.js", 3266);
var name = names[j];
...
if (!onset) {continue;}
                ...
                _yuitest_coverline("build/timezone/timezone.js", 3270);
...
break;
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3284);
if (found) {
...
_yuitest_coverline("build/timezone/timezone.js", 3294);
AjxTimezone.getOffset = function(tzId, date) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getOffset", 3294);
...
if (rule && rule.daylight) {
        _yuitest_coverline("build/timezone/timezone.js", 3297);
...
var stdTrans = AjxTimezone.getTransition(standard, year);
        _yuitest_coverline("build/timezone/timezone.js", 3301);
var dstTrans = AjxTimezone.getTransition(daylight, year);

        _yuitest_coverline("build/timezone/timezone.js", 3303);
var month    = date.getMonth()+1, day = date.getDate();
        _yuitest_coverline("build/timezone/timezone.js", 3304);
var stdMonth = stdTrans[1], stdDay = stdTrans[2];
        _yuitest_coverline("build/timezone/timezone.js", 3305);
var dstMonth = dstTrans[1], dstDay = dstTrans[2];

        // northern hemisphere
        _yuitest_coverline("build/timezone/timezone.js", 3308);
var isDST = false;
...
isDST = isDST || (month == stdMonth && day <  stdDay);
        ...
        // sorthern hemisphere
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3317);
isDST = month < dstMonth || month > stdMonth;
...
isDST = isDST || (month == stdMonth && day >= stdDay);
        ...
        _yuitest_coverline("build/timezone/timezone.js", 3322);
...
AjxTimezone._BY_OFFSET = function(arule, brule) {
    ...
    _yuitest_coverfunc("build/timezone/timezone.js", "_BY_OFFSET", 3327);
_yuitest_coverline("build/timezone/timezone.js", 3329);
var delta = arule.standard.offset - brule.standard.offset;
    _yuitest_coverline("build/timezone/timezone.js", 3330);
if (delta == 0) {
        _yuitest_coverline("build/timezone/timezone.js", 3331);
...
if (aname < bname) {delta = -1;}
        else {_yuitest_coverline("build/timezone/timezone.js", 3334);
if (aname > bname) {delta = 1;}}
    }
    _yuitest_coverline("build/timezone/timezone.js", 3336);
return delta;
};

// Constants

_yuitest_coverline("build/timezone/timezone.js", 3341);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3349);
AjxTimezone.STANDARD_RULES = [];
_yuitest_coverline("build/timezone/timezone.js", 3350);
AjxTimezone.DAYLIGHT_RULES = [];
_yuitest_coverline("build/timezone/timezone.js", 3351);
(function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "(anonymous 2)", 3351);
_yuitest_coverline("build/timezone/timezone.js", 3352);
for (var i = 0; i < TimezoneData.TIMEZONE_RULES.length; i++) {
        _yuitest_coverline("build/timezone/timezone.js", 3353);
var rule = TimezoneData.TIMEZONE_RULES[i];
        _yuitest_coverline("build/timezone/timezone.js", 3354);
var array = rule.daylight ? AjxTimezone.DAYLIGHT_RULES : AjxTimezone.STANDARD_RULES;
        _yuitest_coverline("build/timezone/timezone.js", 3355);
array.push(rule);
    }
})();

_yuitest_coverline("build/timezone/timezone.js", 3359);
AjxTimezone._generateShortName = function(offset, period) {
    _yuitest_coverfunc("build/timezone/timezone.js", "_generateShortName", 3359);
_yuitest_coverline("build/timezone/timezone.js", 3360);
if (offset == 0) {return "";}
    _yuitest_coverline("build/timezone/timezone.js", 3361);
var sign = offset < 0 ? "-" : "+";
    _yuitest_coverline("build/timezone/timezone.js", 3362);
var stdOffset = Math.abs(offset);
    _yuitest_coverline("build/timezone/timezone.js", 3363);
...
(function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "(anonymous 3)", 3370);
_yuitest_coverline("build/timezone/timezone.js", 3371);
TimezoneData.TIMEZONE_RULES.sort(AjxTimezone._BY_OFFSET);
    _yuitest_coverline("build/timezone/timezone.js", 3372);
for (var j = 0; j < TimezoneData.TIMEZONE_RULES.length; j++) {
        _yuitest_coverline("build/timezone/timezone.js", 3373);
...
Array.prototype.indexOf = function(obj) {
    _yuitest_coverfunc("build/timezone/timezone.js", "indexOf", 3378);
...
return i;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3384);
return -1;
}

_yuitest_coverline("build/timezone/timezone.js", 3387);
AjxTimezone.getCurrentTimezoneIds = function(rawOffset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getCurrentTimezoneIds", 3387);
...
var result = [];
    _yuitest_coverline("build/timezone/timezone.js", 3390);
var today = new Date();
    _yuitest_coverline("build/timezone/timezone.js", 3391);
for(tzId in AjxTimezone._CLIENT2RULE) {
        _yuitest_coverline("build/timezone/timezone.js", 3392);
...
result.push(tzId);
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3397);
for(link in TimezoneLinks) {
        _yuitest_coverline("build/timezone/timezone.js", 3398);
...
AjxTimezone.getTimezoneIdForOffset = function(rawOffset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getTimezoneIdForOffset", 3405);
_yuitest_coverline("build/timezone/timezone.js", 3406);
rawOffset = rawOffset/60;	//Need offset in minutes

    _yuitest_coverline("build/timezone/timezone.js", 3408);
if(rawOffset % 60 == 0) {
        _yuitest_coverline("build/timezone/timezone.js", 3409);
var etcGMTId = "Etc/GMT";
        _yuitest_coverline("build/timezone/timezone.js", 3410);
if(rawOffset != 0) {
            _yuitest_coverline("build/timezone/timezone.js", 3411);
...
if(AjxTimezone._CLIENT2RULE[etcGMTId] != null) {
            _yuitest_coverline("build/timezone/timezone.js", 3415);
return etcGMTId;
        } 
    }
	
    _yuitest_coverline("build/timezone/timezone.js", 3419);
var today = new Date();
...
if(AjxTimezone.getOffset(tzId, today) == rawOffset) {
            _yuitest_coverline("build/timezone/timezone.js", 3422);
return tzId;
        }
    }
...
AjxTimezone.isDST = function(tzId, date) {
    _yuitest_coverfunc("build/timezone/timezone.js", "isDST", 3429);
_yuitest_coverline("build/timezone/timezone.js", 3430);
var rule = AjxTimezone.getRule(tzId);
    _yuitest_coverline("build/timezone/timezone.js", 3431);
if (rule && rule.daylight) {
        _yuitest_coverline("build/timezone/timezone.js", 3432);
var year = date.getFullYear();
...
var dstTrans = AjxTimezone.getTransition(daylight, year);
        ...
        _yuitest_coverline("build/timezone/timezone.js", 3438);
var month    = date.getMonth()+1, day = date.getDate();
        _yuitest_coverline("build/timezone/timezone.js", 3439);
var stdMonth = stdTrans[1], stdDay = stdTrans[2];
        _yuitest_coverline("build/timezone/timezone.js", 3440);
var dstMonth = dstTrans[1], dstDay = dstTrans[2];

        // northern hemisphere
        _yuitest_coverline("build/timezone/timezone.js", 3443);
...
isDSTActive = isDSTActive || (month == stdMonth && day <  stdDay);
        ...
        // sorthern hemisphere
            ...
            _yuitest_coverline("build/timezone/timezone.js", 3452);
isDSTActive = month < dstMonth || month > stdMonth;
...
isDSTActive = isDSTActive || (month == stdMonth && day >= stdDay);
        ...
        _yuitest_coverline("build/timezone/timezone.js", 3457);
...
AjxTimezone.isValidTimezoneId = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "isValidTimezoneId", 3462);
_yuitest_coverline("build/timezone/timezone.js", 3463);
...
function zeroPad(num, length) {
    _yuitest_coverfunc("build/timezone/timezone.js", "zeroPad", 3478);
_yuitest_coverline("build/timezone/timezone.js", 3479);
length = length || 2;
    _yuitest_coverline("build/timezone/timezone.js", 3480);
var str = num + "";
    _yuitest_coverline("build/timezone/timezone.js", 3481);
for(var i=str.length; i<length; i++) {
        _yuitest_coverline("build/timezone/timezone.js", 3482);
str = "0" + str;
    }
    _yuitest_coverline("build/timezone/timezone.js", 3484);
return str;
}
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3492);
function getDOY(date) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getDOY", 3492);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3502);
function floatToInt(floatNum) {
    _yuitest_coverfunc("build/timezone/timezone.js", "floatToInt", 3502);
_yuitest_coverline("build/timezone/timezone.js", 3503);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3512);
Y.TimeZone = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "TimeZone", 3512);
_yuitest_coverline("build/timezone/timezone.js", 3513);
var normalizedId = Y.TimeZone.getNormalizedTimezoneId(tzId);
    _yuitest_coverline("build/timezone/timezone.js", 3514);
if(normalizedId == "") {
        _yuitest_coverline("build/timezone/timezone.js", 3515);
...
this.tzId = normalizedId;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3519);
this._ajxTimeZoneInstance = new AjxTimezone();
}

//Exception Handling
_yuitest_coverline("build/timezone/timezone.js", 3523);
Y.TimeZone.UnknownTimeZoneException = function (message) {
    _yuitest_coverfunc("build/timezone/timezone.js", "UnknownTimeZoneException", 3523);
_yuitest_coverline("build/timezone/timezone.js", 3524);
this.message = message;
}
_yuitest_coverline("build/timezone/timezone.js", 3526);
Y.TimeZone.UnknownTimeZoneException.prototype.toString = function () {
    _yuitest_coverfunc("build/timezone/timezone.js", "toString", 3526);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3537);
Y.TimeZone.getCurrentTimezoneIds = function(rawOffset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getCurrentTimezoneIds", 3537);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3548);
Y.TimeZone.getTimezoneIdForOffset = function(rawOffset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getTimezoneIdForOffset", 3548);
_yuitest_coverline("build/timezone/timezone.js", 3549);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3557);
Y.TimeZone.getUnixTimeFromWallTime = function(walltime) {
    /*
	 * Initialize any missing properties.
	 */
    _yuitest_coverfunc("build/timezone/timezone.js", "getUnixTimeFromWallTime", 3557);
_yuitest_coverline("build/timezone/timezone.js", 3561);
if(walltime.year == null) {
        _yuitest_coverline("build/timezone/timezone.js", 3562);
...
if(walltime.mon == null) {
        _yuitest_coverline("build/timezone/timezone.js", 3565);
walltime.mon = 0;				//Default to January
    }
    _yuitest_coverline("build/timezone/timezone.js", 3567);
if(walltime.mday == null) {
        _yuitest_coverline("build/timezone/timezone.js", 3568);
walltime.mday = 1;				//Default to first of month
    }
    _yuitest_coverline("build/timezone/timezone.js", 3570);
if(walltime.hour == null) {			//Default to 12 midnight
        _yuitest_coverline("build/timezone/timezone.js", 3571);
walltime.hour = 0;
    }
    _yuitest_coverline("build/timezone/timezone.js", 3573);
if(walltime.min == null) {
        _yuitest_coverline("build/timezone/timezone.js", 3574);
walltime.min = 0;
    }
...
var utcTime = Date.UTC(walltime.year, walltime.mon, walltime.mday, walltime.hour, walltime.min, walltime.sec);
    _yuitest_coverline("build/timezone/timezone.js", 3584);
...
Y.TimeZone.isValidTimestamp = function(timeStamp, rawOffset) {
    _yuitest_coverfunc("build/timezone/timezone.js", "isValidTimestamp", 3595);
_yuitest_coverline("build/timezone/timezone.js", 3596);
var regex = /^(\d\d\d\d)-([0-1][0-9])-([0-3][0-9])([T ])([0-2][0-9]):([0-6][0-9]):([0-6][0-9])(Z|[+-][0-1][0-9]:[0-3][0-9])?$/
    _yuitest_coverline("build/timezone/timezone.js", 3597);
var matches = (new RegExp(regex)).exec(timeStamp);

    //No match
    _yuitest_coverline("build/timezone/timezone.js", 3600);
if(matches == null) {
        _yuitest_coverline("build/timezone/timezone.js", 3601);
return false;
    }

    _yuitest_coverline("build/timezone/timezone.js", 3604);
var year = parseInt(matches[1]),
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3613);
if(month < 1 || month > 12) {
        _yuitest_coverline("build/timezone/timezone.js", 3614);
return false;
    }

    //Months with 31 days
    _yuitest_coverline("build/timezone/timezone.js", 3618);
var m31 = [1,3,5,7,8,10,12];
    _yuitest_coverline("build/timezone/timezone.js", 3619);
var maxDays = 30;
    _yuitest_coverline("build/timezone/timezone.js", 3620);
if(m31.indexOf(month) != -1) {
        _yuitest_coverline("build/timezone/timezone.js", 3621);
maxDays = 31;
    } else {_yuitest_coverline("build/timezone/timezone.js", 3622);
if(month == 2) {
        _yuitest_coverline("build/timezone/timezone.js", 3623);
if(year%4 == 0) {
            _yuitest_coverline("build/timezone/timezone.js", 3624);
maxDays = 29;
        } else {
            _yuitest_coverline("build/timezone/timezone.js", 3626);
maxDays = 28;
        }
    }}

    //Day should be valid day for month
    _yuitest_coverline("build/timezone/timezone.js", 3631);
if(day < 1 || day > maxDays) {	
        _yuitest_coverline("build/timezone/timezone.js", 3632);
return false;
    }
...
if(hours < 0 || hours > 23) {
        _yuitest_coverline("build/timezone/timezone.js", 3637);
return false;
    }
...
if(minutes < 0 || minutes > 59 || seconds < 0 || seconds > 59) {
        _yuitest_coverline("build/timezone/timezone.js", 3642);
return false;
    }
...
if(dateTimeSeparator == " " && tZone == null) {
        //SQL Format
        _yuitest_coverline("build/timezone/timezone.js", 3648);
return true;
    } else {_yuitest_coverline("build/timezone/timezone.js", 3649);
...
if(tZone != "Z") {
            //Not UTC TimeZone
            _yuitest_coverline("build/timezone/timezone.js", 3654);
offset = parseInt(tZone.substr(1,3))*60 + parseInt(tZone.substr(4));
            _yuitest_coverline("build/timezone/timezone.js", 3655);
...
offset = offset * (tZone.charAt(0) == "+" ? 1 : -1);
        ...
        _yuitest_coverline("build/timezone/timezone.js", 3660);
if(offset == rawOffset) {
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3674);
Y.TimeZone.isValidTimezoneId = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "isValidTimezoneId", 3674);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3684);
Y.TimeZone.getNormalizedTimezoneId = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getNormalizedTimezoneId", 3684);
_yuitest_coverline("build/timezone/timezone.js", 3685);
if(!Y.TimeZone.isValidTimezoneId(tzId)) {
        _yuitest_coverline("build/timezone/timezone.js", 3686);
return "";
    }
    _yuitest_coverline("build/timezone/timezone.js", 3688);
var normalizedId;       
    _yuitest_coverline("build/timezone/timezone.js", 3689);
var next = tzId;
        
    _yuitest_coverline("build/timezone/timezone.js", 3691);
do {
        _yuitest_coverline("build/timezone/timezone.js", 3692);
normalizedId = next;
        _yuitest_coverline("build/timezone/timezone.js", 3693);
next = TimezoneLinks[normalizedId];
    }while( next != null );
        
    _yuitest_coverline("build/timezone/timezone.js", 3696);
return normalizedId;
}
...
Y.TimeZone.prototype._parseRFC3339 = function(dString){
    _yuitest_coverfunc("build/timezone/timezone.js", "_parseRFC3339", 3707);
_yuitest_coverline("build/timezone/timezone.js", 3708);
var regexp = /(\d+)(-)?(\d+)(-)?(\d+)(T)?(\d+)(:)?(\d+)(:)?(\d+)(\.\d+)?(Z|([+-])(\d+)(:)?(\d+))/; 

    _yuitest_coverline("build/timezone/timezone.js", 3710);
var result = new Date();

    _yuitest_coverline("build/timezone/timezone.js", 3712);
var d = dString.match(regexp);
    _yuitest_coverline("build/timezone/timezone.js", 3713);
var offset = 0;

    _yuitest_coverline("build/timezone/timezone.js", 3715);
result.setUTCDate(1);
    _yuitest_coverline("build/timezone/timezone.js", 3716);
result.setUTCFullYear(parseInt(d[1],10));
    _yuitest_coverline("build/timezone/timezone.js", 3717);
result.setUTCMonth(parseInt(d[3],10) - 1);
    _yuitest_coverline("build/timezone/timezone.js", 3718);
result.setUTCDate(parseInt(d[5],10));
    _yuitest_coverline("build/timezone/timezone.js", 3719);
result.setUTCHours(parseInt(d[7],10));
    _yuitest_coverline("build/timezone/timezone.js", 3720);
result.setUTCMinutes(parseInt(d[9],10));
    _yuitest_coverline("build/timezone/timezone.js", 3721);
...
offset = (d[15] * 60) + parseInt(d[17],10);
        _yuitest_coverline("build/timezone/timezone.js", 3729);
offset *= ((d[14] == '-') ? -1 : 1);
 ...
 * @return {Date} The date represented by dString
 */
_yuitest_coverline("build/timezone/timezone.js", 3741);
Y.TimeZone.prototype._parseSQLFormat = function(dString) {
    _yuitest_coverfunc("build/timezone/timezone.js", "_parseSQLFormat", 3741);
...
var time = dateTime[1].split(":");
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3746);
...
_yuitest_coverline("build/timezone/timezone.js", 3753);
Y.TimeZone.prototype.getShortName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getShortName", 3753);
_yuitest_coverline("build/timezone/timezone.js", 3754);
...
Y.TimeZone.prototype.getMediumName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getMediumName", 3758);
_yuitest_coverline("build/timezone/timezone.js", 3759);
return this._ajxTimeZoneInstance.getMediumName(this.tzId);
}

//For use in Y.DateFormat.
_yuitest_coverline("build/timezone/timezone.js", 3763);
Y.TimeZone.prototype.getLongName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getLongName", 3763);
_yuitest_coverline("build/timezone/timezone.js", 3764);
 ...
 * @return {Number} UNIX time - time in seconds since Epoch
 */
_yuitest_coverline("build/timezone/timezone.js", 3772);
Y.TimeZone.prototype.convertToIncrementalUTC = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertToIncrementalUTC", 3772);
_yuitest_coverline("build/timezone/timezone.js", 3773);
if(timeValue.indexOf("T") != -1) {
        //RFC3339
        _yuitest_coverline("build/timezone/timezone.js", 3775);
...
Y.TimeZone.prototype.convertUTCToRFC3339Format = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertUTCToRFC3339Format", 3787);
_yuitest_coverline("build/timezone/timezone.js", 3788);
var uTime = new Date(timeValue * 1000);
    _yuitest_coverline("build/timezone/timezone.js", 3789);
var offset = AjxTimezone.getOffset(this.tzId, uTime);

    _yuitest_coverline("build/timezone/timezone.js", 3791);
var offsetString = "Z";
    _yuitest_coverline("build/timezone/timezone.js", 3792);
if(offset != 0) {
        _yuitest_coverline("build/timezone/timezone.js", 3793);
var offsetSign = (offset > 0 ? "+": "-");
        _yuitest_coverline("build/timezone/timezone.js", 3794);
offsetString = offsetSign + zeroPad(Math.abs(floatToInt(offset/60))) + ":" + zeroPad(offset % 60);
    }

    _yuitest_coverline("build/timezone/timezone.js", 3797);
uTime.setTime(timeValue*1000 + offset*60*1000);

    _yuitest_coverline("build/timezone/timezone.js", 3799);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3810);
Y.TimeZone.prototype.convertUTCToSQLFormat = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertUTCToSQLFormat", 3810);
_yuitest_coverline("build/timezone/timezone.js", 3811);
var uTime = new Date(timeValue * 1000);
    _yuitest_coverline("build/timezone/timezone.js", 3812);
var offset = AjxTimezone.getOffset(this.tzId, uTime);
    _yuitest_coverline("build/timezone/timezone.js", 3813);
uTime.setTime(timeValue*1000 + offset*60*1000);

    _yuitest_coverline("build/timezone/timezone.js", 3815);
var sqlDate = zeroPad(uTime.getUTCFullYear(), 4) + "-" + zeroPad((uTime.getUTCMonth() + 1)) + "-" + zeroPad(uTime.getUTCDate()) 
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3818);
return sqlDate;
}
...
Y.TimeZone.prototype.getRawOffset = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getRawOffset", 3825);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3834);
Y.TimeZone.prototype.getWallTimeFromUnixTime = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getWallTimeFromUnixTime", 3834);
_yuitest_coverline("build/timezone/timezone.js", 3835);
var offset = AjxTimezone.getOffset(this.tzId, new Date(timeValue*1000)) * 60;
    _yuitest_coverline("build/timezone/timezone.js", 3836);
var localTimeValue = timeValue + offset;
    _yuitest_coverline("build/timezone/timezone.js", 3837);
var date = new Date(localTimeValue*1000);

    _yuitest_coverline("build/timezone/timezone.js", 3839);
var walltime = {
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3853);
return walltime;
}
