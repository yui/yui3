...
_yuitest_coverage["build/timezone/timezone.js"].coveredLines = 347;
...
maxDays = 29;
        } else {_yuitest_coverline("build/timezone/timezone.js", 3625);
if(year % 100 == 0) {
            _yuitest_coverline("build/timezone/timezone.js", 3626);
maxDays = 28;
        } else {_yuitest_coverline("build/timezone/timezone.js", 3627);
if(year % 4 == 0) {
            _yuitest_coverline("build/timezone/timezone.js", 3628);
maxDays = 29;
        } else {
            _yuitest_coverline("build/timezone/timezone.js", 3630);
maxDays = 28;
        }}}
    }}
...
return false;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3640);
if(hours < 0 || hours > 23) {
...
return false;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3645);
...
return false;
    ...
    //Now verify timezone
    _yuitest_coverline("build/timezone/timezone.js", 3650);
if(dateTimeSeparator == " " && tZone == null) {
        //SQL Format
        _yuitest_coverline("build/timezone/timezone.js", 3652);
return true;
    } else {_yuitest_coverline("build/timezone/timezone.js", 3653);
...
if(tZone != "Z") {
            //Not UTC TimeZone
            _yuitest_coverline("build/timezone/timezone.js", 3658);
offset = parseInt(tZone.substr(1,3))*60 + parseInt(tZone.substr(4));
            _yuitest_coverline("build/timezone/timezone.js", 3659);
...
offset = offset * (tZone.charAt(0) == "+" ? 1 : -1);
        ...
        _yuitest_coverline("build/timezone/timezone.js", 3664);
if(offset == rawOffset) {
            _yuitest_coverline("build/timezone/timezone.js", 3665);
return true;
        }
    }}
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3678);
Y.TimeZone.isValidTimezoneId = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "isValidTimezoneId", 3678);
_yuitest_coverline("build/timezone/timezone.js", 3679);
...
Y.TimeZone.getNormalizedTimezoneId = function(tzId) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getNormalizedTimezoneId", 3688);
...
var next = tzId;
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3695);
do {
        _yuitest_coverline("build/timezone/timezone.js", 3696);
normalizedId = next;
        _yuitest_coverline("build/timezone/timezone.js", 3697);
...
Y.TimeZone.prototype._parseRFC3339 = function(dString){
    _yuitest_coverfunc("build/timezone/timezone.js", "_parseRFC3339", 3711);
_yuitest_coverline("build/timezone/timezone.js", 3712);
var regexp = /(\d+)(-)?(\d+)(-)?(\d+)(T)?(\d+)(:)?(\d+)(:)?(\d+)(\.\d+)?(Z|([+-])(\d+)(:)?(\d+))/; 

    _yuitest_coverline("build/timezone/timezone.js", 3714);
var result = new Date();
...
result.setUTCHours(parseInt(d[7],10));
    _yuitest_coverline("build/timezone/timezone.js", 3724);
...
result.setUTCSeconds(parseInt(d[11],10));
    _yuitest_coverline("build/timezone/timezone.js", 3726);
if (d[12]) {
...
Y.TimeZone.prototype._parseSQLFormat = function(dString) {
    _yuitest_coverfunc("build/timezone/timezone.js", "_parseSQLFormat", 3745);
_yuitest_coverline("build/timezone/timezone.js", 3746);
var dateTime = dString.split(" ");
    _yuitest_coverline("build/timezone/timezone.js", 3747);
var date = dateTime[0].split("-");
    _yuitest_coverline("build/timezone/timezone.js", 3748);
var time = dateTime[1].split(":");

    _yuitest_coverline("build/timezone/timezone.js", 3750);
var offset = AjxTimezone.getOffset(this.tzId, new Date(date[0], date[1] - 1, date[2]));
    _yuitest_coverline("build/timezone/timezone.js", 3751);
...
Y.TimeZone.prototype.getShortName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getShortName", 3757);
...
Y.TimeZone.prototype.getMediumName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getMediumName", 3762);
_yuitest_coverline("build/timezone/timezone.js", 3763);
return this._ajxTimeZoneInstance.getMediumName(this.tzId);
}

//For use in Y.DateFormat.
_yuitest_coverline("build/timezone/timezone.js", 3767);
Y.TimeZone.prototype.getLongName = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getLongName", 3767);
 ...
 * @return {Number} UNIX time - time in seconds since Epoch
 */
_yuitest_coverline("build/timezone/timezone.js", 3776);
Y.TimeZone.prototype.convertToIncrementalUTC = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertToIncrementalUTC", 3776);
_yuitest_coverline("build/timezone/timezone.js", 3777);
...
return this._parseRFC3339(timeValue).getTime() / 1000;
        ...
        //SQL
        _yuitest_coverline("build/timezone/timezone.js", 3782);
...
Y.TimeZone.prototype.convertUTCToRFC3339Format = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertUTCToRFC3339Format", 3791);
...
var offset = AjxTimezone.getOffset(this.tzId, uTime);
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3795);
var offsetString = "Z";
    _yuitest_coverline("build/timezone/timezone.js", 3796);
if(offset != 0) {
        _yuitest_coverline("build/timezone/timezone.js", 3797);
var offsetSign = (offset > 0 ? "+": "-");
        _yuitest_coverline("build/timezone/timezone.js", 3798);
offsetString = offsetSign + zeroPad(Math.abs(floatToInt(offset/60))) + ":" + zeroPad(offset % 60);
    }

    _yuitest_coverline("build/timezone/timezone.js", 3801);
...
Y.TimeZone.prototype.convertUTCToSQLFormat = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "convertUTCToSQLFormat", 3814);
_yuitest_coverline("build/timezone/timezone.js", 3815);
var uTime = new Date(timeValue * 1000);
    _yuitest_coverline("build/timezone/timezone.js", 3816);
var offset = AjxTimezone.getOffset(this.tzId, uTime);
    _yuitest_coverline("build/timezone/timezone.js", 3817);
uTime.setTime(timeValue*1000 + offset*60*1000);

    _yuitest_coverline("build/timezone/timezone.js", 3819);
var sqlDate = zeroPad(uTime.getUTCFullYear(), 4) + "-" + zeroPad((uTime.getUTCMonth() + 1)) + "-" + zeroPad(uTime.getUTCDate()) 
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3822);
return sqlDate;
}
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3829);
Y.TimeZone.prototype.getRawOffset = function() {
    _yuitest_coverfunc("build/timezone/timezone.js", "getRawOffset", 3829);
 ...
 */
_yuitest_coverline("build/timezone/timezone.js", 3838);
Y.TimeZone.prototype.getWallTimeFromUnixTime = function(timeValue) {
    _yuitest_coverfunc("build/timezone/timezone.js", "getWallTimeFromUnixTime", 3838);
...
var date = new Date(localTimeValue*1000);
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3843);
var walltime = {
    ...
    _yuitest_coverline("build/timezone/timezone.js", 3857);
return walltime;
}
