...
_yuitest_coverage["/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 14);
...
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 37);
function ConsoleFilters() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "ConsoleFilters", 37);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 38);
ConsoleFilters.superclass.constructor.apply(this,arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 41);
...
// Y.Plugin.ConsoleFilters prototype
{
    ...
    initializer : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "initializer", 92);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 93);
this._entries = [];

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 95);
this.get(HOST).on("entry", this._onEntry, this);

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 97);
this.doAfter("renderUI", this.renderUI);
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 98);
this.doAfter("syncUI", this.syncUI);
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 99);
this.doAfter("bindUI", this.bindUI);

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 101);
this.doAfter("clearConsole", this._afterClearConsole);

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 103);
if (this.get(HOST).get('rendered')) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 104);
this.renderUI();
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 105);
this.syncUI();
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 106);
this.bindUI();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 109);
this.after("cacheLimitChange", this._afterCacheLimitChange);
    ...
    destructor : function () {
        ...
        //them (no filtering)
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "destructor", 118);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 121);
this._entries = [];

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 123);
if (this._categories) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 124);
this._categories.remove();
        }
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 126);
if (this._sources) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 127);
this._sources.remove();
     ...
     */
    renderUI : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "renderUI", 137);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 138);
var foot = this.get(HOST).get('contentBox').one(C_FOOT),
            html;

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 141);
if (foot) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 142);
html = Y.substitute(
                        ConsoleFilters.CATEGORIES_TEMPLATE,
                        ConsoleFilters.CHROME_CLASSES);

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 146);
this._categories = foot.appendChild(Y.Node.create(html));

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 148);
html = Y.substitute(
                        ConsoleFilters.SOURCES_TEMPLATE,
                        ConsoleFilters.CHROME_CLASSES);

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 152);
this._sources = foot.appendChild(Y.Node.create(html));
     ...
     */
    bindUI : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "bindUI", 163);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 164);
this._categories.on('click', Y.bind(this._onCategoryCheckboxClick, this));

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 166);
this._sources.on('click', Y.bind(this._onSourceCheckboxClick, this));
            
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 168);
this.after('categoryChange',this._afterCategoryChange);
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 169);
this.after('sourceChange',  this._afterSourceChange);
     ...
     */
    syncUI : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "syncUI", 177);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 178);
Y.each(this.get(CATEGORY), function (v, k) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "(anonymous 2)", 178);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 179);
this._uiSetCheckbox(CATEGORY, k, v);
        }, this);

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 182);
Y.each(this.get(SOURCE), function (v, k) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "(anonymous 3)", 182);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 183);
this._uiSetCheckbox(SOURCE, k, v);
        }, this);

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 186);
this.refreshConsole();
    },
     ...
     */
    _onEntry : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_onEntry", 199);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 200);
this._entries.push(e.message);
        
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 202);
var cat = CATEGORY_DOT + e.message.category,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 209);
if (overLimit > 0) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 210);
this._entries.splice(0, overLimit);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 213);
if (cat_filter === undefined) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 214);
visible = this.get(DEF_VISIBILITY);
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 215);
this.set(cat, visible);
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 216);
cat_filter = visible;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 219);
if (src_filter === undefined) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 220);
visible = this.get(DEF_VISIBILITY);
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 221);
this.set(src, visible);
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 222);
src_filter = visible;
        }
        
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 225);
if (!cat_filter || !src_filter) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 226);
e.preventDefault();
        }
    },
    ...
    _afterClearConsole : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_afterClearConsole", 236);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 237);
this._entries = [];
    },
    ...
    _afterCategoryChange : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_afterCategoryChange", 249);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 250);
var cat    = e.subAttrName.replace(/category\./, EMPTY),
            before = e.prevVal,
            after  = e.newVal;

        // Don't update the console for new categories
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 255);
if (!cat || before[cat] !== undefined) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 256);
this.refreshConsole();

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 258);
this._filterBuffer();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 261);
if (cat && !e.fromUI) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 262);
this._uiSetCheckbox(CATEGORY, cat, after[cat]);
    ...
    _afterSourceChange : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_afterSourceChange", 275);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 276);
var src     = e.subAttrName.replace(/source\./, EMPTY),
            before = e.prevVal,
            after  = e.newVal;

        // Don't update the console for new sources
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 281);
if (!src || before[src] !== undefined) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 282);
this.refreshConsole();

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 284);
this._filterBuffer();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 287);
if (src && !e.fromUI) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 288);
this._uiSetCheckbox(SOURCE, src, after[src]);
    ...
    _filterBuffer : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_filterBuffer", 299);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 300);
var cats = this.get(CATEGORY),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 306);
for (i = buffer.length - 1; i >= 0; --i) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 307);
if (!cats[buffer[i].category] || !srcs[buffer[i].source]) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 308);
start = start || i;
            } else {_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 309);
if (start) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 310);
buffer.splice(i,(start - i));
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 311);
start = null;
            }}
        }
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 314);
if (start) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 315);
buffer.splice(0,start + 1);
    ...
    _afterCacheLimitChange : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_afterCacheLimitChange", 326);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 327);
if (isFinite(e.newVal)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 328);
var delta = this._entries.length - e.newVal;

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 330);
if (delta > 0) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 331);
this._entries.splice(0,delta);
    ...
    refreshConsole : function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "refreshConsole", 342);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 343);
var entries   = this._entries,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 352);
if (body) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 353);
host._cancelPrintLoop();

            // Evaluate all entries from latest to oldest
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 356);
for (i = entries.length - 1; i >= 0 && remaining >= 0; --i) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 357);
e = entries[i];
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 358);
if (cats[e.category] && srcs[e.source]) {
                    _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 359);
buffer.unshift(e);
                    _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 360);
--remaining;
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 364);
body.setHTML(EMPTY);
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 365);
host.buffer = buffer;
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 366);
host.printBuffer();
        }
    },
    ...
    _uiSetCheckbox : function (type, item, checked) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_uiSetCheckbox", 380);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 381);
if (type && item) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 382);
var container = type === CATEGORY ?
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 389);
if (!checkbox) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 390);
host = this.get(HOST);

                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 392);
this._createCheckbox(container, item);

                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 394);
checkbox = container.one(sel);

                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 396);
host._uiSetHeight(host.get('height'));
            }
            
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 399);
checkbox.set(CHECKED, checked);
    ...
    _onCategoryCheckboxClick : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_onCategoryCheckboxClick", 410);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 411);
var t = e.target, cat;

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 413);
if (t.hasClass(ConsoleFilters.CHROME_CLASSES.filter)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 414);
cat = t.get('value');
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 415);
if (cat && cat in this.get(CATEGORY)) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 416);
this.set(CATEGORY_DOT + cat, t.get(CHECKED), { fromUI: true });
    ...
    _onSourceCheckboxClick : function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_onSourceCheckboxClick", 428);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 429);
var t = e.target, src;

        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 431);
if (t.hasClass(ConsoleFilters.CHROME_CLASSES.filter)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 432);
src = t.get('value');
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 433);
if (src && src in this.get(SOURCE)) {
                _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 434);
this.set(SOURCE_DOT + src, t.get(CHECKED), { fromUI: true });
    ...
    hideCategory : function (cat, multiple) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "hideCategory", 447);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 448);
if (isString(multiple)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 449);
Y.Array.each(arguments, this.hideCategory, this);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 451);
this.set(CATEGORY_DOT + cat, false);
    ...
    showCategory : function (cat, multiple) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "showCategory", 463);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 464);
if (isString(multiple)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 465);
Y.Array.each(arguments, this.showCategory, this);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 467);
this.set(CATEGORY_DOT + cat, true);
    ...
    hideSource : function (src, multiple) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "hideSource", 479);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 480);
if (isString(multiple)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 481);
Y.Array.each(arguments, this.hideSource, this);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 483);
this.set(SOURCE_DOT + src, false);
    ...
    showSource : function (src, multiple) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "showSource", 495);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 496);
if (isString(multiple)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 497);
Y.Array.each(arguments, this.showSource, this);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 499);
this.set(SOURCE_DOT + src, true);
    ...
    _createCheckbox : function (container, name) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_createCheckbox", 513);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 514);
var info = Y.merge(ConsoleFilters.CHROME_CLASSES, {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 521);
container.appendChild(node);
    ...
    _validateCategory : function (cat, v) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_validateCategory", 534);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 535);
return Y.Lang.isObject(v,true) && cat.split(/\./).length < 3;
    ...
    _validateSource : function (src, v) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_validateSource", 548);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 549);
return Y.Lang.isObject(v,true) && src.split(/\./).length < 3;
    ...
    _setCacheLimit: function (v) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "_setCacheLimit", 561);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 562);
if (Y.Lang.isNumber(v)) {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 563);
this._cacheLimit = v;
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 564);
return v;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 566);
    ...
    ATTRS : {
        ...
        category : {
            ...
            validator : function (v,k) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "validator", 681);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 682);
return this._validateCategory(k,v);
        ...
        source : {
            value : {},
            validator : function (v,k) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "validator", 699);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 700);
return this._validateSource(k,v);
        ...
        cacheLimit : {
            ...
            setter : function (v) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", "setter", 715);
_yuitest_coverline("/home/yui/src/yui3/src/console-filters/build_tmp/console-filters.js", 716);
