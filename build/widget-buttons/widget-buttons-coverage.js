...
return buttonsCopy;
    ...
    **/
    _insertButtonContainer: function(section, buttonContainer, where) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_insertButtonContainer", 715);
...
this.setStdModContent(section, buttonContainer, where);
    ...
    **/
    _mapButton: function (button, section) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_mapButton", 733);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 734);
var map       = this._buttonsMap,
...
if (name) {
            // name -> button
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 740);
map[name] = button;

            // section:name -> button
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 743);
...
isDefault && (this._defaultButton = button);
    ...
    **/
    _mapButtons: function (buttons) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_mapButtons", 763);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 764);
this._buttonsMap    = {};
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 765);
this._defaultButton = null;

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 767);
YObject.each(buttons, function (sectionButtons, section) {
            _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "(anonymous 5)", 767);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 768);
var i, len;

            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 770);
...
this._mapButton(sectionButtons[i], section);
    ...
    **/
    _mergeButtonConfig: function (config) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_mergeButtonConfig", 788);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 789);
var buttonConfig, defConfig, name, button, tagName, label;

        // Makes sure `config` is an Object and a copy of the specified value.
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 792);
...
buttonConfig = {
            ...
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 808);
label && (buttonConfig.label = label);

            // Merge `config` with `buttonConfig` values.
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 811);
Y.mix(config, buttonConfig, false, null, 0, true);
        }

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 814);
name      = this._getButtonName(config);
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 815);
defConfig = this.BUTTONS && this.BUTTONS[name];

        // Merge `config` with predefined default values.
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 818);
if (defConfig) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 819);
...
return config;
    ...
    **/
    _parseButtons: function (srcNode) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_parseButtons", 838);
...
YArray.each(sections, function (section) {
            _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "(anonymous 6)", 843);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 844);
...
if (!buttons || buttons.isEmpty()) { return; }
            ...
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 850);
sectionButtons = [];
            ...
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 855);
buttons.each(function (button) {
                _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "(anonymous 7)", 855);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 856);
sectionButtons.push({srcNode: button});
            });

            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 859);
buttonsConfig || (buttonsConfig = {});
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 860);
buttonsConfig[section] = sectionButtons;
        }, this);

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 863);
return buttonsConfig;
    ...
    **/
    _setButtons: function (config) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_setButtons", 882);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 883);
var defSection = this.DEFAULT_BUTTONS_SECTION,
            buttons    = {};

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 886);
function processButtons(buttonConfigs, currentSection) {
            _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "processButtons", 886);
...
for (i = 0, len = buttonConfigs.length; i < len; i += 1) {
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 892);
...
button = this._createButton(button);
                ...
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 905);
section || (section = defSection);

                // Add button to the array of buttons for the specified section.
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 908);
...
YObject.each(config, processButtons, this);
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 919);
return buttons;
    },
    ...
    **/
    _syncUIButtons: function () {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_syncUIButtons", 930);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 931);
this._uiSetButtons(this.get('buttons'));
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 932);
...
this._uiSetVisibleButtons(this.get('visible'));
    ...
    **/
    _uiInsertButton: function (button, section, index) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_uiInsertButton", 950);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 951);
var buttonsClassName = WidgetButtons.CLASS_NAMES.button,
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 956);
buttonContainer.insertBefore(button, sectionButtons.item(index));

        // Adds the button container to the section content.
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 959);
this._insertButtonContainer(section, buttonContainer, 'after');
    ...
    **/
    _uiRemoveButton: function (button, section, options) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_uiRemoveButton", 981);
...
var yuid    = Y.stamp(button, this),
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 987);
if (handle) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 988);
handle.detach();
        }
...
button.remove();
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 995);
options || (options = {});
...
if (!options.preserveContent) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 999);
buttonContainer = this._getButtonContainer(section);
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1000);
buttonClassName = WidgetButtons.CLASS_NAMES.button;

            // Only matters if we have a button container which is empty.
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1003);
if (buttonContainer &&
                    buttonContainer.all('.' + buttonClassName).isEmpty()) {

                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1006);
buttonContainer.remove();
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1007);
this._updateContentButtons(section);
    ...
    **/
    _uiSetButtons: function (buttons) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_uiSetButtons", 1031);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1032);
var buttonClassName = WidgetButtons.CLASS_NAMES.button,
            sections        = ['header', 'body', 'footer'];

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1035);
YArray.each(sections, function (section) {
            _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "(anonymous 8)", 1035);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1036);
...
button      = sectionButtons[i];
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1050);
...
if (buttonIndex > -1) {
                    ...
                    // the DOM already.
                    _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1058);
...
oldNodes.each(function (button) {
                _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "(anonymous 9)", 1076);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1077);
this._uiRemoveButton(button, section, {preserveContent: true});
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1078);
buttonsUpdated = true;
            }, this);
...
buttonContainer.remove();
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1085);
this._updateContentButtons(section);
...
if (buttonsUpdated) {
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1091);
this._insertButtonContainer(section, buttonContainer, 'after');
            }
        }, this);
    },
    ...
    **/
    _uiSetDefaultButton: function (newButton, oldButton) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_uiSetDefaultButton", 1106);
...
if (oldButton) { oldButton.removeClass(primaryClassName); }
    ...
    **/
    _uiSetVisibleButtons: function (visible) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_uiSetVisibleButtons", 1122);
...
defaultButton.focus();
    ...
    **/
    _unMapButton: function (button, section) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_unMapButton", 1142);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1143);
var map  = this._buttonsMap,
            name = this._getButtonName(button),
            sectionName;
...
if (name) {
            // name -> button
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1150);
if (map[name] === button) {
                _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1151);
delete map[name];
            }
...
sectionName = section + ':' + name;
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1156);
...
if (this._defaultButton === button) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1163);
this._defaultButton = null;
        }
    },
    ...
    **/
    _updateDefaultButton: function () {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_updateDefaultButton", 1175);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1176);
var defaultButton = this._defaultButton;

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1178);
if (this.get('defaultButton') !== defaultButton) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1179);
this._set('defaultButton', defaultButton);
    ...
    **/
    _updateContentButtons: function (section) {
        ...
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_updateContentButtons", 1196);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1198);
var sectionContent = this.getStdModNode(section).get('childNodes');
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1201);
this.set(section + 'Content', sectionContent.isEmpty() ? null :
    ...
    **/
    _afterButtonsChange: function (e) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_afterButtonsChange", 1220);
...
this._mapButton(button, section);
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1233);
this._updateDefaultButton();
...
this._unMapButton(button, section);
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1245);
this._updateDefaultButton();
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1246);
this._uiRemoveButton(button, section);

            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1248);
return;
        }

        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1251);
this._mapButtons(buttons);
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1252);
this._updateDefaultButton();
...
this._uiSetButtons(buttons);
    ...
    **/
    _afterContentChangeButtons: function (e) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_afterContentChangeButtons", 1269);
...
var src     = e.src,
        ...
        _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1275);
if (replace && src !== 'buttons' && src !== Widget.UI_SRC) {
            _yuitest_coverline("build/widget-buttons/widget-buttons.js", 1276);
this._uiSetButtons(this.get('buttons'));
        }
    },
    ...
    **/
    _afterDefaultButtonChange: function (e) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_afterDefaultButtonChange", 1290);
...
this._uiSetDefaultButton(e.newVal, e.prevVal);
    ...
    **/
    _afterVisibleChangeButtons: function (e) {
        _yuitest_coverfunc("build/widget-buttons/widget-buttons.js", "_afterVisibleChangeButtons", 1303);
_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1304);
this._uiSetVisibleButtons(e.newVal);
    }
};

_yuitest_coverline("build/widget-buttons/widget-buttons.js", 1308);
