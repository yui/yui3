...
_yuitest_coverage["/home/yui/src/yui3/src/app/build_tmp/view.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 35);
function View() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "View", 35);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 36);
View.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 39);
Y.View = Y.extend(View, Y.Base, {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "initializer", 128);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 129);
config || (config = {});

        // Set instance properties specified in the config.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 132);
config.containerTemplate &&
            (this.containerTemplate = config.containerTemplate);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 135);
config.template && (this.template = config.template);

        // Merge events from the config into events in `this.events`.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 138);
this.events = config.events ? Y.merge(this.events, config.events) :
        ...
        // than always on init.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 145);
this.after('containerChange', this._afterContainerChange);
    ...
    */
    destroy: function (options) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "destroy", 161);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 163);
if (options && (options.remove || options['delete'])) {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 168);
this.onceAfter('destroy', function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "(anonymous 2)", 168);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 169);
this._destroyContainer();
            });
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 173);
return View.superclass.destroy.call(this);
    },

    destructor: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "destructor", 176);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 177);
this.detachEvents();
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 178);
delete this._container;
    ...
    **/
    attachEvents: function (events) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "attachEvents", 197);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 198);
var container = this.get('container'),
            owns      = Y.Object.owns,
            handler, handlers, name, selector;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 202);
this.detachEvents();

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 204);
events || (events = this.events);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 206);
for (selector in events) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 207);
if (!owns(events, selector)) { continue; }

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 209);
handlers = events[selector];

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 211);
for (name in handlers) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 212);
if (!owns(handlers, name)) { continue; }

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 214);
handler = handlers[name];

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 216);
if (typeof handler === 'string') {
                    _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 217);
handler = this[handler];
                }

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 220);
this._attachedViewEvents.push(
                    container.delegate(name, handler, selector, this));
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 225);
return this;
    },
    ...
    **/
    create: function (container) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "create", 243);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 244);
return container ? Y.one(container) :
    ...
    **/
    detachEvents: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "detachEvents", 256);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 257);
Y.Array.each(this._attachedViewEvents, function (handle) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "(anonymous 3)", 257);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 258);
handle.detach();
        });

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 261);
this._attachedViewEvents = [];
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 262);
return this;
    },
    ...
    **/
    remove: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "remove", 272);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 273);
var container = this.get('container');
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 274);
container && container.remove();
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 275);
return this;
    },
    ...
    **/
    render: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "render", 299);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 300);
return this;
    },
    ...
    **/
    _destroyContainer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "_destroyContainer", 311);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 312);
var container = this.get('container');
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 313);
container && container.remove(true);
    ...
    **/
    _getContainer: function (value) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "_getContainer", 325);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 330);
if (!this._container) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 331);
if (value) {
                // Attach events to the container when it's specified via a
                // valueFn, which won't fire the containerChange event.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 334);
this._container = value;
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 335);
this.attachEvents();
            } else {
                // Create a default container and set that as the new attribute
                // value. The `this._container` property prevents infinite
                // recursion.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 340);
value = this._container = this.create();
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 341);
this._set('container', value);
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 345);
return value;
    },
    ...
    **/
    _afterContainerChange: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/view.js", "_afterContainerChange", 362);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/view.js", 363);
