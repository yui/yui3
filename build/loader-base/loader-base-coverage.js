...
Y.Get.css(modules.css, {
                ...
                onProgress: function(e) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onProgress", 2392);
_yuitest_coverline("build/loader-base/loader-base.js", 2393);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onTimeout", 2395);
_yuitest_coverline("build/loader-base/loader-base.js", 2396);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onSuccess", 2398);
...
complete.call(self, d);
                ...
                onFailure: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onFailure", 2403);
...
Y.Get.js(modules.js, {
                ...
                async: self.async,
                onProgress: function(e) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onProgress", 2421);
_yuitest_coverline("build/loader-base/loader-base.js", 2422);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onTimeout", 2424);
_yuitest_coverline("build/loader-base/loader-base.js", 2425);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onSuccess", 2427);
...
complete.call(self, d);
                ...
                onFailure: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onFailure", 2432);
...
complete.call(self, d);
    ...
    */
    _continue: function() {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_continue", 2445);
...
_queue.next()();
    ...
    insert: function(o, type, skipsort) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "insert", 2460);
...
_queue.add(function() {
            _yuitest_coverfunc("build/loader-base/loader-base.js", "(anonymous 6)", 2464);
...
this._continue();
    ...
    loadNext: function(mname) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "loadNext", 2481);
...
return;
    ...
    _filter: function(u, name, group) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_filter", 2494);
_yuitest_coverline("build/loader-base/loader-base.js", 2495);
var f = this.filter,
            hasFilter = name && (name in this.filters),
            modFilter = hasFilter && this.filters[name],
            groupName = group || (this.moduleInfo[name] ? this.moduleInfo[name].group : null);

        _yuitest_coverline("build/loader-base/loader-base.js", 2500);
if (groupName && this.groups[groupName] && this.groups[groupName].filter) {
            _yuitest_coverline("build/loader-base/loader-base.js", 2501);
...
return u;
    ...
    _url: function(path, name, base) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_url", 2525);
...
return this._filter((base || this.base || '') + path, name);
    ...
    */
    resolve: function(calc, s) {
        ...
        _yuitest_coverfunc("build/loader-base/loader-base.js", "resolve", 2547);
...
var addSingle = function(m) {
            ...
            _yuitest_coverfunc("build/loader-base/loader-base.js", "addSingle", 2566);
...
return resolved;
    ...
    */
    load: function(cb) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "load", 2746);
_yuitest_coverline("build/loader-base/loader-base.js", 2747);
if (!cb) {
            _yuitest_coverline("build/loader-base/loader-base.js", 2748);
return;
        }
...
self.onEnd = function() {
            _yuitest_coverfunc("build/loader-base/loader-base.js", "onEnd", 2755);
