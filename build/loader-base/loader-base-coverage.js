...
_yuitest_coverfunc("loader-base", "(anonymous 1)", 1);
_yuitest_coverline("loader-base", 9);
if (!YUI.Env[Y.version]) {

    _yuitest_coverline("loader-base", 11);
(function() {
        _yuitest_coverfunc("loader-base", "(anonymous 2)", 11);
_yuitest_coverline("loader-base", 12);
var VERSION = Y.version,
            ...
            yui2Update = function(tnt, yui2, config) {
                ...
                _yuitest_coverfunc("loader-base", "yui2Update", 37);
_yuitest_coverline("loader-base", 39);
var root = TNT + '.' +
                        (tnt || TNT_VERSION) + '/' +
                ...
                _yuitest_coverline("loader-base", 45);
groups.yui2.base = base + root;
                _yuitest_coverline("loader-base", 46);
groups.yui2.root = root;
                _yuitest_coverline("loader-base", 47);
groups.yui2.comboBase = combo;
            },
            galleryUpdate = function(tag, config) {
                _yuitest_coverfunc("loader-base", "galleryUpdate", 49);
_yuitest_coverline("loader-base", 50);
var root = (tag || GALLERY_VERSION) + BUILD,
                    base = (config && config.base) ? config.base : CDN_BASE,
                    combo = (config && config.comboBase) ? config.comboBase : COMBO_BASE;

                _yuitest_coverline("loader-base", 54);
groups.gallery.base = base + root;
                _yuitest_coverline("loader-base", 55);
groups.gallery.root = root;
                _yuitest_coverline("loader-base", 56);
groups.gallery.comboBase = combo;
            };


        _yuitest_coverline("loader-base", 60);
groups[VERSION] = {};

        _yuitest_coverline("loader-base", 62);
groups.gallery = {
            ext: false,
            combine: true,
            comboBase: COMBO_BASE,
        ...
        _yuitest_coverline("loader-base", 72);
groups.yui2 = {
            combine: true,
            ext: false,
            comboBase: COMBO_BASE,
            ...
            patterns: {
                'yui2-': {
                    configFn: function(me) {
                        _yuitest_coverfunc("loader-base", "configFn", 79);
_yuitest_coverline("loader-base", 80);
if (/-skin|reset|fonts|grids|base/.test(me.name)) {
                            _yuitest_coverline("loader-base", 81);
me.type = 'css';
                            _yuitest_coverline("loader-base", 82);
me.path = me.path.replace(/\.js/, '.css');
                            // this makes skins in builds earlier than
                            // 2.6.0 work as long as combine is false
                            _yuitest_coverline("loader-base", 85);
me.path = me.path.replace(/\/yui2-skin/,
        ...
        _yuitest_coverline("loader-base", 93);
galleryUpdate();
        _yuitest_coverline("loader-base", 94);
yui2Update();

        _yuitest_coverline("loader-base", 96);
...
_yuitest_coverline("loader-base", 116);
var NOT_FOUND = {},
    NO_REQUIREMENTS = [],
    MAX_URL_LENGTH = 1024,
    GLOBAL_ENV = YUI.Env,
    ...
    _path = function(dir, file, type, nomin) {
        _yuitest_coverfunc("loader-base", "_path", 137);
_yuitest_coverline("loader-base", 138);
var path = dir + '/' + file;
        _yuitest_coverline("loader-base", 139);
if (!nomin) {
            _yuitest_coverline("loader-base", 140);
path += '-min';
        }
        _yuitest_coverline("loader-base", 142);
path += '.' + (type || CSS);

        _yuitest_coverline("loader-base", 144);
return path;
    };


    _yuitest_coverline("loader-base", 148);
if (!YUI.Env._cssLoaded) {
        _yuitest_coverline("loader-base", 149);
YUI.Env._cssLoaded = {};
    }
 ...
 * @for YUI
 */
_yuitest_coverline("loader-base", 159);
Y.Env.meta = META;
 ...
 */
_yuitest_coverline("loader-base", 207);
Y.Loader = function(o) {

    _yuitest_coverfunc("loader-base", "Loader", 207);
_yuitest_coverline("loader-base", 209);
var self = this;
    
    //Catch no config passed.
    _yuitest_coverline("loader-base", 212);
o = o || {};

    _yuitest_coverline("loader-base", 214);
modulekey = META.md5;
     ...
     */
    _yuitest_coverline("loader-base", 268);
self.context = Y;
     ...
     */
    _yuitest_coverline("loader-base", 311);
self.base = Y.Env.meta.base + Y.Env.meta.root;
     ...
     */
    _yuitest_coverline("loader-base", 319);
self.comboBase = Y.Env.meta.comboBase;
     ...
     */
    _yuitest_coverline("loader-base", 334);
self.combine = o.base &&
    ...
    * @default Ampersand
    */
    _yuitest_coverline("loader-base", 343);
self.comboSep = '&';
    /**
     ...
     * @type int
     */
    _yuitest_coverline("loader-base", 355);
self.maxURLLength = MAX_URL_LENGTH;
     ...
     * @default false
     */
    _yuitest_coverline("loader-base", 362);
self.ignoreRegistered = o.ignoreRegistered;
     ...
     */
    _yuitest_coverline("loader-base", 371);
self.root = Y.Env.meta.root;
     ...
     * @type int
     */
    _yuitest_coverline("loader-base", 380);
self.timeout = 0;
    ...
    _yuitest_coverline("loader-base", 398);
self.forceMap = {};
     ...
     * @default false
     */
    _yuitest_coverline("loader-base", 406);
self.allowRollup = false;
     ...
     * @type object
     */
    _yuitest_coverline("loader-base", 441);
self.filters = {};
     ...
     * @type {string: boolean}
     */
    _yuitest_coverline("loader-base", 448);
self.required = {};
    ...
    _yuitest_coverline("loader-base", 461);
self.patterns = {};
    ...
    _yuitest_coverline("loader-base", 468);
self.moduleInfo = {};

    _yuitest_coverline("loader-base", 470);
self.groups = Y.merge(Y.Env.meta.groups);
     ...
     * @type {Object}
     */
    _yuitest_coverline("loader-base", 500);
self.skin = Y.merge(Y.Env.meta.skin);
     ...
     * @since 3.2.0
     */
    _yuitest_coverline("loader-base", 506);
self.conditions = {};

    // map of modules with a hash of modules that meet the requirement
    // self.provides = {};

    _yuitest_coverline("loader-base", 511);
self.config = o;
    _yuitest_coverline("loader-base", 512);
self._internal = true;

    _yuitest_coverline("loader-base", 514);
self._populateCache();
     ...
     * @type {string: boolean}
     */
    _yuitest_coverline("loader-base", 524);
self.loaded = GLOBAL_LOADED[VERSION];
    ...
    */
    ...
    _yuitest_coverline("loader-base", 532);
self.async = true;

    _yuitest_coverline("loader-base", 534);
self._inspectPage();

    _yuitest_coverline("loader-base", 536);
self._internal = false;

    _yuitest_coverline("loader-base", 538);
self._config(o);

    _yuitest_coverline("loader-base", 540);
self.forceMap = (self.force) ? Y.Array.hash(self.force) : {};	

    _yuitest_coverline("loader-base", 542);
self.testresults = null;

    _yuitest_coverline("loader-base", 544);
if (Y.config.tests) {
        _yuitest_coverline("loader-base", 545);
self.testresults = Y.config.tests;
     ...
     * @type string[]
     */
    _yuitest_coverline("loader-base", 570);
self.sorted = [];
     ...
     * @default true
     */
    _yuitest_coverline("loader-base", 586);
self.dirty = true;
     ...
     * @type {string: boolean}
     */
    _yuitest_coverline("loader-base", 593);
self.inserted = {};
     ...
     * @property skipped
     */
    _yuitest_coverline("loader-base", 600);
self.skipped = {};

    // Y.on('yui:load', self.loadNext, self);

    _yuitest_coverline("loader-base", 604);
self.tested = {};
    ...
    _yuitest_coverline("loader-base", 613);
if (self.ignoreRegistered) {
        //Clear inpage already processed modules.
        _yuitest_coverline("loader-base", 615);
self._resetModules();
    }

};

_yuitest_coverline("loader-base", 620);
Y.Loader.prototype = {
    /**
    ...
    */
    _populateCache: function() {
        _yuitest_coverfunc("loader-base", "_populateCache", 627);
_yuitest_coverline("loader-base", 628);
var self = this,
            defaults = META.modules,
            cache = GLOBAL_ENV._renderedMods,
            i;

        _yuitest_coverline("loader-base", 633);
if (cache && !self.ignoreRegistered) {
            _yuitest_coverline("loader-base", 634);
for (i in cache) {
                _yuitest_coverline("loader-base", 635);
if (cache.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 636);
self.moduleInfo[i] = Y.merge(cache[i]);
                }
            }

            _yuitest_coverline("loader-base", 640);
cache = GLOBAL_ENV._conditions;
            _yuitest_coverline("loader-base", 641);
for (i in cache) {
                _yuitest_coverline("loader-base", 642);
if (cache.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 643);
self.conditions[i] = Y.merge(cache[i]);
                }
            }

        } else {
            _yuitest_coverline("loader-base", 648);
for (i in defaults) {
                _yuitest_coverline("loader-base", 649);
if (defaults.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 650);
self.addModule(defaults[i], i);
    ...
    */
    _resetModules: function() {
        _yuitest_coverfunc("loader-base", "_resetModules", 661);
_yuitest_coverline("loader-base", 662);
var self = this, i, o;
        _yuitest_coverline("loader-base", 663);
for (i in self.moduleInfo) {
            _yuitest_coverline("loader-base", 664);
if (self.moduleInfo.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 665);
var mod = self.moduleInfo[i],
                    name = mod.name,
                    details  = (YUI.Env.mods[name] ? YUI.Env.mods[name].details : null);

                _yuitest_coverline("loader-base", 669);
if (details) {
                    _yuitest_coverline("loader-base", 670);
self.moduleInfo[name]._reset = true;
                    _yuitest_coverline("loader-base", 671);
self.moduleInfo[name].requires = details.requires || [];
                    _yuitest_coverline("loader-base", 672);
self.moduleInfo[name].optional = details.optional || [];
                    _yuitest_coverline("loader-base", 673);
self.moduleInfo[name].supersedes = details.supercedes || [];
                }

                _yuitest_coverline("loader-base", 676);
if (mod.defaults) {
                    _yuitest_coverline("loader-base", 677);
for (o in mod.defaults) {
                        _yuitest_coverline("loader-base", 678);
if (mod.defaults.hasOwnProperty(o)) {
                            _yuitest_coverline("loader-base", 679);
if (mod[o]) {
                                _yuitest_coverline("loader-base", 680);
mod[o] = mod.defaults[o];
                            }
                        }
                    }
                }
                _yuitest_coverline("loader-base", 685);
delete mod.langCache;
                _yuitest_coverline("loader-base", 686);
delete mod.skinCache;
                _yuitest_coverline("loader-base", 687);
if (mod.skinnable) {
                    _yuitest_coverline("loader-base", 688);
self._addSkin(self.skin.defaultSkin, mod.name);
    ...
    */
    _inspectPage: function() {
        _yuitest_coverfunc("loader-base", "_inspectPage", 731);
_yuitest_coverline("loader-base", 732);
var self = this, v, m, req, mr, i;

        //Inspect the page for CSS only modules and mark them as loaded.
        _yuitest_coverline("loader-base", 735);
for (i in self.moduleInfo) {
            _yuitest_coverline("loader-base", 736);
if (self.moduleInfo.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 737);
v = self.moduleInfo[i];
                _yuitest_coverline("loader-base", 738);
if (v.type && v.type === CSS) {
                    _yuitest_coverline("loader-base", 739);
if (self.isCSSLoaded(v.name)) {
                        _yuitest_coverline("loader-base", 740);
self.loaded[i] = true;
                    }
                }
            }
        }
        _yuitest_coverline("loader-base", 745);
for (i in ON_PAGE) {
            _yuitest_coverline("loader-base", 746);
if (ON_PAGE.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 747);
v = ON_PAGE[i];
                _yuitest_coverline("loader-base", 748);
if (v.details) {
                    _yuitest_coverline("loader-base", 749);
m = self.moduleInfo[v.name];
                    _yuitest_coverline("loader-base", 750);
req = v.details.requires;
                    _yuitest_coverline("loader-base", 751);
mr = m && m.requires;

                   _yuitest_coverline("loader-base", 753);
if (m) {
                       _yuitest_coverline("loader-base", 754);
if (!m._inspected && req && mr.length != req.length) {
                           // console.log('deleting ' + m.name);
                           _yuitest_coverline("loader-base", 756);
delete m.expanded;
                       }
                   } else {
                       _yuitest_coverline("loader-base", 759);
m = self.addModule(v.details, i);
                   }
                   _yuitest_coverline("loader-base", 761);
m._inspected = true;
               }
            }
        }
   ...
   _requires: function(mod1, mod2) {
        ...
        _yuitest_coverfunc("loader-base", "_requires", 773);
_yuitest_coverline("loader-base", 775);
var i, rm, after_map, s,
            info = this.moduleInfo,
            m = info[mod1],
            other = info[mod2];

        _yuitest_coverline("loader-base", 780);
if (!m || !other) {
            _yuitest_coverline("loader-base", 781);
return false;
        }

        _yuitest_coverline("loader-base", 784);
rm = m.expanded_map;
        _yuitest_coverline("loader-base", 785);
after_map = m.after_map;

        // check if this module should be sorted after the other
        // do this first to short circut circular deps
        _yuitest_coverline("loader-base", 789);
if (after_map && (mod2 in after_map)) {
            _yuitest_coverline("loader-base", 790);
return true;
        }

        _yuitest_coverline("loader-base", 793);
after_map = other.after_map;

        // and vis-versa
        _yuitest_coverline("loader-base", 796);
if (after_map && (mod1 in after_map)) {
            _yuitest_coverline("loader-base", 797);
return false;
        }

        // check if this module requires one the other supersedes
        _yuitest_coverline("loader-base", 801);
s = info[mod2] && info[mod2].supersedes;
        _yuitest_coverline("loader-base", 802);
if (s) {
            _yuitest_coverline("loader-base", 803);
for (i = 0; i < s.length; i++) {
                _yuitest_coverline("loader-base", 804);
if (this._requires(mod1, s[i])) {
                    _yuitest_coverline("loader-base", 805);
return true;
                }
            }
        }

        _yuitest_coverline("loader-base", 810);
s = info[mod1] && info[mod1].supersedes;
        _yuitest_coverline("loader-base", 811);
if (s) {
            _yuitest_coverline("loader-base", 812);
for (i = 0; i < s.length; i++) {
                _yuitest_coverline("loader-base", 813);
if (this._requires(mod2, s[i])) {
                    _yuitest_coverline("loader-base", 814);
return false;
                }
            }
        }
        ...
        _yuitest_coverline("loader-base", 821);
if (rm && (mod2 in rm)) {
            _yuitest_coverline("loader-base", 822);
return true;
        }

        // external css files should be sorted below yui css
        _yuitest_coverline("loader-base", 826);
if (m.ext && m.type == CSS && !other.ext && other.type == CSS) {
            _yuitest_coverline("loader-base", 827);
return true;
        }

        _yuitest_coverline("loader-base", 830);
return false;
    },
    /**
    ...
    */
    _config: function(o) {
        _yuitest_coverfunc("loader-base", "_config", 838);
_yuitest_coverline("loader-base", 839);
var i, j, val, a, f, group, groupName, self = this;
        // apply config values
        _yuitest_coverline("loader-base", 841);
if (o) {
            _yuitest_coverline("loader-base", 842);
for (i in o) {
                _yuitest_coverline("loader-base", 843);
if (o.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 844);
val = o[i];
                    _yuitest_coverline("loader-base", 845);
if (i == 'require') {
                        _yuitest_coverline("loader-base", 846);
self.require(val);
                    } else {_yuitest_coverline("loader-base", 847);
if (i == 'skin') {
                        //If the config.skin is a string, format to the expected object
                        _yuitest_coverline("loader-base", 849);
if (typeof val === 'string') {
                            _yuitest_coverline("loader-base", 850);
self.skin.defaultSkin = o.skin;
                            _yuitest_coverline("loader-base", 851);
val = {
                                defaultSkin: val
                            };
                        }

                        _yuitest_coverline("loader-base", 856);
Y.mix(self.skin, val, true);
                    } else {_yuitest_coverline("loader-base", 857);
if (i == 'groups') {
                        _yuitest_coverline("loader-base", 858);
for (j in val) {
                            _yuitest_coverline("loader-base", 859);
if (val.hasOwnProperty(j)) {
                                _yuitest_coverline("loader-base", 860);
groupName = j;
                                _yuitest_coverline("loader-base", 861);
group = val[j];
                                _yuitest_coverline("loader-base", 862);
self.addGroup(group, groupName);
                                _yuitest_coverline("loader-base", 863);
if (group.aliases) {
                                    _yuitest_coverline("loader-base", 864);
for (a in group.aliases) {
                                        _yuitest_coverline("loader-base", 865);
if (group.aliases.hasOwnProperty(a)) {
                                            _yuitest_coverline("loader-base", 866);
self.addAlias(group.aliases[a], a);
                    ...
                    } else {_yuitest_coverline("loader-base", 873);
if (i == 'modules') {
                        // add a hash of module definitions
                        _yuitest_coverline("loader-base", 875);
for (j in val) {
                            _yuitest_coverline("loader-base", 876);
if (val.hasOwnProperty(j)) {
                                _yuitest_coverline("loader-base", 877);
self.addModule(val[j], j);
                            }
                        }
                    } else {_yuitest_coverline("loader-base", 880);
if (i === 'aliases') {
                        _yuitest_coverline("loader-base", 881);
for (j in val) {
                            _yuitest_coverline("loader-base", 882);
if (val.hasOwnProperty(j)) {
                                _yuitest_coverline("loader-base", 883);
self.addAlias(val[j], j);
                            }
                        }
                    } else {_yuitest_coverline("loader-base", 886);
if (i == 'gallery') {
                        _yuitest_coverline("loader-base", 887);
this.groups.gallery.update(val, o);
                    } else {_yuitest_coverline("loader-base", 888);
if (i == 'yui2' || i == '2in3') {
                        _yuitest_coverline("loader-base", 889);
this.groups.yui2.update(o['2in3'], o.yui2, o);
                    } else {
                        _yuitest_coverline("loader-base", 891);
self[i] = val;
                    }}}}}}}
                }
            }
        ...
        // fix filter
        _yuitest_coverline("loader-base", 898);
f = self.filter;

        _yuitest_coverline("loader-base", 900);
if (L.isString(f)) {
            _yuitest_coverline("loader-base", 901);
f = f.toUpperCase();
            _yuitest_coverline("loader-base", 902);
self.filterName = f;
            _yuitest_coverline("loader-base", 903);
self.filter = self.FILTER_DEFS[f];
            _yuitest_coverline("loader-base", 904);
if (f == 'DEBUG') {
                _yuitest_coverline("loader-base", 905);
self.require('yui-log', 'dump');
            }
        }

        _yuitest_coverline("loader-base", 909);
if (self.filterName && self.coverage) {
            _yuitest_coverline("loader-base", 910);
if (self.filterName == 'COVERAGE' && L.isArray(self.coverage) && self.coverage.length) {
                _yuitest_coverline("loader-base", 911);
var mods = [];
                _yuitest_coverline("loader-base", 912);
for (i = 0; i < self.coverage.length; i++) {
                    _yuitest_coverline("loader-base", 913);
var mod = self.coverage[i];
                    _yuitest_coverline("loader-base", 914);
if (self.moduleInfo[mod] && self.moduleInfo[mod].use) {
                        _yuitest_coverline("loader-base", 915);
mods = [].concat(mods, self.moduleInfo[mod].use);
                    } else {
                        _yuitest_coverline("loader-base", 917);
mods.push(mod);
                    }
                }
                _yuitest_coverline("loader-base", 920);
self.filters = self.filters || {};
                _yuitest_coverline("loader-base", 921);
Y.Array.each(mods, function(mod) {
                    _yuitest_coverfunc("loader-base", "(anonymous 3)", 921);
_yuitest_coverline("loader-base", 922);
self.filters[mod] = self.FILTER_DEFS.COVERAGE;
                });
                _yuitest_coverline("loader-base", 924);
self.filterName = 'RAW';
                _yuitest_coverline("loader-base", 925);
self.filter = self.FILTER_DEFS[self.filterName];
            }
        }
        

        _yuitest_coverline("loader-base", 930);
if (self.lang) {
    ...
    formatSkin: function(skin, mod) {
        _yuitest_coverfunc("loader-base", "formatSkin", 947);
_yuitest_coverline("loader-base", 948);
var s = SKIN_PREFIX + skin;
        _yuitest_coverline("loader-base", 949);
if (mod) {
            _yuitest_coverline("loader-base", 950);
s = s + '-' + mod;
        }

        _yuitest_coverline("loader-base", 953);
return s;
    },
    ...
    _addSkin: function(skin, mod, parent) {
        _yuitest_coverfunc("loader-base", "_addSkin", 966);
_yuitest_coverline("loader-base", 967);
var mdef, pkg, name, nmod,
        ...
        _yuitest_coverline("loader-base", 973);
if (mod) {
            _yuitest_coverline("loader-base", 974);
name = this.formatSkin(skin, mod);
            _yuitest_coverline("loader-base", 975);
if (!info[name]) {
                _yuitest_coverline("loader-base", 976);
mdef = info[mod];
                _yuitest_coverline("loader-base", 977);
pkg = mdef.pkg || mod;
                _yuitest_coverline("loader-base", 978);
nmod = {
                    skin: true,
                    name: name,
                    group: mdef.group,
                ...
                _yuitest_coverline("loader-base", 988);
if (mdef.base) {
                    _yuitest_coverline("loader-base", 989);
nmod.base = mdef.base;
                }
                _yuitest_coverline("loader-base", 991);
if (mdef.configFn) {
                    _yuitest_coverline("loader-base", 992);
nmod.configFn = mdef.configFn;
                }
                _yuitest_coverline("loader-base", 994);
this.addModule(nmod, name);

            }
        }

        _yuitest_coverline("loader-base", 999);
return name;
    },
    /**
    ...
    */
    addAlias: function(use, name) {
        _yuitest_coverfunc("loader-base", "addAlias", 1014);
_yuitest_coverline("loader-base", 1015);
YUI.Env.aliases[name] = use;
        _yuitest_coverline("loader-base", 1016);
this.addModule({
            name: name,
            use: use
        });
    ...
    addGroup: function(o, name) {
        _yuitest_coverfunc("loader-base", "addGroup", 1044);
_yuitest_coverline("loader-base", 1045);
var mods = o.modules,
            self = this, i, v;

        _yuitest_coverline("loader-base", 1048);
name = name || o.name;
        _yuitest_coverline("loader-base", 1049);
o.name = name;
        _yuitest_coverline("loader-base", 1050);
self.groups[name] = o;

        _yuitest_coverline("loader-base", 1052);
if (o.patterns) {
            _yuitest_coverline("loader-base", 1053);
for (i in o.patterns) {
                _yuitest_coverline("loader-base", 1054);
if (o.patterns.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1055);
o.patterns[i].group = name;
                    _yuitest_coverline("loader-base", 1056);
self.patterns[i] = o.patterns[i];
                }
            }
        }

        _yuitest_coverline("loader-base", 1061);
if (mods) {
            _yuitest_coverline("loader-base", 1062);
for (i in mods) {
                _yuitest_coverline("loader-base", 1063);
if (mods.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1064);
v = mods[i];
                    _yuitest_coverline("loader-base", 1065);
if (typeof v === 'string') {
                        _yuitest_coverline("loader-base", 1066);
v = { name: i, fullpath: v };
                    }
                    _yuitest_coverline("loader-base", 1068);
v.group = name;
                    _yuitest_coverline("loader-base", 1069);
self.addModule(v, i);
                }
            }
        }
    ...
    addModule: function(o, name) {
        _yuitest_coverfunc("loader-base", "addModule", 1105);
_yuitest_coverline("loader-base", 1106);
name = name || o.name;

        _yuitest_coverline("loader-base", 1108);
if (typeof o === 'string') {
            _yuitest_coverline("loader-base", 1109);
o = { name: name, fullpath: o };
        ...
        _yuitest_coverline("loader-base", 1116);
if (this.moduleInfo[name] && this.moduleInfo[name].temp) {
            ...
            _yuitest_coverline("loader-base", 1122);
o = Y.merge(this.moduleInfo[name], o);
        }

        _yuitest_coverline("loader-base", 1125);
o.name = name;

        _yuitest_coverline("loader-base", 1127);
if (!o || !o.name) {
            _yuitest_coverline("loader-base", 1128);
return null;
        }

        _yuitest_coverline("loader-base", 1131);
if (!o.type) {
            //Always assume it's javascript unless the CSS pattern is matched.
            _yuitest_coverline("loader-base", 1133);
o.type = JS;
            _yuitest_coverline("loader-base", 1134);
var p = o.path || o.fullpath;
            _yuitest_coverline("loader-base", 1135);
if (p && this.REGEX_CSS.test(p)) {
                _yuitest_coverline("loader-base", 1136);
o.type = CSS;
            }
        }

        _yuitest_coverline("loader-base", 1140);
if (!o.path && !o.fullpath) {
            _yuitest_coverline("loader-base", 1141);
o.path = _path(name, name, o.type);
        }
        _yuitest_coverline("loader-base", 1143);
o.supersedes = o.supersedes || o.use;

        _yuitest_coverline("loader-base", 1145);
o.ext = ('ext' in o) ? o.ext : (this._internal) ? false : true;

        // Handle submodule logic
        _yuitest_coverline("loader-base", 1148);
var subs = o.submodules, i, l, t, sup, s, smod, plugins, plug,
        ...
        _yuitest_coverline("loader-base", 1154);
this.moduleInfo[name] = o;

        _yuitest_coverline("loader-base", 1156);
o.requires = o.requires || [];
        ...
        */
        _yuitest_coverline("loader-base", 1163);
if (this.requires) {
            _yuitest_coverline("loader-base", 1164);
for (i = 0; i < this.requires.length; i++) {
                _yuitest_coverline("loader-base", 1165);
o.requires.push(this.requires[i]);
            }
        }
        _yuitest_coverline("loader-base", 1168);
if (o.group && this.groups && this.groups[o.group]) {
            _yuitest_coverline("loader-base", 1169);
g = this.groups[o.group];
            _yuitest_coverline("loader-base", 1170);
if (g.requires) {
                _yuitest_coverline("loader-base", 1171);
for (i = 0; i < g.requires.length; i++) {
                    _yuitest_coverline("loader-base", 1172);
o.requires.push(g.requires[i]);
        ...
        _yuitest_coverline("loader-base", 1178);
if (!o.defaults) {
            _yuitest_coverline("loader-base", 1179);
o.defaults = {
        ...
        _yuitest_coverline("loader-base", 1186);
if (o.skinnable && o.ext && o.temp) {
            _yuitest_coverline("loader-base", 1187);
skinname = this._addSkin(this.skin.defaultSkin, name);
            _yuitest_coverline("loader-base", 1188);
o.requires.unshift(skinname);
        }
        
        _yuitest_coverline("loader-base", 1191);
if (o.requires.length) {
            _yuitest_coverline("loader-base", 1192);
o.requires = this.filterRequires(o.requires) || [];
        }

        _yuitest_coverline("loader-base", 1195);
if (!o.langPack && o.lang) {
            _yuitest_coverline("loader-base", 1196);
langs = YArray(o.lang);
            _yuitest_coverline("loader-base", 1197);
for (j = 0; j < langs.length; j++) {
                _yuitest_coverline("loader-base", 1198);
lang = langs[j];
                _yuitest_coverline("loader-base", 1199);
packName = this.getLangPackName(lang, name);
                _yuitest_coverline("loader-base", 1200);
smod = this.moduleInfo[packName];
                _yuitest_coverline("loader-base", 1201);
if (!smod) {
                    _yuitest_coverline("loader-base", 1202);
smod = this._addLangPack(lang, o, packName);
        ...
        _yuitest_coverline("loader-base", 1208);
if (subs) {
            _yuitest_coverline("loader-base", 1209);
sup = o.supersedes || [];
            _yuitest_coverline("loader-base", 1210);
l = 0;

            _yuitest_coverline("loader-base", 1212);
for (i in subs) {
                _yuitest_coverline("loader-base", 1213);
if (subs.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1214);
s = subs[i];

                    _yuitest_coverline("loader-base", 1216);
s.path = s.path || _path(name, i, o.type);
                    _yuitest_coverline("loader-base", 1217);
s.pkg = name;
                    _yuitest_coverline("loader-base", 1218);
s.group = o.group;

                    _yuitest_coverline("loader-base", 1220);
if (s.supersedes) {
                        _yuitest_coverline("loader-base", 1221);
sup = sup.concat(s.supersedes);
                    }

                    _yuitest_coverline("loader-base", 1224);
smod = this.addModule(s, i);
                    _yuitest_coverline("loader-base", 1225);
sup.push(i);

                    _yuitest_coverline("loader-base", 1227);
if (smod.skinnable) {
                        _yuitest_coverline("loader-base", 1228);
o.skinnable = true;
                        _yuitest_coverline("loader-base", 1229);
overrides = this.skin.overrides;
                        _yuitest_coverline("loader-base", 1230);
if (overrides && overrides[i]) {
                            _yuitest_coverline("loader-base", 1231);
for (j = 0; j < overrides[i].length; j++) {
                                _yuitest_coverline("loader-base", 1232);
skinname = this._addSkin(overrides[i][j],
                                         i, name);
                                _yuitest_coverline("loader-base", 1234);
sup.push(skinname);
                            }
                        }
                        _yuitest_coverline("loader-base", 1237);
skinname = this._addSkin(this.skin.defaultSkin,
                                        i, name);
                        _yuitest_coverline("loader-base", 1239);
sup.push(skinname);
                    }
                    ...
                    _yuitest_coverline("loader-base", 1245);
if (s.lang && s.lang.length) {

                        _yuitest_coverline("loader-base", 1247);
langs = YArray(s.lang);
                        _yuitest_coverline("loader-base", 1248);
for (j = 0; j < langs.length; j++) {
                            _yuitest_coverline("loader-base", 1249);
lang = langs[j];
                            _yuitest_coverline("loader-base", 1250);
packName = this.getLangPackName(lang, name);
                            _yuitest_coverline("loader-base", 1251);
supName = this.getLangPackName(lang, i);
                            _yuitest_coverline("loader-base", 1252);
smod = this.moduleInfo[packName];

                            _yuitest_coverline("loader-base", 1254);
if (!smod) {
                                _yuitest_coverline("loader-base", 1255);
smod = this._addLangPack(lang, o, packName);
                            }

                            _yuitest_coverline("loader-base", 1258);
flatSup = flatSup || YArray.hash(smod.supersedes);

                            _yuitest_coverline("loader-base", 1260);
if (!(supName in flatSup)) {
                                _yuitest_coverline("loader-base", 1261);
smod.supersedes.push(supName);
                            }

                            _yuitest_coverline("loader-base", 1264);
o.lang = o.lang || [];

                            _yuitest_coverline("loader-base", 1266);
flatLang = flatLang || YArray.hash(o.lang);

                            _yuitest_coverline("loader-base", 1268);
if (!(lang in flatLang)) {
                                _yuitest_coverline("loader-base", 1269);
o.lang.push(lang);
                            }
...
// Add rollup file, need to add to supersedes list too
                            ...
                            // default packages
                            _yuitest_coverline("loader-base", 1275);
packName = this.getLangPackName(ROOT_LANG, name);
                            _yuitest_coverline("loader-base", 1276);
supName = this.getLangPackName(ROOT_LANG, i);

                            _yuitest_coverline("loader-base", 1278);
smod = this.moduleInfo[packName];

                            _yuitest_coverline("loader-base", 1280);
if (!smod) {
                                _yuitest_coverline("loader-base", 1281);
smod = this._addLangPack(lang, o, packName);
                            }

                            _yuitest_coverline("loader-base", 1284);
if (!(supName in flatSup)) {
                                _yuitest_coverline("loader-base", 1285);
smod.supersedes.push(supName);
                            }
...
// Add rollup file, need to add to supersedes list too
                    ...
                    _yuitest_coverline("loader-base", 1293);
l++;
                }
            }
            //o.supersedes = YObject.keys(YArray.hash(sup));
            _yuitest_coverline("loader-base", 1297);
o.supersedes = YArray.dedupe(sup);
            _yuitest_coverline("loader-base", 1298);
if (this.allowRollup) {
                _yuitest_coverline("loader-base", 1299);
o.rollup = (l < 4) ? l : Math.min(l - 1, 4);
            }
        }

        _yuitest_coverline("loader-base", 1303);
plugins = o.plugins;
        _yuitest_coverline("loader-base", 1304);
if (plugins) {
            _yuitest_coverline("loader-base", 1305);
for (i in plugins) {
                _yuitest_coverline("loader-base", 1306);
if (plugins.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1307);
plug = plugins[i];
                    _yuitest_coverline("loader-base", 1308);
plug.pkg = name;
                    _yuitest_coverline("loader-base", 1309);
plug.path = plug.path || _path(name, i, o.type);
                    _yuitest_coverline("loader-base", 1310);
plug.requires = plug.requires || [];
                    _yuitest_coverline("loader-base", 1311);
plug.group = o.group;
                    _yuitest_coverline("loader-base", 1312);
this.addModule(plug, i);
                    _yuitest_coverline("loader-base", 1313);
if (o.skinnable) {
                        _yuitest_coverline("loader-base", 1314);
this._addSkin(this.skin.defaultSkin, i, name);
        ...
        _yuitest_coverline("loader-base", 1321);
if (o.condition) {
            _yuitest_coverline("loader-base", 1322);
t = o.condition.trigger;
            _yuitest_coverline("loader-base", 1323);
if (YUI.Env.aliases[t]) {
                _yuitest_coverline("loader-base", 1324);
t = YUI.Env.aliases[t];
            }
            _yuitest_coverline("loader-base", 1326);
if (!Y.Lang.isArray(t)) {
                _yuitest_coverline("loader-base", 1327);
t = [t];
            }

            _yuitest_coverline("loader-base", 1330);
for (i = 0; i < t.length; i++) {
                _yuitest_coverline("loader-base", 1331);
trigger = t[i];
                _yuitest_coverline("loader-base", 1332);
when = o.condition.when;
                _yuitest_coverline("loader-base", 1333);
conditions[trigger] = conditions[trigger] || {};
                _yuitest_coverline("loader-base", 1334);
conditions[trigger][name] = o.condition;
                // the 'when' attribute can be 'before', 'after', or 'instead'
                // the default is after.
                _yuitest_coverline("loader-base", 1337);
if (when && when != 'after') {
                    _yuitest_coverline("loader-base", 1338);
if (when == 'instead') { // replace the trigger
                        _yuitest_coverline("loader-base", 1339);
o.supersedes = o.supersedes || [];
                        _yuitest_coverline("loader-base", 1340);
o.supersedes.push(trigger);
                    ...
                    _yuitest_coverline("loader-base", 1347);
o.after = o.after || [];
                    _yuitest_coverline("loader-base", 1348);
o.after.push(trigger);
                }
            }
        }

        _yuitest_coverline("loader-base", 1353);
if (o.supersedes) {
            _yuitest_coverline("loader-base", 1354);
o.supersedes = this.filterRequires(o.supersedes);
        }

        _yuitest_coverline("loader-base", 1357);
if (o.after) {
            _yuitest_coverline("loader-base", 1358);
o.after = this.filterRequires(o.after);
            _yuitest_coverline("loader-base", 1359);
o.after_map = YArray.hash(o.after);
        }

        // this.dirty = true;

        _yuitest_coverline("loader-base", 1364);
if (o.configFn) {
            _yuitest_coverline("loader-base", 1365);
ret = o.configFn(o);
            _yuitest_coverline("loader-base", 1366);
if (ret === false) {
                _yuitest_coverline("loader-base", 1367);
delete this.moduleInfo[name];
                _yuitest_coverline("loader-base", 1368);
delete GLOBAL_ENV._renderedMods[name];
                _yuitest_coverline("loader-base", 1369);
o = null;
            }
        }
        //Add to global cache
        _yuitest_coverline("loader-base", 1373);
if (o) {
            _yuitest_coverline("loader-base", 1374);
if (!GLOBAL_ENV._renderedMods) {
                _yuitest_coverline("loader-base", 1375);
GLOBAL_ENV._renderedMods = {};
            }
            _yuitest_coverline("loader-base", 1377);
GLOBAL_ENV._renderedMods[name] = Y.mix(GLOBAL_ENV._renderedMods[name] || {}, o);
            _yuitest_coverline("loader-base", 1378);
GLOBAL_ENV._conditions = conditions;
        }

        _yuitest_coverline("loader-base", 1381);
return o;
    },
    ...
    require: function(what) {
        _yuitest_coverfunc("loader-base", "require", 1389);
_yuitest_coverline("loader-base", 1390);
var a = (typeof what === 'string') ? YArray(arguments) : what;
        _yuitest_coverline("loader-base", 1391);
this.dirty = true;
        _yuitest_coverline("loader-base", 1392);
this.required = Y.merge(this.required, YArray.hash(this.filterRequires(a)));

        _yuitest_coverline("loader-base", 1394);
this._explodeRollups();
    ...
    */
    _explodeRollups: function() {
        _yuitest_coverfunc("loader-base", "_explodeRollups", 1405);
_yuitest_coverline("loader-base", 1406);
var self = this, m, m2, i, a, v, len, len2,
        r = self.required;

        _yuitest_coverline("loader-base", 1409);
if (!self.allowRollup) {
            _yuitest_coverline("loader-base", 1410);
for (i in r) {
                _yuitest_coverline("loader-base", 1411);
if (r.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1412);
m = self.getModule(i);
                    _yuitest_coverline("loader-base", 1413);
if (m && m.use) {
                        _yuitest_coverline("loader-base", 1414);
len = m.use.length;
                        _yuitest_coverline("loader-base", 1415);
for (a = 0; a < len; a++) {
                            _yuitest_coverline("loader-base", 1416);
m2 = self.getModule(m.use[a]);
                            _yuitest_coverline("loader-base", 1417);
if (m2 && m2.use) {
                                _yuitest_coverline("loader-base", 1418);
len2 = m2.use.length;
                                _yuitest_coverline("loader-base", 1419);
for (v = 0; v < len2; v++) {
                                    _yuitest_coverline("loader-base", 1420);
r[m2.use[v]] = true;
                                }
                            } else {
                                _yuitest_coverline("loader-base", 1423);
r[m.use[a]] = true;
                            }
                        }
                    }
            ...
            _yuitest_coverline("loader-base", 1429);
self.required = r;
        }
    ...
    */
    filterRequires: function(r) {
        _yuitest_coverfunc("loader-base", "filterRequires", 1439);
_yuitest_coverline("loader-base", 1440);
if (r) {
            _yuitest_coverline("loader-base", 1441);
if (!Y.Lang.isArray(r)) {
                _yuitest_coverline("loader-base", 1442);
r = [r];
            }
            _yuitest_coverline("loader-base", 1444);
r = Y.Array(r);
            _yuitest_coverline("loader-base", 1445);
var c = [], i, mod, o, m;

            _yuitest_coverline("loader-base", 1447);
for (i = 0; i < r.length; i++) {
                _yuitest_coverline("loader-base", 1448);
mod = this.getModule(r[i]);
                _yuitest_coverline("loader-base", 1449);
if (mod && mod.use) {
                    _yuitest_coverline("loader-base", 1450);
for (o = 0; o < mod.use.length; o++) {
                        //Must walk the other modules in case a module is a rollup of rollups (datatype)
                        _yuitest_coverline("loader-base", 1452);
m = this.getModule(mod.use[o]);
                        _yuitest_coverline("loader-base", 1453);
if (m && m.use) {
                            _yuitest_coverline("loader-base", 1454);
c = Y.Array.dedupe([].concat(c, this.filterRequires(m.use)));
                        } else {
                            _yuitest_coverline("loader-base", 1456);
c.push(mod.use[o]);
                        }
                    }
                } else {
                    _yuitest_coverline("loader-base", 1460);
c.push(r[i]);
                }
            }
            _yuitest_coverline("loader-base", 1463);
r = c;
        }
        _yuitest_coverline("loader-base", 1465);
return r;
    },
    /**
    ...
    getRequires: function(mod) {
        ...
        _yuitest_coverfunc("loader-base", "getRequires", 1474);
_yuitest_coverline("loader-base", 1476);
if (!mod) {
            //console.log('returning no reqs for ' + mod.name);
            _yuitest_coverline("loader-base", 1478);
return NO_REQUIREMENTS;
        }

        _yuitest_coverline("loader-base", 1481);
if (mod._parsed) {
            //console.log('returning requires for ' + mod.name, mod.requires);
            _yuitest_coverline("loader-base", 1483);
return mod.expanded || NO_REQUIREMENTS;
        }

        //TODO add modue cache here out of scope..

        _yuitest_coverline("loader-base", 1488);
var i, m, j, add, packName, lang, testresults = this.testresults,
        ...
        _yuitest_coverline("loader-base", 1502);
if (mod.temp && adddef) {
            _yuitest_coverline("loader-base", 1503);
old_mod = mod;
            _yuitest_coverline("loader-base", 1504);
mod = this.addModule(adddef, name);
            _yuitest_coverline("loader-base", 1505);
mod.group = old_mod.group;
            _yuitest_coverline("loader-base", 1506);
mod.pkg = old_mod.pkg;
            _yuitest_coverline("loader-base", 1507);
delete mod.expanded;
        }
        ...
        _yuitest_coverline("loader-base", 1513);
reparse = !((!this.lang || mod.langCache === this.lang) && (mod.skinCache === this.skin.defaultSkin));

        _yuitest_coverline("loader-base", 1515);
if (mod.expanded && !reparse) {
            _yuitest_coverline("loader-base", 1516);
return mod.expanded;
        }
        

        _yuitest_coverline("loader-base", 1520);
d = [];
        _yuitest_coverline("loader-base", 1521);
hash = {};
        _yuitest_coverline("loader-base", 1522);
r = this.filterRequires(mod.requires);
        _yuitest_coverline("loader-base", 1523);
if (mod.lang) {
            //If a module has a lang attribute, auto add the intl requirement.
            _yuitest_coverline("loader-base", 1525);
d.unshift('intl');
            _yuitest_coverline("loader-base", 1526);
r.unshift('intl');
            _yuitest_coverline("loader-base", 1527);
intl = true;
        }
        _yuitest_coverline("loader-base", 1529);
o = this.filterRequires(mod.optional);


        _yuitest_coverline("loader-base", 1532);
mod._parsed = true;
        _yuitest_coverline("loader-base", 1533);
mod.langCache = this.lang;
        _yuitest_coverline("loader-base", 1534);
mod.skinCache = this.skin.defaultSkin;

        _yuitest_coverline("loader-base", 1536);
for (i = 0; i < r.length; i++) {
            _yuitest_coverline("loader-base", 1537);
if (!hash[r[i]]) {
                _yuitest_coverline("loader-base", 1538);
d.push(r[i]);
                _yuitest_coverline("loader-base", 1539);
hash[r[i]] = true;
                _yuitest_coverline("loader-base", 1540);
m = this.getModule(r[i]);
                _yuitest_coverline("loader-base", 1541);
if (m) {
                    _yuitest_coverline("loader-base", 1542);
add = this.getRequires(m);
                    _yuitest_coverline("loader-base", 1543);
intl = intl || (m.expanded_map &&
                        (INTL in m.expanded_map));
                    _yuitest_coverline("loader-base", 1545);
for (j = 0; j < add.length; j++) {
                        _yuitest_coverline("loader-base", 1546);
d.push(add[j]);
                    }
                }
            }
        ...
        _yuitest_coverline("loader-base", 1553);
r = this.filterRequires(mod.supersedes);
        _yuitest_coverline("loader-base", 1554);
if (r) {
            _yuitest_coverline("loader-base", 1555);
for (i = 0; i < r.length; i++) {
                _yuitest_coverline("loader-base", 1556);
if (!hash[r[i]]) {
                    // if this module has submodules, the requirements list is
                    // expanded to include the submodules.  This is so we can
                    // prevent dups when a submodule is already loaded and the
                    // parent is requested.
                    _yuitest_coverline("loader-base", 1561);
if (mod.submodules) {
                        _yuitest_coverline("loader-base", 1562);
d.push(r[i]);
                    }

                    _yuitest_coverline("loader-base", 1565);
hash[r[i]] = true;
                    _yuitest_coverline("loader-base", 1566);
m = this.getModule(r[i]);

                    _yuitest_coverline("loader-base", 1568);
if (m) {
                        _yuitest_coverline("loader-base", 1569);
add = this.getRequires(m);
                        _yuitest_coverline("loader-base", 1570);
intl = intl || (m.expanded_map &&
                            (INTL in m.expanded_map));
                        _yuitest_coverline("loader-base", 1572);
for (j = 0; j < add.length; j++) {
                            _yuitest_coverline("loader-base", 1573);
d.push(add[j]);
                        }
                    }
                }
        ...
        _yuitest_coverline("loader-base", 1580);
if (o && this.loadOptional) {
            _yuitest_coverline("loader-base", 1581);
for (i = 0; i < o.length; i++) {
                _yuitest_coverline("loader-base", 1582);
if (!hash[o[i]]) {
                    _yuitest_coverline("loader-base", 1583);
d.push(o[i]);
                    _yuitest_coverline("loader-base", 1584);
hash[o[i]] = true;
                    _yuitest_coverline("loader-base", 1585);
m = info[o[i]];
                    _yuitest_coverline("loader-base", 1586);
if (m) {
                        _yuitest_coverline("loader-base", 1587);
add = this.getRequires(m);
                        _yuitest_coverline("loader-base", 1588);
intl = intl || (m.expanded_map &&
                            (INTL in m.expanded_map));
                        _yuitest_coverline("loader-base", 1590);
for (j = 0; j < add.length; j++) {
                            _yuitest_coverline("loader-base", 1591);
d.push(add[j]);
                        }
                    }
                }
        ...
        _yuitest_coverline("loader-base", 1598);
cond = this.conditions[name];

        _yuitest_coverline("loader-base", 1600);
if (cond) {
            //Set the module to not parsed since we have conditionals and this could change the dependency tree.
            _yuitest_coverline("loader-base", 1602);
mod._parsed = false;
            _yuitest_coverline("loader-base", 1603);
if (testresults && ftests) {
                _yuitest_coverline("loader-base", 1604);
oeach(testresults, function(result, id) {
                    _yuitest_coverfunc("loader-base", "(anonymous 4)", 1604);
_yuitest_coverline("loader-base", 1605);
var condmod = ftests[id].name;
                    _yuitest_coverline("loader-base", 1606);
if (!hash[condmod] && ftests[id].trigger == name) {
                        _yuitest_coverline("loader-base", 1607);
if (result && ftests[id]) {
                            _yuitest_coverline("loader-base", 1608);
hash[condmod] = true;
                            _yuitest_coverline("loader-base", 1609);
d.push(condmod);
                        }
                    }
                });
            } else {
                _yuitest_coverline("loader-base", 1614);
for (i in cond) {
                    _yuitest_coverline("loader-base", 1615);
if (cond.hasOwnProperty(i)) {
                        _yuitest_coverline("loader-base", 1616);
if (!hash[i]) {
                            _yuitest_coverline("loader-base", 1617);
def = cond[i];
                            //first see if they've specfied a ua check
                            //then see if they've got a test fn & if it returns true
                            //otherwise just having a condition block is enough
                            _yuitest_coverline("loader-base", 1621);
go = def && ((!def.ua && !def.test) || (def.ua && Y.UA[def.ua]) ||
                                        (def.test && def.test(Y, r)));

                            _yuitest_coverline("loader-base", 1624);
if (go) {
                                _yuitest_coverline("loader-base", 1625);
hash[i] = true;
                                _yuitest_coverline("loader-base", 1626);
d.push(i);
                                _yuitest_coverline("loader-base", 1627);
m = this.getModule(i);
                                _yuitest_coverline("loader-base", 1628);
if (m) {
                                    _yuitest_coverline("loader-base", 1629);
add = this.getRequires(m);
                                    _yuitest_coverline("loader-base", 1630);
for (j = 0; j < add.length; j++) {
                                        _yuitest_coverline("loader-base", 1631);
d.push(add[j]);
                                    }
        ...
        // Create skin modules
        _yuitest_coverline("loader-base", 1643);
if (mod.skinnable) {
            _yuitest_coverline("loader-base", 1644);
skindef = this.skin.overrides;
            _yuitest_coverline("loader-base", 1645);
for (i in YUI.Env.aliases) {
                _yuitest_coverline("loader-base", 1646);
if (YUI.Env.aliases.hasOwnProperty(i)) {
                    _yuitest_coverline("loader-base", 1647);
if (Y.Array.indexOf(YUI.Env.aliases[i], name) > -1) {
                        _yuitest_coverline("loader-base", 1648);
skinpar = i;
                    }
                }
            }
            _yuitest_coverline("loader-base", 1652);
if (skindef && (skindef[name] || (skinpar && skindef[skinpar]))) {
                _yuitest_coverline("loader-base", 1653);
skinname = name;
                _yuitest_coverline("loader-base", 1654);
if (skindef[skinpar]) {
                    _yuitest_coverline("loader-base", 1655);
skinname = skinpar;
                }
                _yuitest_coverline("loader-base", 1657);
for (i = 0; i < skindef[skinname].length; i++) {
                    _yuitest_coverline("loader-base", 1658);
skinmod = this._addSkin(skindef[skinname][i], name);
                    _yuitest_coverline("loader-base", 1659);
if (!this.isCSSLoaded(skinmod, this._boot)) {
                        _yuitest_coverline("loader-base", 1660);
d.push(skinmod);
                    }
                }
            } else {
                _yuitest_coverline("loader-base", 1664);
skinmod = this._addSkin(this.skin.defaultSkin, name);
                _yuitest_coverline("loader-base", 1665);
if (!this.isCSSLoaded(skinmod, this._boot)) {
                    _yuitest_coverline("loader-base", 1666);
d.push(skinmod);
                }
            }
        }

        _yuitest_coverline("loader-base", 1671);
mod._parsed = false;

        _yuitest_coverline("loader-base", 1673);
if (intl) {

            _yuitest_coverline("loader-base", 1675);
if (mod.lang && !mod.langPack && Y.Intl) {
                _yuitest_coverline("loader-base", 1676);
lang = Y.Intl.lookupBestLang(this.lang || ROOT_LANG, mod.lang);
                _yuitest_coverline("loader-base", 1677);
packName = this.getLangPackName(lang, name);
                _yuitest_coverline("loader-base", 1678);
if (packName) {
                    _yuitest_coverline("loader-base", 1679);
d.unshift(packName);
                }
            }
            _yuitest_coverline("loader-base", 1682);
d.unshift(INTL);
        }

        _yuitest_coverline("loader-base", 1685);
mod.expanded_map = YArray.hash(d);

        _yuitest_coverline("loader-base", 1687);
mod.expanded = YObject.keys(mod.expanded_map);

        _yuitest_coverline("loader-base", 1689);
return mod.expanded;
    },
    /**
    ...
    */
    isCSSLoaded: function(name, skip) {
        ...
        _yuitest_coverfunc("loader-base", "isCSSLoaded", 1697);
_yuitest_coverline("loader-base", 1699);
if (!name || !YUI.Env.cssStampEl || (!skip && this.ignoreRegistered)) {
            _yuitest_coverline("loader-base", 1700);
return false;
        }
        _yuitest_coverline("loader-base", 1702);
var el = YUI.Env.cssStampEl,
        ...
        _yuitest_coverline("loader-base", 1708);
if (mod !== undefined) {
            _yuitest_coverline("loader-base", 1709);
return mod;
        }

        //Add the classname to the element
        _yuitest_coverline("loader-base", 1713);
el.className = name;

        _yuitest_coverline("loader-base", 1715);
if (!style) {
            _yuitest_coverline("loader-base", 1716);
style = Y.config.doc.defaultView.getComputedStyle(el, null);
        }

        _yuitest_coverline("loader-base", 1719);
if (style && style.display === 'none') {
            _yuitest_coverline("loader-base", 1720);
ret = true;
        }


        _yuitest_coverline("loader-base", 1724);
el.className = ''; //Reset the classname to ''

        _yuitest_coverline("loader-base", 1726);
YUI.Env._cssLoaded[name] = ret;

        _yuitest_coverline("loader-base", 1728);
return ret;
    },
    ...
    getProvides: function(name) {
        _yuitest_coverfunc("loader-base", "getProvides", 1737);
_yuitest_coverline("loader-base", 1738);
var m = this.getModule(name), o, s;
            // supmap = this.provides;

        _yuitest_coverline("loader-base", 1741);
if (!m) {
            _yuitest_coverline("loader-base", 1742);
return NOT_FOUND;
        }

        _yuitest_coverline("loader-base", 1745);
if (m && !m.provides) {
            _yuitest_coverline("loader-base", 1746);
o = {};
            _yuitest_coverline("loader-base", 1747);
s = m.supersedes;

            _yuitest_coverline("loader-base", 1749);
if (s) {
                _yuitest_coverline("loader-base", 1750);
YArray.each(s, function(v) {
                    _yuitest_coverfunc("loader-base", "(anonymous 5)", 1750);
_yuitest_coverline("loader-base", 1751);
Y.mix(o, this.getProvides(v));
                }, this);
            }

            _yuitest_coverline("loader-base", 1755);
o[name] = true;
            _yuitest_coverline("loader-base", 1756);
m.provides = o;

        }

        _yuitest_coverline("loader-base", 1760);
return m.provides;
    },
    ...
    calculate: function(o, type) {
        _yuitest_coverfunc("loader-base", "calculate", 1770);
_yuitest_coverline("loader-base", 1771);
if (o || type || this.dirty) {

            _yuitest_coverline("loader-base", 1773);
if (o) {
                _yuitest_coverline("loader-base", 1774);
this._config(o);
            }

            _yuitest_coverline("loader-base", 1777);
if (!this._init) {
                _yuitest_coverline("loader-base", 1778);
this._setup();
            }

            _yuitest_coverline("loader-base", 1781);
this._explode();

            _yuitest_coverline("loader-base", 1783);
if (this.allowRollup) {
                _yuitest_coverline("loader-base", 1784);
this._rollup();
            } else {
                _yuitest_coverline("loader-base", 1786);
this._explodeRollups();
            }
            _yuitest_coverline("loader-base", 1788);
this._reduce();
            _yuitest_coverline("loader-base", 1789);
this._sort();
        }
    },
    /**
    ...
    */
    _addLangPack: function(lang, m, packName) {
        _yuitest_coverfunc("loader-base", "_addLangPack", 1801);
_yuitest_coverline("loader-base", 1802);
var name = m.name,
            packPath, conf,
            existing = this.moduleInfo[packName];

        _yuitest_coverline("loader-base", 1806);
if (!existing) {

            _yuitest_coverline("loader-base", 1808);
packPath = _path((m.pkg || name), packName, JS, true);

            _yuitest_coverline("loader-base", 1810);
conf = {
                path: packPath,
                intl: true,
                langPack: true,
            ...
            _yuitest_coverline("loader-base", 1818);
if (m.root) {
                _yuitest_coverline("loader-base", 1819);
conf.root = m.root;
            }
            _yuitest_coverline("loader-base", 1821);
if (m.base) {
                _yuitest_coverline("loader-base", 1822);
conf.base = m.base;
            }

            _yuitest_coverline("loader-base", 1825);
if (m.configFn) {
                _yuitest_coverline("loader-base", 1826);
conf.configFn = m.configFn;
            }

            _yuitest_coverline("loader-base", 1829);
this.addModule(conf, packName);

            _yuitest_coverline("loader-base", 1831);
if (lang) {
                _yuitest_coverline("loader-base", 1832);
Y.Env.lang = Y.Env.lang || {};
                _yuitest_coverline("loader-base", 1833);
Y.Env.lang[lang] = Y.Env.lang[lang] || {};
                _yuitest_coverline("loader-base", 1834);
Y.Env.lang[lang][name] = true;
            }
        }

        _yuitest_coverline("loader-base", 1838);
return this.moduleInfo[packName];
     ...
     */
    _setup: function() {
        _yuitest_coverfunc("loader-base", "_setup", 1848);
_yuitest_coverline("loader-base", 1849);
var info = this.moduleInfo, name, i, j, m, l,
            packName;

        _yuitest_coverline("loader-base", 1852);
for (name in info) {
            _yuitest_coverline("loader-base", 1853);
if (info.hasOwnProperty(name)) {
                _yuitest_coverline("loader-base", 1854);
m = info[name];
                _yuitest_coverline("loader-base", 1855);
if (m) {

                    // remove dups
                    //m.requires = YObject.keys(YArray.hash(m.requires));
                    _yuitest_coverline("loader-base", 1859);
m.requires = YArray.dedupe(m.requires);

                    // Create lang pack modules
                    //if (m.lang && m.lang.length) {
                    _yuitest_coverline("loader-base", 1863);
if (m.lang) {
                        // Setup root package if the module has lang defined,
                        // it needs to provide a root language pack
                        _yuitest_coverline("loader-base", 1866);
packName = this.getLangPackName(ROOT_LANG, name);
                        _yuitest_coverline("loader-base", 1867);
this._addLangPack(null, m, packName);
        ...
        _yuitest_coverline("loader-base", 1876);
l = {};

        // available modules
        _yuitest_coverline("loader-base", 1879);
if (!this.ignoreRegistered) {
            _yuitest_coverline("loader-base", 1880);
Y.mix(l, GLOBAL_ENV.mods);
        }

        // add the ignore list to the list of loaded packages
        _yuitest_coverline("loader-base", 1884);
if (this.ignore) {
            _yuitest_coverline("loader-base", 1885);
Y.mix(l, YArray.hash(this.ignore));
        }

        // expand the list to include superseded modules
        _yuitest_coverline("loader-base", 1889);
for (j in l) {
            _yuitest_coverline("loader-base", 1890);
if (l.hasOwnProperty(j)) {
                _yuitest_coverline("loader-base", 1891);
Y.mix(l, this.getProvides(j));
            }
        }

        // remove modules on the force list from the loaded list
        _yuitest_coverline("loader-base", 1896);
if (this.force) {
            _yuitest_coverline("loader-base", 1897);
for (i = 0; i < this.force.length; i++) {
                _yuitest_coverline("loader-base", 1898);
if (this.force[i] in l) {
                    _yuitest_coverline("loader-base", 1899);
delete l[this.force[i]];
                }
            }
        }

        _yuitest_coverline("loader-base", 1904);
Y.mix(this.loaded, l);

        _yuitest_coverline("loader-base", 1906);
this._init = true;
    },
    ...
    getLangPackName: function(lang, mname) {
        _yuitest_coverfunc("loader-base", "getLangPackName", 1916);
_yuitest_coverline("loader-base", 1917);
return ('lang/' + mname + ((lang) ? '_' + lang : ''));
    ...
    _explode: function() {
        ...
        _yuitest_coverfunc("loader-base", "_explode", 1926);
_yuitest_coverline("loader-base", 1928);
var r = this.required, m, reqs, done = {},
            self = this, name;

        // the setup phase is over, all modules have been created
        _yuitest_coverline("loader-base", 1932);
self.dirty = false;

        _yuitest_coverline("loader-base", 1934);
self._explodeRollups();
        _yuitest_coverline("loader-base", 1935);
r = self.required;
       
        _yuitest_coverline("loader-base", 1937);
for (name in r) {
            _yuitest_coverline("loader-base", 1938);
if (r.hasOwnProperty(name)) {
                _yuitest_coverline("loader-base", 1939);
if (!done[name]) {
                    _yuitest_coverline("loader-base", 1940);
done[name] = true;
                    _yuitest_coverline("loader-base", 1941);
m = self.getModule(name);
                    _yuitest_coverline("loader-base", 1942);
if (m) {
                        _yuitest_coverline("loader-base", 1943);
var expound = m.expound;

                        _yuitest_coverline("loader-base", 1945);
if (expound) {
                            _yuitest_coverline("loader-base", 1946);
r[expound] = self.getModule(expound);
                            _yuitest_coverline("loader-base", 1947);
reqs = self.getRequires(r[expound]);
                            _yuitest_coverline("loader-base", 1948);
Y.mix(r, YArray.hash(reqs));
                        }

                        _yuitest_coverline("loader-base", 1951);
reqs = self.getRequires(m);
                        _yuitest_coverline("loader-base", 1952);
Y.mix(r, YArray.hash(reqs));
                    }
                }
            }
    ...
    */
    _patternTest: function(mname, pname) {
        _yuitest_coverfunc("loader-base", "_patternTest", 1966);
_yuitest_coverline("loader-base", 1967);
return (mname.indexOf(pname) > -1);
    ...
    */
    getModule: function(mname) {
        ...
        _yuitest_coverfunc("loader-base", "getModule", 1975);
_yuitest_coverline("loader-base", 1977);
if (!mname) {
            _yuitest_coverline("loader-base", 1978);
return null;
        }

        _yuitest_coverline("loader-base", 1981);
var p, found, pname,
        ...
        _yuitest_coverline("loader-base", 1987);
if (!m || (m && m.ext)) {
            _yuitest_coverline("loader-base", 1988);
for (pname in patterns) {
                _yuitest_coverline("loader-base", 1989);
if (patterns.hasOwnProperty(pname)) {
                    _yuitest_coverline("loader-base", 1990);
p = patterns[pname];
                    
                    //There is no test method, create a default one that tests
                    // the pattern against the mod name
                    _yuitest_coverline("loader-base", 1994);
if (!p.test) {
                        _yuitest_coverline("loader-base", 1995);
p.test = this._patternTest;
                    }

                    _yuitest_coverline("loader-base", 1998);
if (p.test(mname, pname)) {
                        // use the metadata supplied for the pattern
                        // as the module definition.
                        _yuitest_coverline("loader-base", 2001);
found = p;
                        _yuitest_coverline("loader-base", 2002);
break;
                    }
                }
            }
        ...
        _yuitest_coverline("loader-base", 2008);
if (!m) {
            _yuitest_coverline("loader-base", 2009);
if (found) {
                _yuitest_coverline("loader-base", 2010);
if (p.action) {
                    _yuitest_coverline("loader-base", 2011);
p.action.call(this, mname, pname);
                } else {
                    // ext true or false?
                    _yuitest_coverline("loader-base", 2014);
m = this.addModule(Y.merge(found), mname);
                    _yuitest_coverline("loader-base", 2015);
if (found.configFn) {
                        _yuitest_coverline("loader-base", 2016);
m.configFn = found.configFn;
                    }
                    _yuitest_coverline("loader-base", 2018);
m.temp = true;
                }
            }
        } else {
            _yuitest_coverline("loader-base", 2022);
if (found && m && found.configFn && !m.configFn) {
                _yuitest_coverline("loader-base", 2023);
m.configFn = found.configFn;
                _yuitest_coverline("loader-base", 2024);
m.configFn(m);
            }
        }

        _yuitest_coverline("loader-base", 2028);
return m;
    },
    ...
    _reduce: function(r) {
        ...
        _yuitest_coverfunc("loader-base", "_reduce", 2041);
_yuitest_coverline("loader-base", 2043);
r = r || this.required;

        _yuitest_coverline("loader-base", 2045);
var i, j, s, m, type = this.loadType,
        ignore = this.ignore ? YArray.hash(this.ignore) : false;

        _yuitest_coverline("loader-base", 2048);
for (i in r) {
            _yuitest_coverline("loader-base", 2049);
if (r.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 2050);
m = this.getModule(i);
                // remove if already loaded
                _yuitest_coverline("loader-base", 2052);
if (((this.loaded[i] || ON_PAGE[i]) &&
                        !this.forceMap[i] && !this.ignoreRegistered) ||
                        (type && m && m.type != type)) {
                    _yuitest_coverline("loader-base", 2055);
delete r[i];
                }
                _yuitest_coverline("loader-base", 2057);
if (ignore && ignore[i]) {
                    _yuitest_coverline("loader-base", 2058);
delete r[i];
                }
                // remove anything this module supersedes
                _yuitest_coverline("loader-base", 2061);
s = m && m.supersedes;
                _yuitest_coverline("loader-base", 2062);
if (s) {
                    _yuitest_coverline("loader-base", 2063);
for (j = 0; j < s.length; j++) {
                        _yuitest_coverline("loader-base", 2064);
if (s[j] in r) {
                            _yuitest_coverline("loader-base", 2065);
delete r[s[j]];
                        }
                    }
                }
        ...
        _yuitest_coverline("loader-base", 2072);
return r;
    },
    /**
    ...
    */
    _finish: function(msg, success) {
        ...
        _yuitest_coverfunc("loader-base", "_finish", 2081);
_yuitest_coverline("loader-base", 2083);
_queue.running = false;

        _yuitest_coverline("loader-base", 2085);
var onEnd = this.onEnd;
        _yuitest_coverline("loader-base", 2086);
if (onEnd) {
            _yuitest_coverline("loader-base", 2087);
onEnd.call(this.context, {
        ...
        _yuitest_coverline("loader-base", 2093);
this._continue();
    },
    /**
    ...
    */
    _onSuccess: function() {
        _yuitest_coverfunc("loader-base", "_onSuccess", 2100);
_yuitest_coverline("loader-base", 2101);
var self = this, skipped = Y.merge(self.skipped), fn,
            failed = [], rreg = self.requireRegistration,
            success, msg, i, mod;
        
        _yuitest_coverline("loader-base", 2105);
for (i in skipped) {
            _yuitest_coverline("loader-base", 2106);
if (skipped.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 2107);
delete self.inserted[i];
            }
        }

        _yuitest_coverline("loader-base", 2111);
self.skipped = {};
        
        _yuitest_coverline("loader-base", 2113);
for (i in self.inserted) {
            _yuitest_coverline("loader-base", 2114);
if (self.inserted.hasOwnProperty(i)) {
                _yuitest_coverline("loader-base", 2115);
mod = self.getModule(i);
                _yuitest_coverline("loader-base", 2116);
if (mod && rreg && mod.type == JS && !(i in YUI.Env.mods)) {
                    _yuitest_coverline("loader-base", 2117);
failed.push(i);
                } else {
                    _yuitest_coverline("loader-base", 2119);
Y.mix(self.loaded, self.getProvides(i));
                }
            }
        }

        _yuitest_coverline("loader-base", 2124);
fn = self.onSuccess;
        _yuitest_coverline("loader-base", 2125);
msg = (failed.length) ? 'notregistered' : 'success';
        _yuitest_coverline("loader-base", 2126);
success = !(failed.length);
        _yuitest_coverline("loader-base", 2127);
if (fn) {
            _yuitest_coverline("loader-base", 2128);
fn.call(self.context, {
        ...
        _yuitest_coverline("loader-base", 2136);
self._finish(msg, success);
    ...
    */
    _onProgress: function(e) {
        _yuitest_coverfunc("loader-base", "_onProgress", 2143);
_yuitest_coverline("loader-base", 2144);
var self = this;
        _yuitest_coverline("loader-base", 2145);
if (self.onProgress) {
            _yuitest_coverline("loader-base", 2146);
self.onProgress.call(self.context, {
    ...
    */
    _onFailure: function(o) {
        _yuitest_coverfunc("loader-base", "_onFailure", 2157);
_yuitest_coverline("loader-base", 2158);
var f = this.onFailure, msg = [], i = 0, len = o.errors.length;
        
        _yuitest_coverline("loader-base", 2160);
for (i; i < len; i++) {
            _yuitest_coverline("loader-base", 2161);
msg.push(o.errors[i].error);
        }

        _yuitest_coverline("loader-base", 2164);
msg = msg.join(',');

        
        _yuitest_coverline("loader-base", 2167);
if (f) {
            _yuitest_coverline("loader-base", 2168);
f.call(this.context, {
                msg: msg,
                data: this.data,
                success: false
        ...
        _yuitest_coverline("loader-base", 2175);
this._finish(msg, false);
    ...
    */
    _onTimeout: function() {
        _yuitest_coverfunc("loader-base", "_onTimeout", 2184);
_yuitest_coverline("loader-base", 2185);
var f = this.onTimeout;
        _yuitest_coverline("loader-base", 2186);
if (f) {
            _yuitest_coverline("loader-base", 2187);
f.call(this.context, {
                msg: 'timeout',
                data: this.data,
                success: false
    ...
    _sort: function() {
        ...
        _yuitest_coverfunc("loader-base", "_sort", 2200);
_yuitest_coverline("loader-base", 2203);
var s = YObject.keys(this.required),
        ...
        _yuitest_coverline("loader-base", 2210);
for (;;) {

            _yuitest_coverline("loader-base", 2212);
l = s.length;
            _yuitest_coverline("loader-base", 2213);
moved = false;

            // start the loop after items that are already sorted
            _yuitest_coverline("loader-base", 2216);
for (j = p; j < l; j++) {

                // check the next module on the list to see if its
                // dependencies have been met
                _yuitest_coverline("loader-base", 2220);
a = s[j];

                // check everything below current item and move if we
                // find a requirement for the current item
                _yuitest_coverline("loader-base", 2224);
for (k = j + 1; k < l; k++) {
                    _yuitest_coverline("loader-base", 2225);
doneKey = a + s[k];

                    _yuitest_coverline("loader-base", 2227);
if (!done[doneKey] && this._requires(a, s[k])) {

                        // extract the dependency so we can move it up
                        _yuitest_coverline("loader-base", 2230);
b = s.splice(k, 1);

                        // insert the dependency above the item that
                        // requires it
                        _yuitest_coverline("loader-base", 2234);
s.splice(j, 0, b[0]);

                        // only swap two dependencies once to short circut
                        // circular dependencies
                        _yuitest_coverline("loader-base", 2238);
done[doneKey] = true;

                        // keep working
                        _yuitest_coverline("loader-base", 2241);
moved = true;

                        _yuitest_coverline("loader-base", 2243);
break;
                    }
                }

                // jump out of loop if we moved something
                _yuitest_coverline("loader-base", 2248);
if (moved) {
                    _yuitest_coverline("loader-base", 2249);
break;
                // this item is sorted, move our pointer and keep going
                } else {
                    _yuitest_coverline("loader-base", 2252);
p++;
                }
            }
            ...
            // finished sorting
            _yuitest_coverline("loader-base", 2258);
if (!moved) {
                _yuitest_coverline("loader-base", 2259);
break;
            }

        }

        _yuitest_coverline("loader-base", 2264);
this.sorted = s;
    },
    ...
    */
    _insert: function(source, o, type, skipcalc) {
        ...
        _yuitest_coverfunc("loader-base", "_insert", 2276);
_yuitest_coverline("loader-base", 2280);
if (source) {
            _yuitest_coverline("loader-base", 2281);
this._config(source);
        }
        ...
        _yuitest_coverline("loader-base", 2287);
if (!skipcalc) {
            //this.calculate(o);
        }

        _yuitest_coverline("loader-base", 2291);
var modules = this.resolve(!skipcalc),
            self = this, comp = 0, actions = 0;

        _yuitest_coverline("loader-base", 2294);
if (type) {
            //Filter out the opposite type and reset the array so the checks later work
            _yuitest_coverline("loader-base", 2296);
modules[((type === JS) ? CSS : JS)] = [];
        }
        _yuitest_coverline("loader-base", 2298);
if (modules.js.length) {
            _yuitest_coverline("loader-base", 2299);
comp++;
        }
        _yuitest_coverline("loader-base", 2301);
if (modules.css.length) {
            _yuitest_coverline("loader-base", 2302);
comp++;
        }

        //console.log('Resolved Modules: ', modules);

        _yuitest_coverline("loader-base", 2307);
var complete = function(d) {
            _yuitest_coverfunc("loader-base", "complete", 2307);
_yuitest_coverline("loader-base", 2308);
actions++;
            _yuitest_coverline("loader-base", 2309);
var errs = {}, i = 0, u = '', fn;

            _yuitest_coverline("loader-base", 2311);
if (d && d.errors) {
                _yuitest_coverline("loader-base", 2312);
for (i = 0; i < d.errors.length; i++) {
                    _yuitest_coverline("loader-base", 2313);
if (d.errors[i].request) {
                        _yuitest_coverline("loader-base", 2314);
u = d.errors[i].request.url;
                    } else {
                        _yuitest_coverline("loader-base", 2316);
u = d.errors[i];
                    }
                    _yuitest_coverline("loader-base", 2318);
errs[u] = u;
                }
            }
            
            _yuitest_coverline("loader-base", 2322);
if (d && d.data && d.data.length && (d.type === 'success')) {
                _yuitest_coverline("loader-base", 2323);
for (i = 0; i < d.data.length; i++) {
                    _yuitest_coverline("loader-base", 2324);
self.inserted[d.data[i].name] = true;
                }
            }

            _yuitest_coverline("loader-base", 2328);
if (actions === comp) {
                _yuitest_coverline("loader-base", 2329);
self._loading = null;
                _yuitest_coverline("loader-base", 2330);
if (d && d.fn) {
                    _yuitest_coverline("loader-base", 2331);
fn = d.fn;
                    _yuitest_coverline("loader-base", 2332);
delete d.fn;
                    _yuitest_coverline("loader-base", 2333);
fn.call(self, d);
                }
            }
        };

        _yuitest_coverline("loader-base", 2338);
this._loading = true;

        _yuitest_coverline("loader-base", 2340);
if (!modules.js.length && !modules.css.length) {
            _yuitest_coverline("loader-base", 2341);
actions = -1;
            _yuitest_coverline("loader-base", 2342);
complete({
                fn: self._onSuccess
            });
            _yuitest_coverline("loader-base", 2345);
return;
        }
        

        _yuitest_coverline("loader-base", 2349);
if (modules.css.length) { //Load CSS first
            _yuitest_coverline("loader-base", 2350);
Y.Get.css(modules.css, {
                ...
                onProgress: function(e) {
                    _yuitest_coverfunc("loader-base", "onProgress", 2357);
_yuitest_coverline("loader-base", 2358);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("loader-base", "onTimeout", 2360);
_yuitest_coverline("loader-base", 2361);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("loader-base", "onSuccess", 2363);
_yuitest_coverline("loader-base", 2364);
d.type = 'success';
                    _yuitest_coverline("loader-base", 2365);
d.fn = self._onSuccess;
                    _yuitest_coverline("loader-base", 2366);
complete.call(self, d);
                },
                onFailure: function(d) {
                    _yuitest_coverfunc("loader-base", "onFailure", 2368);
_yuitest_coverline("loader-base", 2369);
d.type = 'failure';
                    _yuitest_coverline("loader-base", 2370);
d.fn = self._onFailure;
                    _yuitest_coverline("loader-base", 2371);
complete.call(self, d);
                }
            });
        }

        _yuitest_coverline("loader-base", 2376);
if (modules.js.length) {
            _yuitest_coverline("loader-base", 2377);
Y.Get.js(modules.js, {
                data: modules.jsMods,
                insertBefore: self.insertBefore,
                ...
                async: self.async,
                onProgress: function(e) {
                    _yuitest_coverfunc("loader-base", "onProgress", 2386);
_yuitest_coverline("loader-base", 2387);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("loader-base", "onTimeout", 2389);
_yuitest_coverline("loader-base", 2390);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("loader-base", "onSuccess", 2392);
_yuitest_coverline("loader-base", 2393);
d.type = 'success';
                    _yuitest_coverline("loader-base", 2394);
d.fn = self._onSuccess;
                    _yuitest_coverline("loader-base", 2395);
complete.call(self, d);
                },
                onFailure: function(d) {
                    _yuitest_coverfunc("loader-base", "onFailure", 2397);
_yuitest_coverline("loader-base", 2398);
d.type = 'failure';
                    _yuitest_coverline("loader-base", 2399);
d.fn = self._onFailure;
                    _yuitest_coverline("loader-base", 2400);
complete.call(self, d);
                }
            });
        }
    ...
    */
    _continue: function() {
        _yuitest_coverfunc("loader-base", "_continue", 2410);
_yuitest_coverline("loader-base", 2411);
if (!(_queue.running) && _queue.size() > 0) {
            _yuitest_coverline("loader-base", 2412);
_queue.running = true;
            _yuitest_coverline("loader-base", 2413);
_queue.next()();
        }
    },
    ...
    insert: function(o, type, skipsort) {
        _yuitest_coverfunc("loader-base", "insert", 2425);
_yuitest_coverline("loader-base", 2426);
var self = this, copy = Y.merge(this);
        _yuitest_coverline("loader-base", 2427);
delete copy.require;
        _yuitest_coverline("loader-base", 2428);
delete copy.dirty;
        _yuitest_coverline("loader-base", 2429);
_queue.add(function() {
            _yuitest_coverfunc("loader-base", "(anonymous 6)", 2429);
_yuitest_coverline("loader-base", 2430);
self._insert(copy, o, type, skipsort);
        });
        _yuitest_coverline("loader-base", 2432);
this._continue();
    },
    ...
    loadNext: function(mname) {
        _yuitest_coverfunc("loader-base", "loadNext", 2446);
_yuitest_coverline("loader-base", 2447);
return;
    },
    ...
    _filter: function(u, name, group) {
        _yuitest_coverfunc("loader-base", "_filter", 2459);
_yuitest_coverline("loader-base", 2460);
var f = this.filter,
            hasFilter = name && (name in this.filters),
            modFilter = hasFilter && this.filters[name],
            groupName = group || (this.moduleInfo[name] ? this.moduleInfo[name].group : null);

        _yuitest_coverline("loader-base", 2465);
if (groupName && this.groups[groupName] && this.groups[groupName].filter) {
            _yuitest_coverline("loader-base", 2466);
modFilter = this.groups[groupName].filter;
            _yuitest_coverline("loader-base", 2467);
hasFilter = true;
        }

        _yuitest_coverline("loader-base", 2470);
if (u) {
            _yuitest_coverline("loader-base", 2471);
if (hasFilter) {
                _yuitest_coverline("loader-base", 2472);
f = (L.isString(modFilter)) ? this.FILTER_DEFS[modFilter.toUpperCase()] || null : modFilter;
            }
            _yuitest_coverline("loader-base", 2474);
if (f) {
                _yuitest_coverline("loader-base", 2475);
u = u.replace(new RegExp(f.searchExp, 'g'), f.replaceStr);
            }
        }
        _yuitest_coverline("loader-base", 2478);
return u;
    },
    ...
    _url: function(path, name, base) {
        _yuitest_coverfunc("loader-base", "_url", 2490);
_yuitest_coverline("loader-base", 2491);
return this._filter((base || this.base || '') + path, name);
    ...
    */
    resolve: function(calc, s) {
        ...
        _yuitest_coverfunc("loader-base", "resolve", 2512);
_yuitest_coverline("loader-base", 2514);
var len, i, m, url, fn, msg, attr, group, groupName, j, frag,
        ...
        _yuitest_coverline("loader-base", 2522);
if (self.skin.overrides || self.skin.defaultSkin !== DEFAULT_SKIN || self.ignoreRegistered) { 
            _yuitest_coverline("loader-base", 2523);
self._resetModules();
        }

        _yuitest_coverline("loader-base", 2526);
if (calc) {
            _yuitest_coverline("loader-base", 2527);
self.calculate();
        }
        _yuitest_coverline("loader-base", 2529);
s = s || self.sorted;

        _yuitest_coverline("loader-base", 2531);
var addSingle = function(m) {
            
            _yuitest_coverfunc("loader-base", "addSingle", 2531);
_yuitest_coverline("loader-base", 2533);
if (m) {
                _yuitest_coverline("loader-base", 2534);
group = (m.group && self.groups[m.group]) || NOT_FOUND;
                
                //Always assume it's async
                _yuitest_coverline("loader-base", 2537);
if (group.async === false) {
                    _yuitest_coverline("loader-base", 2538);
m.async = group.async;
                }

                _yuitest_coverline("loader-base", 2541);
url = (m.fullpath) ? self._filter(m.fullpath, s[i]) :
                      self._url(m.path, s[i], group.base || m.base);
                
                _yuitest_coverline("loader-base", 2544);
if (m.attributes || m.async === false) {
                    _yuitest_coverline("loader-base", 2545);
url = {
                        url: url,
                        async: m.async
                    };
                    _yuitest_coverline("loader-base", 2549);
if (m.attributes) {
                        _yuitest_coverline("loader-base", 2550);
url.attributes = m.attributes;
                    }
                }
                _yuitest_coverline("loader-base", 2553);
resolved[m.type].push(url);
                _yuitest_coverline("loader-base", 2554);
resolved[m.type + 'Mods'].push(m);
        ...
        _yuitest_coverline("loader-base", 2560);
len = s.length;

        // the default combo base
        _yuitest_coverline("loader-base", 2563);
comboBase = self.comboBase;

        _yuitest_coverline("loader-base", 2565);
url = comboBase;

        _yuitest_coverline("loader-base", 2567);
comboSources = {};

        _yuitest_coverline("loader-base", 2569);
for (i = 0; i < len; i++) {
            _yuitest_coverline("loader-base", 2570);
comboSource = comboBase;
            _yuitest_coverline("loader-base", 2571);
m = self.getModule(s[i]);
            _yuitest_coverline("loader-base", 2572);
groupName = m && m.group;
            _yuitest_coverline("loader-base", 2573);
group = self.groups[groupName];
            _yuitest_coverline("loader-base", 2574);
if (groupName && group) {

                _yuitest_coverline("loader-base", 2576);
if (!group.combine || m.fullpath) {
                    //This is not a combo module, skip it and load it singly later.
                    //singles.push(s[i]);
                    _yuitest_coverline("loader-base", 2579);
addSingle(m);
                    _yuitest_coverline("loader-base", 2580);
continue;
                }
                _yuitest_coverline("loader-base", 2582);
m.combine = true;
                _yuitest_coverline("loader-base", 2583);
if (group.comboBase) {
                    _yuitest_coverline("loader-base", 2584);
comboSource = group.comboBase;
                }

                _yuitest_coverline("loader-base", 2587);
if ("root" in group && L.isValue(group.root)) {
                    _yuitest_coverline("loader-base", 2588);
m.root = group.root;
                }
                _yuitest_coverline("loader-base", 2590);
m.comboSep = group.comboSep || self.comboSep;
                _yuitest_coverline("loader-base", 2591);
m.maxURLLength = group.maxURLLength || self.maxURLLength;
            } else {
                _yuitest_coverline("loader-base", 2593);
if (!self.combine) {
                    //This is not a combo module, skip it and load it singly later.
                    //singles.push(s[i]);
                    _yuitest_coverline("loader-base", 2596);
addSingle(m);
                    _yuitest_coverline("loader-base", 2597);
continue;
                }
            }

            _yuitest_coverline("loader-base", 2601);
comboSources[comboSource] = comboSources[comboSource] || [];
            _yuitest_coverline("loader-base", 2602);
comboSources[comboSource].push(m);
        }

        _yuitest_coverline("loader-base", 2605);
for (j in comboSources) {
            _yuitest_coverline("loader-base", 2606);
if (comboSources.hasOwnProperty(j)) {
                _yuitest_coverline("loader-base", 2607);
resCombos[j] = resCombos[j] || { js: [], jsMods: [], css: [], cssMods: [] };
                _yuitest_coverline("loader-base", 2608);
url = j;
                _yuitest_coverline("loader-base", 2609);
mods = comboSources[j];
                _yuitest_coverline("loader-base", 2610);
len = mods.length;
                
                _yuitest_coverline("loader-base", 2612);
if (len) {
                    _yuitest_coverline("loader-base", 2613);
for (i = 0; i < len; i++) {
                        _yuitest_coverline("loader-base", 2614);
if (inserted[mods[i]]) {
                            _yuitest_coverline("loader-base", 2615);
continue;
                        }
                        _yuitest_coverline("loader-base", 2617);
m = mods[i];
                        // Do not try to combine non-yui JS unless combo def
                        // is found
                        _yuitest_coverline("loader-base", 2620);
if (m && (m.combine || !m.ext)) {
                            _yuitest_coverline("loader-base", 2621);
resCombos[j].comboSep = m.comboSep;
                            _yuitest_coverline("loader-base", 2622);
resCombos[j].group = m.group;
                            _yuitest_coverline("loader-base", 2623);
resCombos[j].maxURLLength = m.maxURLLength;
                            _yuitest_coverline("loader-base", 2624);
frag = ((L.isValue(m.root)) ? m.root : self.root) + (m.path || m.fullpath);
                            _yuitest_coverline("loader-base", 2625);
frag = self._filter(frag, m.name);
                            _yuitest_coverline("loader-base", 2626);
resCombos[j][m.type].push(frag);
                            _yuitest_coverline("loader-base", 2627);
resCombos[j][m.type + 'Mods'].push(m);
                        } else {
                            //Add them to the next process..
                            _yuitest_coverline("loader-base", 2630);
if (mods[i]) {
                                //singles.push(mods[i].name);
                                _yuitest_coverline("loader-base", 2632);
addSingle(mods[i]);
                            }
                        }
        ...
        _yuitest_coverline("loader-base", 2642);
for (j in resCombos) {
            _yuitest_coverline("loader-base", 2643);
base = j;
            _yuitest_coverline("loader-base", 2644);
comboSep = resCombos[base].comboSep || self.comboSep;
            _yuitest_coverline("loader-base", 2645);
maxURLLength = resCombos[base].maxURLLength || self.maxURLLength;
            _yuitest_coverline("loader-base", 2646);
for (type in resCombos[base]) {
                _yuitest_coverline("loader-base", 2647);
if (type === JS || type === CSS) {
                    _yuitest_coverline("loader-base", 2648);
urls = resCombos[base][type];
                    _yuitest_coverline("loader-base", 2649);
mods = resCombos[base][type + 'Mods'];
                    _yuitest_coverline("loader-base", 2650);
len = urls.length;
                    _yuitest_coverline("loader-base", 2651);
tmpBase = base + urls.join(comboSep);
                    _yuitest_coverline("loader-base", 2652);
baseLen = tmpBase.length;
                    _yuitest_coverline("loader-base", 2653);
if (maxURLLength <= base.length) {
                        _yuitest_coverline("loader-base", 2654);
maxURLLength = MAX_URL_LENGTH;
                    }
                    
                    _yuitest_coverline("loader-base", 2657);
if (len) {
                        _yuitest_coverline("loader-base", 2658);
if (baseLen > maxURLLength) {
                            _yuitest_coverline("loader-base", 2659);
u = [];
                            _yuitest_coverline("loader-base", 2660);
for (s = 0; s < len; s++) {
                                _yuitest_coverline("loader-base", 2661);
u.push(urls[s]);
                                _yuitest_coverline("loader-base", 2662);
tmpBase = base + u.join(comboSep);

                                _yuitest_coverline("loader-base", 2664);
if (tmpBase.length > maxURLLength) {
                                    _yuitest_coverline("loader-base", 2665);
m = u.pop();
                                    _yuitest_coverline("loader-base", 2666);
tmpBase = base + u.join(comboSep);
                                    _yuitest_coverline("loader-base", 2667);
resolved[type].push(self._filter(tmpBase, null, resCombos[base].group));
                                    _yuitest_coverline("loader-base", 2668);
u = [];
                                    _yuitest_coverline("loader-base", 2669);
if (m) {
                                        _yuitest_coverline("loader-base", 2670);
u.push(m);
                                    }
                                }
                            }
                            _yuitest_coverline("loader-base", 2674);
if (u.length) {
                                _yuitest_coverline("loader-base", 2675);
tmpBase = base + u.join(comboSep);
                                _yuitest_coverline("loader-base", 2676);
resolved[type].push(self._filter(tmpBase, null, resCombos[base].group));
                            }
                        } else {
                            _yuitest_coverline("loader-base", 2679);
resolved[type].push(self._filter(tmpBase, null, resCombos[base].group));
                        }
                    }
                    _yuitest_coverline("loader-base", 2682);
resolved[type + 'Mods'] = resolved[type + 'Mods'].concat(mods);
                }
            }
        }

        _yuitest_coverline("loader-base", 2687);
resCombos = null;

        _yuitest_coverline("loader-base", 2689);
return resolved;
    },
    /**
    ...
    */
    load: function(cb) {
        _yuitest_coverfunc("loader-base", "load", 2711);
_yuitest_coverline("loader-base", 2712);
if (!cb) {
            _yuitest_coverline("loader-base", 2713);
return;
        }
        _yuitest_coverline("loader-base", 2715);
var self = this,
            out = self.resolve(true);
        
        _yuitest_coverline("loader-base", 2718);
self.data = out;

        _yuitest_coverline("loader-base", 2720);
self.onEnd = function() {
            _yuitest_coverfunc("loader-base", "onEnd", 2720);
_yuitest_coverline("loader-base", 2721);
cb.apply(self.context || self, arguments);
        };

        _yuitest_coverline("loader-base", 2724);
self.insert();
    }
};
