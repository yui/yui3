...
this._finish(msg, false);
    ...
    */
    _onTimeout: function(transaction) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_onTimeout", 2188);
...
f.call(this.context, {
    ...
    _sort: function() {
        ...
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_sort", 2205);
_yuitest_coverline("build/loader-base/loader-base.js", 2208);
...
this.sorted = s;
    ...
    */
    _insert: function(source, o, type, skipcalc) {
        ...
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_insert", 2281);
_yuitest_coverline("build/loader-base/loader-base.js", 2285);
if (source) {
...
complete = function(d) {
            _yuitest_coverfunc("build/loader-base/loader-base.js", "complete", 2315);
...
Y.Get.css(modules.css, {
                ...
                onProgress: function(e) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onProgress", 2402);
_yuitest_coverline("build/loader-base/loader-base.js", 2403);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onTimeout", 2405);
_yuitest_coverline("build/loader-base/loader-base.js", 2406);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onSuccess", 2408);
...
complete.call(self, d);
                ...
                onFailure: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onFailure", 2413);
...
Y.Get.js(modules.js, {
                ...
                async: self.async,
                onProgress: function(e) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onProgress", 2431);
_yuitest_coverline("build/loader-base/loader-base.js", 2432);
self._onProgress.call(self, e);
                },
                onTimeout: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onTimeout", 2434);
_yuitest_coverline("build/loader-base/loader-base.js", 2435);
self._onTimeout.call(self, d);
                },
                onSuccess: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onSuccess", 2437);
...
complete.call(self, d);
                ...
                onFailure: function(d) {
                    _yuitest_coverfunc("build/loader-base/loader-base.js", "onFailure", 2442);
...
complete.call(self, d);
    ...
    */
    _continue: function() {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_continue", 2455);
_yuitest_coverline("build/loader-base/loader-base.js", 2456);
if (!(_queue.running) && _queue.size() > 0) {
            _yuitest_coverline("build/loader-base/loader-base.js", 2457);
_queue.running = true;
...
_queue.next()();
    ...
    insert: function(o, type, skipsort) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "insert", 2470);
...
_queue.add(function() {
            _yuitest_coverfunc("build/loader-base/loader-base.js", "(anonymous 6)", 2474);
...
this._continue();
     ...
     */
    loadNext: function() {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "loadNext", 2491);
...
return;
    ...
    _filter: function(u, name, group) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_filter", 2504);
_yuitest_coverline("build/loader-base/loader-base.js", 2505);
var f = this.filter,
...
if (groupName && this.groups[groupName] && this.groups[groupName].filter) {
            _yuitest_coverline("build/loader-base/loader-base.js", 2511);
...
return u;
    ...
    _url: function(path, name, base) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "_url", 2535);
...
return this._filter((base || this.base || '') + path, name);
    ...
    */
    resolve: function(calc, s) {
        ...
        _yuitest_coverfunc("build/loader-base/loader-base.js", "resolve", 2557);
...
addSingle = function(m) {
            ...
            _yuitest_coverfunc("build/loader-base/loader-base.js", "addSingle", 2576);
...
return resolved;
    ...
    */
    load: function(cb) {
        _yuitest_coverfunc("build/loader-base/loader-base.js", "load", 2753);
...
self.onEnd = function() {
            _yuitest_coverfunc("build/loader-base/loader-base.js", "onEnd", 2762);
