...
_yuitest_coverage["/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 16);
if (Y.UA.ie && !Y.HistoryBase.nativeHashChange) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 17);
var Do          = Y.Do,
     ...
     * @static
     */
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 32);
HistoryHash.getIframeHash = function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "getIframeHash", 32);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 33);
if (!iframe || !iframe.contentWindow) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 34);
return '';
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 37);
var prefix = HistoryHash.hashPrefix,
            hash   = iframe.contentWindow.location.hash.substr(1);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 40);
return prefix && hash.indexOf(prefix) === 0 ?
     ...
     * @for HistoryHash
     */
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 55);
HistoryHash._updateIframe = function (hash, replace) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "_updateIframe", 55);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 56);
var iframeDoc      = iframe && iframe.contentWindow && iframe.contentWindow.document,
            iframeLocation = iframeDoc && iframeDoc.location;

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 59);
if (!iframeDoc || !iframeLocation) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 60);
return;
        }


        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 64);
if (replace) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 65);
iframeLocation.replace(hash.charAt(0) === '#' ? hash : '#' + hash);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 67);
iframeDoc.open().close();
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 68);
iframeLocation.hash = hash;
        }
    };

    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 72);
Do.before(HistoryHash._updateIframe, HistoryHash, 'replaceHash', HistoryHash, true);

    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 74);
if (!iframe) {
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 75);
Y.on('domready', function () {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "(anonymous 2)", 75);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 76);
var lastUrlHash = HistoryHash.getHash();
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 96);
iframe = GlobalEnv._iframe = Y.Node.getDOMNode(Y.Node.create(
            ...
            // technique).
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 104);
Y.config.doc.documentElement.appendChild(iframe);

            // Update the iframe with the initial location hash, if any. This
            // will create an initial history entry that the user can return to
            // after the state has changed.
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 109);
HistoryHash._updateIframe(lastUrlHash || '#');
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 113);
Y.on('hashchange', function (e) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "(anonymous 3)", 113);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 114);
lastUrlHash = e.newHash;

                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 116);
if (HistoryHash.getIframeHash() !== lastUrlHash) {
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 117);
HistoryHash._updateIframe(lastUrlHash);
                }
            }, win);

            // Watch the iframe hash in order to detect back/forward navigation.
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 122);
Y.later(50, null, function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", "(anonymous 4)", 122);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 123);
var iframeHash = HistoryHash.getIframeHash();

                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 125);
if (iframeHash !== lastUrlHash) {
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-hash-ie.js", 126);
