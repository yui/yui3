...
_yuitest_coverfunc("resize-base", "(anonymous 1)", 1);
_yuitest_coverline("resize-base", 9);
var Lang = Y.Lang,
	...
	concat = function() {
		_yuitest_coverfunc("resize-base", "concat", 78);
_yuitest_coverline("resize-base", 79);
return Array.prototype.slice.call(arguments).join(SPACE);
	},

	// round the passed number to get rid of pixel-flickering
	toRoundNumber = function(num) {
		_yuitest_coverfunc("resize-base", "toRoundNumber", 83);
_yuitest_coverline("resize-base", 84);
return Math.round(parseFloat(num)) || 0;
	},

	getCompStyle = function(node, val) {
		_yuitest_coverfunc("resize-base", "getCompStyle", 87);
_yuitest_coverline("resize-base", 88);
return node.getComputedStyle(val);
	},

	handleAttrName = function(handle) {
		_yuitest_coverfunc("resize-base", "handleAttrName", 91);
_yuitest_coverline("resize-base", 92);
return HANDLE + handle.toUpperCase();
	},

	isNode = function(v) {
		_yuitest_coverfunc("resize-base", "isNode", 95);
_yuitest_coverline("resize-base", 96);
return (v instanceof Y.Node);
	},

	toInitialCap = Y.cached(
		function(str) {
			_yuitest_coverfunc("resize-base", "(anonymous 2)", 100);
_yuitest_coverline("resize-base", 101);
return str.substring(0, 1).toUpperCase() + str.substring(1);
		}
	),

	capitalize = Y.cached(function() {
		_yuitest_coverfunc("resize-base", "(anonymous 3)", 105);
_yuitest_coverline("resize-base", 106);
var out = [],
			args = YArray(arguments, 0, true);

		_yuitest_coverline("resize-base", 109);
YArray.each(args, function(part, i) {
			_yuitest_coverfunc("resize-base", "(anonymous 4)", 109);
_yuitest_coverline("resize-base", 110);
if (i > 0) {
				_yuitest_coverline("resize-base", 111);
part = toInitialCap(part);
			}
			_yuitest_coverline("resize-base", 113);
out.push(part);
		});

		_yuitest_coverline("resize-base", 116);
...
_yuitest_coverline("resize-base", 165);
function Resize() {
    _yuitest_coverfunc("resize-base", "Resize", 165);
_yuitest_coverline("resize-base", 166);
Resize.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("resize-base", 169);
Y.mix(Resize, {
	/**
	...
	ATTRS: {
		...
		activeHandle: {
			...
			validator: function(v) {
                _yuitest_coverfunc("resize-base", "validator", 198);
_yuitest_coverline("resize-base", 199);
return Y.Lang.isString(v) || Y.Lang.isNull(v);
	...
	RULES: {
		b: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "b", 349);
_yuitest_coverline("resize-base", 350);
var info = instance.info,
				originalInfo = instance.originalInfo;

			_yuitest_coverline("resize-base", 353);
info.offsetHeight = originalInfo.offsetHeight + dy;
		},

		l: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "l", 356);
_yuitest_coverline("resize-base", 357);
var info = instance.info,
				originalInfo = instance.originalInfo;

			_yuitest_coverline("resize-base", 360);
info.left = originalInfo.left + dx;
			_yuitest_coverline("resize-base", 361);
info.offsetWidth = originalInfo.offsetWidth - dx;
		},

		r: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "r", 364);
_yuitest_coverline("resize-base", 365);
var info = instance.info,
				originalInfo = instance.originalInfo;

			_yuitest_coverline("resize-base", 368);
info.offsetWidth = originalInfo.offsetWidth + dx;
		},

		t: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "t", 371);
_yuitest_coverline("resize-base", 372);
var info = instance.info,
				originalInfo = instance.originalInfo;

			_yuitest_coverline("resize-base", 375);
info.top = originalInfo.top + dy;
			_yuitest_coverline("resize-base", 376);
info.offsetHeight = originalInfo.offsetHeight - dy;
		},

		tr: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "tr", 379);
_yuitest_coverline("resize-base", 380);
this.t.apply(this, arguments);
			_yuitest_coverline("resize-base", 381);
this.r.apply(this, arguments);
		},

		bl: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "bl", 384);
_yuitest_coverline("resize-base", 385);
this.b.apply(this, arguments);
			_yuitest_coverline("resize-base", 386);
this.l.apply(this, arguments);
		},

		br: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "br", 389);
_yuitest_coverline("resize-base", 390);
this.b.apply(this, arguments);
			_yuitest_coverline("resize-base", 391);
this.r.apply(this, arguments);
		},

		tl: function(instance, dx, dy) {
			_yuitest_coverfunc("resize-base", "tl", 394);
_yuitest_coverline("resize-base", 395);
this.t.apply(this, arguments);
			_yuitest_coverline("resize-base", 396);
this.l.apply(this, arguments);
		}
	},
...
_yuitest_coverline("resize-base", 403);
Y.Resize = Y.extend(
	Resize,
	Y.Base,
	{
		...
		initializer: function() {
			_yuitest_coverfunc("resize-base", "initializer", 603);
_yuitest_coverline("resize-base", 604);
this._eventHandles = [];

			_yuitest_coverline("resize-base", 606);
this.renderer();
		},
	     ...
	     */
		renderUI: function() {
			_yuitest_coverfunc("resize-base", "renderUI", 615);
_yuitest_coverline("resize-base", 616);
var instance = this;

			_yuitest_coverline("resize-base", 618);
instance._renderHandles();
	     ...
	     */
		bindUI: function() {
			_yuitest_coverfunc("resize-base", "bindUI", 627);
_yuitest_coverline("resize-base", 628);
var instance = this;

			_yuitest_coverline("resize-base", 630);
instance._createEvents();
			_yuitest_coverline("resize-base", 631);
instance._bindDD();
			_yuitest_coverline("resize-base", 632);
instance._bindHandle();
	     ...
	     */
		syncUI: function() {
			_yuitest_coverfunc("resize-base", "syncUI", 641);
_yuitest_coverline("resize-base", 642);
var instance = this;

			_yuitest_coverline("resize-base", 644);
this.get(NODE).addClass(CSS_RESIZE);

			// hide handles if AUTO_HIDE is true
			_yuitest_coverline("resize-base", 647);
instance._setHideHandlesUI(
	     ...
	     */
		destructor: function() {
			_yuitest_coverfunc("resize-base", "destructor", 659);
_yuitest_coverline("resize-base", 660);
var instance = this,
				node = instance.get(NODE),
				wrapper = instance.get(WRAPPER),
				pNode = wrapper.get(PARENT_NODE);

			_yuitest_coverline("resize-base", 665);
Y.each(
				instance._eventHandles,
				function(handle, index) {
					_yuitest_coverfunc("resize-base", "(anonymous 5)", 667);
_yuitest_coverline("resize-base", 668);
handle.detach();
				}
			);

			_yuitest_coverline("resize-base", 672);
instance._eventHandles.length = 0;

			// destroy handles dd and remove them from the dom
			_yuitest_coverline("resize-base", 675);
instance.eachHandle(function(handleEl) {
				_yuitest_coverfunc("resize-base", "(anonymous 6)", 675);
_yuitest_coverline("resize-base", 676);
instance.delegate.dd.destroy();

				// remove handle
				_yuitest_coverline("resize-base", 679);
handleEl.remove(true);
			});

			_yuitest_coverline("resize-base", 682);
instance.delegate.destroy();

			// unwrap node
			_yuitest_coverline("resize-base", 685);
if (instance.get(WRAP)) {
				_yuitest_coverline("resize-base", 686);
instance._copyStyles(wrapper, node);

				_yuitest_coverline("resize-base", 688);
if (pNode) {
					_yuitest_coverline("resize-base", 689);
pNode.insertBefore(node, wrapper);
				}

				_yuitest_coverline("resize-base", 692);
wrapper.remove(true);
			}

			_yuitest_coverline("resize-base", 695);
node.removeClass(CSS_RESIZE);
			_yuitest_coverline("resize-base", 696);
node.removeClass(CSS_RESIZE_HIDDEN_HANDLES);
	     ...
	     */
	    renderer: function() {
	        _yuitest_coverfunc("resize-base", "renderer", 707);
_yuitest_coverline("resize-base", 708);
this.renderUI();
	        _yuitest_coverline("resize-base", 709);
this.bindUI();
	        _yuitest_coverline("resize-base", 710);
this.syncUI();
	    },
		...
		eachHandle: function(fn) {
			_yuitest_coverfunc("resize-base", "eachHandle", 723);
_yuitest_coverline("resize-base", 724);
var instance = this;

			_yuitest_coverline("resize-base", 726);
Y.each(
				instance.get(HANDLES),
				function(handle, i) {
					_yuitest_coverfunc("resize-base", "(anonymous 7)", 728);
_yuitest_coverline("resize-base", 729);
var handleEl = instance.get(
						handleAttrName(handle)
					);

					_yuitest_coverline("resize-base", 733);
fn.apply(instance, [handleEl, handle, i]);
	     ...
	     */
		_bindDD: function() {
			_yuitest_coverfunc("resize-base", "_bindDD", 744);
_yuitest_coverline("resize-base", 745);
var instance = this;

			_yuitest_coverline("resize-base", 747);
instance.delegate = new Y.DD.Delegate(
			...
			_yuitest_coverline("resize-base", 762);
instance._eventHandles.push(
		...
		_bindHandle: function() {
			_yuitest_coverfunc("resize-base", "_bindHandle", 776);
_yuitest_coverline("resize-base", 777);
var instance = this,
				wrapper = instance.get(WRAPPER);

			_yuitest_coverline("resize-base", 780);
instance._eventHandles.push(
		...
		_createEvents: function() {
			_yuitest_coverfunc("resize-base", "_createEvents", 794);
_yuitest_coverline("resize-base", 795);
var instance = this,
				// create publish function for kweight optimization
				publish = function(name, fn) {
					_yuitest_coverfunc("resize-base", "publish", 797);
_yuitest_coverline("resize-base", 798);
instance.publish(name, {
	         ...
	         * @type {Event.Custom}
	         */
			_yuitest_coverline("resize-base", 817);
publish(EV_RESIZE_START, this._defResizeStartFn);
	         ...
	         * @type {Event.Custom}
	         */
			_yuitest_coverline("resize-base", 829);
publish(EV_RESIZE, this._defResizeFn);
	         ...
	         * @type {Event.Custom}
	         */
			_yuitest_coverline("resize-base", 840);
publish(EV_RESIZE_ALIGN, this._defResizeAlignFn);
	         ...
	         * @type {Event.Custom}
	         */
			_yuitest_coverline("resize-base", 852);
publish(EV_RESIZE_END, this._defResizeEndFn);
	         ...
	         * @type {Event.Custom}
	         */
			_yuitest_coverline("resize-base", 864);
publish(EV_MOUSE_UP, this._defMouseUpFn);
		...
		_renderHandles: function() {
			_yuitest_coverfunc("resize-base", "_renderHandles", 873);
_yuitest_coverline("resize-base", 874);
var instance = this,
				wrapper = instance.get(WRAPPER),
				handlesWrapper = instance.get(HANDLES_WRAPPER);

			_yuitest_coverline("resize-base", 878);
instance.eachHandle(function(handleEl) {
				_yuitest_coverfunc("resize-base", "(anonymous 8)", 878);
_yuitest_coverline("resize-base", 879);
handlesWrapper.append(handleEl);
			});

			_yuitest_coverline("resize-base", 882);
wrapper.append(handlesWrapper);
		...
		_buildHandle: function(handle) {
			_yuitest_coverfunc("resize-base", "_buildHandle", 893);
_yuitest_coverline("resize-base", 894);
var instance = this;

			_yuitest_coverline("resize-base", 896);
return Y.Node.create(
		...
		_calcResize: function() {
			_yuitest_coverfunc("resize-base", "_calcResize", 909);
_yuitest_coverline("resize-base", 910);
var instance = this,
            ...
            _yuitest_coverline("resize-base", 918);
if (handle && Y.Resize.RULES[handle]) {
			    _yuitest_coverline("resize-base", 919);
Y.Resize.RULES[handle](instance, dx, dy);
		...
		_checkSize: function(offset, size) {
			_yuitest_coverfunc("resize-base", "_checkSize", 935);
_yuitest_coverline("resize-base", 936);
var instance = this,
				info = instance.info,
				originalInfo = instance.originalInfo,
			...
			_yuitest_coverline("resize-base", 942);
info[offset] = size;
...
info[axis] = originalInfo[axis] + originalInfo[offset] - size;
		...
		_copyStyles: function(node, wrapper) {
			_yuitest_coverfunc("resize-base", "_copyStyles", 962);
_yuitest_coverline("resize-base", 963);
var position = node.getStyle(POSITION).toLowerCase(),
			...
			_yuitest_coverline("resize-base", 968);
if (position == STATIC) {
				_yuitest_coverline("resize-base", 969);
position = RELATIVE;
			}

			_yuitest_coverline("resize-base", 972);
wrapperStyle = {
				position: position,
...
wrapper.sizeTo(
		...
		_extractHandleName: Y.cached(
			function(node) {
				_yuitest_coverfunc("resize-base", "(anonymous 9)", 995);
_yuitest_coverline("resize-base", 996);
var className = node.get(CLASS_NAME),
				...
				_yuitest_coverline("resize-base", 1004);
return match ? match[1] : null;
		...
		_getInfo: function(node, event) {
			_yuitest_coverfunc("resize-base", "_getInfo", 1018);
_yuitest_coverline("resize-base", 1019);
var actXY = [0,0],
			...
			_yuitest_coverline("resize-base", 1027);
if (event) {
				// the xy that the node will be set to. Changing this will alter the position as it's dragged.
				_yuitest_coverline("resize-base", 1029);
actXY = (drag.actXY.length ? drag.actXY : drag.lastXY);
			}

			_yuitest_coverline("resize-base", 1032);
return {
				actXY: actXY,
		...
		_getBoxSurroundingInfo: function(node) {
			_yuitest_coverfunc("resize-base", "_getBoxSurroundingInfo", 1055);
_yuitest_coverline("resize-base", 1056);
var	info = {
				padding: {},
				margin: {},
				border: {}
			...
			_yuitest_coverline("resize-base", 1062);
if (isNode(node)) {
				_yuitest_coverline("resize-base", 1063);
Y.each([ TOP, RIGHT, BOTTOM, LEFT ], function(dir) {
					_yuitest_coverfunc("resize-base", "(anonymous 10)", 1063);
_yuitest_coverline("resize-base", 1064);
...
return info;
	     ...
	     */
		_syncUI: function() {
			_yuitest_coverfunc("resize-base", "_syncUI", 1093);
_yuitest_coverline("resize-base", 1094);
var instance = this,
				info = instance.info,
...
if (!wrapper.compareTo(node)) {
				...
				_yuitest_coverline("resize-base", 1109);
node.sizeTo(
			...
			_yuitest_coverline("resize-base", 1116);
if (Y.UA.webkit) {
				_yuitest_coverline("resize-base", 1117);
node.setStyle(RESIZE, NONE);
		...
		_updateChangeHandleInfo: function(handle) {
			_yuitest_coverfunc("resize-base", "_updateChangeHandleInfo", 1129);
_yuitest_coverline("resize-base", 1130);
var instance = this;

			_yuitest_coverline("resize-base", 1132);
instance.changeHeightHandles = instance.REGEX_CHANGE_HEIGHT.test(handle);
			_yuitest_coverline("resize-base", 1133);
instance.changeLeftHandles = instance.REGEX_CHANGE_LEFT.test(handle);
			_yuitest_coverline("resize-base", 1134);
instance.changeTopHandles = instance.REGEX_CHANGE_TOP.test(handle);
			_yuitest_coverline("resize-base", 1135);
instance.changeWidthHandles = instance.REGEX_CHANGE_WIDTH.test(handle);
		...
		_updateInfo: function(event) {
			_yuitest_coverfunc("resize-base", "_updateInfo", 1144);
_yuitest_coverline("resize-base", 1145);
var instance = this;

			_yuitest_coverline("resize-base", 1147);
instance.info = instance._getInfo(instance.get(WRAPPER), event);
		...
		_updateSurroundingInfo: function() {
			_yuitest_coverfunc("resize-base", "_updateSurroundingInfo", 1160);
_yuitest_coverline("resize-base", 1161);
var instance = this,
				node = instance.get(NODE),
				wrapper = instance.get(WRAPPER),
...
instance.totalHSurrounding = (nodeSurrounding.totalHPadding + wrapperSurrounding.totalHBorder);
		...
		_setActiveHandlesUI: function(val) {
			_yuitest_coverfunc("resize-base", "_setActiveHandlesUI", 1181);
_yuitest_coverline("resize-base", 1182);
var instance = this,
				activeHandleNode = instance.get(ACTIVE_HANDLE_NODE);

			_yuitest_coverline("resize-base", 1185);
if (activeHandleNode) {
				_yuitest_coverline("resize-base", 1186);
if (val) {
					// remove CSS_RESIZE_HANDLE_ACTIVE from all handles before addClass on the active
					_yuitest_coverline("resize-base", 1188);
instance.eachHandle(
						function(handleEl) {
							_yuitest_coverfunc("resize-base", "(anonymous 11)", 1189);
_yuitest_coverline("resize-base", 1190);
handleEl.removeClass(CSS_RESIZE_HANDLE_ACTIVE);
						}
					);

					_yuitest_coverline("resize-base", 1194);
activeHandleNode.addClass(CSS_RESIZE_HANDLE_ACTIVE);
				}
				else {
					_yuitest_coverline("resize-base", 1197);
activeHandleNode.removeClass(CSS_RESIZE_HANDLE_ACTIVE);
		...
		_setHandles: function(val) {
			_yuitest_coverfunc("resize-base", "_setHandles", 1209);
_yuitest_coverline("resize-base", 1210);
var instance = this,
				handles = [];

			// handles attr accepts both array or string
			_yuitest_coverline("resize-base", 1214);
if (isArray(val)) {
				_yuitest_coverline("resize-base", 1215);
handles = val;
			}
			else {_yuitest_coverline("resize-base", 1217);
if (isString(val)) {
				// if the handles attr passed in is an ALL string...
				_yuitest_coverline("resize-base", 1219);
if (val.toLowerCase() == ALL) {
					_yuitest_coverline("resize-base", 1220);
handles = instance.ALL_HANDLES;
				}
				// otherwise, split the string to extract the handles
				else {
					_yuitest_coverline("resize-base", 1224);
Y.each(
						val.split(COMMA),
						function(node, i) {
							_yuitest_coverfunc("resize-base", "(anonymous 12)", 1226);
_yuitest_coverline("resize-base", 1227);
var handle = trim(node);

							// if its a valid handle, add it to the handles output
							_yuitest_coverline("resize-base", 1230);
if (indexOf(instance.ALL_HANDLES, handle) > -1) {
								_yuitest_coverline("resize-base", 1231);
handles.push(handle);
							}
						}
					);
			...
			_yuitest_coverline("resize-base", 1238);
return handles;
		},
		...
		_setHideHandlesUI: function(val) {
			_yuitest_coverfunc("resize-base", "_setHideHandlesUI", 1248);
_yuitest_coverline("resize-base", 1249);
var instance = this,
				wrapper = instance.get(WRAPPER);

			_yuitest_coverline("resize-base", 1252);
if (!instance.get(RESIZING)) {
				_yuitest_coverline("resize-base", 1253);
if (val) {
					_yuitest_coverline("resize-base", 1254);
wrapper.addClass(CSS_RESIZE_HIDDEN_HANDLES);
				}
				else {
					_yuitest_coverline("resize-base", 1257);
wrapper.removeClass(CSS_RESIZE_HIDDEN_HANDLES);
		...
		_setWrap: function(val) {
			_yuitest_coverfunc("resize-base", "_setWrap", 1269);
_yuitest_coverline("resize-base", 1270);
var instance = this,
				node = instance.get(NODE),
			...
			_yuitest_coverline("resize-base", 1276);
if (typeRegex.test(nodeName)) {
				_yuitest_coverline("resize-base", 1277);
val = true;
			}

			_yuitest_coverline("resize-base", 1280);
return val;
		},
		...
		_defMouseUpFn: function(event) {
			_yuitest_coverfunc("resize-base", "_defMouseUpFn", 1290);
_yuitest_coverline("resize-base", 1291);
var instance = this;

			_yuitest_coverline("resize-base", 1293);
instance.set(RESIZING, false);
		...
		_defResizeFn: function(event) {
			_yuitest_coverfunc("resize-base", "_defResizeFn", 1303);
_yuitest_coverline("resize-base", 1304);
var instance = this;

			_yuitest_coverline("resize-base", 1306);
instance._resize(event);
		...
		_resize: function(event) {
			_yuitest_coverfunc("resize-base", "_resize", 1316);
_yuitest_coverline("resize-base", 1317);
var instance = this;

			_yuitest_coverline("resize-base", 1319);
instance._handleResizeAlignEvent(event.dragEvent);

			// _syncUI of the wrapper, not using proxy
			_yuitest_coverline("resize-base", 1322);
instance._syncUI();
		},
		...
		_defResizeAlignFn: function(event) {
			_yuitest_coverfunc("resize-base", "_defResizeAlignFn", 1332);
_yuitest_coverline("resize-base", 1333);
var instance = this;

			_yuitest_coverline("resize-base", 1335);
instance._resizeAlign(event);
		...
		_resizeAlign: function(event) {
			_yuitest_coverfunc("resize-base", "_resizeAlign", 1345);
_yuitest_coverline("resize-base", 1346);
var instance = this,
				info,
				defMinHeight,
				defMinWidth;

			_yuitest_coverline("resize-base", 1351);
instance.lastInfo = instance.info;

			// update the instance.info values
			_yuitest_coverline("resize-base", 1354);
instance._updateInfo(event);

			_yuitest_coverline("resize-base", 1356);
info = instance.info;

			// basic resize calculations
			_yuitest_coverline("resize-base", 1359);
instance._calcResize();

			// if Y.Plugin.ResizeConstrained is not plugged, check for min dimension
			_yuitest_coverline("resize-base", 1362);
if (!instance.con) {
				_yuitest_coverline("resize-base", 1363);
defMinHeight = (instance.get(DEF_MIN_HEIGHT) + instance.totalVSurrounding);
				_yuitest_coverline("resize-base", 1364);
defMinWidth = (instance.get(DEF_MIN_WIDTH) + instance.totalHSurrounding);

				_yuitest_coverline("resize-base", 1366);
if (info.offsetHeight <= defMinHeight) {
					_yuitest_coverline("resize-base", 1367);
instance._checkSize(OFFSET_HEIGHT, defMinHeight);
				}

				_yuitest_coverline("resize-base", 1370);
if (info.offsetWidth <= defMinWidth) {
					_yuitest_coverline("resize-base", 1371);
instance._checkSize(OFFSET_WIDTH, defMinWidth);
		...
		_defResizeEndFn: function(event) {
			_yuitest_coverfunc("resize-base", "_defResizeEndFn", 1383);
_yuitest_coverline("resize-base", 1384);
var instance = this;

			_yuitest_coverline("resize-base", 1386);
instance._resizeEnd(event);
		...
		_resizeEnd: function(event) {
			_yuitest_coverfunc("resize-base", "_resizeEnd", 1396);
_yuitest_coverline("resize-base", 1397);
var instance = this,
				drag = event.dragEvent.target;

			// reseting actXY from drag when drag end
			_yuitest_coverline("resize-base", 1401);
drag.actXY = [];

			// syncUI when resize end
			_yuitest_coverline("resize-base", 1404);
instance._syncUI();

			_yuitest_coverline("resize-base", 1406);
instance._setActiveHandlesUI(false);

			_yuitest_coverline("resize-base", 1408);
instance.set(ACTIVE_HANDLE, null);
			_yuitest_coverline("resize-base", 1409);
instance.set(ACTIVE_HANDLE_NODE, null);

			_yuitest_coverline("resize-base", 1411);
instance.handle = null;
		...
		_defResizeStartFn: function(event) {
			_yuitest_coverfunc("resize-base", "_defResizeStartFn", 1421);
_yuitest_coverline("resize-base", 1422);
var instance = this;

			_yuitest_coverline("resize-base", 1424);
instance._resizeStart(event);
		...
		_resizeStart: function(event) {
			_yuitest_coverfunc("resize-base", "_resizeStart", 1434);
_yuitest_coverline("resize-base", 1435);
var instance = this,
				wrapper = instance.get(WRAPPER);

			_yuitest_coverline("resize-base", 1438);
instance.handle = instance.get(ACTIVE_HANDLE);

			_yuitest_coverline("resize-base", 1440);
instance.set(RESIZING, true);

			_yuitest_coverline("resize-base", 1442);
instance._updateSurroundingInfo();

			// create an originalInfo information for reference
			_yuitest_coverline("resize-base", 1445);
instance.originalInfo = instance._getInfo(wrapper, event);

			_yuitest_coverline("resize-base", 1447);
instance._updateInfo(event);
		},
		...
		_handleMouseUpEvent: function(event) {
			_yuitest_coverfunc("resize-base", "_handleMouseUpEvent", 1457);
_yuitest_coverline("resize-base", 1458);
this.fire(EV_MOUSE_UP, { dragEvent: event, info: this.info });
		...
		_handleResizeEvent: function(event) {
			_yuitest_coverfunc("resize-base", "_handleResizeEvent", 1468);
_yuitest_coverline("resize-base", 1469);
this.fire(EV_RESIZE, { dragEvent: event, info: this.info });
		...
		_handleResizeAlignEvent: function(event) {
			_yuitest_coverfunc("resize-base", "_handleResizeAlignEvent", 1479);
_yuitest_coverline("resize-base", 1480);
this.fire(EV_RESIZE_ALIGN, { dragEvent: event, info: this.info });
		...
		_handleResizeEndEvent: function(event) {
			_yuitest_coverfunc("resize-base", "_handleResizeEndEvent", 1490);
_yuitest_coverline("resize-base", 1491);
this.fire(EV_RESIZE_END, { dragEvent: event, info: this.info });
		...
		_handleResizeStartEvent: function(event) {
            _yuitest_coverfunc("resize-base", "_handleResizeStartEvent", 1501);
_yuitest_coverline("resize-base", 1502);
if (!this.get(ACTIVE_HANDLE)) {
                //This handles the "touch" case
			    _yuitest_coverline("resize-base", 1504);
this._setHandleFromNode(event.target.get('node'));
            }
			_yuitest_coverline("resize-base", 1506);
this.fire(EV_RESIZE_START, { dragEvent: event, info: this.info });
		...
		_onWrapperMouseEnter: function(event) {
			_yuitest_coverfunc("resize-base", "_onWrapperMouseEnter", 1516);
_yuitest_coverline("resize-base", 1517);
var instance = this;

			_yuitest_coverline("resize-base", 1519);
if (instance.get(AUTO_HIDE)) {
				_yuitest_coverline("resize-base", 1520);
instance._setHideHandlesUI(false);
		...
		_onWrapperMouseLeave: function(event) {
			_yuitest_coverfunc("resize-base", "_onWrapperMouseLeave", 1531);
_yuitest_coverline("resize-base", 1532);
var instance = this;

			_yuitest_coverline("resize-base", 1534);
if (instance.get(AUTO_HIDE)) {
				_yuitest_coverline("resize-base", 1535);
instance._setHideHandlesUI(true);
        ...
        _setHandleFromNode: function(node) {
			_yuitest_coverfunc("resize-base", "_setHandleFromNode", 1546);
_yuitest_coverline("resize-base", 1547);
var instance = this,
				handle = instance._extractHandleName(node);

			_yuitest_coverline("resize-base", 1550);
if (!instance.get(RESIZING)) {
				_yuitest_coverline("resize-base", 1551);
instance.set(ACTIVE_HANDLE, handle);
				_yuitest_coverline("resize-base", 1552);
instance.set(ACTIVE_HANDLE_NODE, node);

				_yuitest_coverline("resize-base", 1554);
instance._setActiveHandlesUI(true);
				_yuitest_coverline("resize-base", 1555);
instance._updateChangeHandleInfo(handle);
		...
		_onHandleMouseEnter: function(event) {
			_yuitest_coverfunc("resize-base", "_onHandleMouseEnter", 1566);
_yuitest_coverline("resize-base", 1567);
this._setHandleFromNode(event.currentTarget);
		...
		_onHandleMouseLeave: function(event) {
			_yuitest_coverfunc("resize-base", "_onHandleMouseLeave", 1577);
_yuitest_coverline("resize-base", 1578);
var instance = this;

			_yuitest_coverline("resize-base", 1580);
if (!instance.get(RESIZING)) {
				_yuitest_coverline("resize-base", 1581);
instance._setActiveHandlesUI(false);
			}
		},
		...
		_valueHandlesWrapper: function() {
			_yuitest_coverfunc("resize-base", "_valueHandlesWrapper", 1592);
_yuitest_coverline("resize-base", 1593);
return Y.Node.create(this.HANDLES_WRAP_TEMPLATE);
		...
		_valueWrapper: function() {
			_yuitest_coverfunc("resize-base", "_valueWrapper", 1603);
_yuitest_coverline("resize-base", 1604);
var instance = this,
				node = instance.get(NODE),
			...
			_yuitest_coverline("resize-base", 1611);
if (instance.get(WRAP)) {
				_yuitest_coverline("resize-base", 1612);
wrapper = Y.Node.create(instance.WRAP_TEMPLATE);

				_yuitest_coverline("resize-base", 1614);
if (pNode) {
					_yuitest_coverline("resize-base", 1615);
pNode.insertBefore(wrapper, node);
				}

				_yuitest_coverline("resize-base", 1618);
wrapper.append(node);

				_yuitest_coverline("resize-base", 1620);
instance._copyStyles(node, wrapper);

				// remove positioning of wrapped node, the WRAPPER take care about positioning
				_yuitest_coverline("resize-base", 1623);
node.setStyles({
					position: STATIC,
					left: 0,
					top: 0
			...
			_yuitest_coverline("resize-base", 1630);
return wrapper;
		}
	}
);

_yuitest_coverline("resize-base", 1635);
Y.each(Y.Resize.prototype.ALL_HANDLES, function(handle, i) {
	// creating ATTRS with the handles elements
	_yuitest_coverfunc("resize-base", "(anonymous 13)", 1635);
_yuitest_coverline("resize-base", 1637);
Y.Resize.ATTRS[handleAttrName(handle)] = {
		setter: function() {
			_yuitest_coverfunc("resize-base", "setter", 1638);
_yuitest_coverline("resize-base", 1639);
