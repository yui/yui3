...
parent._isIndexStale   = true;
        ...
        // flow.
        _yuitest_coverline("build/tree/tree.js", 759);
if (node.isSelected()) {
...
this.selectNode(node);
    ...
    _defClearFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defClearFn", 764);
_yuitest_coverline("build/tree/tree.js", 765);
var newRootNode = e.rootNode;

        _yuitest_coverline("build/tree/tree.js", 767);
if (this.rootNode) {
...
this.rootNode = newRootNode;
    ...
    _defCloseFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defCloseFn", 778);
_yuitest_coverline("build/tree/tree.js", 779);
delete e.node.state.open;
    },

    _defOpenFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defOpenFn", 782);
_yuitest_coverline("build/tree/tree.js", 783);
e.node.state.open = true;
    },

    _defRemoveFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defRemoveFn", 786);
...
this.destroyNode(node, {silent: true});
        } else {_yuitest_coverline("build/tree/tree.js", 794);
if (e.parent) {
            _yuitest_coverline("build/tree/tree.js", 795);
this._removeNodeFromParent(node);
        } else {_yuitest_coverline("build/tree/tree.js", 796);
...
this.rootNode = this.createNode(this._rootNodeConfig);
    ...
    _defSelectFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defSelectFn", 802);
_yuitest_coverline("build/tree/tree.js", 803);
if (!this.get('multiSelect')) {
            _yuitest_coverline("build/tree/tree.js", 804);
this.unselect();
        }

        _yuitest_coverline("build/tree/tree.js", 807);
e.node.state.selected = true;
        _yuitest_coverline("build/tree/tree.js", 808);
this._selectedMap[e.node.id] = e.node;
    },

    _defUnselectFn: function (e) {
        _yuitest_coverfunc("build/tree/tree.js", "_defUnselectFn", 811);
_yuitest_coverline("build/tree/tree.js", 812);
delete e.node.state.selected;
        _yuitest_coverline("build/tree/tree.js", 813);
delete this._selectedMap[e.node.id];
    ...
    ATTRS: {
        ...
        **/
        rootNode: {
            getter: function () {
                _yuitest_coverfunc("build/tree/tree.js", "getter", 834);
_yuitest_coverline("build/tree/tree.js", 835);
