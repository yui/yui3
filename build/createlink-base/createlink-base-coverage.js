...
_yuitest_coverage["createlink-base"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('createlink-base', function (Y, NAME) {
    ...
    _yuitest_coverfunc("createlink-base", "(anonymous 1)", 1);
_yuitest_coverline("createlink-base", 12);
var CreateLinkBase = {};
    /**
    ...
    * @static
    */
    _yuitest_coverline("createlink-base", 18);
CreateLinkBase.STRINGS = {
    ...
    _yuitest_coverline("createlink-base", 33);
Y.namespace('Plugin');
    _yuitest_coverline("createlink-base", 34);
Y.Plugin.CreateLinkBase = CreateLinkBase;

    _yuitest_coverline("createlink-base", 36);
Y.mix(Y.Plugin.ExecCommand.COMMANDS, {
        ...
        */
        createlink: function(cmd) {
            _yuitest_coverfunc("createlink-base", "createlink", 45);
_yuitest_coverline("createlink-base", 46);
var inst = this.get('host').getInstance(), out, a, sel, holder,
            ...
            _yuitest_coverline("createlink-base", 49);
if (url) {
                _yuitest_coverline("createlink-base", 50);
holder = inst.config.doc.createElement('div');
                _yuitest_coverline("createlink-base", 51);
url = url.replace(/"/g, '').replace(/'/g, ''); //Remove single & double quotes
                _yuitest_coverline("createlink-base", 52);
url = inst.config.doc.createTextNode(url);
                _yuitest_coverline("createlink-base", 53);
holder.appendChild(url);
                _yuitest_coverline("createlink-base", 54);
url = holder.innerHTML;


                _yuitest_coverline("createlink-base", 57);
this.get('host')._execCommand(cmd, url);
                _yuitest_coverline("createlink-base", 58);
sel = new inst.EditorSelection();
                _yuitest_coverline("createlink-base", 59);
out = sel.getSelected();
                _yuitest_coverline("createlink-base", 60);
if (!sel.isCollapsed && out.size()) {
                    //We have a selection
                    _yuitest_coverline("createlink-base", 62);
a = out.item(0).one('a');
                    _yuitest_coverline("createlink-base", 63);
if (a) {
                        _yuitest_coverline("createlink-base", 64);
out.item(0).replace(a);
                    }
                    _yuitest_coverline("createlink-base", 66);
if (Y.UA.gecko) {
                        _yuitest_coverline("createlink-base", 67);
if (a.get('parentNode').test('span')) {
                            _yuitest_coverline("createlink-base", 68);
if (a.get('parentNode').one('br.yui-cursor')) {
                                _yuitest_coverline("createlink-base", 69);
a.get('parentNode').insert(a, 'before');
                    ...
                    _yuitest_coverline("createlink-base", 75);
this.get('host').execCommand('inserthtml', '<a href="' + url + '">' + url + '</a>');
                }
            }
            _yuitest_coverline("createlink-base", 78);
return a;
        }
    });
