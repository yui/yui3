...
_yuitest_coverage["/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 59);
var YArray   = Y.Array,
    Text     = Y.Text,
...
AccentFold = {
    ...
    canFold: function (string) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "canFold", 75);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 76);
var letter;

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 78);
for (letter in FoldData) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 79);
if (FoldData.hasOwnProperty(letter) &&
                    string.search(FoldData[letter]) !== -1) {
                _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 81);
return true;
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 85);
return false;
    },
    ...
    compare: function (a, b, func) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "compare", 102);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 103);
var aFolded = AccentFold.fold(a),
            bFolded = AccentFold.fold(b);

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 106);
return func ? !!func(aFolded, bFolded) : aFolded === bFolded;
    ...
    filter: function (haystack, func) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "filter", 128);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 129);
return YArray.filter(haystack, function (item) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "(anonymous 2)", 129);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 130);
return func(AccentFold.fold(item));
     ...
     */
    fold: function (input) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "fold", 144);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 145);
if (Y.Lang.isArray(input)) {
            _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 146);
return YArray.map(input, AccentFold.fold);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 149);
input = input.toLowerCase();

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 151);
Y.Object.each(FoldData, function (regex, letter) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", "(anonymous 3)", 151);
_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 152);
input = input.replace(regex, letter);
        });

        _yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 155);
return input;
    }
};

_yuitest_coverline("/home/yui/src/yui3/src/text/build_tmp/text-accentfold.js", 159);
