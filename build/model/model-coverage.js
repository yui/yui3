...
_yuitest_coverage["/build/model/model.js"].coveredLines = 157;
_yuitest_coverage["/build/model/model.js"].coveredFunctions = 29;
...
return Model.superclass.addAttr.apply(this, arguments);
    ...
    **/
    _validate: function (attributes, callback) {
        _yuitest_coverfunc("/build/model/model.js", "_validate", 872);
_yuitest_coverline("/build/model/model.js", 873);
var self = this;

        _yuitest_coverline("/build/model/model.js", 875);
function handler(err) {
            _yuitest_coverfunc("/build/model/model.js", "handler", 875);
_yuitest_coverline("/build/model/model.js", 876);
if (Lang.isValue(err)) {
                // Validation failed. Fire an error.
                _yuitest_coverline("/build/model/model.js", 878);
self.fire(EVT_ERROR, {
                ...
                _yuitest_coverline("/build/model/model.js", 884);
callback(err);
                _yuitest_coverline("/build/model/model.js", 885);
return;
            }

            _yuitest_coverline("/build/model/model.js", 888);
callback();
        }
...
self.validate(attributes, handler);
    ...
    **/
    _defAttrChangeFn: function (e) {
        _yuitest_coverfunc("/build/model/model.js", "_defAttrChangeFn", 910);
_yuitest_coverline("/build/model/model.js", 911);
var attrName = e.attrName;

        _yuitest_coverline("/build/model/model.js", 913);
if (!this._setAttrVal(attrName, e.subAttrName, e.prevVal, e.newVal)) {
            // Prevent "after" listeners from being invoked since nothing changed.
            _yuitest_coverline("/build/model/model.js", 915);
e.stopImmediatePropagation();
        } else {
            _yuitest_coverline("/build/model/model.js", 917);
e.newVal = this.get(attrName);

            _yuitest_coverline("/build/model/model.js", 919);
if (e._transaction) {
                _yuitest_coverline("/build/model/model.js", 920);
