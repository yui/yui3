...
_yuitest_coverage["/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
var Lang = Y.Lang,
	...
	isNode = function(v) {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "isNode", 9);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 10);
return (v instanceof Y.Node);
	},

	toNumber = function(num) {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "toNumber", 13);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 14);
...
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 56);
function ResizeConstrained() {
	_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "ResizeConstrained", 56);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 57);
ResizeConstrained.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 60);
Y.mix(ResizeConstrained, {
	...
	ATTRS: {
        ...
        */
		constrain: {
			setter: function(v) {
				_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "setter", 76);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 77);
if (v && (isNode(v) || isString(v) || v.nodeType)) {
					_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 78);
v = Y.one(v);
				}

				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 81);
return v;
			}
		},
...
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 169);
Y.extend(ResizeConstrained, Y.Plugin.Base, {
	...
	initializer: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "initializer", 181);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 182);
var instance = this,
			host = instance.get(HOST);

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 185);
host.delegate.dd.plug(
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 193);
host.after('resize:align', Y.bind(instance._handleResizeAlignEvent, instance));
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 194);
host.on('resize:start', Y.bind(instance._handleResizeStartEvent, instance));
	...
	_checkConstrain: function(axis, axisConstrain, offset) {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_checkConstrain", 208);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 209);
var instance = this,
			point1,
			point1Constrain,
			point2,
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 219);
if (region) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 220);
point1 = info[axis] + info[offset];
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 221);
point1Constrain = region[axisConstrain] - toNumber(constrainBorders[capitalize(BORDER, axisConstrain, WIDTH)]);

			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 223);
if (point1 >= point1Constrain) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 224);
info[offset] -= (point1 - point1Constrain);
			}

			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 227);
point2 = info[axis];
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 228);
point2Constrain = region[axis] + toNumber(constrainBorders[capitalize(BORDER, axis, WIDTH)]);

			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 230);
if (point2 <= point2Constrain) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 231);
info[axis] += (point2Constrain - point2);
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 232);
info[offset] -= (point2Constrain - point2);
	...
	_checkHeight: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_checkHeight", 244);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 245);
var instance = this,
			host = instance.get(HOST),
			info = host.info,
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 251);
instance._checkConstrain(TOP, BOTTOM, OFFSET_HEIGHT);

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 253);
if (info.offsetHeight > maxHeight) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 254);
host._checkSize(OFFSET_HEIGHT, maxHeight);
		}

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 257);
if (info.offsetHeight < minHeight) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 258);
host._checkSize(OFFSET_HEIGHT, minHeight);
	...
	_checkRatio: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_checkRatio", 269);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 270);
var instance = this,
			host = instance.get(HOST),
			info = host.info,
			...
			wRatio = function() {
				_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "wRatio", 282);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 283);
return (info.offsetWidth/oWidth);
			},
			hRatio = function() {
				_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "hRatio", 285);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 286);
return (info.offsetHeight/oHeight);
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 297);
if (instance.get(CONSTRAIN) && host.changeHeightHandles && host.changeWidthHandles) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 298);
constrainRegion = instance._getConstrainRegion();
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 299);
constrainBorders = instance.constrainSurrounding.border;
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 300);
bottomDiff = (constrainRegion.bottom - toNumber(constrainBorders[BORDER_BOTTOM_WIDTH])) - oBottom;
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 301);
leftDiff = oLeft - (constrainRegion.left + toNumber(constrainBorders[BORDER_LEFT_WIDTH]));
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 302);
rightDiff = (constrainRegion.right - toNumber(constrainBorders[BORDER_RIGHT_WIDTH])) - oRight;
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 303);
topDiff = oTop - (constrainRegion.top + toNumber(constrainBorders[BORDER_TOP_WIDTH]));

			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 305);
if (host.changeLeftHandles && host.changeTopHandles) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 306);
isClosestToHeight = (topDiff < leftDiff);
			}
			else {_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 308);
if (host.changeLeftHandles) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 309);
isClosestToHeight = (bottomDiff < leftDiff);
			}
			else {_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 311);
if (host.changeTopHandles) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 312);
isClosestToHeight = (topDiff < rightDiff);
			}
			else {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 315);
isClosestToHeight = (bottomDiff < rightDiff);
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 321);
if (isClosestToHeight) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 322);
info.offsetWidth = oWidth*hRatio();
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 323);
instance._checkWidth();
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 324);
info.offsetHeight = oHeight*wRatio();
		}
		else {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 327);
info.offsetHeight = oHeight*wRatio();
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 328);
instance._checkHeight();
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 329);
info.offsetWidth = oWidth*hRatio();
		}
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 334);
if (host.changeTopHandles) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 335);
info.top = oTop + (oHeight - info.offsetHeight);
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 340);
if (host.changeLeftHandles) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 341);
info.left = oLeft + (oWidth - info.offsetWidth);
		}

		// rounding values to avoid pixel jumpings
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 345);
Y.each(info, function(value, key) {
			_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "(anonymous 2)", 345);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 346);
if (isNumber(value)) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 347);
info[key] = Math.round(value);
	...
	_checkRegion: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_checkRegion", 359);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 360);
var instance = this,
			host = instance.get(HOST),
			region = instance._getConstrainRegion();

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 364);
return Y.DOM.inRegion(null, region, true, host.info);
	...
	_checkWidth: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_checkWidth", 374);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 375);
var instance = this,
			host = instance.get(HOST),
			info = host.info,
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 381);
instance._checkConstrain(LEFT, RIGHT, OFFSET_WIDTH);

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 383);
if (info.offsetWidth < minWidth) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 384);
host._checkSize(OFFSET_WIDTH, minWidth);
		}

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 387);
if (info.offsetWidth > maxWidth) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 388);
host._checkSize(OFFSET_WIDTH, maxWidth);
	...
	_getConstrainRegion: function() {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_getConstrainRegion", 400);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 401);
var instance = this,
			host = instance.get(HOST),
			node = host.get(NODE),
		...
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 407);
if (constrain) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 408);
if (constrain == VIEW) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 409);
region = node.get(VIEWPORT_REGION);
			}
			else {_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 411);
if (isNode(constrain)) {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 412);
region = constrain.get(REGION);
			}
			else {
				_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 415);
region = constrain;
			}}
		}

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 419);
return region;
	},

	_handleResizeAlignEvent: function(event) {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_handleResizeAlignEvent", 422);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 423);
var instance = this,
			host = instance.get(HOST);

		// check the max/min height and locking top when these values are reach
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 427);
instance._checkHeight();

		// check the max/min width and locking left when these values are reach
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 430);
instance._checkWidth();

		// calculating the ratio, for proportionally resizing
		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 433);
if (instance.get(PRESEVE_RATIO)) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 434);
instance._checkRatio();
		}

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 437);
if (instance.get(CONSTRAIN) && !instance._checkRegion()) {
			_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 438);
host.info = host.lastInfo;
		}
	},

	_handleResizeStartEvent: function(event) {
		_yuitest_coverfunc("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", "_handleResizeStartEvent", 442);
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 443);
var instance = this,
			constrain = instance.get(CONSTRAIN),
			host = instance.get(HOST);

		_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 447);
instance.constrainSurrounding = host._getBoxSurroundingInfo(constrain);
	}
});

_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 451);
Y.namespace('Plugin');
_yuitest_coverline("/home/yui/src/yui3/src/resize/build_tmp/resize-constrain.js", 452);
