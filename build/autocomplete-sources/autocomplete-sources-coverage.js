...
_yuitest_coverage["/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 10);
...
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 20);
Y.mix(ACBase.prototype, {
    ...
    **/
    _beforeCreateObjectSource: function (source) {
        ...
        // source.
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_beforeCreateObjectSource", 40);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 43);
if (source instanceof Y.Node &&
                source.get('nodeName').toLowerCase() === 'select') {

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 46);
return this._createSelectSource(source);
        }

        // If the object is a JSONPRequest instance, try to use it as a JSONP
        // source.
        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 51);
if (Y.JSONPRequest && source instanceof Y.JSONPRequest) {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 52);
return this._createJSONPSource(source);
        }

        // Fall back to a basic object source.
        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 56);
return this._createObjectSource(source);
    ...
    **/
    _createIOSource: function (source) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_createIOSource", 69);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 70);
var ioSource = {type: 'io'},
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 76);
function _sendRequest(request) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_sendRequest", 76);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 77);
var cacheKey = request.request;

            // Return immediately on a cached response.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 80);
if (that._cache && cacheKey in that._cache) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 81);
that[_SOURCE_SUCCESS](that._cache[cacheKey], request);
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 82);
return;
            }

            // Cancel any outstanding requests.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 86);
if (ioRequest && ioRequest.isInProgress()) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 87);
ioRequest.abort();
            }

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 90);
ioRequest = Y.io(that._getXHRUrl(source, request), {
                on: {
                    success: function (tid, response) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "success", 92);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 93);
var data;

                        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 95);
try {
                            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 96);
data = Y.JSON.parse(response.responseText);
                        } catch (ex) {
                            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 98);
Y.error('JSON parse error', ex);
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 101);
if (data) {
                            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 102);
that._cache && (that._cache[cacheKey] = data);
                            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 103);
that[_SOURCE_SUCCESS](data, request);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 110);
ioSource.sendRequest = function (request) {
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "sendRequest", 110);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 114);
lastRequest = request;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 116);
if (loading) { return; }

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 118);
loading = true;

            // Lazy-load the io-base and json-parse modules if necessary,
            // then overwrite the sendRequest method to bypass this check in
            // the future.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 123);
Y.use('io-base', 'json-parse', function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "(anonymous 2)", 123);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 124);
ioSource.sendRequest = _sendRequest;
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 125);
_sendRequest(lastRequest);
            });
        };

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 129);
return ioSource;
    },
    ...
    **/
    _createJSONPSource: function (source) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_createJSONPSource", 142);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 143);
var jsonpSource = {type: 'jsonp'},
            that        = this,
            lastRequest, loading;

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 147);
function _sendRequest(request) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_sendRequest", 147);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 148);
var cacheKey = request.request,
                query    = request.query;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 151);
if (that._cache && cacheKey in that._cache) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 152);
that[_SOURCE_SUCCESS](that._cache[cacheKey], request);
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 153);
return;
            }
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 164);
source._config.on.success = function (data) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "success", 164);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 165);
that._cache && (that._cache[cacheKey] = data);
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 166);
that[_SOURCE_SUCCESS](data, request);
            };

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 169);
source.send(query);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 172);
jsonpSource.sendRequest = function (request) {
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "sendRequest", 172);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 176);
lastRequest = request;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 178);
if (loading) { return; }

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 180);
loading = true;

            // Lazy-load the JSONP module if necessary, then overwrite the
            // sendRequest method to bypass this check in the future.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 184);
Y.use('jsonp', function () {
                // Turn the source into a JSONPRequest instance if it isn't
                // one already.
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "(anonymous 3)", 184);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 187);
if (!(source instanceof Y.JSONPRequest)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 188);
source = new Y.JSONPRequest(source, {
                        format: Y.bind(that._jsonpFormatter, that)
                    });
                }

                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 193);
jsonpSource.sendRequest = _sendRequest;
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 194);
_sendRequest(lastRequest);
            });
        };

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 198);
return jsonpSource;
    },
    ...
    **/
    _createSelectSource: function (source) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_createSelectSource", 211);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 212);
var that = this;

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 214);
return {
            type: 'select',
            sendRequest: function (request) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "sendRequest", 216);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 217);
var options = [];

                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 219);
source.get('options').each(function (option) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "(anonymous 4)", 219);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 220);
options.push({
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 230);
that[_SOURCE_SUCCESS](options, request);
    ...
    **/
    _createStringSource: function (source) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_createStringSource", 249);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 250);
if (this._YQL_SOURCE_REGEX.test(source)) {
            // Looks like a YQL query.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 252);
return this._createYQLSource(source);
        } else {_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 253);
if (source.indexOf('{callback}') !== -1) {
            // Contains a {callback} param and isn't a YQL query, so it must be
            // JSONP.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 256);
return this._createJSONPSource(source);
        } else {
            // Not a YQL query or JSONP, so we'll assume it's an XHR URL.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 259);
return this._createIOSource(source);
    ...
    **/
    _createYQLSource: function (source) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_createYQLSource", 275);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 276);
var that      = this,
            yqlSource = {type: 'yql'},
            lastRequest, loading, yqlRequest;

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 280);
if (!that.get(RESULT_LIST_LOCATOR)) {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 281);
that.set(RESULT_LIST_LOCATOR, that._defaultYQLLocator);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 284);
function _sendRequest(request) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_sendRequest", 284);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 285);
var query      = request.query,
                env        = that.get('yqlEnv'),
                maxResults = that.get(MAX_RESULTS),
                callback, opts, yqlQuery;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 290);
yqlQuery = Lang.sub(source, {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 296);
if (that._cache && yqlQuery in that._cache) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 297);
that[_SOURCE_SUCCESS](that._cache[yqlQuery], request);
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 298);
return;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 301);
callback = function (data) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "callback", 301);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 302);
that._cache && (that._cache[yqlQuery] = data);
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 303);
that[_SOURCE_SUCCESS](data, request);
            };

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 306);
opts = {proto: that.get('yqlProtocol')};
            ...
            // original instance.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 311);
if (yqlRequest) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 312);
yqlRequest._callback   = callback;
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 313);
yqlRequest._opts       = opts;
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 314);
yqlRequest._params.q   = yqlQuery;

                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 316);
if (env) {
                    _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 317);
yqlRequest._params.env = env;
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 320);
yqlRequest = new Y.YQLRequest(yqlQuery, {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 326);
yqlRequest.send();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 329);
yqlSource.sendRequest = function (request) {
            // Keep track of the most recent request in case there are multiple
            // requests while we're waiting for the YQL module to load. Only the
            // most recent request will be sent.
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "sendRequest", 329);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 333);
lastRequest = request;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 335);
if (!loading) {
                // Lazy-load the YQL module if necessary, then overwrite the
                // sendRequest method to bypass this check in the future.
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 338);
loading = true;

                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 340);
Y.use('yql', function () {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "(anonymous 5)", 340);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 341);
yqlSource.sendRequest = _sendRequest;
                    _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 342);
_sendRequest(lastRequest);
                });
            }
        };

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 347);
return yqlSource;
    },
    ...
    **/
    _defaultYQLLocator: function (response) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_defaultYQLLocator", 360);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 361);
var results = response && response.query && response.query.results,
            values;

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 364);
if (results && Lang.isObject(results)) {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 369);
values  = Y.Object.values(results) || [];
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 370);
results = values.length === 1 ? values[0] : values;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 372);
if (!Lang.isArray(results)) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 373);
results = [results];
            }
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 376);
results = [];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 379);
return results;
    },
    ...
    **/
    _getXHRUrl: function (url, request) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_getXHRUrl", 394);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 395);
var maxResults = this.get(MAX_RESULTS);

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 397);
if (request.query !== request.request) {
            // Append the request template to the URL.
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 399);
url += request.request;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 402);
return Lang.sub(url, {
            maxResults: maxResults > 0 ? maxResults : 1000,
    ...
    **/
    _jsonpFormatter: function (url, proxy, query) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", "_jsonpFormatter", 419);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 420);
var maxResults      = this.get(MAX_RESULTS),
            requestTemplate = this.get(REQUEST_TEMPLATE);

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 423);
if (requestTemplate) {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 424);
url += requestTemplate(query);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 427);
return Lang.sub(url, {
            callback  : proxy,
            maxResults: maxResults > 0 ? maxResults : 1000,
...
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 436);
Y.mix(ACBase.ATTRS, {
    /**
...
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-sources.js", 465);
