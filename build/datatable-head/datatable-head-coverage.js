...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 11);
var Lang = Y.Lang,
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 81);
Y.namespace('DataTable').HeaderView = Y.Base.create('tableHeader', Y.View, [], {
    ...
    **/
    getClassName: function () {
        ...
        // for performance
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "getClassName", 160);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 163);
var host = this.host,
            NAME = (host && host.constructor.NAME) ||
                    this.constructor.NAME;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 167);
if (host && host.getClassName) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 168);
return host.getClassName.apply(host, arguments);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 170);
return Y.ClassNameManager.getClassName
    ...
    **/
    render: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "render", 186);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 187);
var table    = this.get('container'),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 198);
if (thead && columns) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 199);
html = '';

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 201);
if (columns.length) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 202);
for (i = 0, len = columns.length; i < len; ++i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 203);
content = '';

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 205);
for (j = 0, jlen = columns[i].length; j < jlen; ++j) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 206);
col = columns[i][j];
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 207);
values = Y.merge(
                            defaults,
                            col, {
                        ...
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 216);
values._id = col._id ?
                            ' data-yui3-col-id="' + col._id + '"' : '';
                        
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 219);
if (col.abbr) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 220);
values.abbr = ' abbr="' + col.abbr + '"';
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 223);
if (col.className) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 224);
values.className += ' ' + col.className;
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 227);
if (col._first) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 228);
values.className += ' ' + this.getClassName('first', 'header');
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 231);
if (col._id) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 232);
values.className +=
                                ' ' + this.getClassName('col', col._id);
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 236);
content += fromTemplate(
                            col.headerTemplate || this.CELL_TEMPLATE, values);
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 240);
html += fromTemplate(this.ROW_TEMPLATE, {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 246);
thead.setHTML(html);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 248);
if (thead.get('parentNode') !== table) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 249);
table.insertBefore(thead, table.one('tfoot, tbody'));
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 253);
this.bindUI();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 255);
return this;
    },
    ...
    **/
    _afterColumnsChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "_afterColumnsChange", 268);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 269);
this.columns = this._parseColumns(e.newVal);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 271);
this.render();
    },
    ...
    **/
    bindUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "bindUI", 281);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 282);
if (!this._eventHandles.columnsChange) {
            // TODO: How best to decouple this?
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 284);
this._eventHandles.columnsChange =
    ...
    **/
    _createTHeadNode: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "_createTHeadNode", 298);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 299);
return Y.Node.create(fromTemplate(this.THEAD_TEMPLATE, {
    ...
    **/
    destructor: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "destructor", 311);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 312);
(new Y.EventHandle(Y.Object.values(this._eventHandles))).detach();
    ...
    **/
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "initializer", 338);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 339);
this.host  = config.host;
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 340);
this.columns = this._parseColumns(config.columns);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 342);
this._eventHandles = [];
    },
    ...
    **/
    _parseColumns: function (data) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", "_parseColumns", 407);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 408);
var columns = [],
            stack = [],
            rowSpan = 1,
            entry, row, col, children, parent, i, len, j;
        
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 413);
if (isArray(data) && data.length) {
            // don't modify the input array
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 415);
data = data.slice();

            // First pass, assign colspans and calculate row count for
            // non-nested headers' rowspan
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 419);
stack.push([data, -1]);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 421);
while (stack.length) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 422);
entry = stack[stack.length - 1];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 423);
row   = entry[0];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 424);
i     = entry[1] + 1;

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 426);
for (len = row.length; i < len; ++i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 427);
row[i] = col = Y.merge(row[i]);
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 428);
children = col.children;

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 430);
Y.stamp(col);

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 432);
if (!col.id) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 433);
col.id = Y.guid();
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 436);
if (isArray(children) && children.length) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 437);
stack.push([children, -1]);
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 438);
entry[1] = i;

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 440);
rowSpan = Math.max(rowSpan, stack.length);

                        // break to let the while loop process the children
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 443);
break;
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 445);
col._colspan = 1;
                    }
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 449);
if (i >= len) {
                    // All columns in this row are processed
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 451);
if (stack.length > 1) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 452);
entry  = stack[stack.length - 2];
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 453);
parent = entry[0][entry[1]];

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 455);
parent._colspan = 0;

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 457);
for (i = 0, len = row.length; i < len; ++i) {
                            // Can't use .length because in 3+ rows, colspan
                            // needs to aggregate the colspans of children
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 460);
row[i]._parent   = parent;
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 461);
parent._colspan += row[i]._colspan;
                        }
                    }
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 464);
stack.pop();
                }
            }

            // Second pass, build row arrays and assign rowspan
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 469);
for (i = 0; i < rowSpan; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 470);
columns.push([]);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 473);
stack.push([data, -1]);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 475);
while (stack.length) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 476);
entry = stack[stack.length - 1];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 477);
row   = entry[0];
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 478);
i     = entry[1] + 1;

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 480);
for (len = row.length; i < len; ++i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 481);
col = row[i];
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 482);
children = col.children;

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 484);
columns[stack.length - 1].push(col);

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 486);
entry[1] = i;

                    // collect the IDs of parent cols
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 489);
col._headers = [col.id];

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 491);
for (j = stack.length - 2; j >= 0; --j) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 492);
parent = stack[j][0][stack[j][1]];

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 494);
col._headers.unshift(parent.id);
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 497);
if (children && children.length) {
                        // parent cells must assume rowspan 1 (long story)

                        // break to let the while loop process the children
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 501);
stack.push([children, -1]);
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 502);
break;
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 504);
col._rowspan = rowSpan - stack.length + 1;
                    }
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 508);
if (i >= len) {
                    // All columns in this row are processed
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 510);
stack.pop();
                }
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 515);
for (i = 0, len = columns.length; i < len; i += col._rowspan) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 516);
col = columns[i][0];

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 518);
col._first = true;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-head.js", 521);
return columns;
    }
});
