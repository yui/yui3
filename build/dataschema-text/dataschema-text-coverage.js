...
_yuitest_coverage["/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 22);
var Lang = Y.Lang,
    ...
    SchemaText = {
        ...
        **/
        apply: function(schema, data) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", "apply", 105);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 106);
var data_in = data,
                data_out = { results: [], meta: {} };

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 109);
if (isString(data) && schema && isString(schema.resultDelimiter)) {
                // Parse results data
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 111);
data_out = SchemaText._parseResults.call(this, schema, data_in, data_out);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 113);
data_out.error = new Error("Text schema parse failure");
            }

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 116);
return data_out;
        },
        ...
        _parseResults: function(schema, text_in, data_out) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", "_parseResults", 130);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 131);
var resultDelim = schema.resultDelimiter,
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 141);
if (text_in.slice(-resultDelim.length) === resultDelim) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 142);
text_in = text_in.slice(0, -resultDelim.length);
            }

            // Split into results
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 146);
results_in = text_in.split(schema.resultDelimiter);

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 148);
if (fieldDelim) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 149);
for (i = results_in.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 150);
result = {};
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 151);
item = results_in[i];

                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 153);
fields_in = item.split(schema.fieldDelimiter);

                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 155);
for (j = fields.length - 1; j >= 0; --j) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 156);
field = fields[j];
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 157);
key = (!isUndef(field.key)) ? field.key : field;
                        // FIXME: unless the key is an array index, this test
                        // for fields_in[key] is useless.
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 160);
value = (!isUndef(fields_in[key])) ?
                                    fields_in[key] :
                                    fields_in[j];

                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 164);
result[key] = parse.call(this, value, field);
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 167);
results[i] = result;
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 170);
results = results_in;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 173);
data_out.results = results;

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 175);
return data_out;
        }
    };

_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-text.js", 179);
