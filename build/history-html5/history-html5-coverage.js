...
_yuitest_coverage["/home/yui/src/yui3/src/history/build_tmp/history-html5.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 49);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 57);
function HistoryHTML5() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", "HistoryHTML5", 57);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 58);
HistoryHTML5.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 61);
Y.extend(HistoryHTML5, HistoryBase, {
    // -- Initialization -------------------------------------------------------
    _init: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", "_init", 63);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 64);
var bookmarkedState = win.history.state;

        // Treat empty state objects as `null` so they're not processed further.
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 67);
if (Y.Object.isEmpty(bookmarkedState)) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 68);
bookmarkedState = null;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 71);
config || (config = {});

        // If both the initial state and the bookmarked state are objects, merge
        // them (bookmarked state wins).
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 75);
if (config.initialState
                && Lang.type(config.initialState) === 'object'
                && Lang.type(bookmarkedState) === 'object') {

            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 79);
this._initialState = Y.merge(config.initialState, bookmarkedState);
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 84);
this._initialState = bookmarkedState;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 87);
Y.on('popstate', this._onPopState, win, this);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 89);
HistoryHTML5.superclass._init.apply(this, arguments);
    ...
    _storeState: function (src, newState, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", "_storeState", 104);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 105);
if (src !== SRC_POPSTATE) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 106);
win.history[src === SRC_REPLACE ? 'replaceState' : 'pushState'](
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 113);
HistoryHTML5.superclass._storeState.apply(this, arguments);
    ...
    _onPopState: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", "_onPopState", 125);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 126);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 144);
if (!Y.Node.DOM_EVENTS.popstate) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 145);
Y.Node.DOM_EVENTS.popstate = 1;
}

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 148);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 177);
if (useHistoryHTML5 === true || (useHistoryHTML5 !== false &&
        HistoryBase.html5)) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-html5.js", 179);
