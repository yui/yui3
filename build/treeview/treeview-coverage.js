...
_yuitest_coverage["build/treeview/treeview.js"].lines = {"1":0,"19":0,"83":0,"87":0,"102":0,"103":0,"106":0,"119":0,"121":0,"124":0,"125":0,"127":0,"130":0,"134":0,"135":0,"138":0,"140":0,"158":0,"160":0,"163":0,"164":0,"171":0,"172":0,"173":0,"175":0,"178":0,"179":0,"182":0,"183":0,"189":0,"190":0,"193":0,"211":0,"213":0,"217":0,"218":0,"225":0,"229":0,"231":0,"232":0,"233":0,"236":0,"237":0,"239":0,"240":0,"241":0,"243":0,"244":0,"249":0,"250":0,"253":0,"259":0,"261":0,"264":0,"286":0,"293":0,"294":0,"297":0,"301":0,"302":0,"304":0,"305":0,"307":0,"310":0,"312":0,"316":0,"320":0,"327":0,"328":0,"331":0,"332":0,"334":0,"335":0,"339":0,"341":0,"342":0,"346":0,"348":0,"349":0,"353":0,"355":0,"356":0,"357":0,"362":0,"364":0,"366":0,"369":0,"371":0,"376":0,"380":0,"381":0,"382":0,"386":0,"387":0,"392":0,"394":0,"396":0,"397":0,"400":0,"404":0,"408":0,"410":0,"416":0,"420":0,"422":0,"423":0,"425":0,"430":0,"434":0};
_yuitest_coverage["build/treeview/treeview.js"].functions = {"initializer:82":0,"destructor:86":0,"getHTMLNode:101":0,"render:118":0,"renderChildren:157":0,"renderNode:210":0,"_attachTreeViewEvents:258":0,"_detachTreeViewEvents:285":0,"_afterAdd:291":0,"_afterClear:325":0,"_afterClose:338":0,"_afterOpen:345":0,"_afterRemove:352":0,"_afterSelect:361":0,"_afterTreeViewMultiSelectChange:375":0,"_afterUnselect:391":0,"_onIndicatorClick:403":0,"_onMouseDown:413":0,"_onRowClick:419":0,"_onRowDoubleClick:429":0,"(anonymous 1):1":0};
_yuitest_coverage["build/treeview/treeview.js"].coveredLines = 109;
...
if (!htmlNode) {
            _yuitest_coverline("build/treeview/treeview.js", 218);
htmlNode = treeNode._htmlNode = Y.Node.create(TreeView.Templates.node({
        ...
        _yuitest_coverline("build/treeview/treeview.js", 225);
...
if (!labelId) {
            _yuitest_coverline("build/treeview/treeview.js", 232);
labelId = Y.guid();
            _yuitest_coverline("build/treeview/treeview.js", 233);
labelNode.set('id', labelId);
        }

        _yuitest_coverline("build/treeview/treeview.js", 236);
...
htmlNode.toggleClass(classNames.hasChildren, hasChildren);
        ...
        _yuitest_coverline("build/treeview/treeview.js", 243);
...
return htmlNode;
    ...
    _attachTreeViewEvents: function () {
        _yuitest_coverfunc("build/treeview/treeview.js", "_attachTreeViewEvents", 258);
_yuitest_coverline("build/treeview/treeview.js", 259);
...
this._treeViewEvents.push(
    ...
    _detachTreeViewEvents: function () {
        _yuitest_coverfunc("build/treeview/treeview.js", "_detachTreeViewEvents", 285);
_yuitest_coverline("build/treeview/treeview.js", 286);
(new Y.EventHandle(this._treeViewEvents)).detach();
    ...
    _afterAdd: function (e) {
        ...
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterAdd", 291);
_yuitest_coverline("build/treeview/treeview.js", 293);
if (!this.rendered) {
            _yuitest_coverline("build/treeview/treeview.js", 294);
return;
        }
...
if (parent === this.rootNode) {
            _yuitest_coverline("build/treeview/treeview.js", 302);
...
htmlNode = this.renderNode(parent);
                ...
                _yuitest_coverline("build/treeview/treeview.js", 312);
...
return;
        ...
        _yuitest_coverline("build/treeview/treeview.js", 320);
htmlChildrenNode.insert(this.renderNode(e.node, {
    ...
    _afterClear: function () {
        // Nothing to do if the treeview hasn't been rendered yet.
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterClear", 325);
...
this.render();
    ...
    _afterClose: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterClose", 338);
_yuitest_coverline("build/treeview/treeview.js", 339);
var htmlNode = this.getHTMLNode(e.node);

        _yuitest_coverline("build/treeview/treeview.js", 341);
...
htmlNode.set('aria-expanded', false);
    ...
    _afterOpen: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterOpen", 345);
_yuitest_coverline("build/treeview/treeview.js", 346);
var htmlNode = this.getHTMLNode(e.node);

        _yuitest_coverline("build/treeview/treeview.js", 348);
...
htmlNode.set('aria-expanded', true);
    ...
    _afterRemove: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterRemove", 352);
_yuitest_coverline("build/treeview/treeview.js", 353);
var htmlNode = this.getHTMLNode(e.node);
...
delete e.node._htmlNode;
    ...
    _afterSelect: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterSelect", 361);
_yuitest_coverline("build/treeview/treeview.js", 362);
var htmlNode = this.getHTMLNode(e.node);

        _yuitest_coverline("build/treeview/treeview.js", 364);
htmlNode.addClass(this.classNames.selected);

        _yuitest_coverline("build/treeview/treeview.js", 366);
if (this.multiSelect) {
...
htmlNode.set('aria-selected', true);
            ...
            _yuitest_coverline("build/treeview/treeview.js", 371);
htmlNode.set('tabIndex', 0).focus();
        }
    },

    _afterTreeViewMultiSelectChange: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterTreeViewMultiSelectChange", 375);
_yuitest_coverline("build/treeview/treeview.js", 376);
var container = this.get('container'),
            rootList  = container.one('> .' + this.classNames.children),
            htmlNodes = container.all('.' + this.classNames.node);

        _yuitest_coverline("build/treeview/treeview.js", 380);
if (e.newVal) {
            _yuitest_coverline("build/treeview/treeview.js", 381);
...
htmlNodes.set('aria-selected', false);
            ...
            _yuitest_coverline("build/treeview/treeview.js", 386);
rootList.removeAttribute('aria-multiselectable');
            _yuitest_coverline("build/treeview/treeview.js", 387);
htmlNodes.removeAttribute('aria-selected');
        }
    },

    _afterUnselect: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_afterUnselect", 391);
_yuitest_coverline("build/treeview/treeview.js", 392);
var htmlNode = this.getHTMLNode(e.node);

        _yuitest_coverline("build/treeview/treeview.js", 394);
htmlNode.removeClass(this.classNames.selected);

        _yuitest_coverline("build/treeview/treeview.js", 396);
if (this.multiSelect) {
...
htmlNode.removeAttribute('tabIndex');
    ...
    _onIndicatorClick: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_onIndicatorClick", 403);
_yuitest_coverline("build/treeview/treeview.js", 404);
var rowNode = e.currentTarget.ancestor('.' + this.classNames.row);
        ...
        _yuitest_coverline("build/treeview/treeview.js", 408);
...
this.getNodeById(rowNode.getData('node-id')).toggle();
    ...
    _onMouseDown: function (e) {
        ...
        // is set on a node.
        _yuitest_coverfunc("build/treeview/treeview.js", "_onMouseDown", 413);
_yuitest_coverline("build/treeview/treeview.js", 416);
e.preventDefault();
    },

    _onRowClick: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_onRowClick", 419);
_yuitest_coverline("build/treeview/treeview.js", 420);
var node = this.getNodeById(e.currentTarget.getData('node-id'));

        _yuitest_coverline("build/treeview/treeview.js", 422);
if (this.multiSelect) {
...
node.select();
    ...
    _onRowDoubleClick: function (e) {
        _yuitest_coverfunc("build/treeview/treeview.js", "_onRowDoubleClick", 429);
_yuitest_coverline("build/treeview/treeview.js", 430);
