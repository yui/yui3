...
subscriber[_MOVE_HANDLE] = moveHandle;
        ...
        _yuitest_coverline("build/event-move/event-move.js", 353);
_setTouchActions(node, subscriber);
    },

    delegate : function(node, subscriber, ce, filter) {

        _yuitest_coverfunc("build/event-move/event-move.js", "delegate", 356);
...
subscriber[_DEL_MOVE_HANDLE] = node.delegate(EVENT[MOVE],
            function(e) {
                _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 5)", 361);
...
se._onMove(e, node, subscriber, ce, true);
    ...
    detach : function (node, subscriber, ce) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detach", 367);
...
_unsetTouchActions(node);
    ...
    detachDelegate : function(node, subscriber, ce, filter) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detachDelegate", 378);
...
_unsetTouchActions(node);
    ...
    processArgs : function(args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "processArgs", 390);
...
return _defArgsProcessor(this, args, delegate);
    ...
    _onMove : function(e, node, subscriber, ce, delegate) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_onMove", 394);
...
define(GESTURE_MOVE_END, {
    ...
    on : function (node, subscriber, ce) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "on", 464);
_yuitest_coverline("build/event-move/event-move.js", 466);
var root = _getRoot(node, subscriber),
        ...
        _yuitest_coverline("build/event-move/event-move.js", 475);
...
_setTouchActions(node, subscriber, EVENT[END]);
    ...
    delegate : function(node, subscriber, ce, filter) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "delegate", 481);
...
subscriber[_DEL_MOVE_END_HANDLE] = node.delegate(EVENT[END],
            function(e) {
                _yuitest_coverfunc("build/event-move/event-move.js", "(anonymous 6)", 486);
...
se._onEnd(e, node, subscriber, ce, true);
    ...
    detachDelegate : function(node, subscriber, ce, filter) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detachDelegate", 492);
...
_unsetTouchActions(node);
    ...
    detach : function (node, subscriber, ce) {
        _yuitest_coverfunc("build/event-move/event-move.js", "detach", 504);
...
_unsetTouchActions(node);
    ...
    processArgs : function(args, delegate) {
        _yuitest_coverfunc("build/event-move/event-move.js", "processArgs", 515);
...
return _defArgsProcessor(this, args, delegate);
    ...
    _onEnd : function(e, node, subscriber, ce, delegate) {
        ...
        _yuitest_coverfunc("build/event-move/event-move.js", "_onEnd", 519);
