...
_yuitest_coverage["/build/model-sync-rest/model-sync-rest.js"].functions = {"RESTSync:48":0,"initializer:296":0,"getURL:332":0,"serialize:389":0,"sync:426":0,"_joinURL:495":0,"_sendSyncIORequest:532":0,"(anonymous 2):582":0,"_substituteURL:573":0,"_onSyncIOFailure:627":0,"_onSyncIOSuccess:654":0,"(anonymous 1):1":0};
_yuitest_coverage["/build/model-sync-rest/model-sync-rest.js"].coveredLines = 58;
_yuitest_coverage["/build/model-sync-rest/model-sync-rest.js"].coveredFunctions = 12;
...
return this._substituteURL(url, Y.merge(this.getAttrs(), options));
    ...
    **/
    serialize: function (action) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "serialize", 389);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 390);
return Y.JSON.stringify(this);
    ...
    **/
    sync: function (action, options, callback) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "sync", 426);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 427);
options || (options = {});

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 429);
var url       = this.getURL(action, options),
        ...
        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 437);
if (method === 'POST' || method === 'PUT') {
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 438);
entity = this.serialize(action);
        } else {
            // Remove header, no content is being sent.
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 441);
delete headers['Content-Type'];
        }

        // Setup HTTP emulation for older servers if we need it.
        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 445);
...
headers['X-HTTP-Method-Override'] = method;
            ...
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 452);
method = 'POST';
        }

        // Add CSRF token to HTTP request headers if one is specified and the
        // request will cause side effects on the server.
        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 457);
if (csrfToken &&
...
this._sendSyncIORequest({
    ...
    **/
    _joinURL: function (url) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "_joinURL", 495);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 496);
var root = this.root;

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 498);
if (!(root || url)) {
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 499);
return '';
        }

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 502);
if (url.charAt(0) === '/') {
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 503);
url = url.substring(1);
        }

        // Combines the `root` with the `url` and adds a trailing-slash if the
        // `root` has a trailing-slash.
        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 508);
return root && root.charAt(root.length - 1) === '/' ?
    ...
    **/
    _sendSyncIORequest: function (config) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "_sendSyncIORequest", 532);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 533);
return Y.io(config.url, {
    ...
    **/
    _substituteURL: function (url, data) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "_substituteURL", 573);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 574);
if (!url) {
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 575);
return '';
        }

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 578);
var values = {};
...
Y.Object.each(data, function (v, k) {
            _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "(anonymous 2)", 582);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 583);
if (Lang.isString(v) || Lang.isNumber(v)) {
                // URL-encode any string or number values.
                _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 585);
values[k] = encodeURIComponent(v);
            }
        });

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 589);
return Lang.sub(url, values);
    ...
    **/
    _onSyncIOFailure: function (txId, res, details) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "_onSyncIOFailure", 627);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 628);
var callback = details.callback;

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 630);
...
callback({
    ...
    **/
    _onSyncIOSuccess: function (txId, res, details) {
        _yuitest_coverfunc("/build/model-sync-rest/model-sync-rest.js", "_onSyncIOSuccess", 654);
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 655);
var callback = details.callback;

        _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 657);
if (Lang.isFunction(callback)) {
            _yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 658);
...
_yuitest_coverline("/build/model-sync-rest/model-sync-rest.js", 681);
