...
_yuitest_coverage["/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 12);
var Lang = Y.Lang;
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 48);
function RESTSync() {}
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 76);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 92);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 116);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 136);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 155);
...
@since 3.6.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 168);
RESTSync._NON_ATTRS_CFG = ['root', 'url'];

_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 170);
RESTSync.prototype = {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "initializer", 296);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 297);
config || (config = {});

        // Overrides `root` at the instance level.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 300);
if ('root' in config) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 301);
this.root = config.root || '';
        }

        // Overrides `url` at the instance level.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 305);
if ('url' in config) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 306);
this.url = config.url || '';
        }
    },
    ...
    **/
    getURL: function (action, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "getURL", 332);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 333);
var root = this.root,
            url  = this.url;
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 339);
if (this._isYUIModelList) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 340);
if (!url) {
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 341);
return this.model.prototype.root;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 344);
return this._substituteURL(url, Y.merge(this.getAttrs(), options));
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 352);
if (root && (action === 'create' || this.isNew())) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 353);
return root;
        }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 359);
if (!url) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 360);
return this._joinURL(this.getAsURL('id') || '');
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 365);
return this._substituteURL(url, Y.merge(this.getAttrs(), options));
    },
    ...
    **/
    serialize: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "serialize", 387);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 388);
return Y.JSON.stringify(this);
    ...
    **/
    sync: function (action, options, callback) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "sync", 424);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 425);
options || (options = {});

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 427);
var url       = this.getURL(action, options),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 435);
if (method === 'POST' || method === 'PUT') {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 436);
entity = this.serialize();
        } else {
            // Remove header, no content is being sent.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 439);
delete headers['Content-Type'];
        }

        // Setup HTTP emulation for older servers if we need it.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 443);
if (RESTSync.EMULATE_HTTP &&
                (method === 'PUT' || method === 'DELETE')) {

            // Pass along original method type in the headers.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 447);
headers['X-HTTP-Method-Override'] = method;

            // Fall-back to using POST method type.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 450);
method = 'POST';
        }

        // Add CSRF token to HTTP request headers if one is specified and the
        // request will cause side effects on the server.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 455);
if (csrfToken &&
                (method === 'POST' || method === 'PUT' || method === 'DELETE')) {

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 458);
headers['X-CSRF-Token'] = csrfToken;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 461);
this._sendSyncIORequest({
    ...
    **/
    _joinURL: function (url) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "_joinURL", 493);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 494);
var root = this.root;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 496);
if (!(root || url)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 497);
return '';
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 500);
if (url.charAt(0) === '/') {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 501);
url = url.substring(1);
        }

        // Combines the `root` with the `url` and adds a trailing-slash if the
        // `root` has a trailing-slash.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 506);
return root && root.charAt(root.length - 1) === '/' ?
    ...
    **/
    _sendSyncIORequest: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "_sendSyncIORequest", 530);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 531);
return Y.io(config.url, {
    ...
    **/
    _substituteURL: function (url, data) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "_substituteURL", 571);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 572);
if (!url) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 573);
return '';
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 576);
var values = {};

        // Creates a hash of the string and number values only to be used to
        // replace any placeholders in a tokenized `url`.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 580);
Y.Object.each(data, function (v, k) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "(anonymous 2)", 580);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 581);
if (Lang.isString(v) || Lang.isNumber(v)) {
                // URL-encode any string or number values.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 583);
values[k] = encodeURIComponent(v);
            }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 587);
return Lang.sub(url, values);
    ...
    **/
    _onSyncIOFailure: function (txId, res, details) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "_onSyncIOFailure", 625);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 626);
var callback = details.callback;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 628);
if (Lang.isFunction(callback)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 629);
callback({
                code: res.status,
                msg : res.statusText
            }, res.responseText);
    ...
    **/
    _onSyncIOSuccess: function (txId, res, details) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", "_onSyncIOSuccess", 652);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 653);
var callback = details.callback;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 655);
if (Lang.isFunction(callback)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 656);
...
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/model-sync-rest.js", 679);
