...
YUI.add('editor-base', function (Y, NAME) {
    ...
    _yuitest_coverfunc("editor-base", "(anonymous 1)", 1);
_yuitest_coverline("editor-base", 20);
var EditorBase = function() {
        _yuitest_coverfunc("editor-base", "EditorBase", 20);
_yuitest_coverline("editor-base", 21);
EditorBase.superclass.constructor.apply(this, arguments);
    }, LAST_CHILD = ':last-child', BODY = 'body';

    _yuitest_coverline("editor-base", 24);
Y.extend(EditorBase, Y.Base, {
        ...
        */
        ...
        initializer: function() {
            _yuitest_coverfunc("editor-base", "initializer", 30);
_yuitest_coverline("editor-base", 31);
var frame = new Y.Frame({
            ...
            _yuitest_coverline("editor-base", 43);
frame.after('ready', Y.bind(this._afterFrameReady, this));
            _yuitest_coverline("editor-base", 44);
frame.addTarget(this);

            _yuitest_coverline("editor-base", 46);
this.frame = frame;

            _yuitest_coverline("editor-base", 48);
this.publish('nodeChange', {
        ...
        destructor: function() {
            _yuitest_coverfunc("editor-base", "destructor", 56);
_yuitest_coverline("editor-base", 57);
this.frame.destroy();

            _yuitest_coverline("editor-base", 59);
this.detachAll();
        },
        /**
        ...
        */
        copyStyles: function(from, to) {
            _yuitest_coverfunc("editor-base", "copyStyles", 67);
_yuitest_coverline("editor-base", 68);
if (from.test('a')) {
                //Don't carry the A styles
                _yuitest_coverline("editor-base", 70);
return;
            }
            _yuitest_coverline("editor-base", 72);
var styles = ['color', 'fontSize', 'fontFamily', 'backgroundColor', 'fontStyle' ],
                newStyles = {};

            _yuitest_coverline("editor-base", 75);
Y.each(styles, function(v) {
                _yuitest_coverfunc("editor-base", "(anonymous 2)", 75);
_yuitest_coverline("editor-base", 76);
newStyles[v] = from.getStyle(v);
            });
            _yuitest_coverline("editor-base", 78);
if (from.ancestor('b,strong')) {
                _yuitest_coverline("editor-base", 79);
newStyles.fontWeight = 'bold';
            }
            _yuitest_coverline("editor-base", 81);
if (from.ancestor('u')) {
                _yuitest_coverline("editor-base", 82);
if (!newStyles.textDecoration) {
                    _yuitest_coverline("editor-base", 83);
newStyles.textDecoration = 'underline';
                }
            }
            _yuitest_coverline("editor-base", 86);
to.setStyles(newStyles);
        ...
        */
        _resolveChangedNode: function(n) {
            _yuitest_coverfunc("editor-base", "_resolveChangedNode", 102);
_yuitest_coverline("editor-base", 103);
var inst = this.getInstance(), lc, lc2, found;
            _yuitest_coverline("editor-base", 104);
if (n && n.test(BODY)) {
                _yuitest_coverline("editor-base", 105);
var sel = new inst.EditorSelection();
                _yuitest_coverline("editor-base", 106);
if (sel && sel.anchorNode) {
                    _yuitest_coverline("editor-base", 107);
n = sel.anchorNode;
                }
            }
            _yuitest_coverline("editor-base", 110);
if (inst && n && n.test('html')) {
                _yuitest_coverline("editor-base", 111);
lc = inst.one(BODY).one(LAST_CHILD);
                _yuitest_coverline("editor-base", 112);
while (!found) {
                    _yuitest_coverline("editor-base", 113);
if (lc) {
                        _yuitest_coverline("editor-base", 114);
lc2 = lc.one(LAST_CHILD);
                        _yuitest_coverline("editor-base", 115);
if (lc2) {
                            _yuitest_coverline("editor-base", 116);
lc = lc2;
                        } else {
                            _yuitest_coverline("editor-base", 118);
found = true;
                        }
                    } else {
                        _yuitest_coverline("editor-base", 121);
found = true;
                    }
                }
                _yuitest_coverline("editor-base", 124);
if (lc) {
                    _yuitest_coverline("editor-base", 125);
if (lc.test('br')) {
                        _yuitest_coverline("editor-base", 126);
if (lc.previous()) {
                            _yuitest_coverline("editor-base", 127);
lc = lc.previous();
                        } else {
                            _yuitest_coverline("editor-base", 129);
lc = lc.get('parentNode');
                        }
                    }
                    _yuitest_coverline("editor-base", 132);
if (lc) {
                        _yuitest_coverline("editor-base", 133);
n = lc;
                    }
                }
            }
            _yuitest_coverline("editor-base", 137);
if (!n) {
                //Fallback to make sure a node is attached to the event
                _yuitest_coverline("editor-base", 139);
n = inst.one(BODY);
            }
            _yuitest_coverline("editor-base", 141);
return n;
        },
        /**
        ...
        */
        _defNodeChangeFn: function(e) {
            _yuitest_coverfunc("editor-base", "_defNodeChangeFn", 149);
_yuitest_coverline("editor-base", 150);
var startTime = (new Date()).getTime();
            _yuitest_coverline("editor-base", 151);
var inst = this.getInstance(), sel, cur,
                btag = inst.EditorSelection.DEFAULT_BLOCK_TAG;

            _yuitest_coverline("editor-base", 154);
if (Y.UA.ie) {
                _yuitest_coverline("editor-base", 155);
try {
                    _yuitest_coverline("editor-base", 156);
sel = inst.config.doc.selection.createRange();
                    _yuitest_coverline("editor-base", 157);
if (sel.getBookmark) {
                        _yuitest_coverline("editor-base", 158);
this._lastBookmark = sel.getBookmark();
                    }
                } catch (ie) {}
            }

            _yuitest_coverline("editor-base", 163);
e.changedNode = this._resolveChangedNode(e.changedNode);
            ...
            */
            ...
            _yuitest_coverline("editor-base", 173);
switch (e.changedType) {
                case 'keydown':
                    _yuitest_coverline("editor-base", 175);
if (!Y.UA.gecko) {
                        _yuitest_coverline("editor-base", 176);
if (!EditorBase.NC_KEYS[e.changedEvent.keyCode] && !e.changedEvent.shiftKey && !e.changedEvent.ctrlKey && (e.changedEvent.keyCode !== 13)) {
                    ...
                    _yuitest_coverline("editor-base", 180);
break;
                case 'tab':
                    _yuitest_coverline("editor-base", 182);
if (!e.changedNode.test('li, li *') && !e.changedEvent.shiftKey) {
                        _yuitest_coverline("editor-base", 183);
e.changedEvent.frameEvent.preventDefault();
                        _yuitest_coverline("editor-base", 184);
if (Y.UA.webkit) {
                            _yuitest_coverline("editor-base", 185);
this.execCommand('inserttext', '\t');
                        } else {_yuitest_coverline("editor-base", 186);
if (Y.UA.gecko) {
                            _yuitest_coverline("editor-base", 187);
this.frame.exec._command('inserthtml', EditorBase.TABKEY);
                        } else {_yuitest_coverline("editor-base", 188);
if (Y.UA.ie) {
                            _yuitest_coverline("editor-base", 189);
this.execCommand('inserthtml', EditorBase.TABKEY);
                        }}}
                    }
                    _yuitest_coverline("editor-base", 192);
break;
                case 'backspace-up':
                    // Fixes #2531090 - Joins text node strings so they become one for bidi
                    _yuitest_coverline("editor-base", 195);
if (Y.UA.webkit && e.changedNode) {
			            _yuitest_coverline("editor-base", 196);
e.changedNode.set('innerHTML', e.changedNode.get('innerHTML'));
		            }
                    _yuitest_coverline("editor-base", 198);
break;
            }
            _yuitest_coverline("editor-base", 200);
if (Y.UA.webkit && e.commands && (e.commands.indent || e.commands.outdent)) {
                ...
                */
                _yuitest_coverline("editor-base", 206);
var bq = inst.all('.webkit-indent-blockquote, blockquote');
                _yuitest_coverline("editor-base", 207);
if (bq.size()) {
                    _yuitest_coverline("editor-base", 208);
bq.setStyle('margin', '');
                }
            }

            _yuitest_coverline("editor-base", 212);
var changed = this.getDomPath(e.changedNode, false),
                cmds = {}, family, fsize, classes = [],
                fColor = '', bColor = '';

            _yuitest_coverline("editor-base", 216);
if (e.commands) {
                _yuitest_coverline("editor-base", 217);
cmds = e.commands;
            }
            
            _yuitest_coverline("editor-base", 220);
var normal = false;

            _yuitest_coverline("editor-base", 222);
Y.each(changed, function(el) {
                _yuitest_coverfunc("editor-base", "(anonymous 3)", 222);
_yuitest_coverline("editor-base", 223);
var tag = el.tagName.toLowerCase(),
                    cmd = EditorBase.TAG2CMD[tag];

                _yuitest_coverline("editor-base", 226);
if (cmd) {
                    _yuitest_coverline("editor-base", 227);
cmds[cmd] = 1;
                }

                //Bold and Italic styles
                _yuitest_coverline("editor-base", 231);
var s = el.currentStyle || el.style;
                
                _yuitest_coverline("editor-base", 233);
if ((''+s.fontWeight) == 'normal') {
                    _yuitest_coverline("editor-base", 234);
normal = true;
                }
                _yuitest_coverline("editor-base", 236);
if ((''+s.fontWeight) == 'bold') { //Cast this to a string
                    _yuitest_coverline("editor-base", 237);
cmds.bold = 1;
                }
                _yuitest_coverline("editor-base", 239);
if (Y.UA.ie) {
                    _yuitest_coverline("editor-base", 240);
if (s.fontWeight > 400) {
                        _yuitest_coverline("editor-base", 241);
cmds.bold = 1;
                    }
                }
                _yuitest_coverline("editor-base", 244);
if (s.fontStyle == 'italic') {
                    _yuitest_coverline("editor-base", 245);
cmds.italic = 1;
                }

                _yuitest_coverline("editor-base", 248);
if (s.textDecoration.indexOf('underline') > -1) {
                    _yuitest_coverline("editor-base", 249);
cmds.underline = 1;
                }
                _yuitest_coverline("editor-base", 251);
if (s.textDecoration.indexOf('line-through') > -1) {
                    _yuitest_coverline("editor-base", 252);
cmds.strikethrough = 1;
                }
                
                _yuitest_coverline("editor-base", 255);
var n = inst.one(el);
                _yuitest_coverline("editor-base", 256);
if (n.getStyle('fontFamily')) {
                    _yuitest_coverline("editor-base", 257);
var family2 = n.getStyle('fontFamily').split(',')[0].toLowerCase();
                    _yuitest_coverline("editor-base", 258);
if (family2) {
                        _yuitest_coverline("editor-base", 259);
family = family2;
                    }
                    _yuitest_coverline("editor-base", 261);
if (family) {
                        _yuitest_coverline("editor-base", 262);
family = family.replace(/'/g, '').replace(/"/g, '');
                    }
                }

                _yuitest_coverline("editor-base", 266);
fsize = EditorBase.NORMALIZE_FONTSIZE(n);


                _yuitest_coverline("editor-base", 269);
var cls = el.className.split(' ');

                _yuitest_coverline("editor-base", 271);
Y.each(cls, function(v) {
                    _yuitest_coverfunc("editor-base", "(anonymous 4)", 271);
_yuitest_coverline("editor-base", 272);
if (v !== '' && (v.substr(0, 4) !== 'yui_')) {
                        _yuitest_coverline("editor-base", 273);
classes.push(v);
                    }
                });

                _yuitest_coverline("editor-base", 277);
fColor = EditorBase.FILTER_RGB(n.getStyle('color'));
                _yuitest_coverline("editor-base", 278);
var bColor2 = EditorBase.FILTER_RGB(s.backgroundColor);
                _yuitest_coverline("editor-base", 279);
if (bColor2 !== 'transparent') {
                    _yuitest_coverline("editor-base", 280);
if (bColor2 !== '') {
                        _yuitest_coverline("editor-base", 281);
bColor = bColor2;
                    }
                }
            ...
            _yuitest_coverline("editor-base", 287);
if (normal) {
                _yuitest_coverline("editor-base", 288);
delete cmds.bold;
                _yuitest_coverline("editor-base", 289);
delete cmds.italic;
            }

            _yuitest_coverline("editor-base", 292);
e.dompath = inst.all(changed);
            _yuitest_coverline("editor-base", 293);
e.classNames = classes;
            _yuitest_coverline("editor-base", 294);
e.commands = cmds;

            //TODO Dont' like this, not dynamic enough..
            _yuitest_coverline("editor-base", 297);
if (!e.fontFamily) {
                _yuitest_coverline("editor-base", 298);
e.fontFamily = family;
            }
            _yuitest_coverline("editor-base", 300);
if (!e.fontSize) {
                _yuitest_coverline("editor-base", 301);
e.fontSize = fsize;
            }
            _yuitest_coverline("editor-base", 303);
if (!e.fontColor) {
                _yuitest_coverline("editor-base", 304);
e.fontColor = fColor;
            }
            _yuitest_coverline("editor-base", 306);
if (!e.backgroundColor) {
                _yuitest_coverline("editor-base", 307);
e.backgroundColor = bColor;
            }

            _yuitest_coverline("editor-base", 310);
var endTime = (new Date()).getTime();
        ...
        */
        getDomPath: function(node, nodeList) {
			_yuitest_coverfunc("editor-base", "getDomPath", 317);
_yuitest_coverline("editor-base", 318);
var domPath = [], domNode,
                inst = this.frame.getInstance();

            _yuitest_coverline("editor-base", 321);
domNode = inst.Node.getDOMNode(node);
            //return inst.all(domNode);

            _yuitest_coverline("editor-base", 324);
while (domNode !== null) {
                
                _yuitest_coverline("editor-base", 326);
if ((domNode === inst.config.doc.documentElement) || (domNode === inst.config.doc) || !domNode.tagName) {
                    _yuitest_coverline("editor-base", 327);
domNode = null;
                    _yuitest_coverline("editor-base", 328);
break;
                }
                
                _yuitest_coverline("editor-base", 331);
if (!inst.DOM.inDoc(domNode)) {
                    _yuitest_coverline("editor-base", 332);
domNode = null;
                    _yuitest_coverline("editor-base", 333);
break;
                }
                
                //Check to see if we get el.nodeName and nodeType
                _yuitest_coverline("editor-base", 337);
if (domNode.nodeName && domNode.nodeType && (domNode.nodeType == 1)) {
                    _yuitest_coverline("editor-base", 338);
domPath.push(domNode);
                }

                _yuitest_coverline("editor-base", 341);
if (domNode == inst.config.doc.body) {
                    _yuitest_coverline("editor-base", 342);
domNode = null;
                    _yuitest_coverline("editor-base", 343);
break;
                }

                _yuitest_coverline("editor-base", 346);
domNode = domNode.parentNode;
            ...
            _yuitest_coverline("editor-base", 373);
if (domPath.length === 0) {
                _yuitest_coverline("editor-base", 374);
domPath[0] = inst.config.doc.body;
            }

            _yuitest_coverline("editor-base", 377);
if (nodeList) {
                _yuitest_coverline("editor-base", 378);
return inst.all(domPath.reverse());
            } else {
                _yuitest_coverline("editor-base", 380);
...
this.fire('ready');
        ...
        */
        _beforeFrameDeactivate: function(e) {
            _yuitest_coverfunc("editor-base", "_beforeFrameDeactivate", 412);
_yuitest_coverline("editor-base", 413);
if (e.frameTarget.test('html')) { //Means it came from a scrollbar
                _yuitest_coverline("editor-base", 414);
return;
            }
            _yuitest_coverline("editor-base", 416);
var inst = this.getInstance(),
                sel = inst.config.doc.selection.createRange();
            
            _yuitest_coverline("editor-base", 419);
if (sel.compareEndPoints && !sel.compareEndPoints('StartToEnd', sel)) {
                _yuitest_coverline("editor-base", 420);
sel.pasteHTML('<var id="yui-ie-cursor">');
        ...
        */
        _onFrameActivate: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameActivate", 428);
_yuitest_coverline("editor-base", 429);
if (e.frameTarget.test('html')) { //Means it came from a scrollbar
                _yuitest_coverline("editor-base", 430);
return;
            }
            _yuitest_coverline("editor-base", 432);
var inst = this.getInstance(),
                sel = new inst.EditorSelection(),
                range = sel.createRange(),
                cur = inst.all('#yui-ie-cursor');

            _yuitest_coverline("editor-base", 437);
if (cur.size()) {
                _yuitest_coverline("editor-base", 438);
cur.each(function(n) {
                    _yuitest_coverfunc("editor-base", "(anonymous 5)", 438);
_yuitest_coverline("editor-base", 439);
n.set('id', '');
                    _yuitest_coverline("editor-base", 440);
if (range.moveToElementText) {
                        _yuitest_coverline("editor-base", 441);
try {
                            _yuitest_coverline("editor-base", 442);
range.moveToElementText(n._node);
                            _yuitest_coverline("editor-base", 443);
var moved = range.move('character', -1);
                            _yuitest_coverline("editor-base", 444);
if (moved === -1) { //Only move up if we actually moved back.
                                _yuitest_coverline("editor-base", 445);
range.move('character', 1);
                            }
                            _yuitest_coverline("editor-base", 447);
range.select();
                            _yuitest_coverline("editor-base", 448);
range.text = '';
                        } catch (e) {}
                    }
                    _yuitest_coverline("editor-base", 451);
n.remove();
                });
            }
        },
        ...
        */
        _onPaste: function(e) {
            _yuitest_coverfunc("editor-base", "_onPaste", 460);
_yuitest_coverline("editor-base", 461);
this.fire('nodeChange', { changedNode: e.frameTarget, changedType: 'paste', changedEvent: e.frameEvent });
        ...
        */
        _onFrameMouseUp: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameMouseUp", 468);
_yuitest_coverline("editor-base", 469);
this.fire('nodeChange', { changedNode: e.frameTarget, changedType: 'mouseup', changedEvent: e.frameEvent  });
        ...
        */
        _onFrameMouseDown: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameMouseDown", 476);
_yuitest_coverline("editor-base", 477);
this.fire('nodeChange', { changedNode: e.frameTarget, changedType: 'mousedown', changedEvent: e.frameEvent  });
        ...
        */
        _onFrameKeyDown: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameKeyDown", 502);
_yuitest_coverline("editor-base", 503);
var inst, sel;
            _yuitest_coverline("editor-base", 504);
if (!this._currentSelection) {
                _yuitest_coverline("editor-base", 505);
if (this._currentSelectionTimer) {
                    _yuitest_coverline("editor-base", 506);
this._currentSelectionTimer.cancel();
                }
                _yuitest_coverline("editor-base", 508);
this._currentSelectionTimer = Y.later(850, this, function() {
                    _yuitest_coverfunc("editor-base", "(anonymous 6)", 508);
_yuitest_coverline("editor-base", 509);
this._currentSelectionClear = true;
                });
                
                _yuitest_coverline("editor-base", 512);
inst = this.frame.getInstance();
                _yuitest_coverline("editor-base", 513);
sel = new inst.EditorSelection(e);

                _yuitest_coverline("editor-base", 515);
this._currentSelection = sel;
            } else {
                _yuitest_coverline("editor-base", 517);
sel = this._currentSelection;
            }

            _yuitest_coverline("editor-base", 520);
inst = this.frame.getInstance();
            _yuitest_coverline("editor-base", 521);
sel = new inst.EditorSelection();

            _yuitest_coverline("editor-base", 523);
this._currentSelection = sel;
            
            _yuitest_coverline("editor-base", 525);
if (sel && sel.anchorNode) {
                _yuitest_coverline("editor-base", 526);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: 'keydown', changedEvent: e.frameEvent });
                _yuitest_coverline("editor-base", 527);
if (EditorBase.NC_KEYS[e.keyCode]) {
                    _yuitest_coverline("editor-base", 528);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: EditorBase.NC_KEYS[e.keyCode], changedEvent: e.frameEvent });
                    _yuitest_coverline("editor-base", 529);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: EditorBase.NC_KEYS[e.keyCode] + '-down', changedEvent: e.frameEvent });
        ...
        */
        _onFrameKeyPress: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameKeyPress", 538);
_yuitest_coverline("editor-base", 539);
var sel = this._currentSelection;

            _yuitest_coverline("editor-base", 541);
if (sel && sel.anchorNode) {
                _yuitest_coverline("editor-base", 542);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: 'keypress', changedEvent: e.frameEvent });
                _yuitest_coverline("editor-base", 543);
if (EditorBase.NC_KEYS[e.keyCode]) {
                    _yuitest_coverline("editor-base", 544);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: EditorBase.NC_KEYS[e.keyCode] + '-press', changedEvent: e.frameEvent });
        ...
        */
        _onFrameKeyUp: function(e) {
            _yuitest_coverfunc("editor-base", "_onFrameKeyUp", 553);
_yuitest_coverline("editor-base", 554);
var inst = this.frame.getInstance(),
                sel = new inst.EditorSelection(e);

            _yuitest_coverline("editor-base", 557);
if (sel && sel.anchorNode) {
                _yuitest_coverline("editor-base", 558);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: 'keyup', selection: sel, changedEvent: e.frameEvent  });
                _yuitest_coverline("editor-base", 559);
if (EditorBase.NC_KEYS[e.keyCode]) {
                    _yuitest_coverline("editor-base", 560);
this.fire('nodeChange', { changedNode: sel.anchorNode, changedType: EditorBase.NC_KEYS[e.keyCode] + '-up', selection: sel, changedEvent: e.frameEvent  });
            ...
            _yuitest_coverline("editor-base", 563);
if (this._currentSelectionClear) {
                _yuitest_coverline("editor-base", 564);
this._currentSelectionClear = this._currentSelection = null;
        ...
        */
        execCommand: function(cmd, val) {
            _yuitest_coverfunc("editor-base", "execCommand", 574);
_yuitest_coverline("editor-base", 575);
var ret = this.frame.execCommand(cmd, val),
            ...
            _yuitest_coverline("editor-base", 580);
switch (cmd) {
                case 'forecolor':
                    _yuitest_coverline("editor-base", 582);
e.fontColor = val;
                    _yuitest_coverline("editor-base", 583);
break;
                case 'backcolor':
                    _yuitest_coverline("editor-base", 585);
e.backgroundColor = val;
                    _yuitest_coverline("editor-base", 586);
break;
                case 'fontsize':
                    _yuitest_coverline("editor-base", 588);
e.fontSize = val;
                    _yuitest_coverline("editor-base", 589);
break;
                case 'fontname':
                    _yuitest_coverline("editor-base", 591);
e.fontFamily = val;
                    _yuitest_coverline("editor-base", 592);
break;
            }

            _yuitest_coverline("editor-base", 595);
cmds[cmd] = 1;
            _yuitest_coverline("editor-base", 596);
e.commands = cmds;

            _yuitest_coverline("editor-base", 598);
this.fire('nodeChange', e);

            _yuitest_coverline("editor-base", 600);
return ret;
        },
        /**
        ...
        */
        getInstance: function() {
            _yuitest_coverfunc("editor-base", "getInstance", 607);
_yuitest_coverline("editor-base", 608);
return this.frame.getInstance();
        ...
        */
        render: function(node) {
            _yuitest_coverfunc("editor-base", "render", 617);
_yuitest_coverline("editor-base", 618);
this.frame.set('content', this.get('content'));
            _yuitest_coverline("editor-base", 619);
this.frame.render(node);
            _yuitest_coverline("editor-base", 620);
return this;
        },
        /**
        ...
        */
        focus: function(fn) {
            _yuitest_coverfunc("editor-base", "focus", 629);
_yuitest_coverline("editor-base", 630);
this.frame.focus(fn);
            _yuitest_coverline("editor-base", 631);
return this;
        },
        /**
        ...
        */
        show: function() {
            _yuitest_coverfunc("editor-base", "show", 639);
_yuitest_coverline("editor-base", 640);
this.frame.show();
            _yuitest_coverline("editor-base", 641);
return this;
        },
        /**
        ...
        */
        hide: function() {
            _yuitest_coverfunc("editor-base", "hide", 649);
_yuitest_coverline("editor-base", 650);
this.frame.hide();
            _yuitest_coverline("editor-base", 651);
return this;
        },
        /**
        ...
        */
        getContent: function() {
            _yuitest_coverfunc("editor-base", "getContent", 658);
_yuitest_coverline("editor-base", 659);
var html = '', inst = this.getInstance();
            _yuitest_coverline("editor-base", 660);
if (inst && inst.EditorSelection) {
                _yuitest_coverline("editor-base", 661);
html = inst.EditorSelection.unfilter();
            }
            //Removing the _yuid from the objects in IE
            _yuitest_coverline("editor-base", 664);
html = html.replace(/ _yuid="([^>]*)"/g, '');
            _yuitest_coverline("editor-base", 665);
return html;
        }
    }, {
        /**
        ...
        */
        NORMALIZE_FONTSIZE: function(n) {
            _yuitest_coverfunc("editor-base", "NORMALIZE_FONTSIZE", 675);
_yuitest_coverline("editor-base", 676);
var size = n.getStyle('fontSize'), oSize = size;
            
            _yuitest_coverline("editor-base", 678);
switch (size) {
                case '-webkit-xxx-large':
                    _yuitest_coverline("editor-base", 680);
size = '48px';
                    _yuitest_coverline("editor-base", 681);
break;
                case 'xx-large':
                    _yuitest_coverline("editor-base", 683);
size = '32px';
                    _yuitest_coverline("editor-base", 684);
break;
                case 'x-large':
                    _yuitest_coverline("editor-base", 686);
size = '24px';
                    _yuitest_coverline("editor-base", 687);
break;
                case 'large':
                    _yuitest_coverline("editor-base", 689);
size = '18px';
                    _yuitest_coverline("editor-base", 690);
break;
                case 'medium':
                    _yuitest_coverline("editor-base", 692);
size = '16px';
                    _yuitest_coverline("editor-base", 693);
break;
                case 'small':
                    _yuitest_coverline("editor-base", 695);
size = '13px';
                    _yuitest_coverline("editor-base", 696);
break;
                case 'x-small':
                    _yuitest_coverline("editor-base", 698);
size = '10px';
                    _yuitest_coverline("editor-base", 699);
break;
            }
            _yuitest_coverline("editor-base", 701);
if (oSize !== size) {
                _yuitest_coverline("editor-base", 702);
n.setStyle('fontSize', size);
            }
            _yuitest_coverline("editor-base", 704);
return size;
        },
        /**
        * @static
        ...
        */
        FILTER_RGB: function(css) {
            _yuitest_coverfunc("editor-base", "FILTER_RGB", 719);
_yuitest_coverline("editor-base", 720);
if (css.toLowerCase().indexOf('rgb') != -1) {
                _yuitest_coverline("editor-base", 721);
var exp = new RegExp("(.*?)rgb\\s*?\\(\\s*?([0-9]+).*?,\\s*?([0-9]+).*?,\\s*?([0-9]+).*?\\)(.*?)", "gi");
                _yuitest_coverline("editor-base", 722);
var rgb = css.replace(exp, "$1,$2,$3,$4,$5").split(',');
            
                _yuitest_coverline("editor-base", 724);
if (rgb.length == 5) {
                    _yuitest_coverline("editor-base", 725);
var r = parseInt(rgb[1], 10).toString(16);
                    _yuitest_coverline("editor-base", 726);
var g = parseInt(rgb[2], 10).toString(16);
                    _yuitest_coverline("editor-base", 727);
var b = parseInt(rgb[3], 10).toString(16);

                    _yuitest_coverline("editor-base", 729);
r = r.length == 1 ? '0' + r : r;
                    _yuitest_coverline("editor-base", 730);
g = g.length == 1 ? '0' + g : g;
                    _yuitest_coverline("editor-base", 731);
b = b.length == 1 ? '0' + b : b;

                    _yuitest_coverline("editor-base", 733);
css = "#" + r + g + b;
                }
            }
            _yuitest_coverline("editor-base", 736);
return css;
        },        
        /**
        * @static
        ...
        ATTRS: {
            ...
            */
            content: {
                ...
                setter: function(str) {
                    _yuitest_coverfunc("editor-base", "setter", 807);
_yuitest_coverline("editor-base", 808);
if (str.substr(0, 1) === "\n") {
                        _yuitest_coverline("editor-base", 809);
str = str.substr(1);
                    }
                    _yuitest_coverline("editor-base", 811);
if (str === '') {
                        _yuitest_coverline("editor-base", 812);
str = '<br class="yui-cursor">';
                    }
                    _yuitest_coverline("editor-base", 814);
if (str === ' ') {
                        _yuitest_coverline("editor-base", 815);
if (Y.UA.gecko) {
                            _yuitest_coverline("editor-base", 816);
str = '<br class="yui-cursor">';
                        }
                    }
                    _yuitest_coverline("editor-base", 819);
return this.frame.set('content', str);
                },
                getter: function() {
                    _yuitest_coverfunc("editor-base", "getter", 821);
_yuitest_coverline("editor-base", 822);
return this.frame.get('content');
            ...
            */            
            linkedcss: {
                value: '',
                setter: function(css) {
                    _yuitest_coverfunc("editor-base", "setter", 840);
_yuitest_coverline("editor-base", 841);
if (this.frame) {
                        _yuitest_coverline("editor-base", 842);
this.frame.set('linkedcss', css);
                    }
                    _yuitest_coverline("editor-base", 844);
return css;
                }
            },
            /**
            ...
            */            
            extracss: {
                value: false,
                setter: function(css) {
                    _yuitest_coverfunc("editor-base", "setter", 854);
_yuitest_coverline("editor-base", 855);
if (this.frame) {
                        _yuitest_coverline("editor-base", 856);
this.frame.set('extracss', css);
                    }
                    _yuitest_coverline("editor-base", 858);
return css;
                }
            },
            /**
    ...
    _yuitest_coverline("editor-base", 872);
