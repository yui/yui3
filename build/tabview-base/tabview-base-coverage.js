...
var getClassName = Y.ClassNameManager.getClassName,
    ...
    TabviewBase = function() {
        _yuitest_coverfunc("build/tabview-base/tabview-base.js", "TabviewBase", 11);
_yuitest_coverline("build/tabview-base/tabview-base.js", 12);
this.init.apply(this, arguments);
    };

_yuitest_coverline("build/tabview-base/tabview-base.js", 15);
TabviewBase.NAME = 'tabviewBase';
_yuitest_coverline("build/tabview-base/tabview-base.js", 16);
...
_yuitest_coverline("build/tabview-base/tabview-base.js", 26);
...
Y.mix(TabviewBase.prototype, {
    init: function(config) {
        _yuitest_coverfunc("build/tabview-base/tabview-base.js", "init", 38);
...
this.refresh();
    ...
    initClassNames: function(index) {
        _yuitest_coverfunc("build/tabview-base/tabview-base.js", "initClassNames", 45);
_yuitest_coverline("build/tabview-base/tabview-base.js", 46);
var _classNames = Y.TabviewBase._classNames;

        _yuitest_coverline("build/tabview-base/tabview-base.js", 48);
Y.Object.each(Y.TabviewBase._queries, function(query, name) {
            // this === tabview._node
            _yuitest_coverfunc("build/tabview-base/tabview-base.js", "(anonymous 2)", 48);
...
if (result) {
                    _yuitest_coverline("build/tabview-base/tabview-base.js", 58);
result.addClass(_classNames[name]);
                }
            }
        }, this._node);

        _yuitest_coverline("build/tabview-base/tabview-base.js", 63);
this._node.addClass(_classNames.tabview);
    },

    _select: function(index) {
        _yuitest_coverfunc("build/tabview-base/tabview-base.js", "_select", 66);
_yuitest_coverline("build/tabview-base/tabview-base.js", 67);
var _classNames = Y.TabviewBase._classNames,
