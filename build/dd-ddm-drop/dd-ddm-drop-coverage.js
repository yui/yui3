...
YUI.add('dd-ddm-drop', function (Y, NAME) {
    ...
    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 1)", 1);
_yuitest_coverline("dd-ddm-drop", 13);
Y.mix(Y.DD.DDM, {
        /**
        * @private
        * @property _noShim
        ...
        */
        _hasActiveShim: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_hasActiveShim", 34);
_yuitest_coverline("dd-ddm-drop", 35);
if (this._noShim) {
                _yuitest_coverline("dd-ddm-drop", 36);
return true;
            }
            _yuitest_coverline("dd-ddm-drop", 38);
return this._activeShims.length;
        ...
        */
        _addActiveShim: function(d) {
            _yuitest_coverfunc("dd-ddm-drop", "_addActiveShim", 46);
_yuitest_coverline("dd-ddm-drop", 47);
this._activeShims[this._activeShims.length] = d;
        ...
        */
        _removeActiveShim: function(d) {
            _yuitest_coverfunc("dd-ddm-drop", "_removeActiveShim", 55);
_yuitest_coverline("dd-ddm-drop", 56);
var s = [];
            _yuitest_coverline("dd-ddm-drop", 57);
Y.each(this._activeShims, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 2)", 57);
_yuitest_coverline("dd-ddm-drop", 58);
if (v._yuid !== d._yuid) {
                    _yuitest_coverline("dd-ddm-drop", 59);
s[s.length] = v;
                }
                
            });
            _yuitest_coverline("dd-ddm-drop", 63);
this._activeShims = s;
        },
        /**
        ...
        */
        syncActiveShims: function(force) {
            _yuitest_coverfunc("dd-ddm-drop", "syncActiveShims", 70);
_yuitest_coverline("dd-ddm-drop", 71);
Y.later(0, this, function(force) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 3)", 71);
_yuitest_coverline("dd-ddm-drop", 72);
var drops = ((force) ? this.targets : this._lookup());
                _yuitest_coverline("dd-ddm-drop", 73);
Y.each(drops, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 4)", 73);
_yuitest_coverline("dd-ddm-drop", 74);
v.sizeShim.call(v);
                }, this);
            }, force);
        },
        ...
        */
        _addValid: function(drop) {
            _yuitest_coverfunc("dd-ddm-drop", "_addValid", 145);
_yuitest_coverline("dd-ddm-drop", 146);
this.validDrops[this.validDrops.length] = drop;
            _yuitest_coverline("dd-ddm-drop", 147);
return this;
        },
        /**
        * @private 
        ...
        */
        _removeValid: function(drop) {
            _yuitest_coverfunc("dd-ddm-drop", "_removeValid", 157);
_yuitest_coverline("dd-ddm-drop", 158);
var drops = [];
            _yuitest_coverline("dd-ddm-drop", 159);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 5)", 159);
_yuitest_coverline("dd-ddm-drop", 160);
if (v !== drop) {
                    _yuitest_coverline("dd-ddm-drop", 161);
drops[drops.length] = v;
                }
            });

            _yuitest_coverline("dd-ddm-drop", 165);
this.validDrops = drops;
            _yuitest_coverline("dd-ddm-drop", 166);
return this;
        },
        /**
        * @method isOverTarget
        ...
        */
        isOverTarget: function(drop) {
            _yuitest_coverfunc("dd-ddm-drop", "isOverTarget", 174);
_yuitest_coverline("dd-ddm-drop", 175);
if (this.activeDrag && drop) {
                _yuitest_coverline("dd-ddm-drop", 176);
var xy = this.activeDrag.mouseXY, r, dMode = this.activeDrag.get('dragMode'),
                    aRegion, node = drop.shim;
                _yuitest_coverline("dd-ddm-drop", 178);
if (xy && this.activeDrag) {
                    _yuitest_coverline("dd-ddm-drop", 179);
aRegion = this.activeDrag.region;
                    _yuitest_coverline("dd-ddm-drop", 180);
if (dMode == this.STRICT) {
                        _yuitest_coverline("dd-ddm-drop", 181);
return this.activeDrag.get('dragNode').inRegion(drop.region, true, aRegion);
                    } else {
                        _yuitest_coverline("dd-ddm-drop", 183);
if (drop && drop.shim) {
                            _yuitest_coverline("dd-ddm-drop", 184);
if ((dMode == this.INTERSECT) && this._noShim) {
                                _yuitest_coverline("dd-ddm-drop", 185);
r = ((aRegion) ? aRegion : this.activeDrag.get('node'));
                                _yuitest_coverline("dd-ddm-drop", 186);
return drop.get('node').intersect(r, drop.region).inRegion;
                            } else {
                                _yuitest_coverline("dd-ddm-drop", 188);
if (this._noShim) {
                                    _yuitest_coverline("dd-ddm-drop", 189);
node = drop.get('node');
                                }
                                _yuitest_coverline("dd-ddm-drop", 191);
return node.intersect({
                            ...
                            _yuitest_coverline("dd-ddm-drop", 199);
return false;
                        }
                    }
                } else {
                    _yuitest_coverline("dd-ddm-drop", 203);
return false;
                }
            } else {
                _yuitest_coverline("dd-ddm-drop", 206);
return false;
            }
        },
        /**
        ...
        */
        clearCache: function() {
            _yuitest_coverfunc("dd-ddm-drop", "clearCache", 213);
_yuitest_coverline("dd-ddm-drop", 214);
this.validDrops = [];
            _yuitest_coverline("dd-ddm-drop", 215);
this.otherDrops = {};
            _yuitest_coverline("dd-ddm-drop", 216);
this._activeShims = [];
        },
        /**
        * @private
        ...
        */
        _activateTargets: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_activateTargets", 223);
_yuitest_coverline("dd-ddm-drop", 224);
this._noShim = true;
            _yuitest_coverline("dd-ddm-drop", 225);
this.clearCache();
            _yuitest_coverline("dd-ddm-drop", 226);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 6)", 226);
_yuitest_coverline("dd-ddm-drop", 227);
v._activateShim([]);
                _yuitest_coverline("dd-ddm-drop", 228);
if (v.get('noShim') == true) {
                    _yuitest_coverline("dd-ddm-drop", 229);
this._noShim = false;
                }
            }, this);
            _yuitest_coverline("dd-ddm-drop", 232);
this._handleTargetOver();
        ...
        */
        getBestMatch: function(drops, all) {
            _yuitest_coverfunc("dd-ddm-drop", "getBestMatch", 242);
_yuitest_coverline("dd-ddm-drop", 243);
var biggest = null, area = 0, out;
            
            _yuitest_coverline("dd-ddm-drop", 245);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 7)", 245);
_yuitest_coverline("dd-ddm-drop", 246);
var inter = this.activeDrag.get('dragNode').intersect(v.get('node'));
                _yuitest_coverline("dd-ddm-drop", 247);
v.region.area = inter.area;

                _yuitest_coverline("dd-ddm-drop", 249);
if (inter.inRegion) {
                    _yuitest_coverline("dd-ddm-drop", 250);
if (inter.area > area) {
                        _yuitest_coverline("dd-ddm-drop", 251);
area = inter.area;
                        _yuitest_coverline("dd-ddm-drop", 252);
biggest = v;
                    }
                }
            }, this);
            _yuitest_coverline("dd-ddm-drop", 256);
if (all) {
                _yuitest_coverline("dd-ddm-drop", 257);
out = [];
                //TODO Sort the others in numeric order by area covered..
                _yuitest_coverline("dd-ddm-drop", 259);
Y.each(drops, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 8)", 259);
_yuitest_coverline("dd-ddm-drop", 260);
if (v !== biggest) {
                        _yuitest_coverline("dd-ddm-drop", 261);
out[out.length] = v;
                    }
                }, this);
                _yuitest_coverline("dd-ddm-drop", 264);
return [biggest, out];
            } else {
                _yuitest_coverline("dd-ddm-drop", 266);
return biggest;
            }
        },
        /**
        ...
        */
        _deactivateTargets: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_deactivateTargets", 274);
_yuitest_coverline("dd-ddm-drop", 275);
var other = [], tmp,
                activeDrag = this.activeDrag,
                activeDrop = this.activeDrop;
            
            //TODO why is this check so hard??
            _yuitest_coverline("dd-ddm-drop", 280);
if (activeDrag && activeDrop && this.otherDrops[activeDrop]) {
                _yuitest_coverline("dd-ddm-drop", 281);
if (!activeDrag.get('dragMode')) {
                    //TODO otherDrops -- private..
                    _yuitest_coverline("dd-ddm-drop", 283);
other = this.otherDrops;
                    _yuitest_coverline("dd-ddm-drop", 284);
delete other[activeDrop];
                } else {
                    _yuitest_coverline("dd-ddm-drop", 286);
tmp = this.getBestMatch(this.otherDrops, true);
                    _yuitest_coverline("dd-ddm-drop", 287);
activeDrop = tmp[0];
                    _yuitest_coverline("dd-ddm-drop", 288);
other = tmp[1];
                }
                _yuitest_coverline("dd-ddm-drop", 290);
activeDrag.get('node').removeClass(this.CSS_PREFIX + '-drag-over');
                _yuitest_coverline("dd-ddm-drop", 291);
if (activeDrop) {
                    _yuitest_coverline("dd-ddm-drop", 292);
activeDrop.fire('drop:hit', { drag: activeDrag, drop: activeDrop, others: other });
                    _yuitest_coverline("dd-ddm-drop", 293);
activeDrag.fire('drag:drophit', { drag: activeDrag,  drop: activeDrop, others: other });
                }
            } else {_yuitest_coverline("dd-ddm-drop", 295);
if (activeDrag && activeDrag.get('dragging')) {
                _yuitest_coverline("dd-ddm-drop", 296);
activeDrag.get('node').removeClass(this.CSS_PREFIX + '-drag-over');
                _yuitest_coverline("dd-ddm-drop", 297);
activeDrag.fire('drag:dropmiss', { pageX: activeDrag.lastXY[0], pageY: activeDrag.lastXY[1] });
            } else {
            }}
            
            _yuitest_coverline("dd-ddm-drop", 301);
this.activeDrop = null;

            _yuitest_coverline("dd-ddm-drop", 303);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 9)", 303);
_yuitest_coverline("dd-ddm-drop", 304);
v._deactivateShim([]);
            }, this);
        },
        /**
        ...
        */
        _dropMove: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_dropMove", 312);
_yuitest_coverline("dd-ddm-drop", 313);
if (this._hasActiveShim()) {
                _yuitest_coverline("dd-ddm-drop", 314);
this._handleTargetOver();
            } else {
                _yuitest_coverline("dd-ddm-drop", 316);
Y.each(this.otherDrops, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 10)", 316);
_yuitest_coverline("dd-ddm-drop", 317);
v._handleOut.apply(v, []);
        ...
        */
        _lookup: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_lookup", 327);
_yuitest_coverline("dd-ddm-drop", 328);
if (!this.useHash || this._noShim) {
                _yuitest_coverline("dd-ddm-drop", 329);
return this.validDrops;
            }
            _yuitest_coverline("dd-ddm-drop", 331);
var drops = [];
            //Only scan drop shims that are in the Viewport
            _yuitest_coverline("dd-ddm-drop", 333);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 11)", 333);
_yuitest_coverline("dd-ddm-drop", 334);
if (v.shim && v.shim.inViewportRegion(false, v.region)) {
                    _yuitest_coverline("dd-ddm-drop", 335);
drops[drops.length] = v;
                }
            });
            _yuitest_coverline("dd-ddm-drop", 338);
return drops;
        ...
        */
        _handleTargetOver: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_handleTargetOver", 346);
_yuitest_coverline("dd-ddm-drop", 347);
var drops = this._lookup();
            _yuitest_coverline("dd-ddm-drop", 348);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 12)", 348);
_yuitest_coverline("dd-ddm-drop", 349);
v._handleTargetOver.call(v);
        ...
        */
        _regTarget: function(t) {
            _yuitest_coverfunc("dd-ddm-drop", "_regTarget", 358);
_yuitest_coverline("dd-ddm-drop", 359);
this.targets[this.targets.length] = t;
        ...
        */
        _unregTarget: function(drop) {
            _yuitest_coverfunc("dd-ddm-drop", "_unregTarget", 367);
_yuitest_coverline("dd-ddm-drop", 368);
var targets = [], vdrops;
            _yuitest_coverline("dd-ddm-drop", 369);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 13)", 369);
_yuitest_coverline("dd-ddm-drop", 370);
if (v != drop) {
                    _yuitest_coverline("dd-ddm-drop", 371);
targets[targets.length] = v;
                }
            }, this);
            _yuitest_coverline("dd-ddm-drop", 374);
this.targets = targets;

            _yuitest_coverline("dd-ddm-drop", 376);
vdrops = [];
            _yuitest_coverline("dd-ddm-drop", 377);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 14)", 377);
_yuitest_coverline("dd-ddm-drop", 378);
if (v !== drop) {
                    _yuitest_coverline("dd-ddm-drop", 379);
vdrops[vdrops.length] = v;
                }
            });

            _yuitest_coverline("dd-ddm-drop", 383);
this.validDrops = vdrops;
        ...
        */
        getDrop: function(node) {
            _yuitest_coverfunc("dd-ddm-drop", "getDrop", 391);
_yuitest_coverline("dd-ddm-drop", 392);
var drop = false,
                n = Y.one(node);
            _yuitest_coverline("dd-ddm-drop", 394);
if (n instanceof Y.Node) {
                _yuitest_coverline("dd-ddm-drop", 395);
Y.each(this.targets, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 15)", 395);
_yuitest_coverline("dd-ddm-drop", 396);
if (n.compareTo(v.get('node'))) {
                        _yuitest_coverline("dd-ddm-drop", 397);
drop = v;
                    }
                });
            }
            _yuitest_coverline("dd-ddm-drop", 401);
return drop;
        }
    }, true);
