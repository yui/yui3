...
_yuitest_coverage["/build/dd-ddm-drop/dd-ddm-drop.js"].coveredLines = 113;
...
return drop.get('node').intersect(r, drop.region).inRegion;
                                ...
                                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 188);
if (this._noShim) {
...
return node.intersect({
                            ...
                            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 199);
return false;
                        }
                    }
                } else {
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 203);
return false;
                }
            } else {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 206);
return false;
            }
        },
        /**
        ...
        */
        clearCache: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "clearCache", 213);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 214);
this.validDrops = [];
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 215);
this.otherDrops = {};
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 216);
this._activeShims = [];
        },
        /**
        * @private
        ...
        */
        _activateTargets: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_activateTargets", 223);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 224);
this._noShim = true;
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 225);
this.clearCache();
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 226);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 6)", 226);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 227);
v._activateShim([]);
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 228);
if (v.get('noShim') == true) {
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 229);
this._noShim = false;
                }
            }, this);
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 232);
this._handleTargetOver();
        ...
        */
        getBestMatch: function(drops, all) {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "getBestMatch", 242);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 243);
var biggest = null, area = 0, out;
            
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 245);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 7)", 245);
...
v.region.area = inter.area;
                ...
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 249);
if (inter.inRegion) {
...
if (all) {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 257);
out = [];
                //TODO Sort the others in numeric order by area covered..
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 259);
Y.each(drops, function(v, k) {
                    _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 8)", 259);
...
out[out.length] = v;
                ...
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 264);
return [biggest, out];
            } else {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 266);
return biggest;
            }
        },
        /**
        ...
        */
        _deactivateTargets: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_deactivateTargets", 274);
...
activeDrop = tmp[0];
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 288);
other = tmp[1];
                }
...
if (activeDrop) {
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 292);
activeDrop.fire('drop:hit', { drag: activeDrag, drop: activeDrop, others: other });
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 293);
activeDrag.fire('drag:drophit', { drag: activeDrag,  drop: activeDrop, others: other });
                }
            } else {_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 295);
...
activeDrag.fire('drag:dropmiss', { pageX: activeDrag.lastXY[0], pageY: activeDrag.lastXY[1] });
            ...
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 301);
this.activeDrop = null;

            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 303);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 9)", 303);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 304);
v._deactivateShim([]);
            }, this);
        },
        /**
        ...
        */
        _dropMove: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_dropMove", 312);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 313);
if (this._hasActiveShim()) {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 314);
this._handleTargetOver();
            } else {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 316);
Y.each(this.otherDrops, function(v, k) {
                    _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 10)", 316);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 317);
v._handleOut.apply(v, []);
        ...
        */
        _lookup: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_lookup", 327);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 328);
if (!this.useHash || this._noShim) {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 329);
return this.validDrops;
            }
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 331);
var drops = [];
            //Only scan drop shims that are in the Viewport
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 333);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 11)", 333);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 334);
if (v.shim && v.shim.inViewportRegion(false, v.region)) {
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 335);
drops[drops.length] = v;
                }
            });
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 338);
return drops;
        ...
        */
        _handleTargetOver: function() {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_handleTargetOver", 346);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 347);
var drops = this._lookup();
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 348);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 12)", 348);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 349);
v._handleTargetOver.call(v);
        ...
        */
        _regTarget: function(t) {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_regTarget", 358);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 359);
this.targets[this.targets.length] = t;
        ...
        */
        _unregTarget: function(drop) {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "_unregTarget", 367);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 368);
var targets = [], vdrops;
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 369);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 13)", 369);
...
targets[targets.length] = v;
            ...
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 374);
this.targets = targets;

            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 376);
vdrops = [];
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 377);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 14)", 377);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 378);
if (v !== drop) {
                    _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 379);
vdrops[vdrops.length] = v;
                }
            });

            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 383);
this.validDrops = vdrops;
        ...
        */
        getDrop: function(node) {
            _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "getDrop", 391);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 392);
var drop = false,
                n = Y.one(node);
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 394);
if (n instanceof Y.Node) {
                _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 395);
Y.each(this.targets, function(v, k) {
                    _yuitest_coverfunc("/build/dd-ddm-drop/dd-ddm-drop.js", "(anonymous 15)", 395);
_yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 396);
if (n.compareTo(v.get('node'))) {
                        _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 397);
drop = v;
                    }
                });
            }
            _yuitest_coverline("/build/dd-ddm-drop/dd-ddm-drop.js", 401);
return drop;
        }
    }, true);
