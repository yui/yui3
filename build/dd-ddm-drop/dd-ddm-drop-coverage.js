...
_yuitest_coverage["dd-ddm-drop"].coveredLines = 111;
...
if (this._noShim) {
                            _yuitest_coverline("dd-ddm-drop", 190);
node = drop.get('node');
                        }
                        _yuitest_coverline("dd-ddm-drop", 192);
return node.intersect({
            ...
            _yuitest_coverline("dd-ddm-drop", 201);
return false;
        },
        /**
        * @method clearCache
        ...
        */
        clearCache: function() {
            _yuitest_coverfunc("dd-ddm-drop", "clearCache", 207);
_yuitest_coverline("dd-ddm-drop", 208);
this.validDrops = [];
            _yuitest_coverline("dd-ddm-drop", 209);
this.otherDrops = {};
            _yuitest_coverline("dd-ddm-drop", 210);
this._activeShims = [];
        },
        /**
        * @private
        ...
        */
        _activateTargets: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_activateTargets", 217);
_yuitest_coverline("dd-ddm-drop", 218);
this._noShim = true;
            _yuitest_coverline("dd-ddm-drop", 219);
this.clearCache();
            _yuitest_coverline("dd-ddm-drop", 220);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 6)", 220);
_yuitest_coverline("dd-ddm-drop", 221);
v._activateShim([]);
                _yuitest_coverline("dd-ddm-drop", 222);
if (v.get('noShim') == true) {
                    _yuitest_coverline("dd-ddm-drop", 223);
this._noShim = false;
                }
            }, this);
...
this._handleTargetOver();
        ...
        */
        getBestMatch: function(drops, all) {
            _yuitest_coverfunc("dd-ddm-drop", "getBestMatch", 236);
_yuitest_coverline("dd-ddm-drop", 237);
var biggest = null, area = 0, out;
            
            _yuitest_coverline("dd-ddm-drop", 239);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 7)", 239);
_yuitest_coverline("dd-ddm-drop", 240);
var inter = this.activeDrag.get('dragNode').intersect(v.get('node'));
                _yuitest_coverline("dd-ddm-drop", 241);
v.region.area = inter.area;

                _yuitest_coverline("dd-ddm-drop", 243);
if (inter.inRegion) {
                    _yuitest_coverline("dd-ddm-drop", 244);
if (inter.area > area) {
...
out = [];
                ...
                _yuitest_coverline("dd-ddm-drop", 253);
Y.each(drops, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 8)", 253);
_yuitest_coverline("dd-ddm-drop", 254);
if (v !== biggest) {
                        _yuitest_coverline("dd-ddm-drop", 255);
out[out.length] = v;
                    }
                }, this);
                _yuitest_coverline("dd-ddm-drop", 258);
return [biggest, out];
            }
...
return biggest;
        ...
        */
        _deactivateTargets: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_deactivateTargets", 267);
_yuitest_coverline("dd-ddm-drop", 268);
var other = [], tmp,
                activeDrag = this.activeDrag,
                activeDrop = this.activeDrop;
            
            //TODO why is this check so hard??
            _yuitest_coverline("dd-ddm-drop", 273);
if (activeDrag && activeDrop && this.otherDrops[activeDrop]) {
                _yuitest_coverline("dd-ddm-drop", 274);
if (!activeDrag.get('dragMode')) {
                    //TODO otherDrops -- private..
                    _yuitest_coverline("dd-ddm-drop", 276);
other = this.otherDrops;
                    _yuitest_coverline("dd-ddm-drop", 277);
delete other[activeDrop];
                } else {
                    _yuitest_coverline("dd-ddm-drop", 279);
...
if (activeDrop) {
                    _yuitest_coverline("dd-ddm-drop", 285);
activeDrop.fire('drop:hit', { drag: activeDrag, drop: activeDrop, others: other });
                    _yuitest_coverline("dd-ddm-drop", 286);
activeDrag.fire('drag:drophit', { drag: activeDrag,  drop: activeDrop, others: other });
                }
            } else {_yuitest_coverline("dd-ddm-drop", 288);
if (activeDrag && activeDrag.get('dragging')) {
                _yuitest_coverline("dd-ddm-drop", 289);
activeDrag.get('node').removeClass(this.CSS_PREFIX + '-drag-over');
...
this.activeDrop = null;
            ...
            _yuitest_coverline("dd-ddm-drop", 295);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 9)", 295);
...
v._deactivateShim([]);
        ...
        */
        _dropMove: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_dropMove", 304);
_yuitest_coverline("dd-ddm-drop", 305);
if (this._hasActiveShim()) {
                _yuitest_coverline("dd-ddm-drop", 306);
this._handleTargetOver();
            } else {
                _yuitest_coverline("dd-ddm-drop", 308);
Y.each(this.otherDrops, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 10)", 308);
_yuitest_coverline("dd-ddm-drop", 309);
v._handleOut.apply(v, []);
        ...
        */
        _lookup: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_lookup", 319);
_yuitest_coverline("dd-ddm-drop", 320);
if (!this.useHash || this._noShim) {
                _yuitest_coverline("dd-ddm-drop", 321);
return this.validDrops;
            }
            _yuitest_coverline("dd-ddm-drop", 323);
var drops = [];
            //Only scan drop shims that are in the Viewport
            _yuitest_coverline("dd-ddm-drop", 325);
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 11)", 325);
_yuitest_coverline("dd-ddm-drop", 326);
if (v.shim && v.shim.inViewportRegion(false, v.region)) {
                    _yuitest_coverline("dd-ddm-drop", 327);
drops[drops.length] = v;
                }
            });
            _yuitest_coverline("dd-ddm-drop", 330);
return drops;
        ...
        */
        _handleTargetOver: function() {
            _yuitest_coverfunc("dd-ddm-drop", "_handleTargetOver", 338);
_yuitest_coverline("dd-ddm-drop", 339);
var drops = this._lookup();
            _yuitest_coverline("dd-ddm-drop", 340);
Y.each(drops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 12)", 340);
_yuitest_coverline("dd-ddm-drop", 341);
v._handleTargetOver.call(v);
        ...
        */
        _regTarget: function(t) {
            _yuitest_coverfunc("dd-ddm-drop", "_regTarget", 350);
_yuitest_coverline("dd-ddm-drop", 351);
this.targets[this.targets.length] = t;
        ...
        */
        _unregTarget: function(drop) {
            _yuitest_coverfunc("dd-ddm-drop", "_unregTarget", 359);
_yuitest_coverline("dd-ddm-drop", 360);
var targets = [], vdrops;
            _yuitest_coverline("dd-ddm-drop", 361);
Y.each(this.targets, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 13)", 361);
_yuitest_coverline("dd-ddm-drop", 362);
if (v != drop) {
                    _yuitest_coverline("dd-ddm-drop", 363);
targets[targets.length] = v;
                }
            }, this);
            _yuitest_coverline("dd-ddm-drop", 366);
...
Y.each(this.validDrops, function(v, k) {
                _yuitest_coverfunc("dd-ddm-drop", "(anonymous 14)", 369);
...
vdrops[vdrops.length] = v;
            ...
            _yuitest_coverline("dd-ddm-drop", 375);
this.validDrops = vdrops;
        ...
        */
        getDrop: function(node) {
            _yuitest_coverfunc("dd-ddm-drop", "getDrop", 383);
_yuitest_coverline("dd-ddm-drop", 384);
var drop = false,
                n = Y.one(node);
            _yuitest_coverline("dd-ddm-drop", 386);
if (n instanceof Y.Node) {
                _yuitest_coverline("dd-ddm-drop", 387);
Y.each(this.targets, function(v, k) {
                    _yuitest_coverfunc("dd-ddm-drop", "(anonymous 15)", 387);
_yuitest_coverline("dd-ddm-drop", 388);
if (n.compareTo(v.get('node'))) {
                        _yuitest_coverline("dd-ddm-drop", 389);
drop = v;
                    }
                });
            }
            _yuitest_coverline("dd-ddm-drop", 393);
return drop;
        }
    }, true);
