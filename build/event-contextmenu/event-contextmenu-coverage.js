...
_yuitest_coverage["/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 16);
var Event = Y.Event,
    DOM = Y.DOM,
    UA = Y.UA,
    OS = Y.UA.os,
    ...
    conf = {
        ...
        on: function (node, subscription, notifier, filter) {
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "on", 33);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 35);
var handles = [];

            _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 37);
handles.push(Event._attach(["contextmenu", function (e) {
                ...
                _yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "(anonymous 2)", 37);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 42);
e.preventDefault();

                _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 44);
var id = Y.stamp(node),
                    data = eventData[id];

                _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 47);
if (data) {
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 48);
e.clientX = data.clientX;
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 49);
e.clientY = data.clientY;
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 50);
e.pageX = data.pageX;
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 51);
e.pageY = data.pageY;
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 52);
delete eventData[id];
                }

                _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 55);
notifier.fire(e);

            }, node]));


            _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 60);
handles.push(node[filter ? "delegate" : "on"]("keydown", function (e) {

                _yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "(anonymous 3)", 60);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 62);
var target = this.getDOMNode(),
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 86);
if ((isWin && (shiftF10 || menuKey)) ||
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 101);
if (((ie || (isWin && (gecko || opera))) && shiftF10) || macOperaShortcut) {
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 102);
e.preventDefault();
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 105);
xy = DOM.getXY(target);
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 106);
x = xy[0];
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 107);
y = xy[1];
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 108);
scrollX = DOM.docScrollX();
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 109);
scrollY = DOM.docScrollY();
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 113);
if (!Y.Lang.isUndefined(x)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 114);
clientX = (x + (target.offsetWidth/2)) - scrollX;
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 115);
clientY = (y + (target.offsetHeight/2)) - scrollY;
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 118);
pageX = clientX + scrollX;
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 119);
pageY = clientY + scrollY;
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 126);
if (menuKey || (isWin && webkit && shiftF10)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 127);
eventData[Y.stamp(node)] = { 
                    ...
                    _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 149);
if (((ie || (isWin && (gecko || opera))) && shiftF10) || isMac) {

                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 151);
e.clientX = clientX;
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 152);
e.clientY = clientY;
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 153);
e.pageX = pageX;
                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 154);
e.pageY = pageY;

                        _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 156);
notifier.fire(e);
                    }
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 163);
subscription._handles = handles;
        ...
        detach: function (node, subscription, notifier) {
            ...
            _yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "detach", 167);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 169);
Y.each(subscription._handles, function (handle) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", "(anonymous 4)", 169);
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 170);
handle.detach();
            });
...
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 178);
conf.delegate = conf.on;
_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 179);
conf.detachDelegate = conf.detach;


_yuitest_coverline("/home/yui/src/yui3/src/event/build_tmp/event-contextmenu.js", 182);
