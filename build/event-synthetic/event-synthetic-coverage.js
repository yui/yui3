 ...
 * @since 3.2.0
 */
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 35);
function Notifier(handle, emitFacade) {
    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "Notifier", 35);
 ...
 * @private
 */
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 64);
Notifier.prototype.fire = function (e) {
    // first arg to delegate notifier should be an object with currentTarget
    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "fire", 64);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 66);
var args     = toArray(arguments, 0, true),
    ...
    _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 75);
if (this.emitFacade) {
...
event = ce._getFacade();
            ...
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 79);
...
args[0] = event;
                ...
                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 83);
args.unshift(event);
            }
        }

        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 87);
event.type    = ce.type;
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 88);
event.details = args.slice();

        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 90);
if (delegate) {
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 91);
event.container = ce.host;
        }
    } else {_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 93);
if (delegate && isObject(e) && e.currentTarget) {
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 94);
args.shift();
    }}

    _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 97);
...
sub.context = thisObj; // reset for future firing
    ...
    _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 103);
return ret;
};
 ...
 * @private
 */
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 117);
function SynthRegistry(el, yuid, key) {
    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "SynthRegistry", 117);
...
SynthRegistry.prototype = {
    ...
    register: function (handle) {
        _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "register", 140);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 141);
...
this.handles.push(handle);
    ...
    unregister: function (sub) {
        _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "unregister", 152);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 153);
var handles = this.handles,
            events = DOMMap[this.domkey],
            i;

        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 157);
...
break;
        ...
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 165);
if (!handles.length) {
...
delete DOMMap[this.domkey];
     ...
     */
    detachAll : function () {
        _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "detachAll", 185);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 186);
var handles = this.handles,
            i = handles.length;
 ...
 * @in event-synthetic
 */
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 209);
function SyntheticEvent() {
    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "SyntheticEvent", 209);
...
Y.mix(SyntheticEvent, {
    ...
    getRegistry: function (node, type, create) {
        _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "getRegistry", 232);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 233);
var el     = node._node,
            yuid   = Y.stamp(el),
            key    = 'event:' + yuid + type + '_synth',
            events = DOMMap[yuid];
            
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 238);
if (create) {
...
events[key] = new SynthRegistry(el, yuid, key);
        ...
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 247);
return (events && events[key]) || null;
    ...
    _deleteSub: function (sub) {
        _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "_deleteSub", 259);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 260);
if (sub && sub.fn) {
...
delete sub.context;
    ...
    prototype: {
         ...
         */
        _init: function () {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "_init", 285);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 286);
var config = this.publishConfig || (this.publishConfig = {});

            // The notification mechanism handles facade creation
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 289);
...
config.emitFacade  = false;
        ...
        _on: function (args, delegate) {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "_on", 440);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 441);
var handles  = [],
            ...
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 449);
...
if (!nodes.length && isString(selector)) {
                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 454);
handle = Y.on('available', function () {
                    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "(anonymous 2)", 454);
...
Y.Array.each(nodes, function (node) {
                _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "(anonymous 3)", 461);
...
if (!this.preventDups ||
                    ...
                    {
                        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 478);
handles.push(this._subscribe(node, method, subArgs, extra, filter));
                    }
                }
            }, this);

            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 483);
return (handles.length === 1) ?
        ...
        _subscribe: function (node, method, args, extra, filter) {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "_subscribe", 509);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 510);
...
sub.node   = node;
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 517);
sub.filter = filter;
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 518);
if (extra) {
                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 519);
...
Y.mix(dispatcher, {
            ...
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 533);
handle.notifier = notifier;

            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 535);
registry.register(handle);

            // Call the implementation's "on" or "delegate" method
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 538);
this[method](node, sub, notifier, filter);

            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 540);
return handle;
        },
        ...
        applyArgExtras: function (extra, sub) {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "applyArgExtras", 561);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 562);
sub._extra = extra;
        },
        ...
        _detach: function (args) {
            ...
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "_detach", 575);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 578);
var target = args[2],
                els    = (isString(target)) ?
...
args.splice(2, 1);
            ...
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 586);
for (i = 0, len = els.length; i < len; ++i) {
                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 587);
node = Y.one(els[i]);

                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 589);
if (node) {
...
handles[j].detach();
        ...
        getSubs: function (node, args, filter, first) {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "getSubs", 617);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 618);
...
if (registry) {
                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 623);
allHandles = registry.handles;

                _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 625);
if (!filter) {
...
return handles.length && handles;
        ...
        subMatch: function (sub, args) {
            ...
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "subMatch", 663);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 665);
return !args[1] || sub.fn === args[1];
        }
    }
}, true);

_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 670);
 ...
 * @in event-synthetic
 */
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 781);
Y.Event.define = function (type, config, force) {
    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "define", 781);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 782);
var eventDef, Impl, synth;

    _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 784);
if (type && type.type) {
...
force = config;
    } else {_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 787);
if (config) {
...
if (force || !Y.Node.DOM_EVENTS[eventDef.type]) {
            _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 793);
Impl = function () {
                _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "Impl", 793);
...
Y.Node.DOM_EVENTS[type] = Y.Env.evt.plugins[type] = {
                ...
                on: function () {
                    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "on", 804);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 805);
return synth._on(toArray(arguments));
                },

                delegate: function () {
                    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "delegate", 808);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 809);
return synth._on(toArray(arguments), true);
                },

                detach: function () {
                    _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "detach", 812);
...
return synth._detach(toArray(arguments));
    ...
    } else {_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 818);
if (isString(type) || isArray(type)) {
        _yuitest_coverline("/build/event-synthetic/event-synthetic.js", 819);
Y.Array.each(toArray(type), function (t) {
            _yuitest_coverfunc("/build/event-synthetic/event-synthetic.js", "(anonymous 4)", 819);
_yuitest_coverline("/build/event-synthetic/event-synthetic.js", 820);
