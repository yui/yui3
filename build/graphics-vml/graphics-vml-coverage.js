...
return this.node;
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2283);
...
return val;
	...
	graphic: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2302);
...
VMLPath = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLPath", 2319);
...
VMLPath.ATTRS = Y.merge(Y.VMLShape.ATTRS, {
	...
	width: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2334);
...
return val;
	...
	height: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2348);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2350);
return Math.max(this._bottom - this._top, 0);
	...
	path: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2364);
...
VMLRect = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLRect", 2381);
...
VMLRect.NAME = "rect"; 
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2386);
...
VMLEllipse = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLEllipse", 2408);
...
VMLEllipse.ATTRS = Y.merge(Y.VMLShape.ATTRS, {
	...
	xRadius: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2435);
...
return val;
	...
	yRadius: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2460);
...
return val;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2467);
...
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLCircle", 2486);
...
VMLCircle.ATTRS = Y.merge(VMLShape.ATTRS, {
	...
	width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2524);
...
return val;
		...
		getter: function()
		{   
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2530);
...
return val;
	...
	height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2545);
...
return val;
		...
		getter: function()
		{   
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2551);
...
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLPieSlice", 2567);
...
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2572);
Y.extend(VMLPieSlice, Y.VMLShape, Y.mix({
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_draw", 2588);
...
VMLGraphic = function() {
    _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLGraphic", 2649);
...
VMLGraphic.ATTRS = {
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "valueFn", 2671);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2676);
...
return val;
    ...
    shapes: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2697);
...
return this._shapes;
    ...
    contentBounds: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2712);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2714);
return this._contentBounds;
    ...
    node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2727);
...
return this._node;
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2740);
...
return val;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2757);
...
return val;
    ...
    x: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2831);
...
return this._x;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2836);
...
return val;
    ...
    y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2854);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2859);
...
return val;
    ...
    visible: {
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2886);
...
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2894);
Y.extend(VMLGraphic, Y.GraphicBase, {
	...
	{
		_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "set", 2904);
...
forceRedraw = true;
            ...
            else {_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2922);
...
host._redraw();
    ...
    getXY: function()
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getXY", 2964);
...
return xy;
    ...
    initializer: function(config) {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "initializer", 2989);
...
this._node.style.visibility = "visible";
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_calculateCoordOrigin", 3457);
...
return coord;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_getUpdatedContentBounds", 3482);
...
return box;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_toFront", 3516);
...
contentNode.appendChild(shape);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_toBack", 3536);
