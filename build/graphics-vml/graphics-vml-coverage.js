...
return this.node;
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2281);
...
return val;
	...
	graphic: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2300);
...
VMLPath = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLPath", 2317);
...
return val;
	...
	height: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2346);
...
VMLRect = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLRect", 2379);
...
VMLEllipse = function()
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLEllipse", 2406);
...
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2413);
...
VMLEllipse.ATTRS = Y.merge(Y.VMLShape.ATTRS, {
	...
	xRadius: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2433);
...
return val;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2440);
...
return val;
	...
	yRadius: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2458);
...
return val;
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2465);
...
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLCircle", 2484);
...
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2491);
...
VMLCircle.ATTRS = Y.merge(VMLShape.ATTRS, {
	...
	width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2522);
...
return val;
		...
		getter: function()
		{   
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2528);
...
return val;
	...
	height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2543);
...
return val;
		...
		getter: function()
		{   
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2549);
...
{
	_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLPieSlice", 2565);
...
Y.extend(VMLPieSlice, Y.VMLShape, Y.mix({
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_draw", 2586);
...
VMLGraphic = function() {
    _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "VMLGraphic", 2647);
...
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2653);
VMLGraphic.ATTRS = {
    /**
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "valueFn", 2669);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2674);
...
return val;
    ...
    shapes: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2695);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2697);
return this._shapes;
        }
    },
    ...
    contentBounds: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2710);
...
return this._contentBounds;
    ...
    node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2725);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2727);
return this._node;
        }
    },
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2738);
...
return val;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2755);
...
return val;
    ...
    x: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2829);
...
return this._x;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2834);
...
return val;
    ...
    y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getter", 2852);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2857);
...
return val;
    ...
    visible: {
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setter", 2884);
...
Y.extend(VMLGraphic, Y.GraphicBase, {
	...
	{
		_yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "set", 2902);
...
forceRedraw = true;
            ...
            else {_yuitest_coverline("build/graphics-vml/graphics-vml.js", 2920);
...
if(forceRedraw)
        {
            _yuitest_coverline("build/graphics-vml/graphics-vml.js", 2934);
host._redraw();
        }
	},
    ...
    getXY: function()
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getXY", 2962);
...
xy = Y.DOM._getOffset(this._node);
        ...
        _yuitest_coverline("build/graphics-vml/graphics-vml.js", 2978);
return xy;
    },
    ...
    initializer: function(config) {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "initializer", 2987);
...
this.render(render);
    ...
    render: function(render) {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "render", 3014);
...
return this;
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "destroy", 3031);
...
Y.one(this._node).remove(true);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "addShape", 3044);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_appendShape", 3065);
...
this._getDocFrag().appendChild(node);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "removeShape", 3085);
...
this._redraw();
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "removeAllShapes", 3111);
...
this._shapes = {};
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_removeChildren", 3132);
...
node.removeChild(child);
     ...
     */
    clear: function() {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "clear", 3151);
...
this._removeChildren(this._node);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_toggleVisible", 3163);
...
this._node.style.visibility = visibility;
    ...
    setSize: function(w, h) {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setSize", 3195);
...
this._node.style.height = h + 'px';
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "setPosition", 3209);
...
this._node.style.top = y + "px";
    ...
    _createGraphic: function() {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_createGraphic", 3223);
...
return group;
    ...
    _createGraphicNode: function(type)
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_createGraphicNode", 3237);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 3239);
return DOCUMENT.createElement('<' + type + ' xmlns="urn:schemas-microsft.com:vml" style="behavior:url(#default#VML);display:inline-block;zoom:1;" />');
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "getShapeById", 3250);
_yuitest_coverline("build/graphics-vml/graphics-vml.js", 3252);
return this._shapes[id];
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_getShapeClass", 3263);
...
return val;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "batch", 3294);
...
this.set("autoDraw", autoDraw);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_getDocFrag", 3309);
...
return this._frag;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "addToRedrawQueue", 3325);
...
this._redraw();
    ...
    _redraw: function()
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_redraw", 3354);
...
this._node.style.visibility = "visible";
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_calculateCoordOrigin", 3455);
...
return coord;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_getUpdatedContentBounds", 3480);
...
return box;
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_toFront", 3514);
...
contentNode.appendChild(shape);
    ...
    {
        _yuitest_coverfunc("build/graphics-vml/graphics-vml.js", "_toBack", 3534);
