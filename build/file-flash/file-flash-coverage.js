...
_yuitest_coverage["/home/yui/src/yui3/src/file/build_tmp/file-flash.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('file-flash', function(Y) {
    ...
    _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 16);
var FileFlash = function(o) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "FileFlash", 16);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 17);
FileFlash.superclass.constructor.apply(this, arguments);   
    };

    _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 20);
Y.extend(FileFlash, Y.Base, {
        ...
        */
        initializer : function (cfg) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "initializer", 28);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 29);
if (!this.get("id")) {
                _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 30);
this._set("id", Y.guid("file"));
        ...
        */      
        _swfEventHandler: function (event) {
          _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "_swfEventHandler", 41);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 42);
if (event.id === this.get("id")) {
          _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 43);
switch (event.type) {
            /**
             ...
             */
            case "uploadstart":
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 56);
this.fire("uploadstart", {uploader: this.get("uploader")});
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 57);
break;
            case "uploadprogress":
                   ...
                   *  </dl>
                   */
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 77);
this.fire("uploadprogress", {originEvent: event,
                 ...
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 82);
this._set("bytesUploaded", event.bytesLoaded);
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 83);
break;
            case "uploadcomplete":
                   ...
                   *  </dl>
                   */
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 97);
this.fire("uploadfinished", {originEvent: event});
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 98);
break;
            case "uploadcompletedata":
                 ...
                 *  </dl>
                 */
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 113);
this.fire("uploadcomplete", {originEvent: event,
                                              data: event.data});  
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 115);
break;
            case "uploadcancel":
                 ...
                 *  </dl>
                 */
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 129);
this.fire("uploadcancel", {originEvent: event});
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 130);
break;
            case "uploaderror":
                 ...
                 *  </dl>
                 */
                 _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 152);
this.fire("uploaderror", {originEvent: event, status: event.status, statusText: event.message, source: event.source});         
        ...
        */
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "startUpload", 166);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 168);
if (this.get("uploader")) {

            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 170);
var myUploader = this.get("uploader"),
                fileField = fileFieldName || "Filedata",
                id = this.get("id"),
                params = parameters || null;

            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 175);
this._set("bytesUploaded", 0);
            
            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 177);
myUploader.on("uploadstart", this._swfEventHandler, this);
            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 178);
myUploader.on("uploadprogress", this._swfEventHandler, this);
            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 179);
myUploader.on("uploadcomplete", this._swfEventHandler, this);
            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 180);
myUploader.on("uploadcompletedata", this._swfEventHandler, this);
            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 181);
myUploader.on("uploaderror", this._swfEventHandler, this);

            _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 183);
myUploader.callSWF("upload", [id, url, params, fileField]);
        ...
        */  
        cancelUpload: function () {
         _yuitest_coverfunc("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", "cancelUpload", 193);
_yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 194);
if (this.get("uploader")) {
           _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 195);
this.get("uploader").callSWF("cancel", [this.get("id")]);
           _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 196);
this.fire("uploadcancel");
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/file/build_tmp/file-flash.js", 338);
