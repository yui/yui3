...
_yuitest_coverage["/home/yui/src/yui3/src/test-console/build_tmp/test-console.js"].lines = {"1":0,"33":0,"34":0,"37":0,"39":0,"41":0,"56":0,"66":0,"67":0,"68":0,"71":0,"86":0,"87":0,"88":0,"89":0,"90":0,"92":0,"93":0,"94":0,"95":0,"99":0,"100":0,"102":0,"107":0,"109":0,"111":0,"112":0,"113":0};
_yuitest_coverage["/home/yui/src/yui3/src/test-console/build_tmp/test-console.js"].functions = {"TestConsole:33":0,"initializer:38":0,"(anonymous 2):86":0,"_parseCoverage:65":0,"_onEntry:106":0,"(anonymous 1):1":0};
_yuitest_coverage["/home/yui/src/yui3/src/test-console/build_tmp/test-console.js"].coveredLines = 28;
_yuitest_coverage["/home/yui/src/yui3/src/test-console/build_tmp/test-console.js"].coveredFunctions = 6;
...
this.plug(Y.Plugin.ConsoleFilters, {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 56);
Y.Test.Runner.on('complete', Y.bind(this._parseCoverage, this));
    ...
    */
    _parseCoverage: function() {
        _yuitest_coverfunc("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", "_parseCoverage", 65);
_yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 66);
var coverage = Y.Test.Runner.getCoverage();
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 67);
if (!coverage) {
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 68);
return;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 71);
var cov = {
            lines: {
                hit: 0,
                miss: 0,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 86);
Y.Object.each(coverage, function(info) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", "(anonymous 2)", 86);
_yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 87);
cov.lines.total += info.coveredLines;
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 88);
cov.lines.hit += info.calledLines;
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 89);
cov.lines.miss += (info.coveredLines - info.calledLines);
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 90);
cov.lines.percent = Math.floor((cov.lines.hit / cov.lines.total) * 100);
            
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 92);
cov.functions.total += info.coveredFunctions;
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 93);
cov.functions.hit += info.calledFunctions;
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 94);
cov.functions.miss += (info.coveredFunctions - info.calledFunctions);
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 95);
cov.functions.percent = Math.floor((cov.functions.hit / cov.functions.total) * 100);
        });

        
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 99);
var coverageLog = 'Lines: Hit:' + cov.lines.hit + ' Missed:' + cov.lines.miss + ' Total:' + cov.lines.total + ' Percent:' + cov.lines.percent + '%\n';
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 100);
coverageLog += 'Functions: Hit:' + cov.functions.hit + ' Missed:' + cov.functions.miss + ' Total:' + cov.functions.total + ' Percent:' + cov.functions.percent + '%';
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 102);
this.log('Coverage: ' + coverageLog, 'info', 'TestRunner');
    },

    // -- Protected Event Handlers ---------------------------------------------
    _onEntry: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", "_onEntry", 106);
_yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 107);
var msg = e.message;

        _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 109);
if (msg.category === 'info'
                && /\s(?:case|suite)\s|yuitests\d+|began/.test(msg.message)) {
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 111);
msg.category = 'status';
        } else {_yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 112);
if (msg.category === 'fail') {
            _yuitest_coverline("/home/yui/src/yui3/src/test-console/build_tmp/test-console.js", 113);
this.printBuffer();
        }}
    }
}, {
