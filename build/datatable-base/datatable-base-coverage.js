...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js"].coveredLines = 54;
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js"].coveredFunctions = 19;
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 1);
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 218);
Y.DataTable.Base = Y.Base.create('datatable', Y.Widget, [Y.DataTable.Core], {
    ...
    **/
    delegate: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "delegate", 235);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 236);
var contentBox = this.get('contentBox');

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 238);
return contentBox.delegate.apply(contentBox, arguments);
    ...
    **/
    destructor: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "destructor", 248);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 249);
if (this.view) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 250);
this.view.destroy();
        }
    },
    ...
    **/
    getCell: function (seed, shift) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "getCell", 283);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 284);
return this.view && this.view.getCell &&
    ...
    **/
    getRow: function (id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "getRow", 301);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 302);
return this.view && this.view.getRow &&
    ...
    **/
    ...
    _afterDisplayColumnsChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "_afterDisplayColumnsChange", 316);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 317);
this._extractDisplayColumns(e.newVal || []);
    ...
    **/
    bindUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "bindUI", 327);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 328);
this._eventHandles.relayCoreChanges = this.after(
    ...
    **/
    _defRenderViewFn: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "_defRenderViewFn", 345);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 346);
e.view.render();
    },
    ...
    **/
    ...
    _extractDisplayColumns: function (columns) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "_extractDisplayColumns", 359);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 360);
var displayColumns = [];

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 362);
function process(cols) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "process", 362);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 363);
var i, len, col;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 365);
for (i = 0, len = cols.length; i < len; ++i) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 366);
col = cols[i];

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 368);
if (Y.Lang.isArray(col.children)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 369);
process(col.children);
                } else {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 371);
displayColumns.push(col);
                }
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 376);
process(columns);
        ...
        @since 3.5.0
        **/
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 386);
this._displayColumns = displayColumns;
    ...
    **/
    initializer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "initializer", 397);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 398);
this.publish('renderView', {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 404);
this._extractDisplayColumns(this.get('columns') || []);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 409);
this.after('columnsChange', Y.bind('_afterDisplayColumnsChange', this));
    ...
    **/
    _relayCoreAttrChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "_relayCoreAttrChange", 420);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 421);
var attr = (e.attrName === 'data') ? 'modelList' : e.attrName;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 423);
this.view.set(attr, e.newVal);
    ...
    **/
    renderUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "renderUI", 434);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 435);
var self = this,
            View = this.get('view');

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 438);
if (View) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 439);
this.view = new View(
                Y.merge(
                    this.getAttrs(),
                    {
            ...
            // on this instance.
            // TODO: Remove this?
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 452);
if (!this._eventHandles.legacyFeatureProps) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 453);
this._eventHandles.legacyFeatureProps = this.view.after({
                    renderHeader: function (e) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "renderHeader", 454);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 455);
self.head = e.view;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 456);
self._theadNode = e.view.theadNode;
                        ...
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 460);
self._tableNode = e.view.get('container');
                    },
                    renderFooter: function (e) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "renderFooter", 462);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 463);
self.foot = e.view;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 464);
self._tfootNode = e.view.tfootNode;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 465);
self._tableNode = e.view.get('container');
                    },
                    renderBody: function (e) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "renderBody", 467);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 468);
self.body = e.view;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 469);
self._tbodyNode = e.view.tbodyNode;
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 470);
self._tableNode = e.view.get('container');
                    },
                    ...
                    renderTable: function (e) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "renderTable", 474);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 475);
var contentBox = this.get('container');

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 477);
self._tableNode = this.tableNode ||
                        ...
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 485);
self._captionNode = this.captionNode ||
                            contentBox.one('caption');

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 488);
if (!self._theadNode) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 489);
self._theadNode = contentBox.one(
                                '.' + this.getClassName('columns') + ', thead');
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 493);
if (!self._tbodyNode) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 494);
self._tbodyNode = contentBox.one(
                                '.' + this.getClassName('data') + ', tbody');
                        }

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 498);
if (!self._tfootNode) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 499);
self._tfootNode = contentBox.one(
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 509);
this.view.addTarget(this);
    ...
    **/
    syncUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "syncUI", 519);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 520);
if (this.view) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 521);
this.fire('renderView', { view: this.view });
    ...
    **/
    _validateView: function (val) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", "_validateView", 533);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 535);
...
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-base.js", 678);
Y.DataTable = Y.mix(
