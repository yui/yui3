...
Y.mix(Y.namespace("Date"), Dt);
 ...
 /**
 * DataType.Date is an alias for Date.
 * @class DataType.Date
 * @static
 */
_yuitest_coverline("build/datatype-date-format/datatype-date-format.js", 302);
Y.namespace("DataType");
_yuitest_coverline("build/datatype-date-format/datatype-date-format.js", 303);
