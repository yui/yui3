...
_yuitest_coverage["build/jsonp-url/jsonp-url.js"].lines = {"1":0,"3":0,"17":0,"55":0,"60":0,"62":0,"65":0,"66":0,"70":0,"71":0,"76":0,"77":0,"78":0,"79":0,"80":0,"86":0,"92":0,"109":0,"112":0,"113":0,"116":0,"118":0,"119":0,"121":0,"122":0,"123":0,"125":0};
...
_yuitest_coverage["build/jsonp-url/jsonp-url.js"].coveredLines = 27;
...
callback = this._template.replace(callbackRE, proxy);
        ...
        _yuitest_coverline("build/jsonp-url/jsonp-url.js", 118);
if (this._pattern.test(url)) {
            _yuitest_coverline("build/jsonp-url/jsonp-url.js", 119);
return url.replace(this._pattern, callback);
        } else {
            _yuitest_coverline("build/jsonp-url/jsonp-url.js", 121);
lastChar = url.slice(-1);
            _yuitest_coverline("build/jsonp-url/jsonp-url.js", 122);
if (lastChar !== '&' && lastChar !== '?') {
                _yuitest_coverline("build/jsonp-url/jsonp-url.js", 123);
url += (url.indexOf('?') > -1) ? '&' : '?';
            }
            _yuitest_coverline("build/jsonp-url/jsonp-url.js", 125);
return url + callback;
        }
    }
