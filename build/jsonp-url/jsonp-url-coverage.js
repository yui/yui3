...
_yuitest_coverage["/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 17);
Y.mix(JSONPRequest.prototype, {
    ...
    _defaultCallback: function (url) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", "_defaultCallback", 54);
_yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 55);
var match = url.match(this._pattern),
            keys  = [],
            i = 0,
            locator, path, callback;

        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 60);
if (match) {
            // Strip the ["string keys"] and [1] array indexes
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 62);
locator = match[1]
                .replace(/\[(['"])(.*?)\1\]/g,
                    function (x, $1, $2) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", "(anonymous 2)", 64);
_yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 65);
keys[i] = $2;
                        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 66);
return '.@' + (i++);
                    })
                .replace(/\[(\d+)\]/g,
                    function (x, $1) {
                        _yuitest_coverfunc("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", "(anonymous 3)", 69);
_yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 70);
keys[i] = parseInt($1, 10) | 0;
                        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 71);
return '.@' + (i++);
                    })
                .replace(/^\./, ''); // remove leading dot

            // Validate against problematic characters.
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 76);
if (!/[^\w\.\$@]/.test(locator)) {
                _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 77);
path = locator.split('.');
                _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 78);
for (i = path.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 79);
if (path[i].charAt(0) === '@') {
                        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 80);
path[i] = keys[parseInt(path[i].substr(1), 10)];
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 86);
callback = getByPath(Y.config.win, path) ||
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 92);
return callback || noop;
    ...
    _format: function (url, proxy) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", "_format", 108);
_yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 109);
var callback = this._template.replace(/\{callback\}/, proxy),
            lastChar;

        _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 112);
if (this._pattern.test(url)) {
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 113);
return url.replace(this._pattern, callback);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 115);
lastChar = url.slice(-1);
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 116);
if (lastChar !== '&' && lastChar !== '?') {
                _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 117);
url += (url.indexOf('?') > -1) ? '&' : '?';
            }
            _yuitest_coverline("/home/yui/src/yui3/src/jsonp/build_tmp/jsonp-url.js", 119);
return url + callback;
        }
    }
