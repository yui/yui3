...
YUI.add('editor-para', function (Y, NAME) {
    ...
    _yuitest_coverfunc("editor-para", "(anonymous 1)", 1);
_yuitest_coverline("editor-para", 14);
var EditorPara = function() {
        _yuitest_coverfunc("editor-para", "EditorPara", 14);
_yuitest_coverline("editor-para", 15);
EditorPara.superclass.constructor.apply(this, arguments);
    ...
    _yuitest_coverline("editor-para", 20);
Y.extend(EditorPara, Y.Plugin.EditorParaBase, {
        ...
        */
        _onNodeChange: function(e) {
            _yuitest_coverfunc("editor-para", "_onNodeChange", 26);
_yuitest_coverline("editor-para", 27);
var host = this.get(HOST), inst = host.getInstance(),
            ...
            _yuitest_coverline("editor-para", 32);
switch (e.changedType) {
                case 'enter-up':
                    _yuitest_coverline("editor-para", 34);
var para = ((this._lastPara) ? this._lastPara : e.changedNode),
                        b = para.one('br.yui-cursor');

                    _yuitest_coverline("editor-para", 37);
if (this._lastPara) {
                        _yuitest_coverline("editor-para", 38);
delete this._lastPara;
                    }

                    _yuitest_coverline("editor-para", 41);
if (b) {
                        _yuitest_coverline("editor-para", 42);
if (b.previous() || b.next()) {
                            _yuitest_coverline("editor-para", 43);
if (b.ancestor(P)) {
                                _yuitest_coverline("editor-para", 44);
b.remove();
                            }
                        }
                    }
                    _yuitest_coverline("editor-para", 48);
if (!para.test(btag)) {
                        _yuitest_coverline("editor-para", 49);
var para2 = para.ancestor(btag);
                        _yuitest_coverline("editor-para", 50);
if (para2) {
                            _yuitest_coverline("editor-para", 51);
para = para2;
                            _yuitest_coverline("editor-para", 52);
para2 = null;
                        }
                    }
                    _yuitest_coverline("editor-para", 55);
if (para.test(btag)) {
                        _yuitest_coverline("editor-para", 56);
var prev = para.previous(), lc, lc2, found = false;
                        _yuitest_coverline("editor-para", 57);
if (prev) {
                            _yuitest_coverline("editor-para", 58);
lc = prev.one(LAST_CHILD);
                            _yuitest_coverline("editor-para", 59);
while (!found) {
                                _yuitest_coverline("editor-para", 60);
if (lc) {
                                    _yuitest_coverline("editor-para", 61);
lc2 = lc.one(LAST_CHILD);
                                    _yuitest_coverline("editor-para", 62);
if (lc2) {
                                        _yuitest_coverline("editor-para", 63);
lc = lc2;
                                    } else {
                                        _yuitest_coverline("editor-para", 65);
found = true;
                                    }
                                } else {
                                    _yuitest_coverline("editor-para", 68);
found = true;
                                }
                            }
                            _yuitest_coverline("editor-para", 71);
if (lc) {
                                _yuitest_coverline("editor-para", 72);
host.copyStyles(lc, para);
                            }
                        }
                    }
                    _yuitest_coverline("editor-para", 76);
break;
                case 'enter':
                    _yuitest_coverline("editor-para", 78);
if (Y.UA.webkit) {
                        //Webkit doesn't support shift+enter as a BR, this fixes that.
                        _yuitest_coverline("editor-para", 80);
if (e.changedEvent.shiftKey) {
                            _yuitest_coverline("editor-para", 81);
host.execCommand('insertbr');
                            _yuitest_coverline("editor-para", 82);
e.changedEvent.preventDefault();
                        }
                    }
                    _yuitest_coverline("editor-para", 85);
if (e.changedNode.test('li') && !Y.UA.ie) {
                        _yuitest_coverline("editor-para", 86);
html = inst.EditorSelection.getText(e.changedNode);
                        _yuitest_coverline("editor-para", 87);
if (html === '') {
                            _yuitest_coverline("editor-para", 88);
par = e.changedNode.ancestor('ol,ul');
                            _yuitest_coverline("editor-para", 89);
var dir = par.getAttribute('dir');
                            _yuitest_coverline("editor-para", 90);
if (dir !== '') {
                                _yuitest_coverline("editor-para", 91);
dir = ' dir = "' + dir + '"';
                            }
                            _yuitest_coverline("editor-para", 93);
par = e.changedNode.ancestor(inst.EditorSelection.BLOCKS);
                            _yuitest_coverline("editor-para", 94);
d = inst.Node.create('<p' + dir + '>' + inst.EditorSelection.CURSOR + '</p>');
                            _yuitest_coverline("editor-para", 95);
par.insert(d, 'after');
                            _yuitest_coverline("editor-para", 96);
e.changedNode.remove();
                            _yuitest_coverline("editor-para", 97);
e.changedEvent.halt();

                            _yuitest_coverline("editor-para", 99);
sel = new inst.EditorSelection();
                            _yuitest_coverline("editor-para", 100);
sel.selectNode(d, true, false);
                        }
                    }
                    //TODO Move this to a GECKO MODULE - Can't for the moment, requires no change to metadata (YMAIL)
                    _yuitest_coverline("editor-para", 104);
if (Y.UA.gecko && host.get('defaultblock') !== 'p') {
                        _yuitest_coverline("editor-para", 105);
par = e.changedNode;

                        _yuitest_coverline("editor-para", 107);
if (!par.test(LI) && !par.ancestor(LI)) {
                            _yuitest_coverline("editor-para", 108);
if (!par.test(btag)) {
                                _yuitest_coverline("editor-para", 109);
par = par.ancestor(btag);
                            }
                            _yuitest_coverline("editor-para", 111);
d = inst.Node.create('<' + btag + '></' + btag + '>');
                            _yuitest_coverline("editor-para", 112);
par.insert(d, 'after');
                            _yuitest_coverline("editor-para", 113);
sel = new inst.EditorSelection();
                            _yuitest_coverline("editor-para", 114);
if (sel.anchorOffset) {
                                _yuitest_coverline("editor-para", 115);
inHTML = sel.anchorNode.get('textContent');

                                _yuitest_coverline("editor-para", 117);
txt = inst.one(inst.config.doc.createTextNode(inHTML.substr(0, sel.anchorOffset)));
                                _yuitest_coverline("editor-para", 118);
txt2 = inst.one(inst.config.doc.createTextNode(inHTML.substr(sel.anchorOffset)));

                                _yuitest_coverline("editor-para", 120);
aNode = sel.anchorNode;
                                _yuitest_coverline("editor-para", 121);
aNode.setContent(''); //I
                                _yuitest_coverline("editor-para", 122);
node2 = aNode.cloneNode(); //I
                                _yuitest_coverline("editor-para", 123);
node2.append(txt2); //text
                                _yuitest_coverline("editor-para", 124);
top = false;
                                _yuitest_coverline("editor-para", 125);
sib = aNode; //I
                                _yuitest_coverline("editor-para", 126);
while (!top) {
                                    _yuitest_coverline("editor-para", 127);
sib = sib.get(PARENT_NODE); //B
                                    _yuitest_coverline("editor-para", 128);
if (sib && !sib.test(btag)) {
                                        _yuitest_coverline("editor-para", 129);
n = sib.cloneNode();
                                        _yuitest_coverline("editor-para", 130);
n.set('innerHTML', '');
                                        _yuitest_coverline("editor-para", 131);
n.append(node2);
                                        
                                        //Get children..
                                        _yuitest_coverline("editor-para", 134);
childs = sib.get('childNodes');
                                        _yuitest_coverline("editor-para", 135);
var start = false;
                                        _yuitest_coverline("editor-para", 136);
childs.each(function(c) {
                                            _yuitest_coverfunc("editor-para", "(anonymous 2)", 136);
_yuitest_coverline("editor-para", 137);
if (start) {
                                                _yuitest_coverline("editor-para", 138);
n.append(c);
                                            }
                                            _yuitest_coverline("editor-para", 140);
if (c === aNode) {
                                                _yuitest_coverline("editor-para", 141);
start = true;
                                            }
                                        });

                                        _yuitest_coverline("editor-para", 145);
aNode = sib; //Top sibling
                                        _yuitest_coverline("editor-para", 146);
node2 = n;
                                    } else {
                                        _yuitest_coverline("editor-para", 148);
top = true;
                                    }
                                }
                                _yuitest_coverline("editor-para", 151);
txt2 = node2;
                                _yuitest_coverline("editor-para", 152);
sel.anchorNode.append(txt);

                                _yuitest_coverline("editor-para", 154);
if (txt2) {
                                    _yuitest_coverline("editor-para", 155);
d.append(txt2);
                                }
                            }
                            _yuitest_coverline("editor-para", 158);
if (d.get(FC)) {
                                _yuitest_coverline("editor-para", 159);
d = d.get(FC);
                            }
                            _yuitest_coverline("editor-para", 161);
d.prepend(inst.EditorSelection.CURSOR);
                            _yuitest_coverline("editor-para", 162);
sel.focusCursor(true, true);
                            _yuitest_coverline("editor-para", 163);
html = inst.EditorSelection.getText(d);
                            _yuitest_coverline("editor-para", 164);
if (html !== '') {
                                _yuitest_coverline("editor-para", 165);
inst.EditorSelection.cleanCursor();
                            }
                            _yuitest_coverline("editor-para", 167);
e.changedEvent.preventDefault();
                        }
                    }
                    _yuitest_coverline("editor-para", 170);
break;
                case 'keyup':
                    _yuitest_coverline("editor-para", 172);
if (Y.UA.gecko) {
                        _yuitest_coverline("editor-para", 173);
if (inst.config.doc && inst.config.doc.body && inst.config.doc.body.innerHTML.length < 20) {
                            _yuitest_coverline("editor-para", 174);
if (!inst.one(FIRST_P)) {
                                _yuitest_coverline("editor-para", 175);
this._fixFirstPara();
                            }
                        }
                    }
                    _yuitest_coverline("editor-para", 179);
break;
                case 'backspace-up':
                case 'backspace-down':
                case 'delete-up':
                    _yuitest_coverline("editor-para", 183);
if (!Y.UA.ie) {
                        _yuitest_coverline("editor-para", 184);
ps = inst.all(FIRST_P);
                        _yuitest_coverline("editor-para", 185);
item = inst.one(BODY);
                        _yuitest_coverline("editor-para", 186);
if (ps.item(0)) {
                            _yuitest_coverline("editor-para", 187);
item = ps.item(0);
                        }
                        _yuitest_coverline("editor-para", 189);
br = item.one('br');
                        _yuitest_coverline("editor-para", 190);
if (br) {
                            _yuitest_coverline("editor-para", 191);
br.removeAttribute('id');
                            _yuitest_coverline("editor-para", 192);
br.removeAttribute('class');
                        }

                        _yuitest_coverline("editor-para", 195);
txt = inst.EditorSelection.getText(item);
                        _yuitest_coverline("editor-para", 196);
txt = txt.replace(/ /g, '').replace(/\n/g, '');
                        _yuitest_coverline("editor-para", 197);
imgs = item.all('img');
                        
                        _yuitest_coverline("editor-para", 199);
if (txt.length === 0 && !imgs.size()) {
                            //God this is horrible..
                            _yuitest_coverline("editor-para", 201);
if (!item.test(P)) {
                                _yuitest_coverline("editor-para", 202);
this._fixFirstPara();
                            }
                            _yuitest_coverline("editor-para", 204);
p = null;
                            _yuitest_coverline("editor-para", 205);
if (e.changedNode && e.changedNode.test(P)) {
                                _yuitest_coverline("editor-para", 206);
p = e.changedNode;
                            }
                            _yuitest_coverline("editor-para", 208);
if (!p && host._lastPara && host._lastPara.inDoc()) {
                                _yuitest_coverline("editor-para", 209);
p = host._lastPara;
                            }
                            _yuitest_coverline("editor-para", 211);
if (p && !p.test(P)) {
                                _yuitest_coverline("editor-para", 212);
p = p.ancestor(P);
                            }
                            _yuitest_coverline("editor-para", 214);
if (p) {
                                _yuitest_coverline("editor-para", 215);
if (!p.previous() && p.get(PARENT_NODE) && p.get(PARENT_NODE).test(BODY)) {
                                    _yuitest_coverline("editor-para", 216);
e.changedEvent.frameEvent.halt();
                                    _yuitest_coverline("editor-para", 217);
e.preventDefault();
                                }
                            }
                        }
                        _yuitest_coverline("editor-para", 221);
if (Y.UA.webkit) {
                            _yuitest_coverline("editor-para", 222);
if (e.changedNode) {
                                //All backspace calls in Webkit need a preventDefault to
                                //stop history navigation #2531299
                                _yuitest_coverline("editor-para", 225);
e.preventDefault();
                                _yuitest_coverline("editor-para", 226);
item = e.changedNode;
                                _yuitest_coverline("editor-para", 227);
if (item.test('li') && (!item.previous() && !item.next())) {
                                    _yuitest_coverline("editor-para", 228);
html = item.get('innerHTML').replace(BR, '');
                                    _yuitest_coverline("editor-para", 229);
if (html === '') {
                                        _yuitest_coverline("editor-para", 230);
if (item.get(PARENT_NODE)) {
                                            _yuitest_coverline("editor-para", 231);
item.get(PARENT_NODE).replace(inst.Node.create(BR));
                                            _yuitest_coverline("editor-para", 232);
e.changedEvent.frameEvent.halt();
                                            _yuitest_coverline("editor-para", 233);
inst.EditorSelection.filterBlocks();
                    ...
                    _yuitest_coverline("editor-para", 240);
if (Y.UA.gecko) {
                        /*
                        ...
                        */
                        _yuitest_coverline("editor-para", 247);
d = e.changedNode;
                        _yuitest_coverline("editor-para", 248);
t = inst.config.doc.createTextNode(' ');
                        _yuitest_coverline("editor-para", 249);
d.appendChild(t);
                        _yuitest_coverline("editor-para", 250);
d.removeChild(t);
                    }
                    _yuitest_coverline("editor-para", 252);
break;
            }
            _yuitest_coverline("editor-para", 254);
if (Y.UA.gecko) {
                _yuitest_coverline("editor-para", 255);
if (e.changedNode && !e.changedNode.test(btag)) {
                    _yuitest_coverline("editor-para", 256);
p = e.changedNode.ancestor(btag);
                    _yuitest_coverline("editor-para", 257);
if (p) {
                        _yuitest_coverline("editor-para", 258);
this._lastPara = p;
                    }
                }
            }
        ...
        initializer: function() {
            _yuitest_coverfunc("editor-para", "initializer", 264);
_yuitest_coverline("editor-para", 265);
var host = this.get(HOST);
            _yuitest_coverline("editor-para", 266);
if (host.editorBR) {
                _yuitest_coverline("editor-para", 267);
Y.error('Can not plug EditorPara and EditorBR at the same time.');
                _yuitest_coverline("editor-para", 268);
return;
            }

            _yuitest_coverline("editor-para", 271);
host.on(NODE_CHANGE, Y.bind(this._onNodeChange, this));
    ...
    _yuitest_coverline("editor-para", 293);
Y.namespace('Plugin');
    
    _yuitest_coverline("editor-para", 295);
