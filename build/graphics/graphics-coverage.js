 ...
 * @main graphics
 */
_yuitest_coverfunc("graphics", "(anonymous 1)", 1);
_yuitest_coverline("graphics", 32);
var SETTER = "setter",
	 ...
	 * @constructor
	 */
    _yuitest_coverline("graphics", 50);
AttributeLite = function()
    {
        _yuitest_coverfunc("graphics", "AttributeLite", 50);
_yuitest_coverline("graphics", 52);
var host = this; // help compression
        
        // Perf tweak - avoid creating event literals if not required.
        _yuitest_coverline("graphics", 55);
host._ATTR_E_FACADE = {};
        
        _yuitest_coverline("graphics", 57);
Y.EventTarget.call(this, {emitFacade:true});
        _yuitest_coverline("graphics", 58);
host._state = {};
        _yuitest_coverline("graphics", 59);
host.prototype = Y.mix(AttributeLite.prototype, host.prototype);
    };

    _yuitest_coverline("graphics", 62);
AttributeLite.prototype = {
		...
		{
			_yuitest_coverfunc("graphics", "addAttrs", 70);
_yuitest_coverline("graphics", 72);
var host = this,
				...
				fn,
				state = host._state;
			_yuitest_coverline("graphics", 78);
for(i in attrConfig)
			{
				_yuitest_coverline("graphics", 80);
if(attrConfig.hasOwnProperty(i))
				{
					_yuitest_coverline("graphics", 82);
attr = attrConfig[i];
					_yuitest_coverline("graphics", 83);
if(attr.hasOwnProperty(VALUE))
					{
						_yuitest_coverline("graphics", 85);
state[i] = attr.value;
					}
					else {_yuitest_coverline("graphics", 87);
if(attr.hasOwnProperty(VALUEFN))
					{
						_yuitest_coverline("graphics", 89);
fn = attr.valueFn;
						_yuitest_coverline("graphics", 90);
if(Y_LANG.isString(fn))
						{
							_yuitest_coverline("graphics", 92);
state[i] = host[fn].apply(host);
						}
						else
						{
							_yuitest_coverline("graphics", 96);
state[i] = fn.apply(host);
						}
					}}
			    }
            }
			_yuitest_coverline("graphics", 101);
host._state = state;
            _yuitest_coverline("graphics", 102);
for(i in attrConfig)
			{
				_yuitest_coverline("graphics", 104);
if(attrConfig.hasOwnProperty(i))
				{
					_yuitest_coverline("graphics", 106);
attr = attrConfig[i];
                    _yuitest_coverline("graphics", 107);
if(attr.hasOwnProperty(READONLY) && attr.readOnly)
					{
						_yuitest_coverline("graphics", 109);
continue;
					}

					_yuitest_coverline("graphics", 112);
if(attr.hasOwnProperty(WRITE_ONCE) && attr.writeOnce)
					{
						_yuitest_coverline("graphics", 114);
attr.readOnly = true;
					}

					_yuitest_coverline("graphics", 117);
if(cfg && cfg.hasOwnProperty(i))
					{
						_yuitest_coverline("graphics", 119);
if(attr.hasOwnProperty(SETTER))
						{
							_yuitest_coverline("graphics", 121);
host._state[i] = attr.setter.apply(host, [cfg[i]]);
						}
						else
						{
							_yuitest_coverline("graphics", 125);
host._state[i] = cfg[i];
						}
					}
				}
        ...
        get: function(attr)
        {
            _yuitest_coverfunc("graphics", "get", 139);
_yuitest_coverline("graphics", 141);
var host = this,
                getter,
                attrConfig = host.constructor.ATTRS;
            _yuitest_coverline("graphics", 144);
if(attrConfig && attrConfig[attr])
            {
                _yuitest_coverline("graphics", 146);
getter = attrConfig[attr].getter;
                _yuitest_coverline("graphics", 147);
if(getter)
                {
                    _yuitest_coverline("graphics", 149);
if(typeof getter == STR)
                    {
                        _yuitest_coverline("graphics", 151);
return host[getter].apply(host);
                    }
                    _yuitest_coverline("graphics", 153);
return attrConfig[attr].getter.apply(host);
                }

                _yuitest_coverline("graphics", 156);
return host._state[attr];
            }
            _yuitest_coverline("graphics", 158);
return null;
        },
        ...
        {
            _yuitest_coverfunc("graphics", "set", 170);
_yuitest_coverline("graphics", 172);
var i;
            _yuitest_coverline("graphics", 173);
if(Y_LANG.isObject(attr))
            {
                _yuitest_coverline("graphics", 175);
for(i in attr)
                {
                    _yuitest_coverline("graphics", 177);
if(attr.hasOwnProperty(i))
                    {
                        _yuitest_coverline("graphics", 179);
this._set(i, attr[i]);
                    }
                }
            }
            ...
            {
                _yuitest_coverline("graphics", 185);
this._set.apply(this, arguments);
		...
		{
			_yuitest_coverfunc("graphics", "_set", 199);
_yuitest_coverline("graphics", 201);
var host = this,
				setter,
				args,
				attrConfig = host.constructor.ATTRS;
			_yuitest_coverline("graphics", 205);
if(attrConfig && attrConfig.hasOwnProperty(attr))
			{
				_yuitest_coverline("graphics", 207);
setter = attrConfig[attr].setter;
				_yuitest_coverline("graphics", 208);
if(setter)
				{
					_yuitest_coverline("graphics", 210);
args = [val];
					_yuitest_coverline("graphics", 211);
if(typeof setter == STR)
					{
						_yuitest_coverline("graphics", 213);
val = host[setter].apply(host, args);
					}
					else
                    {
					    _yuitest_coverline("graphics", 217);
val = attrConfig[attr].setter.apply(host, args);
                    }
				}
				_yuitest_coverline("graphics", 220);
host._state[attr] = val;
			}
		}
	};
    _yuitest_coverline("graphics", 224);
Y.mix(AttributeLite, Y.EventTarget, false, null, 1);
	_yuitest_coverline("graphics", 225);
Y.AttributeLite = AttributeLite;
     ...
     */
    _yuitest_coverline("graphics", 236);
GraphicBase = function(cfg)
    {
        _yuitest_coverfunc("graphics", "GraphicBase", 236);
_yuitest_coverline("graphics", 238);
var host = this,
            PluginHost = Y.Plugin && Y.Plugin.Host;  
        _yuitest_coverline("graphics", 240);
if (host._initPlugins && PluginHost) {
            _yuitest_coverline("graphics", 241);
PluginHost.call(host);
        }
        
        _yuitest_coverline("graphics", 244);
host.name = host.constructor.NAME;
        _yuitest_coverline("graphics", 245);
host._eventPrefix = host.constructor.EVENT_PREFIX || host.constructor.NAME;
        _yuitest_coverline("graphics", 246);
AttributeLite.call(host);
        _yuitest_coverline("graphics", 247);
host.addAttrs(cfg);
        _yuitest_coverline("graphics", 248);
host.init.apply(this, arguments);
        _yuitest_coverline("graphics", 249);
if (host._initPlugins) {
            // Need to initPlugins manually, to handle constructor parsing, static Plug parsing
            _yuitest_coverline("graphics", 251);
host._initPlugins(cfg);
        }
        _yuitest_coverline("graphics", 253);
host.initialized = true;
    };

    _yuitest_coverline("graphics", 256);
GraphicBase.NAME = "baseGraphic";

    _yuitest_coverline("graphics", 258);
GraphicBase.prototype = {
        ...
        init: function()
        {
            _yuitest_coverfunc("graphics", "init", 266);
_yuitest_coverline("graphics", 268);
this.publish("init", {
                fireOnce:true
            });
            _yuitest_coverline("graphics", 271);
this.initializer.apply(this, arguments);
            _yuitest_coverline("graphics", 272);
this.fire("init", {cfg: arguments[0]});
        }
    };
//Straightup augment, no wrapper functions
_yuitest_coverline("graphics", 276);
Y.mix(GraphicBase, Y.AttributeLite, false, null, 1);
_yuitest_coverline("graphics", 277);
Y.mix(GraphicBase, PluginHost, false, null, 1);
_yuitest_coverline("graphics", 278);
GraphicBase.prototype.constructor = GraphicBase;
_yuitest_coverline("graphics", 279);
GraphicBase.plug = PluginHost.plug;
_yuitest_coverline("graphics", 280);
GraphicBase.unplug = PluginHost.unplug;
_yuitest_coverline("graphics", 281);
