...
_yuitest_coverage["/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @module stylesheet
 */
_yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 9);
var d      = Y.config.doc,
...
// property.
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 25);
_unsetOpacity = (OPACITY in workerStyle) ?
    function (style) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "(anonymous 2)", 26);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 26);
style.opacity = EMPTY; } :
    function (style) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "}", 27);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 27);
style.filter = EMPTY; };
...
// property.
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 32);
workerStyle.border = "1px solid red";
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 33);
workerStyle.border = EMPTY; // IE doesn't unset child properties
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 34);
_unsetProperty = workerStyle.borderLeft ?
    function (style,prop) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "(anonymous 3)", 35);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 36);
var p;
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 37);
if (prop !== floatAttr && prop.toLowerCase().indexOf(FLOAT) != -1) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 38);
prop = floatAttr;
        }
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 40);
if (isString(style[prop])) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 41);
switch (prop) {
                case OPACITY:
                case 'filter' : _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 43);
_unsetOpacity(style); break;
                case 'font'   :
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 45);
style.font       = style.fontStyle = style.fontVariant =
                    style.fontWeight = style.fontSize  = style.lineHeight  =
                    style.fontFamily = EMPTY;
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 48);
break;
                default       :
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 50);
for (p in style) {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 51);
if (p.indexOf(prop) === 0) {
                            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 52);
style[p] = EMPTY;
                        }
                    }
            }
    ...
    function (style,prop) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "}", 58);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 59);
if (prop !== floatAttr && prop.toLowerCase().indexOf(FLOAT) != -1) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 60);
prop = floatAttr;
        }
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 62);
if (isString(style[prop])) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 63);
if (prop === OPACITY) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 64);
_unsetOpacity(style);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 66);
style[prop] = EMPTY;
            }
        }
    };
 ...
 *              access
 */
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 107);
function StyleSheet(seed, name) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "StyleSheet", 107);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 108);
var head,
        node,
        sheet,
        cssRules = {},
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 118);
if (!(Y.instanceOf(this, StyleSheet))) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 119);
return new StyleSheet(seed,name);
    }

    // Extract the DOM node from Node instances
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 123);
if (seed) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 124);
if (Y.Node && seed instanceof Y.Node) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 125);
node = seed._node;
        } else {_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 126);
if (seed.nodeName) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 127);
node = seed;
        // capture the DOM node if the string is an id
        } else {_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 129);
if (isString(seed)) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 130);
if (seed && sheets[seed]) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 131);
return sheets[seed];
            }
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 133);
node = d.getElementById(seed.replace(/^#/,EMPTY));
        }}}

        // Check for the StyleSheet in the static registry
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 137);
if (node && sheets[Y.stamp(node)]) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 138);
return sheets[Y.stamp(node)];
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 144);
if (!node || !/^(?:style|link)$/i.test(node.nodeName)) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 145);
node = d.createElement('style');
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 146);
node.type = 'text/css';
    }

    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 149);
if (isString(seed)) {
        // Create entire sheet from seed cssText
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 151);
if (seed.indexOf('{') != -1) {
            // Not a load-time fork because low run-time impact and IE fails
            // test for s.styleSheet at page load time (oddly)
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 154);
if (node.styleSheet) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 155);
node.styleSheet.cssText = seed;
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 157);
node.appendChild(d.createTextNode(seed));
            }
        } else {_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 159);
if (!name) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 160);
name = seed;
        }}
    }

    // Make sure the node is attached to the appropriate head element
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 165);
if (!node.parentNode || node.parentNode.nodeName.toLowerCase() !== 'head') {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 166);
head = (node.ownerDocument || d).getElementsByTagName('head')[0];
        ...
        // change in Safari.
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 170);
head.appendChild(node);
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 177);
sheet = node.sheet || node.styleSheet;

    // 2. The style rules collection
    // IE stores the rules collection under the "rules" property
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 181);
_rules = sheet && ('cssRules' in sheet) ? 'cssRules' : 'rules';

    // 3. The method to remove a rule from the stylesheet
    // IE supports removeRule
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 185);
_deleteRule = ('deleteRule' in sheet) ?
        function (i) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "(anonymous 4)", 186);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 186);
sheet.deleteRule(i); } :
        function (i) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "}", 187);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 187);
sheet.removeRule(i); };

    // 4. The method to add a new rule to the stylesheet
    // IE supports addRule with different signature
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 191);
_insertRule = ('insertRule' in sheet) ?
        function (sel,css,i) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "(anonymous 5)", 192);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 192);
sheet.insertRule(sel+' {'+css+'}',i); } :
        function (sel,css,i) { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "}", 193);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 193);
sheet.addRule(sel,css,i); };
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 199);
for (i = sheet[_rules].length - 1; i >= 0; --i) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 200);
r   = sheet[_rules][i];
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 201);
sel = r.selectorText;

        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 203);
if (cssRules[sel]) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 204);
cssRules[sel].style.cssText += ';' + r.style.cssText;
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 205);
_deleteRule(i);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 207);
cssRules[sel] = r;
        }
    }

    // Cache the instance by the generated Id
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 212);
StyleSheet.register(Y.stamp(node),this);

    // Register the instance by name if provided or defaulted from seed
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 215);
if (name) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 216);
StyleSheet.register(name,this);
    }

    // Public API
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 220);
Y.mix(this,{
        /**
         ...
         */
        getId : function () { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "getId", 227);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 227);
return Y.stamp(node); },
         ...
         * @chainable
         */
        enable : function () { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "enable", 236);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 236);
sheet.disabled = false; return this; },
         ...
         * @chainable
         */
        disable : function () { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "disable", 246);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 246);
sheet.disabled = true; return this; },
         ...
         * @return {Boolean}
         */
        isEnabled : function () { _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "isEnabled", 254);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 254);
return !sheet.disabled; },
        ...
        set : function (sel,css) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "set", 274);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 275);
var rule = cssRules[sel],
                multi = sel.split(/\s*,\s*/),i,
                idx;

            // IE's addRule doesn't support multiple comma delimited selectors
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 280);
if (multi.length > 1) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 281);
for (i = multi.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 282);
this.set(multi[i], css);
                }
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 284);
return this;
            }

            // Some selector values can cause IE to hang
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 288);
if (!StyleSheet.isValidSelector(sel)) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 289);
return this;
            }
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 295);
if (rule) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 296);
rule.style.cssText = StyleSheet.toCssText(css,rule.style.cssText);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 298);
idx = sheet[_rules].length;
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 299);
css = StyleSheet.toCssText(css);
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 303);
if (css) {
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 304);
_insertRule(sel, css, idx);
                    ...
                    // added/removed
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 309);
cssRules[sel] = sheet[_rules][idx];
                }
            }
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 312);
return this;
        },
        ...
        unset : function (sel,css) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "unset", 335);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 336);
var rule = cssRules[sel],
                multi = sel.split(/\s*,\s*/),
                remove = !css,
                rules, i;
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 343);
if (multi.length > 1) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 344);
for (i = multi.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 345);
this.unset(multi[i], css);
                }
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 347);
return this;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 350);
if (rule) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 351);
if (!remove) {
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 352);
css = Y.Array(css);

                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 354);
workerStyle.cssText = rule.style.cssText;
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 355);
for (i = css.length - 1; i >= 0; --i) {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 356);
_unsetProperty(workerStyle,css[i]);
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 359);
if (workerStyle.cssText) {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 360);
rule.style.cssText = workerStyle.cssText;
                    } else {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 362);
remove = true;
                    }
                }

                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 366);
if (remove) { // remove the rule altogether
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 367);
rules = sheet[_rules];
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 368);
for (i = rules.length - 1; i >= 0; --i) {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 369);
if (rules[i] === rule) {
                            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 370);
delete cssRules[sel];
                            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 371);
_deleteRule(i);
                            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 372);
break;
                        }
                    }
                }
            }
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 377);
return this;
        },
        ...
        getCssText : function (sel) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "getCssText", 392);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 393);
var rule, css, selector;

            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 395);
if (isString(sel)) {
                // IE's addRule doesn't support multiple comma delimited
                // selectors so rules are mapped internally by atomic selectors
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 398);
rule = cssRules[sel.split(/\s*,\s*/)[0]];

                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 400);
return rule ? rule.style.cssText : null;
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 402);
css = [];
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 403);
for (selector in cssRules) {
                    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 404);
if (cssRules.hasOwnProperty(selector)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 405);
rule = cssRules[selector];
                        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 406);
css.push(rule.selectorText+" {"+rule.style.cssText+"}");
                    }
                }
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 409);
return css.join("\n");
            }
        }
    });
...
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 416);
_toCssText = function (css,base) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "_toCssText", 416);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 417);
var f    = css.styleFloat || css.cssFloat || css[FLOAT],
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 427);
try {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 428);
workerStyle.cssText = base || EMPTY;
    } catch (e) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 430);
p = d.createElement('p');
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 431);
workerStyle = p.style;
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 432);
workerStyle.cssText = base || EMPTY;
    }

    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 435);
if (f && !css[floatAttr]) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 436);
css = Y.merge(css);
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 437);
delete css.styleFloat; delete css.cssFloat; delete css[FLOAT];
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 438);
css[floatAttr] = f;
    }

    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 441);
for (prop in css) {
        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 442);
if (css.hasOwnProperty(prop)) {
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 443);
try {
                // IE throws Invalid Value errors and doesn't like whitespace
                // in values ala ' red' or 'red '
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 446);
workerStyle[prop] = trim(css[prop]);
    ...
    _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 452);
return workerStyle.cssText;
};

_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 455);
Y.mix(StyleSheet, {
    /**
    ...
    toCssText : ((OPACITY in workerStyle) ? _toCssText :
        ...
        function (css, cssText) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "_toCssText", 475);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 476);
if (OPACITY in css) {
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 477);
css = Y.merge(css,{
                        filter: 'alpha(opacity='+(css.opacity*100)+')'
                      });
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 480);
delete css.opacity;
            }
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 482);
return _toCssText(css,cssText);
    ...
    register : function (name,sheet) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "register", 495);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 496);
return !!(name && sheet instanceof StyleSheet &&
    ...
    isValidSelector : function (sel) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", "isValidSelector", 516);
_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 517);
var valid = false;

        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 519);
if (sel && isString(sel)) {

            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 521);
if (!selectors.hasOwnProperty(sel)) {
                // TEST: there should be nothing but white-space left after
                // these destructive regexs
                _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 524);
selectors[sel] = !/\S/.test(
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 540);
valid = selectors[sel];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 543);
return valid;
    }
},true);

_yuitest_coverline("/home/yui/src/yui3/src/stylesheet/build_tmp/stylesheet.js", 547);
