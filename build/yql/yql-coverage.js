...
_yuitest_coverage["/home/yui/src/yui3/src/yql/build_tmp/yql.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
YUI.add('yql', function(Y) {
     ...
     */
    _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 16);
var YQLRequest = function (sql, callback, params, opts) {
        
        _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "YQLRequest", 16);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 18);
if (!params) {
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 19);
params = {};
        }
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 21);
params.q = sql;
        //Allow format override.. JSON-P-X
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 23);
if (!params.format) {
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 24);
params.format = Y.YQLRequest.FORMAT;
        }
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 26);
if (!params.env) {
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 27);
params.env = Y.YQLRequest.ENV;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 30);
this._context = this;

        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 32);
if (opts && opts.context) {
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 33);
this._context = opts.context;
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 34);
delete opts.context;
        }
        
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 37);
if (params && params.context) {
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 38);
this._context = params.context;
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 39);
delete params.context;
        }
        
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 42);
this._params = params;
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 43);
this._opts = opts;
        _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 44);
this._callback = callback;

    };
    
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 48);
YQLRequest.prototype = {
        ...
        */
        _internal: function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "_internal", 84);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 85);
this._callback.apply(this._context, arguments);
        ...
        */
        send: function() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "send", 93);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 94);
var qs = [], url = ((this._opts && this._opts.proto) ? this._opts.proto : Y.YQLRequest.PROTO);

            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 96);
Y.each(this._params, function(v, k) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "(anonymous 2)", 96);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 97);
qs.push(k + '=' + encodeURIComponent(v));
            });

            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 100);
qs = qs.join('&');
            
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 102);
url += ((this._opts && this._opts.base) ? this._opts.base : Y.YQLRequest.BASE_URL) + qs;
            
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 104);
var o = (!Y.Lang.isFunction(this._callback)) ? this._callback : { on: { success: this._callback } };

            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 106);
o.on = o.on || {};
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 107);
this._callback = o.on.success;

            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 109);
o.on.success = Y.bind(this._internal, this);

            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 111);
if (o.allowCache !== false) {
                _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 112);
o.allowCache = true;
            }
            
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 115);
if (!this._jsonp) {
                _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 116);
this._jsonp = Y.jsonp(url, o);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 118);
this._jsonp.url = url;
                _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 119);
if (o.on && o.on.success) {
                    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 120);
this._jsonp._config.on.success = o.on.success;
                }
                _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 122);
this._jsonp.send();
            }
            _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 124);
return this;
        }
    };
    ...
    */
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 133);
YQLRequest.FORMAT = 'json';
    ...
    */
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 139);
YQLRequest.PROTO = 'http';
    ...
    */
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 145);
YQLRequest.BASE_URL = ':/'+'/query.yahooapis.com/v1/public/yql?';
    ...
    */
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 151);
YQLRequest.ENV = 'http:/'+'/datatables.org/alltables.env';
    
    _yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 153);
Y.YQLRequest = YQLRequest;
     ...
     * @param {Object} opts An object literal of configuration options (optional): proto (http|https), base (url)
     */
	_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 164);
Y.YQL = function(sql, callback, params, opts) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/yql/build_tmp/yql.js", "YQL", 164);
_yuitest_coverline("/home/yui/src/yui3/src/yql/build_tmp/yql.js", 165);
