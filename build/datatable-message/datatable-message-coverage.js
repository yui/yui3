...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 12);
var Message;
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 28);
Y.namespace('DataTable').Message = Message = function () {};

_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 30);
Message.ATTRS = {
    /**
...
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 47);
Y.mix(Message.prototype, {
    ...
    **/
    hideMessage: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "hideMessage", 66);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 67);
this.get('boundingBox').removeClass(
            this.getClassName('message', 'visible'));

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 70);
return this;
    },
    ...
    **/
    showMessage: function (message) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "showMessage", 84);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 85);
var content = this.getString(message) || message;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 87);
if (!this._messageNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 88);
this._initMessageNode();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 91);
if (this.get('showMessages')) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 92);
if (content) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 93);
this._messageNode.one(
                    '.' + this.getClassName('message', 'content'))
                    .setHTML(content);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 97);
this.get('boundingBox').addClass(
                    this.getClassName('message','visible'));
            } else {
                // TODO: is this right?
                // If no message provided, remove the message node.
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 102);
this.hideMessage();
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 106);
return this;
    },
    ...
    **/
    _afterMessageColumnsChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_afterMessageColumnsChange", 120);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 121);
var contentNode;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 123);
if (this._messageNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 124);
contentNode = this._messageNode.one(
                '.' + this.getClassName('message', 'content'));

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 127);
if (contentNode) {
                // FIXME: This needs to become a class extension plus a view or
                // plugin for the table view.
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 130);
contentNode.set('colSpan', this._displayColumns.length);
    ...
    **/
    _afterMessageDataChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_afterMessageDataChange", 143);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 144);
this._uiSetMessage();
    },
    ...
    **/
    _afterShowMessagesChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_afterShowMessagesChange", 156);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 157);
if (e.newVal) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 158);
this._uiSetMessage(e);
        } else {_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 159);
if (this._messageNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 160);
this.get('boundingBox').removeClass(
                this.getClassName('message', 'visible'));

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 163);
this._messageNode.remove().destroy(true);
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 164);
this._messageNode = null;
    ...
    **/
    _bindMessageUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_bindMessageUI", 176);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 177);
this.after(['dataChange', '*:add', '*:remove', '*:reset'],
            Y.bind('_afterMessageDataChange', this));

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 180);
this.after('columnsChange', Y.bind('_afterMessageColumnsChange', this));

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 182);
this.after('showMessagesChange',
    ...
    **/
    initializer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "initializer", 194);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 195);
this._initMessageStrings();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 197);
if (this.get('showMessages')) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 198);
this.after('renderBody', Y.bind('_initMessageNode', this));
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 201);
this.after(Y.bind('_bindMessageUI', this), this, 'bindUI');
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 202);
this.after(Y.bind('_syncMessageUI', this), this, 'syncUI');
    ...
    **/
    _initMessageNode: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_initMessageNode", 213);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 214);
if (!this._messageNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 215);
this._messageNode = Y.Node.create(
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 222);
this._tableNode.insertBefore(this._messageNode, this._tbodyNode);
    ...
    **/
    _initMessageStrings: function () {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_initMessageStrings", 233);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 235);
this.set('strings', Y.mix((this.get('strings') || {}), 
    ...
    **/
    _syncMessageUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_syncMessageUI", 256);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 257);
this._uiSetMessage();
    },
    ...
    **/
    _uiSetMessage: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", "_uiSetMessage", 275);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 276);
if (!this.data.size()) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 277);
this.showMessage((e && e.message) || 'emptyMessage');
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 279);
this.hideMessage();
        }
    }
});
...
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 285);
if (Y.Lang.isFunction(Y.DataTable)) {
    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-message.js", 286);
