...
return !(Y.UA.ios || Y.UA.android);
    ...
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1143);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1145);
...
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1153);
...
return ret;
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1289);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1290);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1291);
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1470);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1486);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1499);
...
return svg && (useSVG || !canvas);
    ...
    "graphics-svg-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1516);
...
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1544);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1545);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
...
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1613);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1614);
...
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2159);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2160);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2163);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2338);
...
if (node && node.style) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2344);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style || 'transition' in node.style);
    }

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2347);
return ret;
},
            "trigger": "transition"
        },
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2571);
