...
return !(Y.UA.ios || Y.UA.android);
    ...
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1219);
...
var testFeature = Y.Features.test,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1228);
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1229);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1230);
...
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1235);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1236);
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1240);
...
return ret;
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1365);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1366);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1367);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1572);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1573);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1577);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
},
            "trigger": "graphics"
        }
...
return svg && (useSVG || !canvas);
    ...
    "graphics-svg-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1607);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1608);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1613);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1621);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1622);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1624);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1635);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1636);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1638);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1702);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1703);
var docMode = Y.config.doc && Y.config.doc.documentMode;

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1705);
...
function workingNative( k, v ) {
        _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "workingNative", 1811);
...
return !nativeSupport;
    ...
    "json-stringify-shim": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1842);
...
if ( nativeSupport ) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1850);
try {
...
nativeSupport = false;
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1858);
return !nativeSupport;
},
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2311);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2312);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2315);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2652);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2653);
var DOCUMENT = Y.config.doc,
        node = (DOCUMENT) ? DOCUMENT.documentElement: null,
        ret = true;

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2657);
if (node && node.style) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2658);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style || 'transition' in node.style);
    }

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2661);
return ret;
},
            "trigger": "transition"
        },
    ...
    */
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2872);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2876);
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2920);
