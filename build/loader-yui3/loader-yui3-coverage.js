...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2175);
var testFeature = Y.Features.test,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2182);
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 2183);
...
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2194);
ret =  (!testFeature('style', 'opacity') &&
            !testFeature('style', 'computedStyle'));

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2197);
return ret;
},
            "trigger": "dom-style"
        },
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2319);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2320);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2321);
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2500);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2501);
...
var DOCUMENT = Y.config.doc,
		...
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2521);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
},
            "trigger": "graphics"
        }
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2529);
...
var DOCUMENT = Y.config.doc,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2552);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2560);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2561);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2563);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2574);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2575);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2577);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2643);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2644);
...
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 3199);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 3200);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 3203);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 3378);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 3379);
var DOCUMENT = Y.config.doc,
        node = (DOCUMENT) ? DOCUMENT.documentElement: null,
        ret = true;

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 3383);
if (node && node.style) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 3384);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style || 'transition' in node.style);
    }

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 3387);
return ret;
},
            "trigger": "transition"
        },
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 3611);
