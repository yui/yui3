...
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1127);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1128);
...
ret =  (!testFeature('style', 'opacity') &&
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1135);
return ret;
},
            "trigger": "dom-style"
        },
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1257);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1258);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1259);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1454);
...
return svg && (useSVG || !canvas);
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1498);
...
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1581);
...
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2127);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2128);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2131);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2290);
...
if (node && node.style) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2296);
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2523);
