...
return !(Y.UA.ios || Y.UA.android);
    ...
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1103);
...
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1113);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1114);
return WINDOW && 'getComputedStyle' in WINDOW;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1118);
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1119);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1120);
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1124);
...
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2807);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2808);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2823);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2824);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2836);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2837);
var DOCUMENT = Y.config.doc,
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2854);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2859);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2867);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2868);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2870);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2881);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2882);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2884);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2950);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2951);
var docMode = Y.config.doc && Y.config.doc.documentMode;

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2953);
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 3496);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 3497);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 3500);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 3994);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 3995);
var DOCUMENT = Y.config.doc,
...
if (node && node.style) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 4000);
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 4227);
