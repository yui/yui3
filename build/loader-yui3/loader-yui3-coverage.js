...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1151);
var testFeature = Y.Features.test,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1158);
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1159);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1160);
return WINDOW && 'getComputedStyle' in WINDOW;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1164);
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1165);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1166);
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1170);
ret =  (!testFeature('style', 'opacity') &&
            !testFeature('style', 'computedStyle'));

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1173);
return ret;
},
            "trigger": "dom-style"
        },
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1295);
...
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1476);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1477);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1481);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1505);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1506);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1511);
...
var DOCUMENT = Y.config.doc,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1528);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
...
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1550);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1551);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
...
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1999);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2003);
return typeof Object.defineProperties !== 'function' ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2187);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2188);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2191);
return ret;
},
            "trigger": "selector"
        },
...
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2599);
