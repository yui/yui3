...
_yuitest_coverage["/home/yui/src/yui3/src/history/build_tmp/history-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 43);
var Lang      = Y.Lang,
    Obj       = Y.Object,
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 57);
function HistoryBase() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "HistoryBase", 57);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 58);
this._init.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 61);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 68);
if (!GlobalEnv._state) {
    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 69);
GlobalEnv._state = {};
}
 ...
 * @private
 */
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 83);
function _isSimpleObject(value) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_isSimpleObject", 83);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 84);
 ...
 * @static
 */
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 96);
 ...
 * @final
 */
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 107);
 ...
 * @final
 */
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 118);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 131);
...
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 154);
HistoryBase.nativeHashChange = ('onhashchange' in win || 'onhashchange' in doc) &&
        (!docMode || docMode > 7);

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 157);
Y.mix(HistoryBase.prototype, {
    ...
    _init: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_init", 168);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 169);
var initialState;
         ...
         * @protected
         */
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 180);
config = this._config = config || {};
         ...
         * @default false
         */
         _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 190);
this.force = !!config.force;
         ...
         * @protected
         */
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 204);
initialState = this._initialState = this._initialState ||
         ...
         * </dl>
         */
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 254);
this.publish(EVT_CHANGE, {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 260);
if (initialState) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 261);
this.replace(initialState);
     ...
     */
    add: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "add", 295);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 296);
var args = YArray(arguments, 0, true);
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 297);
args.unshift(SRC_ADD);
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 298);
return this._change.apply(this, args);
    ...
    addValue: function (key, value, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "addValue", 315);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 316);
var state = {};
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 317);
state[key] = value;
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 318);
return this._change(SRC_ADD, state, options);
     ...
     */
    get: function (key) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "get", 331);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 332);
var state    = GlobalEnv._state,
            isObject = _isSimpleObject(state);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 335);
if (key) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 336);
return isObject && Obj.owns(state, key) ? state[key] : undefined;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 338);
return isObject ? Y.mix({}, state, true) : state; // mix provides a fast shallow clone.
     ...
     */
    replace: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "replace", 353);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 354);
var args = YArray(arguments, 0, true);
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 355);
args.unshift(SRC_REPLACE);
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 356);
return this._change.apply(this, args);
    },
    ...
    replaceValue: function (key, value, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "replaceValue", 371);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 372);
var state = {};
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 373);
state[key] = value;
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 374);
return this._change(SRC_REPLACE, state, options);
    ...
    _change: function (src, state, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_change", 392);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 393);
options = options ? Y.merge(DEFAULT_OPTIONS, options) : DEFAULT_OPTIONS;

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 395);
if (options.merge && _isSimpleObject(state) &&
                _isSimpleObject(GlobalEnv._state)) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 397);
state = Y.merge(GlobalEnv._state, state);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 400);
this._resolveChanges(src, state, options);
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 401);
return this;
    },
    ...
    _fireEvents: function (src, changes, options) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_fireEvents", 416);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 418);
this.fire(EVT_CHANGE, {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 428);
Obj.each(changes.changed, function (value, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "(anonymous 2)", 428);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 429);
this._fireChangeEvent(src, key, value);
        }, this);

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 432);
Obj.each(changes.removed, function (value, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "(anonymous 3)", 432);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 433);
this._fireRemoveEvent(src, key, value);
    ...
    _fireChangeEvent: function (src, key, value) {
         ...
         * </dl>
         */
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_fireChangeEvent", 448);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 489);
this.fire(key + 'Change', {
    ...
    _fireRemoveEvent: function (src, key, value) {
         ...
         * </dl>
         */
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_fireRemoveEvent", 506);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 540);
this.fire(key + 'Remove', {
    ...
    _resolveChanges: function (src, newState, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_resolveChanges", 559);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 560);
var changed   = {},
            isChanged,
            prevState = GlobalEnv._state,
            removed   = {};

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 565);
newState || (newState = {});
        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 566);
options  || (options  = {});

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 568);
if (_isSimpleObject(newState) && _isSimpleObject(prevState)) {
            // Figure out what was added or changed.
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 570);
Obj.each(newState, function (newVal, key) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "(anonymous 4)", 570);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 571);
var prevVal = prevState[key];

                _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 573);
if (newVal !== prevVal) {
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 574);
changed[key] = {
                        newVal : newVal,
                        prevVal: prevVal
                    };

                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 579);
isChanged = true;
                }
            }, this);

            // Figure out what was removed.
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 584);
Obj.each(prevState, function (prevVal, key) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "(anonymous 5)", 584);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 585);
if (!Obj.owns(newState, key) || newState[key] === null) {
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 586);
delete newState[key];
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 587);
removed[key] = prevVal;
                    _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 588);
isChanged = true;
                }
            }, this);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 592);
isChanged = newState !== prevState;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 595);
if (isChanged || this.force) {
            _yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 596);
this._fireEvents(src, {
    ...
    _storeState: function (src, newState) {
        ...
        // by subclasses.
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_storeState", 617);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 620);
GlobalEnv._state = newState || {};
    ...
    _defChangeFn: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/history/build_tmp/history-base.js", "_defChangeFn", 632);
_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 633);
this._storeState(e.src, e.newVal, e._options);
    }
}, true);

_yuitest_coverline("/home/yui/src/yui3/src/history/build_tmp/history-base.js", 637);
