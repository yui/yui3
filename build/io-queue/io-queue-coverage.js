...
this._q.remove(o);
    ...
    */
    qEmpty: function() {
        _yuitest_coverfunc("build/io-queue/io-queue.js", "qEmpty", 116);
_yuitest_coverline("build/io-queue/io-queue.js", 117);
this._q = new Y.Queue();
    },

    qStart: function() {
        _yuitest_coverfunc("build/io-queue/io-queue.js", "qStart", 120);
_yuitest_coverline("build/io-queue/io-queue.js", 121);
var io = this;
        _yuitest_coverline("build/io-queue/io-queue.js", 122);
io._qState = 1;

        _yuitest_coverline("build/io-queue/io-queue.js", 124);
if (io._q.size() > 0) {
...
io._qShift();
    ...
    */
    qStop: function() {
        _yuitest_coverfunc("build/io-queue/io-queue.js", "qStop", 138);
...
this._qState = 0;
    ...
    */
    qSize: function() {
        _yuitest_coverfunc("build/io-queue/io-queue.js", "qSize", 150);
...
_yuitest_coverline("build/io-queue/io-queue.js", 156);
function _queue(u, c) {
    _yuitest_coverfunc("build/io-queue/io-queue.js", "_queue", 156);
_yuitest_coverline("build/io-queue/io-queue.js", 157);
return io.queue.apply(io, [u, c]);
}

_yuitest_coverline("build/io-queue/io-queue.js", 160);
_queue.start = function () { _yuitest_coverfunc("build/io-queue/io-queue.js", "start", 160);
io.qStart(); };
_yuitest_coverline("build/io-queue/io-queue.js", 161);
_queue.stop = function () { _yuitest_coverfunc("build/io-queue/io-queue.js", "stop", 161);
io.qStop(); };
_yuitest_coverline("build/io-queue/io-queue.js", 162);
_queue.promote = function (o) { _yuitest_coverfunc("build/io-queue/io-queue.js", "promote", 162);
io.qPromote(o); };
_yuitest_coverline("build/io-queue/io-queue.js", 163);
_queue.remove = function (o) { _yuitest_coverfunc("build/io-queue/io-queue.js", "remove", 163);
io.qRemove(o); };
_yuitest_coverline("build/io-queue/io-queue.js", 164);
_queue.size = function () { _yuitest_coverfunc("build/io-queue/io-queue.js", "size", 164);
io.qSize(); };
_yuitest_coverline("build/io-queue/io-queue.js", 165);
_queue.empty = function () { _yuitest_coverfunc("build/io-queue/io-queue.js", "empty", 165);
io.qEmpty(); };
