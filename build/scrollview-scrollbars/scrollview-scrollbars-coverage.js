...
_yuitest_coverline("scrollview-scrollbars", 11);
...
function ScrollbarsPlugin() {
    _yuitest_coverfunc("scrollview-scrollbars", "ScrollbarsPlugin", 58);
_yuitest_coverline("scrollview-scrollbars", 59);
ScrollbarsPlugin.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("scrollview-scrollbars", 62);
...
_yuitest_coverline("scrollview-scrollbars", 75);
 ...
 * @static
 */
_yuitest_coverline("scrollview-scrollbars", 85);
 ...
 * @static
 */
_yuitest_coverline("scrollview-scrollbars", 95);
 ...
 * @static
 */
_yuitest_coverline("scrollview-scrollbars", 104);
 ...
 * @static
 */
_yuitest_coverline("scrollview-scrollbars", 119);
...
_yuitest_coverline("scrollview-scrollbars", 144);
Y.namespace("Plugin").ScrollViewScrollbars = Y.extend(ScrollbarsPlugin, Y.Plugin.Base, {
    ...
    initializer: function() {
        _yuitest_coverfunc("scrollview-scrollbars", "initializer", 151);
_yuitest_coverline("scrollview-scrollbars", 152);
...
this.afterHostMethod('scrollTo', this._update);
        _yuitest_coverline("scrollview-scrollbars", 156);
this.afterHostMethod('_uiDimensionsChange', this._hostDimensionsChange);
    ...
    _hostDimensionsChange: function() {
        _yuitest_coverfunc("scrollview-scrollbars", "_hostDimensionsChange", 167);
_yuitest_coverline("scrollview-scrollbars", 168);
var host = this._host,
            axis = host.axis;

        _yuitest_coverline("scrollview-scrollbars", 171);
this._renderBar(this.get(VERTICAL_NODE), axis.y, 'vert');
        _yuitest_coverline("scrollview-scrollbars", 172);
this._renderBar(this.get(HORIZONTAL_NODE), axis.x, 'horiz');

        _yuitest_coverline("scrollview-scrollbars", 174);
this._update();

        _yuitest_coverline("scrollview-scrollbars", 176);
Y.later(500, this, 'flash', true);
    ...
    _hostScrollEnd : function(e) {
        _yuitest_coverfunc("scrollview-scrollbars", "_hostScrollEnd", 186);
_yuitest_coverline("scrollview-scrollbars", 187);
if (!this._host._flicking) {
            _yuitest_coverline("scrollview-scrollbars", 188);
this.flash();
        }
    },
    ...
    _renderBar: function(bar, add) {
        _yuitest_coverfunc("scrollview-scrollbars", "_renderBar", 200);
_yuitest_coverline("scrollview-scrollbars", 201);
var inDoc = bar.inDoc(),
            bb = this._host._bb,
...
bar.toggleClass(className, this._basic);
            _yuitest_coverline("scrollview-scrollbars", 208);
this._setChildCache(bar);
        } else {_yuitest_coverline("scrollview-scrollbars", 209);
if(!add && inDoc) {
            _yuitest_coverline("scrollview-scrollbars", 210);
bar.remove();
            _yuitest_coverline("scrollview-scrollbars", 211);
this._clearChildCache(bar);
    ...
    _setChildCache : function(node) {
        _yuitest_coverfunc("scrollview-scrollbars", "_setChildCache", 223);
_yuitest_coverline("scrollview-scrollbars", 224);
...
mc.setStyle(TRANSITION_PROPERTY, TRANSFORM);
        _yuitest_coverline("scrollview-scrollbars", 232);
lc.setStyle(TRANSITION_PROPERTY, TRANSFORM);

        _yuitest_coverline("scrollview-scrollbars", 234);
node.setData(CHILD_CACHE, {
    ...
    _clearChildCache : function(node) {
        _yuitest_coverfunc("scrollview-scrollbars", "_clearChildCache", 250);
_yuitest_coverline("scrollview-scrollbars", 251);
node.clearData(CHILD_CACHE);
    ...
    _updateBar : function(scrollbar, current, duration, horiz) {
        ...
        _yuitest_coverfunc("scrollview-scrollbars", "_updateBar", 265);
_yuitest_coverline("scrollview-scrollbars", 267);
var host = this._host,
            basic = this._basic,
            cb = host._cb,
...
scale = SCALE_X;
            _yuitest_coverline("scrollview-scrollbars", 300);
...
scale = SCALE_Y;
            _yuitest_coverline("scrollview-scrollbars", 309);
...
scrollbarSize = Math.floor(widgetSize * (widgetSize/contentSize));
        _yuitest_coverline("scrollview-scrollbars", 313);
...
if (middleChildSize < 0) {
            _yuitest_coverline("scrollview-scrollbars", 329);
middleChildSize = 0;
        }

        _yuitest_coverline("scrollview-scrollbars", 332);
if (middleChildSize === 0 && scrollbarPos !== 0) {
            _yuitest_coverline("scrollview-scrollbars", 333);
scrollbarPos = widgetSize - (firstChildSize + lastChildSize) - 1;
        }

        _yuitest_coverline("scrollview-scrollbars", 336);
if (duration !== 0) {
            // Position Scrollbar
            _yuitest_coverline("scrollview-scrollbars", 338);
transition = {
                duration : duration
            };
...
if (this[dimCache] !== middleChildSize) {
            _yuitest_coverline("scrollview-scrollbars", 360);
this[dimCache] = middleChildSize;

            _yuitest_coverline("scrollview-scrollbars", 362);
if (middleChildSize > 0) {

                _yuitest_coverline("scrollview-scrollbars", 364);
if (duration !== 0) {
                    _yuitest_coverline("scrollview-scrollbars", 365);
transition = {
                        duration : duration             
                    };
...
if(NATIVE_TRANSITIONS) {
                        _yuitest_coverline("scrollview-scrollbars", 370);
transition.transform = scale + middleChildSize + CLOSE;
                    } else {
                        _yuitest_coverline("scrollview-scrollbars", 372);
transition[dim] = middleChildSize + PX;
                    }

                    _yuitest_coverline("scrollview-scrollbars", 375);
middleChild.transition(transition);
                } else {
                    _yuitest_coverline("scrollview-scrollbars", 377);
if (NATIVE_TRANSITIONS) {
                        _yuitest_coverline("scrollview-scrollbars", 378);
middleChild.setStyle(TRANSFORM, scale + middleChildSize + CLOSE);
                    } else {
                        _yuitest_coverline("scrollview-scrollbars", 380);
middleChild.setStyle(dim, middleChildSize + PX);
                    }
                }
    
                // Position Last Child
                _yuitest_coverline("scrollview-scrollbars", 385);
if (!horiz || !basic) {

                    _yuitest_coverline("scrollview-scrollbars", 387);
lastChildPosition = scrollbarSize - lastChildSize;
    
                    _yuitest_coverline("scrollview-scrollbars", 389);
if(duration !== 0) { 
                        _yuitest_coverline("scrollview-scrollbars", 390);
transition = {
                            duration : duration
                        };
...
if (NATIVE_TRANSITIONS) {
                            _yuitest_coverline("scrollview-scrollbars", 395);
transition.transform = translate + lastChildPosition + PX_CLOSE; 
                        } else {
                            _yuitest_coverline("scrollview-scrollbars", 397);
transition[dimOffset] = lastChildPosition; 
                        }

                        _yuitest_coverline("scrollview-scrollbars", 400);
lastChild.transition(transition);
                    } else {
                        _yuitest_coverline("scrollview-scrollbars", 402);
if (NATIVE_TRANSITIONS) {
                            _yuitest_coverline("scrollview-scrollbars", 403);
lastChild.setStyle(TRANSFORM, translate + lastChildPosition + PX_CLOSE); 
                        } else {
                            _yuitest_coverline("scrollview-scrollbars", 405);
lastChild.setStyle(dimOffset, lastChildPosition + PX); 
    ...
    _update: function(x, y, duration, easing) {
        ...
        _yuitest_coverfunc("scrollview-scrollbars", "_update", 424);
_yuitest_coverline("scrollview-scrollbars", 426);
var vNode = this.get(VERTICAL_NODE),
            hNode = this.get(HORIZONTAL_NODE),
            host = this._host,
            axis = host.axis;

        _yuitest_coverline("scrollview-scrollbars", 431);
duration = (duration || 0)/1000;

        _yuitest_coverline("scrollview-scrollbars", 433);
if (!this._showing) {
            _yuitest_coverline("scrollview-scrollbars", 434);
this.show();
        }

        _yuitest_coverline("scrollview-scrollbars", 437);
if (axis.y && vNode) {
            _yuitest_coverline("scrollview-scrollbars", 438);
this._updateBar(vNode, y, duration, false);
        }

        _yuitest_coverline("scrollview-scrollbars", 441);
if (axis.x && hNode) {
            _yuitest_coverline("scrollview-scrollbars", 442);
this._updateBar(hNode, x, duration, true);
    ...
    show: function(animated) {
        _yuitest_coverfunc("scrollview-scrollbars", "show", 452);
_yuitest_coverline("scrollview-scrollbars", 453);
this._show(true, animated);
    ...
    hide: function(animated) {
        _yuitest_coverfunc("scrollview-scrollbars", "hide", 462);
_yuitest_coverline("scrollview-scrollbars", 463);
this._show(false, animated);
    ...
    _show : function(show, animated) {
        ...
        _yuitest_coverfunc("scrollview-scrollbars", "_show", 474);
_yuitest_coverline("scrollview-scrollbars", 476);
var verticalNode = this.get(VERTICAL_NODE),
        ...
        _yuitest_coverline("scrollview-scrollbars", 484);
this._showing = show;

        _yuitest_coverline("scrollview-scrollbars", 486);
if (this._flashTimer) {
            _yuitest_coverline("scrollview-scrollbars", 487);
this._flashTimer.cancel();
        }

        _yuitest_coverline("scrollview-scrollbars", 490);
transition = {
            duration : duration,
            opacity : opacity
        };
...
if (verticalNode) {
            _yuitest_coverline("scrollview-scrollbars", 496);
verticalNode.transition(transition);
        }

        _yuitest_coverline("scrollview-scrollbars", 499);
if (horizontalNode) {
            _yuitest_coverline("scrollview-scrollbars", 500);
horizontalNode.transition(transition);
     ...
     */
    flash: function() {
        _yuitest_coverfunc("scrollview-scrollbars", "flash", 509);
_yuitest_coverline("scrollview-scrollbars", 510);
var host = this._host;

        _yuitest_coverline("scrollview-scrollbars", 512);
this.show(true);
        _yuitest_coverline("scrollview-scrollbars", 513);
this._flashTimer = Y.later(800, this, 'hide', true);
    ...
    _setNode: function(node, name) {
        _yuitest_coverfunc("scrollview-scrollbars", "_setNode", 526);
_yuitest_coverline("scrollview-scrollbars", 527);
var horiz = (name === HORIZONTAL_NODE);
            _yuitest_coverline("scrollview-scrollbars", 528);
node = Y.one(node);
...
node.addClass( (horiz) ? _classNames.scrollbarH : _classNames.scrollbarV );
            _yuitest_coverline("scrollview-scrollbars", 533);
node.setData("isHoriz", horiz);
        }

        _yuitest_coverline("scrollview-scrollbars", 536);
return node;
    },
    ...
    _defaultNode: function() {
        _yuitest_coverfunc("scrollview-scrollbars", "_defaultNode", 547);
_yuitest_coverline("scrollview-scrollbars", 548);
