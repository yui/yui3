...
return allowSet;
        ...
        setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "setAttrs", 810);
...
return this._setAttrs(attrs, opts);
        ...
        _setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setAttrs", 824);
...
return this;
        ...
        getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "getAttrs", 842);
...
return this._getAttrs(attrs);
        ...
        _getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrs", 855);
...
return obj;
        ...
        addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "addAttrs", 897);
...
return host;
        ...
        _addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_addAttrs", 926);
...
host.addAttr(attr, attrCfg, lazy);
        ...
        _normAttrVals : function(valueHash) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_normAttrVals", 982);
...
v[v.length] = {
                            ...
                            _yuitest_coverline("build/attribute-core/attribute-core.js", 1001);
vals[k] = valueHash[k];
                        }
                    }
                }
...
return { simple:vals, complex:subvals };
                ...
                _yuitest_coverline("build/attribute-core/attribute-core.js", 1007);
return null;
            }
        },
        ...
        _getAttrInitVal : function(attr, cfg, initValues) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrInitVal", 1026);
...
return val;
        ...
        _initAttrs : function(attrs, values, lazy) {
            ...
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_initAttrs", 1088);
