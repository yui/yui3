...
this.addAttr(name, lazyCfg);
        ...
        set : function(name, val, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "set", 490);
_yuitest_coverline("build/attribute-core/attribute-core.js", 491);
return this._setAttr(name, val, opts);
        ...
        _set : function(name, val, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_set", 506);
_yuitest_coverline("build/attribute-core/attribute-core.js", 507);
return this._setAttr(name, val, opts, true);
        ...
        _setAttr : function(name, val, opts, force)  {
            ...
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setAttr", 527);
...
cfg = state.getAll(name, true) || {};
            ...
            _yuitest_coverline("build/attribute-core/attribute-core.js", 556);
...
initializing = cfg.initializing;
            ...
            _yuitest_coverline("build/attribute-core/attribute-core.js", 566);
if (!initialSet && !force) {

                _yuitest_coverline("build/attribute-core/attribute-core.js", 568);
if (writeOnce) {
...
return this;
        ...
        _getAttr : function(name) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttr", 627);
...
val = (getter) ? getter.call(host, val, fullName) : val;
            _yuitest_coverline("build/attribute-core/attribute-core.js", 663);
...
return val;
        ...
        _getStateVal : function(name) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getStateVal", 677);
...
return stateProxy && (name in stateProxy) && !this._state.get(name, BYPASS_PROXY) ? stateProxy[name] : this._state.get(name, VALUE);
        ...
        _setStateVal : function(name, value) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setStateVal", 691);
...
this._state.add(name, VALUE, value);
        ...
        _setAttrVal : function(attrName, subAttrName, prevVal, newVal, opts) {
            ...
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setAttrVal", 714);
...
allowSet = false;
                        } else {_yuitest_coverline("build/attribute-core/attribute-core.js", 753);
if (retVal !== undefined){
...
if(!subAttrName && (newVal === prevRawVal) && !Lang.isObject(newVal)) {
                        _yuitest_coverline("build/attribute-core/attribute-core.js", 761);
allowSet = false;
                    } else {
                        // Store value
                        _yuitest_coverline("build/attribute-core/attribute-core.js", 764);
...
return allowSet;
        ...
        setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "setAttrs", 787);
...
return this._setAttrs(attrs, opts);
        ...
        _setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setAttrs", 801);
...
for (attr in attrs) {
                _yuitest_coverline("build/attribute-core/attribute-core.js", 804);
...
return this;
        ...
        getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "getAttrs", 819);
...
return this._getAttrs(attrs);
        ...
        _getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrs", 832);
_yuitest_coverline("build/attribute-core/attribute-core.js", 833);
var obj = {},
                attr, i, len,
...
attrs = O.keys(this._state.data);
            ...
            _yuitest_coverline("build/attribute-core/attribute-core.js", 842);
for (i = 0, len = attrs.length; i < len; i++) {
                _yuitest_coverline("build/attribute-core/attribute-core.js", 843);
attr = attrs[i];
...
return obj;
        ...
        addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "addAttrs", 874);
_yuitest_coverline("build/attribute-core/attribute-core.js", 875);
var host = this; // help compression
...
host._tVals = host._normAttrVals(values);
                _yuitest_coverline("build/attribute-core/attribute-core.js", 879);
host._addAttrs(cfgs, host._tVals, lazy);
                _yuitest_coverline("build/attribute-core/attribute-core.js", 880);
...
return host;
        ...
        _addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_addAttrs", 903);
...
value = host._getAttrInitVal(attr, attrCfg, host._tVals);
                    ...
                    _yuitest_coverline("build/attribute-core/attribute-core.js", 919);
if (value !== undefined) {
...
delete host._tCfgs[attr];
                    ...
                    _yuitest_coverline("build/attribute-core/attribute-core.js", 927);
host.addAttr(attr, attrCfg, lazy);
        ...
        _protectAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_protectAttrs", 942);
...
return attrs;
        ...
        _normAttrVals : function(valueHash) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_normAttrVals", 965);
...
return (valueHash) ? Y.merge(valueHash) : null;
        ...
        _getAttrInitVal : function(attr, cfg, initValues) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrInitVal", 984);
...
return val;
        ...
        _initAttrs : function(attrs, values, lazy) {
            ...
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_initAttrs", 1016);
