...
return this;
        ...
        _getAttr : function(name) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttr", 622);
...
getter = state.get(name, GETTER);
            ...
            _yuitest_coverline("build/attribute-core/attribute-core.js", 653);
...
return val;
        ...
        _getStateVal : function(name) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getStateVal", 672);
...
return stateProxy && (name in stateProxy) && !this._state.get(name, BYPASS_PROXY) ? stateProxy[name] : this._state.get(name, VALUE);
        ...
        _setStateVal : function(name, value) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setStateVal", 686);
...
return allowSet;
        ...
        setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "setAttrs", 782);
...
return this._setAttrs(attrs, opts);
        ...
        _setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_setAttrs", 796);
...
return this;
        ...
        getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "getAttrs", 814);
...
return this._getAttrs(attrs);
        ...
        _getAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrs", 827);
...
return obj;
        ...
        addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "addAttrs", 869);
...
return host;
        ...
        _addAttrs : function(cfgs, values, lazy) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_addAttrs", 898);
...
if (value !== undefined) {
                        _yuitest_coverline("build/attribute-core/attribute-core.js", 915);
attrCfg.value = value;
                    }

                    _yuitest_coverline("build/attribute-core/attribute-core.js", 918);
if (host._tCfgs[attr]) {
...
host.addAttr(attr, attrCfg, lazy);
        ...
        _protectAttrs : function(attrs) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_protectAttrs", 937);
...
return attrs;
        ...
        _normAttrVals : function(valueHash) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_normAttrVals", 960);
_yuitest_coverline("build/attribute-core/attribute-core.js", 961);
return (valueHash) ? Y.merge(valueHash) : null;
        ...
        _getAttrInitVal : function(attr, cfg, initValues) {
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_getAttrInitVal", 979);
...
return val;
        ...
        _initAttrs : function(attrs, values, lazy) {
            ...
            _yuitest_coverfunc("build/attribute-core/attribute-core.js", "_initAttrs", 1011);
...
if ( attrs && !baseInst && !baseCoreInst) {
                _yuitest_coverline("build/attribute-core/attribute-core.js", 1021);
