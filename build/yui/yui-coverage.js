...
_yuitest_coverfunc("build/yui/yui.js", "(anonymous 1)", 1);
_yuitest_coverline("build/yui/yui.js", 23);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 71);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui/yui.js", "_isNative", 71);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 89);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui/yui.js", "isArray", 89);
_yuitest_coverline("build/yui/yui.js", 90);
...
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isBoolean", 100);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 111);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isDate", 111);
_yuitest_coverline("build/yui/yui.js", 112);
...
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isFunction", 139);
_yuitest_coverline("build/yui/yui.js", 140);
...
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNull", 150);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 161);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNumber", 161);
_yuitest_coverline("build/yui/yui.js", 162);
 ...
 * @see isPlainObject
 */
_yuitest_coverline("build/yui/yui.js", 176);
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui/yui.js", "isObject", 176);
_yuitest_coverline("build/yui/yui.js", 177);
var t = typeof o;
    _yuitest_coverline("build/yui/yui.js", 178);
return (o && (t === 'object' ||
...
L.isString = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isString", 189);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isUndefined", 200);
...
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isValue", 213);
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui/yui.js", 237);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 2)", 237);
_yuitest_coverline("build/yui/yui.js", 238);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 252);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui/yui.js", "sub", 252);
_yuitest_coverline("build/yui/yui.js", 253);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 3)", 253);
...
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 4)", 266);
_yuitest_coverline("build/yui/yui.js", 267);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 268);
_yuitest_coverline("build/yui/yui.js", 269);
try {
        _yuitest_coverline("build/yui/yui.js", 270);
return s.replace(TRIMREGEX, '');
    } catch (e) {
        _yuitest_coverline("build/yui/yui.js", 272);
return s;
    }
};
...
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 5)", 283);
_yuitest_coverline("build/yui/yui.js", 284);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 285);
...
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 6)", 296);
_yuitest_coverline("build/yui/yui.js", 297);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 298);
_yuitest_coverline("build/yui/yui.js", 299);
return s.replace(/\s+$/, '');
};
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "type", 329);
_yuitest_coverline("build/yui/yui.js", 330);
...
@return {Array} A native array created from _thing_, according to the rules
  described above.
**/
_yuitest_coverline("build/yui/yui.js", 370);
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui/yui.js", "YArray", 370);
_yuitest_coverline("build/yui/yui.js", 371);
var len, result;

    _yuitest_coverline("build/yui/yui.js", 373);
startIndex || (startIndex = 0);

    _yuitest_coverline("build/yui/yui.js", 375);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("build/yui/yui.js", 377);
try {
            _yuitest_coverline("build/yui/yui.js", 378);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("build/yui/yui.js", 380);
result = [];

            _yuitest_coverline("build/yui/yui.js", 382);
...
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui/yui.js", "dedupe", 409);
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 7)", 441);
_yuitest_coverline("build/yui/yui.js", 442);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui/yui.js", 443);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 444);
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui/yui.js", "hash", 478);
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 8)", 506);
_yuitest_coverline("build/yui/yui.js", 507);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui/yui.js", "}", 508);
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "numericSort", 551);
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 571);
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 9)", 571);
_yuitest_coverline("build/yui/yui.js", 572);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 573);
_yuitest_coverline("build/yui/yui.js", 574);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 575);
if (i in array && fn.call(thisObj, array[i], i, array)) {
            _yuitest_coverline("build/yui/yui.js", 576);
return true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 580);
return false;
};
...
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "test", 601);
...
result = 1;
    } else {_yuitest_coverline("build/yui/yui.js", 606);
...
result = 2;
    ...
    _yuitest_coverline("build/yui/yui.js", 617);
return result;
};
/**
 * The YUI module contains the components required for building the YUI
...
function Queue() {
    _yuitest_coverfunc("build/yui/yui.js", "Queue", 635);
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui/yui.js", "_init", 647);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui/yui.js", "next", 664);
...
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui/yui.js", "last", 674);
...
return this._q.pop();
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui/yui.js", "add", 685);
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui/yui.js", "size", 697);
...
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui/yui.js", "cached", 744);
_yuitest_coverline("build/yui/yui.js", 745);
cache || (cache = {});

    _yuitest_coverline("build/yui/yui.js", 747);
return function (arg) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 10)", 747);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "getLocation", 776);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui/yui.js", "merge", 801);
...
var args   = arguments,
    ...
    _yuitest_coverline("build/yui/yui.js", 807);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 808);
Y.mix(result, args[i], true);
    }

    _yuitest_coverline("build/yui/yui.js", 811);
return result;
};
...
**/
_yuitest_coverline("build/yui/yui.js", 848);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 848);
_yuitest_coverline("build/yui/yui.js", 849);
var alwaysOverwrite, exists, from, i, key, len, to;

    // If no supplier is given, we return the receiver. If no receiver is given,
    // we return Y. Returning Y doesn't make much sense to me, but it's
    // grandfathered in for backcompat reasons.
    _yuitest_coverline("build/yui/yui.js", 854);
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui/yui.js", 855);
return receiver || Y;
    }

    _yuitest_coverline("build/yui/yui.js", 858);
if (mode) {
...
return receiver;
        ...
        _yuitest_coverline("build/yui/yui.js", 879);
from = supplier;
        _yuitest_coverline("build/yui/yui.js", 880);
to   = receiver;
    }
...
alwaysOverwrite = overwrite && !merge;
    ...
    _yuitest_coverline("build/yui/yui.js", 887);
if (whitelist) {
        _yuitest_coverline("build/yui/yui.js", 888);
...
key = whitelist[i];
            ...
            // method.
            _yuitest_coverline("build/yui/yui.js", 896);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 897);
continue;
            }
            ...
            _yuitest_coverline("build/yui/yui.js", 903);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("build/yui/yui.js", 905);
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 916);
if (overwrite || !exists) {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 942);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui/yui.js", 950);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui/yui.js", 951);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 955);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 11)", 987);
_yuitest_coverline("build/yui/yui.js", 993);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 12)", 994);
...
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 13)", 999);
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 1062);
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 1098);
...
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 1115);
keys.push(key);
            }
        }
    }
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 1150);
...
var keys   = O.keys(obj),
    ...
    _yuitest_coverline("build/yui/yui.js", 1156);
for (; i < len; ++i) {
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 1171);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 1189);
_yuitest_coverline("build/yui/yui.js", 1190);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 1213);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 1213);
_yuitest_coverline("build/yui/yui.js", 1214);
var key;

    _yuitest_coverline("build/yui/yui.js", 1216);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 1217);
...
fn.call(thisObj || Y, obj[key], key, obj);
    ...
    _yuitest_coverline("build/yui/yui.js", 1222);
return Y;
};
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 1245);
...
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 1250);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1272);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 1272);
...
return UNDEFINED;
    ...
    _yuitest_coverline("build/yui/yui.js", 1277);
var i,
        p = Y.Array(path),
        l = p.length;
...
o = o[p[i]];
    ...
    _yuitest_coverline("build/yui/yui.js", 1285);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 1302);
...
ref = ref[p[i]];
        ...
        _yuitest_coverline("build/yui/yui.js", 1313);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui/yui.js", 1314);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("build/yui/yui.js", 1316);
return UNDEFINED;
        }
    }
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 1332);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 1332);
_yuitest_coverline("build/yui/yui.js", 1333);
...
YUI.Env.parseUA = function(subUA) {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 1368);
_yuitest_coverline("build/yui/yui.js", 1370);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 1370);
_yuitest_coverline("build/yui/yui.js", 1371);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 1372);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 15)", 1372);
...
return (c++ == 1) ? '' : '.';
    ...
    * @static
    */
    _yuitest_coverline("build/yui/yui.js", 1600);
o.userAgent = ua;


    _yuitest_coverline("build/yui/yui.js", 1603);
o.secure = href && (href.toLowerCase().indexOf('https') === 0);

    _yuitest_coverline("build/yui/yui.js", 1605);
if (ua) {

        _yuitest_coverline("build/yui/yui.js", 1607);
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1608);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui/yui.js", 1609);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1610);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui/yui.js", 1611);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1612);
o.os = 'android';
        } else {_yuitest_coverline("build/yui/yui.js", 1613);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1614);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui/yui.js", 1615);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1616);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 1617);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1618);
o.os = 'rhino';
        }}}}}}

        // Modern KHTML browsers should qualify as Safari X-Grade
        _yuitest_coverline("build/yui/yui.js", 1622);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1623);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui/yui.js", 1625);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1626);
o.mobile = 'windows';
        }
        _yuitest_coverline("build/yui/yui.js", 1628);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 1629);
o.mobile = 'gecko';
        }
        // Modern WebKit browsers are at least X-Grade
        _yuitest_coverline("build/yui/yui.js", 1632);
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui/yui.js", 1633);
if (m && m[1]) {
            _yuitest_coverline("build/yui/yui.js", 1634);
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui/yui.js", 1635);
o.safari = o.webkit;
            
            _yuitest_coverline("build/yui/yui.js", 1637);
if (/PhantomJS/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 1638);
m = ua.match(/PhantomJS\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 1639);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 1640);
o.phantomjs = numberify(m[1]);
                }
            }

            // Mobile browser check
            _yuitest_coverline("build/yui/yui.js", 1645);
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 1646);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("build/yui/yui.js", 1648);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 1649);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 1650);
m = numberify(m[1].replace('_', '.'));
                }
                _yuitest_coverline("build/yui/yui.js", 1652);
o.ios = m;
                _yuitest_coverline("build/yui/yui.js", 1653);
o.os = 'ios';
                _yuitest_coverline("build/yui/yui.js", 1654);
o.ipad = o.ipod = o.iphone = 0;

                _yuitest_coverline("build/yui/yui.js", 1656);
m = ua.match(/iPad|iPod|iPhone/);
                _yuitest_coverline("build/yui/yui.js", 1657);
if (m && m[0]) {
                    _yuitest_coverline("build/yui/yui.js", 1658);
o[m[0].toLowerCase()] = o.ios;
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 1661);
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("build/yui/yui.js", 1662);
if (m) {
                    // Nokia N-series, webOS, ex: NokiaN95
                    _yuitest_coverline("build/yui/yui.js", 1664);
o.mobile = m[0];
                }
                _yuitest_coverline("build/yui/yui.js", 1666);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 1667);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui/yui.js", 1668);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 1669);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 1670);
o.webos = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui/yui.js", 1673);
if (/ Android/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 1674);
if (/Mobile/.test(ua)) {
                        _yuitest_coverline("build/yui/yui.js", 1675);
o.mobile = 'Android';
                    }
                    _yuitest_coverline("build/yui/yui.js", 1677);
m = ua.match(/Android ([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 1678);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 1679);
o.android = numberify(m[1]);
                    }

                }
                _yuitest_coverline("build/yui/yui.js", 1683);
if (/Silk/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 1684);
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("build/yui/yui.js", 1685);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 1686);
o.silk = numberify(m[1]);
                    }
                    _yuitest_coverline("build/yui/yui.js", 1688);
if (!o.android) {
                        _yuitest_coverline("build/yui/yui.js", 1689);
o.android = 2.34; //Hack for desktop mode in Kindle
                        _yuitest_coverline("build/yui/yui.js", 1690);
o.os = 'Android';
                    }
                    _yuitest_coverline("build/yui/yui.js", 1692);
if (/Accelerated=true/.test(ua)) {
                        _yuitest_coverline("build/yui/yui.js", 1693);
o.accel = true;
                    }
                }
            }

            _yuitest_coverline("build/yui/yui.js", 1698);
m = ua.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/);
            _yuitest_coverline("build/yui/yui.js", 1699);
if (m && m[1] && m[2]) {
                _yuitest_coverline("build/yui/yui.js", 1700);
o.chrome = numberify(m[2]); // Chrome
                _yuitest_coverline("build/yui/yui.js", 1701);
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("build/yui/yui.js", 1702);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui/yui.js", 1703);
o.mobile = 'chrome';
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 1706);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 1707);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 1708);
o.air = m[0]; // Adobe AIR 1.0 or better
                }
            }
        }

        _yuitest_coverline("build/yui/yui.js", 1713);
if (!o.webkit) { // not webkit
// @todo check Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1316; fi; U; ssr)
            _yuitest_coverline("build/yui/yui.js", 1715);
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 1716);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 1717);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 1718);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("build/yui/yui.js", 1720);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 1721);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 1722);
o.opera = numberify(m[1]); // opera 10+
                }

                _yuitest_coverline("build/yui/yui.js", 1725);
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 1726);
o.mobile = 'opera';
                    _yuitest_coverline("build/yui/yui.js", 1727);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 1728);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 1729);
o.opera = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui/yui.js", 1732);
m = ua.match(/Opera Mini[^;]*/);

                _yuitest_coverline("build/yui/yui.js", 1734);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 1735);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui/yui.js", 1738);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui/yui.js", 1739);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 1740);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui/yui.js", 1742);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 1743);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 1744);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui/yui.js", 1745);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui/yui.js", 1746);
if (m && m[1]) {
                            _yuitest_coverline("build/yui/yui.js", 1747);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui/yui.js", 1756);
if (!subUA) {

        _yuitest_coverline("build/yui/yui.js", 1758);
if (typeof process == 'object') {

            _yuitest_coverline("build/yui/yui.js", 1760);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui/yui.js", 1762);
o.os = process.platform;
                _yuitest_coverline("build/yui/yui.js", 1763);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("build/yui/yui.js", 1767);
YUI.Env.UA = o;

    }

    _yuitest_coverline("build/yui/yui.js", 1771);
return o;
};


_yuitest_coverline("build/yui/yui.js", 1775);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 1797);
_yuitest_coverline("build/yui/yui.js", 1798);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui/yui.js", 1800);
if (a === b) {
        _yuitest_coverline("build/yui/yui.js", 1801);
return 0;
    }

    _yuitest_coverline("build/yui/yui.js", 1804);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui/yui.js", 1805);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui/yui.js", 1807);
...
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui/yui.js", 1812);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui/yui.js", 1814);
if (aPart < bPart) {
            _yuitest_coverline("build/yui/yui.js", 1815);
return -1;
        }

        _yuitest_coverline("build/yui/yui.js", 1818);
if (aPart > bPart) {
...
return 1;
    ...
    _yuitest_coverline("build/yui/yui.js", 1823);
return 0;
};
_yuitest_coverline("build/yui/yui.js", 1825);
YUI.Env.aliases = {
