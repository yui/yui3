...
_yuitest_coverage["/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 12);
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 25);
function AppTransitionsNative() {}

_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 27);
AppTransitionsNative.prototype = {
    ...
    **/
    ...
    initializer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "initializer", 53);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 54);
this._transitioning       = false;
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 55);
this._viewTransitionQueue = [];

        // TODO: Consider the AOP approach that `Plugin.WidgetAnim` uses.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 58);
Y.Do.before(this._queueActiveView, this, '_uiSetActiveView');
    ...
    **/
    _dequeueActiveView: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "_dequeueActiveView", 74);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 75);
var queue      = this._viewTransitionQueue,
            transition = queue.shift(),
            options;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 79);
if (transition) {
            // When items are still left in the queue, override the transition
            // so it does not run.
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 82);
if (queue.length) {
                // Overrides `transition` option and splices in the new options.
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 84);
options = Y.merge(transition[2], {transition: false});
                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 85);
transition.splice(2, 1, options);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 88);
this._uiTransitionActiveView.apply(this, transition);
    ...
    **/
    _getFx: function (newView, oldView, transition) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "_getFx", 105);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 106);
var fx          = AppTransitions.FX,
            transitions = this.get('transitions');

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 109);
if (transition === false || !transitions) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 110);
return null;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 113);
if (transition) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 114);
return fx[transition];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 117);
if (this._isChildView(newView, oldView)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 118);
return fx[transitions.toChild];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 121);
if (this._isParentView(newView, oldView)) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 122);
return fx[transitions.toParent];
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 125);
return fx[transitions.navigate];
    ...
    **/
    _queueActiveView: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "_queueActiveView", 139);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 140);
var args = Y.Array(arguments, 0, true);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 142);
this._viewTransitionQueue.push(args);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 144);
if (!this._transitioning) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 145);
this._dequeueActiveView();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 148);
return new Y.Do.Prevent();
    ...
    **/
    _uiTransitionActiveView: function (newView, oldView, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "_uiTransitionActiveView", 192);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 193);
options || (options = {});

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 195);
var callback = options.callback,
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 200);
if (newView === oldView) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 201);
callback && callback.call(this, newView);

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 203);
this._transitioning = false;
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 204);
return this._dequeueActiveView();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 207);
fx       = this._getFx(newView, oldView, options.transition);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 208);
isChild  = this._isChildView(newView, oldView);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 209);
isParent = !isChild && this._isParentView(newView, oldView);
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 210);
prepend  = !!options.prepend || isParent;
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 214);
if (!fx) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 215);
this._attachView(newView, prepend);
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 216);
this._detachView(oldView);
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 217);
callback && callback.call(this, newView);

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 219);
this._transitioning = false;
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 220);
return this._dequeueActiveView();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 223);
this._transitioning = true;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 225);
container     = this.get('container');
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 226);
transitioning = Y.App.CLASS_NAMES.transitioning;

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 228);
container.addClass(transitioning);

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 230);
this._attachView(newView, prepend);

        // Called when view transitions completed, if none were added this will
        // run right away.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 234);
function complete() {
            _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "complete", 234);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 235);
this._detachView(oldView);
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 236);
container.removeClass(transitioning);
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 237);
callback && callback.call(this, newView);

            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 239);
this._transitioning = false;
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 240);
return this._dequeueActiveView();
        }

        // Setup a new stack to run the view transitions in parallel.
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 244);
transitions = new Y.Parallel({context: this});
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 245);
fxConfig    = {
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 251);
if (newView && fx.viewIn) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 252);
newView.get('container')
                .transition(fx.viewIn, fxConfig, transitions.add());
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 256);
if (oldView && fx.viewOut) {
            _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 257);
oldView.get('container')
                .transition(fx.viewOut, fxConfig, transitions.add());
        }

        _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 261);
transitions.done(complete);
    }
};

// -- Transition fx ------------------------------------------------------------
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 266);
Y.mix(Y.Transition.fx, {
    'app:fadeIn': {
        ...
        on: {
            start: function (data) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "start", 272);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 273);
var styles = {opacity: 0},
                    config = data.config;

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 276);
if (config.crossView && !config.prepended) {
                    _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 277);
styles.transform = 'translateX(-100%)';
                }

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 280);
this.setStyles(styles);
            },

            end: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "end", 283);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 284);
this.setStyle('transform', 'translateX(0)');
    ...
    'app:fadeOut': {
        ...
        on: {
            start: function (data) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "start", 294);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 295);
var styles = {opacity: 1},
                    config = data.config;

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 298);
if (config.crossView && config.prepended) {
                    _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 299);
styles.transform = 'translateX(-100%)';
                }

                _yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 302);
this.setStyles(styles);
            },

            end: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "end", 305);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 306);
this.setStyle('transform', 'translateX(0)');
            }
        }
    },
    ...
    'app:slideLeft': {
        ...
        on: {
            start: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "start", 316);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 317);
this.setStyles({
                    opacity  : 1,
                ...
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "end", 323);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 324);
this.setStyle('transform', 'translateX(0)');
            }
        }
    },
    ...
    'app:slideRight': {
        ...
        on: {
            start: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "start", 334);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 335);
this.setStyles({
                    opacity  : 1,
                    transform: 'translateX(-100%)'
                });
                ...
                _yuitest_coverfunc("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", "end", 341);
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 342);
this.setStyle('transform', 'translateX(0)');
            }
        }
    }
...
// -- Namespacae ---------------------------------------------------------------
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 349);
Y.App.TransitionsNative = AppTransitionsNative;
_yuitest_coverline("/home/yui/src/yui3/src/app/build_tmp/app-transitions-native.js", 350);
Y.Base.mix(Y.App, [AppTransitionsNative]);
