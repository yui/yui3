...
_yuitest_coverage["/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 12);
var YArray     = Y.Array,
    YObject    = Y.Object,
...
Filters = Y.mix(Y.namespace('AutoCompleteFilters'), {
    ...
    **/
    charMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "charMatch", 29);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 33);
if (!query) { return results; }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 35);
var queryChars = YArray.unique((caseSensitive ? query :
                query.toLowerCase()).split(''));

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 38);
return YArray.filter(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 2)", 38);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 39);
result = result.text;

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 41);
if (!caseSensitive) {
                _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 42);
result = result.toLowerCase();
            }

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 45);
return YArray.every(queryChars, function (chr) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 3)", 45);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 46);
return result.indexOf(chr) !== -1;
    ...
    **/
    charMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "charMatchCase", 60);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 61);
return Filters.charMatch(query, results, true);
    ...
    **/
    phraseMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "phraseMatch", 74);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 78);
if (!query) { return results; }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 80);
if (!caseSensitive) {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 81);
query = query.toLowerCase();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 84);
return YArray.filter(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 4)", 84);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 85);
return (caseSensitive ? result.text : result.text.toLowerCase()).indexOf(query) !== -1;
    ...
    **/
    phraseMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "phraseMatchCase", 98);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 99);
return Filters.phraseMatch(query, results, true);
    ...
    **/
    startsWith: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "startsWith", 112);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 116);
if (!query) { return results; }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 118);
if (!caseSensitive) {
            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 119);
query = query.toLowerCase();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 122);
return YArray.filter(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 5)", 122);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 123);
return (caseSensitive ? result.text : result.text.toLowerCase()).indexOf(query) === 0;
    ...
    **/
    startsWithCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "startsWithCase", 136);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 137);
return Filters.startsWith(query, results, true);
    ...
    **/
    subWordMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "subWordMatch", 160);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 164);
if (!query) { return results; }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 166);
var queryWords = WordBreak.getUniqueWords(query, {
            ignoreCase: !caseSensitive
        });

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 170);
return YArray.filter(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 6)", 170);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 171);
var resultText = caseSensitive ? result.text :
                    result.text.toLowerCase();

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 174);
return YArray.every(queryWords, function (queryWord) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 7)", 174);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 175);
return resultText.indexOf(queryWord) !== -1;
    ...
    **/
    subWordMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "subWordMatchCase", 189);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 190);
return Filters.subWordMatch(query, results, true);
    ...
    **/
    wordMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "wordMatch", 204);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 208);
if (!query) { return results; }

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 210);
var options    = {ignoreCase: !caseSensitive},
            queryWords = WordBreak.getUniqueWords(query, options);

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 213);
return YArray.filter(results, function (result) {
            // Convert resultWords array to a hash for fast lookup.
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 8)", 213);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 215);
var resultWords = YArray.hash(WordBreak.getUniqueWords(result.text,
                                options));

            _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 218);
return YArray.every(queryWords, function (word) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "(anonymous 9)", 218);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 219);
return YObject.owns(resultWords, word);
    ...
    **/
    wordMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", "wordMatchCase", 233);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-filters.js", 234);
