...
_yuitest_coverage["dd-drag"].functions = {"Drag:194":0,"setter:220":0,"setter:237":0,"setter:287":0,"setter:354":0,"setter:366":0,"(anonymous 2):382":0,"getter:377":0,"(anonymous 3):389":0,"setter:387":0,"(anonymous 4):405":0,"setter:402":0,"setter:425":0,"_canDrag:450":0,"addToGroup:469":0,"removeFromGroup:481":0,"_handleTarget:498":0,"(anonymous 5):577":0,"_createEvents:528":0,"_handleMouseUp:705":0,"_fixDragStart:718":0,"_ieSelectFix:728":0,"_fixIEMouseDown:742":0,"_fixIEMouseUp:753":0,"_handleMouseDownEvent:764":0,"_defMouseDownFn:773":0,"(anonymous 7):819":0,"(anonymous 6):812":0,"(anonymous 8):841":0,"(anonymous 9):855":0,"validClick:804":0,"_setStartPosition:873":0,"_timeoutCheck:889":0,"removeHandle:903":0,"addHandle:921":0,"removeInvalid:940":0,"addInvalid:955":0,"initializer:967":0,"_prep:998":0,"_unprep:1011":0,"start:1031":0,"end:1073":0,"_defEndFn:1099":0,"_prevEndFn:1108":0,"_align:1121":0,"_defAlignFn:1130":0,"_alignNode:1139":0,"_moveNode:1150":0,"_defDragFn:1193":0,"_move:1209":0,"stopDrag:1236":0,"destructor:1247":0,"(anonymous 1):1":0};
_yuitest_coverage["dd-drag"].coveredLines = 272;
...
this.target = null;
                    ...
                    _yuitest_coverline("dd-drag", 506);
if (!Y.Lang.isObject(config)) {
                        _yuitest_coverline("dd-drag", 507);
config = {};
                    }
                    _yuitest_coverline("dd-drag", 509);
...
this.target = new Y.DD.Drop(config);
        ...
        */
        _createEvents: function() {
            ...
            _yuitest_coverfunc("dd-drag", "_createEvents", 528);
_yuitest_coverline("dd-drag", 530);
this.publish(EV_MOUSE_DOWN, {
            ...
            _yuitest_coverline("dd-drag", 538);
this.publish(EV_ALIGN, {
            ...
            _yuitest_coverline("dd-drag", 546);
this.publish(EV_DRAG, {
            ...
            _yuitest_coverline("dd-drag", 554);
this.publish(EV_END, {
            ...
            _yuitest_coverline("dd-drag", 563);
var ev = [
                EV_AFTER_MOUSE_DOWN,
                EV_REMOVE_HANDLE,
                EV_ADD_HANDLE,
            ...
            _yuitest_coverline("dd-drag", 577);
Y.each(ev, function(v, k) {
                _yuitest_coverfunc("dd-drag", "(anonymous 5)", 577);
_yuitest_coverline("dd-drag", 578);
this.publish(v, {
                    type: v,
                    emitFacade: true,
                    bubbles: true,
        ...
        */
        _handleMouseUp: function(ev) {
            _yuitest_coverfunc("dd-drag", "_handleMouseUp", 705);
_yuitest_coverline("dd-drag", 706);
this.fire('drag:mouseup');
            _yuitest_coverline("dd-drag", 707);
this._fixIEMouseUp();
            _yuitest_coverline("dd-drag", 708);
if (DDM.activeDrag) {
...
DDM._end();
        ...
        */
        _fixDragStart: function(e) {
            _yuitest_coverfunc("dd-drag", "_fixDragStart", 718);
_yuitest_coverline("dd-drag", 719);
if (this.validClick(e)) {
                _yuitest_coverline("dd-drag", 720);
e.preventDefault();
            }
        },
        /** 
        ...
        */
        _ieSelectFix: function() {
            _yuitest_coverfunc("dd-drag", "_ieSelectFix", 728);
_yuitest_coverline("dd-drag", 729);
return false;
        },
        /** 
        * @private
        ...
        */
        _fixIEMouseDown: function(e) {
            _yuitest_coverfunc("dd-drag", "_fixIEMouseDown", 742);
_yuitest_coverline("dd-drag", 743);
if (Y.UA.ie) {
                _yuitest_coverline("dd-drag", 744);
this._ieSelectBack = Y.config.doc.body.onselectstart;
                _yuitest_coverline("dd-drag", 745);
Y.config.doc.body.onselectstart = this._ieSelectFix;
        ...
        */
        _fixIEMouseUp: function() {
            _yuitest_coverfunc("dd-drag", "_fixIEMouseUp", 753);
_yuitest_coverline("dd-drag", 754);
if (Y.UA.ie) {
                _yuitest_coverline("dd-drag", 755);
Y.config.doc.body.onselectstart = this._ieSelectBack;
        ...
        */
        _handleMouseDownEvent: function(ev) {
            _yuitest_coverfunc("dd-drag", "_handleMouseDownEvent", 764);
_yuitest_coverline("dd-drag", 765);
this.fire(EV_MOUSE_DOWN, { ev: ev });
        ...
        */
        _defMouseDownFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defMouseDownFn", 773);
_yuitest_coverline("dd-drag", 774);
var ev = e.ev;

            _yuitest_coverline("dd-drag", 776);
...
this._fixIEMouseDown(ev);
                _yuitest_coverline("dd-drag", 784);
...
this._setStartPosition([ev.pageX, ev.pageY]);
                ...
                _yuitest_coverline("dd-drag", 792);
DDM.activeDrag = this;
                
                _yuitest_coverline("dd-drag", 794);
this._clickTimeout = Y.later(this.get('clickTimeThresh'), this, this._timeoutCheck);
            }
            _yuitest_coverline("dd-drag", 796);
this.fire(EV_AFTER_MOUSE_DOWN, { ev: ev });
        ...
        */
        validClick: function(ev) {
            _yuitest_coverfunc("dd-drag", "validClick", 804);
_yuitest_coverline("dd-drag", 805);
var r = false, n = false,
            tar = ev.target,
            hTest = null,
            els = null,
            nlist = null,
            set = false;
            _yuitest_coverline("dd-drag", 811);
if (this._handles) {
                _yuitest_coverline("dd-drag", 812);
Y.each(this._handles, function(i, n) {
                    _yuitest_coverfunc("dd-drag", "(anonymous 6)", 812);
_yuitest_coverline("dd-drag", 813);
...
nlist.each(function(nl) {
                                _yuitest_coverfunc("dd-drag", "(anonymous 7)", 819);
_yuitest_coverline("dd-drag", 820);
if (nl.contains(tar)) {
                                    _yuitest_coverline("dd-drag", 821);
r = true;
                                }
                            });
                        }
                    } else {_yuitest_coverline("dd-drag", 825);
if (Y.Lang.isString(n)) {
                        //Am I this or am I inside this
                        _yuitest_coverline("dd-drag", 827);
if (tar.test(n + ', ' + n + ' *') && !hTest) {
                            _yuitest_coverline("dd-drag", 828);
hTest = n;
                            _yuitest_coverline("dd-drag", 829);
r = true;
                        }
                    }}
                });
            } else {
                _yuitest_coverline("dd-drag", 834);
n = this.get(NODE);
                _yuitest_coverline("dd-drag", 835);
if (n.contains(tar) || n.compareTo(tar)) {
                    _yuitest_coverline("dd-drag", 836);
r = true;
                }
            }
            _yuitest_coverline("dd-drag", 839);
if (r) {
                _yuitest_coverline("dd-drag", 840);
if (this._invalids) {
                    _yuitest_coverline("dd-drag", 841);
Y.each(this._invalids, function(i, n) {
                        _yuitest_coverfunc("dd-drag", "(anonymous 8)", 841);
...
r = false;
            ...
            _yuitest_coverline("dd-drag", 851);
if (r) {
                _yuitest_coverline("dd-drag", 852);
if (hTest) {
                    _yuitest_coverline("dd-drag", 853);
els = ev.currentTarget.all(hTest);
                    _yuitest_coverline("dd-drag", 854);
set = false;
                    _yuitest_coverline("dd-drag", 855);
els.each(function(n, i) {
                        _yuitest_coverfunc("dd-drag", "(anonymous 9)", 855);
...
this.set('activeHandle', n);
                    ...
                    _yuitest_coverline("dd-drag", 862);
...
return r;
        ...
        */
        _setStartPosition: function(xy) {
            _yuitest_coverfunc("dd-drag", "_setStartPosition", 873);
_yuitest_coverline("dd-drag", 874);
this.startXY = xy;
            
            _yuitest_coverline("dd-drag", 876);
this.nodeXY = this.lastXY = this.realXY = this.get(NODE).getXY();
            
            _yuitest_coverline("dd-drag", 878);
...
this.deltaXY = [0, 0];
        ...
        */
        _timeoutCheck: function() {
            _yuitest_coverfunc("dd-drag", "_timeoutCheck", 889);
_yuitest_coverline("dd-drag", 890);
if (!this.get('lock') && !this._dragThreshMet && this._ev_md) {
                _yuitest_coverline("dd-drag", 891);
this._fromTimeout = this._dragThreshMet = true;
                _yuitest_coverline("dd-drag", 892);
this.start();
...
this._alignNode([this._ev_md.pageX, this._ev_md.pageY], true);
        ...
        */
        removeHandle: function(str) {
            _yuitest_coverfunc("dd-drag", "removeHandle", 903);
_yuitest_coverline("dd-drag", 904);
var key = str;
            _yuitest_coverline("dd-drag", 905);
if (str instanceof Y.Node || str instanceof Y.NodeList) {
                _yuitest_coverline("dd-drag", 906);
key = str._yuid;
            }
...
delete this._handles[key];
                _yuitest_coverline("dd-drag", 910);
...
return this;
        ...
        */
        addHandle: function(str) {
            _yuitest_coverfunc("dd-drag", "addHandle", 921);
_yuitest_coverline("dd-drag", 922);
if (!this._handles) {
                _yuitest_coverline("dd-drag", 923);
this._handles = {};
            }
...
if (str instanceof Y.Node || str instanceof Y.NodeList) {
                _yuitest_coverline("dd-drag", 927);
key = str._yuid;
            }
...
this.fire(EV_ADD_HANDLE, { handle: str });
            _yuitest_coverline("dd-drag", 931);
return this;
        },
        /**
        ...
        */
        removeInvalid: function(str) {
            _yuitest_coverfunc("dd-drag", "removeInvalid", 940);
_yuitest_coverline("dd-drag", 941);
if (this._invalids[str]) {
                _yuitest_coverline("dd-drag", 942);
this._invalids[str] = null;
                _yuitest_coverline("dd-drag", 943);
...
return this;
        ...
        */
        addInvalid: function(str) {
            _yuitest_coverfunc("dd-drag", "addInvalid", 955);
_yuitest_coverline("dd-drag", 956);
if (Y.Lang.isString(str)) {
                _yuitest_coverline("dd-drag", 957);
this._invalids[str] = true;
                _yuitest_coverline("dd-drag", 958);
...
return this;
        ...
        */
        initializer: function(cfg) {
            ...
            _yuitest_coverfunc("dd-drag", "initializer", 967);
_yuitest_coverline("dd-drag", 969);
this.get(NODE).dd = this;

            _yuitest_coverline("dd-drag", 971);
if (!this.get(NODE).get('id')) {
                _yuitest_coverline("dd-drag", 972);
var id = Y.stamp(this.get(NODE));
                _yuitest_coverline("dd-drag", 973);
...
this.actXY = [];
            ...
            _yuitest_coverline("dd-drag", 978);
this._invalids = Y.clone(this._invalidsDefault, true);

            _yuitest_coverline("dd-drag", 980);
this._createEvents();
            
            _yuitest_coverline("dd-drag", 982);
...
this.set(DRAG_NODE, this.get(NODE));
            ...
            _yuitest_coverline("dd-drag", 988);
...
this.set('groups', this.get('groups'));
        ...
        */
        _prep: function() {
            _yuitest_coverfunc("dd-drag", "_prep", 998);
_yuitest_coverline("dd-drag", 999);
this._dragThreshMet = false;
            _yuitest_coverline("dd-drag", 1000);
var node = this.get(NODE);
            _yuitest_coverline("dd-drag", 1001);
...
node.on('dragstart', Y.bind(this._fixDragStart, this));
        ...
        */
        _unprep: function() {
            _yuitest_coverfunc("dd-drag", "_unprep", 1011);
_yuitest_coverline("dd-drag", 1012);
var node = this.get(NODE);
            _yuitest_coverline("dd-drag", 1013);
node.removeClass(DDM.CSS_PREFIX + '-draggable');
            _yuitest_coverline("dd-drag", 1014);
...
this.realXY = [];
        ...
        */
        start: function() {
            _yuitest_coverfunc("dd-drag", "start", 1031);
_yuitest_coverline("dd-drag", 1032);
if (!this.get('lock') && !this.get(DRAGGING)) {
                _yuitest_coverline("dd-drag", 1033);
var node = this.get(NODE), ow, oh, xy;
                _yuitest_coverline("dd-drag", 1034);
...
node.addClass(DDM.CSS_PREFIX + '-dragging');
                _yuitest_coverline("dd-drag", 1038);
this.fire(EV_START, {
                    pageX: this.nodeXY[0],
                    pageY: this.nodeXY[1],
                    startTime: this._startTime
                });
                _yuitest_coverline("dd-drag", 1043);
node = this.get(DRAG_NODE);
                _yuitest_coverline("dd-drag", 1044);
xy = this.nodeXY;
...
this._setStartPosition([xy[0] + (ow / 2), xy[1] + (oh / 2)]);
                ...
                _yuitest_coverline("dd-drag", 1054);
this.region = {
                    '0': xy[0], 
                    '1': xy[1],
                    area: 0,
                ...
                _yuitest_coverline("dd-drag", 1063);
this.set(DRAGGING, true);
            }
            _yuitest_coverline("dd-drag", 1065);
return this;
        },
        /**
        * @method end
        ...
        */
            ...
            _yuitest_coverfunc("dd-drag", "end", 1073);
_yuitest_coverline("dd-drag", 1074);
this._endTime = (new Date()).getTime();
            _yuitest_coverline("dd-drag", 1075);
if (this._clickTimeout) {
                _yuitest_coverline("dd-drag", 1076);
this._clickTimeout.cancel();
            }
            _yuitest_coverline("dd-drag", 1078);
this._dragThreshMet = this._fromTimeout = false;

            _yuitest_coverline("dd-drag", 1080);
if (!this.get('lock') && this.get(DRAGGING)) {
...
this.fire(EV_END, {
            ...
            _yuitest_coverline("dd-drag", 1088);
this.get(NODE).removeClass(DDM.CSS_PREFIX + '-dragging');
            _yuitest_coverline("dd-drag", 1089);
this.set(DRAGGING, false);
            _yuitest_coverline("dd-drag", 1090);
this.deltaXY = [0, 0];
...
return this;
        ...
        */
        _defEndFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defEndFn", 1099);
_yuitest_coverline("dd-drag", 1100);
this._fixIEMouseUp();
            _yuitest_coverline("dd-drag", 1101);
this._ev_md = null;
        },
        /**
        * @private
        ...
        */
        _prevEndFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_prevEndFn", 1108);
_yuitest_coverline("dd-drag", 1109);
this._fixIEMouseUp();
            //Bug #1852577
            _yuitest_coverline("dd-drag", 1111);
this.get(DRAG_NODE).setXY(this.nodeXY);
            _yuitest_coverline("dd-drag", 1112);
this._ev_md = null;
            _yuitest_coverline("dd-drag", 1113);
this.region = null;
        },
        /**
        * @private
        ...
        */
        _align: function(xy) {
            _yuitest_coverfunc("dd-drag", "_align", 1121);
_yuitest_coverline("dd-drag", 1122);
this.fire(EV_ALIGN, {pageX: xy[0], pageY: xy[1] });
        ...
        */
        _defAlignFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defAlignFn", 1130);
_yuitest_coverline("dd-drag", 1131);
this.actXY = [e.pageX - this.deltaXY[0], e.pageY - this.deltaXY[1]];
        ...
        */
        _alignNode: function(eXY, scroll) {
            _yuitest_coverfunc("dd-drag", "_alignNode", 1139);
_yuitest_coverline("dd-drag", 1140);
this._align(eXY);
            _yuitest_coverline("dd-drag", 1141);
if (!scroll) {
                _yuitest_coverline("dd-drag", 1142);
this._moveNode();
            }
        },
        /**
        ...
        */
        _moveNode: function(scroll) {
            ...
            //    return;
            //}
            _yuitest_coverfunc("dd-drag", "_moveNode", 1150);
_yuitest_coverline("dd-drag", 1154);
var diffXY = [], diffXY2 = [], startXY = this.nodeXY, xy = this.actXY;

            _yuitest_coverline("dd-drag", 1156);
...
this.region = {
            ...
            _yuitest_coverline("dd-drag", 1173);
this.fire(EV_DRAG, {
                pageX: xy[0],
                pageY: xy[1],
                scroll: scroll,
            ...
            _yuitest_coverline("dd-drag", 1185);
this.lastXY = xy;
        },
        /**
        * @private
        ...
        */
        _defDragFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defDragFn", 1193);
_yuitest_coverline("dd-drag", 1194);
if (this.get('move')) {
                _yuitest_coverline("dd-drag", 1195);
if (e.scroll && e.scroll.node) {
                    _yuitest_coverline("dd-drag", 1196);
...
this.realXY = [e.pageX, e.pageY];
        ...
        */
        _move: function(ev) {
            _yuitest_coverfunc("dd-drag", "_move", 1209);
_yuitest_coverline("dd-drag", 1210);
if (this.get('lock')) {
                _yuitest_coverline("dd-drag", 1211);
return false;
            }

            _yuitest_coverline("dd-drag", 1214);
this.mouseXY = [ev.pageX, ev.pageY];
            _yuitest_coverline("dd-drag", 1215);
...
if (diffX > this.get('clickPixelThresh') || diffY > this.get('clickPixelThresh')) {
                    _yuitest_coverline("dd-drag", 1219);
...
this._alignNode([ev.pageX, ev.pageY]);
                ...
                _yuitest_coverline("dd-drag", 1224);
if (this._clickTimeout) {
                    _yuitest_coverline("dd-drag", 1225);
this._clickTimeout.cancel();
                }
...
this._alignNode([ev.pageX, ev.pageY]);
        ...
        */
        stopDrag: function() {
            _yuitest_coverfunc("dd-drag", "stopDrag", 1236);
_yuitest_coverline("dd-drag", 1237);
if (this.get(DRAGGING)) {
                _yuitest_coverline("dd-drag", 1238);
DDM._end();
            }
...
return this;
        ...
        */
        destructor: function() {
            _yuitest_coverfunc("dd-drag", "destructor", 1247);
_yuitest_coverline("dd-drag", 1248);
this._unprep();
            _yuitest_coverline("dd-drag", 1249);
if (this.target) {
                _yuitest_coverline("dd-drag", 1250);
this.target.destroy();
            }
...
Y.namespace('DD');    
    _yuitest_coverline("dd-drag", 1256);
Y.DD.Drag = Drag;
