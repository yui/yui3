...
_yuitest_coverage["/build/dd-drag/dd-drag.js"].functions = {"Drag:194":0,"setter:220":0,"setter:237":0,"setter:287":0,"setter:354":0,"setter:366":0,"(anonymous 2):382":0,"getter:377":0,"(anonymous 3):389":0,"setter:387":0,"(anonymous 4):405":0,"setter:402":0,"setter:425":0,"_canDrag:450":0,"addToGroup:469":0,"removeFromGroup:481":0,"_handleTarget:498":0,"(anonymous 5):580":0,"_createEvents:531":0,"_handleMouseUp:708":0,"_fixDragStart:721":0,"_ieSelectFix:731":0,"_fixIEMouseDown:745":0,"_fixIEMouseUp:756":0,"_handleMouseDownEvent:767":0,"_defMouseDownFn:776":0,"(anonymous 7):822":0,"(anonymous 6):815":0,"(anonymous 8):844":0,"(anonymous 9):858":0,"validClick:807":0,"_setStartPosition:876":0,"_timeoutCheck:892":0,"removeHandle:906":0,"addHandle:924":0,"removeInvalid:943":0,"addInvalid:958":0,"initializer:970":0,"_prep:1001":0,"_unprep:1014":0,"start:1034":0,"end:1076":0,"_defEndFn:1102":0,"_prevEndFn:1111":0,"_align:1124":0,"_defAlignFn:1133":0,"_alignNode:1142":0,"_moveNode:1153":0,"_defDragFn:1196":0,"_move:1212":0,"stopDrag:1239":0,"destructor:1250":0,"(anonymous 1):1":0};
...
this.target = new Y.DD.Drop(config);
                ...
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 516);
return false;
            }
        },
        /**
        ...
        */
        _createEvents: function() {
            ...
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_createEvents", 531);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 533);
this.publish(EV_MOUSE_DOWN, {
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 541);
this.publish(EV_ALIGN, {
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 549);
this.publish(EV_DRAG, {
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 557);
this.publish(EV_END, {
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 566);
var ev = [
                EV_AFTER_MOUSE_DOWN,
                EV_REMOVE_HANDLE,
                EV_ADD_HANDLE,
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 580);
Y.each(ev, function(v, k) {
                _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "(anonymous 5)", 580);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 581);
this.publish(v, {
                    type: v,
                    emitFacade: true,
                    bubbles: true,
        ...
        */
        _handleMouseUp: function(ev) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_handleMouseUp", 708);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 709);
this.fire('drag:mouseup');
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 710);
this._fixIEMouseUp();
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 711);
if (DDM.activeDrag) {
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 712);
DDM._end();
            }
        },
        /** 
        ...
        */
        _fixDragStart: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_fixDragStart", 721);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 722);
if (this.validClick(e)) {
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 723);
e.preventDefault();
            }
        },
        /** 
        ...
        */
        _ieSelectFix: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_ieSelectFix", 731);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 732);
return false;
        },
        /** 
        * @private
        ...
        */
        _fixIEMouseDown: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_fixIEMouseDown", 745);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 746);
if (Y.UA.ie) {
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 747);
this._ieSelectBack = Y.config.doc.body.onselectstart;
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 748);
Y.config.doc.body.onselectstart = this._ieSelectFix;
        ...
        */
        _fixIEMouseUp: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_fixIEMouseUp", 756);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 757);
if (Y.UA.ie) {
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 758);
Y.config.doc.body.onselectstart = this._ieSelectBack;
        ...
        */
        _handleMouseDownEvent: function(ev) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_handleMouseDownEvent", 767);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 768);
this.fire(EV_MOUSE_DOWN, { ev: ev });
        ...
        */
        _defMouseDownFn: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_defMouseDownFn", 776);
...
ev.preventDefault();
                ...
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 793);
...
this.fire(EV_AFTER_MOUSE_DOWN, { ev: ev });
        ...
        */
        validClick: function(ev) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "validClick", 807);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 808);
var r = false, n = false,
            tar = ev.target,
            hTest = null,
            els = null,
...
Y.each(this._handles, function(i, n) {
                    _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "(anonymous 6)", 815);
...
nlist.each(function(nl) {
                                _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "(anonymous 7)", 822);
...
r = true;
                    ...
                    } else {_yuitest_coverline("/build/dd-drag/dd-drag.js", 828);
...
Y.each(this._invalids, function(i, n) {
                        _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "(anonymous 8)", 844);
...
els.each(function(n, i) {
                        _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "(anonymous 9)", 858);
...
this.set('activeHandle', this.get(NODE));
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 868);
return r;
        },
        /**
        * @private
        ...
        */
        _setStartPosition: function(xy) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_setStartPosition", 876);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 877);
this.startXY = xy;
...
this.deltaXY = [(this.startXY[0] - this.nodeXY[0]), (this.startXY[1] - this.nodeXY[1])];
                ...
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 884);
this.deltaXY = [0, 0];
            }
        },
        /**
        ...
        */
        _timeoutCheck: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_timeoutCheck", 892);
...
this._alignNode([this._ev_md.pageX, this._ev_md.pageY], true);
        ...
        */
        removeHandle: function(str) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "removeHandle", 906);
...
return this;
        ...
        */
        addHandle: function(str) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "addHandle", 924);
...
return this;
        ...
        */
        removeInvalid: function(str) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "removeInvalid", 943);
...
return this;
        ...
        */
        addInvalid: function(str) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "addInvalid", 958);
...
return this;
        ...
        */
        initializer: function(cfg) {
            ...
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "initializer", 970);
...
this.actXY = [];
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 981);
...
this.on('initializedChange', Y.bind(this._prep, this));
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 994);
this.set('groups', this.get('groups'));
        ...
        */
        _prep: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_prep", 1001);
...
node.on('dragstart', Y.bind(this._fixDragStart, this));
        ...
        */
        _unprep: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_unprep", 1014);
...
this.realXY = [];
        ...
        */
        start: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "start", 1034);
...
this.region = {
                ...
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 1066);
this.set(DRAGGING, true);
            }
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 1068);
return this;
        },
        /**
        * @method end
        ...
        */
            ...
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "end", 1076);
...
return this;
        ...
        */
        _defEndFn: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_defEndFn", 1102);
...
this._ev_md = null;
        ...
        */
        _prevEndFn: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_prevEndFn", 1111);
...
this.region = null;
        ...
        */
        _align: function(xy) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_align", 1124);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 1125);
this.fire(EV_ALIGN, {pageX: xy[0], pageY: xy[1] });
        ...
        */
        _defAlignFn: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_defAlignFn", 1133);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 1134);
this.actXY = [e.pageX - this.deltaXY[0], e.pageY - this.deltaXY[1]];
        ...
        */
        _alignNode: function(eXY, scroll) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_alignNode", 1142);
...
this._moveNode();
        ...
        */
        _moveNode: function(scroll) {
            ...
            //    return;
            //}
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_moveNode", 1153);
...
this.region = {
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 1176);
this.fire(EV_DRAG, {
                pageX: xy[0],
                pageY: xy[1],
                scroll: scroll,
            ...
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 1188);
this.lastXY = xy;
        },
        /**
        * @private
        ...
        */
        _defDragFn: function(e) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_defDragFn", 1196);
...
this.realXY = [e.pageX, e.pageY];
        ...
        */
        _move: function(ev) {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "_move", 1212);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 1213);
if (this.get('lock')) {
...
this._alignNode([ev.pageX, ev.pageY]);
        ...
        */
        stopDrag: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "stopDrag", 1239);
_yuitest_coverline("/build/dd-drag/dd-drag.js", 1240);
if (this.get(DRAGGING)) {
                _yuitest_coverline("/build/dd-drag/dd-drag.js", 1241);
DDM._end();
            }
            _yuitest_coverline("/build/dd-drag/dd-drag.js", 1243);
return this;
        },
        /**
        * @private
        ...
        */
        destructor: function() {
            _yuitest_coverfunc("/build/dd-drag/dd-drag.js", "destructor", 1250);
...
DDM._unregDrag(this);
    ...
    _yuitest_coverline("/build/dd-drag/dd-drag.js", 1258);
Y.namespace('DD');    
