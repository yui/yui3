...
YUI.add('dd-drag', function (Y, NAME) {
    ...
    _yuitest_coverfunc("dd-drag", "(anonymous 1)", 1);
_yuitest_coverline("dd-drag", 17);
var DDM = Y.DD.DDM,
        NODE = 'node',
        DRAGGING = 'dragging',
        DRAG_NODE = 'dragNode',
    ...
    Drag = function(o) {
        _yuitest_coverfunc("dd-drag", "Drag", 194);
_yuitest_coverline("dd-drag", 195);
this._lazyAddAttrs = false;
        _yuitest_coverline("dd-drag", 196);
Drag.superclass.constructor.apply(this, arguments);

        _yuitest_coverline("dd-drag", 198);
var valid = DDM._regDrag(this);
        _yuitest_coverline("dd-drag", 199);
if (!valid) {
            _yuitest_coverline("dd-drag", 200);
Y.error('Failed to register node, already in use: ' + o.node);
        }
    };

    _yuitest_coverline("dd-drag", 204);
Drag.NAME = 'drag';
    ...
    */
    _yuitest_coverline("dd-drag", 211);
Drag.START_EVENT = 'mousedown';

    _yuitest_coverline("dd-drag", 213);
Drag.ATTRS = {
        /**
        * @attribute node
        ...
        */
        node: {
            setter: function(node) {
                _yuitest_coverfunc("dd-drag", "setter", 220);
_yuitest_coverline("dd-drag", 221);
if (this._canDrag(node)) {
                    _yuitest_coverline("dd-drag", 222);
return node;
                }
                _yuitest_coverline("dd-drag", 224);
var n = Y.one(node);
                _yuitest_coverline("dd-drag", 225);
if (!n) {
                    _yuitest_coverline("dd-drag", 226);
Y.error('DD.Drag: Invalid Node Given: ' + node);
                }
                _yuitest_coverline("dd-drag", 228);
return n;
            }
        },
        /**
        ...
        */
        dragNode: {
            setter: function(node) {
                _yuitest_coverfunc("dd-drag", "setter", 237);
_yuitest_coverline("dd-drag", 238);
if (this._canDrag(node)) {
                    _yuitest_coverline("dd-drag", 239);
return node;
                }
                _yuitest_coverline("dd-drag", 241);
var n = Y.one(node);
                _yuitest_coverline("dd-drag", 242);
if (!n) {
                    _yuitest_coverline("dd-drag", 243);
Y.error('DD.Drag: Invalid dragNode Given: ' + node);
                }
                _yuitest_coverline("dd-drag", 245);
return n;
            }
        },
        /**
        ...
        */
        lock: {
            ...
            setter: function(lock) {
                _yuitest_coverfunc("dd-drag", "setter", 287);
_yuitest_coverline("dd-drag", 288);
if (lock) {
                    _yuitest_coverline("dd-drag", 289);
this.get(NODE).addClass(DDM.CSS_PREFIX + '-locked');
                } else {
                    _yuitest_coverline("dd-drag", 291);
this.get(NODE).removeClass(DDM.CSS_PREFIX + '-locked');
                }
                _yuitest_coverline("dd-drag", 293);
return lock;
            }
        },
        /**
        ...
        */
        target: {
            ...
            setter: function(config) {
                _yuitest_coverfunc("dd-drag", "setter", 354);
_yuitest_coverline("dd-drag", 355);
this._handleTarget(config);
                _yuitest_coverline("dd-drag", 356);
return config;
            }
        },
        /**
        ...
        */
        dragMode: {
            ...
            setter: function(mode) {
                _yuitest_coverfunc("dd-drag", "setter", 366);
_yuitest_coverline("dd-drag", 367);
return DDM._setDragMode(mode);
        ...
        */
        groups: {
            value: ['default'],
            getter: function() {
                _yuitest_coverfunc("dd-drag", "getter", 377);
_yuitest_coverline("dd-drag", 378);
if (!this._groups) {
                    _yuitest_coverline("dd-drag", 379);
this._groups = {};
                }
                _yuitest_coverline("dd-drag", 381);
var ret = [];
                _yuitest_coverline("dd-drag", 382);
Y.each(this._groups, function(v, k) {
                    _yuitest_coverfunc("dd-drag", "(anonymous 2)", 382);
_yuitest_coverline("dd-drag", 383);
ret[ret.length] = k;
                });
                _yuitest_coverline("dd-drag", 385);
return ret;
            },
            setter: function(g) {
                _yuitest_coverfunc("dd-drag", "setter", 387);
_yuitest_coverline("dd-drag", 388);
this._groups = {};
                _yuitest_coverline("dd-drag", 389);
Y.each(g, function(v, k) {
                    _yuitest_coverfunc("dd-drag", "(anonymous 3)", 389);
_yuitest_coverline("dd-drag", 390);
this._groups[v] = true;
                }, this);
                _yuitest_coverline("dd-drag", 392);
return g;
            }
        },
        /**
        ...
        */
        handles: {
            value: null,
            setter: function(g) {
                _yuitest_coverfunc("dd-drag", "setter", 402);
_yuitest_coverline("dd-drag", 403);
if (g) {
                    _yuitest_coverline("dd-drag", 404);
this._handles = {};
                    _yuitest_coverline("dd-drag", 405);
Y.each(g, function(v, k) {
                        _yuitest_coverfunc("dd-drag", "(anonymous 4)", 405);
_yuitest_coverline("dd-drag", 406);
var key = v;
                        _yuitest_coverline("dd-drag", 407);
if (v instanceof Y.Node || v instanceof Y.NodeList) {
                            _yuitest_coverline("dd-drag", 408);
key = v._yuid;
                        }
                        _yuitest_coverline("dd-drag", 410);
this._handles[key] = v;
                    }, this);
                } else {
                    _yuitest_coverline("dd-drag", 413);
this._handles = null;
                }
                _yuitest_coverline("dd-drag", 415);
return g;
            }
        },
        /**
        ...
        */
        bubbles: {
            setter: function(t) {
                _yuitest_coverfunc("dd-drag", "setter", 425);
_yuitest_coverline("dd-drag", 426);
this.addTarget(t);
                _yuitest_coverline("dd-drag", 427);
return t;
            }
        },
        /**
    ...
    _yuitest_coverline("dd-drag", 440);
Y.extend(Drag, Y.Base, {
        ...
        */
        _canDrag: function(n) {
            _yuitest_coverfunc("dd-drag", "_canDrag", 450);
_yuitest_coverline("dd-drag", 451);
if (n && n.setXY && n.getXY && n.test && n.contains) {
                _yuitest_coverline("dd-drag", 452);
return true;
            }
            _yuitest_coverline("dd-drag", 454);
return false;
        },
        /**
        * @private
        ...
        */
        addToGroup: function(g) {
            _yuitest_coverfunc("dd-drag", "addToGroup", 469);
_yuitest_coverline("dd-drag", 470);
this._groups[g] = true;
            _yuitest_coverline("dd-drag", 471);
DDM._activateTargets();
            _yuitest_coverline("dd-drag", 472);
return this;
        },
        /**
        ...
        */
        removeFromGroup: function(g) {
            _yuitest_coverfunc("dd-drag", "removeFromGroup", 481);
_yuitest_coverline("dd-drag", 482);
delete this._groups[g];
            _yuitest_coverline("dd-drag", 483);
DDM._activateTargets();
            _yuitest_coverline("dd-drag", 484);
return this;
        },
        /**
        * @property target
        ...
        */
        _handleTarget: function(config) {
            _yuitest_coverfunc("dd-drag", "_handleTarget", 498);
_yuitest_coverline("dd-drag", 499);
if (Y.DD.Drop) {
                _yuitest_coverline("dd-drag", 500);
if (config === false) {
                    _yuitest_coverline("dd-drag", 501);
if (this.target) {
                        _yuitest_coverline("dd-drag", 502);
DDM._unregTarget(this.target);
                        _yuitest_coverline("dd-drag", 503);
this.target = null;
                    }
                    _yuitest_coverline("dd-drag", 505);
return false;
                } else {
                    _yuitest_coverline("dd-drag", 507);
if (!Y.Lang.isObject(config)) {
                        _yuitest_coverline("dd-drag", 508);
config = {};
                    }
                    _yuitest_coverline("dd-drag", 510);
config.bubbleTargets = ('bubbleTargets' in config) ? config.bubbleTargets : Y.Object.values(this._yuievt.targets);
                    _yuitest_coverline("dd-drag", 511);
config.node = this.get(NODE);
                    _yuitest_coverline("dd-drag", 512);
config.groups = config.groups || this.get('groups');
                    _yuitest_coverline("dd-drag", 513);
this.target = new Y.DD.Drop(config);
                }
            } else {
                _yuitest_coverline("dd-drag", 516);
return false;
            }
        },
        /**
        ...
        */
        _createEvents: function() {
            ...
            _yuitest_coverfunc("dd-drag", "_createEvents", 531);
_yuitest_coverline("dd-drag", 533);
this.publish(EV_MOUSE_DOWN, {
            ...
            _yuitest_coverline("dd-drag", 541);
this.publish(EV_ALIGN, {
            ...
            _yuitest_coverline("dd-drag", 549);
this.publish(EV_DRAG, {
            ...
            _yuitest_coverline("dd-drag", 557);
this.publish(EV_END, {
            ...
            _yuitest_coverline("dd-drag", 566);
var ev = [
                EV_AFTER_MOUSE_DOWN,
                EV_REMOVE_HANDLE,
                EV_ADD_HANDLE,
            ...
            _yuitest_coverline("dd-drag", 580);
Y.each(ev, function(v, k) {
                _yuitest_coverfunc("dd-drag", "(anonymous 5)", 580);
_yuitest_coverline("dd-drag", 581);
this.publish(v, {
                    type: v,
                    emitFacade: true,
                    bubbles: true,
        ...
        */
        _handleMouseUp: function(ev) {
            _yuitest_coverfunc("dd-drag", "_handleMouseUp", 708);
_yuitest_coverline("dd-drag", 709);
this.fire('drag:mouseup');
            _yuitest_coverline("dd-drag", 710);
this._fixIEMouseUp();
            _yuitest_coverline("dd-drag", 711);
if (DDM.activeDrag) {
                _yuitest_coverline("dd-drag", 712);
DDM._end();
            }
        },
        /** 
        ...
        */
        _fixDragStart: function(e) {
            _yuitest_coverfunc("dd-drag", "_fixDragStart", 721);
_yuitest_coverline("dd-drag", 722);
if (this.validClick(e)) {
                _yuitest_coverline("dd-drag", 723);
e.preventDefault();
            }
        },
        /** 
        ...
        */
        _ieSelectFix: function() {
            _yuitest_coverfunc("dd-drag", "_ieSelectFix", 731);
_yuitest_coverline("dd-drag", 732);
return false;
        },
        /** 
        * @private
        ...
        */
        _fixIEMouseDown: function(e) {
            _yuitest_coverfunc("dd-drag", "_fixIEMouseDown", 745);
_yuitest_coverline("dd-drag", 746);
if (Y.UA.ie) {
                _yuitest_coverline("dd-drag", 747);
this._ieSelectBack = Y.config.doc.body.onselectstart;
                _yuitest_coverline("dd-drag", 748);
Y.config.doc.body.onselectstart = this._ieSelectFix;
        ...
        */
        _fixIEMouseUp: function() {
            _yuitest_coverfunc("dd-drag", "_fixIEMouseUp", 756);
_yuitest_coverline("dd-drag", 757);
if (Y.UA.ie) {
                _yuitest_coverline("dd-drag", 758);
Y.config.doc.body.onselectstart = this._ieSelectBack;
        ...
        */
        _handleMouseDownEvent: function(ev) {
            _yuitest_coverfunc("dd-drag", "_handleMouseDownEvent", 767);
_yuitest_coverline("dd-drag", 768);
this.fire(EV_MOUSE_DOWN, { ev: ev });
        ...
        */
        _defMouseDownFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defMouseDownFn", 776);
_yuitest_coverline("dd-drag", 777);
var ev = e.ev;

            _yuitest_coverline("dd-drag", 779);
this._dragThreshMet = false;
            _yuitest_coverline("dd-drag", 780);
this._ev_md = ev;
            
            _yuitest_coverline("dd-drag", 782);
if (this.get('primaryButtonOnly') && ev.button > 1) {
                _yuitest_coverline("dd-drag", 783);
return false;
            }
            _yuitest_coverline("dd-drag", 785);
if (this.validClick(ev)) {
                _yuitest_coverline("dd-drag", 786);
this._fixIEMouseDown(ev);
                _yuitest_coverline("dd-drag", 787);
if (this.get('haltDown')) {
                    _yuitest_coverline("dd-drag", 788);
ev.halt();
                } else {
                    _yuitest_coverline("dd-drag", 790);
ev.preventDefault();
                }
                
                _yuitest_coverline("dd-drag", 793);
this._setStartPosition([ev.pageX, ev.pageY]);

                _yuitest_coverline("dd-drag", 795);
DDM.activeDrag = this;
                
                _yuitest_coverline("dd-drag", 797);
this._clickTimeout = Y.later(this.get('clickTimeThresh'), this, this._timeoutCheck);
            }
            _yuitest_coverline("dd-drag", 799);
this.fire(EV_AFTER_MOUSE_DOWN, { ev: ev });
        ...
        */
        validClick: function(ev) {
            _yuitest_coverfunc("dd-drag", "validClick", 807);
_yuitest_coverline("dd-drag", 808);
var r = false, n = false,
            tar = ev.target,
            hTest = null,
            els = null,
            nlist = null,
            set = false;
            _yuitest_coverline("dd-drag", 814);
if (this._handles) {
                _yuitest_coverline("dd-drag", 815);
Y.each(this._handles, function(i, n) {
                    _yuitest_coverfunc("dd-drag", "(anonymous 6)", 815);
_yuitest_coverline("dd-drag", 816);
if (i instanceof Y.Node || i instanceof Y.NodeList) {
                        _yuitest_coverline("dd-drag", 817);
if (!r) {
                            _yuitest_coverline("dd-drag", 818);
nlist = i;
                            _yuitest_coverline("dd-drag", 819);
if (nlist instanceof Y.Node) {
                                _yuitest_coverline("dd-drag", 820);
nlist = new Y.NodeList(i._node);
                            }
                            _yuitest_coverline("dd-drag", 822);
nlist.each(function(nl) {
                                _yuitest_coverfunc("dd-drag", "(anonymous 7)", 822);
_yuitest_coverline("dd-drag", 823);
if (nl.contains(tar)) {
                                    _yuitest_coverline("dd-drag", 824);
r = true;
                                }
                            });
                        }
                    } else {_yuitest_coverline("dd-drag", 828);
if (Y.Lang.isString(n)) {
                        //Am I this or am I inside this
                        _yuitest_coverline("dd-drag", 830);
if (tar.test(n + ', ' + n + ' *') && !hTest) {
                            _yuitest_coverline("dd-drag", 831);
hTest = n;
                            _yuitest_coverline("dd-drag", 832);
r = true;
                        }
                    }}
                });
            } else {
                _yuitest_coverline("dd-drag", 837);
n = this.get(NODE);
                _yuitest_coverline("dd-drag", 838);
if (n.contains(tar) || n.compareTo(tar)) {
                    _yuitest_coverline("dd-drag", 839);
r = true;
                }
            }
            _yuitest_coverline("dd-drag", 842);
if (r) {
                _yuitest_coverline("dd-drag", 843);
if (this._invalids) {
                    _yuitest_coverline("dd-drag", 844);
Y.each(this._invalids, function(i, n) {
                        _yuitest_coverfunc("dd-drag", "(anonymous 8)", 844);
_yuitest_coverline("dd-drag", 845);
if (Y.Lang.isString(n)) {
                            //Am I this or am I inside this
                            _yuitest_coverline("dd-drag", 847);
if (tar.test(n + ', ' + n + ' *')) {
                                _yuitest_coverline("dd-drag", 848);
r = false;
                            }
                        }
                    });
            ...
            _yuitest_coverline("dd-drag", 854);
if (r) {
                _yuitest_coverline("dd-drag", 855);
if (hTest) {
                    _yuitest_coverline("dd-drag", 856);
els = ev.currentTarget.all(hTest);
                    _yuitest_coverline("dd-drag", 857);
set = false;
                    _yuitest_coverline("dd-drag", 858);
els.each(function(n, i) {
                        _yuitest_coverfunc("dd-drag", "(anonymous 9)", 858);
_yuitest_coverline("dd-drag", 859);
if ((n.contains(tar) || n.compareTo(tar)) && !set) {
                            _yuitest_coverline("dd-drag", 860);
set = true;
                            _yuitest_coverline("dd-drag", 861);
this.set('activeHandle', n);
                        }
                    }, this);
                } else {
                    _yuitest_coverline("dd-drag", 865);
this.set('activeHandle', this.get(NODE));
                }
            }
            _yuitest_coverline("dd-drag", 868);
return r;
        },
        /**
        * @private
        ...
        */
        _setStartPosition: function(xy) {
            _yuitest_coverfunc("dd-drag", "_setStartPosition", 876);
_yuitest_coverline("dd-drag", 877);
this.startXY = xy;
            
            _yuitest_coverline("dd-drag", 879);
this.nodeXY = this.lastXY = this.realXY = this.get(NODE).getXY();
            
            _yuitest_coverline("dd-drag", 881);
if (this.get('offsetNode')) {
                _yuitest_coverline("dd-drag", 882);
this.deltaXY = [(this.startXY[0] - this.nodeXY[0]), (this.startXY[1] - this.nodeXY[1])];
            } else {
                _yuitest_coverline("dd-drag", 884);
this.deltaXY = [0, 0];
            }
        },
        /**
        ...
        */
        _timeoutCheck: function() {
            _yuitest_coverfunc("dd-drag", "_timeoutCheck", 892);
_yuitest_coverline("dd-drag", 893);
if (!this.get('lock') && !this._dragThreshMet && this._ev_md) {
                _yuitest_coverline("dd-drag", 894);
this._fromTimeout = this._dragThreshMet = true;
                _yuitest_coverline("dd-drag", 895);
this.start();
                _yuitest_coverline("dd-drag", 896);
this._alignNode([this._ev_md.pageX, this._ev_md.pageY], true);
        ...
        */
        removeHandle: function(str) {
            _yuitest_coverfunc("dd-drag", "removeHandle", 906);
_yuitest_coverline("dd-drag", 907);
var key = str;
            _yuitest_coverline("dd-drag", 908);
if (str instanceof Y.Node || str instanceof Y.NodeList) {
                _yuitest_coverline("dd-drag", 909);
key = str._yuid;
            }
            _yuitest_coverline("dd-drag", 911);
if (this._handles[key]) {
                _yuitest_coverline("dd-drag", 912);
delete this._handles[key];
                _yuitest_coverline("dd-drag", 913);
this.fire(EV_REMOVE_HANDLE, { handle: str });
            }
            _yuitest_coverline("dd-drag", 915);
return this;
        },
        /**
        * @method addHandle
        ...
        */
        addHandle: function(str) {
            _yuitest_coverfunc("dd-drag", "addHandle", 924);
_yuitest_coverline("dd-drag", 925);
if (!this._handles) {
                _yuitest_coverline("dd-drag", 926);
this._handles = {};
            }
            _yuitest_coverline("dd-drag", 928);
var key = str;
            _yuitest_coverline("dd-drag", 929);
if (str instanceof Y.Node || str instanceof Y.NodeList) {
                _yuitest_coverline("dd-drag", 930);
key = str._yuid;
            }
            _yuitest_coverline("dd-drag", 932);
this._handles[key] = str;
            _yuitest_coverline("dd-drag", 933);
this.fire(EV_ADD_HANDLE, { handle: str });
            _yuitest_coverline("dd-drag", 934);
return this;
        },
        /**
        ...
        */
        removeInvalid: function(str) {
            _yuitest_coverfunc("dd-drag", "removeInvalid", 943);
_yuitest_coverline("dd-drag", 944);
if (this._invalids[str]) {
                _yuitest_coverline("dd-drag", 945);
this._invalids[str] = null;
                _yuitest_coverline("dd-drag", 946);
delete this._invalids[str];
                _yuitest_coverline("dd-drag", 947);
this.fire(EV_REMOVE_INVALID, { handle: str });
            }
            _yuitest_coverline("dd-drag", 949);
return this;
        },
        /**
        * @method addInvalid
        ...
        */
        addInvalid: function(str) {
            _yuitest_coverfunc("dd-drag", "addInvalid", 958);
_yuitest_coverline("dd-drag", 959);
if (Y.Lang.isString(str)) {
                _yuitest_coverline("dd-drag", 960);
this._invalids[str] = true;
                _yuitest_coverline("dd-drag", 961);
this.fire(EV_ADD_INVALID, { handle: str });
            }
            _yuitest_coverline("dd-drag", 963);
return this;
        },
        /**
        * @private
        ...
        */
        initializer: function(cfg) {
            ...
            _yuitest_coverfunc("dd-drag", "initializer", 970);
_yuitest_coverline("dd-drag", 972);
this.get(NODE).dd = this;

            _yuitest_coverline("dd-drag", 974);
if (!this.get(NODE).get('id')) {
                _yuitest_coverline("dd-drag", 975);
var id = Y.stamp(this.get(NODE));
                _yuitest_coverline("dd-drag", 976);
this.get(NODE).set('id', id);
            }

            _yuitest_coverline("dd-drag", 979);
this.actXY = [];
            
            _yuitest_coverline("dd-drag", 981);
this._invalids = Y.clone(this._invalidsDefault, true);

            _yuitest_coverline("dd-drag", 983);
this._createEvents();
            
            _yuitest_coverline("dd-drag", 985);
if (!this.get(DRAG_NODE)) {
                _yuitest_coverline("dd-drag", 986);
this.set(DRAG_NODE, this.get(NODE));
            }

            //Fix for #2528096
            //Don't prep the DD instance until all plugins are loaded.
            _yuitest_coverline("dd-drag", 991);
this.on('initializedChange', Y.bind(this._prep, this));

            //Shouldn't have to do this..
            _yuitest_coverline("dd-drag", 994);
this.set('groups', this.get('groups'));
        ...
        */
        _prep: function() {
            _yuitest_coverfunc("dd-drag", "_prep", 1001);
_yuitest_coverline("dd-drag", 1002);
this._dragThreshMet = false;
            _yuitest_coverline("dd-drag", 1003);
var node = this.get(NODE);
            _yuitest_coverline("dd-drag", 1004);
node.addClass(DDM.CSS_PREFIX + '-draggable');
            _yuitest_coverline("dd-drag", 1005);
node.on(Drag.START_EVENT, Y.bind(this._handleMouseDownEvent, this));
            _yuitest_coverline("dd-drag", 1006);
node.on('mouseup', Y.bind(this._handleMouseUp, this));
            _yuitest_coverline("dd-drag", 1007);
node.on('dragstart', Y.bind(this._fixDragStart, this));
        ...
        */
        _unprep: function() {
            _yuitest_coverfunc("dd-drag", "_unprep", 1014);
_yuitest_coverline("dd-drag", 1015);
var node = this.get(NODE);
            _yuitest_coverline("dd-drag", 1016);
node.removeClass(DDM.CSS_PREFIX + '-draggable');
            _yuitest_coverline("dd-drag", 1017);
node.detachAll('mouseup');
            _yuitest_coverline("dd-drag", 1018);
node.detachAll('dragstart');
            _yuitest_coverline("dd-drag", 1019);
node.detachAll(Drag.START_EVENT);
            _yuitest_coverline("dd-drag", 1020);
this.mouseXY = [];
            _yuitest_coverline("dd-drag", 1021);
this.deltaXY = [0,0];
            _yuitest_coverline("dd-drag", 1022);
this.startXY = [];
            _yuitest_coverline("dd-drag", 1023);
this.nodeXY = [];
            _yuitest_coverline("dd-drag", 1024);
this.lastXY = [];
            _yuitest_coverline("dd-drag", 1025);
this.actXY = [];
            _yuitest_coverline("dd-drag", 1026);
this.realXY = [];
        },
        /**
        * @method start
        ...
        */
        start: function() {
            _yuitest_coverfunc("dd-drag", "start", 1034);
_yuitest_coverline("dd-drag", 1035);
if (!this.get('lock') && !this.get(DRAGGING)) {
                _yuitest_coverline("dd-drag", 1036);
var node = this.get(NODE), ow, oh, xy;
                _yuitest_coverline("dd-drag", 1037);
this._startTime = (new Date()).getTime();

                _yuitest_coverline("dd-drag", 1039);
DDM._start();
                _yuitest_coverline("dd-drag", 1040);
node.addClass(DDM.CSS_PREFIX + '-dragging');
                _yuitest_coverline("dd-drag", 1041);
this.fire(EV_START, {
                    pageX: this.nodeXY[0],
                    pageY: this.nodeXY[1],
                    startTime: this._startTime
                });
                _yuitest_coverline("dd-drag", 1046);
node = this.get(DRAG_NODE);
                _yuitest_coverline("dd-drag", 1047);
xy = this.nodeXY;
                
                _yuitest_coverline("dd-drag", 1049);
ow = node.get(OFFSET_WIDTH);
                _yuitest_coverline("dd-drag", 1050);
oh = node.get(OFFSET_HEIGHT);
                
                _yuitest_coverline("dd-drag", 1052);
if (this.get('startCentered')) {
                    _yuitest_coverline("dd-drag", 1053);
this._setStartPosition([xy[0] + (ow / 2), xy[1] + (oh / 2)]);
                }
                
                
                _yuitest_coverline("dd-drag", 1057);
this.region = {
                    '0': xy[0], 
                    '1': xy[1],
                    area: 0,
                ...
                _yuitest_coverline("dd-drag", 1066);
this.set(DRAGGING, true);
            }
            _yuitest_coverline("dd-drag", 1068);
return this;
        },
        /**
        * @method end
        ...
        */
            ...
            _yuitest_coverfunc("dd-drag", "end", 1076);
_yuitest_coverline("dd-drag", 1077);
this._endTime = (new Date()).getTime();
            _yuitest_coverline("dd-drag", 1078);
if (this._clickTimeout) {
                _yuitest_coverline("dd-drag", 1079);
this._clickTimeout.cancel();
            }
            _yuitest_coverline("dd-drag", 1081);
this._dragThreshMet = this._fromTimeout = false;

            _yuitest_coverline("dd-drag", 1083);
if (!this.get('lock') && this.get(DRAGGING)) {
                _yuitest_coverline("dd-drag", 1084);
this.fire(EV_END, {
                    pageX: this.lastXY[0],
                    pageY: this.lastXY[1],
                    startTime: this._startTime,
            ...
            _yuitest_coverline("dd-drag", 1091);
this.get(NODE).removeClass(DDM.CSS_PREFIX + '-dragging');
            _yuitest_coverline("dd-drag", 1092);
this.set(DRAGGING, false);
            _yuitest_coverline("dd-drag", 1093);
this.deltaXY = [0, 0];

            _yuitest_coverline("dd-drag", 1095);
return this;
        },
        /**
        * @private
        ...
        */
        _defEndFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defEndFn", 1102);
_yuitest_coverline("dd-drag", 1103);
this._fixIEMouseUp();
            _yuitest_coverline("dd-drag", 1104);
this._ev_md = null;
        },
        /**
        * @private
        ...
        */
        _prevEndFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_prevEndFn", 1111);
_yuitest_coverline("dd-drag", 1112);
this._fixIEMouseUp();
            //Bug #1852577
            _yuitest_coverline("dd-drag", 1114);
this.get(DRAG_NODE).setXY(this.nodeXY);
            _yuitest_coverline("dd-drag", 1115);
this._ev_md = null;
            _yuitest_coverline("dd-drag", 1116);
this.region = null;
        },
        /**
        * @private
        ...
        */
        _align: function(xy) {
            _yuitest_coverfunc("dd-drag", "_align", 1124);
_yuitest_coverline("dd-drag", 1125);
this.fire(EV_ALIGN, {pageX: xy[0], pageY: xy[1] });
        ...
        */
        _defAlignFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defAlignFn", 1133);
_yuitest_coverline("dd-drag", 1134);
this.actXY = [e.pageX - this.deltaXY[0], e.pageY - this.deltaXY[1]];
        ...
        */
        _alignNode: function(eXY, scroll) {
            _yuitest_coverfunc("dd-drag", "_alignNode", 1142);
_yuitest_coverline("dd-drag", 1143);
this._align(eXY);
            _yuitest_coverline("dd-drag", 1144);
if (!scroll) {
                _yuitest_coverline("dd-drag", 1145);
this._moveNode();
            }
        },
        /**
        ...
        */
        _moveNode: function(scroll) {
            ...
            //    return;
            //}
            _yuitest_coverfunc("dd-drag", "_moveNode", 1153);
_yuitest_coverline("dd-drag", 1157);
var diffXY = [], diffXY2 = [], startXY = this.nodeXY, xy = this.actXY;

            _yuitest_coverline("dd-drag", 1159);
diffXY[0] = (xy[0] - this.lastXY[0]);
            _yuitest_coverline("dd-drag", 1160);
diffXY[1] = (xy[1] - this.lastXY[1]);

            _yuitest_coverline("dd-drag", 1162);
diffXY2[0] = (xy[0] - this.nodeXY[0]);
            _yuitest_coverline("dd-drag", 1163);
diffXY2[1] = (xy[1] - this.nodeXY[1]);


            _yuitest_coverline("dd-drag", 1166);
this.region = {
                '0': xy[0], 
                '1': xy[1],
                area: 0,
            ...
            _yuitest_coverline("dd-drag", 1176);
this.fire(EV_DRAG, {
                pageX: xy[0],
                pageY: xy[1],
                scroll: scroll,
            ...
            _yuitest_coverline("dd-drag", 1188);
this.lastXY = xy;
        },
        /**
        * @private
        ...
        */
        _defDragFn: function(e) {
            _yuitest_coverfunc("dd-drag", "_defDragFn", 1196);
_yuitest_coverline("dd-drag", 1197);
if (this.get('move')) {
                _yuitest_coverline("dd-drag", 1198);
if (e.scroll && e.scroll.node) {
                    _yuitest_coverline("dd-drag", 1199);
e.scroll.node.set('scrollTop', e.scroll.top);
                    _yuitest_coverline("dd-drag", 1200);
e.scroll.node.set('scrollLeft', e.scroll.left);
                }
                _yuitest_coverline("dd-drag", 1202);
this.get(DRAG_NODE).setXY([e.pageX, e.pageY]);
                _yuitest_coverline("dd-drag", 1203);
this.realXY = [e.pageX, e.pageY];
        ...
        */
        _move: function(ev) {
            _yuitest_coverfunc("dd-drag", "_move", 1212);
_yuitest_coverline("dd-drag", 1213);
if (this.get('lock')) {
                _yuitest_coverline("dd-drag", 1214);
return false;
            } else {
                _yuitest_coverline("dd-drag", 1216);
this.mouseXY = [ev.pageX, ev.pageY];
                _yuitest_coverline("dd-drag", 1217);
if (!this._dragThreshMet) {
                    _yuitest_coverline("dd-drag", 1218);
var diffX = Math.abs(this.startXY[0] - ev.pageX),
                    diffY = Math.abs(this.startXY[1] - ev.pageY);
                    _yuitest_coverline("dd-drag", 1220);
if (diffX > this.get('clickPixelThresh') || diffY > this.get('clickPixelThresh')) {
                        _yuitest_coverline("dd-drag", 1221);
this._dragThreshMet = true;
                        _yuitest_coverline("dd-drag", 1222);
this.start();
                        _yuitest_coverline("dd-drag", 1223);
this._alignNode([ev.pageX, ev.pageY]);
                    }
                } else {
                    _yuitest_coverline("dd-drag", 1226);
if (this._clickTimeout) {
                        _yuitest_coverline("dd-drag", 1227);
this._clickTimeout.cancel();
                    }
                    _yuitest_coverline("dd-drag", 1229);
this._alignNode([ev.pageX, ev.pageY]);
                }
            }
        },
        ...
        */
        stopDrag: function() {
            _yuitest_coverfunc("dd-drag", "stopDrag", 1239);
_yuitest_coverline("dd-drag", 1240);
if (this.get(DRAGGING)) {
                _yuitest_coverline("dd-drag", 1241);
DDM._end();
            }
            _yuitest_coverline("dd-drag", 1243);
return this;
        },
        /**
        * @private
        ...
        */
        destructor: function() {
            _yuitest_coverfunc("dd-drag", "destructor", 1250);
_yuitest_coverline("dd-drag", 1251);
this._unprep();
            _yuitest_coverline("dd-drag", 1252);
if (this.target) {
                _yuitest_coverline("dd-drag", 1253);
this.target.destroy();
            }
            _yuitest_coverline("dd-drag", 1255);
DDM._unregDrag(this);
        }
    });
    _yuitest_coverline("dd-drag", 1258);
Y.namespace('DD');    
    _yuitest_coverline("dd-drag", 1259);
Y.DD.Drag = Drag;
