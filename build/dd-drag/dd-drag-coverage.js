...
var domNode = e.scroll.node.getDOMNode();
                    //If it's the window
                    _yuitest_coverline("build/dd-drag/dd-drag.js", 1205);
...
e.scroll.node.set('scrollTop', e.scroll.top);
                        _yuitest_coverline("build/dd-drag/dd-drag.js", 1209);
e.scroll.node.set('scrollLeft', e.scroll.left);
                    }
                }
                _yuitest_coverline("build/dd-drag/dd-drag.js", 1212);
...
this.realXY = [e.pageX, e.pageY];
        ...
        */
        _move: function(ev) {
            _yuitest_coverfunc("build/dd-drag/dd-drag.js", "_move", 1222);
...
this._alignNode([ev.pageX, ev.pageY]);
        ...
        */
        stopDrag: function() {
            _yuitest_coverfunc("build/dd-drag/dd-drag.js", "stopDrag", 1253);
_yuitest_coverline("build/dd-drag/dd-drag.js", 1254);
if (this.get(DRAGGING)) {
                _yuitest_coverline("build/dd-drag/dd-drag.js", 1255);
DDM._end();
            }
            _yuitest_coverline("build/dd-drag/dd-drag.js", 1257);
return this;
        },
        /**
        * @private
        ...
        */
        destructor: function() {
            _yuitest_coverfunc("build/dd-drag/dd-drag.js", "destructor", 1264);
_yuitest_coverline("build/dd-drag/dd-drag.js", 1265);
this._unprep();
...
this.target.destroy();
            ...
            _yuitest_coverline("build/dd-drag/dd-drag.js", 1269);
DDM._unregDrag(this);
        }
    });
    _yuitest_coverline("build/dd-drag/dd-drag.js", 1272);
Y.namespace('DD');
    _yuitest_coverline("build/dd-drag/dd-drag.js", 1273);
Y.DD.Drag = Drag;
