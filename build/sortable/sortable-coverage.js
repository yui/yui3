...
return node.test(test);
        ...
        */
        getSortable: function(node) {
            _yuitest_coverfunc("build/sortable/sortable.js", "getSortable", 427);
...
Y.each(Y.Sortable._sortables, function(v) {
                _yuitest_coverfunc("build/sortable/sortable.js", "(anonymous 3)", 430);
...
return s;
        ...
        */
        reg: function(s) {
            _yuitest_coverfunc("build/sortable/sortable.js", "reg", 443);
_yuitest_coverline("build/sortable/sortable.js", 444);
Y.Sortable._sortables.push(s);
        ...
        */
        unreg: function(s) {
            _yuitest_coverfunc("build/sortable/sortable.js", "unreg", 452);
_yuitest_coverline("build/sortable/sortable.js", 453);
Y.each(Y.Sortable._sortables, function(v, k) {
                _yuitest_coverfunc("build/sortable/sortable.js", "(anonymous 4)", 453);
...
delete Sortable._sortables[k];
    ...
    _yuitest_coverline("build/sortable/sortable.js", 462);
Y.Sortable = Sortable;
