...
var nodes = e.drop.get(NODE).all(this.get(NODES));
                _yuitest_coverline("sortable", 104);
...
if (e.drag.get(NODE).get(PARENT_NODE).contains(e.drop.get(NODE))) {
                _yuitest_coverline("sortable", 128);
same = true;
            }
            _yuitest_coverline("sortable", 130);
if (same && moveType == 'move') {
                _yuitest_coverline("sortable", 131);
moveType = 'insert';
            }
            _yuitest_coverline("sortable", 133);
switch (moveType) {
                case 'insert':
...
return this;
        ...
        */
        sync: function() {
            _yuitest_coverfunc("sortable", "sync", 231);
_yuitest_coverline("sortable", 232);
this.delegate.syncTargets();
            _yuitest_coverline("sortable", 233);
return this;
        },
        destructor: function() {
            _yuitest_coverfunc("sortable", "destructor", 235);
_yuitest_coverline("sortable", 236);
this.drop.destroy();
            _yuitest_coverline("sortable", 237);
this.delegate.destroy();
            _yuitest_coverline("sortable", 238);
Sortable.unreg(this);
        },
        /**
        * @method join
        ...
        */
        join: function(sel, type) {
            _yuitest_coverfunc("sortable", "join", 253);
...
Y.error('Sortable: join needs a Sortable Instance');
                _yuitest_coverline("sortable", 256);
return this;
            }
            _yuitest_coverline("sortable", 258);
if (!type) {
                _yuitest_coverline("sortable", 259);
type = 'full';
            }
            _yuitest_coverline("sortable", 261);
type = type.toLowerCase();
            _yuitest_coverline("sortable", 262);
var method = '_join_' + type;

            _yuitest_coverline("sortable", 264);
if (this[method]) {
                _yuitest_coverline("sortable", 265);
this[method](sel);
            }
            
            _yuitest_coverline("sortable", 268);
return this;
        },
        /**
        * @private
...
sel.delegate.dd.removeFromGroup(this.get(ID));
        ...
        */
        _join_full: function(sel) {
            _yuitest_coverfunc("sortable", "_join_full", 286);
_yuitest_coverline("sortable", 287);
this.delegate.dd.addToGroup(sel.get(ID));
            _yuitest_coverline("sortable", 288);
sel.delegate.dd.addToGroup(this.get(ID));
        ...
        */
        _join_outer: function(sel) {
            _yuitest_coverfunc("sortable", "_join_outer", 296);
_yuitest_coverline("sortable", 297);
this.delegate.dd.addToGroup(sel.get(ID));
        },
        /**
        * @private
        ...
        */
        _join_inner: function(sel) {
            _yuitest_coverfunc("sortable", "_join_inner", 305);
_yuitest_coverline("sortable", 306);
sel.delegate.dd.addToGroup(this.get(ID));
        },
        /**
        ...
        */
        getOrdering: function(callback) {
            _yuitest_coverfunc("sortable", "getOrdering", 314);
_yuitest_coverline("sortable", 315);
var ordering = [];
...
callback = function (node) {
                    _yuitest_coverfunc("sortable", "callback", 318);
_yuitest_coverline("sortable", 319);
return node;
                };
            }
...
Y.one(this.get(CONT)).all(this.get(NODES)).each(function(node) {
                _yuitest_coverfunc("sortable", "(anonymous 2)", 323);
_yuitest_coverline("sortable", 324);
ordering.push(callback(node));
            });
            _yuitest_coverline("sortable", 326);
return ordering;
       }
    }, {
        NAME: 'sortable',
        ...
        */
        _test: function(node, test) {
            _yuitest_coverfunc("sortable", "_test", 411);
...
return node.test(test);
        ...
        */
        getSortable: function(node) {
            _yuitest_coverfunc("sortable", "getSortable", 424);
_yuitest_coverline("sortable", 425);
var s = null;
            _yuitest_coverline("sortable", 426);
node = Y.one(node);
            _yuitest_coverline("sortable", 427);
Y.each(Y.Sortable._sortables, function(v) {
                _yuitest_coverfunc("sortable", "(anonymous 3)", 427);
...
s = v;
            ...
            _yuitest_coverline("sortable", 432);
return s;
        },
        /**
        * @static
        ...
        */
        reg: function(s) {
            _yuitest_coverfunc("sortable", "reg", 440);
_yuitest_coverline("sortable", 441);
Y.Sortable._sortables.push(s);
        ...
        */
        unreg: function(s) {
            _yuitest_coverfunc("sortable", "unreg", 449);
_yuitest_coverline("sortable", 450);
Y.each(Y.Sortable._sortables, function(v, k) {
                _yuitest_coverfunc("sortable", "(anonymous 4)", 450);
...
delete Sortable._sortables[k];
    ...
    _yuitest_coverline("sortable", 459);
Y.Sortable = Sortable;
