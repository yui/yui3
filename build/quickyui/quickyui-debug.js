...
YUI.add('quickyui', function(Y) {

// empty



}, '@VERSION@' ,{use:['yui','oop','dom','event-custom','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','event-touch','event-synthetic','event-gestures']});
var Y = YUI().use('*');
