...
YUI.Env[Y.version].modules = YUI.Env[Y.version].modules || {
    ...
    "app-transitions-native": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 2934);
_yuitest_coverline("/build/loader/loader.js", 2935);
var doc  = Y.config.doc,
        node = doc ? doc.documentElement : null;

    _yuitest_coverline("/build/loader/loader.js", 2938);
if (node && node.style) {
        _yuitest_coverline("/build/loader/loader.js", 2939);
...
return false;
    ...
    // available.
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 3088);
_yuitest_coverline("/build/loader/loader.js", 3100);
return !(Y.UA.ios || Y.UA.android);
    ...
    "dd-gestures": {
        "condition": {
            "name": "dd-gestures",
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 3828);
_yuitest_coverline("/build/loader/loader.js", 3829);
return ((Y.config.win && ("ontouchstart" in Y.config.win)) && !(Y.UA.chrome && Y.UA.chrome < 6));
    ...
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 3914);
_yuitest_coverline("/build/loader/loader.js", 3916);
...
addFeature('style', 'computedStyle', {
        test: function() {
            _yuitest_coverfunc("/build/loader/loader.js", "test", 3924);
_yuitest_coverline("/build/loader/loader.js", 3925);
return WINDOW && 'getComputedStyle' in WINDOW;
        }
    });

    _yuitest_coverline("/build/loader/loader.js", 3929);
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("/build/loader/loader.js", "test", 3930);
_yuitest_coverline("/build/loader/loader.js", 3931);
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
        }
    });

    _yuitest_coverline("/build/loader/loader.js", 3935);
...
return ret;
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4059);
_yuitest_coverline("/build/loader/loader.js", 4060);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("/build/loader/loader.js", 4061);
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4233);
_yuitest_coverline("/build/loader/loader.js", 4234);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("/build/loader/loader.js", 4238);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4249);
_yuitest_coverline("/build/loader/loader.js", 4250);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("/build/loader/loader.js", 4254);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
},
            "trigger": "graphics"
        }
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4262);
_yuitest_coverline("/build/loader/loader.js", 4263);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("/build/loader/loader.js", 4268);
return svg && (useSVG || !canvas);
    ...
    "graphics-svg-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4279);
_yuitest_coverline("/build/loader/loader.js", 4280);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("/build/loader/loader.js", 4285);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4293);
_yuitest_coverline("/build/loader/loader.js", 4294);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("/build/loader/loader.js", 4296);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4307);
_yuitest_coverline("/build/loader/loader.js", 4308);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("/build/loader/loader.js", 4310);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
    ...
    "history-hash-ie": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4376);
_yuitest_coverline("/build/loader/loader.js", 4377);
var docMode = Y.config.doc && Y.config.doc.documentMode;

    _yuitest_coverline("/build/loader/loader.js", 4379);
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 4914);
_yuitest_coverline("/build/loader/loader.js", 4915);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("/build/loader/loader.js", 4918);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("/build/loader/loader.js", "\"test\"", 5079);
_yuitest_coverline("/build/loader/loader.js", 5080);
var DOCUMENT = Y.config.doc,
        node = (DOCUMENT) ? DOCUMENT.documentElement: null,
        ret = true;

    _yuitest_coverline("/build/loader/loader.js", 5084);
if (node && node.style) {
        _yuitest_coverline("/build/loader/loader.js", 5085);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style);
    } 

    _yuitest_coverline("/build/loader/loader.js", 5088);
return ret;
},
            "trigger": "transition"
        },
...
_yuitest_coverline("/build/loader/loader.js", 5296);
...
_yuitest_coverline("/build/loader/loader.js", 5302);
