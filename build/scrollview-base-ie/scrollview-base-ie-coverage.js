...
_yuitest_coverage["scrollview-base-ie"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("scrollview-base-ie", "(anonymous 1)", 1);
_yuitest_coverline("scrollview-base-ie", 9);
Y.mix(Y.ScrollView.prototype, {
    ...
    _fixIESelect : function(bb, cb) {
        _yuitest_coverfunc("scrollview-base-ie", "_fixIESelect", 20);
_yuitest_coverline("scrollview-base-ie", 21);
this._cbDoc = cb.get("ownerDocument");
        _yuitest_coverline("scrollview-base-ie", 22);
this._nativeBody = Y.Node.getDOMNode(Y.one("body", this._cbDoc));

        _yuitest_coverline("scrollview-base-ie", 24);
cb.on("mousedown", function() {
            _yuitest_coverfunc("scrollview-base-ie", "(anonymous 2)", 24);
_yuitest_coverline("scrollview-base-ie", 25);
this._selectstart = this._nativeBody.onselectstart;
            _yuitest_coverline("scrollview-base-ie", 26);
this._nativeBody.onselectstart = this._iePreventSelect;
            _yuitest_coverline("scrollview-base-ie", 27);
this._cbDoc.once("mouseup", this._ieRestoreSelect, this);
    ...
    _iePreventSelect : function() {
        _yuitest_coverfunc("scrollview-base-ie", "_iePreventSelect", 38);
_yuitest_coverline("scrollview-base-ie", 39);
return false;
    },
    ...
    _ieRestoreSelect : function() {
        _yuitest_coverfunc("scrollview-base-ie", "_ieRestoreSelect", 49);
_yuitest_coverline("scrollview-base-ie", 50);
