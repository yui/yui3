...
_yuitest_coverage["/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@static
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 19);
var Lang = Y.Lang,
...
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 29);
SchemaXML = {
    ...
    **/
    apply: function(schema, data) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "apply", 116);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 117);
var xmldoc = data, // unnecessary variables
            data_out = { results: [], meta: {} };

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 120);
if (xmldoc && okNodeType[xmldoc.nodeType] && schema) {
            // Parse results data
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 122);
data_out = SchemaXML._parseResults(schema, xmldoc, data_out);

            // Parse meta data
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 125);
data_out = SchemaXML._parseMeta(schema.metaFields, xmldoc, data_out);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 127);
data_out.error = new Error("XML schema parse failure");
        }

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 130);
return data_out;
    },
    ...
    _getLocationValue: function(field, context) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_getLocationValue", 143);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 144);
var locator = field.locator || field.key || field,
            xmldoc = context.ownerDocument || context,
            result, res, value = null;

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 148);
try {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 149);
result = SchemaXML._getXPathResult(locator, context, xmldoc);
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 150);
while ((res = result.iterateNext())) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 151);
value = res.textContent || res.value || res.text || res.innerHTML || null;
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 161);
return Y.DataSchema.Base.parse.call(this, value, field);
        } catch (e) {
        }

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 165);
return null;
    },
    ...
    _getXPathResult: function(locator, context, xmldoc) {
        // Standards mode
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_getXPathResult", 180);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 182);
if (! Lang.isUndefined(xmldoc.evaluate)) {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 183);
return xmldoc.evaluate(locator, context, xmldoc.createNSResolver(context.ownerDocument ? context.ownerDocument.documentElement : context.documentElement), 0, null);
        ...
        // IE mode
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 187);
var values=[], locatorArray = locator.split(/\b\/\b/), i=0, l=locatorArray.length, location, subloc, m, isNth;
            
            // XPath is supported
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 190);
try {
                // this fixes the IE 5.5+ issue where childnode selectors begin at 0 instead of 1
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 192);
xmldoc.setProperty("SelectionLanguage", "XPath");
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 193);
values = context.selectNodes(locator);
            }
            // Fallback for DOM nodes and fragments
            catch (e) {
                // Iterate over each locator piece
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 198);
for (; i<l && context; i++) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 199);
location = locatorArray[i];

                    // grab nth child []
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 202);
if ((location.indexOf("[") > -1) && (location.indexOf("]") > -1)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 203);
subloc = location.slice(location.indexOf("[")+1, location.indexOf("]"));
                        //XPath is 1-based while DOM is 0-based
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 205);
subloc--;
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 206);
context = context.children[subloc];
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 207);
isNth = true;
                    }
                    // grab attribute value @
                    else {_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 210);
if (location.indexOf("@") > -1) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 211);
subloc = location.substr(location.indexOf("@"));
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 212);
context = subloc ? context.getAttribute(subloc.replace('@', '')) : context;
                    }
                    // grab that last instance of tagName
                    else {_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 215);
if (-1 < location.indexOf("//")) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 216);
subloc = context.getElementsByTagName(location.substr(2));
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 217);
context = subloc.length ? subloc[subloc.length - 1] : null;
                    }
                    // find the last matching location in children
                    else {_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 220);
if (l != i + 1) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 221);
for (m=context.childNodes.length-1; 0 <= m; m-=1) {
                            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 222);
if (location === context.childNodes[m].tagName) {
                                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 223);
context = context.childNodes[m];
                                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 224);
m = -1;
                            }
                        }
                    }}}}
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 230);
if (context) {
                    // attribute
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 232);
if (Lang.isString(context)) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 233);
values[0] = {value: context};
                    }
                    // nth child
                    else {_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 236);
if (isNth) {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 237);
values[0] = {value: context.innerHTML};
                    }
                    // all children
                    else {
                        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 241);
values = Y.Array(context.childNodes, 0, true);
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 247);
return {
                index: 0,
                
                iterateNext: function() {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "iterateNext", 250);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 251);
if (this.index >= this.values.length) {return undefined;}
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 252);
var result = this.values[this.index];
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 253);
this.index += 1;
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 254);
return result;
                },
    ...
    _parseField: function(field, result, context) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_parseField", 272);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 273);
var key = field.key || field,
            parsed;

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 276);
if (field.schema) {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 277);
parsed = { results: [], meta: {} };
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 278);
parsed = SchemaXML._parseResults(field.schema, context, parsed);

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 280);
result[key] = parsed.results;
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 282);
result[key] = SchemaXML._getLocationValue(field, context);
    ...
    _parseMeta: function(metaFields, xmldoc_in, data_out) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_parseMeta", 296);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 297);
if(Lang.isObject(metaFields)) {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 298);
var key,
                xmldoc = xmldoc_in.ownerDocument || xmldoc_in;

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 301);
for(key in metaFields) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 302);
if (metaFields.hasOwnProperty(key)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 303);
data_out.meta[key] = SchemaXML._getLocationValue(metaFields[key], xmldoc);
                }
            }
        }
        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 307);
return data_out;
    },
    ...
    _parseResult: function(fields, context) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_parseResult", 320);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 321);
var result = {}, j;

        // Find each field value
        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 324);
for (j=fields.length-1; 0 <= j; j--) {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 325);
SchemaXML._parseField(fields[j], result, context);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 328);
return result;
    },
    ...
    _parseResults: function(schema, context, data_out) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", "_parseResults", 342);
_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 343);
if (schema.resultListLocator && Lang.isArray(schema.resultFields)) {
            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 344);
var xmldoc = context.ownerDocument || context,
                fields = schema.resultFields,
                results = [],
                node, nodeList, i=0;

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 349);
if (schema.resultListLocator.match(/^[:\-\w]+$/)) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 350);
nodeList = context.getElementsByTagName(schema.resultListLocator);
                
                // loop through each result node
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 353);
for (i = nodeList.length - 1; i >= 0; --i) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 354);
results[i] = SchemaXML._parseResult(fields, nodeList[i]);
                }
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 357);
nodeList = SchemaXML._getXPathResult(schema.resultListLocator, context, xmldoc);

                // loop through the nodelist
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 360);
while ((node = nodeList.iterateNext())) {
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 361);
results[i] = SchemaXML._parseResult(fields, node);
                    _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 362);
i += 1;
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 366);
if (results.length) {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 367);
data_out.results = results;
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 369);
data_out.error = new Error("XML schema result nodes retrieval failure");
            }
        }
        _yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 372);
return data_out;
    }
};

_yuitest_coverline("/home/yui/src/yui3/src/dataschema/build_tmp/dataschema-xml.js", 376);
