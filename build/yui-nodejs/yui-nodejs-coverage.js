...
return (imp && (!imp.hasFeature('Events', '2.0')));
    ...
    "graphics-canvas": {
        "condition": {
            "name": "graphics-canvas",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 8929);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8930);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8934);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
},
            "trigger": "graphics"
        },
    ...
    "graphics-canvas-default": {
        "condition": {
            "name": "graphics-canvas-default",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 8945);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8946);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8950);
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
},
            "trigger": "graphics"
        }
    ...
    "graphics-svg": {
        "condition": {
            "name": "graphics-svg",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 8958);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8959);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8964);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        },
    ...
    "graphics-svg-default": {
        "condition": {
            "name": "graphics-svg-default",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 8975);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8976);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
    
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8981);
return svg && (useSVG || !canvas);
},
            "trigger": "graphics"
        }
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 8989);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8990);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 8992);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        },
    ...
    "graphics-vml-default": {
        "condition": {
            "name": "graphics-vml-default",
            "test": function(Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9003);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9004);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9006);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
    ...
    "history-hash-ie": {
        "condition": {
            "name": "history-hash-ie",
            "test": function (Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9072);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9073);
var docMode = Y.config.doc && Y.config.doc.documentMode;

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9075);
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
            !docMode || docMode < 8);
},
            "trigger": "history-hash"
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9603);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9604);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9607);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            "name": "transition-timer",
            "test": function (Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9768);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9769);
var DOCUMENT = Y.config.doc,
        node = (DOCUMENT) ? DOCUMENT.documentElement: null,
        ret = true;

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9773);
if (node && node.style) {
        _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9774);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style);
    } 

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9777);
return ret;
},
            "trigger": "transition"
        },
...
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9985);
...
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9991);
