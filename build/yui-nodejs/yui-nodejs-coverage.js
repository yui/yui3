...
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9611);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9612);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9615);
return ret;
},
            "trigger": "selector"
        },
    ...
    "transition-timer": {
        "condition": {
            "name": "transition-timer",
            "test": function (Y) {
    _yuitest_coverfunc("/build/yui-nodejs/yui-nodejs.js", "\"test\"", 9776);
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9777);
var DOCUMENT = Y.config.doc,
        node = (DOCUMENT) ? DOCUMENT.documentElement: null,
        ret = true;

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9781);
if (node && node.style) {
        _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9782);
ret = !('MozTransition' in node.style || 'WebkitTransition' in node.style);
    } 

    _yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9785);
return ret;
},
            "trigger": "transition"
        },
...
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9993);
...
_yuitest_coverline("/build/yui-nodejs/yui-nodejs.js", 9999);
