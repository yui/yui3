...
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
    ...
    **/
    _setup: function(o) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_setup", 506);
...
var i, Y = this,
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 512);
for (i = 0; i < extras.length; i++) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 513);
if (mods[extras[i]]) {
...
core.push(extras[i]);
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 518);
Y._attach(['yui-base']);
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 519);
Y._attach(core);
...
getLoader(Y);
    ...
    **/
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "applyTo", 539);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 540);
...
var instance = instances[id], nest, m, i;
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 546);
if (instance) {
...
**/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "add", 608);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 609);
details = details || {};
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 610);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 622);
env.mods[name] = mod;
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 623);
...
return this;
    ...
    **/
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_attach", 654);
...
c.push(def.name);
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 683);
r = c;
...
if (!moot && name) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 705);
...
if (loader && cache && cache[name] && cache[name].temp) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 727);
...
details = mod.details;
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 738);
...
break;
                    ...
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 769);
if (mod.fn) {
                            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 770);
...
break;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 799);
return true;
    },
    ...
    **/
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_delayCallback", 813);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 815);
var Y = this,
            mod = ['event-base'];
...
return function() {
            _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 3)", 824);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 825);
var args = arguments;
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 826);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 4)", 826);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 827);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 5)", 827);
...
cb.apply(Y, args);
    ...
    **/
    use: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "use", 898);
...
break;
            ...
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 929);
if (provisioned) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 930);
if (args.length) {
                }
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 932);
Y._notify(callback, ALREADY_DONE, args);
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 933);
return Y;
            }
        }

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 937);
if (Y._loading) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 938);
...
Y._use(args, function(Y, response) {
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 6)", 941);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 942);
Y._notify(callback, response, args);
            });
        }

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 946);
return Y;
    },
    ...
    **/
    _notify: function(callback, response, args) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_notify", 958);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 959);
if (!response.success && this.config.loadErrorFn) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 960);
this.config.loadErrorFn.call(this, this, callback, response, args);
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 961);
if (callback) {
...
this.error('use callback error', e, args);
    ...
    **/
    _use: function(args, callback) {
        ...
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_use", 988);
...
var len, loader, handleBoot, handleRLS,
            ...
            process = function(names, skip) {
                ...
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "process", 1011);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1013);
var i = 0, a = [], name, len, m, req, use;

                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1015);
if (!names.length) {
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1016);
return;
                }
...
a.push(names[i]);
                    ...
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1028);
names = a;
                }

                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1031);
len = names.length;
...
if (m) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1049);
used[name] = true;
...
if (!G_ENV._loaded[VERSION][name]) {
                            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1056);
missing.push(name);
                        } else {
...
if (req && req.length) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1064);
process(req);
                    }
...
if (use && use.length) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1069);
process(use, 1);
                    }
                }
            ...
            handleLoader = function(fromLoader) {
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "handleLoader", 1075);
...
if (data) {
                    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1087);
origMissing = missing;
...
Y._use(missing, function() {
                        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 7)", 1102);
...
if (data) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1109);
ret = Y._attach(data);
                    }
...
Y._notify(callback, response, args);
                ...
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1116);
...
if ((mods.loader || mods['loader-base']) && !Y.Loader) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1139);
...
loader._boot = false;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1155);
process(args);
...
len = missing.length;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1160);
if (len) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1161);
...
len = missing.length;
        ...
        // dynamic load
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1167);
if (boot && len && Y.Loader) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1168);
Y._loading = true;
...
loader.insert(null, (fetchCSS) ? null : 'js');
        ...
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1177);
if (boot && len && Y.Get && !Env.bootstrapped) {

            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1179);
Y._loading = true;

            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1181);
handleBoot = function() {
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "handleBoot", 1181);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1182);
Y._loading = false;
...
Y._use(args, callback);
            ...
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1191);
if (G_ENV._bootstrapping) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1192);
...
return Y;
    ...
    **/
    namespace: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "namespace", 1250);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1251);
var a = arguments, o, i = 0, j, d, arg;

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1253);
for (; i < a.length; i++) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1254);
...
o = o[d[j]];
                ...
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1263);
o[arg] = o[arg] || {};
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1264);
o = o[arg]; //Reset base object to the new object so it's returned
            }
        }
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1267);
return o;
    },
    ...
    dump: function (o) { _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "dump", 1274);
...
return ''+o; },
    ...
    **/
    error: function(msg, e, src) {
        ...
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "error", 1293);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1296);
var Y = this, ret;

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1298);
if (Y.config.errorFn) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1299);
ret = Y.config.errorFn.apply(Y, arguments);
        }

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1302);
if (!ret) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1303);
...
return Y;
    ...
    **/
    guid: function(pre) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "guid", 1319);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1320);
var id = this.Env._guidp + '_' + (++this.Env._uidx);
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1321);
return (pre) ? (pre + id) : id;
    ...
    **/
    stamp: function(o, readOnly) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "stamp", 1341);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1342);
var uid;
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1343);
if (!o) {
...
return o;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1349);
if (o.uniqueID && o.nodeType && o.nodeType !== 9) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1350);
uid = o.uniqueID;
        } else {
...
uid = (typeof o === 'string') ? o : o._yuid;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1355);
if (!uid) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1356);
uid = this.guid();
...
uid = null;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1365);
return uid;
    },
    ...
    **/
    destroy: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "destroy", 1374);
...
delete instances[Y.id];
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1380);
delete Y.Env;
...
YUI.prototype = proto;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1401);
for (prop in proto) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1402);
...
YUI[prop] = proto[prop];
    ...
    @since 3.5.0
    **/
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1442);
YUI.applyConfig = function(o) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "applyConfig", 1442);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1443);
if (!o) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1444);
return;
        }
        //If there is a GlobalConfig, apply it first to set the defaults
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1447);
if (YUI.GlobalConfig) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1448);
this.prototype.applyConfig.call(this, YUI.GlobalConfig);
        }
        //Apply this config to it
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1451);
...
YUI.GlobalConfig = this.config;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1457);
YUI._init();
...
if (hasWin) {
        ...
        // complete.
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1463);
...
handleLoad();
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1468);
YUI.Env.add = add;
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1469);
YUI.Env.remove = remove;

    /*global exports*/
    // Support the CommonJS method for exporting our single global
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1473);
if (typeof exports == 'object') {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1474);
exports.YUI = YUI;
    }
...
@since 3.6.0
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1709);
...
_yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 8)", 1709);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1731);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1779);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_isNative", 1779);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1780);
 ...
 * @static
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1797);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isArray", 1797);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1798);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1808);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isBoolean", 1808);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1809);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1819);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isDate", 1819);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1820);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1847);
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isFunction", 1847);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1848);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1858);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isNull", 1858);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1869);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isNumber", 1869);
 ...
 * @see isPlainObject
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1884);
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isObject", 1884);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1885);
var t = typeof o;
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1897);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isString", 1897);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1898);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1908);
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isUndefined", 1908);
...
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isValue", 1921);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1922);
var t = L.type(o);
...
return isFinite(o);
        ...
        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1930);
return false;

        default:
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1933);
return !!t;
    }
};
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1945);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 9)", 1945);
...
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "sub", 1960);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1961);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 10)", 1961);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1974);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 11)", 1974);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1975);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "}", 1976);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1977);
try {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1978);
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1991);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 12)", 1991);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 1992);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "}", 1993);
...
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 13)", 2004);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2005);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "}", 2006);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "type", 2037);
...
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2045);
var Lang   = Y.Lang,
...
@return {Array} A native array created from _thing_, according to the rules
  described above.
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2078);
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "YArray", 2078);
...
try {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2086);
...
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2091);
...
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2101);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2117);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "dedupe", 2117);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2118);
var hash    = {},
        results = [],
        i, item, len;
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 14)", 2149);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2150);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2151);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "}", 2152);
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "hash", 2186);
...
@static
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2214);
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 15)", 2214);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2215);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "}", 2216);
...
if (from < 0) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2224);
from += len;

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2226);
if (from < 0) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2227);
from = 0;
        }
    }
...
@static
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2259);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "numericSort", 2259);
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 16)", 2279);
...
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2283);
...
@static
**/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2309);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "test", 2309);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2310);
var result = 0;
...
result = 1;
    } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2314);
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2343);
function Queue() {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "Queue", 2343);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2344);
this._init();
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2345);
this.add.apply(this, arguments);
}

_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2348);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "_init", 2355);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "next", 2372);
...
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "last", 2382);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2383);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "add", 2393);
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "size", 2405);
...
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2423);
...
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "cached", 2452);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2453);
cache || (cache = {});

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2455);
return function (arg) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 17)", 2455);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2456);
var key = arguments.length > 1 ?
                Array.prototype.join.call(arguments, CACHED_DELIMITER) :
                String(arg);

        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2460);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "getLocation", 2484);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "merge", 2509);
...
var i      = 0,
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2516);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2517);
obj = arguments[i];
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "mix", 2563);
...
var alwaysOverwrite, exists, from, i, key, len, to;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2569);
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2570);
return receiver || Y;
    }

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2573);
if (mode) {
...
if (mode === 2) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2578);
...
if (!from || !to) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2591);
return receiver;
        }
    } else {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2631);
if (overwrite || !exists) {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2657);
if (overwrite || !exists) {
...
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2666);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2670);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 18)", 2702);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2708);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 19)", 2709);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2711);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2714);
return function (obj) {
        _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 20)", 2714);
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "owns", 2777);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2778);
 ...
 * @static
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2790);
O.hasKey = owns;
 ...
 * @static
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2813);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "keys", 2813);
...
if (hasProtoEnumBug && typeof obj === 'function') {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2822);
for (key in obj) {
...
if (owns(obj, key)) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2840);
keys.push(key);
            }
        }
    }
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "values", 2865);
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "size", 2886);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "hasValue", 2904);
...
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "each", 2928);
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "some", 2960);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2961);
var key;

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2963);
for (key in obj) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2964);
if (proto || owns(obj, key)) {
 ...
 */
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2987);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "getValue", 2987);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2988);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2989);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2992);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2996);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 2997);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3000);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "setValue", 3017);
...
var i,
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3023);
if (leafIdx >= 0) {
...
ref = ref[p[i]];
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3028);
if (ref !== UNDEFINED) {
...
return UNDEFINED;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3035);
return o;
};
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "isEmpty", 3047);
...
*/
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3083);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "parseUA", 3083);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3085);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "numberify", 3085);
_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3086);
var c = 0;
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3087);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "(anonymous 22)", 3087);
...
o.userAgent = ua;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3325);
...
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3330);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3331);
...
o.os = 'rhino';
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3344);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3345);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3347);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3348);
o.mobile = 'windows';
        }
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3350);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3351);
o.mobile = 'gecko';
        }
        // Modern WebKit browsers are at least X-Grade
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3354);
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3355);
if (m && m[1]) {
...
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3368);
...
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3384);
if (m) {
...
if (!o.android) {
                        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3411);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-nodejs/yui-nodejs.js", "compareVersions", 3525);
...
return -1;
        ...
        _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3546);
if (aPart > bPart) {
...
return 1;
    ...
    _yuitest_coverline("build/yui-nodejs/yui-nodejs.js", 3551);
return 0;
};
