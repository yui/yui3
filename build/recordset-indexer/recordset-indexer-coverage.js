...
_yuitest_coverage["/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 */
_yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 13);
function RecordsetIndexer(config) {
    _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "RecordsetIndexer", 13);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 14);
RecordsetIndexer.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 17);
...
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 47);
Y.extend(RecordsetIndexer, Y.Plugin.Base, {

    initializer: function(config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "initializer", 49);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 50);
var host = this.get('host');

        //setup listeners on recordset events
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 53);
this.onHostEvent('add', Y.bind("_defAddHash", this), host);
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 54);
this.onHostEvent('remove', Y.bind('_defRemoveHash', this), host);
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 55);
this.onHostEvent('update', Y.bind('_defUpdateHash', this), host);
    ...
    _setHashTable: function(key) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "_setHashTable", 72);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 73);
var host = this.get('host'),
        obj = {},
        i = 0,
        len = host.getLength();

        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 78);
for (; i < len; i++) {
            _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 79);
obj[host._items[i].getValue(key)] = host._items[i];
        }
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 81);
return obj;
    },
    ...
    _defAddHash: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "_defAddHash", 94);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 95);
var tbl = this.get('hashTables');
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 100);
Y.each(tbl,
        function(v, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "(anonymous 2)", 101);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 102);
Y.each(e.added || e.updated,
            function(o) {
                //if the object being added has a key which is being stored by hashtable v, add it into the table.
                _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "(anonymous 3)", 103);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 105);
if (o.getValue(key)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 106);
v[o.getValue(key)] = o;
                }
            });
        });
    ...
    _defRemoveHash: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "_defRemoveHash", 119);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 120);
var tbl = this.get('hashTables'),
        reckey;

        //Go through every hashtable that is stored.
        //in each hashtable, look to see if the key is represented in the object being deleted.
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 125);
Y.each(tbl,
        function(v, key) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "(anonymous 4)", 126);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 127);
Y.each(e.removed || e.overwritten,
            function(o) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "(anonymous 5)", 128);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 129);
reckey = o.getValue(key);
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 132);
if (reckey && v[reckey] === o) {
                    _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 133);
delete v[reckey];
                }
            });
        });
    ...
    _defUpdateHash: function(e) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "_defUpdateHash", 145);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 148);
e.added = e.updated;
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 149);
e.removed = e.overwritten;
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 150);
this._defAddHash(e);
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 151);
this._defRemoveHash(e);
    ...
    createTable: function(key) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "createTable", 197);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 198);
var tbls = this.get('hashTables');
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 199);
tbls[key] = this._setHashTable(key);
        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 200);
this.set('hashTables', tbls);

        _yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 202);
return tbls[key];
    },
    ...
    getTable: function(key) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", "getTable", 214);
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 215);
...
_yuitest_coverline("/home/yui/src/yui3/src/recordset/build_tmp/recordset-indexer.js", 223);
