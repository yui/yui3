...
sv._flickFrame(flickVelocity, flickAxis, startPosition);
    ...
    _flickFrame: function (velocity, flickAxis, startPosition) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_flickFrame", 772);
...
sv.set(axisAttr, newPosition);
    ...
    _mousewheel: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_mousewheel", 844);
...
e.preventDefault();
    ...
    _isOutOfBounds: function (x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_isOutOfBounds", 889);
...
return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY > maxY));
     ...
     */
    _snapBack: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_snapBack", 911);
...
sv.set(SCROLL_X, newX, {duration:duration, easing:easing});
        ...
        else {_yuitest_coverline("build/scrollview-base/scrollview-base.js", 927);
if (newY !== currentY) {
...
sv._onTransEnd();
    ...
    _afterScrollChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollChange", 943);
...
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _afterFlickChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterFlickChange", 981);
...
this._bindFlick(e.newVal);
    ...
    _afterDisabledChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDisabledChange", 992);
...
this._cDisabled = e.newVal;
    ...
    _afterAxisChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterAxisChange", 1004);
...
this._cAxis = e.newVal;
    ...
    _afterDragChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDragChange", 1015);
...
this._bindDrag(e.newVal);
    ...
    _afterDimChange: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDimChange", 1026);
...
this._uiDimensionsChange();
    ...
    _afterScrollEnd: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollEnd", 1037);
...
if (sv._flickAnim) {
            ...
            _yuitest_coverline("build/scrollview-base/scrollview-base.js", 1043);
sv._flickAnim.cancel();
...
sv._snapBack();
    ...
    _axisSetter: function (val, name) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_axisSetter", 1069);
...
return {
    ...
    */
    _setScroll : function(val, dim) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScroll", 1090);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1093);
if (this._cDisabled) {
            _yuitest_coverline("build/scrollview-base/scrollview-base.js", 1094);
...
return val;
    ...
    */
    _setScrollX: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollX", 1108);
...
return this._setScroll(val, DIM_X);
    ...
    */
    _setScrollY: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollY", 1120);
