...
e.preventDefault();
    ...
    _isOutOfBounds: function (x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_isOutOfBounds", 861);
...
return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY > maxY));
     ...
     */
    _snapBack: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_snapBack", 883);
...
sv.set(SCROLL_X, newX, {duration:duration, easing:easing});
        ...
        else {_yuitest_coverline("build/scrollview-base/scrollview-base.js", 899);
if (newY !== currentY) {
...
sv._onTransEnd();
    ...
    _afterScrollChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollChange", 915);
...
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _afterFlickChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterFlickChange", 953);
...
this._bindFlick(e.newVal);
    ...
    _afterDisabledChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDisabledChange", 964);
...
this._cDisabled = e.newVal;
    ...
    _afterAxisChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterAxisChange", 976);
...
this._cAxis = e.newVal;
    ...
    _afterDragChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDragChange", 987);
...
this._bindDrag(e.newVal);
    ...
    _afterDimChange: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDimChange", 998);
...
this._uiDimensionsChange();
    ...
    _afterScrollEnd: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollEnd", 1009);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1010);
var sv = this;
