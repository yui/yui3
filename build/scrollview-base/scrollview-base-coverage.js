...
_yuitest_coverline("scrollview-base", 9);
var getClassName = Y.ClassNameManager.getClassName,
    ...
    _constrain = function (val, min, max) {
        _yuitest_coverfunc("scrollview-base", "_constrain", 45);
_yuitest_coverline("scrollview-base", 46);
 ...
 * @constructor
 */
_yuitest_coverline("scrollview-base", 58);
function ScrollView() {
    _yuitest_coverfunc("scrollview-base", "ScrollView", 58);
_yuitest_coverline("scrollview-base", 59);
ScrollView.superclass.constructor.apply(this, arguments);
}

_yuitest_coverline("scrollview-base", 62);
Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
    ...
    initializer: function (config) {
        _yuitest_coverfunc("scrollview-base", "initializer", 72);
_yuitest_coverline("scrollview-base", 73);
var sv = this,
        ...
        _yuitest_coverline("scrollview-base", 77);
...
sv._cb = sv.get(CONTENT_BOX);
        ...
        _yuitest_coverline("scrollview-base", 81);
if (config.axis) {
...
switch (config.axis) {
                case "x":
                    _yuitest_coverline("scrollview-base", 85);
axis = {
                        x: true,
                        y: false
                    };
                    _yuitest_coverline("scrollview-base", 89);
break;
                
                case "y":
                    _yuitest_coverline("scrollview-base", 92);
axis = {
                        x: false,
                        y: true
                    };
                    _yuitest_coverline("scrollview-base", 96);
break;

                // Unsupported ATM.  For future development purposes.
                case "xy":
                case "yx":
                    _yuitest_coverline("scrollview-base", 101);
...
axis = {
                    ...
                    _yuitest_coverline("scrollview-base", 107);
break;
            }
        }
         ...
         * @public
         */
        _yuitest_coverline("scrollview-base", 118);
sv.axis = axis;
    },
     ...
     */
    bindUI: function () {
        _yuitest_coverfunc("scrollview-base", "bindUI", 127);
_yuitest_coverline("scrollview-base", 128);
var sv = this;

        _yuitest_coverline("scrollview-base", 130);
...
sv._bindMousewheel(sv.get(MOUSEWHEEL));
        ...
        _yuitest_coverline("scrollview-base", 134);
sv._bindAttrs();

        // IE SELECT HACK. See if we can do this non-natively and in the gesture for a future release.
        _yuitest_coverline("scrollview-base", 137);
if (IE) {
...
sv.after({
        ...
        _yuitest_coverline("scrollview-base", 165);
Y.one(WINDOW).after('resize', dimChangeHandler, sv);
    ...
    _bindDrag: function (drag) {
        _yuitest_coverfunc("scrollview-base", "_bindDrag", 175);
_yuitest_coverline("scrollview-base", 176);
var sv = this,
            bb = sv._bb;

        // Unbind any previous 'drag' listeners
        _yuitest_coverline("scrollview-base", 180);
bb.detach(DRAG + '|*');

        _yuitest_coverline("scrollview-base", 182);
if (drag) {
...
bb.on(DRAG + '|' + GESTURE_MOVE + START, Y.bind(sv._onGestureMoveStart, sv));
    ...
    _bindFlick: function (flick) {
        _yuitest_coverfunc("scrollview-base", "_bindFlick", 194);
_yuitest_coverline("scrollview-base", 195);
var sv = this,
            bb = sv._bb;

        // Unbind any previous 'flick' listeners
        _yuitest_coverline("scrollview-base", 199);
bb.detach(FLICK + '|*');

        _yuitest_coverline("scrollview-base", 201);
if (flick) {
...
Y.one(DOCUMENT).on(MOUSEWHEEL, Y.bind(sv._mousewheel, sv));
     ...
     */
    syncUI: function () {
        _yuitest_coverfunc("scrollview-base", "syncUI", 234);
_yuitest_coverline("scrollview-base", 235);
var sv = this,
            axis = sv.axis,
        ...
        _yuitest_coverline("scrollview-base", 244);
if (axis === "auto") {
...
sv.axis = axis;
        ...
        _yuitest_coverline("scrollview-base", 253);
sv.rtl = (sv._cb.getComputedStyle('direction') === 'rtl');

        // Cache the disabled value
        _yuitest_coverline("scrollview-base", 256);
...
sv._uiDimensionsChange();
        ...
        _yuitest_coverline("scrollview-base", 262);
if (sv._isOOB()) {
...
sv._snapBack();
    ...
    _getScrollDims: function () {
        _yuitest_coverfunc("scrollview-base", "_getScrollDims", 274);
_yuitest_coverline("scrollview-base", 275);
var sv = this,
            cb = sv._cb,
            bb = sv._bb,
        ...
        _yuitest_coverline("scrollview-base", 282);
...
cb.setStyle(TRANS.PROPERTY, EMPTY);
        ...
        _yuitest_coverline("scrollview-base", 287);
dims = {
        ...
        _yuitest_coverline("scrollview-base", 294);
return dims;
    },
    ...
    _uiDimensionsChange: function () {
        _yuitest_coverfunc("scrollview-base", "_uiDimensionsChange", 304);
_yuitest_coverline("scrollview-base", 305);
var sv = this,
            bb = sv._bb,
            scrollDims = sv._getScrollDims(),
            width = scrollDims.offsetWidth,
...
bb.addClass(CLASS_NAMES.horizontal);
        ...
        _yuitest_coverline("scrollview-base", 326);
if (axis.y) {
...
bb.addClass(CLASS_NAMES.vertical);
    ...
    scrollTo: function (x, y, duration, easing, node) {
        ...
        _yuitest_coverfunc("scrollview-base", "scrollTo", 389);
_yuitest_coverline("scrollview-base", 391);
if (this._cDisabled) {
            _yuitest_coverline("scrollview-base", 392);
return;
        }

        _yuitest_coverline("scrollview-base", 395);
var sv = this,
            cb = sv._cb,
            TRANS = ScrollView._TRANSITION,
        ...
        _yuitest_coverline("scrollview-base", 405);
duration = duration || 0;
...
node = node || cb;
        ...
        _yuitest_coverline("scrollview-base", 409);
if (x !== null) {
...
newX = -(x);
        ...
        _yuitest_coverline("scrollview-base", 414);
if (y !== null) {
...
newY = -(y);
        ...
        _yuitest_coverline("scrollview-base", 419);
transform = sv._transform(newX, newY);

        _yuitest_coverline("scrollview-base", 421);
if (NATIVE_TRANSITIONS) {
            // ANDROID WORKAROUND - try and stop existing transition, before kicking off new one.
            _yuitest_coverline("scrollview-base", 423);
node.setStyle(TRANS.DURATION, ZERO).setStyle(TRANS.PROPERTY, EMPTY);
        }

        // Move
        _yuitest_coverline("scrollview-base", 427);
if (duration === 0) {
...
node.setStyle(LEFT, newX + PX);
                ...
                _yuitest_coverline("scrollview-base", 437);
if (y !== null) {
...
return prop;
    ...
    _onTransEnd: function (e) {
        _yuitest_coverfunc("scrollview-base", "_onTransEnd", 487);
_yuitest_coverline("scrollview-base", 488);
var sv = this;
         ...
         */
        _yuitest_coverline("scrollview-base", 496);
sv.fire(EV_SCROLL_END);
    ...
    _onGestureMoveStart: function (e) {
        _yuitest_coverfunc("scrollview-base", "_onGestureMoveStart", 545);
_yuitest_coverline("scrollview-base", 546);
if (!this._cDisabled) {
...
e.stopPropagation();
            ...
            _yuitest_coverline("scrollview-base", 555);
...
e.preventDefault();
            ...
            _yuitest_coverline("scrollview-base", 560);
if (sv._flickAnim) {
...
sv._flickAnim.cancel();
            ...
            _yuitest_coverline("scrollview-base", 565);
sv._gesture = {
    ...
    _onGestureMove: function (e) {
        _yuitest_coverfunc("scrollview-base", "_onGestureMove", 603);
_yuitest_coverline("scrollview-base", 604);
var sv = this,
            gesture = sv._gesture,
            svAxis = sv.axis,
            svAxisX = svAxis.x,
        ...
        _yuitest_coverline("scrollview-base", 616);
if (sv._prevent.move) {
...
sv.set(SCROLL_Y, startY + gesture.deltaY);
    ...
    _onGestureMoveEnd: function (e) {
        _yuitest_coverfunc("scrollview-base", "_onGestureMoveEnd", 643);
_yuitest_coverline("scrollview-base", 644);
var sv = this,
            gesture = sv._gesture,
            flick = gesture.flick,
            clientX = e.clientX,
        ...
        _yuitest_coverline("scrollview-base", 651);
if (sv._prevent.end) {
            _yuitest_coverline("scrollview-base", 652);
e.preventDefault();
        }

        _yuitest_coverline("scrollview-base", 655);
...
gesture.endClientY = clientY;
        ...
        _yuitest_coverline("scrollview-base", 659);
...
sv._snapBack();
                ...
                _yuitest_coverline("scrollview-base", 666);
...
sv._onTransEnd();
     ...
     */
    _flick: function (e) {
        _yuitest_coverfunc("scrollview-base", "_flick", 680);
_yuitest_coverline("scrollview-base", 681);
var sv = this,
            gesture = sv._gesture,
            svAxis = sv.axis,
            svAxisX = svAxis.x,
        ...
        _yuitest_coverline("scrollview-base", 689);
if (!sv._cDisabled) {
...
sv._flickFrame(flick.velocity);
    ...
    _flickFrame: function (velocity) {
        ...
        _yuitest_coverfunc("scrollview-base", "_flickFrame", 709);
_yuitest_coverline("scrollview-base", 711);
var sv = this,
            gesture = sv._gesture,
...
velocity *= deceleration;
        ...
        _yuitest_coverline("scrollview-base", 732);
if (sv._isOOB()) {
            // We're past an edge, now bounce back
            _yuitest_coverline("scrollview-base", 734);
sv._snapBack();
        }
        
        // If the velocity gets slow enough, just stop
        else {_yuitest_coverline("scrollview-base", 738);
if (Math.abs(velocity).toFixed(4) <= 0.015) {
            _yuitest_coverline("scrollview-base", 739);
sv._onTransEnd();
        }

        // Otherwise, animate to the next frame
        else {
            _yuitest_coverline("scrollview-base", 744);
...
sv.set(SCROLL_X, newX);
            ...
            else {_yuitest_coverline("scrollview-base", 750);
...
velocity *= bounce;
                ...
                _yuitest_coverline("scrollview-base", 754);
sv.set(SCROLL_Y, newY);
            }}

            // TODO: maybe use requestAnimationFrame instead
            _yuitest_coverline("scrollview-base", 758);
sv._flickAnim = Y.later(step, sv, '_flickFrame', [velocity]);
    ...
    _mousewheel: function (e) {
        _yuitest_coverfunc("scrollview-base", "_mousewheel", 769);
_yuitest_coverline("scrollview-base", 770);
var sv = this,
        ...
        _yuitest_coverline("scrollview-base", 777);
scrollToY = _constrain(scrollToY, sv._minScrollY, sv._maxScrollY);

        _yuitest_coverline("scrollview-base", 779);
if (bb.contains(e.target)) {
            // Jump to the new offset
            _yuitest_coverline("scrollview-base", 781);
...
if (sv.scrollbars) {
                ...
                _yuitest_coverline("scrollview-base", 787);
...
sv._onTransEnd();
            ...
            _yuitest_coverline("scrollview-base", 797);
e.preventDefault();
        }
    },
     ...
     */
    _isOOB: function () {
        _yuitest_coverfunc("scrollview-base", "_isOOB", 808);
_yuitest_coverline("scrollview-base", 809);
var sv = this,
            svAxis = sv.axis,
            svAxisX = svAxis.x,
            svAxisY = svAxis.y,
        ...
        _yuitest_coverline("scrollview-base", 820);
return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY > maxY));
     ...
     */
    _snapBack: function () {
        _yuitest_coverfunc("scrollview-base", "_snapBack", 830);
_yuitest_coverline("scrollview-base", 831);
var sv = this,
            currentX = sv.get(SCROLL_X),
            currentY = sv.get(SCROLL_Y),
            minX = sv._minScrollX,
...
sv._onTransEnd();
    ...
    _afterScrollChange: function (e) {
        _yuitest_coverfunc("scrollview-base", "_afterScrollChange", 861);
_yuitest_coverline("scrollview-base", 862);
var sv = this,
            duration = e.duration,
            easing = e.easing,
            val = e.newVal,
...
if (e.src !== ScrollView.UI_SRC) {
            ...
            _yuitest_coverline("scrollview-base", 871);
...
scrollToArgs.push(sv.get(SCROLL_Y));
                ...
                _yuitest_coverline("scrollview-base", 876);
...
scrollToArgs.push(easing);
            ...
            _yuitest_coverline("scrollview-base", 883);
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _afterFlickChange: function (e) {
        _yuitest_coverfunc("scrollview-base", "_afterFlickChange", 894);
_yuitest_coverline("scrollview-base", 895);
this._bindFlick(e.newVal);
    ...
    _afterDisabledChange: function (e) {
        ...
        _yuitest_coverfunc("scrollview-base", "_afterDisabledChange", 905);
_yuitest_coverline("scrollview-base", 907);
this._cDisabled = e.newVal;
    ...
    _afterDragChange: function (e) {
        _yuitest_coverfunc("scrollview-base", "_afterDragChange", 917);
_yuitest_coverline("scrollview-base", 918);
this._bindDrag(e.newVal);
    ...
    _afterMousewheelChange: function (e) {
        _yuitest_coverfunc("scrollview-base", "_afterMousewheelChange", 928);
_yuitest_coverline("scrollview-base", 929);
this._bindMousewheel(e.newVal);
    ...
    _afterDimChange: function () {
        _yuitest_coverfunc("scrollview-base", "_afterDimChange", 939);
_yuitest_coverline("scrollview-base", 940);
this._uiDimensionsChange();
    ...
    _afterScrollEnd: function (e) {
        _yuitest_coverfunc("scrollview-base", "_afterScrollEnd", 950);
_yuitest_coverline("scrollview-base", 951);
var sv = this,
            gesture = sv._gesture;

        _yuitest_coverline("scrollview-base", 954);
...
gesture.onGestureMove.detach();
        ...
        _yuitest_coverline("scrollview-base", 958);
...
gesture.onGestureMoveEnd.detach();
        ...
        _yuitest_coverline("scrollview-base", 962);
if (sv._flickAnim) {
            _yuitest_coverline("scrollview-base", 963);
sv._flickAnim.cancel(); // Might as well?
        }
        
        _yuitest_coverline("scrollview-base", 966);
