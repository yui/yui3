...
sv._onTransEnd();
     ...
     */
    _onFlick: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onFlick", 742);
...
if ((position < minBounce) || (position > maxBounce)) {
            ...
            _yuitest_coverline("build/scrollview-base/scrollview-base.js", 792);
...
scrollToArgs.push(null);
            _yuitest_coverline("build/scrollview-base/scrollview-base.js", 802);
scrollToArgs.push(position);
        }
...
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _onMousewheel: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onMousewheel", 818);
...
e.preventDefault();
    ...
    _isOutOfBounds: function (x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_isOutOfBounds", 867);
...
return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY > maxY));
     ...
     */
    _snapBack: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_snapBack", 889);
...
sv.set(SCROLL_X, newX, {duration:duration, easing:easing});
        ...
        else {_yuitest_coverline("build/scrollview-base/scrollview-base.js", 905);
if (newY !== currentY) {
...
sv._onTransEnd();
    ...
    _afterScrollChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollChange", 921);
...
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _afterFlickChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterFlickChange", 959);
...
this._bindFlick(e.newVal);
    ...
    _afterDisabledChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDisabledChange", 970);
...
this._cDisabled = e.newVal;
    ...
    _afterAxisChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterAxisChange", 982);
...
this._cAxis = e.newVal;
    ...
    _afterDragChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDragChange", 993);
...
this._bindDrag(e.newVal);
    ...
    _afterDimChange: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDimChange", 1004);
...
this._uiDimensionsChange();
    ...
    _afterScrollEnd: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollEnd", 1015);
...
sv._snapBack();
    ...
    _axisSetter: function (val, name) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_axisSetter", 1041);
...
return {
    ...
    */
    _setScroll : function(val, dim) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScroll", 1062);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1065);
if (this._cDisabled) {
...
return val;
    ...
    */
    _setScrollX: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollX", 1080);
...
return this._setScroll(val, DIM_X);
    ...
    */
    _setScrollY: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollY", 1092);
