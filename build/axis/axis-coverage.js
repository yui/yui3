...
points = labelData.points;
                _yuitest_coverline("build/axis/axis.js", 1918);
...
point = points[i];
                        _yuitest_coverline("build/axis/axis.js", 1971);
if(point)
                        {
...
this._createLabelCache();
                _yuitest_coverline("build/axis/axis.js", 1978);
...
this._setTitle();
                _yuitest_coverline("build/axis/axis.js", 1983);
explicitlySized = layout.getExplicitlySized.apply(this, [styles]);
                _yuitest_coverline("build/axis/axis.js", 1984);
for(i = 0; i < len; i = i + 1)
                {
                    _yuitest_coverline("build/axis/axis.js", 1986);
point = points[i];
                    _yuitest_coverline("build/axis/axis.js", 1987);
if(point)
                    {
                        _yuitest_coverline("build/axis/axis.js", 1989);
label = this.getLabel(point, labelStyles);
                        _yuitest_coverline("build/axis/axis.js", 1990);
this._labels.push(label);
                        _yuitest_coverline("build/axis/axis.js", 1991);
this.get("appendLabelFunction")(label, labelFunction.apply(labelFunctionScope, [labelValues[i], labelFormat]));
                        _yuitest_coverline("build/axis/axis.js", 1992);
labelWidth = Math.round(label.offsetWidth);
                        _yuitest_coverline("build/axis/axis.js", 1993);
labelHeight = Math.round(label.offsetHeight);
                        _yuitest_coverline("build/axis/axis.js", 1994);
if(!explicitlySized)
                        {
...
this._labelWidths.push(labelWidth);
                        _yuitest_coverline("build/axis/axis.js", 1999);
...
if(this._titleTextField)
                {
                    _yuitest_coverline("build/axis/axis.js", 2010);
this._layout.positionTitle.apply(this, [this._titleTextField]);
                }
                _yuitest_coverline("build/axis/axis.js", 2012);
len = this._labels.length;
                _yuitest_coverline("build/axis/axis.js", 2013);
for(i = 0; i < len; ++i)
                {
...
this._updatePathElement();
            _yuitest_coverline("build/axis/axis.js", 2027);
this.fire("axisRendered");
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_setTotalTitleSize", 2038);
...
var title = this._titleTextField,
            ...
            position = this.get("position"),
            matrix = new Y.Matrix();
        _yuitest_coverline("build/axis/axis.js", 2049);
matrix.rotate(rot);
        _yuitest_coverline("build/axis/axis.js", 2050);
bounds = matrix.getContentRect(w, h);
        _yuitest_coverline("build/axis/axis.js", 2051);
if(position === "left" || position === "right")
        {
            _yuitest_coverline("build/axis/axis.js", 2053);
size = bounds.right - bounds.left;
            _yuitest_coverline("build/axis/axis.js", 2054);
if(margin)
            {
                _yuitest_coverline("build/axis/axis.js", 2056);
size += margin.left + margin.right;
            }
        }
        else
        {
            _yuitest_coverline("build/axis/axis.js", 2061);
size = bounds.bottom - bounds.top;
            _yuitest_coverline("build/axis/axis.js", 2062);
if(margin)
            {
                _yuitest_coverline("build/axis/axis.js", 2064);
...
this._totalTitleSize = size;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_updatePathElement", 2077);
...
if(path)
        {
            _yuitest_coverline("build/axis/axis.js", 2085);
redrawGraphic = true;
...
if(redrawGraphic)
        {
            _yuitest_coverline("build/axis/axis.js", 2095);
graphic._redraw();
        }
    },
    ...
    _setTitle: function()
    {
        _yuitest_coverfunc("build/axis/axis.js", "_setTitle", 2105);
...
var i,
            ...
            parentNode;
        _yuitest_coverline("build/axis/axis.js", 2113);
if(title !== null && title !== undefined)
        {
            _yuitest_coverline("build/axis/axis.js", 2115);
customStyles = {
                    rotation: "rotation",
                    margin: "margin",
                    alpha: "alpha"
            };
            _yuitest_coverline("build/axis/axis.js", 2120);
styles = this.get("styles").title;
            _yuitest_coverline("build/axis/axis.js", 2121);
if(!titleTextField)
            {
                _yuitest_coverline("build/axis/axis.js", 2123);
titleTextField = DOCUMENT.createElement('span');
                _yuitest_coverline("build/axis/axis.js", 2124);
titleTextField.style.display = "block";
                _yuitest_coverline("build/axis/axis.js", 2125);
titleTextField.style.whiteSpace = "nowrap";
                _yuitest_coverline("build/axis/axis.js", 2126);
...
this.get("contentBox").append(titleTextField);
            ...
            else {_yuitest_coverline("build/axis/axis.js", 2129);
if(!DOCUMENT.createElementNS)
            {
                _yuitest_coverline("build/axis/axis.js", 2131);
...
titleTextField.style.filter = null;
            ...
            _yuitest_coverline("build/axis/axis.js", 2136);
...
this._setTotalTitleSize(styles);
        ...
        else {_yuitest_coverline("build/axis/axis.js", 2149);
if(titleTextField)
        {
...
parentNode.removeChild(titleTextField);
            ...
            _yuitest_coverline("build/axis/axis.js", 2156);
...
this._totalTitleSize = 0;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getLabel", 2170);
_yuitest_coverline("build/axis/axis.js", 2172);
var i,
            label,
...
label.style.whiteSpace = "nowrap";
        _yuitest_coverline("build/axis/axis.js", 2199);
...
label.style[i] = styles[i];
        ...
        _yuitest_coverline("build/axis/axis.js", 2207);
return label;
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_createLabelCache", 2216);
...
while(this._labels.length > 0)
            {
                _yuitest_coverline("build/axis/axis.js", 2222);
...
this._labels = [];
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_clearLabelCache", 2238);
...
this._labelCache = [];
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getLineEnd", 2263);
_yuitest_coverline("build/axis/axis.js", 2265);
var w = this.get("width"),
            h = this.get("height"),
            pos = this.get("position");
        _yuitest_coverline("build/axis/axis.js", 2268);
if(pos === "top" || pos === "bottom")
        {
            _yuitest_coverline("build/axis/axis.js", 2270);
return {x:w, y:pt.y};
        }
        else
        {
            _yuitest_coverline("build/axis/axis.js", 2274);
return {x:pt.x, y:h};
        }
    },
    ...
    getLength: function()
    {
        _yuitest_coverfunc("build/axis/axis.js", "getLength", 2285);
...
l = w - (padding.left + padding.right);
        ...
        {
            _yuitest_coverline("build/axis/axis.js", 2299);
l = h - (padding.top + padding.bottom);
        }
        _yuitest_coverline("build/axis/axis.js", 2301);
return l;
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getFirstPoint", 2312);
...
return np;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_getPoints", 2342);
_yuitest_coverline("build/axis/axis.js", 2344);
var points = [],
            i,
            style = this.get("styles"),
            staticCoord,
...
staticCoord = "x";
            _yuitest_coverline("build/axis/axis.js", 2356);
dynamicCoord = "y";
            _yuitest_coverline("build/axis/axis.js", 2357);
padding = style.padding.top;
        }
        else
        {
            _yuitest_coverline("build/axis/axis.js", 2361);
staticCoord = "y";
            _yuitest_coverline("build/axis/axis.js", 2362);
dynamicCoord = "x";
            _yuitest_coverline("build/axis/axis.js", 2363);
padding = style.padding.left;
        }
        _yuitest_coverline("build/axis/axis.js", 2365);
constantVal = startPoint[staticCoord];
        _yuitest_coverline("build/axis/axis.js", 2366);
coord = edgeOffset + padding;
        _yuitest_coverline("build/axis/axis.js", 2367);
for(i = 0; i < len; i = i + 1)
        {
            _yuitest_coverline("build/axis/axis.js", 2369);
newPoint = {};
            _yuitest_coverline("build/axis/axis.js", 2370);
newPoint[staticCoord] = constantVal;
            _yuitest_coverline("build/axis/axis.js", 2371);
newPoint[dynamicCoord] = coord;
            _yuitest_coverline("build/axis/axis.js", 2372);
...
return points;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_rotate", 2386);
...
filterString = "progid:DXImageTransform.Microsoft.Alpha(Opacity=" + Math.round(textAlpha * 100) + ")";
            ...
            _yuitest_coverline("build/axis/axis.js", 2410);
if(rot !== 0)
            {
...
filterString = "";
                ...
                _yuitest_coverline("build/axis/axis.js", 2428);
filterString += matrix.toFilterText();
                _yuitest_coverline("build/axis/axis.js", 2429);
label.style.left = matrix.dx + "px";
                _yuitest_coverline("build/axis/axis.js", 2430);
label.style.top = matrix.dy + "px";
            }
            else
            {
                _yuitest_coverline("build/axis/axis.js", 2434);
label.style.left = x + "px";
                _yuitest_coverline("build/axis/axis.js", 2435);
...
label.style.filter = filterString;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_simulateRotateWithTransformOrigin", 2456);
_yuitest_coverline("build/axis/axis.js", 2458);
var transformX = transformOrigin[0] * w,
            transformY = transformOrigin[1] * h;
        _yuitest_coverline("build/axis/axis.js", 2460);
transformX = !isNaN(transformX) ? transformX : 0;
        _yuitest_coverline("build/axis/axis.js", 2461);
transformY = !isNaN(transformY) ? transformY : 0;
        _yuitest_coverline("build/axis/axis.js", 2462);
matrix.translate(transformX, transformY);
        _yuitest_coverline("build/axis/axis.js", 2463);
matrix.rotate(rot);
        _yuitest_coverline("build/axis/axis.js", 2464);
matrix.translate(-transformX, -transformY);
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getMaxLabelBounds", 2473);
_yuitest_coverline("build/axis/axis.js", 2475);
return this._getLabelBounds(this.getMaximumValue());
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getMinLabelBounds", 2484);
...
return this._getLabelBounds(this.getMinimumValue());
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_getLabelBounds", 2497);
...
return matrix.getContentRect(props.labelWidth, props.labelHeight);
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_removeChildren", 2527);
_yuitest_coverline("build/axis/axis.js", 2529);
if(node.hasChildNodes())
        {
            _yuitest_coverline("build/axis/axis.js", 2531);
var child;
            _yuitest_coverline("build/axis/axis.js", 2532);
...
node.removeChild(child);
    ...
    destructor: function()
    {
        _yuitest_coverfunc("build/axis/axis.js", "destructor", 2547);
...
var cb = this.get("contentBox").getDOMNode(),
        ...
        _yuitest_coverline("build/axis/axis.js", 2554);
if(len > 0)
        {
            _yuitest_coverline("build/axis/axis.js", 2556);
while(labels.length > 0)
            {
                _yuitest_coverline("build/axis/axis.js", 2558);
label = labels.shift();
                _yuitest_coverline("build/axis/axis.js", 2559);
this._removeChildren(label);
                _yuitest_coverline("build/axis/axis.js", 2560);
cb.removeChild(label);
                _yuitest_coverline("build/axis/axis.js", 2561);
label = null;
            }
        }
        _yuitest_coverline("build/axis/axis.js", 2564);
if(graphic)
        {
            _yuitest_coverline("build/axis/axis.js", 2566);
graphic.destroy();
        }
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_setText", 2588);
_yuitest_coverline("build/axis/axis.js", 2590);
textField.innerHTML = "";
        _yuitest_coverline("build/axis/axis.js", 2591);
if(Y_Lang.isNumber(val))
        {
            _yuitest_coverline("build/axis/axis.js", 2593);
val = val + "";
        }
        else {_yuitest_coverline("build/axis/axis.js", 2595);
if(!val)
        {
            _yuitest_coverline("build/axis/axis.js", 2597);
val = "";
        }}
...
val = DOCUMENT.createTextNode(val);
        ...
        _yuitest_coverline("build/axis/axis.js", 2603);
textField.appendChild(val);
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getTotalMajorUnits", 2612);
_yuitest_coverline("build/axis/axis.js", 2614);
var units,
            majorUnit = this.get("styles").majorUnit,
            len = this.getLength();
        _yuitest_coverline("build/axis/axis.js", 2617);
if(majorUnit.determinant === "count")
        {
            _yuitest_coverline("build/axis/axis.js", 2619);
units = majorUnit.count;
        }
        else {_yuitest_coverline("build/axis/axis.js", 2621);
if(majorUnit.determinant === "distance")
        {
            _yuitest_coverline("build/axis/axis.js", 2623);
...
return units;
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getMajorUnitDistance", 2637);
_yuitest_coverline("build/axis/axis.js", 2639);
var dist;
        _yuitest_coverline("build/axis/axis.js", 2640);
if(majorUnit.determinant === "count")
        {
            _yuitest_coverline("build/axis/axis.js", 2642);
if(!this.get("calculateEdgeOffset"))
            {
                _yuitest_coverline("build/axis/axis.js", 2644);
len = len - 1;
            }
            _yuitest_coverline("build/axis/axis.js", 2646);
dist = uiLen/len;
        }
        else {_yuitest_coverline("build/axis/axis.js", 2648);
if(majorUnit.determinant === "distance")
        {
            _yuitest_coverline("build/axis/axis.js", 2650);
dist = majorUnit.distance;
        }}
        _yuitest_coverline("build/axis/axis.js", 2652);
return dist;
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "_hasDataOverflow", 2664);
_yuitest_coverline("build/axis/axis.js", 2666);
if(this.get("setMin") || this.get("setMax"))
        {
            _yuitest_coverline("build/axis/axis.js", 2668);
return true;
        }
        _yuitest_coverline("build/axis/axis.js", 2670);
return false;
    },
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getMinimumValue", 2680);
_yuitest_coverline("build/axis/axis.js", 2682);
return this.get("minimum");
    ...
    {
        _yuitest_coverfunc("build/axis/axis.js", "getMaximumValue", 2692);
_yuitest_coverline("build/axis/axis.js", 2694);
return this.get("maximum");
    ...
    ATTRS:
    {
        ...
        width: {
            ...
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2712);
_yuitest_coverline("build/axis/axis.js", 2714);
if(this._explicitWidth)
                {
                    _yuitest_coverline("build/axis/axis.js", 2716);
...
return this._calculatedWidth;
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2721);
_yuitest_coverline("build/axis/axis.js", 2723);
...
if(this._explicitHeight)
                {
                    _yuitest_coverline("build/axis/axis.js", 2745);
return this._explicitHeight;
                }
                _yuitest_coverline("build/axis/axis.js", 2747);
return this._calculatedHeight;
            },

            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2750);
_yuitest_coverline("build/axis/axis.js", 2752);
...
return val;
        ...
        calculatedWidth: {
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2766);
_yuitest_coverline("build/axis/axis.js", 2768);
return this._calculatedWidth;
            },

            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2771);
_yuitest_coverline("build/axis/axis.js", 2773);
...
return val;
        ...
        calculatedHeight: {
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2787);
_yuitest_coverline("build/axis/axis.js", 2789);
return this._calculatedHeight;
            },

            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2792);
_yuitest_coverline("build/axis/axis.js", 2794);
this._calculatedHeight = val;
                _yuitest_coverline("build/axis/axis.js", 2795);
return val;
            }
        },
        ...
        path: {
            ...
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2828);
_yuitest_coverline("build/axis/axis.js", 2830);
if(!this._path)
                {
                    _yuitest_coverline("build/axis/axis.js", 2832);
var graphic = this.get("graphic");
                    _yuitest_coverline("build/axis/axis.js", 2833);
if(graphic)
                    {
                        _yuitest_coverline("build/axis/axis.js", 2835);
...
return this._path;
        ...
        tickPath: {
            ...
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2851);
_yuitest_coverline("build/axis/axis.js", 2853);
if(!this._tickPath)
                {
                    _yuitest_coverline("build/axis/axis.js", 2855);
var graphic = this.get("graphic");
                    _yuitest_coverline("build/axis/axis.js", 2856);
if(graphic)
                    {
...
this._tickPath = graphic.addShape({type:"path"});
                ...
                _yuitest_coverline("build/axis/axis.js", 2861);
return this._tickPath;
        ...
        position: {
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2882);
_yuitest_coverline("build/axis/axis.js", 2884);
var LayoutClass = this._layoutClasses[val];
                _yuitest_coverline("build/axis/axis.js", 2885);
if(val && val !== "none")
                {
                    _yuitest_coverline("build/axis/axis.js", 2887);
this._layout = new LayoutClass();
                }
                _yuitest_coverline("build/axis/axis.js", 2889);
return val;
            }
        },
...
return this._labels;
        ...
        tickPoints: {
            ...
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2960);
_yuitest_coverline("build/axis/axis.js", 2962);
if(this.get("position") === "none")
                {
                    _yuitest_coverline("build/axis/axis.js", 2964);
return this.get("styles").majorUnit.count;
                }
                _yuitest_coverline("build/axis/axis.js", 2966);
return this._tickPoints;
        ...
        overlapGraph: {
            ...
            {
                _yuitest_coverfunc("build/axis/axis.js", "validator", 2980);
...
return Y_Lang.isBoolean(val);
        ...
        maxLabelSize: {
            getter: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "getter", 2994);
_yuitest_coverline("build/axis/axis.js", 2996);
return this._maxLabelSize;
            },

            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 2999);
_yuitest_coverline("build/axis/axis.js", 3001);
this._maxLabelSize = val;
                _yuitest_coverline("build/axis/axis.js", 3002);
return val;
            }
        },
        ...
        appendLabelFunction: {
            valueFn: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "valueFn", 3037);
_yuitest_coverline("build/axis/axis.js", 3039);
return this._setText;
        ...
        appendTitleFunction: {
            valueFn: function()
            {
                _yuitest_coverfunc("build/axis/axis.js", "valueFn", 3058);
_yuitest_coverline("build/axis/axis.js", 3060);
return this._setText;
            }
        },
        ...
        labelValues: {
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/axis/axis.js", "setter", 3077);
_yuitest_coverline("build/axis/axis.js", 3079);
var opts = arguments[2];
                _yuitest_coverline("build/axis/axis.js", 3080);
if(!val || (opts && opts.src && opts.src === "internal"))
                {
                    _yuitest_coverline("build/axis/axis.js", 3082);
this._labelValuesExplicitlySet = false;
                }
                else
                {
                    _yuitest_coverline("build/axis/axis.js", 3086);
this._labelValuesExplicitlySet = true;
                }
                _yuitest_coverline("build/axis/axis.js", 3088);
return val;
            }
        },
...
_yuitest_coverline("build/axis/axis.js", 3167);
