...
_yuitest_coverage["/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 12);
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 66);
function PjaxBase() {}

_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 68);
PjaxBase.prototype = {
    ...
    **/
    ...
    initializer: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "initializer", 97);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 98);
this.publish(EVT_NAVIGATE, {defaultFn: this._defNavigateFn});
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 103);
if (this.get('html5')) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 104);
this._pjaxBindUI();
        }
    },

    destructor: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "destructor", 108);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 109);
this._pjaxEvents && this._pjaxEvents.detach();
    ...
    **/
    navigate: function (url, options) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "navigate", 144);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 146);
url = this._resolveURL(url);

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 148);
if (this._navigate(url, options)) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 149);
return true;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 152);
if (!this._hasSameOrigin(url)) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 153);
Y.error('Security error: The new URL must be of the same origin as the current URL.');
        }

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 156);
return false;
    },
    ...
    **/
    _isLinkSameOrigin: function (link) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "_isLinkSameOrigin", 176);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 177);
var location = Y.getLocation(),
        ...
        // currrent location.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 185);
if (link.get('protocol') !== protocol ||
                link.get('hostname') !== hostname) {

            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 188);
return false;
        }

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 191);
linkPort = parseInt(link.get('port'), 10) || null;
        ...
        // they are compared.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 197);
if (protocol === 'http:') {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 198);
port     || (port     = 80);
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 199);
linkPort || (linkPort = 80);
        } else {_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 200);
if (protocol === 'https:') {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 201);
port     || (port     = 443);
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 202);
linkPort || (linkPort = 443);
        }}

        // Finally, to be from the same origin, the link's `port` must match the
        // page's current `port`.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 207);
return linkPort === port;
    ...
    **/
    _navigate: function (url, options) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "_navigate", 228);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 229);
url = this._upgradeURL(url);

        // Navigation can only be enhanced if there is a route-handler.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 232);
if (!this.hasRoute(url)) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 233);
return false;
        }

        // Make a copy of `options` before modifying it.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 237);
options = Y.merge(options, {url: url});

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 239);
var currentURL = this._upgradeURL(this._getURL()),
            hash, hashlessURL;

        // Captures the `url`'s hash and returns a URL without that hash.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 243);
hashlessURL = url.replace(/(#.*)$/, function (u, h, i) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "(anonymous 2)", 243);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 244);
hash = h;
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 245);
return u.substring(i);
        });

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 248);
if (hash && hashlessURL === currentURL.replace(/#.*$/, '')) {
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 251);
if (!this.get('navigateOnHash')) {
                _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 252);
return false;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 255);
options.hash = hash;
        }
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 260);
'replace' in options || (options.replace = url === currentURL);
        ...
        // on `window.location`.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 266);
if (this.get('html5') || options.force) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 267);
this.fire(EVT_NAVIGATE, options);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 269);
if (options.replace) {
                _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 270);
win && win.location.replace(url);
            } else {
                _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 272);
win && (win.location = url);
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 276);
return true;
    },
    ...
    **/
    _pjaxBindUI: function () {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "_pjaxBindUI", 290);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 292);
if (!this._pjaxEvents) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 293);
this._pjaxEvents = Y.one('body').delegate('click',
    ...
    **/
    _defNavigateFn: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "_defNavigateFn", 311);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 312);
this[e.replace ? 'replace' : 'save'](e.url);

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 314);
if (win && this.get('scrollToTop')) {
            ...
            // button.
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 319);
setTimeout(function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "(anonymous 3)", 319);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 320);
win.scroll(0, 0);
            }, 1);
        }
    },
    ...
    **/
    _onLinkClick: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", "_onLinkClick", 343);
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 344);
var link, url;

        // Allow the native behavior on middle/right-click, or when Ctrl or
        // Command are pressed.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 348);
if (e.button !== 1 || e.ctrlKey || e.metaKey) { return; }

        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 350);
link = e.currentTarget;

        // Only allow anchor elements because we need access to its `protocol`,
        // `host`, and `href` attributes.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 354);
if (link.get('tagName').toUpperCase() !== 'A') {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 355);
return;
        }

        // Same origin check to prevent trying to navigate to URLs from other
        // sites or things like mailto links.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 360);
if (!this._isLinkSameOrigin(link)) {
            _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 361);
return;
        }

        // All browsers fully resolve an anchor's `href` property.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 365);
url = link.get('href');

        // Try and navigate to the URL via the router, and prevent the default
        // link-click action if we do.
        _yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 369);
url && this._navigate(url, {originEvent: e}) && e.preventDefault();
    }
};

_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 373);
PjaxBase.ATTRS = {
    /**
...
_yuitest_coverline("/home/yui/src/yui3/src/pjax/build_tmp/pjax-base.js", 428);
Y.PjaxBase = PjaxBase;
