...
_yuitest_coverage["resize-plugin"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @constructor
 */
_yuitest_coverfunc("resize-plugin", "(anonymous 1)", 1);
_yuitest_coverline("resize-plugin", 25);
var ResizePlugin = function(config) {

                //if its a widget, get the bounding box
                _yuitest_coverfunc("resize-plugin", "ResizePlugin", 25);
_yuitest_coverline("resize-plugin", 28);
config.node = ((Y.Widget && config.host instanceof Y.Widget) ? config.host.get('boundingBox') : config.host);
                _yuitest_coverline("resize-plugin", 29);
if (config.host instanceof Y.Widget) {
                        _yuitest_coverline("resize-plugin", 30);
config.widget = config.host;
                }
                else {
                        _yuitest_coverline("resize-plugin", 33);
config.widget = false;
                }

                _yuitest_coverline("resize-plugin", 36);
ResizePlugin.superclass.constructor.call(this, config);
        ...
        * @type {String}
        */
        _yuitest_coverline("resize-plugin", 44);
ResizePlugin.NAME = "resize-plugin";
        ...
        * @type {String}
        */
        _yuitest_coverline("resize-plugin", 51);
ResizePlugin.NS = "resize";
         ...
         * @static
         */
        _yuitest_coverline("resize-plugin", 61);
ResizePlugin.ATTRS = {
        ...
        _yuitest_coverline("resize-plugin", 87);
Y.extend(ResizePlugin, Y.Resize, {
                ...
                initializer: function(config) {
                        ...
                        _yuitest_coverfunc("resize-plugin", "initializer", 95);
_yuitest_coverline("resize-plugin", 97);
this.set('node', config.node);
                        _yuitest_coverline("resize-plugin", 98);
this.set('widget', config.widget);

                        _yuitest_coverline("resize-plugin", 100);
this.on('resize:resize', function(e) {
                                _yuitest_coverfunc("resize-plugin", "(anonymous 2)", 100);
_yuitest_coverline("resize-plugin", 101);
this._correctDimensions(e);
                ...
                _correctDimensions: function(e) {
                        ...
                        _yuitest_coverfunc("resize-plugin", "_correctDimensions", 113);
_yuitest_coverline("resize-plugin", 115);
var node = this.get('node'),
                        ...
                        _yuitest_coverline("resize-plugin", 126);
if (this.get('widget')) {
                            _yuitest_coverline("resize-plugin", 127);
this._setWidgetProperties(e, x, y);
                        }

                        //now set properties on just the node or the widget's bounding box
                        _yuitest_coverline("resize-plugin", 131);
if (this._isDifferent(x.old, x.cur)) {
                            _yuitest_coverline("resize-plugin", 132);
node.set('x', x.cur);
                        }

                        _yuitest_coverline("resize-plugin", 135);
if (this._isDifferent(y.old, y.cur)) {
                            _yuitest_coverline("resize-plugin", 136);
node.set('y', y.cur);
                        }
                   ...
                   _setWidgetProperties: function(e,x,y) {
                       ...
                       _yuitest_coverfunc("resize-plugin", "_setWidgetProperties", 151);
_yuitest_coverline("resize-plugin", 154);
var widget = this.get('widget'),
                       ...
                       _yuitest_coverline("resize-plugin", 160);
if (this._isDifferent(oldHeight, currentHeight)) {
                          _yuitest_coverline("resize-plugin", 161);
widget.set('height', currentHeight);
                       }

                       _yuitest_coverline("resize-plugin", 164);
if (this._isDifferent(oldWidth, currentWidth)) {
                          _yuitest_coverline("resize-plugin", 165);
widget.set('width', currentWidth);
                       ...
                       _yuitest_coverline("resize-plugin", 171);
if (widget.hasImpl && widget.hasImpl(Y.WidgetPosition)) {
                           
                           _yuitest_coverline("resize-plugin", 173);
if (this._isDifferent(widget.get('x'), x.cur)) {
                               _yuitest_coverline("resize-plugin", 174);
widget.set('x', x.cur);
                           }

                           _yuitest_coverline("resize-plugin", 177);
if (this._isDifferent(widget.get('y'), y.cur)) {
                               _yuitest_coverline("resize-plugin", 178);
widget.set('y', y.cur);
                           }
                   ...
                   _isDifferent: function(oldVal, newVal) {
                       _yuitest_coverfunc("resize-plugin", "_isDifferent", 193);
_yuitest_coverline("resize-plugin", 194);
if (oldVal !== newVal) {
                           _yuitest_coverline("resize-plugin", 195);
return newVal;
                       }
                       else {
                           _yuitest_coverline("resize-plugin", 198);
return false;
                       }
                   }
        ...
        _yuitest_coverline("resize-plugin", 204);
Y.namespace('Plugin');
        _yuitest_coverline("resize-plugin", 205);
