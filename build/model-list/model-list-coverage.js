...
_yuitest_coverline("/build/model-list/model-list.js", 31);
...
_yuitest_coverline("/build/model-list/model-list.js", 133);
function ModelList() {
    _yuitest_coverfunc("/build/model-list/model-list.js", "ModelList", 133);
_yuitest_coverline("/build/model-list/model-list.js", 134);
...
Y.ModelList = Y.extend(ModelList, Y.Base, {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "initializer", 173);
_yuitest_coverline("/build/model-list/model-list.js", 174);
config || (config = {});

        _yuitest_coverline("/build/model-list/model-list.js", 176);
...
if (!this.model) {
                _yuitest_coverline("/build/model-list/model-list.js", 183);
...
this.publish(EVT_ADD,    {defaultFn: this._defAddFn});
        _yuitest_coverline("/build/model-list/model-list.js", 188);
this.publish(EVT_RESET,  {defaultFn: this._defResetFn});
        _yuitest_coverline("/build/model-list/model-list.js", 189);
...
this._clear();
    ...
    destructor: function () {
        _yuitest_coverfunc("/build/model-list/model-list.js", "destructor", 196);
...
this._clear();
    ...
    **/
    add: function (models, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "add", 242);
_yuitest_coverline("/build/model-list/model-list.js", 243);
var isList = models._isYUIModelList;

        _yuitest_coverline("/build/model-list/model-list.js", 245);
if (isList || Lang.isArray(models)) {
            _yuitest_coverline("/build/model-list/model-list.js", 246);
return YArray.map(isList ? models.toArray() : models, function (model, index) {
                _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 2)", 246);
_yuitest_coverline("/build/model-list/model-list.js", 247);
var modelOptions = options || {};
                ...
                // array.
                _yuitest_coverline("/build/model-list/model-list.js", 252);
...
modelOptions = Y.merge(modelOptions, {
                ...
                _yuitest_coverline("/build/model-list/model-list.js", 258);
...
return this._add(models, options);
    ...
    **/
    create: function (model, options, callback) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "create", 307);
_yuitest_coverline("/build/model-list/model-list.js", 308);
var self = this;

        // Allow callback as second arg.
        _yuitest_coverline("/build/model-list/model-list.js", 311);
if (typeof options === 'function') {
            _yuitest_coverline("/build/model-list/model-list.js", 312);
callback = options;
            _yuitest_coverline("/build/model-list/model-list.js", 313);
options  = {};
        }
...
options || (options = {});
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 318);
if (!model._isYUIModel) {
            _yuitest_coverline("/build/model-list/model-list.js", 319);
model = new this.model(model);
        }

        _yuitest_coverline("/build/model-list/model-list.js", 322);
...
return model.save(options, function (err) {
            _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 3)", 326);
_yuitest_coverline("/build/model-list/model-list.js", 327);
if (!err) {
                _yuitest_coverline("/build/model-list/model-list.js", 328);
self.add(model, options);
            }

            _yuitest_coverline("/build/model-list/model-list.js", 331);
callback && callback.apply(null, arguments);
    ...
    **/
    each: function (callback, thisObj) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "each", 355);
_yuitest_coverline("/build/model-list/model-list.js", 356);
var items = this._items.concat(),
            i, item, len;

        _yuitest_coverline("/build/model-list/model-list.js", 359);
for (i = 0, len = items.length; i < len; i++) {
            _yuitest_coverline("/build/model-list/model-list.js", 360);
item = items[i];
            _yuitest_coverline("/build/model-list/model-list.js", 361);
...
return this;
    ...
    */
    filter: function (options, callback) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "filter", 405);
_yuitest_coverline("/build/model-list/model-list.js", 406);
var filtered = [],
            items    = this._items,
            i, item, len, list;

        // Allow options as first arg.
        _yuitest_coverline("/build/model-list/model-list.js", 411);
if (typeof options === 'function') {
            _yuitest_coverline("/build/model-list/model-list.js", 412);
callback = options;
            _yuitest_coverline("/build/model-list/model-list.js", 413);
options  = {};
        }

        _yuitest_coverline("/build/model-list/model-list.js", 416);
for (i = 0, len = items.length; i < len; ++i) {
            _yuitest_coverline("/build/model-list/model-list.js", 417);
item = items[i];
...
list.add(filtered, {silent: true});
            ...
            _yuitest_coverline("/build/model-list/model-list.js", 431);
return list;
        } else {
...
return filtered;
    ...
    **/
    get: function (name) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "get", 447);
_yuitest_coverline("/build/model-list/model-list.js", 448);
if (this.attrAdded(name)) {
            _yuitest_coverline("/build/model-list/model-list.js", 449);
return AttrProto.get.apply(this, arguments);
        }

        _yuitest_coverline("/build/model-list/model-list.js", 452);
return this.invoke('get', name);
    ...
    **/
    getAsHTML: function (name) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "getAsHTML", 469);
_yuitest_coverline("/build/model-list/model-list.js", 470);
if (this.attrAdded(name)) {
            _yuitest_coverline("/build/model-list/model-list.js", 471);
return Y.Escape.html(AttrProto.get.apply(this, arguments));
        }

        _yuitest_coverline("/build/model-list/model-list.js", 474);
return this.invoke('getAsHTML', name);
    ...
    **/
    getAsURL: function (name) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "getAsURL", 490);
_yuitest_coverline("/build/model-list/model-list.js", 491);
if (this.attrAdded(name)) {
            _yuitest_coverline("/build/model-list/model-list.js", 492);
return encodeURIComponent(AttrProto.get.apply(this, arguments));
        }

        _yuitest_coverline("/build/model-list/model-list.js", 495);
return this.invoke('getAsURL', name);
    ...
    **/
    getByClientId: function (clientId) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "getByClientId", 505);
_yuitest_coverline("/build/model-list/model-list.js", 506);
return this._clientIdMap[clientId] || null;
    ...
    **/
    getById: function (id) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "getById", 520);
_yuitest_coverline("/build/model-list/model-list.js", 521);
return this._idMap[id] || null;
    ...
    **/
    invoke: function (name /*, args* */) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "invoke", 534);
_yuitest_coverline("/build/model-list/model-list.js", 535);
var args = [this._items, name].concat(YArray(arguments, 1, true));
        _yuitest_coverline("/build/model-list/model-list.js", 536);
return YArray.invoke.apply(YArray, args);
    ...
    **/
    load: function (options, callback) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "load", 572);
_yuitest_coverline("/build/model-list/model-list.js", 573);
var self = this;

        // Allow callback as only arg.
        _yuitest_coverline("/build/model-list/model-list.js", 576);
if (typeof options === 'function') {
            _yuitest_coverline("/build/model-list/model-list.js", 577);
callback = options;
            _yuitest_coverline("/build/model-list/model-list.js", 578);
options  = {};
        }
...
options || (options = {});
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 583);
this.sync('read', options, function (err, response) {
            _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 4)", 583);
...
facade.error = err;
                _yuitest_coverline("/build/model-list/model-list.js", 593);
facade.src   = 'load';

                _yuitest_coverline("/build/model-list/model-list.js", 595);
self.fire(EVT_ERROR, facade);
            } else {
                // Lazy publish.
                _yuitest_coverline("/build/model-list/model-list.js", 598);
if (!self._loadEvent) {
...
self._loadEvent = self.publish(EVT_LOAD, {
                ...
                _yuitest_coverline("/build/model-list/model-list.js", 604);
...
self.fire(EVT_LOAD, facade);
            ...
            _yuitest_coverline("/build/model-list/model-list.js", 610);
callback && callback.apply(null, arguments);
        });

        _yuitest_coverline("/build/model-list/model-list.js", 613);
return this;
    },
    ...
    **/
    map: function (fn, thisObj) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "map", 628);
_yuitest_coverline("/build/model-list/model-list.js", 629);
return YArray.map(this._items, fn, thisObj);
    ...
    **/
    parse: function (response) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "parse", 650);
_yuitest_coverline("/build/model-list/model-list.js", 651);
if (typeof response === 'string') {
            _yuitest_coverline("/build/model-list/model-list.js", 652);
try {
                _yuitest_coverline("/build/model-list/model-list.js", 653);
return Y.JSON.parse(response) || [];
            } catch (ex) {
                _yuitest_coverline("/build/model-list/model-list.js", 655);
this.fire(EVT_ERROR, {
                    error   : ex,
                    response: response,
                    src     : 'parse'
...
return null;
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 665);
return response || [];
    },
    ...
    **/
    remove: function (models, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "remove", 685);
_yuitest_coverline("/build/model-list/model-list.js", 686);
var isList = models._isYUIModelList;

        _yuitest_coverline("/build/model-list/model-list.js", 688);
if (isList || Lang.isArray(models)) {
            ...
            // first.
            _yuitest_coverline("/build/model-list/model-list.js", 692);
models = YArray.map(isList ? models.toArray() : models, function (model) {
                _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 5)", 692);
_yuitest_coverline("/build/model-list/model-list.js", 693);
if (Lang.isNumber(model)) {
                    _yuitest_coverline("/build/model-list/model-list.js", 694);
return this.item(model);
                }

                _yuitest_coverline("/build/model-list/model-list.js", 697);
return model;
            }, this);

            _yuitest_coverline("/build/model-list/model-list.js", 700);
return YArray.map(models, function (model) {
                _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 6)", 700);
_yuitest_coverline("/build/model-list/model-list.js", 701);
return this._remove(model, options);
            }, this);
        } else {
            _yuitest_coverline("/build/model-list/model-list.js", 704);
return this._remove(models, options);
    ...
    **/
    reset: function (models, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "reset", 730);
_yuitest_coverline("/build/model-list/model-list.js", 731);
models  || (models  = []);
        _yuitest_coverline("/build/model-list/model-list.js", 732);
options || (options = {});

        _yuitest_coverline("/build/model-list/model-list.js", 734);
var facade = Y.merge({src: 'reset'}, options);

        _yuitest_coverline("/build/model-list/model-list.js", 736);
if (models._isYUIModelList) {
            _yuitest_coverline("/build/model-list/model-list.js", 737);
models = models.toArray();
        } else {
            _yuitest_coverline("/build/model-list/model-list.js", 739);
models = YArray.map(models, function (model) {
                _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 7)", 739);
...
facade.models = models;
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 746);
if (options.silent) {
            _yuitest_coverline("/build/model-list/model-list.js", 747);
this._defResetFn(facade);
        } else {
            // Sort the models before firing the reset event.
            _yuitest_coverline("/build/model-list/model-list.js", 750);
if (this.comparator) {
                _yuitest_coverline("/build/model-list/model-list.js", 751);
...
this.fire(EVT_RESET, facade);
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 757);
return this;
    },
    ...
    **/
    some: function (callback, thisObj) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "some", 782);
_yuitest_coverline("/build/model-list/model-list.js", 783);
var items = this._items.concat(),
            i, item, len;

        _yuitest_coverline("/build/model-list/model-list.js", 786);
for (i = 0, len = items.length; i < len; i++) {
            _yuitest_coverline("/build/model-list/model-list.js", 787);
item = items[i];

            _yuitest_coverline("/build/model-list/model-list.js", 789);
if (callback.call(thisObj || item, item, i, this)) {
                _yuitest_coverline("/build/model-list/model-list.js", 790);
return true;
            }
        }
...
return false;
    ...
    **/
    sort: function (options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "sort", 812);
_yuitest_coverline("/build/model-list/model-list.js", 813);
if (!this.comparator) {
            _yuitest_coverline("/build/model-list/model-list.js", 814);
return this;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 817);
var models = this._items.concat(),
            facade;

        _yuitest_coverline("/build/model-list/model-list.js", 820);
options || (options = {});

        _yuitest_coverline("/build/model-list/model-list.js", 822);
models.sort(Y.bind(this._sort, this));

        _yuitest_coverline("/build/model-list/model-list.js", 824);
facade = Y.merge(options, {
            models: models,
            src   : 'sort'
        });

        _yuitest_coverline("/build/model-list/model-list.js", 829);
...
return this;
    ...
    **/
    sync: function (/* action, options, callback */) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "sync", 863);
_yuitest_coverline("/build/model-list/model-list.js", 864);
var callback = YArray(arguments, 0, true).pop();

        _yuitest_coverline("/build/model-list/model-list.js", 866);
if (typeof callback === 'function') {
            _yuitest_coverline("/build/model-list/model-list.js", 867);
callback();
        }
    },
    ...
    **/
    toArray: function () {
        _yuitest_coverfunc("/build/model-list/model-list.js", "toArray", 877);
_yuitest_coverline("/build/model-list/model-list.js", 878);
return this._items.concat();
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("/build/model-list/model-list.js", "toJSON", 892);
_yuitest_coverline("/build/model-list/model-list.js", 893);
return this.map(function (model) {
            _yuitest_coverfunc("/build/model-list/model-list.js", "(anonymous 8)", 893);
_yuitest_coverline("/build/model-list/model-list.js", 894);
return model.toJSON();
        });
    },
    ...
    **/
    _add: function (model, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_add", 915);
_yuitest_coverline("/build/model-list/model-list.js", 916);
var facade, id;

        _yuitest_coverline("/build/model-list/model-list.js", 918);
options || (options = {});

        _yuitest_coverline("/build/model-list/model-list.js", 920);
if (!model._isYUIModel) {
            _yuitest_coverline("/build/model-list/model-list.js", 921);
model = new this.model(model);
        }
...
this.fire(EVT_ERROR, {
            ...
            _yuitest_coverline("/build/model-list/model-list.js", 935);
return;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 938);
facade = Y.merge(options, {
...
options.silent ? this._defAddFn(facade) : this.fire(EVT_ADD, facade);
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 945);
return model;
    },
    ...
    **/
    _attachList: function (model) {
        ...
        _yuitest_coverfunc("/build/model-list/model-list.js", "_attachList", 955);
_yuitest_coverline("/build/model-list/model-list.js", 957);
model.lists.push(this);
        _yuitest_coverline("/build/model-list/model-list.js", 958);
model.addTarget(this);
    ...
    **/
    _clear: function () {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_clear", 968);
_yuitest_coverline("/build/model-list/model-list.js", 969);
YArray.each(this._items, this._detachList, this);

        _yuitest_coverline("/build/model-list/model-list.js", 971);
this._clientIdMap = {};
        _yuitest_coverline("/build/model-list/model-list.js", 972);
this._idMap       = {};
        _yuitest_coverline("/build/model-list/model-list.js", 973);
this._items       = [];
    },
    ...
    **/
    _compare: function (a, b) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_compare", 990);
_yuitest_coverline("/build/model-list/model-list.js", 991);
return a < b ? -1 : (a > b ? 1 : 0);
    ...
    **/
    _detachList: function (model) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_detachList", 1001);
_yuitest_coverline("/build/model-list/model-list.js", 1002);
var index = YArray.indexOf(model.lists, this);

        _yuitest_coverline("/build/model-list/model-list.js", 1004);
if (index > -1) {
            _yuitest_coverline("/build/model-list/model-list.js", 1005);
model.lists.splice(index, 1);
            _yuitest_coverline("/build/model-list/model-list.js", 1006);
model.removeTarget(this);
    ...
    **/
    _findIndex: function (model) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_findIndex", 1019);
_yuitest_coverline("/build/model-list/model-list.js", 1020);
var items = this._items,
            max   = items.length,
            min   = 0,
            item, middle, needle;

        _yuitest_coverline("/build/model-list/model-list.js", 1025);
if (!this.comparator || !max) {
            _yuitest_coverline("/build/model-list/model-list.js", 1026);
return max;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1029);
...
middle = (min + max) >> 1; // Divide by two and discard remainder.
            _yuitest_coverline("/build/model-list/model-list.js", 1035);
item   = items[middle];

            _yuitest_coverline("/build/model-list/model-list.js", 1037);
if (this._compare(this.comparator(item), needle) < 0) {
                _yuitest_coverline("/build/model-list/model-list.js", 1038);
min = middle + 1;
            } else {
                _yuitest_coverline("/build/model-list/model-list.js", 1040);
max = middle;
            }
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1044);
return min;
    },
    ...
    **/
    _remove: function (model, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_remove", 1059);
_yuitest_coverline("/build/model-list/model-list.js", 1060);
var index, facade;

        _yuitest_coverline("/build/model-list/model-list.js", 1062);
options || (options = {});

        _yuitest_coverline("/build/model-list/model-list.js", 1064);
if (Lang.isNumber(model)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1065);
index = model;
            _yuitest_coverline("/build/model-list/model-list.js", 1066);
model = this.item(index);
        } else {
            _yuitest_coverline("/build/model-list/model-list.js", 1068);
index = this.indexOf(model);
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1071);
if (index === -1 || !model) {
            _yuitest_coverline("/build/model-list/model-list.js", 1072);
this.fire(EVT_ERROR, {
            ...
            _yuitest_coverline("/build/model-list/model-list.js", 1079);
return;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1082);
facade = Y.merge(options, {
            index: index,
            model: model
        });

        _yuitest_coverline("/build/model-list/model-list.js", 1087);
...
return model;
    ...
    **/
    _sort: function (a, b) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_sort", 1102);
_yuitest_coverline("/build/model-list/model-list.js", 1103);
return this._compare(this.comparator(a), this.comparator(b));
    ...
    **/
    _afterIdChange: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_afterIdChange", 1115);
_yuitest_coverline("/build/model-list/model-list.js", 1116);
var newVal  = e.newVal,
            prevVal = e.prevVal,
            target  = e.target;

        _yuitest_coverline("/build/model-list/model-list.js", 1120);
if (Lang.isValue(prevVal)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1121);
if (this._idMap[prevVal] === target) {
                _yuitest_coverline("/build/model-list/model-list.js", 1122);
delete this._idMap[prevVal];
                ...
                _yuitest_coverline("/build/model-list/model-list.js", 1126);
return;
            }
        } else {
            // The model had no previous id. Verify that it exists in this list
            // before continuing.
            _yuitest_coverline("/build/model-list/model-list.js", 1131);
if (this.indexOf(target) === -1) {
                _yuitest_coverline("/build/model-list/model-list.js", 1132);
return;
            }
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1136);
if (Lang.isValue(newVal)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1137);
this._idMap[newVal] = target;
    ...
    **/
    _defAddFn: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defAddFn", 1150);
_yuitest_coverline("/build/model-list/model-list.js", 1151);
var model = e.model,
            id    = model.get('id');

        _yuitest_coverline("/build/model-list/model-list.js", 1154);
this._clientIdMap[model.get('clientId')] = model;

        _yuitest_coverline("/build/model-list/model-list.js", 1156);
if (Lang.isValue(id)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1157);
this._idMap[id] = model;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1160);
this._attachList(model);
        _yuitest_coverline("/build/model-list/model-list.js", 1161);
this._items.splice(e.index, 0, model);
    ...
    **/
    _defRemoveFn: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defRemoveFn", 1171);
_yuitest_coverline("/build/model-list/model-list.js", 1172);
var model = e.model,
            id    = model.get('id');

        _yuitest_coverline("/build/model-list/model-list.js", 1175);
this._detachList(model);
        _yuitest_coverline("/build/model-list/model-list.js", 1176);
delete this._clientIdMap[model.get('clientId')];

        _yuitest_coverline("/build/model-list/model-list.js", 1178);
if (Lang.isValue(id)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1179);
...
this._items.splice(e.index, 1);
    ...
    **/
    _defResetFn: function (e) {
        ...
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defResetFn", 1192);
_yuitest_coverline("/build/model-list/model-list.js", 1195);
if (e.src === 'sort') {
            _yuitest_coverline("/build/model-list/model-list.js", 1196);
this._items = e.models.concat();
            _yuitest_coverline("/build/model-list/model-list.js", 1197);
return;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1200);
this._clear();

        _yuitest_coverline("/build/model-list/model-list.js", 1202);
if (e.models.length) {
            _yuitest_coverline("/build/model-list/model-list.js", 1203);
...
_yuitest_coverline("/build/model-list/model-list.js", 1210);
