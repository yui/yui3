...
return min;
    ...
    **/
    _parse: function (response) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_parse", 1061);
...
return this.parse(response);
    ...
    **/
    _remove: function (model, options) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_remove", 1077);
_yuitest_coverline("/build/model-list/model-list.js", 1078);
var index, facade;

        _yuitest_coverline("/build/model-list/model-list.js", 1080);
options || (options = {});

        _yuitest_coverline("/build/model-list/model-list.js", 1082);
if (Lang.isNumber(model)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1083);
index = model;
            _yuitest_coverline("/build/model-list/model-list.js", 1084);
...
index = this.indexOf(model);
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 1089);
if (index === -1 || !model) {
...
return;
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 1100);
facade = Y.merge(options, {
            index: index,
            model: model
        });
...
return model;
    ...
    **/
    _sort: function (a, b) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_sort", 1120);
...
return this._compare(this.comparator(a), this.comparator(b));
    ...
    **/
    _afterIdChange: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_afterIdChange", 1133);
_yuitest_coverline("/build/model-list/model-list.js", 1134);
var newVal  = e.newVal,
            prevVal = e.prevVal,
            target  = e.target;

        _yuitest_coverline("/build/model-list/model-list.js", 1138);
if (Lang.isValue(prevVal)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1139);
if (this._idMap[prevVal] === target) {
                _yuitest_coverline("/build/model-list/model-list.js", 1140);
delete this._idMap[prevVal];
                ...
                _yuitest_coverline("/build/model-list/model-list.js", 1144);
return;
            }
        } else {
            // The model had no previous id. Verify that it exists in this list
            // before continuing.
            _yuitest_coverline("/build/model-list/model-list.js", 1149);
if (this.indexOf(target) === -1) {
                _yuitest_coverline("/build/model-list/model-list.js", 1150);
return;
            }
        }
...
if (Lang.isValue(newVal)) {
            _yuitest_coverline("/build/model-list/model-list.js", 1155);
this._idMap[newVal] = target;
    ...
    **/
    _defAddFn: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defAddFn", 1168);
_yuitest_coverline("/build/model-list/model-list.js", 1169);
var model = e.model,
            id    = model.get('id');
...
this._clientIdMap[model.get('clientId')] = model;
        ...
        _yuitest_coverline("/build/model-list/model-list.js", 1174);
if (Lang.isValue(id)) {
...
this._items.splice(e.index, 0, model);
    ...
    **/
    _defRemoveFn: function (e) {
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defRemoveFn", 1189);
_yuitest_coverline("/build/model-list/model-list.js", 1190);
var model = e.model,
            id    = model.get('id');

        _yuitest_coverline("/build/model-list/model-list.js", 1193);
this._detachList(model);
        _yuitest_coverline("/build/model-list/model-list.js", 1194);
...
this._items.splice(e.index, 1);
    ...
    **/
    _defResetFn: function (e) {
        ...
        _yuitest_coverfunc("/build/model-list/model-list.js", "_defResetFn", 1210);
_yuitest_coverline("/build/model-list/model-list.js", 1213);
if (e.src === 'sort') {
            _yuitest_coverline("/build/model-list/model-list.js", 1214);
this._items = e.models.concat();
            _yuitest_coverline("/build/model-list/model-list.js", 1215);
return;
        }

        _yuitest_coverline("/build/model-list/model-list.js", 1218);
this._clear();

        _yuitest_coverline("/build/model-list/model-list.js", 1220);
if (e.models.length) {
