...
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
    coveredFunctions: 0,
    calledFunctions: 0,
    path: "/home/yui/src/yui3/src/uploader/build_tmp/uploader.js",
    code: []
};
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"].code=["YUI.add('uploader', function(Y) {","","/**"," * Provides UI for selecting multiple files and functionality for "," * uploading multiple files to the server with support for either"," * html5 or Flash transport mechanisms, automatic queue management,"," * upload progress monitoring, and error events."," * @module uploader"," * @main uploader"," * @since 3.5.0"," */","","/**"," * `Y.Uploader` serves as an alias for either <a href=\"UploaderFlash.html\">`Y.UploaderFlash`</a>"," * or <a href=\"UploaderHTML5.html\">`Y.UploaderHTML5`</a>, depending on the feature set available"," * in a specific browser. If neither HTML5 nor Flash transport layers are available, `Y.Uploader.TYPE` "," * static property is set to `\"none\"`."," *"," * @class Uploader"," */",""," /**"," * The static property reflecting the type of uploader that `Y.Uploader`"," * aliases. The possible values are:"," * <ul>"," * <li><strong>`\"html5\"`</strong>: Y.Uploader is an alias for <a href=\"UploaderHTML5.html\">Y.UploaderHTML5</a></li>"," * <li><strong>`\"flash\"`</strong>: Y.Uploader is an alias for <a href=\"UploaderFlash.html\">Y.UploaderFlash</a></li>"," * <li><strong>`\"none\"`</strong>: Neither Flash not HTML5 are available, and Y.Uploader does"," * not reference an actual implementation.</li>"," * </ul>"," *"," * @property TYPE"," * @type {String}"," * @static"," */",""," var Win = Y.config.win;",""," if (Win && Win.File && Win.FormData && Win.XMLHttpRequest) {","    Y.Uploader = Y.UploaderHTML5;"," }",""," else if (Y.SWFDetect.isFlashVersionAtLeast(10,0,45)) {","    Y.Uploader = Y.UploaderFlash;"," }",""," else {","    Y.namespace(\"Uploader\");","    Y.Uploader.TYPE = \"none\";"," }","","","}, '@VERSION@' ,{requires:['uploader-flash', 'uploader-html5']});"];
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"].lines = {"1":0,"37":0,"39":0,"40":0,"43":0,"44":0,"48":0,"49":0};
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"].functions = {"(anonymous 1):1":0};
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"].coveredLines = 8;
_yuitest_coverage["/home/yui/src/yui3/src/uploader/build_tmp/uploader.js"].coveredFunctions = 1;
_yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 1);
 ...
 */
 ...
 _yuitest_coverfunc("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 37);
var Win = Y.config.win;

 _yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 39);
if (Win && Win.File && Win.FormData && Win.XMLHttpRequest) {
    _yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 40);
Y.Uploader = Y.UploaderHTML5;
 }

 else {_yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 43);
if (Y.SWFDetect.isFlashVersionAtLeast(10,0,45)) {
    _yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 44);
Y.Uploader = Y.UploaderFlash;
 }

 else {
    _yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 48);
Y.namespace("Uploader");
    _yuitest_coverline("/home/yui/src/yui3/src/uploader/build_tmp/uploader.js", 49);
