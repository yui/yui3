...
_yuitest_coverage["/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
@since 3.5.0
**/
_yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 11);
var Lang         = Y.Lang,
...
@since 3.5.0
**/
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 102);
Y.namespace('DataTable').BodyView = Y.Base.create('tableBody', Y.View, [], {
    ...
    **/
    getCell: function (seed, shift) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "getCell", 200);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 201);
var tbody = this.tbodyNode,
            row, cell, index, rowIndexOffset;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 204);
if (seed && tbody) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 205);
if (isArray(seed)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 206);
row = tbody.get('children').item(seed[0]);
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 207);
cell = row && row.get('children').item(seed[1]);
            } else {_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 208);
if (Y.instanceOf(seed, Y.Node)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 209);
cell = seed.ancestor('.' + this.getClassName('cell'), true);
            }}

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 212);
if (cell && shift) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 213);
rowIndexOffset = tbody.get('firstChild.rowIndex');
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 214);
if (isString(shift)) {
                    // TODO this should be a static object map
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 216);
switch (shift) {
                        case 'above'   : _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 217);
shift = [-1, 0]; break;
                        case 'below'   : _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 218);
shift = [1, 0]; break;
                        case 'next'    : _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 219);
shift = [0, 1]; break;
                        case 'previous': _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 220);
shift = [0, -1]; break;
                    }
                }

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 224);
if (isArray(shift)) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 225);
index = cell.get('parentNode.rowIndex') +
                                shift[0] - rowIndexOffset;
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 227);
row   = tbody.get('children').item(index);

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 229);
index = cell.get('cellIndex') + shift[1];
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 230);
cell  = row && row.get('children').item(index);
                }
            }
        }
        
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 235);
return cell || null;
    },
    ...
    **/
    getClassName: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "getClassName", 253);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 254);
var host = this.host,
            args;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 257);
if (host && host.getClassName) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 258);
return host.getClassName.apply(host, arguments);
        } else {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 260);
args = toArray(arguments);
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 261);
args.unshift(this.constructor.NAME);
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 262);
return Y.ClassNameManager.getClassName
    ...
    **/
    getRecord: function (seed) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "getRecord", 278);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 279);
var modelList = this.get('modelList'),
            tbody     = this.tbodyNode,
            row       = null,
            record;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 284);
if (tbody) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 285);
if (isString(seed)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 286);
seed = tbody.one('#' + seed);
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 289);
if (Y.instanceOf(seed, Y.Node)) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 290);
row = seed.ancestor(function (node) {
                    _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "(anonymous 2)", 290);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 291);
return node.get('parentNode').compareTo(tbody);
                }, true);

                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 294);
record = row &&
                    modelList.getByClientId(row.getData('yui3-record'));
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 299);
return record || null;
    },
    ...
    **/
    getRow: function (id) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "getRow", 312);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 313);
var tbody = this.tbodyNode,
            row = null;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 316);
if (tbody) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 317);
if (id) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 318);
id = this._idMap[id.get ? id.get('clientId') : id] || id;
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 321);
row = isNumber(id) ?
                tbody.get('children').item(id) :
                tbody.one('#' + id);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 326);
return row;
    },
    ...
    **/
    render: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "render", 419);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 420);
var table   = this.get('container'),
        ...
        // Needed for mutation
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 427);
this._createRowTemplate(columns);

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 429);
if (data) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 430);
tbody.setHTML(this._createDataHTML(columns));

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 432);
this._applyNodeFormatters(tbody, columns);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 435);
if (tbody.get('parentNode') !== table) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 436);
table.appendChild(tbody);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 439);
this.bindUI();

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 441);
return this;
    },
    ...
    **/
    ...
    _afterColumnsChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_afterColumnsChange", 460);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 461);
this.render();
    },
    ...
    **/
    _afterDataChange: function (e) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_afterDataChange", 474);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 478);
this.render();
    },
    ...
    **/
    _afterModelListChange: function (e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_afterModelListChange", 491);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 492);
var handles = this._eventHandles;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 494);
if (handles.dataChange) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 495);
handles.dataChange.detach();
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 496);
delete handles.dataChange;
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 497);
this.bindUI();
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 500);
if (this.tbodyNode) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 501);
this.render();
        }
    },
    ...
    **/
    _applyNodeFormatters: function (tbody, columns) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_applyNodeFormatters", 515);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 516);
var host = this.host,
            data = this.get('modelList'),
            formatters = [],
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 523);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 524);
if (columns[i].nodeFormatter) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 525);
formatters.push(i);
            }
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 529);
if (data && formatters.length) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 530);
rows = tbody.get('childNodes');

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 532);
data.each(function (record, index) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "(anonymous 3)", 532);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 533);
var formatterData = {
                        data      : record.toJSON(),
                        record    : record,
                        rowIndex  : index
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 542);
if (row) {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 543);
cells = row.get('childNodes');
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 544);
for (i = 0, len = formatters.length; i < len; ++i) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 545);
cell = cells.item(formatters[i]);

                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 547);
if (cell) {
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 548);
col = formatterData.column = columns[formatters[i]];
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 549);
key = col.key || col.id;

                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 551);
formatterData.value = record.get(key);
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 552);
formatterData.td    = cell;
                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 553);
formatterData.cell  = cell.one(linerQuery) || cell;

                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 555);
keep = col.nodeFormatter.call(host,formatterData);

                            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 557);
if (keep === false) {
                                ...
                                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 563);
cell.destroy(true);
                            }
                        }
                    }
    ...
    **/
    bindUI: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "bindUI", 579);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 580);
var handles     = this._eventHandles,
            modelList   = this.get('modelList'),
            changeEvent = modelList.model.NAME + ':change';

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 584);
if (!handles.columnsChange) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 585);
handles.columnsChange = this.after('columnsChange',
                bind('_afterColumnsChange', this));
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 589);
if (modelList && !handles.dataChange) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 590);
handles.dataChange = modelList.after(
    ...
    **/
    _createDataHTML: function (columns) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_createDataHTML", 610);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 611);
var data = this.get('modelList'),
            html = '';

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 614);
if (data) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 615);
data.each(function (model, index) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "(anonymous 4)", 615);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 616);
html += this._createRowHTML(model, index, columns);
            }, this);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 620);
return html;
    },
    ...
    **/
    _createRowHTML: function (model, index, columns) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_createRowHTML", 658);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 659);
var data     = model.toJSON(),
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 669);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 670);
col   = columns[i];
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 671);
value = data[col.key];
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 672);
token = col._id || col.key;

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 674);
values[token + '-className'] = '';

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 676);
if (col.formatter) {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 677);
formatterData = {
                    value    : value,
                    data     : data,
                    column   : col,
                ...
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 687);
if (typeof col.formatter === 'string') {
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 688);
if (value !== undefined) {
                        // TODO: look for known formatters by string name
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 690);
value = fromTemplate(col.formatter, formatterData);
                    }
                } else {
                    // Formatters can either return a value
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 694);
value = col.formatter.call(host, formatterData);

                    // or update the value property of the data obj passed
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 697);
if (value === undefined) {
                        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 698);
value = formatterData.value;
                    }

                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 701);
values[token + '-className'] = formatterData.className;
                    _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 702);
values.rowClass += ' ' + formatterData.rowClass;
                }
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 706);
if (value === undefined || value === null || value === '') {
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 707);
value = col.emptyCellValue || '';
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 710);
values[token] = col.allowHTML ? value : htmlEscape(value);

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 712);
values.rowClass = values.rowClass.replace(/\s+/g, ' ');
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 715);
return fromTemplate(this._rowTemplate, values);
    ...
    **/
    _createRowTemplate: function (columns) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_createRowTemplate", 730);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 731);
var html         = '',
            cellTemplate = this.CELL_TEMPLATE,
            i, len, col, key, token, headers, tokenValues;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 735);
for (i = 0, len = columns.length; i < len; ++i) {
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 736);
col     = columns[i];
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 737);
key     = col.key;
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 738);
token   = col._id || key;
            // Only include headers if there are more than one
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 740);
headers = (col._headers || []).length > 1 ?
                        'headers="' + col._headers.join(' ') + '"' : '';

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 743);
tokenValues = {
                content  : '{' + token + '}',
                headers  : headers,
            ...
            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 752);
if (col.nodeFormatter) {
                // Defer all node decoration to the formatter
                _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 754);
tokenValues.content = '';
            }

            _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 757);
html += fromTemplate(col.cellTemplate || cellTemplate, tokenValues);
        }

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 760);
this._rowTemplate = fromTemplate(this.ROW_TEMPLATE, {
    ...
    **/
    _createTBodyNode: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_createTBodyNode", 773);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 774);
return Y.Node.create(fromTemplate(this.TBODY_TEMPLATE, {
    ...
    **/
    destructor: function () {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "destructor", 786);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 787);
(new Y.EventHandle(YObject.values(this._eventHandles))).detach();
    ...
    **/
    _getRowId: function (clientId) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "_getRowId", 810);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 811);
return this._idMap[clientId] || (this._idMap[clientId] = Y.guid());
    ...
    **/
    initializer: function (config) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", "initializer", 836);
_yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 837);
this.host = config.host;

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 839);
this._eventHandles = {
            modelListChange: this.after('modelListChange',
                bind('_afterModelListChange', this))
        };
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 843);
this._idMap = {};

        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 845);
this.CLASS_ODD  = this.getClassName('odd');
        _yuitest_coverline("/home/yui/src/yui3/src/datatable/build_tmp/datatable-body.js", 846);
