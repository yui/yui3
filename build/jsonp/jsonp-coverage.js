...
Y.Get.script(url, {
        ...
        _yuitest_coverline("build/jsonp/jsonp.js", 202);
return self;
    },
    ...
    _format: function (url, proxy) {
        _yuitest_coverfunc("build/jsonp/jsonp.js", "_format", 219);
_yuitest_coverline("build/jsonp/jsonp.js", 220);
return url.replace(/\{callback\}/, proxy);
    }
};

_yuitest_coverline("build/jsonp/jsonp.js", 224);
