...
_yuitest_coverage["/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
_yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 12);
var YArray    = Y.Array,
...
Highlighters = Y.mix(Y.namespace('AutoCompleteHighlighters'), {
    ...
    **/
    charMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "charMatch", 28);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 32);
var queryChars = YArray.unique((caseSensitive ? query :
                query.toLowerCase()).split(''));

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 35);
return YArray.map(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 2)", 35);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 36);
return Highlight.all(result.text, queryChars, {
    ...
    **/
    charMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "charMatchCase", 51);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 52);
return Highlighters.charMatch(query, results, true);
    ...
    **/
    phraseMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "phraseMatch", 65);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 69);
return YArray.map(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 3)", 69);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 70);
return Highlight.all(result.text, [query], {
    ...
    **/
    phraseMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "phraseMatchCase", 85);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 86);
return Highlighters.phraseMatch(query, results, true);
    ...
    **/
    startsWith: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "startsWith", 99);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 103);
return YArray.map(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 4)", 103);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 104);
return Highlight.all(result.text, [query], {
                caseSensitive: caseSensitive,
                startsWith   : true
            });
    ...
    **/
    startsWithCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "startsWithCase", 120);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 121);
return Highlighters.startsWith(query, results, true);
    ...
    **/
    subWordMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "subWordMatch", 135);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 139);
var queryWords = Y.Text.WordBreak.getUniqueWords(query, {
            ignoreCase: !caseSensitive
        });

        _yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 143);
return YArray.map(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 5)", 143);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 144);
return Highlight.all(result.text, queryWords, {
    ...
    **/
    subWordMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "subWordMatchCase", 159);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 160);
return Highlighters.subWordMatch(query, results, true);
    ...
    **/
    wordMatch: function (query, results, caseSensitive) {
        ...
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "wordMatch", 173);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 177);
return YArray.map(results, function (result) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "(anonymous 6)", 177);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 178);
return Highlight.words(result.text, query, {
    ...
    **/
    wordMatchCase: function (query, results) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", "wordMatchCase", 193);
_yuitest_coverline("/home/yui/src/yui3/src/autocomplete/build_tmp/autocomplete-highlighters.js", 194);
