...
@static
**/
_yuitest_coverline("build/template-micro/template-micro.js", 100);
Micro.compile = function (text, options) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "compile", 100);
...
var blocks     = [],
    ...
    _yuitest_coverline("build/template-micro/template-micro.js", 106);
options = Y.merge(Micro.options, options);
    ...
    _yuitest_coverline("build/template-micro/template-micro.js", 111);
source = "var $t='" +
        ...
        .replace(options.rawOutput, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 2)", 121);
_yuitest_coverline("build/template-micro/template-micro.js", 122);
return tokenOpen + (blocks.push("'+\n(" + code + ")+\n'") - 1) + tokenClose;
        })

        .replace(options.escapedOutput, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 3)", 125);
_yuitest_coverline("build/template-micro/template-micro.js", 126);
return tokenOpen + (blocks.push("'+\n$e(" + code + ")+\n'") - 1) + tokenClose;
        })

        .replace(options.code, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 4)", 129);
_yuitest_coverline("build/template-micro/template-micro.js", 130);
return tokenOpen + (blocks.push("';\n" + code + "\n;$t+='") - 1) + tokenClose;
        })
        ...
        .replace(/\ufffe(\d+)\uffff/g, function (match, index) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 5)", 136);
_yuitest_coverline("build/template-micro/template-micro.js", 137);
return blocks[parseInt(index, 10)];
    ...
    _yuitest_coverline("build/template-micro/template-micro.js", 143);
if (options.precompile) {
        _yuitest_coverline("build/template-micro/template-micro.js", 144);
...
@static
**/
_yuitest_coverline("build/template-micro/template-micro.js", 168);
Micro.precompile = function (text, options) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "precompile", 168);
_yuitest_coverline("build/template-micro/template-micro.js", 169);
options || (options = {});
    _yuitest_coverline("build/template-micro/template-micro.js", 170);
options.precompile = true;

    _yuitest_coverline("build/template-micro/template-micro.js", 172);
...
@static
**/
_yuitest_coverline("build/template-micro/template-micro.js", 191);
Micro.render = function (text, data, options) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "render", 191);
_yuitest_coverline("build/template-micro/template-micro.js", 192);
...
@static
**/
_yuitest_coverline("build/template-micro/template-micro.js", 206);
Micro.revive = function (precompiled) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "revive", 206);
_yuitest_coverline("build/template-micro/template-micro.js", 207);
return function (data) {
        _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 6)", 207);
_yuitest_coverline("build/template-micro/template-micro.js", 208);
data || (data = {});
        _yuitest_coverline("build/template-micro/template-micro.js", 209);
