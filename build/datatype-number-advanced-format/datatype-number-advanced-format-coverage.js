...
_yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 936);
Y.Number.format = function(data, config) {
    _yuitest_coverfunc("build/datatype-number-advanced-format/datatype-number-advanced-format.js", "format", 936);
_yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 937);
config = config || {};
    
    _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 939);
if(config.prefix != null || config.decimalPlaces != null || config.decimalSeparator != null || config.thousandsSeparator != null || config.suffix != null) {
        _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 940);
return Y.Number.deprecatedFormat(data, config);
    }
    
    _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 943);
try {
        _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 944);
var formatter = new YNumberFormat(config.style);
        _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 945);
...
Y.Number.parse = function(data, config) {
    _yuitest_coverfunc("build/datatype-number-advanced-format/datatype-number-advanced-format.js", "parse", 956);
_yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 957);
try {
...
console.log(e);
    ...
    _yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 965);
return Y.Number.parse(data);
}

//Update Parsers shortcut
_yuitest_coverline("build/datatype-number-advanced-format/datatype-number-advanced-format.js", 969);
