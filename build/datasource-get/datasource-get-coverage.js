...
_yuitest_coverage["/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
 ...
 * @constructor
 */    
_yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "(anonymous 1)", 1);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 16);
var DSGet = function() {
    _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "DSGet", 16);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 17);
DSGet.superclass.constructor.apply(this, arguments);
};
    
    
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 21);
Y.DataSource.Get = Y.extend(DSGet, Y.DataSource.Local, {
    ...
    _defRequestFn: function(e) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "_defRequestFn", 41);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 42);
var uri  = this.get("source"),
         ...
         * @protected
         */
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 57);
this._last = guid;

        // Dynamically add handler function with a closure to the callback stack
        // for access to guid
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 61);
YUI.Env.DataSource.callbacks[guid] = function(response) {
            _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "]", 61);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 62);
delete YUI.Env.DataSource.callbacks[guid];
            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 63);
delete Y.DataSource.Local.transactions[e.tId];

            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 65);
var process = self.get('asyncMode') !== "ignoreStaleResponses" ||
                          self._last === guid;

            _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 68);
if (process) {
                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 69);
payload.data = response;

                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 71);
self.fire("data", payload);
        ...
        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 78);
uri += e.request + generateRequest.call( this, guid );


        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 81);
Y.DataSource.Local.transactions[e.tId] = get.script(uri, {
            autopurge: true,
            // Works in Firefox only....
            onFailure: function (o) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "onFailure", 84);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 85);
delete YUI.Env.DataSource.callbacks[guid];
                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 86);
delete Y.DataSource.Local.transactions[e.tId];

                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 88);
payload.error = new Error(o.msg || "Script node data failure");


                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 91);
self.fire("data", payload);
            },
            onTimeout: function(o) {
                _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "onTimeout", 93);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 94);
delete YUI.Env.DataSource.callbacks[guid];
                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 95);
delete Y.DataSource.Local.transactions[e.tId];

                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 97);
payload.error = new Error(o.msg || "Script node data timeout");


                _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 100);
self.fire("data", payload);
            }
        });

        _yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 104);
return e.tId;
    },
     ...
     */
     _generateRequest: function (guid) {
        _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "_generateRequest", 116);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 117);
return "&" + this.get("scriptCallbackParam") +
    ...
    ATTRS: {
        ...
        generateRequestCallback : {
            value: function () {
                _yuitest_coverfunc("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", "value", 199);
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 200);
...
_yuitest_coverline("/home/yui/src/yui3/src/datasource/build_tmp/datasource-get.js", 206);
