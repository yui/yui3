YUI.add('charts-legend-tests', function(Y) {
    var suite = new Y.Test.Suite('charts-legend-tests example test suite'),
        _getClassName = Y.ClassNameManager.getClassName,
        CHART_BOUNDINGBOX = "." + _getClassName("cartesianchartlegend"),
        CHART_CONTENTBOX = "." + _getClassName("cartesianchartlegend-content"),
