YUI.add('verticalcombospline-gridlines-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.VerticalComboSplineGridlines"),
    ...
    suite.add(getGridlinesTest("combospline", null, true, false));
    suite.add(getGridlinesTest("combospline", null, true, true));
    suite.add(getGridlinesTest("combospline", null, false, true));
    suite.add(getGridlinesTest("combospline", null, styledGridlines, false));
    suite.add(getGridlinesTest("combospline", null, styledGridlines, true));
    suite.add(getGridlinesTest("combospline", null, styledGridlines, true));
    suite.add(getGridlinesTest("combospline", null, true, styledGridlines));
    suite.add(getGridlinesTest("combospline", null, true, styledGridlines));
    suite.add(getGridlinesTest("combospline", null, false, styledGridlines));
    suite.add(getGridlinesTest("combospline", "time", true, false));
    suite.add(getGridlinesTest("combospline", "time", true, true));
    suite.add(getGridlinesTest("combospline", "time", false, true));
    suite.add(getGridlinesTest("combospline", "time", styledGridlines, false));
    suite.add(getGridlinesTest("combospline", "time", styledGridlines, true));
    suite.add(getGridlinesTest("combospline", "time", styledGridlines, true));
    suite.add(getGridlinesTest("combospline", "time", true, styledGridlines));
    suite.add(getGridlinesTest("combospline", "time", true, styledGridlines));
    suite.add(getGridlinesTest("combospline", "time", false, styledGridlines));
