YUI.add('combo-globalstyles-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.GlobalStyles"),
    ...
    suite.add(getGlobalStylesTest("combo", null, arraySeriesStyles, null, true, false));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, null, true, false));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, null, true, false));
