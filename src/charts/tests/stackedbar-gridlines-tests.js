YUI.add('stackedbar-gridlines-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.StackedBarGridlines"),
    ...
    suite.add(getGridlinesTest("bar", null, true, false));
    suite.add(getGridlinesTest("bar", null, true, true));
    suite.add(getGridlinesTest("bar", null, false, true));
    suite.add(getGridlinesTest("bar", null, styledGridlines, false));
    suite.add(getGridlinesTest("bar", null, styledGridlines, true));
    suite.add(getGridlinesTest("bar", null, styledGridlines, true));
    suite.add(getGridlinesTest("bar", null, true, styledGridlines));
    suite.add(getGridlinesTest("bar", null, true, styledGridlines));
    suite.add(getGridlinesTest("bar", null, false, styledGridlines));
    suite.add(getGridlinesTest("bar", "time", true, false));
    suite.add(getGridlinesTest("bar", "time", true, true));
    suite.add(getGridlinesTest("bar", "time", false, true));
    suite.add(getGridlinesTest("bar", "time", styledGridlines, false));
    suite.add(getGridlinesTest("bar", "time", styledGridlines, true));
    suite.add(getGridlinesTest("bar", "time", styledGridlines, true));
    suite.add(getGridlinesTest("bar", "time", true, styledGridlines));
    suite.add(getGridlinesTest("bar", "time", true, styledGridlines));
    suite.add(getGridlinesTest("bar", "time", false, styledGridlines));
