YUI.add('bar-legend-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.BarLegend"),
    ...
    suite.add(NoLegendTest("bar"));
    suite.add(LegendTest("bar", "top", topLegend(), "center"));
    suite.add(LegendTest("bar", "right", rightLegend(), "middle"));
    suite.add(LegendTest("bar", "bottom", bottomLegend(), "center"));
    suite.add(LegendTest("bar", "left", leftLegend(), "middle"));
    suite.add(LegendTest("bar", "top", topLegendLeft(), "left"));
    suite.add(LegendTest("bar", "right", rightLegendTop(), "top"));
    suite.add(LegendTest("bar", "bottom", bottomLegendLeft(), "left"));
    suite.add(LegendTest("bar", "left", leftLegendTop(), "top"));
    suite.add(LegendTest("bar", "top", topLegendRight(), "right"));
    suite.add(LegendTest("bar", "right", rightLegendBottom(), "bottom"));
    suite.add(LegendTest("bar", "bottom", bottomLegendRight(), "right"));
    suite.add(LegendTest("bar", "left",  leftLegendBottom(), "bottom"));
    suite.add(LegendPositionTest("bar"));
