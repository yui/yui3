YUI.add('area-globalstyles-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.AreaGlobalStyles"),
    ...
    suite.add(getGlobalStylesTest("area", null, hashSeriesStyles, null, false));
    suite.add(getGlobalStylesTest("area", null, arraySeriesStyles, null, false));
    suite.add(getGlobalStylesTest("area", null, hashSeriesStyles, null, true));
    suite.add(getGlobalStylesTest("area", null, arraySeriesStyles, null, true));
    suite.add(getGlobalStylesTest("area", "time", hashSeriesStyles, null, false));
    suite.add(getGlobalStylesTest("area", "time", arraySeriesStyles, null, false));
    suite.add(getGlobalStylesTest("area", "time", hashSeriesStyles, null, true));
    suite.add(getGlobalStylesTest("area", "time", arraySeriesStyles, null, true));
