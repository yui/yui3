YUI.add('stackedverticalarea-gridlines-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.StackedVerticalAreaGridlines"),
    ...
    suite.add(getGridlinesTest("area", null, true, false));
    suite.add(getGridlinesTest("area", null, true, true));
    suite.add(getGridlinesTest("area", null, false, true));
    suite.add(getGridlinesTest("area", null, styledGridlines, false));
    suite.add(getGridlinesTest("area", null, styledGridlines, true));
    suite.add(getGridlinesTest("area", null, styledGridlines, true));
    suite.add(getGridlinesTest("area", null, true, styledGridlines));
    suite.add(getGridlinesTest("area", null, true, styledGridlines));
    suite.add(getGridlinesTest("area", null, false, styledGridlines));
    suite.add(getGridlinesTest("area", "time", true, false));
    suite.add(getGridlinesTest("area", "time", true, true));
    suite.add(getGridlinesTest("area", "time", false, true));
    suite.add(getGridlinesTest("area", "time", styledGridlines, false));
    suite.add(getGridlinesTest("area", "time", styledGridlines, true));
    suite.add(getGridlinesTest("area", "time", styledGridlines, true));
    suite.add(getGridlinesTest("area", "time", true, styledGridlines));
    suite.add(getGridlinesTest("area", "time", true, styledGridlines));
    suite.add(getGridlinesTest("area", "time", false, styledGridlines));
