YUI.add('combosplineshowareafill-globalstyles-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.ComboSplineShowAreaFillGlobalStyles"),
    ...
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, null, true, true));
