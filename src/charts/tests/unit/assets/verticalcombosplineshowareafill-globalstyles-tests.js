YUI.add('verticalcombosplineshowareafill-globalstyles-tests', function(Y) {
    ...
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, "vertical", true, true));
