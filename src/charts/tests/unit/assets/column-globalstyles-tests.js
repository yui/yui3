YUI.add('column-globalstyles-tests', function(Y) {
    ...
    suite.add(getGlobalStylesTest("column", null, hashSeriesStyles, null, false));
    suite.add(getGlobalStylesTest("column", null, arraySeriesStyles, null, false));
    suite.add(getGlobalStylesTest("column", null, hashSeriesStyles, null, true));
    suite.add(getGlobalStylesTest("column", null, arraySeriesStyles, null, true));
    suite.add(getGlobalStylesTest("column", "time", hashSeriesStyles, null, false));
    suite.add(getGlobalStylesTest("column", "time", arraySeriesStyles, null, false));
    suite.add(getGlobalStylesTest("column", "time", hashSeriesStyles, null, true));
    suite.add(getGlobalStylesTest("column", "time", arraySeriesStyles, null, true));
