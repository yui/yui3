YUI.add('comboshowareafill-globalstyles-tests', function(Y) {
    ...
    suite.add(getGlobalStylesTest("combo", null, hashSeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combo", null, arraySeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combo", null, hashSeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combo", null, arraySeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, null, false, true));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, null, true, true));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, null, true, true));
