YUI.add('combospline-globalstyles-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.ComboSplineGlobalStyles"),
    ...
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combospline", null, hashSeriesStyles, null, true, false));
    suite.add(getGlobalStylesTest("combospline", null, arraySeriesStyles, null, true, false));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, null, false, false));
    suite.add(getGlobalStylesTest("combospline", "time", hashSeriesStyles, null, true, false));
    suite.add(getGlobalStylesTest("combospline", "time", arraySeriesStyles, null, true, false));
