YUI.add('stackedverticalareaspline-gridlines-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.StackedVerticalAreaSplineGridlines"),
    ...
    suite.add(getGridlinesTest("areaspline", null, true, false));
    suite.add(getGridlinesTest("areaspline", null, true, true));
    suite.add(getGridlinesTest("areaspline", null, false, true));
    suite.add(getGridlinesTest("areaspline", null, styledGridlines, false));
    suite.add(getGridlinesTest("areaspline", null, styledGridlines, true));
    suite.add(getGridlinesTest("areaspline", null, styledGridlines, true));
    suite.add(getGridlinesTest("areaspline", null, true, styledGridlines));
    suite.add(getGridlinesTest("areaspline", null, true, styledGridlines));
    suite.add(getGridlinesTest("areaspline", null, false, styledGridlines));
    suite.add(getGridlinesTest("areaspline", "time", true, false));
    suite.add(getGridlinesTest("areaspline", "time", true, true));
    suite.add(getGridlinesTest("areaspline", "time", false, true));
    suite.add(getGridlinesTest("areaspline", "time", styledGridlines, false));
    suite.add(getGridlinesTest("areaspline", "time", styledGridlines, true));
    suite.add(getGridlinesTest("areaspline", "time", styledGridlines, true));
    suite.add(getGridlinesTest("areaspline", "time", true, styledGridlines));
    suite.add(getGridlinesTest("areaspline", "time", true, styledGridlines));
    suite.add(getGridlinesTest("areaspline", "time", false, styledGridlines));
