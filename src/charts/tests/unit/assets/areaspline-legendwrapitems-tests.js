YUI.add('areaspline-legendwrapitems-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.AreaSplineLegendWrapItems"),
    ...
    suite.add(LegendTest("areaspline", "bottom", bottomLegend(), "center"));
    suite.add(LegendTest("areaspline", "left", leftLegend(), "middle"));
    suite.add(LegendTest("areaspline", "top", topLegendLeft(), "left"));
    suite.add(LegendTest("areaspline", "right", rightLegendTop(), "top"));
    suite.add(LegendTest("areaspline", "bottom", bottomLegendLeft(), "left"));
    suite.add(LegendTest("areaspline", "left", leftLegendTop(), "top"));
    suite.add(LegendTest("areaspline", "top", topLegendRight(), "right"));
    suite.add(LegendTest("areaspline", "right", rightLegendBottom(), "bottom"));
