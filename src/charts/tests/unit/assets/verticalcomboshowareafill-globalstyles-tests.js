YUI.add('verticalcomboshowareafill-globalstyles-tests', function(Y) {
    var suite = new Y.Test.Suite("Y.Charts.VerticalComboShowAreaFillGlobalStyles"),
    ...
    suite.add(getGlobalStylesTest("combo", null, hashSeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combo", null, arraySeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combo", null, hashSeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combo", null, arraySeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, "vertical", false, true));
    suite.add(getGlobalStylesTest("combo", "time", hashSeriesStyles, "vertical", true, true));
    suite.add(getGlobalStylesTest("combo", "time", arraySeriesStyles, "vertical", true, true));
