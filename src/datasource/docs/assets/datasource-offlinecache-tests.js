YUI.add('datasource-offlinecache-tests', function(Y) {

    var suite = new Y.Test.Suite('datasource-offlinecache example test suite'),
        Assert = Y.Assert;
    ...
    suite.add(new Y.Test.Case({
        ...
        'test retrieve data with offlinecache': function() {
