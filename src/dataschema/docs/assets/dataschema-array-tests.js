YUI.add('dataschema-array-tests', function(Y) {
    ...
    suite.add(new Y.Test.Case({
        ...
        'test Array of objects': function() {
            var test = this,
                outputExpected = cleanStr('{results =&gt; [{year =&gt; 1957, model =&gt; Bel Air, make =&gt; Chevrolet}, {year =&gt; 1964, model =&gt; Dart, make =&gt; Dodge}, {year =&gt; 1968, model =&gt; Mustang, make =&gt; Ford}], meta =&gt; {}}');
...
//          alert(output);
        ...
        'test Simple array of primitives': function() {
            var test = this,
                outputExpected = cleanStr('{results =&gt; [1957 Chevrolet Bel Air, 1964 Dodge Dart, 1968 Ford Mustang], meta =&gt; {}}');
