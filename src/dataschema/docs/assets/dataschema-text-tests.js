YUI.add('dataschema-text-tests', function(Y) {
    ...
    suite.add(new Y.Test.Case({
        ...
        'test apply schema for text': function() {
            var test = this,
                outputExpected = cleanStr('{results =&gt; [{detail =&gt;  spiral-bound, quantity =&gt;  100, product =&gt; notebooks}, {detail =&gt;  #2 with erasers, quantity =&gt;  300, product =&gt; pencils}, {detail =&gt;  blue ink, quantity =&gt;  500, product =&gt; pens}], meta =&gt; {}}');
