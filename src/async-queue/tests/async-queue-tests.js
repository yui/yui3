...
suite.add(new Y.Test.Case({
    ...
    iterationBreakTester: function (timeout) {
        var results = '',
            self = this,
            q = new Y.AsyncQueue(
    ...
    test_iterationBreakSync: function () {
        this.iterationBreakTester(-1);
    },
    test_iterationBreakASync: function () {
        this.iterationBreakTester(10);
    },
