...
suite.add(new Y.Test.Case({
    ...
    _should: {
        ...
        ignore: {
            ...
            // Not supported by core eventx
            "test ET altered return": true
        }
    },
...
// Commented out because core eventx is not supporting AOP through overloaded
// on()/after() methods on EventTarget.
/*
suite.add(new Y.Test.Case({
