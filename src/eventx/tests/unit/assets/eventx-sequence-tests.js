YUI.add("eventx-sequence-tests", function(Y) {
    ...
    suite.add(new Y.Test.Case({
        ...
        _should: {
            ignore: {
                ...
                test_broadcast_1: true,
                test_broadcast_2: true,
                test_broadcast_1_complete: true,
                test_broadcast_1_prevented_at_YUI_instance: true,
                test_broadcast_1_stopped_at_source: true,
                test_broadcast_1_stopped_at_YUI_instance: true,
                test_broadcast_2_complete: true,
                test_broadcast_2_prevented_at_YUI_instance: true,
                test_broadcast_2_prevented_at_YUI_global: true,
                test_broadcast_2_stopped_at_source: true,
                test_broadcast_2_stopped_at_YUI_instance: true,
                test_broadcast_2_stopped_at_YUI_global: true
            }
        },
    ...
    suite.add(new Y.Test.Case({
        ...
        test_bubbleStoppedOnTarget: function () {
            ...
            //Y.Assert.areSame('ABCDE', results);
            // This is odd to me, so I changed the expected result.
            // stopPropagation is stopPropagation. The stoppedFn should trigger
            // on a call to the function, regardless of the presence of other
            // subs/targets that would have been notified that now aren't
            Y.Assert.areSame('AB2CDE', results);
        },
