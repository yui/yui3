/**
Adds selection support to Calendar.

@module calendar
@submodule calendar-selection
**/
...
/**
Class extension that enables support for selecting dates in a Calandar.
...
CalendarSelection.prototype = {
    ...
    **/
    initializer : function () {
        ...
        Y.Do.before(this._constrainSelected, this, '_canBeSelected');
        Y.Do.after(this._constrainCustomRules, this, '_renderCustomRules');
    },
...
*/
    ...
    **/
    ...
    @method _constrainSelected
    @private
    **/
    _constrainSelected : function (date) {
        ...
        return Y.Do.AlterArgs('new args', [date]);
    },

    /**
    Overrides CalendarBase.prototype._renderCustomRules to disable
    nodes earlier than minimumDate and later than maximumDate
    @method _constrainCustomRules
    @private
    **/
    _constrainCustomRules: function () {
        var minDate = this.get('minimumDate'),
            maxDate = this.get('maximumDate'),
            dates = [],
            i, l,
    ...
    destructor: function () {
        Y.Array.each(this._keyEvents, function (handler) {
            handler.detach();
        });
...
Y.CalendarSelection = CalendarSelection;
