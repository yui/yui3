...
// -- Y.TreeView.Tree ----------------------------------------------------------
var treeSuite = new Y.Test.Suite('TreeView.Tree');
...
treeSuite.add(new Y.Test.Case({
    ...
    'constructor should work without a config object': function () {
        ...
        Assert.isInstanceOf(TreeView.Tree, tree, 'tree should be an instance of TreeView.Tree');
        Assert.isInstanceOf(TreeView.Node, tree.rootNode, 'rootNode should be an instance of TreeView.Node');
    ...
    'constructor: `rootNode` config property should support a custom root node config': function () {
        var tree = new TreeView.Tree({rootNode: {label: 'hi!'}});

        Assert.isInstanceOf(TreeView.Node, tree.rootNode, 'rootNode should be an instance of TreeView.Node');
        Assert.areSame('hi!', tree.rootNode.label, 'rootNode should have the custom label specified');
    },

    'constructor: `rootNode` config property should support a custom TreeView.Node instance': function () {
        var treeA = new TreeView.Tree(),
            node  = treeA.createNode({label: 'hi!'}),
            treeB = new TreeView.Tree({rootNode: node});
...
treeSuite.add(new Y.Test.Case({
    ...
    setUp: function () {
        this.tree = new TreeView.Tree({nodes: [
            {label: 'one'},
            {label: 'two'},
            {label: 'three'}
        ]});
...
treeSuite.add(new Y.Test.Case({
    ...
    'appendNode() should append a node to the end of the specified parent node': function () {
        ...
        Assert.isInstanceOf(TreeView.Node, node, 'return value should be the appended node');
    ...
    'appendNode() should adopt a node if it exists in another tree': function () {
        var otherTree = new TreeView.Tree({nodes: [{label: 'adopted node'}]}),
    ...
    'createNode() should create a node and associate it with this tree': function () {
        ...
        Assert.isInstanceOf(TreeView.Node, node, 'node should be a TreeView.Node instance');
        ...
        Assert.isInstanceOf(TreeView.Node, node.children[0], 'child one should be a TreeView.Node instance');
        Assert.isInstanceOf(TreeView.Node, node.children[1], 'child two should be a TreeView.Node instance');
        Assert.isInstanceOf(TreeView.Node, node.children[2], 'child three should be a TreeView.Node instance');
        Assert.isInstanceOf(TreeView.Node, node.children[0].children[0], "child one's child should be a TreeView.Node instance");
    },

    "createNode() should adopt the specified node if it's from another tree": function () {
        var otherTree = new TreeView.Tree({nodes: [{label: 'other node'}]}),
            node      = otherTree.rootNode.children[0];
    ...
    'insertNode() should insert a node at the specified index': function () {
        ...
        Assert.isInstanceOf(TreeView.Node, node, 'return value should be a TreeView.Node instance');
    ...
    'insertNode() should adopt a node if it exists in another tree': function () {
        var otherTree = new TreeView.Tree({nodes: [{label: 'adopted'}]}),
            node      = otherTree.rootNode.children[0];
    ...
    'prependNode() should prepend a node to the beginning of the specified parent node': function () {
        ...
        Assert.isInstanceOf(TreeView.Node, node, 'return value should be the prepended node');
...
treeSuite.add(new Y.Test.Case({
    ...
    'clear() should fire a `clear` event': function () {
        ...
        this.tree.once('clear', function (e) {
            fired = true;
            Assert.isInstanceOf(TreeView.Node, e.rootNode, 'rootNode should be a TreeView.Node instance');
        });
...
// -- Y.TreeView.Node ----------------------------------------------------------
var nodeSuite = new Y.Test.Suite('TreeView.Node');
