...
$nav[]=array('cookie',$docroot.'examples/cookie/index.html','Cookie', 'Cookie - Functional Examples');
$nav[]=array('dd',$docroot.'examples/dd/index.html','Drag &amp; Drop', 'Drag &amp; Drop - Functional Examples');
$nav[]=array('get',$docroot.'examples/get/index.html','Get', 'Get - Functional Examples');
...
$nav[]=array('hosting','http://developer.yahoo.com/yui/3/articles/hosting/','Serving YUI Files from Yahoo! (external)', 'Serve YUI source files from Yahoo! -- free, fast, and simple');
?>
