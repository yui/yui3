			...
			<div class="yui-t1">
				...
				<div class="yui-main">
					<div class="yui-b">
					   ...
					   <div id="productsandservices" class="yui-menu yui-menu-horizontal yui-menubuttonnav">
							<div class="yui-menu-content">
								<ul>
									<li class="yui-menuitem"><a class="yui-menuitem-content" href="http://www.yahoo.com/">Home</a></li>
									<li>
										<a class="yui-menu-label" href="#connect"><em>Connect</em></a>
									...
									<li>
										<a class="yui-menu-label" href="#find-info"><em>Find Info</em></a>
									...
									<li>
										<a class="yui-menu-label" href="#lifestyles"><em>Lifestyles</em></a>
									...
									<li>
										<a class="yui-menu-label" href="#new-finance"><em>News &#38; Finance</em></a>
									...
									<li>
										<a class="yui-menu-label" href="#your-yahoo"><em>Your Yahoo!</em></a>
