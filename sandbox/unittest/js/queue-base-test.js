    ...
    apiTests : {
        ...
        "add" : {
            "supplied items at construction should be added" : function () {
                ...
                Y.ArrayAssert.itemsAreEquivalent([f,f,f,f], q._q);
            },

            "added items should be appended" : function () {
                var q = new Y.Queue();

                Y.ArrayAssert.itemsAreEquivalent([], q._q);

                q.add(1);
                q.add(2,3,4,5);

                Y.ArrayAssert.itemsAreEquivalent([1,2,3,4,5], q._q);

                q = new Y.Queue(f, 1, f, 2);
                q.add(f, 3, f, 4);

                Y.ArrayAssert.itemsAreEquivalent([f,1,f,2,f,3,f,4], q._q);
            }
        },
