...
if (Y.Event) {
    ...
    Y.extend(CE, Y.CustomEvent, {
        subscribe: function(fn, data, context) {
            console.log('HERE: ' + this.type);
            this.on(fn, context, data);
        },
        unsubscribe: function(fn, data, context) {
            this.detach(fn, context, data);
        }
    });
    ...
    Y.extend(EP, Y.EventTarget, {
        ...
        createEvent: function(type, o) {
            ...
            var ce = this.publish(type, o);
            ce.subscribe = function(fn, data, context) {
                this.on(fn, context, data);
            };
            ce.unsubscribe = function(fn, data, context) {
                this.detach(fn, context, data);
            };
