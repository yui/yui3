...
YUI(yConfig).use('dd-ddm', 'dd-drag', 'dd-proxy', 'dd-constrain', 'yui-throttle', 'dd-drop-plugin', 'dd-plugin', function(Y) {
    console.log(Y);
    var d = Y.one('#drag');
    d.plug([
        Y.Plugin.Drag,
    ...
    d.dd.after('drag:end', function(e) {
        console.log('drag end: ', e);
        d.unplug(Y.Plugin.Drop);
        d.unplug(Y.Plugin.Drag);
        console.log(d);
    });
    console.log(d);
});
