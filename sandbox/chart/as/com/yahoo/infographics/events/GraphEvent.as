package com.yahoo.infographics.events
{
	...
	//--------------------------------------
		 ...
		 * @playerversion Flash 9.0.28.0
		 */
		public function GraphEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, index:int = 0, marker:SeriesMarker = null, series:ISeries = null)
		{
	...
	//--------------------------------------		
		...
		{
			return new GraphEvent(this.type, this.bubbles, this.cancelable, this.index, this.marker, this.series);
		}
	}
}
